...
```typescript
import { OpenEndedDateTime1 } from "@cvent/sdk/models/components";

let value: OpenEndedDateTime1 = {
...
| `format`                                                                                      | [components.DateTimeDisplayFormat](../../models/components/datetimedisplayformat.md)          | :heavy_minus_sign:                                                                            | This is used to denote the display format type of date time type custom field.                | DateOnlyMonthFirst                                                                            |
