...
```typescript
import { MeetingRequestCreate } from "@cvent/sdk/models/components";

let value: MeetingRequestCreate = {
  name: "####test",
  sourceId: "sourceId12",
  questions: [
    {
...
| `questions`                                                                                                                                                                                             | [components.MeetingRequestQuestionInput](../../models/components/meetingrequestquestioninput.md)[]                                                                                                      | :heavy_check_mark:                                                                                                                                                                                      | Questions for the meeting request.                                                                                                                                                                      |                                                                                                                                                                                                         |