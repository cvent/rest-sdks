...
```typescript
import { VideoRendition } from "@cvent/sdk/models/components";

let value: VideoRendition = {
...
| `type`                                                                                        | [components.VideoRenditionType](../../models/components/videorenditiontype.md)                | :heavy_minus_sign:                                                                            | Denotes the type of rendition.                                                                | Hls                                                                                           |
| `location`                                                                                    | [components.VideoRenditionLink](../../models/components/videorenditionlink.md)                | :heavy_minus_sign:                                                                            | Location where the rendition is stored.                                                       |                                                                                               |
