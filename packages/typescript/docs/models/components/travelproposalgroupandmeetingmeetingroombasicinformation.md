...
```typescript
import { TravelProposalGroupAndMeetingMeetingRoomBasicInformation } from "@cvent/sdk/models/components";

let value: TravelProposalGroupAndMeetingMeetingRoomBasicInformation = {
