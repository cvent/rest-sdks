...
| `event`                                                                                       | [components.EventLite](../../models/components/eventlite.md)                                  | :heavy_check_mark:                                                                            | The unique identifier of an event.                                                            |                                                                                               |
| `session`                                                                                     | [components.SessionLite](../../models/components/sessionlite.md)                              | :heavy_check_mark:                                                                            | The unique identifier of a session.                                                           |                                                                                               |
| `speaker`                                                                                     | [components.SpeakerLite](../../models/components/speakerlite.md)                              | :heavy_check_mark:                                                                            | The unique identifier of a speaker.                                                           |                                                                                               |
| `programItem`                                                                                 | [components.ProgramItemLite](../../models/components/programitemlite.md)                      | :heavy_check_mark:                                                                            | The unique identifier of a program item.                                                      |                                                                                               |