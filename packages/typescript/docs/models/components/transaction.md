...
```typescript
import { Transaction } from "@cvent/sdk/models/components";
...
| `type`                                                                                        | [components.TransactionType](../../models/components/transactiontype.md)                      | :heavy_minus_sign:                                                                            | The proposal transaction type                                                                 |                                                                                               |
