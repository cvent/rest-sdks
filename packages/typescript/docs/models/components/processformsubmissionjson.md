...
| `event`                                                                                                                                         | [components.ProcessFormSubmissionJsonEvent](../../models/components/processformsubmissionjsonevent.md)                                          | :heavy_check_mark:                                                                                                                              | The event which the process form submission is associated with.                                                                                 |                                                                                                                                                 |
