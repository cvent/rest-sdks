...
```typescript
import { Schedule } from "@cvent/sdk/models/components";
...
| `action`                                                                                                                          | [components.ScheduleAction](../../models/components/scheduleaction.md)                                                            | :heavy_minus_sign:                                                                                                                | This is used to denote the action to perform with the scheduled task                                                              | activate                                                                                                                          |