...
| `capacities`                                                                         | [components.ExistingCapacityJson](../../models/components/existingcapacityjson.md)[] | :heavy_check_mark:                                                                   | Capacities allocated per registration type for this exhibitor's registration pack.   |                                                                                      |