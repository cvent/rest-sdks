...
| `data`                                                                                | [components.SegmentAttendee](../../models/components/segmentattendee.md)[]            | :heavy_check_mark:                                                                    | Collection of list of attendees associated/disassociated to/from an audience segment. |