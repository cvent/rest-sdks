...
```typescript
import { ActivityBaseAppointment } from "@cvent/sdk/models/components";

let value: ActivityBaseAppointment = {
...
| `appointmentEvent`                                                                                                       | [components.ActivityBaseAppointmentAppointmentEvent](../../models/components/activitybaseappointmentappointmentevent.md) | :heavy_minus_sign:                                                                                                       | N/A                                                                                                                      |                                                                                                                          |