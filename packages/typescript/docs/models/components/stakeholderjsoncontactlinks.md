...
```typescript
import { StakeholderJsonContactLinks } from "@cvent/sdk/models/components";

let value: StakeholderJsonContactLinks = {
  twitterUrl: {
...
| `profilePicture`                                                                 | [components.StakeholderJsonLink](../../models/components/stakeholderjsonlink.md) | :heavy_minus_sign:                                                               | Reference to a profile picture.                                                  |