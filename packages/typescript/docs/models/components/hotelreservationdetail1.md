...
```typescript
import { HotelReservationDetail1 } from "@cvent/sdk/models/components";

let value: HotelReservationDetail1 = {
  attendee: {
  ...
  hotelRequestDetails: [
    {
      ...
      rewardsCode: "ROYALTY",
      checkinDate: new Date("2023-05-19T00:00:00Z"),
      checkoutDate: new Date("2023-05-20T00:00:00Z"),
      status: "SUBMITTED",
      ...
      earliestShoulderDate: new Date("2023-05-19T00:00:00Z"),
      latestShoulderDate: new Date("2023-05-19T00:00:00Z"),
...
| `hotelRequestDetails`                                                | [components.HotelRequest](../../models/components/hotelrequest.md)[] | :heavy_minus_sign:                                                   | List of all the hotel requests by attendee and its guest.            |