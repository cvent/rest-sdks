...
```typescript
import { RoomBlock } from "@cvent/sdk/models/components";
...
| `details`                                                                    | [components.RoomBlockDetails](../../models/components/roomblockdetails.md)[] | :heavy_minus_sign:                                                           | Contains detail of quantity required for each room type.                     |                                                                              |