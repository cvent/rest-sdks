...
```typescript
import { StakeholderContactOptOut } from "@cvent/sdk/models/components";

let value: StakeholderContactOptOut = {
...
| `by`                                                                                                                        | [components.OptoutBy](../../models/components/optoutby.md)                                                                  | :heavy_minus_sign:                                                                                                          | This is used to denote how a contact is opt'd out of Cvent system.                                                          | Account User                                                                                                                |