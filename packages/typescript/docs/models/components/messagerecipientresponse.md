...
```typescript
import { MessageRecipientResponse } from "@cvent/sdk/models/components";

let value: MessageRecipientResponse = {
  attendee: {
...
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `attendee`                                                                                                 | [components.MessageRecipientResponseAttendee](../../models/components/messagerecipientresponseattendee.md) | :heavy_check_mark:                                                                                         | The attendee object                                                                                        |
