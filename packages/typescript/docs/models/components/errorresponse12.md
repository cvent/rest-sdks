...
```typescript
import { ErrorResponse12 } from "@cvent/sdk/models/components";

let value: ErrorResponse12 = {
  code: 400,
  message: "Bad Request",
...
| `details`                                                                          | [components.ErrorResponseBase11](../../models/components/errorresponsebase11.md)[] | :heavy_minus_sign:                                                                 | Additional details of cascading error messages.                                    |                                                                                    |