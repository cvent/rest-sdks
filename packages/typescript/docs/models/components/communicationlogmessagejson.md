...
| `attachments`                                                                                            | [components.AttachmentJson](../../models/components/attachmentjson.md)[]                                 | :heavy_minus_sign:                                                                                       | A collection of attachments that are associated with this message.                                       |                                                                                                          |