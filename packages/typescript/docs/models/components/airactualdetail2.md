...
```typescript
import { AirActualDetail2 } from "@cvent/sdk/models/components";

let value: AirActualDetail2 = {
  paging: {
...
| `data`                                                                       | [components.AirActualDetail1](../../models/components/airactualdetail1.md)[] | :heavy_check_mark:                                                           | Collection of air actuals for attendees.                                     |