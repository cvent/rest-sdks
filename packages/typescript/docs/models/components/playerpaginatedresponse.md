...
```typescript
import { PlayerPaginatedResponse } from "@cvent/sdk/models/components";

let value: PlayerPaginatedResponse = {
  paging: {
...
| `data`                                                                   | [components.ExistingPlayer](../../models/components/existingplayer.md)[] | :heavy_check_mark:                                                       | Collection of players.                                                   |