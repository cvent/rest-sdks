...
| `data`                                                                             | [components.ExhibitorCategoryId](../../models/components/exhibitorcategoryid.md)[] | :heavy_minus_sign:                                                                 | Paginated list of exhibitor category Ids for an exhibitor.                         |