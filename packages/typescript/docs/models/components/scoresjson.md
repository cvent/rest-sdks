...
| `event`                                                                                        | [components.EventJson6](../../models/components/eventjson6.md)                                 | :heavy_check_mark:                                                                             | An event reference used in attendee insights to identify the event context for engagement data |                                                                                                |
