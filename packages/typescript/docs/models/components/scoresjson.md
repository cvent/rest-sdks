...
| `event`                                                                                        | [components.EventJson2](../../models/components/eventjson2.md)                                 | :heavy_check_mark:                                                                             | An event reference used in attendee insights to identify the event context for engagement data |                                                                                                |
