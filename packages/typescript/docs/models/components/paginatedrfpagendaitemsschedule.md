...
| `data`                                                                                                     | [components.RfpAgendaItemScheduleWithIdJson](../../models/components/rfpagendaitemschedulewithidjson.md)[] | :heavy_minus_sign:                                                                                         | List of agenda items schedule attached to an RFP.                                                          |