...
```typescript
import { PropertyPaginatedResponse } from "@cvent/sdk/models/components";

let value: PropertyPaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.Property](../../models/components/property.md)[]     | :heavy_minus_sign:                                               | Collection of properties and their related details.              |