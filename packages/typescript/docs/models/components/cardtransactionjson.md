...
```typescript
import { CardTransactionJson } from "@cvent/sdk/models/components";

let value: CardTransactionJson = {
  event: {
...
| ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| `event`                                                                                                | [components.CardTransactionJsonEvent](../../models/components/cardtransactionjsonevent.md)             | :heavy_minus_sign:                                                                                     | The identifier of the Event.                                                                           |                                                                                                        |
...
| `reconciliations`                                                                                      | [components.ZeroAllOf4](../../models/components/zeroallof4.md)[]                                       | :heavy_minus_sign:                                                                                     | The list of reconciled item.                                                                           |                                                                                                        |
