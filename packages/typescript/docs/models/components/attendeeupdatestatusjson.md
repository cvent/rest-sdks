...
```typescript
import { AttendeeUpdateStatusJson } from "@cvent/sdk/models/components";

let value: AttendeeUpdateStatusJson = "Accepted";
```

## Values

```typescript
"No Response" | "Accepted" | "Cancelled" | "Visited" | "Declined" | "Pending Approval" | "Denied Approval"
```