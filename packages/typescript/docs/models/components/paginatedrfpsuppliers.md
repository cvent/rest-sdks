...
```typescript
import { PaginatedRfpSuppliers } from "@cvent/sdk/models/components";

let value: PaginatedRfpSuppliers = {
  paging: {
...
| `data`                                                                     | [components.RfpSupplierJson](../../models/components/rfpsupplierjson.md)[] | :heavy_check_mark:                                                         | List of RFP suppliers.                                                     |