...
```typescript
import { EventFeatureJson } from "@cvent/sdk/models/components";

let value: EventFeatureJson = {
  type: "Registration",
  enabled: true,
  locked: true,
...
| `config`                                                                                 | *components.EventFeatureJsonConfig*                                                      | :heavy_minus_sign:                                                                       | Feature configuration.                                                                   |                                                                                          |
