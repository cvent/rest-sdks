...
```typescript
import { BadgePrintJobsPaginatedResponse } from "@cvent/sdk/models/components";

let value: BadgePrintJobsPaginatedResponse = {
  paging: {
...
| `data`                                                                                 | [components.ExistingBadgePrintJob](../../models/components/existingbadgeprintjob.md)[] | :heavy_minus_sign:                                                                     | Collection of badge print jobs.                                                        |