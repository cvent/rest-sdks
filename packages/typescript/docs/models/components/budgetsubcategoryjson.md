...
```typescript
import { BudgetSubCategoryJson } from "@cvent/sdk/models/components";

let value: BudgetSubCategoryJson = {
...
| `name`                                                               | *string*                                                             | :heavy_minus_sign:                                                   | Name of the budget subcategory assigned to the budget item.          | utilities                                                            |