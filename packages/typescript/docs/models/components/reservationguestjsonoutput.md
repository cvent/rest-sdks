...
| `homeAddress`                                                                                                            | [components.AddressJson](../../models/components/addressjson.md)                                                         | :heavy_minus_sign:                                                                                                       | Address details. Required to create/update a guest's reservation if the hotel/event requires an address in reservations. |                                                                                                                          |
