...
```typescript
import { ExhibitorAdminsListResponse } from "@cvent/sdk/models/components";

let value: ExhibitorAdminsListResponse = {
  paging: {
...
| `data`                                                                                           | [components.ExistingExhibitorAdminJson](../../models/components/existingexhibitoradminjson.md)[] | :heavy_minus_sign:                                                                               | List of exhibitor admins.                                                                        |