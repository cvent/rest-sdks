...
```typescript
import { BudgetTaxInput } from "@cvent/sdk/models/components";

let value: BudgetTaxInput = {
...
| `taxType`                                                                                           | [components.BudgetTaxGratuityType](../../models/components/budgettaxgratuitytype.md)                | :heavy_check_mark:                                                                                  | Denotes the type of tax or gratuity.                                                                | PERCENTAGE                                                                                          |
