...
```typescript
"Website" | "Registration" | "OnArrival" | "AttendeeHub" | "Appointments" | "Planning" | "Agenda" | "Travel" | "Marketing" | "Surveys" | "Speakers" | "Exhibitors" | "Vendors" | "EventAds" | "EventCredits" | "CreditsAndCertificates"
```