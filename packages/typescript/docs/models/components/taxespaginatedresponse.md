...
```typescript
import { TaxesPaginatedResponse } from "@cvent/sdk/models/components";

let value: TaxesPaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.Tax](../../models/components/tax.md)[]               | :heavy_check_mark:                                               | Collection of taxes.                                             |