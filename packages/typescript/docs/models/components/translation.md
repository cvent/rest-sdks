...
| `choiceTranslations`                                                                                                  | [components.ChoiceTranslation](../../models/components/choicetranslation.md)[]                                        | :heavy_minus_sign:                                                                                                    | Translations for the choice texts of a custom field. This property is only applicable for custom fields with choices. |                                                                                                                       |