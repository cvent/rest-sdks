...
```typescript
import { Guest1 } from "@cvent/sdk/models/components";
...
| `paymentInfo`                                                                                                            | [components.PaymentInfo](../../models/components/paymentinfo.md)                                                         | :heavy_minus_sign:                                                                                                       | Payment information.                                                                                                     |                                                                                                                          |