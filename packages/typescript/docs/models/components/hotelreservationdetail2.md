...
```typescript
import { HotelReservationDetail2 } from "@cvent/sdk/models/components";

let value: HotelReservationDetail2 = {
  paging: {
...
| `data`                                                                                     | [components.HotelReservationDetail1](../../models/components/hotelreservationdetail1.md)[] | :heavy_check_mark:                                                                         | Collection of hotel reservation for attendees.                                             |