...
| `type`                                                                                                                     | [components.TransactionType](../../models/components/transactiontype.md)                                                   | :heavy_minus_sign:                                                                                                         | This is used to denote the transaction type for a transaction.                                                             | Approved                                                                                                                   |
