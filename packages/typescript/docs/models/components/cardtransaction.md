...
```typescript
import { CardTransaction } from "@cvent/sdk/models/components";

let value: CardTransaction = {
  event: {
...
| -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `event`                                                                                                                    | [components.CardTransactionEvent](../../models/components/cardtransactionevent.md)                                         | :heavy_minus_sign:                                                                                                         | The identifier of the Event.                                                                                               |                                                                                                                            |
...
| `type`                                                                                                                     | [components.TransactionType1](../../models/components/transactiontype1.md)                                                 | :heavy_minus_sign:                                                                                                         | This is used to denote the transaction type for a transaction.                                                             | Approved                                                                                                                   |
...
| `reconciliation`                                                                                                           | [components.CardTransactionTransactionReconciliation](../../models/components/cardtransactiontransactionreconciliation.md) | :heavy_minus_sign:                                                                                                         | N/A                                                                                                                        |                                                                                                                            |
| `reconciliations`                                                                                                          | [components.TransactionReconciliation](../../models/components/transactionreconciliation.md)[]                             | :heavy_minus_sign:                                                                                                         | The list of reconciled item.                                                                                               |                                                                                                                            |
