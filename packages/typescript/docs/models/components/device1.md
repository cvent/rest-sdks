...
```typescript
import { Device1 } from "@cvent/sdk/models/components";
...
| `type`                                                                                 | [components.DeviceType](../../models/components/devicetype.md)                         | :heavy_minus_sign:                                                                     | The device used to watch the video. Videos can be viewed on desktop, mobile or tablet. |                                                                                        |
