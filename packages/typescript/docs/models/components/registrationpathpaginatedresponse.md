...
```typescript
import { RegistrationPathPaginatedResponse } from "@cvent/sdk/models/components";

let value: RegistrationPathPaginatedResponse = {
  paging: {
...
| `data`                                                                                               | [components.ExistingRegistrationPathJson](../../models/components/existingregistrationpathjson.md)[] | :heavy_check_mark:                                                                                   | Collection of registration paths.                                                                    |