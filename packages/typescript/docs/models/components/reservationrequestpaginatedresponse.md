...
| `data`                                                                                           | [components.HousingReservationResponse](../../models/components/housingreservationresponse.md)[] | :heavy_check_mark:                                                                               | Collection of reservation request details for attendees.                                         |