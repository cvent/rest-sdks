...
```typescript
import { LegDetail } from "@cvent/sdk/models/components";
...
| `date`                                                                                        | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_minus_sign:                                                                            | The ISO 8601 zoned date time (in UTC) of the flight origin.                                   | 2023-05-19T00:00:00Z                                                                          |
