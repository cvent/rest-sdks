...
| `event`                                                                                                      | [components.EventJson4](../../models/components/eventjson4.md)                                               | :heavy_check_mark:                                                                                           | Details of the event.                                                                                        |                                                                                                              |
| `email`                                                                                                      | [components.EmailJson](../../models/components/emailjson.md)                                                 | :heavy_check_mark:                                                                                           | Details of an email to be send.                                                                              |                                                                                                              |
