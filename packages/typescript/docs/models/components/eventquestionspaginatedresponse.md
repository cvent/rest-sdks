...
```typescript
import { EventQuestionsPaginatedResponse } from "@cvent/sdk/models/components";

let value: EventQuestionsPaginatedResponse = {
  paging: {
...
| `data`                                                                         | [components.EventQuestionJson](../../models/components/eventquestionjson.md)[] | :heavy_check_mark:                                                             | Collection of event questions.                                                 |