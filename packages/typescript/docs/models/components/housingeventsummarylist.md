...
| `data`                                                                                  | [components.ZeroAllOf5](../../models/components/zeroallof5.md)[]                        | :heavy_check_mark:                                                                      | List of housing events with key information, providing a summarized view of each event. |