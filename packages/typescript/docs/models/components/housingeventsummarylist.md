...
| `data`                                                                                  | [components.ZeroAllOf8](../../models/components/zeroallof8.md)[]                        | :heavy_check_mark:                                                                      | List of housing events with key information, providing a summarized view of each event. |