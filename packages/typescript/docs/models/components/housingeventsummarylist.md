...
| `data`                                                                                  | [components.ZeroAllOf6](../../models/components/zeroallof6.md)[]                        | :heavy_check_mark:                                                                      | List of housing events with key information, providing a summarized view of each event. |