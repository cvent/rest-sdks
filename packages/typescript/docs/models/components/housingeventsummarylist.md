...
| `data`                                                                                  | [components.HousingEventSummary](../../models/components/housingeventsummary.md)[]      | :heavy_check_mark:                                                                      | List of housing events with key information, providing a summarized view of each event. |