...
```typescript
import { ExistingExhibitorAnswer } from "@cvent/sdk/models/components";

let value: ExistingExhibitorAnswer = {
...
| `answers`                                                                                     | [components.Answer22](../../models/components/answer22.md)[]                                  | :heavy_check_mark:                                                                            | List of answers                                                                               |                                                                                               |
