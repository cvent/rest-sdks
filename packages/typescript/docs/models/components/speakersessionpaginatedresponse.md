...
```typescript
import { SpeakerSessionPaginatedResponse } from "@cvent/sdk/models/components";

let value: SpeakerSessionPaginatedResponse = {
  paging: {
...
| `data`                                                                           | [components.SpeakerSessionJson](../../models/components/speakersessionjson.md)[] | :heavy_check_mark:                                                               | Collection of speaker sessions.                                                  |