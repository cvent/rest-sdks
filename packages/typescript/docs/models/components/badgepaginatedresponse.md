...
```typescript
import { BadgePaginatedResponse } from "@cvent/sdk/models/components";

let value: BadgePaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.Badge](../../models/components/badge.md)[]           | :heavy_minus_sign:                                               | List of badges.                                                  |