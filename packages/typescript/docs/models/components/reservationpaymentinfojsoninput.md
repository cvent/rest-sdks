...
```typescript
import { ReservationPaymentInfoJsonInput } from "@cvent/sdk/models/components";
import { RFCDate } from "@cvent/sdk/types";

let value: ReservationPaymentInfoJsonInput = {
...
| `address`                                                                                                                | [components.AddressJson2](../../models/components/addressjson2.md)                                                       | :heavy_minus_sign:                                                                                                       | Address details. Required to create/update a guest's reservation if the hotel/event requires an address in reservations. |                                                                                                                          |
...
| `creditCard`                                                                                                             | [components.TokenizedCreditCardJsonInput](../../models/components/tokenizedcreditcardjsoninput.md)                       | :heavy_minus_sign:                                                                                                       | Credit card info.                                                                                                        |                                                                                                                          |