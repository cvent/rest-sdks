...
```typescript
import { ExternalActivityMetadataPaginatedResponse } from "@cvent/sdk/models/components";

let value: ExternalActivityMetadataPaginatedResponse = {
  paging: {
...
| `data`                                                                                       | [components.ExternalActivityMetadata](../../models/components/externalactivitymetadata.md)[] | :heavy_check_mark:                                                                           | Collection of external attendee activities metadata in an account.                           |