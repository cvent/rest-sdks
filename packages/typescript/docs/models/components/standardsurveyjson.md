...
let value: StandardSurveyJson = {
  ...
  closeAfter: new Date("2022-02-01T23:59:00.000Z"),
  responseCount: 10,
  status: "Active",
  archiveAfter: new Date("2022-05-07T12:00:00.000Z"),
  customFields: [
    {
...
| `closeAfter`                                                                                  | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_minus_sign:                                                                            | The survey will be closed after this ISO 8601 formatted date and time.                        | 2022-02-01T23:59:00.000Z                                                                      |
...
| `archiveAfter`                                                                                | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_minus_sign:                                                                            | The survey will be archived after this ISO 8601 formatted date and time.                      | 2022-05-07T12:00:00.000Z                                                                      |
| `customFields`                                                                                | [components.CustomFieldJson1](../../models/components/customfieldjson1.md)[]                  | :heavy_minus_sign:                                                                            | Collection of survey custom fields.                                                           |                                                                                               |