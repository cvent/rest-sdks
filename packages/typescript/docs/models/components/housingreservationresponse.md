...
```typescript
import { HousingReservationResponse } from "@cvent/sdk/models/components";

let value: HousingReservationResponse = {
  attendee: {
...
| `reservationRequest`                                                                          | [components.HousingReservation](../../models/components/housingreservation.md)                | :heavy_minus_sign:                                                                            | Representation of the housing reservation details.                                            |                                                                                               |
