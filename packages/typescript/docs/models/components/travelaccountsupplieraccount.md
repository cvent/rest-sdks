...
| `managementLevel`                                                                                                            | [components.ManagementLevelType1](../../models/components/managementleveltype1.md)                                           | :heavy_minus_sign:                                                                                                           | The management level of the travel account.  Defined by the supply-side.                                                     | global                                                                                                                       |
