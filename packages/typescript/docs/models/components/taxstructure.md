...
```typescript
import { TaxStructure } from "@cvent/sdk/models/components";

let value: TaxStructure = {
  disclosureStatement:
...
| `items`                                                                      | [components.TaxAndFee](../../models/components/taxandfee.md)[]               | :heavy_check_mark:                                                           | List of tax or fee items.                                                    |                                                                              |