...
```typescript
import { TransactionDetailsPaginatedResponse } from "@cvent/sdk/models/components";

let value: TransactionDetailsPaginatedResponse = {
  paging: {
...
| `data`                                                                                         | [components.TransactionDetailResponse](../../models/components/transactiondetailresponse.md)[] | :heavy_check_mark:                                                                             | Collection of transaction details.                                                             |