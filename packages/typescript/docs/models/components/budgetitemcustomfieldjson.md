...
| `type`                                                                                                                     | [components.BudgetItemCustomFieldJsonCustomFieldType](../../models/components/budgetitemcustomfieldjsoncustomfieldtype.md) | :heavy_minus_sign:                                                                                                         | The type of data collected by a custom field.                                                                              | MultiSelect                                                                                                                |
