...
```typescript
import { AudioTrackStatusJson } from "@cvent/sdk/models/components";

let value: AudioTrackStatusJson = "Started";
```

## Values

```typescript
"Started" | "Uploaded" | "Scanning" | "Scanned" | "Syncing" | "Rejected" | "Error" | "Available"
```