...
```typescript
import { StakeholderJsonHomeAddressAddress } from "@cvent/sdk/models/components";

let value: StakeholderJsonHomeAddressAddress = {
  address1: "Cvent Inc.",
...
| `latitude`                                                    | *number*                                                      | :heavy_minus_sign:                                            | The geo longitude of the address.                             | 30                                                            |
| `longitude`                                                   | *number*                                                      | :heavy_minus_sign:                                            | The geo latitude of the address.                              | -97                                                           |