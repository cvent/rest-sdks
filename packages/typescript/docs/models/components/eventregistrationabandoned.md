...
| ~~`contact`~~                                                                                                                             | [components.EventRegistrationAbandonedActivityContact](../../models/components/eventregistrationabandonedactivitycontact.md)              | :heavy_minus_sign:                                                                                                                        | : warning: ** DEPRECATED **: This will be removed in a future release, please migrate away from it as soon as possible.<br/><br/>Related contact. |                                                                                                                                           |