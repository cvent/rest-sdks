...
```typescript
import { BudgetVendorResponseJson } from "@cvent/sdk/models/components";

let value: BudgetVendorResponseJson = {
...
| `contactInformation`                                                                          | [components.ContactInformationJson](../../models/components/contactinformationjson.md)        | :heavy_minus_sign:                                                                            | Primary contact details associated with the entity.                                           |                                                                                               |
| `addressInformation`                                                                          | [components.BaseAddressJson](../../models/components/baseaddressjson.md)                      | :heavy_minus_sign:                                                                            | Base Address Model                                                                            |                                                                                               |
