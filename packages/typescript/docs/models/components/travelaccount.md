...
| `type`                                                                                        | [components.TravelAccountType](../../models/components/travelaccounttype.md)                  | :heavy_minus_sign:                                                                            | Code representing the travel account type.                                                    | corporate                                                                                     |
| `certified`                                                                                   | *boolean*                                                                                     | :heavy_minus_sign:                                                                            | Is this a certified travel account?                                                           | true                                                                                          |
| `addresses`                                                                                   | [components.Address6](../../models/components/address6.md)[]                                  | :heavy_minus_sign:                                                                            | List of addresses associated with the travel account.                                         |                                                                                               |