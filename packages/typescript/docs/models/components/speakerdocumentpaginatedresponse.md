...
```typescript
import { SpeakerDocumentPaginatedResponse } from "@cvent/sdk/models/components";

let value: SpeakerDocumentPaginatedResponse = {
  paging: {
...
| `data`                                                             | [components.SpeakerFile](../../models/components/speakerfile.md)[] | :heavy_check_mark:                                                 | Collection of a speaker's documents.                               |