...
```typescript
import { FieldJson1 } from "@cvent/sdk/models/components";

let value: FieldJson1 = {
  text: "Field value",
...
| `type`                                                                             | [components.FieldTypeJson1](../../models/components/fieldtypejson1.md)             | :heavy_minus_sign:                                                                 | Field Type                                                                         | SingleChoice                                                                       |
