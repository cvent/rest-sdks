...
| `language`                                                                                                   | [components.Language1](../../models/components/language1.md)                                                 | :heavy_check_mark:                                                                                           | IETF language code used to specify a target language for the translation.                                    | es-ES                                                                                                        |