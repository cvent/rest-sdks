...
```typescript
import { SessionSpeakerPaginatedResponse } from "@cvent/sdk/models/components";

let value: SessionSpeakerPaginatedResponse = {
  paging: {
...
| `data`                                                                           | [components.SessionSpeakerJson](../../models/components/sessionspeakerjson.md)[] | :heavy_check_mark:                                                               | Collection of a session's speakers.                                              |