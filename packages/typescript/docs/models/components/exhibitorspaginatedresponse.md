...
```typescript
import { ExhibitorsPaginatedResponse } from "@cvent/sdk/models/components";

let value: ExhibitorsPaginatedResponse = {
  paging: {
...
| `data`                                                                                 | [components.ExistingExhibitorJson](../../models/components/existingexhibitorjson.md)[] | :heavy_minus_sign:                                                                     | Paginated list of exhibitors for an event.                                             |