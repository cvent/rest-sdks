...
```typescript
import { PollResponse } from "@cvent/sdk/models/components";
...
| `responses`                                                                          | [components.BaseQuestionResponse](../../models/components/basequestionresponse.md)[] | :heavy_minus_sign:                                                                   | The list of question and answers for a poll.                                         |                                                                                      |