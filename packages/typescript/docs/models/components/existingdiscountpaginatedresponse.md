...
```typescript
import { ExistingDiscountPaginatedResponse } from "@cvent/sdk/models/components";

let value: ExistingDiscountPaginatedResponse = {
  paging: {
...
| `data`                                                           | *components.ExistingDiscountPaginatedResponseData*[]             | :heavy_check_mark:                                               | Collection of discounts.                                         |