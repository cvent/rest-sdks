...
```typescript
import { ELiteratureDocument } from "@cvent/sdk/models/components";

let value: ELiteratureDocument = {
...
| `type`                                                                                   | [components.ELiteratureDocumentType](../../models/components/eliteraturedocumenttype.md) | :heavy_check_mark:                                                                       | Type of eliterature document                                                             | FILE                                                                                     |