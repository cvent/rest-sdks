...
```typescript
import { StandardSurveysPaginatedResponse } from "@cvent/sdk/models/components";

let value: StandardSurveysPaginatedResponse = {
  paging: {
...
| `data`                                                                           | [components.StandardSurveyJson](../../models/components/standardsurveyjson.md)[] | :heavy_check_mark:                                                               | Collection of standard surveys.                                                  |