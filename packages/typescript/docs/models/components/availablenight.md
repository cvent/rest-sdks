...
```typescript
import { AvailableNight } from "@cvent/sdk/models/components";
import { RFCDate } from "@cvent/sdk/types";

let value: AvailableNight = {
  hotel: {
    id: 49543342,
  },
  roomType: {
...
| ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `hotel`                                                                                                     | [components.HotelId](../../models/components/hotelid.md)                                                    | :heavy_check_mark:                                                                                          | Contains unique ID of the hotel.                                                                            |                                                                                                             |
| `roomType`                                                                                                  | [components.RoomTypeId](../../models/components/roomtypeid.md)                                              | :heavy_check_mark:                                                                                          | Contains unique ID of the room type.                                                                        |                                                                                                             |
| `attendeeType`                                                                                              | [components.AttendeeType](../../models/components/attendeetype.md)                                          | :heavy_check_mark:                                                                                          | Attendee type details.                                                                                      |                                                                                                             |
...
| `taxStructure`                                                                                              | [components.TaxStructure](../../models/components/taxstructure.md)                                          | :heavy_minus_sign:                                                                                          | Details about taxes and fees applicable to a room.                                                          |                                                                                                             |
