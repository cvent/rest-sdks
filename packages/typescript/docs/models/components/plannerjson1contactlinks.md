...
```typescript
import { PlannerJson1ContactLinks } from "@cvent/sdk/models/components";

let value: PlannerJson1ContactLinks = {
  twitterUrl: {
...
| `profilePicture`                                                           | [components.PlannerJson1Link](../../models/components/plannerjson1link.md) | :heavy_minus_sign:                                                         | Reference to a profile picture.                                            |