...
| `type`                                                                        | [components.EventType12](../../models/components/eventtype12.md)              | :heavy_minus_sign:                                                            | Event type.                                                                   |                                                                               |
...
| `repeat`                                                                      | *boolean*                                                                     | :heavy_minus_sign:                                                            | True indicates similar event(s) have been held in the past.                   | true                                                                          |
