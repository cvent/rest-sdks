...
| `event`                                                                                                 | [components.Event4](../../models/components/event4.md)                                                  | :heavy_check_mark:                                                                                      | The Associated Event.                                                                                   |                                                                                                         |
...
| `address`                                                                                               | [components.Address4](../../models/components/address4.md)                                              | :heavy_minus_sign:                                                                                      | An object representing an address with various properties.                                              |                                                                                                         |
...
| `contactLinks`                                                                                          | [components.ContactLinks1](../../models/components/contactlinks1.md)                                    | :heavy_minus_sign:                                                                                      | A JSON schema representing contact links, including Twitter, Facebook, and LinkedIn URLs.               |                                                                                                         |
...
| `sponsorshipLevel`                                                                                      | [components.SponsorshipLevel](../../models/components/sponsorshiplevel.md)                              | :heavy_minus_sign:                                                                                      | Associated sponsorship level for an exhibitor                                                           |                                                                                                         |
