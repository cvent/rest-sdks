...
```typescript
import { PaginatedRfpCustomField } from "@cvent/sdk/models/components";

let value: PaginatedRfpCustomField = {
  paging: {
...
| `data`                                                                           | [components.RfpCustomFieldJson](../../models/components/rfpcustomfieldjson.md)[] | :heavy_minus_sign:                                                               | List of RFP custom fields linked to an RFP.                                      |