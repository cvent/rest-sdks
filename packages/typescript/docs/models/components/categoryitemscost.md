...
```typescript
import { CategoryItemsCost } from "@cvent/sdk/models/components";

let value: CategoryItemsCost = {
...
| `categories`                                                   | [components.Category1](../../models/components/category1.md)[] | :heavy_minus_sign:                                             | List of categories.                                            |                                                                |