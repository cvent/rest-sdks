...
```typescript
import { ActivityAppointment } from "@cvent/sdk/models/components";

let value: ActivityAppointment = {
...
| `appointmentEvent`                                                                                               | [components.ActivityAppointmentAppointmentEvent](../../models/components/activityappointmentappointmentevent.md) | :heavy_minus_sign:                                                                                               | N/A                                                                                                              |                                                                                                                  |
