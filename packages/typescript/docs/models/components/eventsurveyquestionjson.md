...
| `choices`                                                                                     | [components.ChoiceJson2](../../models/components/choicejson2.md)[]                            | :heavy_minus_sign:                                                                            | List of choices for the question.                                                             |                                                                                               |
...
| `fields`                                                                                      | [components.FieldJson3](../../models/components/fieldjson3.md)[]                              | :heavy_minus_sign:                                                                            | List of fields for form/matrix questions                                                      |                                                                                               |
