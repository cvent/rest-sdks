...
```typescript
import { RespondentsPaginatedResponse } from "@cvent/sdk/models/components";

let value: RespondentsPaginatedResponse = {
  paging: {
...
| `data`                                                                   | [components.RespondentJson](../../models/components/respondentjson.md)[] | :heavy_check_mark:                                                       | Respondents for surveys.                                                 |