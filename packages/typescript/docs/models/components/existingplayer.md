...
| `region`                                                                                                             | [components.RegionJson](../../models/components/regionjson.md)                                                       | :heavy_minus_sign:                                                                                                   | Region where the live stream originates (These regions are only for Brightcove player)                               | Oregon                                                                                                               |
