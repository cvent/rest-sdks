...
```typescript
import { UsersSchema } from "@cvent/sdk/models/components";

let value: UsersSchema = {
...
| `attributes`                                                   | [components.Attribute](../../models/components/attribute.md)[] | :heavy_minus_sign:                                             | The collection of attributes for the schema.                   |                                                                |
| `meta`                                                         | [components.Meta](../../models/components/meta.md)             | :heavy_minus_sign:                                             | Metadata of the resource.                                      |                                                                |