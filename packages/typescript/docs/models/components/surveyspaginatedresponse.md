...
```typescript
import { SurveysPaginatedResponse } from "@cvent/sdk/models/components";

let value: SurveysPaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.SurveyJson](../../models/components/surveyjson.md)[] | :heavy_check_mark:                                               | Collection of surveys.                                           |