...
```typescript
import { ChainPaginatedResponse } from "@cvent/sdk/models/components";

let value: ChainPaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.Chain](../../models/components/chain.md)[]           | :heavy_minus_sign:                                               | Collection of chains and their related details.                  |