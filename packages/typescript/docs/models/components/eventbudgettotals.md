...
```typescript
import { EventBudgetTotals } from "@cvent/sdk/models/components";

let value: EventBudgetTotals = {
  event: {
...
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `event`                                                                                       | [components.EventBudgetTotalsEvent](../../models/components/eventbudgettotalsevent.md)        | :heavy_minus_sign:                                                                            | The identifier of the Event.                                                                  |                                                                                               |
...
| `lastModifiedDate`                                                                            | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) | :heavy_minus_sign:                                                                            | The ISO 8601 zoned date and time for budget version last modified date.                       | 2020-02-07T00:00:00.000Z                                                                      |
...
| `costDetail`                                                                                  | [components.BudgetCostDetail](../../models/components/budgetcostdetail.md)[]                  | :heavy_minus_sign:                                                                            | The list of cost details.                                                                     |                                                                                               |