...
```typescript
import { SpeakerCategoryPaginatedResponse } from "@cvent/sdk/models/components";

let value: SpeakerCategoryPaginatedResponse = {
  paging: {
...
| `data`                                                                                     | [components.ExistingSpeakerCategory](../../models/components/existingspeakercategory.md)[] | :heavy_check_mark:                                                                         | Collection of speaker categories.                                                          |