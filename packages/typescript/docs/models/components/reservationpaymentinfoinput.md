...
```typescript
import { ReservationPaymentInfoInput } from "@cvent/sdk/models/components";
import { RFCDate } from "@cvent/sdk/types";

let value: ReservationPaymentInfoInput = {
...
| `creditCard`                                                                                                             | [components.TokenizedCreditCardInput](../../models/components/tokenizedcreditcardinput.md)                               | :heavy_minus_sign:                                                                                                       | Credit card info.                                                                                                        |                                                                                                                          |