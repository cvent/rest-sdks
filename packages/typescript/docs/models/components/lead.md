...
| `event`                                                                                       | [components.Event1](../../models/components/event1.md)                                        | :heavy_minus_sign:                                                                            | The Associated Event.                                                                         |                                                                                               |
...
| `appointment`                                                                                 | [components.Appointment](../../models/components/appointment.md)                              | :heavy_minus_sign:                                                                            | A JSON schema representing the structure of an appointment object.                            |                                                                                               |
