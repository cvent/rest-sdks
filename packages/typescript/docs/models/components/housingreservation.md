...
```typescript
import { HousingReservation } from "@cvent/sdk/models/components";

let value: HousingReservation = {
  id: "D6A63423-G796",
  bookingSite: {
    href:
...
| `bookingSite`                                                                          | [components.HousingReservationLink](../../models/components/housingreservationlink.md) | :heavy_minus_sign:                                                                     | Represents a link to a related resource.                                               |                                                                                        |