...
```typescript
import { ResponsesPaginatedResponse } from "@cvent/sdk/models/components";

let value: ResponsesPaginatedResponse = {
  paging: {
...
| `data`                                                               | [components.ResponseJson](../../models/components/responsejson.md)[] | :heavy_check_mark:                                                   | Responses for a survey.                                              |