...
| `reason`                                                                                                                | [components.RfpResponseReason](../../models/components/rfpresponsereason.md)                                            | :heavy_minus_sign:                                                                                                      | Reason given for a response to an RFP.                                                                                  | GUEST_ROOMS_NO_LONGER_AVAILABLE                                                                                         |
