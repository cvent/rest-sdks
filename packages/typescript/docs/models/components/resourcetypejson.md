...
```typescript
import { ResourceTypeJson } from "@cvent/sdk/models/components";

let value: ResourceTypeJson = {
  schemas: [
...
| `schemaExtensions`                                                                                         | [components.ResourceTypeJsonSchemaExtension](../../models/components/resourcetypejsonschemaextension.md)[] | :heavy_minus_sign:                                                                                         | The list of schema extensions for the resource type.                                                       |                                                                                                            |
