...
```typescript
import { ContactHistoryPaginatedResponse } from "@cvent/sdk/models/components";

let value: ContactHistoryPaginatedResponse = {
  paging: {
...
| `data`                                                                           | [components.ContactHistoryJson](../../models/components/contacthistoryjson.md)[] | :heavy_minus_sign:                                                               | Collection of change histories for a specific contact.                           |