...
```typescript
import { SessionCategoryPaginatedResponse } from "@cvent/sdk/models/components";

let value: SessionCategoryPaginatedResponse = {
  paging: {
...
| `data`                                                                     | [components.SessionCategory](../../models/components/sessioncategory.md)[] | :heavy_check_mark:                                                         | Collection of session categories.                                          |