...
```typescript
import { AlternateTravelPaginatedResponsePaging } from "@cvent/sdk/models/components";

let value: AlternateTravelPaginatedResponsePaging = {
...
| `links`                                                                                                                                                                | [components.PaginationLinks](../../models/components/paginationlinks.md)                                                                                               | :heavy_check_mark:                                                                                                                                                     | Represents pagination links for navigating between pages of data.                                                                                                      |                                                                                                                                                                        |