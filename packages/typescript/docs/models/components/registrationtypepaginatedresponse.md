...
| `data`                                                                                                                                 | [components.ExistingRegistrationTypeWithAssociatedRegPath](../../models/components/existingregistrationtypewithassociatedregpath.md)[] | :heavy_check_mark:                                                                                                                     | Collection of registration types.                                                                                                      |