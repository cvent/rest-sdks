...
```typescript
import { AttendeeLinkPaginatedResponse } from "@cvent/sdk/models/components";

let value: AttendeeLinkPaginatedResponse = {
  paging: {
...
| `data`                                                                               | [components.ExistingAttendeeLink](../../models/components/existingattendeelink.md)[] | :heavy_check_mark:                                                                   | Collection of webcast attendee links.                                                |