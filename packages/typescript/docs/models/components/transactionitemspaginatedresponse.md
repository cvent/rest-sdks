...
```typescript
import { TransactionItemsPaginatedResponse } from "@cvent/sdk/models/components";

let value: TransactionItemsPaginatedResponse = {
  paging: {
...
| `data`                                                                                     | [components.TransactionItemResponse](../../models/components/transactionitemresponse.md)[] | :heavy_check_mark:                                                                         | Collection of transaction details.                                                         |