...
```typescript
import { SupplierTypeJson } from "@cvent/sdk/models/components";

let value: SupplierTypeJson = "CONVENTION_AND_CONFERENCE_CENTER";
```

## Values

```typescript
"CONVENTION_AND_CONFERENCE_CENTER" | "CVB" | "HOTEL" | "OTHER"
```