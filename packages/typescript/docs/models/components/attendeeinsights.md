...
| `event`                                                                                        | [components.EventJson3](../../models/components/eventjson3.md)                                 | :heavy_check_mark:                                                                             | An event reference used in attendee insights to identify the event context for engagement data |                                                                                                |
