...
| `event`                                                                                        | [components.EventJson7](../../models/components/eventjson7.md)                                 | :heavy_check_mark:                                                                             | An event reference used in attendee insights to identify the event context for engagement data |                                                                                                |
