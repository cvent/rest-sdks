...
```typescript
import { CardDetailsPaginatedResponse } from "@cvent/sdk/models/components";

let value: CardDetailsPaginatedResponse = {
  paging: {
...
| `data`                                                                     | [components.CardDetailsJson](../../models/components/carddetailsjson.md)[] | :heavy_check_mark:                                                         | Collection of Card Details.                                                |