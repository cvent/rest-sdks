...
```typescript
import { QuantityItemUpdate } from "@cvent/sdk/models/components";

let value: QuantityItemUpdate = {
...
| `attendee`                                                                                       | [components.QuantityItemUpdateAttendee](../../models/components/quantityitemupdateattendee.md)   | :heavy_check_mark:                                                                               | The reference to the attendee. Contains only the ID of the attendee.                             |                                                                                                  |
