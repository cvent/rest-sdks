...
```typescript
import { PaginatedExistingMember } from "@cvent/sdk/models/components";

let value: PaginatedExistingMember = {
  paging: {
...
| `data`                                                                           | [components.ExistingMemberJson](../../models/components/existingmemberjson.md)[] | :heavy_check_mark:                                                               | Collection of Events+ members.                                                   |