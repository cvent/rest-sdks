...
```typescript
import { ExhibitorCategoriesPaginatedResponse } from "@cvent/sdk/models/components";

let value: ExhibitorCategoriesPaginatedResponse = {
  paging: {
...
| `data`                                                                                                 | [components.ExistingExhibitorCategoryJson](../../models/components/existingexhibitorcategoryjson.md)[] | :heavy_minus_sign:                                                                                     | Paginated list of all exhibitor categories for an event.                                               |