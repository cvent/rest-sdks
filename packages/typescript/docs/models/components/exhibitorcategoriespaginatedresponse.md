...
| `data`                                                                                         | [components.ExhibitorCategoryResponse](../../models/components/exhibitorcategoryresponse.md)[] | :heavy_minus_sign:                                                                             | Paginated list of all exhibitor categories for an event.                                       |