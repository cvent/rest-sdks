...
```typescript
import { AttendeeContactMembershipJson } from "@cvent/sdk/models/components";
import { RFCDate } from "@cvent/sdk/types";

let value: AttendeeContactMembershipJson = {
...
| `listInDirectory`                                                             | *boolean*                                                                     | :heavy_minus_sign:                                                            | True indicates the member details should be included in the member directory. | false                                                                         |