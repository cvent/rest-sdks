...
```typescript
import { EmailHistoryPaginatedResponse } from "@cvent/sdk/models/components";

let value: EmailHistoryPaginatedResponse = {
  paging: {
...
| `data`                                                                       | [components.EmailHistoryJson](../../models/components/emailhistoryjson.md)[] | :heavy_check_mark:                                                           | Collection of emails history data.                                           |