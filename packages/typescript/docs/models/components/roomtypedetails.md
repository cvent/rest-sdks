...
| `attendeeTypes`                                                                                                                         | [components.RoomAttendeeType](../../models/components/roomattendeetype.md)[]                                                            | :heavy_minus_sign:                                                                                                                      | List of supported attendee types for this room type, and their individual room policies.                                                |                                                                                                                                         |
...
| `images`                                                                                                                                | [components.ImageLink](../../models/components/imagelink.md)[]                                                                          | :heavy_minus_sign:                                                                                                                      | List of room images.                                                                                                                    |                                                                                                                                         |
