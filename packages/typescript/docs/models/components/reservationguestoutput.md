...
```typescript
import { ReservationGuestOutput } from "@cvent/sdk/models/components";
import { RFCDate } from "@cvent/sdk/types";

let value: ReservationGuestOutput = {
...
| `homeAddress`                                                                                                            | [components.Address3](../../models/components/address3.md)                                                               | :heavy_minus_sign:                                                                                                       | Address details. Required to create/update a guest's reservation if the hotel/event requires an address in reservations. |                                                                                                                          |
| `paymentInfo`                                                                                                            | [components.ReservationPaymentInfoOutput](../../models/components/reservationpaymentinfooutput.md)                       | :heavy_minus_sign:                                                                                                       | Payment information.                                                                                                     |                                                                                                                          |
