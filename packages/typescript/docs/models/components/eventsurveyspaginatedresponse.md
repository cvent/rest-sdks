...
```typescript
import { EventSurveysPaginatedResponse } from "@cvent/sdk/models/components";

let value: EventSurveysPaginatedResponse = {
  paging: {
...
| `data`                                                                     | [components.EventSurveyJson](../../models/components/eventsurveyjson.md)[] | :heavy_check_mark:                                                         | Collection of event surveys.                                               |