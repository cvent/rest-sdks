...
```typescript
import { HooksPaginatedResponse } from "@cvent/sdk/models/components";

let value: HooksPaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.HookOutput](../../models/components/hookoutput.md)[] | :heavy_check_mark:                                               | Collection of contact hooks.                                     |