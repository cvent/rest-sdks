...
| `totalMeetingSpaceRequired`                                                        | [components.SpaceAreaJson0](../../models/components/spaceareajson0.md)             | :heavy_minus_sign:                                                                 | Space area divisons.                                                               |                                                                                    |
...
| `largestMeetingSpaceRequired`                                                      | [components.SpaceAreaJson0](../../models/components/spaceareajson0.md)             | :heavy_minus_sign:                                                                 | Space area divisons.                                                               |                                                                                    |
