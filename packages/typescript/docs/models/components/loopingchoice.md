...
```typescript
import { LoopingChoice } from "@cvent/sdk/models/components";

let value: LoopingChoice = {
...
| ------------------------------------ | ------------------------------------ | ------------------------------------ | ------------------------------------ | ------------------------------------ |
| `id`                                 | *string*                             | :heavy_minus_sign:                   | Loop Choice ID.                      | 9463c74e-18c6-401a-a710-ae0f485bf059 |