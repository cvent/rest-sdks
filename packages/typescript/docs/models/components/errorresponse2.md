...
```typescript
import { ErrorResponse2 } from "@cvent/sdk/models/components";

let value: ErrorResponse2 = {
...
| `details`                                                                          | [components.ErrorResponseBase12](../../models/components/errorresponsebase12.md)[] | :heavy_minus_sign:                                                                 | Additional details of cascading error messages.                                    |                                                                                    |