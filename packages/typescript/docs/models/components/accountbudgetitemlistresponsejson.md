...
| `event`                                                                                       | [components.EventJson3](../../models/components/eventjson3.md)                                | :heavy_minus_sign:                                                                            | Event ID Information.                                                                         |                                                                                               |
| `rfp`                                                                                         | [components.RfpIdJson](../../models/components/rfpidjson.md)                                  | :heavy_minus_sign:                                                                            | RFP ID Information.                                                                           |                                                                                               |
