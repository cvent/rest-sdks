...
```typescript
import { SpeakerPaginatedResponse } from "@cvent/sdk/models/components";

let value: SpeakerPaginatedResponse = {
  paging: {
...
| `data`                                                                     | [components.ExistingSpeaker](../../models/components/existingspeaker.md)[] | :heavy_check_mark:                                                         | Collection of speakers.                                                    |