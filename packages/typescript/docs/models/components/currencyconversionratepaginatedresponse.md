...
| `data`                                                                                                           | [components.CurrencyConversionRateListResponse](../../models/components/currencyconversionratelistresponse.md)[] | :heavy_check_mark:                                                                                               | Collection of conversion rate for a currency in an account.                                                      |