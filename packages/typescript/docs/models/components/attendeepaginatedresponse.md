...
```typescript
import { AttendeePaginatedResponse } from "@cvent/sdk/models/components";

let value: AttendeePaginatedResponse = {
  paging: {
...
| `data`                                                           | [components.Attendee11](../../models/components/attendee11.md)[] | :heavy_check_mark:                                               | Collection of attendees.                                         |