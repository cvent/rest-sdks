...
```typescript
import { LeadQualificationAnswers } from "@cvent/sdk/models/components";

let value: LeadQualificationAnswers = {
...
| `question`                                                                                    | [components.Uuid1](../../models/components/uuid1.md)                                          | :heavy_minus_sign:                                                                            | The reference to the related entity. Contains only the ID of the related entity.              |                                                                                               |
...
| `lead`                                                                                        | [components.Lead2](../../models/components/lead2.md)                                          | :heavy_minus_sign:                                                                            | JSON schema for the Lead object                                                               |                                                                                               |
| `answers`                                                                                     | [components.Answer1](../../models/components/answer1.md)[]                                    | :heavy_minus_sign:                                                                            | List of answers                                                                               |                                                                                               |