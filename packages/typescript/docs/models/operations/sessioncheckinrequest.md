...
| `requestBody`                                                                   | [components.SessionCheckin](../../models/components/sessioncheckin.md)[]        | :heavy_check_mark:                                                              | Attendees to be checked-in. Up to **100 attendees** can be checked-in per call. |                                                                                 |