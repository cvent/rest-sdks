...
```typescript
import { PatchVenueFacilityRequest } from "@cvent/sdk/models/operations";

let value: PatchVenueFacilityRequest = {
...
| `venueFacilityPatch`                                                           | [components.VenueFacilityPatch](../../models/components/venuefacilitypatch.md) | :heavy_check_mark:                                                             | N/A                                                                            |                                                                                |