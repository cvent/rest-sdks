...
```typescript
import { ListWebcastsResponse } from "@cvent/sdk/models/operations";

let value: ListWebcastsResponse = {
  result: {
    paging: {
...
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------ |
| `result`                                                                                   | [components.WebcastPaginatedResponse](../../models/components/webcastpaginatedresponse.md) | :heavy_check_mark:                                                                         | N/A                                                                                        |