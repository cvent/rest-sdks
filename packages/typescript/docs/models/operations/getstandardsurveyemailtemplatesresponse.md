...
```typescript
import { GetStandardSurveyEmailTemplatesResponse } from "@cvent/sdk/models/operations";

let value: GetStandardSurveyEmailTemplatesResponse = {
  result: {
    paging: {
...
| ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
| `result`                                                                                                                             | [components.StandardSurveyEmailTemplatesPaginatedResponse](../../models/components/standardsurveyemailtemplatespaginatedresponse.md) | :heavy_check_mark:                                                                                                                   | N/A                                                                                                                                  |