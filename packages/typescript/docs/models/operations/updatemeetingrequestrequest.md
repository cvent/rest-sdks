...
| `requestBody`                                                                        | [components.MeetingRequestUpdate](../../models/components/meetingrequestupdate.md)[] | :heavy_check_mark:                                                                   | Up to **5 meeting requests** can be updated per call.                                |                                                                                      |