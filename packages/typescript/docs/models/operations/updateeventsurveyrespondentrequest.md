...
```typescript
import { UpdateEventSurveyRespondentRequest } from "@cvent/sdk/models/operations";

let value: UpdateEventSurveyRespondentRequest = {
...
| `eventSurveyRespondent`                                                                        | [components.EventSurveyRespondentInput](../../models/components/eventsurveyrespondentinput.md) | :heavy_check_mark:                                                                             | Used to update a respondent for an event survey.                                               |                                                                                                |