...
```typescript
import { ListProgramItemsPostFiltersResponse } from "@cvent/sdk/models/operations";

let value: ListProgramItemsPostFiltersResponse = {
  result: {
    paging: {
...
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `result`                                                                                           | [components.ProgramItemPaginatedResponse](../../models/components/programitempaginatedresponse.md) | :heavy_check_mark:                                                                                 | N/A                                                                                                |