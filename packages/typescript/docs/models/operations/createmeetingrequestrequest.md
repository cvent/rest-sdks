...
| `requestBody`                                                                        | [components.MeetingRequestCreate](../../models/components/meetingrequestcreate.md)[] | :heavy_check_mark:                                                                   | Up to **5 meeting requests** can be created per call.                                |                                                                                      |