...
| `requestBody`                                                                     | [components.SessionCheckinBase](../../models/components/sessioncheckinbase.md)[]  | :heavy_check_mark:                                                                | Attendee check-in to be updated. Up to **100 attendees** can be updated per call. |                                                                                   |