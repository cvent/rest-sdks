...
```typescript
import { ListAvailabilityResponse } from "@cvent/sdk/models/operations";

let value: ListAvailabilityResponse = {
  result: {
    paging: {
...
| -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `result`                                                                                                                   | [components.AppointmentAvailabilityPaginatedResponse](../../models/components/appointmentavailabilitypaginatedresponse.md) | :heavy_check_mark:                                                                                                         | N/A                                                                                                                        |