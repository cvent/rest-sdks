...
```typescript
import { GetEventsPostFiltersResponse } from "@cvent/sdk/models/operations";

let value: GetEventsPostFiltersResponse = {
  result: {
    paging: {
...
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| `result`                                                                               | [components.EventPaginatedResponse](../../models/components/eventpaginatedresponse.md) | :heavy_check_mark:                                                                     | N/A                                                                                    |