...
```typescript
import { GetSignaturesResponse } from "@cvent/sdk/models/operations";

let value: GetSignaturesResponse = {
  result: {
    paging: {
...
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `result`                                                                       | [components.SignaturesResponse](../../models/components/signaturesresponse.md) | :heavy_check_mark:                                                             | N/A                                                                            |