...
export type EventUpdate = {
   ...
   * @deprecated field: This will be removed in a future release, please migrate away from it as soon as possible.
   */
  category?: EventUpdateLookup | undefined;
  /**
...
/** @internal */
export const EventUpdateLookup$inboundSchema: z.ZodType<
  EventUpdateLookup,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function eventUpdateLookupFromJSON(
  jsonString: string,
): SafeParseResult<EventUpdateLookup, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventUpdateLookup$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventUpdateLookup' from JSON`,
  );
}
