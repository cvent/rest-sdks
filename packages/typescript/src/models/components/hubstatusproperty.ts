 ...
 */
export const HubStatusProperty = {
  Inactive: "Inactive",
  Active: "Active",
  Deleted: "Deleted",
} as const;
 ...
 * The current Events+ Hub status. Inactive: The Events+ Hub is inactive and unavailable to members. Active: Members can access the Events+ Hub. Deleted: The Events+ Hub has been deleted and is unavailable to members or planners.
 */
export type HubStatusProperty = ClosedEnum<typeof HubStatusProperty>;

/** @internal */
export const HubStatusProperty$inboundSchema: z.ZodNativeEnum<
  typeof HubStatusProperty
> = z.nativeEnum(HubStatusProperty);
