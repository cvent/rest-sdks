 ...
 */
export const AttendeeResponseMethod = {
 ...
 * @deprecated enum: This will be removed in a future release, please migrate away from it as soon as possible.
 */
export type AttendeeResponseMethod = ClosedEnum<typeof AttendeeResponseMethod>;

/** @internal */
export const AttendeeResponseMethod$outboundSchema: z.ZodNativeEnum<
  typeof AttendeeResponseMethod
> = z.nativeEnum(AttendeeResponseMethod);
