...
export type Event11 = {
   ...
   * @deprecated field: This will be removed in a future release, please migrate away from it as soon as possible.
   */
  category?: Event1Lookup | undefined;
  /**
...
/** @internal */
export const Event1Lookup$inboundSchema: z.ZodType<
  Event1Lookup,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function event1LookupFromJSON(
  jsonString: string,
): SafeParseResult<Event1Lookup, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Event1Lookup$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Event1Lookup' from JSON`,
  );
}

/** @internal */
export const Event11$inboundSchema: z.ZodType<Event11, z.ZodTypeDef, unknown> =
  z.object({
    id: z.string().optional(),
    title: z.string(),
    code: z.string().optional(),
    ...
    category: z.lazy(() => Event1Lookup$inboundSchema).optional(),
