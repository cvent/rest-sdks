 ...
 */
export const OfferingCostType1 = {
 ...
 * Cost type associated with organizing and hosting events and meetings.
 */
export type OfferingCostType1 = ClosedEnum<typeof OfferingCostType1>;

/** @internal */
export const OfferingCostType1$inboundSchema: z.ZodNativeEnum<
  typeof OfferingCostType1
> = z.nativeEnum(OfferingCostType1);
