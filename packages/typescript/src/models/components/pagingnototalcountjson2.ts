 ...
 */
export type PagingNoTotalCountJson2 = {
  /**
...
/** @internal */
export const PagingNoTotalCountJson2$inboundSchema: z.ZodType<
...
export function pagingNoTotalCountJson2FromJSON(
  jsonString: string,
): SafeParseResult<PagingNoTotalCountJson2, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PagingNoTotalCountJson2$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PagingNoTotalCountJson2' from JSON`,
  );
}
