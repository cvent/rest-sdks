...
/** @internal */
export const PagingJson23$inboundSchema: z.ZodType<
  PagingJson23,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function pagingJson23FromJSON(
  jsonString: string,
): SafeParseResult<PagingJson23, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PagingJson23$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PagingJson23' from JSON`,
  );
}
