...
/** @internal */
export const HubBackground$inboundSchema: z.ZodType<
  HubBackground,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function hubBackgroundFromJSON(
  jsonString: string,
): SafeParseResult<HubBackground, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HubBackground$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HubBackground' from JSON`,
  );
}
