 ...
 */
export type AttendeeContactMembership = {
  /**
...
/** @internal */
export const AttendeeContactMembership$inboundSchema: z.ZodType<
...
export function attendeeContactMembershipFromJSON(
  jsonString: string,
): SafeParseResult<AttendeeContactMembership, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AttendeeContactMembership$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AttendeeContactMembership' from JSON`,
  );
}
