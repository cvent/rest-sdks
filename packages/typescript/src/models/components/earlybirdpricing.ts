...
/** @internal */
export const EarlyBirdPricing$inboundSchema: z.ZodType<
  EarlyBirdPricing,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function earlyBirdPricingFromJSON(
  jsonString: string,
): SafeParseResult<EarlyBirdPricing, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EarlyBirdPricing$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EarlyBirdPricing' from JSON`,
  );
}
