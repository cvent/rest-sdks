 ...
 */
export const ContactObfuscationStatusType = {
  Initiated: "INITIATED",
  Queued: "QUEUED",
 ...
 * FAILED - The obfuscation request failed due to an error.
 */
export type ContactObfuscationStatusType = ClosedEnum<
  typeof ContactObfuscationStatusType
>;

/** @internal */
export const ContactObfuscationStatusType$inboundSchema: z.ZodNativeEnum<
  typeof ContactObfuscationStatusType
> = z.nativeEnum(ContactObfuscationStatusType);
