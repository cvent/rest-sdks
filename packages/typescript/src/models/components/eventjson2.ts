...
export type EventJson2 = {
   ...
   * @deprecated field: This will be removed in a future release, please migrate away from it as soon as possible.
   */
  category?: EventJson2Lookup | undefined;
  /**
...
/** @internal */
export const EventJson2Lookup$inboundSchema: z.ZodType<
  EventJson2Lookup,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function eventJson2LookupFromJSON(
  jsonString: string,
): SafeParseResult<EventJson2Lookup, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EventJson2Lookup$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EventJson2Lookup' from JSON`,
  );
}
...
> = z.object({
  ...
  category: z.lazy(() => EventJson2Lookup$inboundSchema).optional(),
