 ...
 * Event type.
 */
export type EventType12 = ClosedEnum<typeof EventType12>;

/** @internal */
export const EventType12$inboundSchema: z.ZodNativeEnum<typeof EventType12> = z
  .nativeEnum(EventType12);
