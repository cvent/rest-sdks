...
/** @internal */
export type AddressJsonInput$Outbound = {
  address1?: string | undefined;
  address2?: string | undefined;
  address3?: string | undefined;
  city?: string | undefined;
...
/** @internal */
export const AddressJsonInput$outboundSchema: z.ZodType<
...
export function addressJsonInputToJSON(
  addressJsonInput: AddressJsonInput,
): string {
  return JSON.stringify(
    AddressJsonInput$outboundSchema.parse(addressJsonInput),
  );
}
