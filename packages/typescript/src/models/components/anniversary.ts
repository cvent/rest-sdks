 ...
 */
export type AnniversaryContactType = {
  /**
...
export type Anniversary = {
   ...
   * The contact type associated with this membership item.
   */
  contactType?: AnniversaryContactType | undefined;
  /**
...
/** @internal */
export const AnniversaryContactType$inboundSchema: z.ZodType<
...
export function anniversaryContactTypeFromJSON(
  jsonString: string,
): SafeParseResult<AnniversaryContactType, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => AnniversaryContactType$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'AnniversaryContactType' from JSON`,
  );
}
...
/** @internal */
export const Anniversary$inboundSchema: z.ZodType<
  Anniversary,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  contactType: z.lazy(() => AnniversaryContactType$inboundSchema).optional(),
...
export function anniversaryFromJSON(
  jsonString: string,
): SafeParseResult<Anniversary, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Anniversary$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Anniversary' from JSON`,
  );
}
