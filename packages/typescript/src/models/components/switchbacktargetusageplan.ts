 ...
 */
export type SwitchBackTargetUsagePlan = {
  /**
...
/** @internal */
export const SwitchBackTargetUsagePlan$inboundSchema: z.ZodType<
...
export function switchBackTargetUsagePlanFromJSON(
  jsonString: string,
): SafeParseResult<SwitchBackTargetUsagePlan, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => SwitchBackTargetUsagePlan$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'SwitchBackTargetUsagePlan' from JSON`,
  );
}
