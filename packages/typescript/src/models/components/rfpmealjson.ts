 ...
 * Meal type offered during the agenda.
 */
export type RfpMealJson = ClosedEnum<typeof RfpMealJson>;

/** @internal */
export const RfpMealJson$inboundSchema: z.ZodNativeEnum<typeof RfpMealJson> = z
  .nativeEnum(RfpMealJson);
