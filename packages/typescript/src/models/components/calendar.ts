 ...
 */
export type CalendarContactType = {
  /**
...
export type Calendar = {
   ...
   * The contact type associated with this membership item.
   */
  contactType?: CalendarContactType | undefined;
  /**
...
/** @internal */
export const CalendarContactType$inboundSchema: z.ZodType<
  CalendarContactType,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function calendarContactTypeFromJSON(
  jsonString: string,
): SafeParseResult<CalendarContactType, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CalendarContactType$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CalendarContactType' from JSON`,
  );
}

/** @internal */
export const Calendar$inboundSchema: z.ZodType<
  Calendar,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  contactType: z.lazy(() => CalendarContactType$inboundSchema).optional(),
