...
/** @internal */
export const Attendee1$inboundSchema: z.ZodType<
  Attendee1,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function attendee1FromJSON(
  jsonString: string,
): SafeParseResult<Attendee1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => Attendee1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Attendee1' from JSON`,
  );
}
