...
/** @internal */
export const Webcast$outboundSchema: z.ZodType<
  Webcast$Outbound,
  z.ZodTypeDef,
  Webcast
> = z.object({
...
export function webcastToJSON(webcast: Webcast): string {
  return JSON.stringify(Webcast$outboundSchema.parse(webcast));
}
