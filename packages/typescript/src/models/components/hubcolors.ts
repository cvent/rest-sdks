...
/** @internal */
export const HubColors$inboundSchema: z.ZodType<
  HubColors,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function hubColorsFromJSON(
  jsonString: string,
): SafeParseResult<HubColors, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HubColors$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HubColors' from JSON`,
  );
}
