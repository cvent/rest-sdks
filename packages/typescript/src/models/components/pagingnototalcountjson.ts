 ...
 */
export type PagingNoTotalCountJson = {
  /**
...
/** @internal */
export const PagingNoTotalCountJson$inboundSchema: z.ZodType<
...
export function pagingNoTotalCountJsonFromJSON(
  jsonString: string,
): SafeParseResult<PagingNoTotalCountJson, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PagingNoTotalCountJson$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PagingNoTotalCountJson' from JSON`,
  );
}
