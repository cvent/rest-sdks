 ...
 */
export type ExistingExhibitorJson = {
  /**
...
/** @internal */
export const ExistingExhibitorJson$inboundSchema: z.ZodType<
...
export function existingExhibitorJsonFromJSON(
  jsonString: string,
): SafeParseResult<ExistingExhibitorJson, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExistingExhibitorJson$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExistingExhibitorJson' from JSON`,
  );
}
