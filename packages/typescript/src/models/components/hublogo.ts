...
/** @internal */
export const HubLogo$inboundSchema: z.ZodType<HubLogo, z.ZodTypeDef, unknown> =
  z.object({
...
export function hubLogoFromJSON(
  jsonString: string,
): SafeParseResult<HubLogo, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HubLogo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HubLogo' from JSON`,
  );
}
