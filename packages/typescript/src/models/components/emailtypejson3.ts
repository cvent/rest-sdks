 ...
 * Denotes the type of the email.
 */
export type EmailTypeJson3 = ClosedEnum<typeof EmailTypeJson3>;

/** @internal */
export const EmailTypeJson3$inboundSchema: z.ZodNativeEnum<
  typeof EmailTypeJson3
> = z.nativeEnum(EmailTypeJson3);
