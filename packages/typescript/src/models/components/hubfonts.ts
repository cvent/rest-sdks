...
/** @internal */
export const HubFonts$inboundSchema: z.ZodType<
  HubFonts,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function hubFontsFromJSON(
  jsonString: string,
): SafeParseResult<HubFonts, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => HubFonts$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'HubFonts' from JSON`,
  );
}
