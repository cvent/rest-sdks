 ...
 */
export type ExhibitorAnswerLimits = {
  /**
...
/** @internal */
export const ExhibitorAnswerLimits$inboundSchema: z.ZodType<
...
export function exhibitorAnswerLimitsFromJSON(
  jsonString: string,
): SafeParseResult<ExhibitorAnswerLimits, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExhibitorAnswerLimits$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExhibitorAnswerLimits' from JSON`,
  );
}
