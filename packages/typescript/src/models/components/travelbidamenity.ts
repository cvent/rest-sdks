...
import { AmenityType, AmenityType$inboundSchema } from "./amenitytype.js";
import {
  BidItemStatusType,
 ...
 */
export type TravelBidAmenity = {
  /**
   * Amenity type
   */
  type?: AmenityType | undefined;
  /**
...
/** @internal */
export const TravelBidAmenity$inboundSchema: z.ZodType<
  TravelBidAmenity,
  z.ZodTypeDef,
  unknown
> = z.object({
  type: AmenityType$inboundSchema.optional(),
...
export function travelBidAmenityFromJSON(
  jsonString: string,
): SafeParseResult<TravelBidAmenity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TravelBidAmenity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TravelBidAmenity' from JSON`,
  );
}
