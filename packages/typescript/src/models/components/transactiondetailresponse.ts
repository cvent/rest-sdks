...
/** @internal */
export const TransactionDetailResponse$inboundSchema: z.ZodType<
...
export function transactionDetailResponseFromJSON(
  jsonString: string,
): SafeParseResult<TransactionDetailResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TransactionDetailResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TransactionDetailResponse' from JSON`,
  );
}
