...
/** @internal */
export const PagingJson19$inboundSchema: z.ZodType<
  PagingJson19,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function pagingJson19FromJSON(
  jsonString: string,
): SafeParseResult<PagingJson19, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PagingJson19$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PagingJson19' from JSON`,
  );
}
