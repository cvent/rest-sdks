...
/** @internal */
export const TaxAndFee$inboundSchema: z.ZodType<
  TaxAndFee,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function taxAndFeeFromJSON(
  jsonString: string,
): SafeParseResult<TaxAndFee, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => TaxAndFee$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'TaxAndFee' from JSON`,
  );
}
