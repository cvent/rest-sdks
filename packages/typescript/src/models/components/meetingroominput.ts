...
/** @internal */
export type MeetingRoomInput$Outbound = {
  name: string;
  description?: string | undefined;
...
/** @internal */
export const MeetingRoomInput$outboundSchema: z.ZodType<
  MeetingRoomInput$Outbound,
  z.ZodTypeDef,
  MeetingRoomInput
> = z.object({
  name: z.string(),
...
export function meetingRoomInputToJSON(
  meetingRoomInput: MeetingRoomInput,
): string {
  return JSON.stringify(
    MeetingRoomInput$outboundSchema.parse(meetingRoomInput),
  );
}
