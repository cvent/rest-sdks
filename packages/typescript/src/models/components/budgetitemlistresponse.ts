 ...
 */
export type BudgetItemListResponseEvent = {
  /**
 ...
 */
export type BudgetItemListResponse = {
  /**
   * The identifier of the Event.
   */
  event?: BudgetItemListResponseEvent | undefined;
  /**
...
/** @internal */
export const BudgetItemListResponseEvent$inboundSchema: z.ZodType<
...
export function budgetItemListResponseEventFromJSON(
  jsonString: string,
): SafeParseResult<BudgetItemListResponseEvent, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BudgetItemListResponseEvent$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BudgetItemListResponseEvent' from JSON`,
  );
}

/** @internal */
export const BudgetItemListResponse$inboundSchema: z.ZodType<
  BudgetItemListResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  event: z.lazy(() => BudgetItemListResponseEvent$inboundSchema).optional(),
  id: z.string().optional(),
...
export function budgetItemListResponseFromJSON(
  jsonString: string,
): SafeParseResult<BudgetItemListResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BudgetItemListResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BudgetItemListResponse' from JSON`,
  );
}
