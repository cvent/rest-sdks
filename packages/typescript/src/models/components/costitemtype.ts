 ...
 * The cost item type.
 */
export type CostItemType = ClosedEnum<typeof CostItemType>;

/** @internal */
export const CostItemType$inboundSchema: z.ZodNativeEnum<typeof CostItemType> =
  z.nativeEnum(CostItemType);
/** @internal */
export const CostItemType$outboundSchema: z.ZodNativeEnum<typeof CostItemType> =
