...
import {
  CompositeValue,
  CompositeValue$inboundSchema,
} from "./compositevalue.js";
import { QuestionType1, QuestionType1$inboundSchema } from "./questiontype1.js";
 ...
 */
export type MeetingRequestQuestion = {
  /**
   ...
   */
  compositeValue?: CompositeValue | undefined;
};

/** @internal */
export const MeetingRequestQuestion$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  type: QuestionType1$inboundSchema.optional(),
  value: z.array(z.string()),
  answerType: AnswerType12$inboundSchema.optional(),
  secondaryValue: z.string().optional(),
  compositeValue: CompositeValue$inboundSchema.optional(),
});

export function meetingRequestQuestionFromJSON(
  jsonString: string,
): SafeParseResult<MeetingRequestQuestion, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MeetingRequestQuestion$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MeetingRequestQuestion' from JSON`,
  );
}
