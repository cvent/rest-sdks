 ...
 */
export type BudgetCostDetail12 = {
  /**
...
/** @internal */
export const BudgetCostDetail12$inboundSchema: z.ZodType<
  BudgetCostDetail12,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function budgetCostDetail12FromJSON(
  jsonString: string,
): SafeParseResult<BudgetCostDetail12, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BudgetCostDetail12$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BudgetCostDetail12' from JSON`,
  );
}
