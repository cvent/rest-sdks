 ...
 */
export const AttendeeResponseMethod1 = {
 ...
 * Note: The responseMethod can only be set if the invitee's status is No Response.
 */
export type AttendeeResponseMethod1 = ClosedEnum<
  typeof AttendeeResponseMethod1
>;

/** @internal */
export const AttendeeResponseMethod1$inboundSchema: z.ZodNativeEnum<
  typeof AttendeeResponseMethod1
> = z.nativeEnum(AttendeeResponseMethod1);
/** @internal */
export const AttendeeResponseMethod1$outboundSchema: z.ZodNativeEnum<
  typeof AttendeeResponseMethod1
