 ...
 */
export const AttendeeResponseMethodJson = {
 ...
 * Note: The responseMethod can only be set if the invitee's status is No Response.
 */
export type AttendeeResponseMethodJson = ClosedEnum<
  typeof AttendeeResponseMethodJson
>;

/** @internal */
export const AttendeeResponseMethodJson$inboundSchema: z.ZodNativeEnum<
  typeof AttendeeResponseMethodJson
> = z.nativeEnum(AttendeeResponseMethodJson);
/** @internal */
export const AttendeeResponseMethodJson$outboundSchema: z.ZodNativeEnum<
  typeof AttendeeResponseMethodJson
