 ...
 * Denotes the method of payment.
 */
export type PaymentType11 = ClosedEnum<typeof PaymentType11>;

/** @internal */
export const PaymentType11$inboundSchema: z.ZodNativeEnum<
  typeof PaymentType11
> = z.nativeEnum(PaymentType11);
/** @internal */
export const PaymentType11$outboundSchema: z.ZodNativeEnum<
  typeof PaymentType11
> = PaymentType11$inboundSchema;
