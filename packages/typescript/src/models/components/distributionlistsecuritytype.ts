 ...
 */
export const DistributionListSecurityType = {
  Private: "PRIVATE",
 ...
 * Type of distribution list security. For a public list, contacts can sign up themselves. For a semi-private list, contacts can add themselves, but a planner must approve their membership before they can receive emails. For a private list, only planners can add contacts. Contacts can always remove themselves from lists on the Manage Profile page.
 */
export type DistributionListSecurityType = ClosedEnum<
  typeof DistributionListSecurityType
>;

/** @internal */
export const DistributionListSecurityType$inboundSchema: z.ZodNativeEnum<
  typeof DistributionListSecurityType
> = z.nativeEnum(DistributionListSecurityType);
/** @internal */
export const DistributionListSecurityType$outboundSchema: z.ZodNativeEnum<
  typeof DistributionListSecurityType
