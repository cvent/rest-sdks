 ...
 */
export type CurrencyConversionRateResponse = {
  /**
...
/** @internal */
export const CurrencyConversionRateResponse$inboundSchema: z.ZodType<
...
export function currencyConversionRateResponseFromJSON(
  jsonString: string,
): SafeParseResult<CurrencyConversionRateResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CurrencyConversionRateResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CurrencyConversionRateResponse' from JSON`,
  );
}
