 ...
 */
export const ExistingDiscountCodeLevel = {
  Event: "EVENT",
  Account: "ACCOUNT",
} as const;
/**
 * Whether the discount is created at event level or account level.
 */
export type ExistingDiscountCodeLevel = ClosedEnum<
  typeof ExistingDiscountCodeLevel
>;

/**
 * Representation of an existing discount code.
 */
export type ExistingDiscountCode = {
  /**
   ...
   * Whether the discount is created at event level or account level.
   */
  level?: ExistingDiscountCodeLevel | undefined;
  /**
...
/** @internal */
export const ExistingDiscountCodeLevel$inboundSchema: z.ZodNativeEnum<
  typeof ExistingDiscountCodeLevel
> = z.nativeEnum(ExistingDiscountCodeLevel);

/** @internal */
export const ExistingDiscountCode$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  level: ExistingDiscountCodeLevel$inboundSchema.optional(),
  capacity: DiscountCapacity$inboundSchema.optional(),
  type: z.literal("DISCOUNT_CODE"),
  applyToAllEvents: z.boolean().optional(),
});

export function existingDiscountCodeFromJSON(
  jsonString: string,
): SafeParseResult<ExistingDiscountCode, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ExistingDiscountCode$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ExistingDiscountCode' from JSON`,
  );
}
