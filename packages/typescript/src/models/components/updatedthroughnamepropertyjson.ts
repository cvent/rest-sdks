 ...
 */
export const UpdatedThroughNamePropertyJson = {
  ...
  ConcurReconciliationMapToExistingBudgetItem:
    "Concur Reconciliation - Map to Existing Budget Item",
  ...
  EventAutomaticallyCreatedFromMeetingRequest:
    "Event Automatically Created from Meeting Request",
  ...
  EventModifiedFromMeetingRequestViaAPI:
    "Event Modified from Meeting Request via API",
  ...
  EventPlannerContactInformationUpdate:
    "Event Planner Contact Information Update",
  ...
  ModifiedFromMeetingRequestViaNotification:
    "Modified from Meeting Request via Notification",
  ...
  TravelCostImportMapToExistingBudgetItem:
    "Travel Cost Import - Map to Existing Budget item",
  TravelCostImportMapToNewBudgetItem:
    "Travel Cost Import - Map to New Budget Item",
  ...
  VCNTransactionMapToMultipleBudgetItem:
    "VCN Transaction - Map to Multiple Budget Item",
  VCNTransactionMapToSingleBudgetItem:
    "VCN Transaction - Map to Single Budget Item",
  VCNTransactionRemovedFromBudgetItem:
    "VCN Transaction - Removed from Budget Item",
 ...
 * Name of the place where this change was updated through.
 */
export type UpdatedThroughNamePropertyJson = ClosedEnum<
  typeof UpdatedThroughNamePropertyJson
>;

/** @internal */
export const UpdatedThroughNamePropertyJson$inboundSchema: z.ZodNativeEnum<
  typeof UpdatedThroughNamePropertyJson
> = z.nativeEnum(UpdatedThroughNamePropertyJson);
