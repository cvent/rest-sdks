...
/** @internal */
export const ProgramItem1$inboundSchema: z.ZodType<
  ProgramItem1,
  z.ZodTypeDef,
  unknown
> = z.object({
...
export function programItem1FromJSON(
  jsonString: string,
): SafeParseResult<ProgramItem1, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ProgramItem1$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ProgramItem1' from JSON`,
  );
}
