 ...
 * The date types used for the proposal, 'PREFERRED' have the highest priority. Values prefixed with 'ALTERNATE_' are decreasing in priority (e.g., ALTERNATE_1 has higher priority than 'ALTERNATE_2 and so on).
 */
export type DateType1 = ClosedEnum<typeof DateType1>;

/** @internal */
export const DateType1$inboundSchema: z.ZodNativeEnum<typeof DateType1> = z
  .nativeEnum(DateType1);
/** @internal */
export const DateType1$outboundSchema: z.ZodNativeEnum<typeof DateType1> =
