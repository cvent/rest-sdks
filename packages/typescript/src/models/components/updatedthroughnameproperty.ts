 ...
 */
export const UpdatedThroughNameProperty = {
 ...
 * Name of the place where this change was updated through.
 */
export type UpdatedThroughNameProperty = ClosedEnum<
  typeof UpdatedThroughNameProperty
>;

/** @internal */
export const UpdatedThroughNameProperty$inboundSchema: z.ZodNativeEnum<
  typeof UpdatedThroughNameProperty
> = z.nativeEnum(UpdatedThroughNameProperty);
