 ...
 * The target type can either refer to the type of recipient or the type of action that made the recipient a participant in the RFP process.
 */
export type TargetTypeJson = ClosedEnum<typeof TargetTypeJson>;

/** @internal */
export const TargetTypeJson$inboundSchema: z.ZodNativeEnum<
  typeof TargetTypeJson
> = z.nativeEnum(TargetTypeJson);
