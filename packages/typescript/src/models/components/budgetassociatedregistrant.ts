 ...
 */
export type BudgetAssociatedRegistrant = {
  /**
...
/** @internal */
export const BudgetAssociatedRegistrant$inboundSchema: z.ZodType<
...
export function budgetAssociatedRegistrantFromJSON(
  jsonString: string,
): SafeParseResult<BudgetAssociatedRegistrant, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => BudgetAssociatedRegistrant$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'BudgetAssociatedRegistrant' from JSON`,
  );
}
