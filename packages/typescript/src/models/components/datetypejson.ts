 ...
 * The date types used for the proposal, 'PREFERRED' have the highest priority. Values prefixed with 'ALTERNATE_' are decreasing in priority (e.g., ALTERNATE_1 has higher priority than 'ALTERNATE_2 and so on).
 */
export type DateTypeJson = ClosedEnum<typeof DateTypeJson>;

/** @internal */
export const DateTypeJson$inboundSchema: z.ZodNativeEnum<typeof DateTypeJson> =
  z.nativeEnum(DateTypeJson);
/** @internal */
export const DateTypeJson$outboundSchema: z.ZodNativeEnum<typeof DateTypeJson> =
