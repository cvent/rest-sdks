 ...
 */
export type PlanningDocumentReferenceLink = {
  /**
...
/** @internal */
export const PlanningDocumentReferenceLink$inboundSchema: z.ZodType<
...
export function planningDocumentReferenceLinkFromJSON(
  jsonString: string,
): SafeParseResult<PlanningDocumentReferenceLink, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => PlanningDocumentReferenceLink$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'PlanningDocumentReferenceLink' from JSON`,
  );
}
