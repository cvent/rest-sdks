 ...
 */
export const OfferingCostTypeJson0 = {
 ...
 * Cost type associated with organizing and hosting events and meetings.
 */
export type OfferingCostTypeJson0 = ClosedEnum<typeof OfferingCostTypeJson0>;

/** @internal */
export const OfferingCostTypeJson0$inboundSchema: z.ZodNativeEnum<
  typeof OfferingCostTypeJson0
> = z.nativeEnum(OfferingCostTypeJson0);
