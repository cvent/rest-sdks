...
import {
  ChoiceSortOrderJson,
  ChoiceSortOrderJson$inboundSchema,
} from "./choicesortorderjson.js";
import {
  DateAnswerFormatJson,
  DateAnswerFormatJson$inboundSchema,
} from "./dateanswerformatjson.js";
import {
  DisplayTypeJson,
  DisplayTypeJson$inboundSchema,
} from "./displaytypejson.js";
import { FieldJson, FieldJson$inboundSchema } from "./fieldjson.js";
import {
  NumericAnswerFormatJson,
  NumericAnswerFormatJson$inboundSchema,
} from "./numericanswerformatjson.js";
import {
  QuestionClassificationTypeJson,
  QuestionClassificationTypeJson$inboundSchema,
} from "./questionclassificationtypejson.js";
import {
  QuestionTypeJson,
...
import {
  ...
  StandardQuestionJson$inboundSchema,
} from "./standardquestionjson.js";
import {
  SupplierTypeJson,
  SupplierTypeJson$inboundSchema,
} from "./suppliertypejson.js";
import {
  TextAnswerFormatJson,
  TextAnswerFormatJson$inboundSchema,
} from "./textanswerformatjson.js";
import { TextFieldJson, TextFieldJson$inboundSchema } from "./textfieldjson.js";
import {
  UnitPositionJson,
  UnitPositionJson$inboundSchema,
} from "./unitpositionjson.js";
...
export type RfpQuestionJson = {
   ...
   */
  choiceSortOrder?: ChoiceSortOrderJson | undefined;
  /**
   ...
   */
  displayType?: DisplayTypeJson | undefined;
  /**
   ...
   */
  dateAnswerFormat: DateAnswerFormatJson;
  /**
   * The answer format that a given number is stored in.
   */
  numericAnswerFormat?: NumericAnswerFormatJson | undefined;
  /**
   ...
   */
  unitPosition?: UnitPositionJson | undefined;
  /**
   ...
   */
  textAnswerFormat?: TextAnswerFormatJson | undefined;
  /**
   * An object that contains custom answer format data.
   */
   ...
   */
  supplierTypes?: Array<SupplierTypeJson> | undefined;
  /**
   ...
   */
  classificationType?: QuestionClassificationTypeJson | undefined;
  /**
   ...
   */
  standardQuestion?: StandardQuestionJson | undefined;
  /**
...
/** @internal */
export const RfpQuestionJson$inboundSchema: z.ZodType<
  RfpQuestionJson,
  z.ZodTypeDef,
  unknown
> = z.object({
  ...
  choiceSortOrder: ChoiceSortOrderJson$inboundSchema.optional(),
  displayType: DisplayTypeJson$inboundSchema.optional(),
  ...
  dateAnswerFormat: DateAnswerFormatJson$inboundSchema.default("DateTime"),
  numericAnswerFormat: NumericAnswerFormatJson$inboundSchema.optional(),
  unitLabel: z.string().optional(),
  unitPosition: UnitPositionJson$inboundSchema.optional(),
  minLength: z.number().int().default(0),
  maxLength: z.number().int().default(500),
  textAnswerFormat: TextAnswerFormatJson$inboundSchema.optional(),
  customAnswerFormat: z.lazy(() => CustomAnswerFormat$inboundSchema).optional(),
  supplierTypes: z.array(SupplierTypeJson$inboundSchema).optional(),
  classificationType: QuestionClassificationTypeJson$inboundSchema.optional(),
  order: z.number().int().optional(),
  standardQuestion: StandardQuestionJson$inboundSchema.optional(),
  aiQuestionGenerationSource: z.string().optional(),
});

export function rfpQuestionJsonFromJSON(
  jsonString: string,
): SafeParseResult<RfpQuestionJson, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => RfpQuestionJson$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'RfpQuestionJson' from JSON`,
  );
}
