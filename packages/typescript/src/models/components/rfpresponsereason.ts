 ...
 */
export const RfpResponseReason = {
 ...
 * Reason given for a response to an RFP.
 */
export type RfpResponseReason = ClosedEnum<typeof RfpResponseReason>;

/** @internal */
export const RfpResponseReason$inboundSchema: z.ZodNativeEnum<
  typeof RfpResponseReason
> = z.nativeEnum(RfpResponseReason);
