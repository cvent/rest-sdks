...
export type GetEventSurveysResponse = {
  result: components.EventSurveysPaginatedResponse;
};
...
/** @internal */
export const GetEventSurveysRequest$outboundSchema: z.ZodType<
  GetEventSurveysRequest$Outbound,
  z.ZodTypeDef,
...
export function getEventSurveysRequestToJSON(
  getEventSurveysRequest: GetEventSurveysRequest,
): string {
  return JSON.stringify(
    GetEventSurveysRequest$outboundSchema.parse(getEventSurveysRequest),
  );
}

/** @internal */
export const GetEventSurveysResponse$inboundSchema: z.ZodType<
  GetEventSurveysResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  Result: components.EventSurveysPaginatedResponse$inboundSchema,
}).transform((v) => {
  return remap$(v, {
    "Result": "result",
  });
...
export function getEventSurveysResponseFromJSON(
  jsonString: string,
): SafeParseResult<GetEventSurveysResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetEventSurveysResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetEventSurveysResponse' from JSON`,
  );
}
