...
export type GetHotelRequestsRequest = {
  /**
   ...
   */
  expand?: Array<components.ExpandHotelRequestQuestionAnswer> | undefined;
  /**
...
/** @internal */
export type GetHotelRequestsRequest$Outbound = {
...
/** @internal */
export const GetHotelRequestsRequest$outboundSchema: z.ZodType<
  GetHotelRequestsRequest$Outbound,
  z.ZodTypeDef,
  GetHotelRequestsRequest
> = z.object({
  after: z.date().transform(v => v.toISOString()).optional(),
  before: z.date().transform(v => v.toISOString()).optional(),
  limit: z.number().int().default(100),
  token: z.string().optional(),
  expand: z.array(components.ExpandHotelRequestQuestionAnswer$outboundSchema)
    .optional(),
...
export function getHotelRequestsRequestToJSON(
  getHotelRequestsRequest: GetHotelRequestsRequest,
): string {
  return JSON.stringify(
    GetHotelRequestsRequest$outboundSchema.parse(getHotelRequestsRequest),
  );
}

/** @internal */
export const GetHotelRequestsResponse$inboundSchema: z.ZodType<
...
export function getHotelRequestsResponseFromJSON(
  jsonString: string,
): SafeParseResult<GetHotelRequestsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetHotelRequestsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetHotelRequestsResponse' from JSON`,
  );
}
