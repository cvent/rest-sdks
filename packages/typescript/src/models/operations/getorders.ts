...
export function getOrdersResponseFromJSON(
  jsonString: string,
): SafeParseResult<GetOrdersResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => GetOrdersResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetOrdersResponse' from JSON`,
  );
}
