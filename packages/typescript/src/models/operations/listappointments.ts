...
export type ListAppointmentsRequest = {
  /**
...
export type ListAppointmentsResponse = {
  result: components.AppointmentPaginatedResponse;
};

/** @internal */
export type ListAppointmentsRequest$Outbound = {
...
/** @internal */
export const ListAppointmentsRequest$outboundSchema: z.ZodType<
  ListAppointmentsRequest$Outbound,
  z.ZodTypeDef,
...
export function listAppointmentsRequestToJSON(
  listAppointmentsRequest: ListAppointmentsRequest,
): string {
  return JSON.stringify(
    ListAppointmentsRequest$outboundSchema.parse(listAppointmentsRequest),
  );
}

/** @internal */
export const ListAppointmentsResponse$inboundSchema: z.ZodType<
  ListAppointmentsResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  Result: components.AppointmentPaginatedResponse$inboundSchema,
}).transform((v) => {
  return remap$(v, {
    "Result": "result",
  });
...
export function listAppointmentsResponseFromJSON(
  jsonString: string,
): SafeParseResult<ListAppointmentsResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ListAppointmentsResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListAppointmentsResponse' from JSON`,
  );
}
