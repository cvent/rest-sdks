...
export type ListAvailabilityResponse = {
  result: components.AppointmentAvailabilityPaginatedResponse;
};

/** @internal */
export type ListAvailabilityRequest$Outbound = {
...
/** @internal */
export const ListAvailabilityRequest$outboundSchema: z.ZodType<
  ListAvailabilityRequest$Outbound,
  z.ZodTypeDef,
...
export function listAvailabilityRequestToJSON(
  listAvailabilityRequest: ListAvailabilityRequest,
): string {
  return JSON.stringify(
    ListAvailabilityRequest$outboundSchema.parse(listAvailabilityRequest),
  );
}

/** @internal */
export const ListAvailabilityResponse$inboundSchema: z.ZodType<
  ListAvailabilityResponse,
  z.ZodTypeDef,
  unknown
> = z.object({
  Result: components.AppointmentAvailabilityPaginatedResponse$inboundSchema,
}).transform((v) => {
  return remap$(v, {
    "Result": "result",
  });
...
export function listAvailabilityResponseFromJSON(
  jsonString: string,
): SafeParseResult<ListAvailabilityResponse, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ListAvailabilityResponse$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListAvailabilityResponse' from JSON`,
  );
}
