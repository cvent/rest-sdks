    ...
    [
      {
        type: "oauth2:client_credentials",
        value: {
          clientID: security?.oAuth2ClientCredentials?.clientID
            ?? env().CVENTSDK_CLIENT_ID,
          clientSecret: security?.oAuth2ClientCredentials?.clientSecret
    ...
    [
      {
        ...
        type: "oauth2",
        value: security?.oAuth2AuthorizationCode
          ?? env().CVENTSDK_O_AUTH2_AUTHORIZATION_CODE,
      },
    ],
  );
}
