 ...
 */
export function budgetGetBudgetItems(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetBudgetItemsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetBudgetItemsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBudgetItemsResponse$inboundSchema, {
      key: "Result",
    }),
