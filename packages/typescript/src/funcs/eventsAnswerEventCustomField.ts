 ...
 */
export function eventsAnswerEventCustomField(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AnswerEventCustomFieldRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/custom-fields/{customFieldId}/answers")(
    pathParams,
  );
