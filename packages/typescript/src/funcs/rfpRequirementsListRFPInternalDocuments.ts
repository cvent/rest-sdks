 ...
 */
export function rfpRequirementsListRFPInternalDocuments(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListRfpInternalDocumentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rfps/{rfpId}/internal-documents")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["rfp/rfp-internal-documents:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListRfpInternalDocumentsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      rfpRequirementsListRFPInternalDocuments(
        client,
        {
          ...request,
          token: nextCursor,
