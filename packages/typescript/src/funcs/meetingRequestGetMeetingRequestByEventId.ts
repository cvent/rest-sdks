 ...
 */
export function meetingRequestGetMeetingRequestByEventId(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMeetingRequestByEventIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/meeting-requests")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.MeetingRequest$inboundSchema),
