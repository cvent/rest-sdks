 ...
 */
export function rfpRequirementsListRFPCustomFields(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListRfpCustomFieldsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListRfpCustomFieldsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rfps/{rfpId}/custom-fields/answers")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["rfp/rfp-custom-fields:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListRfpCustomFieldsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      rfpRequirementsListRFPCustomFields(
        client,
        {
          ...request,
          token: nextCursor,
