 ...
 */
export function attendeeActivitiesListAttendeeActivities(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListAttendeeActivitiesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAttendeeActivitiesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/attendees/activities")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/attendee-activities:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAttendeeActivitiesResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      attendeeActivitiesListAttendeeActivities(
        client,
        {
          ...request,
          token: nextCursor,
