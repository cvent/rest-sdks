 ...
 */
export function usersAddUserToAccountUserGroup(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AddUserToAccountUserGroupRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "addUserToAccountUserGroup",
    oAuth2Scopes: ["account/user-groups:write"],
