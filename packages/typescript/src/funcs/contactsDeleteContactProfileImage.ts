 ...
 */
export function contactsDeleteContactProfileImage(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteContactProfileImageRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deleteContactProfileImage",
