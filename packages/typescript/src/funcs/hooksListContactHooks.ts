 ...
 */
export function hooksListContactHooks(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListContactHooksResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListContactHooksRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/contacts/hooks")();
  ...
  const context = {
    ...
    operationID: "ListContactHooks",
    oAuth2Scopes: ["account/hooks:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListContactHooksResponse$inboundSchema, {
      key: "Result",
    }),
