 ...
 */
export function speakersAddSpeakerDoc(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddSpeakerDocRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/speakers/{id}/docs/{fileId}")(pathParams);
