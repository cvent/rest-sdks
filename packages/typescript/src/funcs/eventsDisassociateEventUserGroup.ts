 ...
 */
export function eventsDisassociateEventUserGroup(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisassociateEventUserGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/user-groups/{userGroupId}")(pathParams);
  ...
  const context = {
    ...
    operationID: "disassociateEventUserGroup",
    oAuth2Scopes: ["event/event-user-groups:write"],
