 ...
 */
export function sessionsRemoveSpeakerFromSession(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveSpeakerFromSessionRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "removeSpeakerFromSession",
    oAuth2Scopes: ["event/sessions:delete"],
