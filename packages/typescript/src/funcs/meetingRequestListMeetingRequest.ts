 ...
 */
export function meetingRequestListMeetingRequest(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListMeetingRequestResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListMeetingRequestRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/meeting-request-forms/{id}/requests")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListMeetingRequestResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      meetingRequestListMeetingRequest(
        client,
        {
          ...request,
          token: nextCursor,
