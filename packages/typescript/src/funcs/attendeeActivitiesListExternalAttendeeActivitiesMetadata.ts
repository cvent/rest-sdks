 ...
 */
export function attendeeActivitiesListExternalAttendeeActivitiesMetadata(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListExternalAttendeeActivitiesMetadataRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/attendees/activities/external/metadata")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/attendee-activities-metadata:read"],
  ...
  >(
    M.json(
      200,
      operations.ListExternalAttendeeActivitiesMetadataResponse$inboundSchema,
      { key: "Result" },
    ),
