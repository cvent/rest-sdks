 ...
 */
export function eventsListRegistrationTypes(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListRegistrationTypesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListRegistrationTypesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/registration-types")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/registration-types:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListRegistrationTypesResponse$inboundSchema, {
      key: "Result",
    }),
