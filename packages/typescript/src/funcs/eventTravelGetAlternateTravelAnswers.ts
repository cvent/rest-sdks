...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAlternateTravelAnswersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/event-travel/alternate-answers")(
    pathParams,
  );
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/alternate-travel:read"],
