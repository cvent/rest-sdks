 ...
 */
export function appointmentsListAvailability(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListAvailabilityResponse,
...
> {
  ...
  const path = pathToFunc("/appointment-availability-times")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAvailabilityResponse$inboundSchema, {
      key: "Result",
    }),
