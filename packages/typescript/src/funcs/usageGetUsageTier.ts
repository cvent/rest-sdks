 ...
 */
export function usageGetUsageTier(
  client: CventSDKCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.PublicUsagePlan,
...
> {
  const path = pathToFunc("/usage/tier")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.PublicUsagePlan$inboundSchema),
    M.jsonErr([401, 403, 429], errors.ErrorResponse11$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
