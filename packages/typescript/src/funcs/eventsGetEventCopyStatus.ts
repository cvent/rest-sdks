 ...
 */
export function eventsGetEventCopyStatus(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetEventCopyStatusRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    eventCopyId: encodeSimple("eventCopyId", payload.eventCopyId, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/events/copy/{eventCopyId}/status")(pathParams);
