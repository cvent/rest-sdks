 ...
 */
export function transactionsGetAccountTransactionItem(
  client: CventSDKCore,
  request: operations.GetAccountTransactionItemRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.TransactionItemAccountResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountTransactionItemRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    transactionItemId: encodeSimple(
      "transactionItemId",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.TransactionItemAccountResponse$inboundSchema),
