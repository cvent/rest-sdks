 ...
 */
export function exhibitorGetSponsorshipLevels(
  client: CventSDKCore,
  request: operations.GetSponsorshipLevelsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SponsorshipLevelListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSponsorshipLevelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/sponsorship-levels")(pathParams);
  ...
  const context = {
    ...
    operationID: "getSponsorshipLevels",
    oAuth2Scopes: ["exhibitor/sponsorship-levels:read"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.SponsorshipLevelListResponse$inboundSchema),
