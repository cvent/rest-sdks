...
export function housingGetHousingEventRoomTypes(
  ...
  Result<
    components.HousingEventRoomTypesList,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHousingEventRoomTypesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.HousingEventRoomTypesList$inboundSchema),
