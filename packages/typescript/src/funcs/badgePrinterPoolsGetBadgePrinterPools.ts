 ...
 */
export function badgePrinterPoolsGetBadgePrinterPools(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetBadgePrinterPoolsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetBadgePrinterPoolsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{eventId}/badge-printer-pools")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["remote-printing/badge-printer-pools:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBadgePrinterPoolsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      badgePrinterPoolsGetBadgePrinterPools(
        client,
        {
          ...request,
          token: nextCursor,
