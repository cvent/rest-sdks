 ...
 */
export function travelRFPsGetTravelProgramQuestion(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTravelProgramQuestionRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Question$inboundSchema),
