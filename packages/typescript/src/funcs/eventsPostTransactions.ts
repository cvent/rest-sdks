 ...
 */
export function eventsPostTransactions(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostTransactionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/transactions")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/transactions:write"],
