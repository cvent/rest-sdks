 ...
 */
export function ordersGetAccountOrderItem(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountOrderItemRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/orders/{orderId}/items/{orderItemId}")(pathParams);
