 ...
 */
export function hooksDeleteContactHook(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteContactHookRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deleteContactHook",
    oAuth2Scopes: ["account/hooks:delete"],
