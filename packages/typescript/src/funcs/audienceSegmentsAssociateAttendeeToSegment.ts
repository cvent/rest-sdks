 ...
 */
export function audienceSegmentsAssociateAttendeeToSegment(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AssociateAttendeeToSegmentRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr([401, 403, 404, 422, 429], errors.ErrorResponse1$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
