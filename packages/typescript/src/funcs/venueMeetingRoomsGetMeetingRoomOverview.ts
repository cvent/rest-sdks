 ...
 */
export function venueMeetingRoomsGetMeetingRoomOverview(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMeetingRoomOverviewRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "getMeetingRoomOverview",
