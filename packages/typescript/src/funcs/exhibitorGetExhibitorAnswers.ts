 ...
 */
export function exhibitorGetExhibitorAnswers(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExhibitorAnswersRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["exhibitor/exhibitor-answers:read"],
