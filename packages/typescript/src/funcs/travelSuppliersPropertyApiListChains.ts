 ...
 */
export function travelSuppliersPropertyApiListChains(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PropertyApiListChainsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/travel-suppliers/chains")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["business-transient/supplier-chains:read"],
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      travelSuppliersPropertyApiListChains(
        client,
        {
          ...request,
          token: nextCursor,
