 ...
 */
export function rfpSuppliersGetRFPSuppliers(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetRfpSuppliersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRfpSuppliersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rfps/{rfpId}/suppliers")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["rfp/rfp-suppliers:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetRfpSuppliersResponse$inboundSchema, {
      key: "Result",
    }),
