 ...
 */
export function appointmentsGetAppointmentById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAppointmentByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/appointments/{id}")(pathParams);
