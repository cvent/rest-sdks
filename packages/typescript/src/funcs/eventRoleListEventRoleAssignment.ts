 ...
 */
export function eventRoleListEventRoleAssignment(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListEventRoleAssignmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListEventRoleAssignmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/event-roles/assignments")();
  ...
  const context = {
    ...
    operationID: "listEventRoleAssignment",
    oAuth2Scopes: ["event/role-assignments:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEventRoleAssignmentResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      eventRoleListEventRoleAssignment(
        client,
        {
          ...request,
          token: nextCursor,
