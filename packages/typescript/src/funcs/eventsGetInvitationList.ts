 ...
 */
export function eventsGetInvitationList(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetInvitationListResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetInvitationListRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/invitation-lists")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/invitation-lists:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetInvitationListResponse$inboundSchema, {
      key: "Result",
    }),
