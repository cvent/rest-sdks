 ...
 */
export function sessionsUpdateProgramItem(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateProgramItemRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["program-item-update-request"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/program-items/{programItemId}")(pathParams);
