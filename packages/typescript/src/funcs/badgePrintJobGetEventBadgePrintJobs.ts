 ...
 */
export function badgePrintJobGetEventBadgePrintJobs(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetEventBadgePrintJobsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetEventBadgePrintJobsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{eventId}/badge-print-jobs")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["remote-printing/badge-print-jobs:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEventBadgePrintJobsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      badgePrintJobGetEventBadgePrintJobs(
        client,
        {
          ...request,
          token: nextCursor,
