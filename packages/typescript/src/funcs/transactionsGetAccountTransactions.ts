 ...
 */
export function transactionsGetAccountTransactions(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetAccountTransactionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountTransactionsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAccountTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
