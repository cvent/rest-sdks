 ...
 */
export function sessionsGetSessionLocation(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetSessionLocationResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSessionLocationRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/sessions:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSessionLocationResponse$inboundSchema, {
      key: "Result",
    }),
