 ...
 */
export function leadsGetEliteratureRequests(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetEliteratureRequestsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetEliteratureRequestsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/eliterature-requests")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["exhibitor/eliterature-requests:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEliteratureRequestsResponse$inboundSchema, {
      key: "Result",
    }),
