 ...
 */
export function customFieldsListCustomFields(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListCustomFieldsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/custom-fields")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/custom-fields:read"],
