 ...
 */
export function webcastsCreateWebcast(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.Webcast$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr([400, 401, 403, 409, 429], errors.ErrorResponse11$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
