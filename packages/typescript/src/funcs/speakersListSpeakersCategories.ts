 ...
 */
export function speakersListSpeakersCategories(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSpeakersCategoriesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSpeakersCategoriesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/speaker-categories")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/speaker-categories:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSpeakersCategoriesResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      speakersListSpeakersCategories(
        client,
        {
          ...request,
          token: nextCursor,
