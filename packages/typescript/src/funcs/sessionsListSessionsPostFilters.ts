 ...
 */
export function sessionsListSessionsPostFilters(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSessionsPostFiltersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/filter")();
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      sessionsListSessionsPostFilters(
        client,
        {
          ...request,
          token: nextCursor,
