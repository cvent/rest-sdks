...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHousingEventHotelAvailabilityRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    oAuth2Scopes: ["housing/housing-event-available-nights:read"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AvailableNights$inboundSchema),
