 ...
 */
export function eventFeaturesGetEventFeatures(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetEventFeaturesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetEventFeaturesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/features")(pathParams);
  ...
  const context = {
    ...
    operationID: "getEventFeatures",
    oAuth2Scopes: ["event/event-features:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEventFeaturesResponse$inboundSchema, {
      key: "Result",
    }),
