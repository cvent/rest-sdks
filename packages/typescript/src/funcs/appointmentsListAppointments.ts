 ...
 */
export function appointmentsListAppointments(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListAppointmentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAppointmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/appointments")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["appointments/appointments:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAppointmentsResponse$inboundSchema, {
      key: "Result",
    }),
