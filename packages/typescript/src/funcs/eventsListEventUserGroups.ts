 ...
 */
export function eventsListEventUserGroups(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListEventUserGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListEventUserGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/user-groups")(pathParams);
  ...
  const context = {
    ...
    operationID: "listEventUserGroups",
    oAuth2Scopes: ["event/event-user-groups:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEventUserGroupsResponse$inboundSchema, {
      key: "Result",
    }),
