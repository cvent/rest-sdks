 ...
 */
export function venueMeetingRoomsDisassociateMeetingRoomImage(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisassociateMeetingRoomImageRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "disassociateMeetingRoomImage",
    oAuth2Scopes: ["venue/meeting-room-images:delete"],
