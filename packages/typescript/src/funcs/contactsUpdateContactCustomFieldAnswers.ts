 ...
 */
export function contactsUpdateContactCustomFieldAnswers(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateContactCustomFieldAnswersRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "updateContactCustomFieldAnswers",
