 ...
 */
export function surveysGetStandardSurveys(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetStandardSurveysResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetStandardSurveysRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/standard-surveys")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["survey/standard-surveys:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStandardSurveysResponse$inboundSchema, {
      key: "Result",
    }),
