 ...
 */
export function contactsCreateContactRelationship(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateContactRelationshipRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/contacts/{id}/related-contacts/{relatedContactId}")(
    pathParams,
  );
