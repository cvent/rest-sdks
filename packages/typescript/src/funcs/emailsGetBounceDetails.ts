 ...
 */
export function emailsGetBounceDetails(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetBounceDetailsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetBounceDetailsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["email/bounces:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBounceDetailsResponse$inboundSchema, {
      key: "Result",
    }),
