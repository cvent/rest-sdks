 ...
 */
export function eventTravelGetAirRequests(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetAirRequestsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAirRequestsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/event-travel/air-requests")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAirRequestsResponse$inboundSchema, {
      key: "Result",
    }),
