 ...
 */
export function sessionsRelateProgramItemToSessionDocument(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RelateProgramItemToSessionDocumentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/program-items/{programItemId}/docs/{fileId}")(
    pathParams,
  );
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/program-items:write"],
