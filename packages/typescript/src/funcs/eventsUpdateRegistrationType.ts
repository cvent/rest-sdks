 ...
 */
export function eventsUpdateRegistrationType(
  client: CventSDKCore,
  request: operations.UpdateRegistrationTypeRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.RegistrationTypeUpdate,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateRegistrationTypeRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["registration-type-update"], {
    explode: true,
  });
  ...
  const pathParams = {
    ...
    registrationTypeId: encodeSimple(
      "registrationTypeId",
      payload.registrationTypeId,
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/registration-types:write"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RegistrationTypeUpdate$inboundSchema),
