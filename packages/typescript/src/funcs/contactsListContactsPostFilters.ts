 ...
 */
export function contactsListContactsPostFilters(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListContactsPostFiltersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListContactsPostFiltersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/contacts/filter")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListContactsPostFiltersResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      contactsListContactsPostFilters(
        client,
        {
          ...request,
          token: nextCursor,
