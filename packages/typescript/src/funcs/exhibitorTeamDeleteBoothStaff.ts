 ...
 */
export function exhibitorTeamDeleteBoothStaff(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteBoothStaffRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "deleteBoothStaff",
    oAuth2Scopes: ["exhibitor/booth-staff:delete"],
