 ...
 */
export function eventTravelGetHotelRequests(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetHotelRequestsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetHotelRequestsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/event-travel/hotel-requests")(
    pathParams,
  );
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/hotel-request:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHotelRequestsResponse$inboundSchema, {
      key: "Result",
    }),
