 ...
 */
export function eventsListEventVouchers(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListEventVouchersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListEventVouchersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/vouchers")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEventVouchersResponse$inboundSchema, {
      key: "Result",
    }),
