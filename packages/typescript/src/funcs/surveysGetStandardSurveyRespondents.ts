 ...
 */
export function surveysGetStandardSurveyRespondents(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetStandardSurveyRespondentsRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "getStandardSurveyRespondents",
    oAuth2Scopes: ["survey/standard-survey-respondents:read"],
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      surveysGetStandardSurveyRespondents(
        client,
        {
          ...request,
          token: nextCursor,
