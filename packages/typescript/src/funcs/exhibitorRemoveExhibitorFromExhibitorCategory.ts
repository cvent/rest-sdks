 ...
 */
export function exhibitorRemoveExhibitorFromExhibitorCategory(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveExhibitorFromExhibitorCategoryRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["exhibitor/exhibitor-categories:delete"],
