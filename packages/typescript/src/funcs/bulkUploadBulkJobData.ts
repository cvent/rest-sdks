 ...
 */
export function bulkUploadBulkJobData(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UploadBulkJobDataRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["bulk-data"], { explode: true });
  ...
  const path = pathToFunc("/bulk-jobs/{id}/data")(pathParams);
  ...
  >(
    ...
    M.jsonErr(409, errors.ErrorResponse1$inboundSchema),
    M.jsonErr([400, 401, 403, 404, 429], errors.ErrorResponse2$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
