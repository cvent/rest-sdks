 ...
 */
export function travelRFPsListTravelProposalBids(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListTravelProposalBidsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTravelProposalBidsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/travel-proposals/bids")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTravelProposalBidsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      travelRFPsListTravelProposalBids(
        client,
        {
          ...request,
          token: nextCursor,
