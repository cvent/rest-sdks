 ...
 */
export function complianceGetCommunicationLogMessages(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCommunicationLogMessagesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/logs/communications/messages")();
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      complianceGetCommunicationLogMessages(
        client,
        {
          ...request,
          token: nextCursor,
