 ...
 */
export function eventTravelGetAirActualDetail(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetAirActualDetailResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAirActualDetailRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/event-travel/air-actuals")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/air-request:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAirActualDetailResponse$inboundSchema, {
      key: "Result",
    }),
