 ...
 */
export function contactsPatchContactById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PatchContactByIdRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["contact-patch"], { explode: true });
