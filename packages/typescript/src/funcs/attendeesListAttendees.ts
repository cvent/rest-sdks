 ...
 */
export function attendeesListAttendees(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListAttendeesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAttendeesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/attendees")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAttendeesResponse$inboundSchema, {
      key: "Result",
    }),
