 ...
 */
export function seatingGetSeat(
  client: CventSDKCore,
  request: operations.GetSeatRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ExistingSeat,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSeatRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    seatId: encodeSimple("seatId", payload.seatId, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const context = {
    ...
    operationID: "getSeat",
    oAuth2Scopes: ["seating/seats:read"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ExistingSeat$inboundSchema),
