 ...
 */
export function speakersCreateSpeaker(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.Speaker$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/speakers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.ExistingSpeaker$inboundSchema),
