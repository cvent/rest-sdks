 ...
 */
export function badgePrintJobCreateBadgePrintJob(
  client: CventSDKCore,
  request: operations.CreateBadgePrintJobRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.BadgePrintJobCreated,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateBadgePrintJobRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["badge-print-job-created"], {
    explode: true,
  });
  ...
  const context = {
    ...
    oAuth2Scopes: ["remote-printing/badge-print-jobs:write"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.BadgePrintJobCreated$inboundSchema),
