 ...
 */
export function userSCIMCreateUser(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.UserInput$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/scim/v2/Users")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["account/users:write"],
  ...
  >(
    ...
    M.jsonErr([400, 401, 403, 409, 429], errors.ErrorResponse14$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
