 ...
 */
export function exhibitorGetSponsorshipLevel(
  client: CventSDKCore,
  request: operations.GetSponsorshipLevelRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ExistingSponsorshipLevel,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetSponsorshipLevelRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    sponsorshipLevelId: encodeSimple(
      "sponsorshipLevelId",
      payload.sponsorshipLevelId,
  ...
  const context = {
    ...
    operationID: "getSponsorshipLevel",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ExistingSponsorshipLevel$inboundSchema),
