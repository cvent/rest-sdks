 ...
 */
export function eventsListAdmissionItems(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListAdmissionItemsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAdmissionItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/admission-items")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAdmissionItemsResponse$inboundSchema, {
      key: "Result",
    }),
