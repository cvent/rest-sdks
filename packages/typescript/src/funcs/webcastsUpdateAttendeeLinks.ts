 ...
 */
export function webcastsUpdateAttendeeLinks(
  client: CventSDKCore,
  request: operations.UpdateAttendeeLinksRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<components.AttendeeLinkBulkResponseItem>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateAttendeeLinksRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/attendee-links:write"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(207, z.array(components.AttendeeLinkBulkResponseItem$inboundSchema)),
