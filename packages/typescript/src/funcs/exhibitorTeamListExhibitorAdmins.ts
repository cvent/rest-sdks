 ...
 */
export function exhibitorTeamListExhibitorAdmins(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListExhibitorAdminsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListExhibitorAdminsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "listExhibitorAdmins",
    oAuth2Scopes: ["exhibitor/exhibitor-admins:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListExhibitorAdminsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      exhibitorTeamListExhibitorAdmins(
        client,
        {
          ...request,
          token: nextCursor,
