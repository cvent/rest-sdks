 ...
 */
export function travelSuppliersPropertyApiGetPropertyRoom(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PropertyApiGetPropertyRoomRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/travel-suppliers/property-rooms/{roomId}")(
    pathParams,
  );
