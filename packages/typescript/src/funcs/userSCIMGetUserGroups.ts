 ...
 */
export function userSCIMGetUserGroups(
  client: CventSDKCore,
  request: operations.GetUserGroupsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UserGroups1,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetUserGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/scim/v2/Groups")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UserGroups1$inboundSchema),
    M.jsonErr([400, 401, 403, 429], errors.ErrorResponse14$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
