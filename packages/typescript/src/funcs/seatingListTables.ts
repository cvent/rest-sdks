 ...
 */
export function seatingListTables(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListTablesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/seatings/{seatingId}/tables")(
    pathParams,
  );
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTablesResponse$inboundSchema, { key: "Result" }),
