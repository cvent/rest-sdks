 ...
 */
export function transactionsGetTransaction(
  client: CventSDKCore,
  request: operations.GetTransactionRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.TransactionDetailResponse,
...
> {
  ...
  const path = pathToFunc("/transactions/{transactionId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.TransactionDetailResponse$inboundSchema),
