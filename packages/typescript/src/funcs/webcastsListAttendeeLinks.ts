 ...
 */
export function webcastsListAttendeeLinks(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListAttendeeLinksResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAttendeeLinksRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/webcasts/attendee-links")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAttendeeLinksResponse$inboundSchema, {
      key: "Result",
    }),
