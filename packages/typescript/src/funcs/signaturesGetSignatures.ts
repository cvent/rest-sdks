 ...
 */
export function signaturesGetSignatures(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetSignaturesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSignaturesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/signatures")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["onsite/signatures:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSignaturesResponse$inboundSchema, {
      key: "Result",
    }),
