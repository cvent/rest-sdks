...
export function housingGetHousingEventHotels(
  ...
  Result<
    components.HousingEventHotelsList,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHousingEventHotelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/housing-events/{housingEventId}/hotels")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.HousingEventHotelsList$inboundSchema),
