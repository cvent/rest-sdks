 ...
 */
export function eventsGetEventQuestions(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetEventQuestionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetEventQuestionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/event-questions")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEventQuestionsResponse$inboundSchema, {
      key: "Result",
    }),
