 ...
 */
export function eventFeaturesLaunchEventFeatures(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LaunchEventFeaturesRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["event-feature-launch-request"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/events/{id}/features/{type}/launch")(pathParams);
  ...
  const context = {
    ...
    operationID: "launchEventFeatures",
