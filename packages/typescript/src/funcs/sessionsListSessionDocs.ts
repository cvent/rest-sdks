 ...
 */
export function sessionsListSessionDocs(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSessionDocsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSessionDocsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{id}/docs")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSessionDocsResponse$inboundSchema, {
      key: "Result",
    }),
