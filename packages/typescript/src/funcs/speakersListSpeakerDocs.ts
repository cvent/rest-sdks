 ...
 */
export function speakersListSpeakerDocs(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSpeakerDocsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSpeakerDocsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/speakers/{id}/docs")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSpeakerDocsResponse$inboundSchema, {
      key: "Result",
    }),
