 ...
 */
export function campaignsSendEMarketingEmails(
  client: CventSDKCore,
  request?: components.SendEmailRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.SendEmailResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.SendEmailRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/emarketing/emails")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["eMarketing/eMarketing-send-emails:write"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, components.SendEmailResponse$inboundSchema),
