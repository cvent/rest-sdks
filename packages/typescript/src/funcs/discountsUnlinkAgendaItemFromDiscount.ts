 ...
 */
export function discountsUnlinkAgendaItemFromDiscount(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UnlinkAgendaItemFromDiscountRequest$outboundSchema.parse(
        value,
      ),
  ...
  const pathParams = {
    agendaItemId: encodeSimple("agendaItemId", payload.agendaItemId, {
      explode: false,
