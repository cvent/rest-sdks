 ...
 */
export function complianceUpdateConfiguration(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CommunicationConfiguration$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/logs/communications/configuration")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["compliance/communications:write"],
