 ...
 */
export function surveysGetResponses(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetResponsesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetResponsesRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["survey/responses:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetResponsesResponse$inboundSchema, {
      key: "Result",
    }),
