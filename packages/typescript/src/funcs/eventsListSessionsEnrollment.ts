 ...
 */
export function eventsListSessionsEnrollment(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSessionsEnrollmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSessionsEnrollmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/enrollment")();
  ...
  const context = {
    ...
    operationID: "listSessionsEnrollment",
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSessionsEnrollmentResponse$inboundSchema, {
      key: "Result",
    }),
