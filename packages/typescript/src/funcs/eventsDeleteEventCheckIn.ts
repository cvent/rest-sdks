 ...
 */
export function eventsDeleteEventCheckIn(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteEventCheckInRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/check-in/{attendeeId}")(pathParams);
