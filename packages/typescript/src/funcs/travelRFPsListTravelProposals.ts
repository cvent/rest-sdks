 ...
 */
export function travelRFPsListTravelProposals(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListTravelProposalsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListTravelProposalsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/travel-proposals")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTravelProposalsResponse$inboundSchema, {
      key: "Result",
    }),
