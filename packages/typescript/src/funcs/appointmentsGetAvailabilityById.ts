 ...
 */
export function appointmentsGetAvailabilityById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAvailabilityByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/appointment-availability-times/{id}")(pathParams);
