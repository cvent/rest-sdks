 ...
 */
export function contactsRemoveContactFromContactGroup(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RemoveContactFromContactGroupRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/contact-groups/{id}/contacts/{contactId}")(
    pathParams,
  );
