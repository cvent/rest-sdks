 ...
 */
export function budgetGetAccountVendors(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAccountVendorsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/budget-vendors")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["budget/budget-vendors:read"],
