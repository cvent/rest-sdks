 ...
 */
export function meetingRequestListMRF(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListMRFRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/meeting-request-forms")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListMRFResponse$inboundSchema, { key: "Result" }),
