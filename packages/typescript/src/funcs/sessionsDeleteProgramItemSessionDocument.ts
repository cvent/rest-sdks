 ...
 */
export function sessionsDeleteProgramItemSessionDocument(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteProgramItemSessionDocumentRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/program-items:delete"],
