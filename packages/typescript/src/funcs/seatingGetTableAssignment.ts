 ...
 */
export function seatingGetTableAssignment(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetTableAssignmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/seatings/{seatingId}/assignments")(
    pathParams,
  );
