 ...
 */
export function eventsListMembershipItems(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListMembershipItemsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListMembershipItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/membership-items")(pathParams);
  ...
  const context = {
    ...
    operationID: "listMembershipItems",
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListMembershipItemsResponse$inboundSchema, {
      key: "Result",
    }),
