 ...
 */
export function campaignsGetEmailTemplates(
  client: CventSDKCore,
  request: operations.GetEmailTemplatesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.EmailTemplatePaginatedResponse,
...
> {
  ...
  const path = pathToFunc("/emarketing/campaigns/{campaignId}/email-templates")(
    pathParams,
  );
  ...
  const context = {
    ...
    oAuth2Scopes: ["eMarketing/eMarketing-email-templates:read"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.EmailTemplatePaginatedResponse$inboundSchema),
