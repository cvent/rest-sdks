 ...
 */
export function userSCIMGetSchema(
  client: CventSDKCore,
  request: operations.GetSchemaRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UsersSchema,
...
> {
  ...
  const path = pathToFunc("/scim/v2/Schemas/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.UsersSchema$inboundSchema),
