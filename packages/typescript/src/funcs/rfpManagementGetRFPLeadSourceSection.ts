 ...
 */
export function rfpManagementGetRFPLeadSourceSection(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetRfpLeadSourceSectionRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    leadSourceSectionId: encodeSimple(
      "leadSourceSectionId",
      payload.leadSourceSectionId,
