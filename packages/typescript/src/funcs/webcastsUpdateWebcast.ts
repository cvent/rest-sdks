 ...
 */
export function webcastsUpdateWebcast(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateWebcastRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["existing-webcast"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/webcasts/{id}")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/webcasts:write"],
