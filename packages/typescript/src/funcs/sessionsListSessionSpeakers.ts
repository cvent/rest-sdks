 ...
 */
export function sessionsListSessionSpeakers(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSessionSpeakersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSessionSpeakersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{id}/speakers")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSessionSpeakersResponse$inboundSchema, {
      key: "Result",
    }),
