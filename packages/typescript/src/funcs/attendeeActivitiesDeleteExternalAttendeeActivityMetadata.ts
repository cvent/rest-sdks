 ...
 */
export function attendeeActivitiesDeleteExternalAttendeeActivityMetadata(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteExternalAttendeeActivityMetadataRequest$outboundSchema
        .parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/attendee-activities-metadata:delete"],
