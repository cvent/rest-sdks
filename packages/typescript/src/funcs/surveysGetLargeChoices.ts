 ...
 */
export function surveysGetLargeChoices(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetLargeChoicesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLargeChoicesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/large-choices")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["survey/questions:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetLargeChoicesResponse$inboundSchema, {
      key: "Result",
    }),
