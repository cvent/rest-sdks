 ...
 */
export function budgetDeleteCurrencyConversionRate(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteCurrencyConversionRateRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    oAuth2Scopes: ["budget/currency-conversion-rate:delete"],
