 ...
 */
export function audienceSegmentsDisassociateAttendeeFromAudienceSegments(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisassociateAttendeeFromAudienceSegmentsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/attendees/{attendeeId}/audience-segments")(
    pathParams,
  );
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/audience-segments:write"],
