 ...
 */
export function attendeesPostBadge(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostBadgeRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/badges")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["exhibitor/badges:write"],
