...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRoomTypeDetailsRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["housing/housing-event-room-types:read"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.RoomTypeDetails$inboundSchema),
