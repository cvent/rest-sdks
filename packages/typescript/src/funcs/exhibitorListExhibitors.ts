 ...
 */
export function exhibitorListExhibitors(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListExhibitorsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListExhibitorsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListExhibitorsResponse$inboundSchema, {
      key: "Result",
    }),
