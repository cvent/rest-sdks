 ...
 */
export function exhibitorContentDisassociateExhibitorFile(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisassociateExhibitorFileRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "disassociateExhibitorFile",
