 ...
 */
export function surveysGetRespondents(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetRespondentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRespondentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/respondents")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["survey/respondents:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetRespondentsResponse$inboundSchema, {
      key: "Result",
    }),
