 ...
 */
export function eventsUpdateSessionCheckIn(
  client: CventSDKCore,
  request: operations.UpdateSessionCheckInRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<components.AttendeeInvitesBulkResponseItem12>,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateSessionCheckInRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{id}/check-in")(pathParams);
  ...
  const context = {
    ...
    operationID: "updateSessionCheckIn",
  ...
  >(
    M.json(
      207,
      z.array(components.AttendeeInvitesBulkResponseItem12$inboundSchema),
    ),
