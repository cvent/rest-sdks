 ...
 */
export function contactsUpdateContactById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateContactByIdRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["contact-update"], { explode: true });
