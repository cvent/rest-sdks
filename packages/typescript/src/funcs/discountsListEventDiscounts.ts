 ...
 */
export function discountsListEventDiscounts(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListEventDiscountsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListEventDiscountsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/discounts")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListEventDiscountsResponse$inboundSchema, {
      key: "Result",
    }),
