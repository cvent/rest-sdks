 ...
 */
export function usersDeleteAccountUserGroup(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteAccountUserGroupRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/account-user-groups/{userGroupId}")(pathParams);
  ...
  const context = {
    ...
    operationID: "deleteAccountUserGroup",
