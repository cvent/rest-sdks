 ...
 */
export function discountsCreateEventDiscount(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateEventDiscountRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.CreateUpdateDiscountResponse$inboundSchema),
