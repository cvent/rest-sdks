 ...
 */
export function budgetGetPayments(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetPaymentsResponse,
...
> {
  ...
  const path = pathToFunc("/events/{id}/budget-payments")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["budget/payments:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPaymentsResponse$inboundSchema, {
      key: "Result",
    }),
