 ...
 */
export function speakersListSpeakerSessions(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSpeakerSessionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSpeakerSessionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/speakers/{id}/sessions")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSpeakerSessionsResponse$inboundSchema, {
      key: "Result",
    }),
