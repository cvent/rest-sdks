 ...
 */
export function budgetGetCardTransactions(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetCardTransactionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetCardTransactionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/cards/transactions")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["budget/transactions:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCardTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
