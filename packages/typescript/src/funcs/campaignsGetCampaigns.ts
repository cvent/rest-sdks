 ...
 */
export function campaignsGetCampaigns(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetCampaignsResponse,
...
> {
  ...
  const path = pathToFunc("/campaigns")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["eMarketing/campaigns:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCampaignsResponse$inboundSchema, {
      key: "Result",
    }),
