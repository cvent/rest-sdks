 ...
 */
export function sessionsUpdateSession(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateSessionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["session-update"], { explode: true });
