 ...
 */
export function audienceSegmentsCreateAudienceSegment(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.AudienceSegmentCreate$outboundSchema.parse(value),
  ...
  >(
    ...
    M.jsonErr([401, 403, 422, 429], errors.ErrorResponse1$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
