 ...
 */
export function attendeeInsightsGetScores(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetScoresRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/attendee-insights/{id}/scores")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["attendee-insights/scores:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScoresResponse$inboundSchema, { key: "Result" }),
