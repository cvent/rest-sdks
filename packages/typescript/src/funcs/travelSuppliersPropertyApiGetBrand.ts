 ...
 */
export function travelSuppliersPropertyApiGetBrand(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PropertyApiGetBrandRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    brandId: encodeSimple("brandId", payload.brandId, {
      explode: false,
      charEncoding: "percent",
    }),
  };

  const path = pathToFunc("/travel-suppliers/brands/{brandId}")(pathParams);
