 ...
 */
export function travelSuppliersPropertyApiGetChain(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PropertyApiGetChainRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/travel-suppliers/chains/{chainId}")(pathParams);
