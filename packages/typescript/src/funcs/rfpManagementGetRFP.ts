 ...
 */
export function rfpManagementGetRFP(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetRFPRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rfps/{rfpId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Rfp$inboundSchema),
