 ...
 */
export function customFieldsCreateCustomFieldTranslation(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateCustomFieldTranslationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.Translation1$inboundSchema),
