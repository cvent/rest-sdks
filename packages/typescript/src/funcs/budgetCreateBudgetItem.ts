 ...
 */
export function budgetCreateBudgetItem(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateBudgetItemRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/budget-items")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.BudgetItemResponse$inboundSchema),
