 ...
 */
export function seatingListSeating(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSeatingResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSeatingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/seatings")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSeatingResponse$inboundSchema, {
      key: "Result",
    }),
