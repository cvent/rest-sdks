 ...
 */
export function audienceSegmentsGetAudienceSegmentById(
  client: CventSDKCore,
  request: operations.GetAudienceSegmentByIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AudienceSegmentResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAudienceSegmentByIdRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AudienceSegmentResponse$inboundSchema),
