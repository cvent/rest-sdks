 ...
 */
export function exhibitorCreateExhibitor(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateExhibitorRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/exhibitors")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.ExhibitorResponse$inboundSchema),
