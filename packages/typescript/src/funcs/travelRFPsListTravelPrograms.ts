 ...
 */
export function travelRFPsListTravelPrograms(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListTravelProgramsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListTravelProgramsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/travel-programs")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListTravelProgramsResponse$inboundSchema, {
      key: "Result",
    }),
