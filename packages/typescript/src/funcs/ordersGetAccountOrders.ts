 ...
 */
export function ordersGetAccountOrders(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetAccountOrdersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAccountOrdersRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAccountOrdersResponse$inboundSchema, {
      key: "Result",
    }),
