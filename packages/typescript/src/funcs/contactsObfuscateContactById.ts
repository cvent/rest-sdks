 ...
 */
export function contactsObfuscateContactById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ObfuscateContactByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/contacts/{id}/obfuscate")(pathParams);
  ...
  const context = {
    ...
    operationID: "obfuscateContactById",
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(202, operations.ObfuscateContactByIdResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.jsonErr([401, 403, 404, 409, 429], errors.ErrorResponse12$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
