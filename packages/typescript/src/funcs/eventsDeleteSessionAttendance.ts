 ...
 */
export function eventsDeleteSessionAttendance(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteSessionAttendanceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{id}/attendance/{attendeeId}")(pathParams);
  ...
  const context = {
    ...
    operationID: "deleteSessionAttendance",
    oAuth2Scopes: ["event/session-attendance:write"],
