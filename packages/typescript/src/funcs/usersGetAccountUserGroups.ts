 ...
 */
export function usersGetAccountUserGroups(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetAccountUserGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAccountUserGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/account-user-groups")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["account/user-groups:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAccountUserGroupsResponse$inboundSchema, {
      key: "Result",
    }),
