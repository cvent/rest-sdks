 ...
 */
export function contactsCreateContactGroup(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.ContactGroupInput$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.ContactGroup$inboundSchema),
