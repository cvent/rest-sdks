 ...
 */
export function usersDeleteUserFromAccountUserGroup(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteUserFromAccountUserGroupRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/account-user-groups/{userGroupId}/users/{userId}")(
    pathParams,
  );
  ...
  const context = {
    ...
    operationID: "deleteUserFromAccountUserGroup",
    oAuth2Scopes: ["account/user-groups:delete"],
