 ...
 */
export function sessionsListSessionsCategories(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListSessionsCategoriesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSessionsCategoriesRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/session-categories:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSessionsCategoriesResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      sessionsListSessionsCategories(
        client,
        {
          ...request,
          token: nextCursor,
