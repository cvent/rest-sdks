 ...
 */
export function eventsDeleteSessionEnrollment(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteSessionEnrollmentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/sessions/{id}/enrollment/{attendeeId}")(pathParams);
  ...
  const context = {
    ...
    operationID: "deleteSessionEnrollment",
    oAuth2Scopes: ["event/session-enrollment:delete"],
