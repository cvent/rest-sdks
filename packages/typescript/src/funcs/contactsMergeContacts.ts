 ...
 */
export function contactsMergeContacts(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MergeContactsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["contact-merge"], { explode: true });
  ...
  const path = pathToFunc("/contacts/{id}/merge")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/contacts:write", "event/contacts:write-sensitive"],
