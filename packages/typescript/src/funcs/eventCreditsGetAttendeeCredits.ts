 ...
 */
export function eventCreditsGetAttendeeCredits(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAttendeeCreditsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/attendee-credits")();
  ...
  const context = {
    ...
    operationID: "getAttendeeCredits",
    oAuth2Scopes: ["event/attendee-credits:read"],
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      eventCreditsGetAttendeeCredits(
        client,
        {
          ...request,
          token: nextCursor,
