 ...
 */
export function surveysGetQuestions(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetQuestionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetQuestionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/questions")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetQuestionsResponse$inboundSchema, {
      key: "Result",
    }),
