 ...
 */
export function emailsGetEmailsHistory(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetEmailsHistoryResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetEmailsHistoryRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["email/emails:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetEmailsHistoryResponse$inboundSchema, {
      key: "Result",
    }),
