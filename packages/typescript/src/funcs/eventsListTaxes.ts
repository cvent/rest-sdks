 ...
 */
export function eventsListTaxes(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListTaxesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/events/{id}/taxes")(pathParams);
