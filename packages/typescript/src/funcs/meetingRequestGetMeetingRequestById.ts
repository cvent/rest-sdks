 ...
 */
export function meetingRequestGetMeetingRequestById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMeetingRequestByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/meeting-request-forms/{id}/requests/{requestId}")(
    pathParams,
  );
