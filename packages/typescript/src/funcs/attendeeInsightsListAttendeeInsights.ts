 ...
 */
export function attendeeInsightsListAttendeeInsights(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAttendeeInsightsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/attendee-insights")();
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      attendeeInsightsListAttendeeInsights(
        client,
        {
          ...request,
          token: nextCursor,
