 ...
 */
export function eventsSendEventEmails(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.SendEmailEventRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/events/emails")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/event-emails:write"],
