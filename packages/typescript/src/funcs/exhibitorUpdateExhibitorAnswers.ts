 ...
 */
export function exhibitorUpdateExhibitorAnswers(
  client: CventSDKCore,
  request: operations.UpdateExhibitorAnswersRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ExhibitorAnswersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateExhibitorAnswersRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload["exhibitor-answers-request"], {
    explode: true,
  });
  ...
  const context = {
    ...
    oAuth2Scopes: ["exhibitor/exhibitor-answers:write"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ExhibitorAnswersResponse$inboundSchema),
