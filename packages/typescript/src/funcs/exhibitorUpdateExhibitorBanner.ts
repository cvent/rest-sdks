 ...
 */
export function exhibitorUpdateExhibitorBanner(
  client: CventSDKCore,
  request: operations.UpdateExhibitorBannerRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.ExhibitorBannerLogoFile,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateExhibitorBannerRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ExhibitorBannerLogoFile$inboundSchema),
