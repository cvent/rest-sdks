 ...
 */
export function webcastsListPlayers(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListPlayersResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPlayersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/webcasts/players")();
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/players:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPlayersResponse$inboundSchema, {
      key: "Result",
    }),
