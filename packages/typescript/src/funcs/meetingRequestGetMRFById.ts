 ...
 */
export function meetingRequestGetMRFById(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMRFByIdRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/meeting-request-forms/{id}")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/meeting-request-forms:read"],
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["401", "403", "404", "422", "429", "4XX", "5XX"],
