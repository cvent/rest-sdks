 ...
 */
export function meetingRequestUpdateMeetingRequest(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateMeetingRequestRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    "skipRequiredQuestionValidation": payload.skipRequiredQuestionValidation,
  });
  ...
  const context = {
    ...
    oAuth2Scopes: ["event/meeting-requests:write"],
