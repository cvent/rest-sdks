...
> {
  ...
  const headers = new Headers(compactMap({
    ...
    "Cvent-Access-Code": encodeSimple(
      "Cvent-Access-Code",
      payload["Cvent-Access-Code"],
  ...
  const context = {
    ...
    oAuth2Scopes: ["housing/connections:write"],
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ConnectionResponse$inboundSchema),
