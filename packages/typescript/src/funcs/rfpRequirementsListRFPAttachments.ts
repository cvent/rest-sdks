 ...
 */
export function rfpRequirementsListRFPAttachments(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListRfpAttachmentsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListRfpAttachmentsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rfps/{rfpId}/attachments")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["rfp/rfp-attachments:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListRfpAttachmentsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      rfpRequirementsListRFPAttachments(
        client,
        {
          ...request,
          token: nextCursor,
