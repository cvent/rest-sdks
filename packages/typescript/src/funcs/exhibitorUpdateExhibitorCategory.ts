 ...
 */
export function exhibitorUpdateExhibitorCategory(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateExhibitorCategoryRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    exhibitorCategoryId: encodeSimple(
      "exhibitorCategoryId",
      payload.exhibitorCategoryId,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ExhibitorCategoryResponse$inboundSchema),
