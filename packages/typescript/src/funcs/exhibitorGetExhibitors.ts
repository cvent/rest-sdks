 ...
 */
export function exhibitorGetExhibitors(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetExhibitorsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetExhibitorsRequest$outboundSchema.parse(value),
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetExhibitorsResponse$inboundSchema, {
      key: "Result",
    }),
