 ...
 */
export function customFieldsUpdateCustomField(
  client: CventSDKCore,
...
> {
  ...
  const body = encodeJSON("body", payload["existing-custom-field"], {
    explode: true,
  });
  ...
  const path = pathToFunc("/custom-fields/{customFieldId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.ExistingCustomField$inboundSchema),
