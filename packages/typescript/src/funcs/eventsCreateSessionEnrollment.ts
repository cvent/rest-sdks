 ...
 */
export function eventsCreateSessionEnrollment(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateSessionEnrollmentRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "createSessionEnrollment",
    oAuth2Scopes: ["event/session-enrollment:write"],
