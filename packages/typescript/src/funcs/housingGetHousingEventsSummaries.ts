...
export function housingGetHousingEventsSummaries(
  ...
  Result<
    components.HousingEventSummaryList,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetHousingEventsSummariesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/housing-events/summaries")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.HousingEventSummaryList$inboundSchema),
