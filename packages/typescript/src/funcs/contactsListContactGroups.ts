 ...
 */
export function contactsListContactGroups(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListContactGroupsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListContactGroupsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/contact-groups")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListContactGroupsResponse$inboundSchema, {
      key: "Result",
    }),
