 ...
 */
export function exhibitorContentUpdateExhibitorFile(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateExhibitorFileRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.file, { explode: true });
  ...
  const context = {
    ...
    operationID: "updateExhibitorFile",
