 ...
 */
export function appointmentsListLocations(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListLocationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/appointment-events/{id}/locations")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["appointments/locations:read"],
