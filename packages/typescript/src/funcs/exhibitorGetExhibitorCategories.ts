 ...
 */
export function exhibitorGetExhibitorCategories(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.GetExhibitorCategoriesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetExhibitorCategoriesRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    oAuth2Scopes: ["exhibitor/exhibitor-categories:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetExhibitorCategoriesResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      exhibitorGetExhibitorCategories(
        client,
        {
          ...request,
          token: nextCursor,
