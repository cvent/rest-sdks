 ...
 */
export function bulkListBulkJobResult(
  client: CventSDKCore,
  ...
  PageIterator<
    Result<
      operations.ListBulkJobResultResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListBulkJobResultRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/bulk-jobs/{id}/results")(pathParams);
  ...
  const context = {
    ...
    oAuth2Scopes: ["bulk/bulk-jobs:read"],
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListBulkJobResultResponse$inboundSchema, {
      key: "Result",
    }),
