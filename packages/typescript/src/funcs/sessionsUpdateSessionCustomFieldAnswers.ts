 ...
 */
export function sessionsUpdateSessionCustomFieldAnswers(
  client: CventSDKCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateSessionCustomFieldAnswersRequest$outboundSchema.parse(
        value,
      ),
  ...
  const context = {
    ...
    operationID: "updateSessionCustomFieldAnswers",
