...
public class GetEventSurveyResponsesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetEventSurveyResponsesRequest request;
    private final Options.Builder optionsBuilder;

    public GetEventSurveyResponsesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetEventSurveyResponsesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetEventSurveyResponsesRequestBuilder request(@Nonnull GetEventSurveyResponsesRequest request) {
     ...
     * <pre><code>
     * Publisher&lt;GetEventSurveyResponsesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetEventSurveyResponsesResponse&gt;() {
