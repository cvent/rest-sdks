...
public enum AttendeeResponseMethod {
    ...
    AttendeeResponseMethod(String value) {
        this.value = value;
    }
    ...
    public static Optional<AttendeeResponseMethod> fromValue(String value) {
        for (AttendeeResponseMethod o : AttendeeResponseMethod.values()) {
