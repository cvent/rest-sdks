...
public class DonationItem1 {
     ...
     * This text will be displayed in emails using the registration information widget.
     */
    public DonationItem1 withRegistrantInformation(@Nullable String registrantInformation) {
        this.registrantInformation = registrantInformation;
        return this;
    }
     ...
     * A unique identifier of the donation item.
     */
    public DonationItem1 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Title of the donation item.
     */
    public DonationItem1 withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Description of the donation item.
     */
    public DonationItem1 withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * A planner-specified code for the donation item. By default, it matches the title.
     */
    public DonationItem1 withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * currency.
     */
    public DonationItem1 withMinimumAmountAllowedPerInvitee(@Nullable Double minimumAmountAllowedPerInvitee) {
        this.minimumAmountAllowedPerInvitee = minimumAmountAllowedPerInvitee;
        return this;
    }
     ...
     * currency.
     */
    public DonationItem1 withMaximumAmountAllowedPerInvitee(@Nullable Double maximumAmountAllowedPerInvitee) {
        this.maximumAmountAllowedPerInvitee = maximumAmountAllowedPerInvitee;
        return this;
    }
     ...
     * Contains unique identifiers for registration types associated with this donation item.
     */
    public DonationItem1 withRegistrationTypes(@Nullable List<String> registrationTypes) {
        this.registrationTypes = registrationTypes;
        return this;
    }
     ...
     * True indicates the donation item is selectable during registration.
     */
    public DonationItem1 withOpenForRegistration(@Nullable Boolean openForRegistration) {
        this.openForRegistration = openForRegistration;
        return this;
    }
     ...
     * closes at the start (12 AM) of the chosen date, according to UTC timezone.
     */
    public DonationItem1 withAutomaticallyClosesOn(@Nullable LocalDate automaticallyClosesOn) {
        this.automaticallyClosesOn = automaticallyClosesOn;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DonationItem1 other = (DonationItem1) o;
    ...
    public static final class Builder {
        ...
        public DonationItem1 build() {
            return new DonationItem1(
                    registrantInformation,
                    id,
                    name,
                    description,
