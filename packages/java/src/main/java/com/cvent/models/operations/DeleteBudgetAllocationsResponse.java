...
public class DeleteBudgetAllocationsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public DeleteBudgetAllocationsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public DeleteBudgetAllocationsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteBudgetAllocationsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
