...
public class ListContactsRequestBuilder {
     ...
     */
    public ListContactsResponse call() {
     ...
     * <pre><code>
     * for (ListContactsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListContactsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListContactsResponse> callAsStream() {
