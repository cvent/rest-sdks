...
public class AnswerEventCustomFieldResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AnswerEventCustomFieldResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
