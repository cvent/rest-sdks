...
public class GetEventSurveyResponsesRequestBuilder {
     ...
     */
    public GetEventSurveyResponsesResponse call() {
     ...
     * <pre><code>
     * for (GetEventSurveyResponsesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEventSurveyResponsesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEventSurveyResponsesResponse> callAsStream() {
