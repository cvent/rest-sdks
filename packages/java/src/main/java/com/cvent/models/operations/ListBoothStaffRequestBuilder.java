...
public class ListBoothStaffRequestBuilder {
     ...
     */
    public ListBoothStaffResponse call() {
     ...
     * <pre><code>
     * for (ListBoothStaffResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListBoothStaffResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListBoothStaffResponse> callAsStream() {
