...
public class GetTransactionsRequestBuilder {
     ...
     * <pre><code>
     * for (GetTransactionsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetTransactionsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetTransactionsResponse> callAsStream() {
