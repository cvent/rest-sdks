...
public class ListTravelAccountsResponse implements AsyncResponse {
    /**
     ...
     * Successfully retrieved a paginated list of travel accounts.
     */
    public Optional<TravelAccountPaginatedResponse> travelAccountPaginatedResponse() {
        return Optional.ofNullable(this.travelAccountPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public ListTravelAccountsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListTravelAccountsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListTravelAccountsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
