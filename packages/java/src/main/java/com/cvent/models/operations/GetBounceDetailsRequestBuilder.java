...
public class GetBounceDetailsRequestBuilder {
     ...
     */
    public GetBounceDetailsResponse call() {
     ...
     * <pre><code>
     * for (GetBounceDetailsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetBounceDetailsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetBounceDetailsResponse> callAsStream() {
