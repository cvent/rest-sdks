...
public class GetSessionLocationRequestBuilder {
     ...
     */
    public GetSessionLocationResponse call() {
     ...
     * <pre><code>
     * for (GetSessionLocationResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetSessionLocationResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetSessionLocationResponse> callAsStream() {
