...
public class ListSpeakersRequestBuilder {
     ...
     */
    public ListSpeakersResponse call() {
     ...
     * <pre><code>
     * for (ListSpeakersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSpeakersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSpeakersResponse> callAsStream() {
