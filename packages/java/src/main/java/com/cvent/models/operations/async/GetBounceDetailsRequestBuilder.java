...
public class GetBounceDetailsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetBounceDetailsRequest request;
    private final Options.Builder optionsBuilder;

    public GetBounceDetailsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetBounceDetailsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetBounceDetailsRequestBuilder request(@Nonnull GetBounceDetailsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetBounceDetailsRequest _buildRequest() {
        return this.request;
    }

    public GetBounceDetailsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetBounceDetailsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetBounceDetailsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetBounceDetailsResponse&gt;() {
     ...
     */
    public Publisher<GetBounceDetailsResponse> callAsPublisher() {
        GetBounceDetailsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetBounceDetailsRequest, GetBounceDetailsResponse> operation =
                new GetBounceDetails.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetBounceDetailsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
