...
public class ImageLink {
    ...
    @JsonCreator
    public ImageLink(@JsonProperty("href") @Nonnull String href) {
     ...
     * A url provided that can be followed for linking
     */
    public ImageLink withHref(@Nonnull String href) {
    ...
    public String toString() {
        return Utils.toString(ImageLink.class, "href", href);
    }
