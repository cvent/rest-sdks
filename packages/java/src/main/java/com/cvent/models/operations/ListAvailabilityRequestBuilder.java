...
public class ListAvailabilityRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListAvailabilityRequest request;
    private final Options.Builder optionsBuilder;

    public ListAvailabilityRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListAvailabilityRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListAvailabilityRequestBuilder request(@Nonnull ListAvailabilityRequest request) {
     ...
     */
    public ListAvailabilityResponse call() {
     ...
     * <pre><code>
     * for (ListAvailabilityResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAvailabilityResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAvailabilityResponse> callAsStream() {
