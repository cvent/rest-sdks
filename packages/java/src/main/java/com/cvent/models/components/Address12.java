...
public class Address12 {
     ...
     * The first line of an address
     */
    public Address12 withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address
     */
    public Address12 withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The name of the city.
     */
    public Address12 withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public Address12 withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public Address12 withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * postal code (also known as zipcode) of the address
     */
    public Address12 withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * Name of the country for example, 'United States'
     */
    public Address12 withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code
     */
    public Address12 withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public Address12 build() {
            return new Address12(address1, address2, city, region, regionCode, postalCode, country, countryCode);
        }
    }
}
