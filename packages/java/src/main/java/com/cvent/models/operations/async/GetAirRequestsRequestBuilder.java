...
public class GetAirRequestsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetAirRequestsRequest request;
    private final Options.Builder optionsBuilder;

    public GetAirRequestsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetAirRequestsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetAirRequestsRequestBuilder request(@Nonnull GetAirRequestsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAirRequestsRequest _buildRequest() {
        return this.request;
    }

    public GetAirRequestsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetAirRequestsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetAirRequestsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetAirRequestsResponse&gt;() {
     ...
     */
    public Publisher<GetAirRequestsResponse> callAsPublisher() {
        GetAirRequestsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetAirRequestsRequest, GetAirRequestsResponse> operation =
                new GetAirRequests.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetAirRequestsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
