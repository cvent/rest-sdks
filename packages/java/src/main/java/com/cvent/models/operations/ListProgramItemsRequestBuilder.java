...
public class ListProgramItemsRequestBuilder {
     ...
     */
    public ListProgramItemsResponse call() {
     ...
     * <pre><code>
     * for (ListProgramItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListProgramItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListProgramItemsResponse> callAsStream() {
