...
public class GetStandardSurveyRespondentsRequestBuilder {
     ...
     */
    public GetStandardSurveyRespondentsResponse call() {
     ...
     * <pre><code>
     * for (GetStandardSurveyRespondentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetStandardSurveyRespondentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetStandardSurveyRespondentsResponse> callAsStream() {
