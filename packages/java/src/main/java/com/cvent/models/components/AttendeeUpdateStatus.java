...
public enum AttendeeUpdateStatus {
    ...
    AttendeeUpdateStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<AttendeeUpdateStatus> fromValue(String value) {
        for (AttendeeUpdateStatus o : AttendeeUpdateStatus.values()) {
