...
public class PagingJson1 {
    ...
    public PagingJson1(@Nonnull PaginationLinksJson links) {
     ...
     * additional data to fetch
     */
    public PagingJson1 withNextToken(@Nullable String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
     ...
     * The pagination token for the current page
     */
    public PagingJson1 withCurrentToken(@Nullable String currentToken) {
        this.currentToken = currentToken;
        return this;
    }
     ...
     * The number of records to return on the page not to exceed 200
     */
    public PagingJson1 withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The total number of records available
     */
    public PagingJson1 withTotalCount(@Nullable Long totalCount) {
        this.totalCount = totalCount;
        return this;
    }
     ...
     * Represents pagination links for navigating between pages of data.
     */
    public PagingJson1 withLinks(@Nonnull PaginationLinksJson links) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PagingJson1 other = (PagingJson1) o;
    ...
    public static final class Builder {
        ...
        public PagingJson1 build() {
            return new PagingJson1(nextToken, currentToken, limit, totalCount, links);
        }
    }
}
