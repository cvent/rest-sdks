...
public class ListEventVoucherAttendeesRequestBuilder {
     ...
     */
    public ListEventVoucherAttendeesResponse call() {
     ...
     * <pre><code>
     * for (ListEventVoucherAttendeesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventVoucherAttendeesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventVoucherAttendeesResponse> callAsStream() {
