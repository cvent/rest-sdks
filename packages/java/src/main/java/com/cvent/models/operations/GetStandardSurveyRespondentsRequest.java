...
public class GetStandardSurveyRespondentsRequest {
     ...
     * Id of a survey or Id of a chapter in event survey
     */
    public GetStandardSurveyRespondentsRequest withSurveyId(@Nonnull String surveyId) {
     ...
     * beginning of time of the data store.
     */
    public GetStandardSurveyRespondentsRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public GetStandardSurveyRespondentsRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public GetStandardSurveyRespondentsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetStandardSurveyRespondentsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * id (eq|ne)
     */
    public GetStandardSurveyRespondentsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
