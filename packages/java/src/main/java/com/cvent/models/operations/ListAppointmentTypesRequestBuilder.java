...
public class ListAppointmentTypesRequestBuilder {
     ...
     */
    public ListAppointmentTypesResponse call() {
     ...
     * <pre><code>
     * for (ListAppointmentTypesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAppointmentTypesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAppointmentTypesResponse> callAsStream() {
