...
public class UsersSchema {
     ...
     * The unique identifier of the schema.
     */
    public UsersSchema withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The name of the schema.
     */
    public UsersSchema withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * The description of the schema.
     */
    public UsersSchema withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
