...
public enum CustomFieldJsonCustomFieldType {
    ...
    CustomFieldJsonCustomFieldType(String value) {
        this.value = value;
    }
    ...
    public static Optional<CustomFieldJsonCustomFieldType> fromValue(String value) {
        for (CustomFieldJsonCustomFieldType o : CustomFieldJsonCustomFieldType.values()) {
