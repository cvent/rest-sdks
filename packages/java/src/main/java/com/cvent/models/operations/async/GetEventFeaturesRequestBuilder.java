...
public class GetEventFeaturesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetEventFeaturesRequest request;
    private final Options.Builder optionsBuilder;

    public GetEventFeaturesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetEventFeaturesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetEventFeaturesRequestBuilder request(@Nonnull GetEventFeaturesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetEventFeaturesRequest _buildRequest() {
        return this.request;
    }

    public GetEventFeaturesRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetEventFeaturesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetEventFeaturesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetEventFeaturesResponse&gt;() {
     ...
     */
    public Publisher<GetEventFeaturesResponse> callAsPublisher() {
        GetEventFeaturesRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetEventFeaturesRequest, GetEventFeaturesResponse> operation =
                new GetEventFeatures.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetEventFeaturesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
