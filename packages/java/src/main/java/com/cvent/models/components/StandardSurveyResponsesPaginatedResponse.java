...
public class StandardSurveyResponsesPaginatedResponse {
     ...
     * Response for a survey
     */
    public List<StandardSurveyResponse> data() {
        return this.data;
    }
     ...
     * Represents pagination information for a collection of resources.
     */
    public StandardSurveyResponsesPaginatedResponse withPaging(@Nonnull PagingJson paging) {
     ...
     * Response for a survey
     */
    public StandardSurveyResponsesPaginatedResponse withData(@Nonnull List<StandardSurveyResponse> data) {
    ...
    public static final class Builder {
         ...
         * Response for a survey
         */
        public Builder data(@Nonnull List<StandardSurveyResponse> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
