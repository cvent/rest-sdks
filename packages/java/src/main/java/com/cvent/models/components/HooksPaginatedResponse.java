 ...
 */
public class HooksPaginatedResponse {
    /**
     ...
     * Represents pagination information for a collection of resources.
     */
    public HooksPaginatedResponse withPaging(@Nonnull PagingJson paging) {
     ...
     * Collection of contact hooks.
     */
    public HooksPaginatedResponse withData(@Nonnull List<HookOutput> data) {
    ...
    public static final class Builder {
         ...
         * Collection of contact hooks.
         */
        public Builder data(@Nonnull List<HookOutput> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
