...
public class SurveyJson {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("events")
    private List<EventJson4> events;
    ...
    public SurveyJson(
            ...
            @JsonProperty("events") @Nullable List<EventJson4> events) {
     ...
     * List of events with which this survey is linked.
     */
    public Optional<List<EventJson4>> events() {
     ...
     * List of events with which this survey is linked.
     */
    public SurveyJson withEvents(@Nullable List<EventJson4> events) {
        this.events = events;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * List of events with which this survey is linked.
         */
        public Builder events(@Nullable List<EventJson4> events) {
            this.events = events;
            return this;
        }
