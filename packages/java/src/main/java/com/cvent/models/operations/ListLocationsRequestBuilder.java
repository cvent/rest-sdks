...
public class ListLocationsRequestBuilder {
    ...
    public ListLocationsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public ListLocationsResponse call() {
     ...
     * <pre><code>
     * for (ListLocationsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListLocationsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListLocationsResponse> callAsStream() {
