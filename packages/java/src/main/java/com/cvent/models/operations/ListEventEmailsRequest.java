...
public class ListEventEmailsRequest {
     ...
     * Unique ID of an event
     */
    public ListEventEmailsRequest withId(@Nonnull String id) {
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public ListEventEmailsRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * beginning of time of the data store.
     */
    public ListEventEmailsRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public ListEventEmailsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListEventEmailsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * invitationList.id (eq|ne)
     */
    public ListEventEmailsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
