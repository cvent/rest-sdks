...
public class PagingJson19 {
    ...
    public PagingJson19(@Nonnull PaginationLinksJson links) {
     ...
     * additional data to fetch
     */
    public PagingJson19 withNextToken(@Nullable String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
     ...
     * The pagination token for the current page
     */
    public PagingJson19 withCurrentToken(@Nullable String currentToken) {
        this.currentToken = currentToken;
        return this;
    }
     ...
     * The number of records to return on the page not to exceed 200
     */
    public PagingJson19 withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The total number of records available
     */
    public PagingJson19 withTotalCount(@Nullable Long totalCount) {
        this.totalCount = totalCount;
        return this;
    }
     ...
     * Represents pagination links for navigating between pages of data.
     */
    public PagingJson19 withLinks(@Nonnull PaginationLinksJson links) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PagingJson19 other = (PagingJson19) o;
    ...
    public static final class Builder {
        ...
        public PagingJson19 build() {
            return new PagingJson19(nextToken, currentToken, limit, totalCount, links);
        }
    }
}
