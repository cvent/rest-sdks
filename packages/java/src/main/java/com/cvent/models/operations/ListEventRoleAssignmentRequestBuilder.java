...
public class ListEventRoleAssignmentRequestBuilder {
     ...
     */
    public ListEventRoleAssignmentResponse call() {
     ...
     * <pre><code>
     * for (ListEventRoleAssignmentResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventRoleAssignmentResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventRoleAssignmentResponse> callAsStream() {
