...
public class ListExhibitorAdminsRequestBuilder {
     ...
     */
    public ListExhibitorAdminsResponse call() {
     ...
     * <pre><code>
     * for (ListExhibitorAdminsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListExhibitorAdminsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListExhibitorAdminsResponse> callAsStream() {
