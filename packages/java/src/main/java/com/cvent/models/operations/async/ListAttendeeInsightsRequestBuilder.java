...
public class ListAttendeeInsightsRequestBuilder {
    ...
    public ListAttendeeInsightsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public CompletableFuture<ListAttendeeInsightsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListAttendeeInsightsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListAttendeeInsightsResponse&gt;() {
     ...
     */
    public Publisher<ListAttendeeInsightsResponse> callAsPublisher() {
        ...
        Flow.Publisher<ListAttendeeInsightsResponse> flowPublisher =
