...
public class ListSeatingRequestBuilder {
     ...
     */
    public ListSeatingResponse call() {
     ...
     * <pre><code>
     * for (ListSeatingResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSeatingResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSeatingResponse> callAsStream() {
