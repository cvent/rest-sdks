...
public class GetAccountUserGroupResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAccountUserGroupResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
