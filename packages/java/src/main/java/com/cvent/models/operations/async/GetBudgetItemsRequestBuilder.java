...
public class GetBudgetItemsRequestBuilder {
    ...
    public GetBudgetItemsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public CompletableFuture<GetBudgetItemsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetBudgetItemsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetBudgetItemsResponse&gt;() {
     ...
     */
    public Publisher<GetBudgetItemsResponse> callAsPublisher() {
        ...
        Flow.Publisher<GetBudgetItemsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
