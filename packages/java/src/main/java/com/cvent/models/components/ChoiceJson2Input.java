...
public class ChoiceJson2Input {
    ...
    @JsonCreator
    public ChoiceJson2Input(@JsonProperty("text") @Nonnull String text) {
     ...
     * The text for the custom field choice.
     */
    public ChoiceJson2Input withText(@Nonnull String text) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChoiceJson2Input other = (ChoiceJson2Input) o;
    ...
    public String toString() {
        return Utils.toString(ChoiceJson2Input.class, "text", text);
    }
    ...
    public static final class Builder {
        ...
        public ChoiceJson2Input build() {
            return new ChoiceJson2Input(text);
        }
    }
}
