 ...
 */
public class VenueAddress1Input {
    /**
     ...
     * The first line of an address.
     */
    public VenueAddress1Input withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public VenueAddress1Input withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public VenueAddress1Input withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public VenueAddress1Input withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public VenueAddress1Input withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public VenueAddress1Input withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public VenueAddress1Input withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VenueAddress1Input other = (VenueAddress1Input) o;
    ...
    public static final class Builder {
        ...
        public VenueAddress1Input build() {
            return new VenueAddress1Input(address1, address2, address3, city, countryCode, postalCode, regionCode);
        }
    }
}
