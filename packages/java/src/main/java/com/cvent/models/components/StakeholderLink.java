...
public class StakeholderLink {
    ...
    @JsonCreator
    public StakeholderLink(@JsonProperty("href") @Nonnull String href) {
     ...
     * The url of the contact's profile picture
     */
    public StakeholderLink withHref(@Nonnull String href) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StakeholderLink other = (StakeholderLink) o;
    ...
    public String toString() {
        return Utils.toString(StakeholderLink.class, "href", href);
    }
    ...
    public static final class Builder {
        ...
        public StakeholderLink build() {
            return new StakeholderLink(href);
        }
    }
}
