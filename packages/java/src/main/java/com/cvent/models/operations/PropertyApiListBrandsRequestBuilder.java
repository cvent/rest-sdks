...
public class PropertyApiListBrandsRequestBuilder {
     ...
     */
    public PropertyApiListBrandsResponse call() {
     ...
     * <pre><code>
     * for (PropertyApiListBrandsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<PropertyApiListBrandsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<PropertyApiListBrandsResponse> callAsStream() {
