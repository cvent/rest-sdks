...
public class FieldJson3 {
     ...
     * Text field ID.
     */
    public FieldJson3 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * text Value of the Field
     */
    public FieldJson3 withText(@Nullable String text) {
        this.text = text;
        return this;
    }
     ...
     * Reporting value of the Category, Its like a custom abbreviation
     */
    public FieldJson3 withShortText(@Nullable String shortText) {
        this.shortText = shortText;
        return this;
    }
     ...
     * Field Type
     */
    public FieldJson3 withType(@Nullable FieldTypeJson2 type) {
        this.type = type;
        return this;
    }
     ...
     * List of choices for this field.
     */
    public FieldJson3 withChoices(@Nullable List<ChoiceJson2> choices) {
        this.choices = choices;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public FieldJson3 withNotApplicableAnswer(@Nullable AdditionalChoiceJson1 notApplicableAnswer) {
        this.notApplicableAnswer = notApplicableAnswer;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public FieldJson3 withOtherAnswer(@Nullable AdditionalChoiceJson1 otherAnswer) {
        this.otherAnswer = otherAnswer;
        return this;
    }
     ...
     * Is this a mandatory field
     */
    public FieldJson3 withRequired(@Nullable Boolean required) {
    ...
    public static final class Builder {
        ...
        public FieldJson3 build() {
            return new FieldJson3(id, text, shortText, type, choices, notApplicableAnswer, otherAnswer, required);
        }
