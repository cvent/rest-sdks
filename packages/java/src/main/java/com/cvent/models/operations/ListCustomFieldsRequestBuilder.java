...
public class ListCustomFieldsRequestBuilder {
     ...
     */
    public ListCustomFieldsResponse call() {
     ...
     * <pre><code>
     * for (ListCustomFieldsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListCustomFieldsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListCustomFieldsResponse> callAsStream() {
