...
public class ListAttendeeAudienceSegmentsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListAttendeeAudienceSegmentsRequest request;
    private final Options.Builder optionsBuilder;

    public ListAttendeeAudienceSegmentsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListAttendeeAudienceSegmentsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListAttendeeAudienceSegmentsRequestBuilder request(@Nonnull ListAttendeeAudienceSegmentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListAttendeeAudienceSegmentsRequest _buildRequest() {
        return this.request;
    }

    public ListAttendeeAudienceSegmentsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListAttendeeAudienceSegmentsResponse> call() {
     ...
     */
    public Publisher<ListAttendeeAudienceSegmentsResponse> callAsPublisher() {
        ListAttendeeAudienceSegmentsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListAttendeeAudienceSegmentsRequest, ListAttendeeAudienceSegmentsResponse> operation =
                new ListAttendeeAudienceSegments.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListAttendeeAudienceSegmentsResponse> flowPublisher =
