...
public class GetHotelRequestsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetHotelRequestsRequest request;
    private final Options.Builder optionsBuilder;

    public GetHotelRequestsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetHotelRequestsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetHotelRequestsRequestBuilder request(@Nonnull GetHotelRequestsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetHotelRequestsRequest _buildRequest() {
        return this.request;
    }

    public GetHotelRequestsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetHotelRequestsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetHotelRequestsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetHotelRequestsResponse&gt;() {
     ...
     */
    public Publisher<GetHotelRequestsResponse> callAsPublisher() {
        GetHotelRequestsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetHotelRequestsRequest, GetHotelRequestsResponse> operation =
                new GetHotelRequests.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetHotelRequestsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
