...
public class GetStandardSurveyResponsesRequest {
     ...
     * beginning of time of the data store.
     */
    public GetStandardSurveyResponsesRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public GetStandardSurveyResponsesRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public GetStandardSurveyResponsesRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetStandardSurveyResponsesRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
