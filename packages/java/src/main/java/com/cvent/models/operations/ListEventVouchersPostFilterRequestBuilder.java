...
public class ListEventVouchersPostFilterRequestBuilder {
     ...
     */
    public ListEventVouchersPostFilterResponse call() {
     ...
     * <pre><code>
     * for (ListEventVouchersPostFilterResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventVouchersPostFilterResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventVouchersPostFilterResponse> callAsStream() {
