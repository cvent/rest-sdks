...
public class SessionInput {
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public SessionInput withEvent(@Nonnull UuidJson event) {
     ...
     * Title of the session. For example, Keynote Session.
     */
    public SessionInput withTitle(@Nonnull String title) {
     ...
     * A unique code for this session.
     */
    public SessionInput withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * A Named object
     */
    public SessionInput withCategory(@Nullable IdNameJson category) {
        this.category = category;
        return this;
    }


    public SessionInput withType(@Nullable SessionLookup type) {
        this.type = type;
        return this;
    }
     ...
     * Used to denote a locations name and abbreviation.
     */
    public SessionInput withLocation(@Nullable LocationJson2Input location) {
        this.location = location;
        return this;
    }
     ...
     * - href, target, rel on a
     */
    public SessionInput withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The ISO 8601 formatted date and time when the session starts.
     */
    public SessionInput withStart(@Nonnull OffsetDateTime start) {
     ...
     * The ISO 8601 formatted date and time when the session ends.
     */
    public SessionInput withEnd(@Nonnull OffsetDateTime end) {
     ...
     * This is used to denote the status of a session.
     */
    public SessionInput withStatus(@Nonnull SessionStatusJson status) {
     ...
     * The ISO 8601 formatted date when the session registration automatically opens.
     */
    public SessionInput withAutomaticallyOpensOn(@Nullable LocalDate automaticallyOpensOn) {
        this.automaticallyOpensOn = automaticallyOpensOn;
        return this;
    }
     ...
     * The ISO 8601 formatted date when the session registration automatically closes.
     */
    public SessionInput withAutomaticallyClosesOn(@Nullable LocalDate automaticallyClosesOn) {
        this.automaticallyClosesOn = automaticallyClosesOn;
        return this;
    }
     ...
     * Indicates if the waitlist is supported for the session.
     */
    public SessionInput withEnableWaitlist(@Nullable Boolean enableWaitlist) {
        this.enableWaitlist = enableWaitlist;
        return this;
    }
     ...
     * The maximum number of attendees who can waitlist for the in-person portion of the session.
     */
    public SessionInput withWaitlistCapacity(@Nullable Long waitlistCapacity) {
        this.waitlistCapacity = waitlistCapacity;
        return this;
    }
     ...
     * Indicates if the virtual waitlist for the session is open.
     */
    public SessionInput withEnableWaitlistVirtual(@Nullable Boolean enableWaitlistVirtual) {
        this.enableWaitlistVirtual = enableWaitlistVirtual;
        return this;
    }
     ...
     * The maximum number of attendees who can enroll in the in-person portion of the session.
     */
    public SessionInput withCapacity(@Nullable Long capacity) {
        this.capacity = capacity;
        return this;
    }
     ...
     * Indicates whether a given session has unlimited in-person capacity.
     */
    public SessionInput withCapacityUnlimited(@Nullable Boolean capacityUnlimited) {
        this.capacityUnlimited = capacityUnlimited;
        return this;
    }
     ...
     * The maximum number of attendees who can enroll in the virtual portion of the session.
     */
    public SessionInput withCapacityVirtual(@Nullable Long capacityVirtual) {
        this.capacityVirtual = capacityVirtual;
        return this;
    }
     ...
     * Indicates whether a given session has unlimited virtual capacity.
     */
    public SessionInput withVirtualCapacityUnlimited(@Nullable Boolean virtualCapacityUnlimited) {
        this.virtualCapacityUnlimited = virtualCapacityUnlimited;
        return this;
    }
     ...
     * The maximum number of attendees who can waitlist the virtual portion of the session.
     */
    public SessionInput withWaitlistCapacityVirtual(@Nullable Long waitlistCapacityVirtual) {
        this.waitlistCapacityVirtual = waitlistCapacityVirtual;
        return this;
    }
     ...
     * Indicates whether to display the session on Agenda.
     */
    public SessionInput withDisplayOnAgenda(@Nullable Boolean displayOnAgenda) {
     ...
     * Indicates if the session is featured
     */
    public SessionInput withFeatured(@Nullable Boolean featured) {
        this.featured = featured;
        return this;
    }
     ...
     * The id of the session group, if the session belongs to one
     */
    public SessionInput withGroup(@Nullable String group) {
        this.group = group;
        return this;
    }
     ...
     * The ids of the admission items, if the session is included with any.
     */
    public SessionInput withAdmissionItems(@Nullable List<String> admissionItems) {
        this.admissionItems = admissionItems;
        return this;
    }
     ...
     * Indicates if the session is open for registration.
     */
    public SessionInput withOpenForRegistration(@Nullable Boolean openForRegistration) {
        this.openForRegistration = openForRegistration;
        return this;
    }
     ...
     * Indicates if the session is open for AttendeeHub.
     */
    public SessionInput withOpenForAttendeeHub(@Nullable Boolean openForAttendeeHub) {
        this.openForAttendeeHub = openForAttendeeHub;
        return this;
    }
     ...
     * Contains unique identifiers for registration types associated with this session
     */
    public SessionInput withRegistrationTypes(@Nullable List<String> registrationTypes) {
        this.registrationTypes = registrationTypes;
        return this;
    }
     ...
     * The presentation type of the session.
     */
    public SessionInput withPresentationType(@Nullable String presentationType) {
        this.presentationType = presentationType;
        return this;
    }
     ...
     * A tag associated with the session.
     */
    public SessionInput withDataTagCode(@Nullable String dataTagCode) {
        this.dataTagCode = dataTagCode;
        return this;
    }
     ...
     * The display order of session, set by planner for concurrent sessions
     */
    public SessionInput withOrder(@Nullable Long order) {
        this.order = order;
        return this;
    }
     ...
     * Indicator to specify if this session was automatically included with the event.
     */
    public SessionInput withIncludedSession(@Nullable Boolean includedSession) {
     ...
     * <p>Null if no `match` filter is provided.
     */
    public SessionInput withRelevance(@Nullable Double relevance) {
        this.relevance = relevance;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SessionInput other = (SessionInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SessionInput.class,
                "event", event,
                "title", title,
                "code", code,
                "category", category,
