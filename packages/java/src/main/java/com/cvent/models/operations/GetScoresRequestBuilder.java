...
public class GetScoresRequestBuilder {
     ...
     * <pre><code>
     * for (GetScoresResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetScoresResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetScoresResponse> callAsStream() {
