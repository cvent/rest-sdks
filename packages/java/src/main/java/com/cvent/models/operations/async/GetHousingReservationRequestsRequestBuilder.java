...
public class GetHousingReservationRequestsRequestBuilder {
    ...
    public GetHousingReservationRequestsRequestBuilder retryConfig(RetryConfig retryConfig) {
    ...
    public Publisher<GetHousingReservationRequestsResponse> callAsPublisher() {
        ...
        Flow.Publisher<GetHousingReservationRequestsResponse> flowPublisher =
