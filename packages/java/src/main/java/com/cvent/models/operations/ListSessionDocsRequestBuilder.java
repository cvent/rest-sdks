...
public class ListSessionDocsRequestBuilder {
     ...
     */
    public ListSessionDocsResponse call() {
     ...
     * <pre><code>
     * for (ListSessionDocsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSessionDocsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSessionDocsResponse> callAsStream() {
