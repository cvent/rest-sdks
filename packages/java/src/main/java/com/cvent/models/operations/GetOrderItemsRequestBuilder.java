...
public class GetOrderItemsRequestBuilder {
     ...
     */
    public GetOrderItemsResponse call() {
     ...
     * <pre><code>
     * for (GetOrderItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetOrderItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetOrderItemsResponse> callAsStream() {
