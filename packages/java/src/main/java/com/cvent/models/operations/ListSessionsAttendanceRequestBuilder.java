...
public class ListSessionsAttendanceRequestBuilder {
     ...
     */
    public ListSessionsAttendanceResponse call() {
     ...
     * <pre><code>
     * for (ListSessionsAttendanceResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSessionsAttendanceResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSessionsAttendanceResponse> callAsStream() {
