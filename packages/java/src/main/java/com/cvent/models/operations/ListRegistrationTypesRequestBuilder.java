...
public class ListRegistrationTypesRequestBuilder {
     ...
     */
    public ListRegistrationTypesResponse call() {
     ...
     * <pre><code>
     * for (ListRegistrationTypesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListRegistrationTypesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListRegistrationTypesResponse> callAsStream() {
