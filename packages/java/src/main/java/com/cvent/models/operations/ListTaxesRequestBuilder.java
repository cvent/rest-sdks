...
public class ListTaxesRequestBuilder {
     ...
     * <pre><code>
     * for (ListTaxesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListTaxesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListTaxesResponse> callAsStream() {
