...
public class ListWebcastsRequestBuilder {
    ...
    private ListWebcastsRequest _buildRequest() {
        return this.request;
    }

    public ListWebcastsRequestBuilder header(String name, String value) {
     ...
     * <pre><code>
     * Publisher&lt;ListWebcastsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListWebcastsResponse&gt;() {
    ...
    public Publisher<ListWebcastsResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
                ...
                ListWebcastsRequest::withToken,
                operation::doRequest);

        Flow.Publisher<ListWebcastsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
