...
public class Event1 {
     ...
     * Denotes the format of an event.
     */
    public Event1 withFormat(@Nonnull EventFormat format) {
     ...
     * Collection of venues.
     */
    public Event1 withVenues(@Nullable List<Venue1> venues) {
        this.venues = venues;
        return this;
    }
     ...
     * Represents the security level used for event registrations.
     */
    public Event1 withRegistrationSecurityLevel(@Nullable EventSecurityLevel registrationSecurityLevel) {
        this.registrationSecurityLevel = registrationSecurityLevel;
        return this;
    }
     ...
     * This is used to denote the registration status for an event.
     */
    public Event1 withStatus(@Nullable RegistrationStatus status) {
        this.status = status;
        return this;
    }
     ...
     * was cancelled or deleted.
     */
    public Event1 withEventStatus(@Nullable EventStatus eventStatus) {
        this.eventStatus = eventStatus;
        return this;
    }
     ...
     * A collection of contacts representing the event planners.
     */
    public Event1 withPlanners(@Nonnull List<Planner1> planners) {
     ...
     * A collection of contacts representing event stakeholders.
     */
    public Event1 withStakeholders(@Nullable List<Stakeholder> stakeholders) {
        this.stakeholders = stakeholders;
        return this;
    }
     ...
     * Collection of custom fields.
     */
    public Event1 withCustomFields(@Nullable List<CustomField> customFields) {
        this.customFields = customFields;
        return this;
    }
     ...
     * Essentials.
     */
    public Event1 withType(@Nonnull EventType11 type) {
     ...
     * Represents the links associated with an event.
     */
    public Event1 withLinks(@Nullable EventLinks links) {
        this.links = links;
        return this;
    }
