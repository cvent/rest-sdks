...
public class GetStandardSurveysRequestBuilder {
     ...
     */
    public GetStandardSurveysResponse call() {
     ...
     * <pre><code>
     * for (GetStandardSurveysResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetStandardSurveysResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetStandardSurveysResponse> callAsStream() {
