...
public class GetAccountVendorsRequestBuilder {
     ...
     */
    public GetAccountVendorsResponse call() {
     ...
     * <pre><code>
     * for (GetAccountVendorsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAccountVendorsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAccountVendorsResponse> callAsStream() {
