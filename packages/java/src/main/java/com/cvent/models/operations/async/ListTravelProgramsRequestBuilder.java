...
public class ListTravelProgramsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListTravelProgramsRequest request;
    private final Options.Builder optionsBuilder;

    public ListTravelProgramsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListTravelProgramsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListTravelProgramsRequestBuilder request(@Nonnull ListTravelProgramsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTravelProgramsRequest _buildRequest() {
        return this.request;
    }

    public ListTravelProgramsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListTravelProgramsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListTravelProgramsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListTravelProgramsResponse&gt;() {
     ...
     */
    public Publisher<ListTravelProgramsResponse> callAsPublisher() {
        ListTravelProgramsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListTravelProgramsRequest, ListTravelProgramsResponse> operation =
                new ListTravelPrograms.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListTravelProgramsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
