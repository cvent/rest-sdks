...
public class VenueAddressJson {
     ...
     * The first line of an address.
     */
    public VenueAddressJson withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public VenueAddressJson withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public VenueAddressJson withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public VenueAddressJson withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public VenueAddressJson withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public VenueAddressJson withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public VenueAddressJson withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public VenueAddressJson withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country for example, 'United States'
     */
    public VenueAddressJson withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public VenueAddressJson withLatitude(@Nullable Double latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public VenueAddressJson withLongitude(@Nullable Double longitude) {
        this.longitude = longitude;
        return this;
    }
