...
public class GetAirRequestsResponse implements Response {
    ...
    @Override
    public int hashCode() {
        return Utils.enhancedHash(contentType, statusCode, rawResponse, airReservationDetail);
    }

    @Override
    public String toString() {
        return Utils.toString(
                GetAirRequestsResponse.class,
                "contentType",
                contentType,
                "statusCode",
                statusCode,
    ...
    public static final class Builder {
        ...
        public GetAirRequestsResponse build() {
            return new GetAirRequestsResponse(contentType, statusCode, rawResponse, airReservationDetail);
        }
    }
}
