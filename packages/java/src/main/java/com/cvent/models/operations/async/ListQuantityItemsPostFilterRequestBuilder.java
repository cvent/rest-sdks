...
public class ListQuantityItemsPostFilterRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListQuantityItemsPostFilterRequest request;
    private final Options.Builder optionsBuilder;

    public ListQuantityItemsPostFilterRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListQuantityItemsPostFilterRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListQuantityItemsPostFilterRequestBuilder request(@Nonnull ListQuantityItemsPostFilterRequest request) {
     ...
     * <pre><code>
     * Publisher&lt;ListQuantityItemsPostFilterResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListQuantityItemsPostFilterResponse&gt;() {
