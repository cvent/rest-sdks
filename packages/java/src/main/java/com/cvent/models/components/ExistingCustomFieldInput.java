...
public class ExistingCustomFieldInput {
    ...
    private ExistingCustomFieldDetailsInput details;
    ...
    @JsonCreator
    public ExistingCustomFieldInput(
            ...
            @JsonProperty("details") @Nullable ExistingCustomFieldDetailsInput details,
    ...
    public ExistingCustomFieldInput(
        ...
        this(category, name, code, null, type, null, null, null, null, null, null, null, null, null);
    }
     ...
     * Type-specific details of the custom-field.
     */
    public Optional<ExistingCustomFieldDetailsInput> details() {
     ...
     * This is used to denote the category of a custom field.
     */
    public ExistingCustomFieldInput withCategory(@Nonnull CustomFieldCategoryJson category) {
     ...
     * The actual text of the custom field.
     */
    public ExistingCustomFieldInput withName(@Nonnull String name) {
     ...
     * Code to uniquely identify custom field.
     */
    public ExistingCustomFieldInput withCode(@Nonnull String code) {
     ...
     * Whether answer to custom field is mandatory or not.
     */
    public ExistingCustomFieldInput withRequired(@Nullable Boolean required) {
     ...
     * are read only.
     */
    public ExistingCustomFieldInput withType(@Nonnull CustomFieldTypeJson1 type) {
     ...
     * Type-specific details of the custom-field.
     */
    public ExistingCustomFieldInput withDetails(@Nullable ExistingCustomFieldDetailsInput details) {
        this.details = details;
        return this;
    }
     ...
     * The help text of the custom field.
     */
    public ExistingCustomFieldInput withHelpText(@Nullable String helpText) {
        this.helpText = helpText;
        return this;
    }
     ...
     * <p>Only applicable to session custom fields.
     */
    public ExistingCustomFieldInput withDisplayInDataTag(@Nullable DisplayInDataTagJson displayInDataTag) {
     ...
     * applicable to contact custom fields.
     */
    public ExistingCustomFieldInput withDefaultTagText(@Nullable String defaultTagText) {
        this.defaultTagText = defaultTagText;
        return this;
    }
     ...
     * True means that this is a consent field. Only applicable to contact custom fields.
     */
    public ExistingCustomFieldInput withConsentField(@Nullable Boolean consentField) {
     ...
     * True means that this custom field is active. Determines visibility for event custom fields.
     */
    public ExistingCustomFieldInput withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
     ...
     * custom fields.
     */
    public ExistingCustomFieldInput withDisplayInEventCreationWizard(@Nullable Boolean displayInEventCreationWizard) {
     ...
     * Visibility of the custom field on various pages/forms.
     */
    public ExistingCustomFieldInput withPageVisibility(@Nullable PageVisibilityJson pageVisibility) {
        this.pageVisibility = pageVisibility;
        return this;
    }
     ...
     * The ID of the custom field.
     */
    public ExistingCustomFieldInput withId(@Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExistingCustomFieldInput other = (ExistingCustomFieldInput) o;
    ...
    public String toString() {
        return Utils.toString(
                ExistingCustomFieldInput.class,
                "category",
                category,
                "name",
                name,
    ...
    public static final class Builder {
         ...
         * Type-specific details of the custom-field.
         */
        public Builder details(@Nullable ExistingCustomFieldDetailsInput details) {
            this.details = details;
            return this;
        }
        ...
        public ExistingCustomFieldInput build() {
            return new ExistingCustomFieldInput(
                    category,
                    name,
                    code,
                    required,
