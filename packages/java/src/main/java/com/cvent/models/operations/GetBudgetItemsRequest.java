...
public class GetBudgetItemsRequest {
     ...
     * Unique ID of an event.
     */
    public GetBudgetItemsRequest withId(@Nonnull String id) {
     ...
     * beginning of time of the data store.
     */
    public GetBudgetItemsRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public GetBudgetItemsRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public GetBudgetItemsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetBudgetItemsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public GetBudgetItemsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
