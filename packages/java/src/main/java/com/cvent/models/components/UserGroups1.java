...
public class UserGroups1 {
     ...
     * The collection of user schemas.
     */
    public UserGroups1 withSchemas(@Nullable List<String> schemas) {
        this.schemas = schemas;
        return this;
    }
     ...
     * The number of schemas per page.
     */
    public UserGroups1 withItemsPerPage(@Nullable Long itemsPerPage) {
        this.itemsPerPage = itemsPerPage;
        return this;
    }
     ...
     * Starting index of the response.
     */
    public UserGroups1 withStartIndex(@Nullable Long startIndex) {
        this.startIndex = startIndex;
        return this;
    }
     ...
     * The total count of schemas.
     */
    public UserGroups1 withTotalResults(@Nullable Long totalResults) {
        this.totalResults = totalResults;
        return this;
    }
     ...
     * The collection of schema resources.
     */
    public UserGroups1 withResources(@Nullable List<Group1> resources) {
        this.resources = resources;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UserGroups1 other = (UserGroups1) o;
    ...
    public static final class Builder {
        ...
        public UserGroups1 build() {
            return new UserGroups1(schemas, itemsPerPage, startIndex, totalResults, resources);
        }
    }
}
