...
public class PropertyApiListChainsResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PropertyApiListChainsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
