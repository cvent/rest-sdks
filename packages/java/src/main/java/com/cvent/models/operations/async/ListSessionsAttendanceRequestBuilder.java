...
public class ListSessionsAttendanceRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListSessionsAttendanceRequest request;
    private final Options.Builder optionsBuilder;

    public ListSessionsAttendanceRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListSessionsAttendanceRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListSessionsAttendanceRequestBuilder request(@Nonnull ListSessionsAttendanceRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListSessionsAttendanceRequest _buildRequest() {
        return this.request;
    }

    public ListSessionsAttendanceRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListSessionsAttendanceResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListSessionsAttendanceResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListSessionsAttendanceResponse&gt;() {
     ...
     */
    public Publisher<ListSessionsAttendanceResponse> callAsPublisher() {
        ListSessionsAttendanceRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListSessionsAttendanceRequest, ListSessionsAttendanceResponse> operation =
                new ListSessionsAttendance.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListSessionsAttendanceResponse> flowPublisher =
