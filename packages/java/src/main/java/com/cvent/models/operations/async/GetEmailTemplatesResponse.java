...
public class GetEmailTemplatesResponse implements AsyncResponse {
    /**
     ...
     * Successfully retrieved a paginated list of email templates for a campaign.
     */
    public Optional<EmailTemplatePaginatedResponse> emailTemplatePaginatedResponse() {
        return Optional.ofNullable(this.emailTemplatePaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetEmailTemplatesResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetEmailTemplatesResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetEmailTemplatesResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
