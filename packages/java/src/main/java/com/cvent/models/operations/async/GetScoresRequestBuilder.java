...
public class GetScoresRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetScoresRequest request;
    private final Options.Builder optionsBuilder;

    public GetScoresRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetScoresRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetScoresRequestBuilder request(@Nonnull GetScoresRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetScoresRequest _buildRequest() {
        return this.request;
    }

    public GetScoresRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetScoresResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetScoresResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetScoresResponse&gt;() {
     ...
     */
    public Publisher<GetScoresResponse> callAsPublisher() {
        GetScoresRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetScoresRequest, GetScoresResponse> operation =
                new GetScores.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetScoresResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
