...
public class GetBadgesPostFiltersRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetBadgesPostFiltersRequest request;
    private final Options.Builder optionsBuilder;

    public GetBadgesPostFiltersRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetBadgesPostFiltersRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetBadgesPostFiltersRequestBuilder request(@Nonnull GetBadgesPostFiltersRequest request) {
     ...
     */
    public CompletableFuture<GetBadgesPostFiltersResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetBadgesPostFiltersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetBadgesPostFiltersResponse&gt;() {
     ...
     */
    public Publisher<GetBadgesPostFiltersResponse> callAsPublisher() {
        ...
        Flow.Publisher<GetBadgesPostFiltersResponse> flowPublisher =
