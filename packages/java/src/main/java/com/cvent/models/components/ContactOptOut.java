...
public class ContactOptOut {
     ...
     * Used to denote if a contact has opted-out of receiving system generated emails.
     */
    public ContactOptOut withOptedOut(@Nullable Boolean optedOut) {
     ...
     * opts out multiple times.
     */
    public ContactOptOut withDate(@Nullable OffsetDateTime date) {
        this.date = date;
        return this;
    }
     ...
     * This is used to denote how a contact is opt'd out of Cvent system.
     */
    public ContactOptOut withBy(@Nullable OptoutBy by) {
        this.by = by;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContactOptOut other = (ContactOptOut) o;
    ...
    public String toString() {
        return Utils.toString(ContactOptOut.class, "optedOut", optedOut, "date", date, "by", by);
    }
    ...
    public static final class Builder {
        ...
        public ContactOptOut build() {
            return new ContactOptOut(optedOut, date, by);
        }
