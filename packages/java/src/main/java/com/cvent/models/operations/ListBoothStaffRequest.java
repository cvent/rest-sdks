...
public class ListBoothStaffRequest {
     ...
     * ID of an event.
     */
    public ListBoothStaffRequest withId(@Nonnull String id) {
     ...
     * ID of an exhibitor.
     */
    public ListBoothStaffRequest withExhibitorId(@Nonnull String exhibitorId) {
     ...
     * The maximum number of records to return per page.
     */
    public ListBoothStaffRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListBoothStaffRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
