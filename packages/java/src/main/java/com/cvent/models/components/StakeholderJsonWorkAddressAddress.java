 ...
 */
@Deprecated
public class StakeholderJsonWorkAddressAddress {
    /**
     ...
     * The first line of an address.
     */
    public StakeholderJsonWorkAddressAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public StakeholderJsonWorkAddressAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public StakeholderJsonWorkAddressAddress withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public StakeholderJsonWorkAddressAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public StakeholderJsonWorkAddressAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public StakeholderJsonWorkAddressAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public StakeholderJsonWorkAddressAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public StakeholderJsonWorkAddressAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country of the address.
     */
    public StakeholderJsonWorkAddressAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public StakeholderJsonWorkAddressAddress withLatitude(@Nullable Long latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public StakeholderJsonWorkAddressAddress withLongitude(@Nullable Long longitude) {
        this.longitude = longitude;
        return this;
    }
