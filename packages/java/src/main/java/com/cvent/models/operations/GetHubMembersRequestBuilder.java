...
public class GetHubMembersRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetHubMembersRequest request;
    private final Options.Builder optionsBuilder;

    public GetHubMembersRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetHubMembersRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetHubMembersRequestBuilder request(@Nonnull GetHubMembersRequest request) {
     ...
     */
    public GetHubMembersResponse call() {
     ...
     * <pre><code>
     * for (GetHubMembersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetHubMembersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetHubMembersResponse> callAsStream() {
