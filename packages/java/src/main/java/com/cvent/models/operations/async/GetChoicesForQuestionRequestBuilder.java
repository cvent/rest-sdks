...
public class GetChoicesForQuestionRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetChoicesForQuestionRequest request;
    private final Options.Builder optionsBuilder;

    public GetChoicesForQuestionRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetChoicesForQuestionRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetChoicesForQuestionRequestBuilder request(@Nonnull GetChoicesForQuestionRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetChoicesForQuestionRequest _buildRequest() {
        return this.request;
    }

    public GetChoicesForQuestionRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetChoicesForQuestionResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetChoicesForQuestionResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetChoicesForQuestionResponse&gt;() {
     ...
     */
    public Publisher<GetChoicesForQuestionResponse> callAsPublisher() {
        GetChoicesForQuestionRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetChoicesForQuestionRequest, GetChoicesForQuestionResponse> operation =
                new GetChoicesForQuestion.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetChoicesForQuestionResponse> flowPublisher =
