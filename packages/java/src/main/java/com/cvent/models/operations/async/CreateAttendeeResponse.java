...
public class CreateAttendeeResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public CreateAttendeeResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public CreateAttendeeResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAttendeeResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
