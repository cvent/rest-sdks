...
public class Users {
     ...
     * The collection of user schemas.
     */
    public Users withSchemas(@Nullable List<String> schemas) {
        this.schemas = schemas;
        return this;
    }
     ...
     * The number of users per page.
     */
    public Users withItemsPerPage(@Nullable Long itemsPerPage) {
        this.itemsPerPage = itemsPerPage;
        return this;
    }
     ...
     * Starting index of the response.
     */
    public Users withStartIndex(@Nullable Long startIndex) {
        this.startIndex = startIndex;
        return this;
    }
     ...
     * The total count of users.
     */
    public Users withTotalResults(@Nullable Long totalResults) {
        this.totalResults = totalResults;
        return this;
    }
