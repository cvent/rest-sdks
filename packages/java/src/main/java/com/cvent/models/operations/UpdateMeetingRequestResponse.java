...
public class UpdateMeetingRequestResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateMeetingRequestResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
