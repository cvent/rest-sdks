...
public class One {
     ...
     * The ISO 8601 zoned minimum date time accepted.
     */
    public One withFrom(@Nullable OffsetDateTime from) {
        this.from = from;
        return this;
    }
     ...
     * The ISO 8601 zoned maximum date time accepted.
     */
    public One withTo(@Nullable OffsetDateTime to) {
        this.to = to;
        return this;
    }
     ...
     * This is used to denote the display format type of date time type custom field.
     */
    public One withFormat(@Nullable DateTimeDisplayFormatJson format) {
        this.format = format;
        return this;
    }
     ...
     * Whether it needs to be pre populated with current date.
     */
    public One withDefaultToCurrentDate(@Nullable Boolean defaultToCurrentDate) {
        this.defaultToCurrentDate = defaultToCurrentDate;
        return this;
    }
     ...
     * True means that a pop-up calendar will be displayed to assist date selection on UI.
     */
    public One withDisplayPopUpCalendar(@Nullable Boolean displayPopUpCalendar) {
    ...
    public static final class Builder {
        ...
        public One build() {
            return new One(from, to, format, defaultToCurrentDate, displayPopUpCalendar);
        }
