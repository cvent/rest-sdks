...
public class ListAdmissionItemsPostFiltersRequestBuilder {
     ...
     */
    public ListAdmissionItemsPostFiltersResponse call() {
     ...
     * <pre><code>
     * for (ListAdmissionItemsPostFiltersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAdmissionItemsPostFiltersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAdmissionItemsPostFiltersResponse> callAsStream() {
