...
public class ListSessionsEnrollmentRequest {
     ...
     * beginning of time of the data store.
     */
    public ListSessionsEnrollmentRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * time should be in ISO 8601 format.
     */
    public ListSessionsEnrollmentRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public ListSessionsEnrollmentRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListSessionsEnrollmentRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * lastModified (eq|ne|lt|le|gt|ge)
     */
    public ListSessionsEnrollmentRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
