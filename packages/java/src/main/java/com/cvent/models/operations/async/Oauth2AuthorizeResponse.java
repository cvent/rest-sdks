...
public class Oauth2AuthorizeResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public Oauth2AuthorizeResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public Oauth2AuthorizeResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public Oauth2AuthorizeResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
