...
public class ListEventVouchersRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListEventVouchersRequest request;
    private final Options.Builder optionsBuilder;

    public ListEventVouchersRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListEventVouchersRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListEventVouchersRequestBuilder request(@Nonnull ListEventVouchersRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListEventVouchersRequest _buildRequest() {
        return this.request;
    }

    public ListEventVouchersRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListEventVouchersResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListEventVouchersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListEventVouchersResponse&gt;() {
     ...
     */
    public Publisher<ListEventVouchersResponse> callAsPublisher() {
        ListEventVouchersRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListEventVouchersRequest, ListEventVouchersResponse> operation =
                new ListEventVouchers.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListEventVouchersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
