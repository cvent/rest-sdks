...
public class ZeroAllOf2 {
     ...
     * systems.
     */
    public ZeroAllOf2 withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * The description of the appointment.
     */
    public ZeroAllOf2 withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The ISO 8601 formatted start date/time of the appointment.
     */
    public ZeroAllOf2 withStart(@Nonnull OffsetDateTime start) {
     ...
     * The ISO 8601 formatted end date/time of the appointment.
     */
    public ZeroAllOf2 withEnd(@Nonnull OffsetDateTime end) {
     ...
     * Denotes the status of an appointment.
     */
    public ZeroAllOf2 withStatus(@Nullable AppointmentStatusJson status) {
        this.status = status;
        return this;
    }
     ...
     * The location of the appointment.
     */
    public ZeroAllOf2 withLocation(@Nullable LocationAllOf location) {
        this.location = location;
        return this;
    }
     ...
     * The type of the appointment.
     */
    public ZeroAllOf2 withType(@Nonnull TypeAllOf type) {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public ZeroAllOf2 withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public ZeroAllOf2 withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public ZeroAllOf2 withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public ZeroAllOf2 withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public ZeroAllOf2 withAppointmentEvent(@Nullable UuidJson appointmentEvent) {
        this.appointmentEvent = appointmentEvent;
        return this;
    }
     ...
     * Collection of attendees participating in this appointment, and their related details.
     */
    public ZeroAllOf2 withParticipants(@Nullable List<AppointmentParticipantJson> participants) {
        this.participants = participants;
        return this;
    }
     ...
     * True indicates participants will be automatically marked as accepted for the appointment.
     */
    public ZeroAllOf2 withAutoAcceptAttendees(@Nullable Boolean autoAcceptAttendees) {
        this.autoAcceptAttendees = autoAcceptAttendees;
        return this;
    }
     ...
     * True indicates that existing schedule rules were enforced when the appointment was created.
     */
    public ZeroAllOf2 withEnforceScheduleRules(@Nullable Boolean enforceScheduleRules) {
        this.enforceScheduleRules = enforceScheduleRules;
        return this;
    }
     ...
     */
    @Deprecated
    public ZeroAllOf2 withModified(@Nullable OffsetDateTime modified) {
        this.modified = modified;
        return this;
    }
     ...
     * True indicates the appointment has been logically deleted.
     */
    public ZeroAllOf2 withDeleted(@Nullable Boolean deleted) {
        this.deleted = deleted;
        return this;
    }
