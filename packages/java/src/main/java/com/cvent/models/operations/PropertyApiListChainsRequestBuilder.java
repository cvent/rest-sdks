...
public class PropertyApiListChainsRequestBuilder {
     ...
     */
    public PropertyApiListChainsResponse call() {
     ...
     * <pre><code>
     * for (PropertyApiListChainsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<PropertyApiListChainsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<PropertyApiListChainsResponse> callAsStream() {
