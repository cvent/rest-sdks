...
public class ListMembershipItemsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListMembershipItemsRequest request;
    private final Options.Builder optionsBuilder;

    public ListMembershipItemsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListMembershipItemsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListMembershipItemsRequestBuilder request(@Nonnull ListMembershipItemsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListMembershipItemsRequest _buildRequest() {
        return this.request;
    }

    public ListMembershipItemsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListMembershipItemsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListMembershipItemsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListMembershipItemsResponse&gt;() {
     ...
     */
    public Publisher<ListMembershipItemsResponse> callAsPublisher() {
        ListMembershipItemsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListMembershipItemsRequest, ListMembershipItemsResponse> operation =
                new ListMembershipItems.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListMembershipItemsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
