...
public class ListSpeakersRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListSpeakersRequest request;
    private final Options.Builder optionsBuilder;

    public ListSpeakersRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListSpeakersRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListSpeakersRequestBuilder request(@Nonnull ListSpeakersRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListSpeakersRequest _buildRequest() {
        return this.request;
    }

    public ListSpeakersRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListSpeakersResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListSpeakersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListSpeakersResponse&gt;() {
     ...
     */
    public Publisher<ListSpeakersResponse> callAsPublisher() {
        ListSpeakersRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListSpeakersRequest, ListSpeakersResponse> operation =
                new ListSpeakers.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListSpeakersResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
