...
public class GetSessionSegmentsRequest {
     ...
     * The maximum number of records to return per page.
     */
    public GetSessionSegmentsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetSessionSegmentsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public GetSessionSegmentsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
