...
public class AttendeeContactInfo {
     ...
     * Please use the [Get
     * Contact](https://developers.cvent.com/documentation#tag/Contacts/operation/getContactById) or [List
     * Contact](https://developers.cvent.com/documentation#tag/Contacts/operation/listContacts) endpoints
     * for contact audit details.
     *
    ...
    @Deprecated
    private AttendeeContactMembership membership;
    ...
    private List<CustomFieldSchema1> customFields;
    ...
    public AttendeeContactInfo(
            ...
            @JsonProperty("homeAddress") @Nullable Address4 homeAddress,
            @JsonProperty("homePhone") @Nullable String homePhone,
            @JsonProperty("homeFax") @Nullable String homeFax,
            @JsonProperty("workAddress") @Nullable Address4 workAddress,
            ...
            @JsonProperty("customFields") @Nullable List<CustomFieldSchema1> customFields,
     ...
     */
    @Deprecated
    public Optional<AttendeeContactMembership> membership() {
     ...
     * Address details
     */
    public Optional<Address4> homeAddress() {
     ...
     * Address details
     */
    public Optional<Address4> workAddress() {
     ...
     * Collection of custom fields.
     */
    public Optional<List<CustomFieldSchema1>> customFields() {
     ...
     */
    @Deprecated
    public AttendeeContactInfo withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     */
    @Deprecated
    public AttendeeContactInfo withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     */
    @Deprecated
    public AttendeeContactInfo withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     */
    @Deprecated
    public AttendeeContactInfo withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The id of contact
     */
    public AttendeeContactInfo withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The first name of the contact
     */
    public AttendeeContactInfo withFirstName(@Nullable String firstName) {
        this.firstName = firstName;
        return this;
    }
     ...
     * The last name of the contact
     */
    public AttendeeContactInfo withLastName(@Nullable String lastName) {
        this.lastName = lastName;
        return this;
    }
     ...
     * The middle name of the contact
     */
    public AttendeeContactInfo withMiddleName(@Nullable String middleName) {
        this.middleName = middleName;
        return this;
    }
     ...
     * The nickname of the contact.
     */
    public AttendeeContactInfo withNickname(@Nullable String nickname) {
        this.nickname = nickname;
        return this;
    }
     ...
     * The email address of the contact
     */
    public AttendeeContactInfo withEmail(@Nullable String email) {
        this.email = email;
        return this;
    }
     ...
     * An alternate email address of the contact that will be cc'd on all email communications
     */
    public AttendeeContactInfo withCcEmail(@Nullable String ccEmail) {
        this.ccEmail = ccEmail;
        return this;
    }
     ...
     * The gender of the contact.
     */
    public AttendeeContactInfo withGender(@Nullable Gender gender) {
        this.gender = gender;
        return this;
    }
     ...
     * The company/organization the contact belongs to.
     */
    public AttendeeContactInfo withCompany(@Nullable String company) {
        this.company = company;
        return this;
    }
     ...
     * The designation of the contact
     */
    public AttendeeContactInfo withDesignation(@Nullable String designation) {
        this.designation = designation;
        return this;
    }
     ...
     * The job title of the contact
     */
    public AttendeeContactInfo withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * Contains details related to the attendee's contact type.
     */
    public AttendeeContactInfo withType(@Nullable AttendeeContactType type) {
        this.type = type;
        return this;
    }
     ...
     */
    @Deprecated
    public AttendeeContactInfo withMembership(@Nullable AttendeeContactMembership membership) {
        this.membership = membership;
        return this;
    }
     ...
     * The type of address.
     */
    public AttendeeContactInfo withPrimaryAddressType(@Nullable AddressType primaryAddressType) {
        this.primaryAddressType = primaryAddressType;
        return this;
    }
     ...
     * Address details
     */
    public AttendeeContactInfo withHomeAddress(@Nullable Address4 homeAddress) {
        this.homeAddress = homeAddress;
        return this;
    }
     ...
     * Home phone number
     */
    public AttendeeContactInfo withHomePhone(@Nullable String homePhone) {
        this.homePhone = homePhone;
        return this;
    }
     ...
     * Home FAX number
     */
    public AttendeeContactInfo withHomeFax(@Nullable String homeFax) {
        this.homeFax = homeFax;
        return this;
    }
     ...
     * Address details
     */
    public AttendeeContactInfo withWorkAddress(@Nullable Address4 workAddress) {
        this.workAddress = workAddress;
        return this;
    }
     ...
     * Work phone number
     */
    public AttendeeContactInfo withWorkPhone(@Nullable String workPhone) {
        this.workPhone = workPhone;
        return this;
    }
     ...
     * Work FAX number
     */
    public AttendeeContactInfo withWorkFax(@Nullable String workFax) {
        this.workFax = workFax;
        return this;
    }
     ...
     * Opt-out choices.
     */
    public AttendeeContactInfo withOptOut(@Nullable OptOut optOut) {
        this.optOut = optOut;
        return this;
    }
     ...
     * Collection of custom fields.
     */
    public AttendeeContactInfo withCustomFields(@Nullable List<CustomFieldSchema1> customFields) {
        this.customFields = customFields;
        return this;
    }
     ...
     * each contact within an account. Consider adding the external system name has part of the ID
     */
    public AttendeeContactInfo withSourceId(@Nullable String sourceId) {
        this.sourceId = sourceId;
        return this;
    }
     ...
     * Mobile phone number
     */
    public AttendeeContactInfo withMobilePhone(@Nullable String mobilePhone) {
        this.mobilePhone = mobilePhone;
        return this;
    }
     ...
     * Detail related to compliance with the contact's privacy rights under various legislation.
     */
    public AttendeeContactInfo withCompliance(@Nullable List<Compliance> compliance) {
        this.compliance = compliance;
        return this;
    }
     ...
     * Used to denote what is traditionally a title of an individual. For example, Mr., Mrs., Dr., etc.
     */
    public AttendeeContactInfo withPrefix(@Nullable String prefix) {
        this.prefix = prefix;
        return this;
    }
     ...
     * The pager number of the contact.
     */
    public AttendeeContactInfo withPager(@Nullable String pager) {
        this.pager = pager;
        return this;
    }
     ...
     * True indicates a contact is deleted.
     */
    public AttendeeContactInfo withDeleted(@Nullable Boolean deleted) {
     ...
     * The headline of the contact's profile, which summarizes their professional experience and qualities.
     */
    public AttendeeContactInfo withHeadline(@Nullable String headline) {
        this.headline = headline;
        return this;
    }
     ...
     * A contact's personal website URL.
     */
    public AttendeeContactInfo withPersonalWebsite(@Nullable String personalWebsite) {
        this.personalWebsite = personalWebsite;
        return this;
    }
     ...
     * A contact's biographical writeup.
     */
    public AttendeeContactInfo withBiography(@Nullable String biography) {
        this.biography = biography;
        return this;
    }
     ...
     */
    @Deprecated
    public AttendeeContactInfo withPronoun(@Nullable String pronoun) {
        this.pronoun = pronoun;
        return this;
    }
     ...
     * Represents the preferred pronouns of a contact.
     */
    public AttendeeContactInfo withPronouns(@Nullable String pronouns) {
        this.pronouns = pronouns;
        return this;
    }
     ...
     * Collection of social media links for the contact.
     */
    public AttendeeContactInfo withLinks(@Nullable ContactLinks links) {
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AttendeeContactInfo other = (AttendeeContactInfo) o;
    ...
    public static final class Builder {
         ...
         */
        @Deprecated
        public Builder membership(@Nullable AttendeeContactMembership membership) {
            this.membership = membership;
            return this;
        }
         ...
         * Address details
         */
        public Builder homeAddress(@Nullable Address4 homeAddress) {
            this.homeAddress = homeAddress;
            return this;
        }
         ...
         * Address details
         */
        public Builder workAddress(@Nullable Address4 workAddress) {
            this.workAddress = workAddress;
            return this;
        }
         ...
         * Collection of custom fields.
         */
        public Builder customFields(@Nullable List<CustomFieldSchema1> customFields) {
            this.customFields = customFields;
            return this;
        }
        ...
        public AttendeeContactInfo build() {
            return new AttendeeContactInfo(
                    created,
                    createdBy,
                    lastModified,
                    lastModifiedBy,
