 ...
 * 
 * <p>The response from a request to get the list of conversions rate for a currency.
 */
public class CurrencyConversionRatePaginatedResponse {
     ...
     * Collection of conversion rate for a currency in an account.
     */
    public CurrencyConversionRatePaginatedResponse withData(@Nonnull List<CurrencyConversionRateListResponseJson> data) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CurrencyConversionRatePaginatedResponse other = (CurrencyConversionRatePaginatedResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CurrencyConversionRatePaginatedResponse.class,
                "paging", paging,
                "data", data);
    }
    ...
    public final static class Builder {
        ...
        public CurrencyConversionRatePaginatedResponse build() {
            return new CurrencyConversionRatePaginatedResponse(
                paging, data);
        }
