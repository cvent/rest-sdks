...
public class GetEmarketingEmailStatusResponse implements AsyncResponse {
    /**
     ...
     * request ID.
     */
    public Optional<SendEmailEmarketingResponse> sendEmailEmarketingResponse() {
        return Optional.ofNullable(this.sendEmailEmarketingResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetEmarketingEmailStatusResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetEmarketingEmailStatusResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetEmarketingEmailStatusResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
    ...
    public final static class Builder {
         ...
         * request ID.
         */
        public Builder sendEmailEmarketingResponse(@Nullable SendEmailEmarketingResponse sendEmailEmarketingResponse) {
            this.sendEmailEmarketingResponse = sendEmailEmarketingResponse;
            return this;
        }
