...
public class Paging {
    ...
    public Paging(@Nonnull PaginationLinks links) {
     ...
     * Represents pagination links for navigating between pages of data.
     */
    public Paging withLinks(@Nonnull PaginationLinks links) {
    ...
    public static final class Builder {
        ...
        public Paging build() {
            return new Paging(previousToken, nextToken, currentToken, limit, totalCount, links);
        }
    }
}
