...
public class ListSessionsEnrollmentRequestBuilder {
     ...
     */
    public ListSessionsEnrollmentResponse call() {
     ...
     * <pre><code>
     * for (ListSessionsEnrollmentResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSessionsEnrollmentResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSessionsEnrollmentResponse> callAsStream() {
