...
public class ListEventVoucherAttendeesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListEventVoucherAttendeesRequest request;
    private final Options.Builder optionsBuilder;

    public ListEventVoucherAttendeesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListEventVoucherAttendeesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListEventVoucherAttendeesRequestBuilder request(@Nonnull ListEventVoucherAttendeesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListEventVoucherAttendeesRequest _buildRequest() {
        return this.request;
    }

    public ListEventVoucherAttendeesRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListEventVoucherAttendeesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListEventVoucherAttendeesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListEventVoucherAttendeesResponse&gt;() {
     ...
     */
    public Publisher<ListEventVoucherAttendeesResponse> callAsPublisher() {
        ListEventVoucherAttendeesRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListEventVoucherAttendeesRequest, ListEventVoucherAttendeesResponse> operation =
                new ListEventVoucherAttendees.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListEventVoucherAttendeesResponse> flowPublisher =
