...
public class Email1 {
     ...
     * The type of the email.
     */
    public Email1 withType(@Nullable EmailType1 type) {
        this.type = type;
        return this;
    }
     ...
     * The email of the user.
     */
    public Email1 withValue(@Nonnull String value) {
     ...
     * True indicates the email is primary.
     */
    public Email1 withPrimary(@Nullable Boolean primary) {
    ...
    public String toString() {
        return Utils.toString(Email1.class, "type", type, "value", value, "primary", primary);
    }
    ...
    public static final class Builder {
        ...
        public Email1 build() {
            return new Email1(type, value, primary);
        }
