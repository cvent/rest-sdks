...
public class FilterProgramItemDocumentsRequestBuilder {
     ...
     */
    public FilterProgramItemDocumentsResponse call() {
     ...
     * <pre><code>
     * for (FilterProgramItemDocumentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<FilterProgramItemDocumentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<FilterProgramItemDocumentsResponse> callAsStream() {
