...
public class DeleteSessionProgramSpeakerRequest {
     ...
     * The unique identifier of a program item.
     */
    public DeleteSessionProgramSpeakerRequest withProgramItemId(@Nonnull String programItemId) {
     ...
     * The unique identifier of a speaker.
     */
    public DeleteSessionProgramSpeakerRequest withId(@Nonnull String id) {
