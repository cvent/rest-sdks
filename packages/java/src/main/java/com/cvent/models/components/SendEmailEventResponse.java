...
public class SendEmailEventResponse {
    ...
    public SendEmailEventResponse(
            ...
            @JsonProperty("event") @Nonnull EventJson3 event,
     ...
     * Details of the event.
     */
    public SendEmailEventResponse withEvent(@Nonnull EventJson3 event) {
    ...
    public static final class Builder {
         ...
         * Details of the event.
         */
        public Builder event(@Nonnull EventJson3 event) {
            this.event = Utils.checkNotNull(event, "event");
            return this;
        }
