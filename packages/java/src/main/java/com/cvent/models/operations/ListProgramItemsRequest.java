...
public class ListProgramItemsRequest {
     ...
     * The maximum number of records to return per page.
     */
    public ListProgramItemsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListProgramItemsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public ListProgramItemsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
