...
public class ListMembershipItemsPostFilterRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListMembershipItemsPostFilterRequest request;
    private final Options.Builder optionsBuilder;

    public ListMembershipItemsPostFilterRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListMembershipItemsPostFilterRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListMembershipItemsPostFilterRequestBuilder request(@Nonnull ListMembershipItemsPostFilterRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListMembershipItemsPostFilterRequest _buildRequest() {
        return this.request;
    }

    public ListMembershipItemsPostFilterRequestBuilder header(String name, String value) {
     ...
     */
    public ListMembershipItemsPostFilterResponse call() {
     ...
     */
    public Iterable<ListMembershipItemsPostFilterResponse> callAsIterable() {
        ListMembershipItemsPostFilterRequest request = this.request;
        Options options = optionsBuilder.build();
        RequestOperation<ListMembershipItemsPostFilterRequest, ListMembershipItemsPostFilterResponse> operation =
                new ListMembershipItemsPostFilter.Sync(sdkConfiguration, options, _headers);
     ...
     * are returned.
     **/
    public Stream<ListMembershipItemsPostFilterResponse> callAsStream() {
