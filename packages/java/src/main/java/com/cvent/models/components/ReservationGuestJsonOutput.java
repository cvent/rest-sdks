...
public class ReservationGuestJsonOutput {
    ...
    @JsonCreator
    public ReservationGuestJsonOutput(
     ...
     * Payment information.
     */
    public Optional<ReservationPaymentInfoJsonOutput> paymentInfo() {
     ...
     * Arrival date in ISO 8601 format.
     */
    public ReservationGuestJsonOutput withArrival(@Nonnull LocalDate arrival) {
     ...
     * Departure date in ISO 8601 format.
     */
    public ReservationGuestJsonOutput withDeparture(@Nonnull LocalDate departure) {
     ...
     * First name of the guest.
     */
    public ReservationGuestJsonOutput withFirstName(@Nonnull String firstName) {
     ...
     * Last name of the guest.
     */
    public ReservationGuestJsonOutput withLastName(@Nonnull String lastName) {
     ...
     * Middle name of the guest.
     */
    public ReservationGuestJsonOutput withMiddleName(@Nullable String middleName) {
        this.middleName = middleName;
        return this;
    }
     ...
     * Title of the guest.
     */
    public ReservationGuestJsonOutput withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * Position of the guest.
     */
    public ReservationGuestJsonOutput withPosition(@Nullable String position) {
        this.position = position;
        return this;
    }
     ...
     * Organization or company name of the guest.
     */
    public ReservationGuestJsonOutput withCompany(@Nullable String company) {
        this.company = company;
        return this;
    }
     ...
     * Home fax number of the guest.
     */
    public ReservationGuestJsonOutput withHomeFax(@Nullable String homeFax) {
        this.homeFax = homeFax;
        return this;
    }
     ...
     * Email address of the guest.
     */
    public ReservationGuestJsonOutput withEmail(@Nonnull String email) {
     ...
     * Home phone number of the guest. Required if the hotel/event requires address in reservations.
     */
    public ReservationGuestJsonOutput withHomePhone(@Nullable String homePhone) {
        this.homePhone = homePhone;
        return this;
    }
     ...
     * Work phone number of the guest.
     */
    public ReservationGuestJsonOutput withWorkPhone(@Nullable String workPhone) {
        this.workPhone = workPhone;
        return this;
    }
     ...
     * address in reservations.
     */
    public ReservationGuestJsonOutput withHomeAddress(@Nullable AddressJson3 homeAddress) {
        this.homeAddress = homeAddress;
        return this;
    }
     ...
     * Payment information.
     */
    public ReservationGuestJsonOutput withPaymentInfo(@Nullable ReservationPaymentInfoJsonOutput paymentInfo) {
        this.paymentInfo = paymentInfo;
        return this;
    }
     ...
     * Code that specifies if the guest is an adult or child. (10 - adult, 8 - child)
     */
    public ReservationGuestJsonOutput withAgeQualifyingCode(@Nullable AgeQualifyingCode ageQualifyingCode) {
     ...
     * True indicates this guest is the primary guest for the reservation.
     */
    public ReservationGuestJsonOutput withPrimary(@Nullable Boolean primary) {
     ...
     * Locale code in IETF language tag format.
     */
    public ReservationGuestJsonOutput withLocale(@Nullable String locale) {
        this.locale = locale;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ReservationGuestJsonOutput other = (ReservationGuestJsonOutput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ReservationGuestJsonOutput.class,
                "arrival", arrival,
                "departure", departure,
                "firstName", firstName,
                "lastName", lastName,
    ...
    public final static class Builder {
         ...
         * Payment information.
         */
        public Builder paymentInfo(@Nullable ReservationPaymentInfoJsonOutput paymentInfo) {
            this.paymentInfo = paymentInfo;
            return this;
        }
        ...
        public ReservationGuestJsonOutput build() {
            return new ReservationGuestJsonOutput(
                arrival, departure, firstName,
                lastName, middleName, title,
                position, company, homeFax,
                email, homePhone, workPhone,
