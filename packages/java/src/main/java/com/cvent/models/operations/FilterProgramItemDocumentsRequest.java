...
public class FilterProgramItemDocumentsRequest {
     ...
     * beginning of time of the data store.
     */
    public FilterProgramItemDocumentsRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public FilterProgramItemDocumentsRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public FilterProgramItemDocumentsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public FilterProgramItemDocumentsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public FilterProgramItemDocumentsRequest withFilter(@Nullable Filter filter) {
        this.filter = filter;
        return this;
    }
