...
public class Capacity1 {
     ...
     * the consumed capacity has surpassed the total capacity.
     */
    public Capacity1 withRemaining(@Nullable Long remaining) {
        this.remaining = remaining;
        return this;
    }
     ...
     * The consumed capacity of an event item, such as registration type.
     */
    public Capacity1 withConsumed(@Nullable Long consumed) {
        this.consumed = consumed;
        return this;
    }
     ...
     * capacity.
     */
    public Capacity1 withTotal(long total) {
        this.total = total;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Capacity1.class, "remaining", remaining, "consumed", consumed, "total", total);
    }
    ...
    public static final class Builder {
        ...
        public Capacity1 build() {
            return new Capacity1(remaining, consumed, total);
        }
    }
}
