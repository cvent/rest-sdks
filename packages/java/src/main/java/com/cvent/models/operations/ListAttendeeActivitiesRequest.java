...
public class ListAttendeeActivitiesRequest {
     ...
     * beginning of time of the data store.
     */
    public ListAttendeeActivitiesRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public ListAttendeeActivitiesRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public ListAttendeeActivitiesRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListAttendeeActivitiesRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public ListAttendeeActivitiesRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
