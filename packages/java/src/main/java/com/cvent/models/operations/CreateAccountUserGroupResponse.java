...
public class CreateAccountUserGroupResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateAccountUserGroupResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
    ...
    public String toString() {
        return Utils.toString(CreateAccountUserGroupResponse.class,
    ...
    public final static class Builder {
        ...
        public CreateAccountUserGroupResponse build() {
            return new CreateAccountUserGroupResponse(
                contentType, statusCode, rawResponse,
                userGroupJson);
        }
