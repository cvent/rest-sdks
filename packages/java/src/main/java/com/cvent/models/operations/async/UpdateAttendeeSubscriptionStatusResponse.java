...
import com.cvent.models.components.AttendeeSubscriptionResponse;
...
public class UpdateAttendeeSubscriptionStatusResponse implements AsyncResponse {
    /**
     ...
     * Successfully updated the attendee's subscription status.
     */
    public Optional<AttendeeSubscriptionResponse> attendeeSubscriptionResponse() {
        return Optional.ofNullable(this.attendeeSubscriptionResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public UpdateAttendeeSubscriptionStatusResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public UpdateAttendeeSubscriptionStatusResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateAttendeeSubscriptionStatusResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
