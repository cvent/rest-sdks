...
public class ListQuantityItemsRequestBuilder {
     ...
     */
    public ListQuantityItemsResponse call() {
     ...
     * <pre><code>
     * for (ListQuantityItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListQuantityItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListQuantityItemsResponse> callAsStream() {
