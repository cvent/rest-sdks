...
public class GetRespondentsRequestBuilder {
     ...
     */
    public GetRespondentsResponse call() {
     ...
     * <pre><code>
     * for (GetRespondentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetRespondentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetRespondentsResponse> callAsStream() {
