...
public class ListTravelAccountsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListTravelAccountsRequest request;
    private final Options.Builder optionsBuilder;

    public ListTravelAccountsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListTravelAccountsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListTravelAccountsRequestBuilder request(@Nonnull ListTravelAccountsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTravelAccountsRequest _buildRequest() {
        return this.request;
    }

    public ListTravelAccountsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListTravelAccountsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListTravelAccountsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListTravelAccountsResponse&gt;() {
     ...
     */
    public Publisher<ListTravelAccountsResponse> callAsPublisher() {
        ListTravelAccountsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListTravelAccountsRequest, ListTravelAccountsResponse> operation =
                new ListTravelAccounts.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListTravelAccountsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
