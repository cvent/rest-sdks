...
public class AddSpeakerDocRequest {
    /**
    ...
    @JsonCreator
    public AddSpeakerDocRequest(@Nonnull String id, @Nonnull String fileId) {
     ...
     * The unique identifier of a speaker.
     */
    public AddSpeakerDocRequest withId(@Nonnull String id) {
     ...
     * The unique identifier of a file from <a href="#operation/uploadFile">file upload</a> service.
     */
    public AddSpeakerDocRequest withFileId(@Nonnull String fileId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddSpeakerDocRequest other = (AddSpeakerDocRequest) o;
    ...
    public String toString() {
        return Utils.toString(AddSpeakerDocRequest.class, "id", id, "fileId", fileId);
    }
    ...
    public static final class Builder {
        ...
        public AddSpeakerDocRequest build() {
            return new AddSpeakerDocRequest(id, fileId);
        }
    }
}
