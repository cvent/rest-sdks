...
public class ListExhibitorCategoriesRequestBuilder {
    ...
    public ListExhibitorCategoriesRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public ListExhibitorCategoriesResponse call() {
     ...
     * <pre><code>
     * for (ListExhibitorCategoriesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListExhibitorCategoriesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListExhibitorCategoriesResponse> callAsStream() {
