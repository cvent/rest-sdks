...
public class ExistingBoothStaffJson {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public ExistingBoothStaffJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public ExistingBoothStaffJson withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public ExistingBoothStaffJson withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public ExistingBoothStaffJson withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * A JSON Schema for an Attendee object
     */
    public ExistingBoothStaffJson withAttendee(@Nonnull AttendeeJson3 attendee) {
     ...
     * The Associated Event.
     */
    public ExistingBoothStaffJson withEvent(@Nonnull EventJson5 event) {
     ...
     * The Associated Exhibitor.
     */
    public ExistingBoothStaffJson withExhibitor(@Nonnull ExhibitorJson exhibitor) {
     ...
     * ID of an exhibitor booth staff member.
     */
    public ExistingBoothStaffJson withId(@Nullable String id) {
        this.id = id;
        return this;
    }
