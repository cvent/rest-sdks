...
public enum AttendeeResponseMethod1 {
    ...
    AttendeeResponseMethod1(String value) {
        this.value = value;
    }
    ...
    public static Optional<AttendeeResponseMethod1> fromValue(String value) {
        for (AttendeeResponseMethod1 o : AttendeeResponseMethod1.values()) {
