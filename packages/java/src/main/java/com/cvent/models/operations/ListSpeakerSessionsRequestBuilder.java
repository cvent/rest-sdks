...
public class ListSpeakerSessionsRequestBuilder {
     ...
     */
    public ListSpeakerSessionsResponse call() {
     ...
     * <pre><code>
     * for (ListSpeakerSessionsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSpeakerSessionsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSpeakerSessionsResponse> callAsStream() {
