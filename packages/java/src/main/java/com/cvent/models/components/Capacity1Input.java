...
public class Capacity1Input {
    ...
    @JsonCreator
    public Capacity1Input(@JsonProperty("total") long total) {
        this.total = total;
    }
     ...
     * capacity.
     */
    public Capacity1Input withTotal(long total) {
        this.total = total;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Capacity1Input other = (Capacity1Input) o;
    ...
    public String toString() {
        return Utils.toString(Capacity1Input.class, "total", total);
    }
    ...
    public static final class Builder {
        ...
        public Capacity1Input build() {
            return new Capacity1Input(total);
        }
    }
}
