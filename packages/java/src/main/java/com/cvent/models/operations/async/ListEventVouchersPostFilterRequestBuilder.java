...
public class ListEventVouchersPostFilterRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListEventVouchersPostFilterRequest request;
    private final Options.Builder optionsBuilder;

    public ListEventVouchersPostFilterRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListEventVouchersPostFilterRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListEventVouchersPostFilterRequestBuilder request(@Nonnull ListEventVouchersPostFilterRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListEventVouchersPostFilterRequest _buildRequest() {
        return this.request;
    }

    public ListEventVouchersPostFilterRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListEventVouchersPostFilterResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListEventVouchersPostFilterResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListEventVouchersPostFilterResponse&gt;() {
     ...
     */
    public Publisher<ListEventVouchersPostFilterResponse> callAsPublisher() {
        ListEventVouchersPostFilterRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListEventVouchersPostFilterRequest, ListEventVouchersPostFilterResponse> operation =
                new ListEventVouchersPostFilter.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListEventVouchersPostFilterResponse> flowPublisher =
