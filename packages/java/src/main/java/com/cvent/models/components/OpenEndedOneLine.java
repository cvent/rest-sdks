...
public class OpenEndedOneLine {
     ...
     * the planner UI.
     */
    public OpenEndedOneLine withAnswerFormat(@Nullable String answerFormat) {
        this.answerFormat = answerFormat;
        return this;
    }
     ...
     * Minimum number/characters allowed.
     */
    public OpenEndedOneLine withMinimum(@Nullable Long minimum) {
        this.minimum = minimum;
        return this;
    }
     ...
     * Maximum number/characters allowed.
     */
    public OpenEndedOneLine withMaximum(@Nullable Long maximum) {
        this.maximum = maximum;
        return this;
    }
