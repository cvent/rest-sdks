...
public class ListSessionsEnrollmentResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public ListSessionsEnrollmentResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListSessionsEnrollmentResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListSessionsEnrollmentResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
