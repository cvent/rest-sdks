...
public class OpenEndedDateTime1 {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("format")
    private DateTimeDisplayFormat format;
     ...
     * This is used to denote the display format type of date time type custom field.
     */
    public Optional<DateTimeDisplayFormat> format() {
     ...
     * The ISO 8601 zoned minimum date time accepted.
     */
    public OpenEndedDateTime1 withFrom(@Nullable OffsetDateTime from) {
        this.from = from;
        return this;
    }
     ...
     * The ISO 8601 zoned maximum date time accepted.
     */
    public OpenEndedDateTime1 withTo(@Nullable OffsetDateTime to) {
        this.to = to;
        return this;
    }
     ...
     * This is used to denote the display format type of date time type custom field.
     */
    public OpenEndedDateTime1 withFormat(@Nullable DateTimeDisplayFormat format) {
        this.format = format;
        return this;
    }
     ...
     * Whether it needs to be pre populated with current date.
     */
    public OpenEndedDateTime1 withDefaultToCurrentDate(@Nullable Boolean defaultToCurrentDate) {
        this.defaultToCurrentDate = defaultToCurrentDate;
        return this;
    }
     ...
     * True means that a pop-up calendar will be displayed to assist date selection on UI.
     */
    public OpenEndedDateTime1 withDisplayPopUpCalendar(@Nullable Boolean displayPopUpCalendar) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        OpenEndedDateTime1 other = (OpenEndedDateTime1) o;
    ...
    public static final class Builder {
         ...
         * This is used to denote the display format type of date time type custom field.
         */
        public Builder format(@Nullable DateTimeDisplayFormat format) {
            this.format = format;
            return this;
        }
        ...
        public OpenEndedDateTime1 build() {
            return new OpenEndedDateTime1(from, to, format, defaultToCurrentDate, displayPopUpCalendar);
        }
