...
public class GetAttendeeCreditsRequestBuilder {
     ...
     */
    public GetAttendeeCreditsResponse call() {
     ...
     * <pre><code>
     * for (GetAttendeeCreditsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAttendeeCreditsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAttendeeCreditsResponse> callAsStream() {
