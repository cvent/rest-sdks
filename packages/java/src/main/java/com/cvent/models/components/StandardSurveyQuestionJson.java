...
public class StandardSurveyQuestionJson {
    ...
    @JsonCreator
    public StandardSurveyQuestionJson(
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public StandardSurveyQuestionJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public StandardSurveyQuestionJson withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public StandardSurveyQuestionJson withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public StandardSurveyQuestionJson withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * Text field ID.
     */
    public StandardSurveyQuestionJson withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * text Value of the Field
     */
    public StandardSurveyQuestionJson withText(@Nullable String text) {
        this.text = text;
        return this;
    }
     ...
     * Reporting value of the Category, Its like a custom abbreviation
     */
    public StandardSurveyQuestionJson withShortText(@Nullable String shortText) {
        this.shortText = shortText;
        return this;
    }
     ...
     * Html of the question
     */
    public StandardSurveyQuestionJson withHtmlText(@Nullable String htmlText) {
        this.htmlText = htmlText;
        return this;
    }
     ...
     * Question Code
     */
    public StandardSurveyQuestionJson withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * List of choices for the question.
     */
    public StandardSurveyQuestionJson withChoices(@Nullable List<ChoiceJson3> choices) {
        this.choices = choices;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public StandardSurveyQuestionJson withNotApplicableAnswer(@Nullable AdditionalChoiceJson2 notApplicableAnswer) {
        this.notApplicableAnswer = notApplicableAnswer;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public StandardSurveyQuestionJson withOtherAnswer(@Nullable AdditionalChoiceJson2 otherAnswer) {
        this.otherAnswer = otherAnswer;
        return this;
    }
     ...
     * Text Value of Comments Input box placeholder
     */
    public StandardSurveyQuestionJson withComments(@Nullable String comments) {
        this.comments = comments;
        return this;
    }
     ...
     * Is this a mandatory question
     */
    public StandardSurveyQuestionJson withRequired(@Nullable Boolean required) {
     ...
     * Max possible score
     */
    public StandardSurveyQuestionJson withMaxScore(@Nullable Double maxScore) {
        this.maxScore = maxScore;
        return this;
    }
     ...
     * Total configured sum of all choices for number allocation question
     */
    public StandardSurveyQuestionJson withTotalSum(@Nullable Long totalSum) {
        this.totalSum = totalSum;
        return this;
    }
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public StandardSurveyQuestionJson withSurvey(@Nullable UuidJson survey) {
        this.survey = survey;
        return this;
    }
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public StandardSurveyQuestionJson withChapter(@Nullable UuidJson chapter) {
        this.chapter = chapter;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StandardSurveyQuestionJson other = (StandardSurveyQuestionJson) o;
    ...
    public String toString() {
        return Utils.toString(
                StandardSurveyQuestionJson.class,
                "created",
                created,
                "createdBy",
                createdBy,
    ...
    public static final class Builder {
        ...
        public StandardSurveyQuestionJson build() {
            return new StandardSurveyQuestionJson(
                    created,
                    createdBy,
                    lastModified,
                    lastModifiedBy,
