...
public class StandardSurveyQuestionJson {
     ...
     * Question Type.
     */
    public StandardSurveyQuestionJson withType(@Nullable QuestionTypeJson type) {
        this.type = type;
        return this;
    }
     ...
     * List of categories for the question.
     */
    public StandardSurveyQuestionJson withCategories(@Nullable List<CategoryJson> categories) {
        this.categories = categories;
        return this;
    }
