...
public class ListTablesRequestBuilder {
     ...
     */
    public ListTablesResponse call() {
     ...
     * <pre><code>
     * for (ListTablesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListTablesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListTablesResponse> callAsStream() {
