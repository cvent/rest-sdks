...
public class CardTransaction {
    ...
    @JsonProperty("event")
    private CardTransactionEvent event;
    ...
    private CardTransactionTransactionReconciliation reconciliation;
    ...
    private List<TransactionReconciliation> reconciliations;
    ...
    public CardTransaction(
            @JsonProperty("event") @Nullable CardTransactionEvent event,
            ...
            @JsonProperty("reconciliation") @Nullable CardTransactionTransactionReconciliation reconciliation,
            @JsonProperty("reconciliations") @Nullable List<TransactionReconciliation> reconciliations,
     ...
     * The identifier of the Event.
     */
    public Optional<CardTransactionEvent> event() {
    ...
    public Optional<CardTransactionTransactionReconciliation> reconciliation() {
     ...
     * The list of reconciled item.
     */
    public Optional<List<TransactionReconciliation>> reconciliations() {
     ...
     * The identifier of the Event.
     */
    public CardTransaction withEvent(@Nullable CardTransactionEvent event) {
        this.event = event;
        return this;
    }
     ...
     * The identifier of the Card.
     */
    public CardTransaction withCard(@Nullable Card card) {
        this.card = card;
        return this;
    }
     ...
     * Card transaction ID.
     */
    public CardTransaction withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The ISO 8601 zoned date and time for Card transaction date.
     */
    public CardTransaction withTransactionDate(@Nullable OffsetDateTime transactionDate) {
        this.transactionDate = transactionDate;
        return this;
    }
     ...
     * Transaction amount.
     */
    public CardTransaction withAmount(@Nullable Double amount) {
        this.amount = amount;
        return this;
    }
     ...
     * The ISO 4217 standard format currency code used of transaction currency.
     */
    public CardTransaction withCurrency(@Nullable String currency) {
        this.currency = currency;
        return this;
    }
     ...
     * Merchant name.
     */
    public CardTransaction withMerchant(@Nullable String merchant) {
        this.merchant = merchant;
        return this;
    }

    public CardTransaction withReconciliation(@Nullable CardTransactionTransactionReconciliation reconciliation) {
        this.reconciliation = reconciliation;
        return this;
    }
     ...
     * The list of reconciled item.
     */
    public CardTransaction withReconciliations(@Nullable List<TransactionReconciliation> reconciliations) {
        this.reconciliations = reconciliations;
        return this;
    }
     ...
     * The list of transaction description.
     */
    public CardTransaction withDescriptions(@Nullable List<String> descriptions) {
        this.descriptions = descriptions;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * The identifier of the Event.
         */
        public Builder event(@Nullable CardTransactionEvent event) {
            this.event = event;
            return this;
        }
        ...
        public Builder reconciliation(@Nullable CardTransactionTransactionReconciliation reconciliation) {
            this.reconciliation = reconciliation;
            return this;
        }
         ...
         * The list of reconciled item.
         */
        public Builder reconciliations(@Nullable List<TransactionReconciliation> reconciliations) {
            this.reconciliations = reconciliations;
            return this;
        }
