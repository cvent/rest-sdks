...
public class GetBadgePrinterPoolsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetBadgePrinterPoolsRequest request;

    public GetBadgePrinterPoolsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public GetBadgePrinterPoolsRequestBuilder request(@Nonnull GetBadgePrinterPoolsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetBadgePrinterPoolsRequest _buildRequest() {
        return this.request;
    }
    
    public GetBadgePrinterPoolsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<GetBadgePrinterPoolsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetBadgePrinterPoolsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetBadgePrinterPoolsResponse&gt;() {
     ...
     */
    public Publisher<GetBadgePrinterPoolsResponse> callAsPublisher() {
        GetBadgePrinterPoolsRequest request = this.request;
        AsyncRequestOperation<GetBadgePrinterPoolsRequest, GetBadgePrinterPoolsResponse> operation
              = new GetBadgePrinterPools.Async(sdkConfiguration, _headers);
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            GetBadgePrinterPoolsRequest::withToken,
            operation::doRequest);

        Flow.Publisher<GetBadgePrinterPoolsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
