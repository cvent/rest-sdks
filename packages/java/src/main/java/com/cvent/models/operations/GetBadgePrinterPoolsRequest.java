...
public class GetBadgePrinterPoolsRequest {
     ...
     * Id of an event
     */
    public GetBadgePrinterPoolsRequest withEventId(@Nonnull String eventId) {
     ...
     * The maximum number of records to return per page.
     */
    public GetBadgePrinterPoolsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetBadgePrinterPoolsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * disabled (eq|ne)
     */
    public GetBadgePrinterPoolsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
