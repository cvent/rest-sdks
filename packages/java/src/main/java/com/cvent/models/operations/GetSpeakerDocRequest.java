...
public class GetSpeakerDocRequest {
    /**
    ...
    @JsonCreator
    public GetSpeakerDocRequest(@Nonnull String id, @Nonnull String fileId) {
     ...
     * The unique identifier of a speaker.
     */
    public GetSpeakerDocRequest withId(@Nonnull String id) {
     ...
     * The unique identifier of a file from <a href="#operation/uploadFile">file upload</a> service.
     */
    public GetSpeakerDocRequest withFileId(@Nonnull String fileId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetSpeakerDocRequest other = (GetSpeakerDocRequest) o;
    ...
    public String toString() {
        return Utils.toString(GetSpeakerDocRequest.class, "id", id, "fileId", fileId);
    }
    ...
    public static final class Builder {
        ...
        public GetSpeakerDocRequest build() {
            return new GetSpeakerDocRequest(id, fileId);
        }
    }
}
