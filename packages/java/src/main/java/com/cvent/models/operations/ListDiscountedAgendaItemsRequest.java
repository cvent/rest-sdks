...
public class ListDiscountedAgendaItemsRequest {
     ...
     * Unique ID of an event.
     */
    public ListDiscountedAgendaItemsRequest withId(@Nonnull String id) {
     ...
     * The maximum number of records to return per page.
     */
    public ListDiscountedAgendaItemsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListDiscountedAgendaItemsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public ListDiscountedAgendaItemsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
