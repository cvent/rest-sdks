...
public class ErrorResponse11 {
    ...
    public ErrorResponse11(long code, @Nonnull String message) {
     ...
     * The HTTP status code representing the error.
     */
    public ErrorResponse11 withCode(long code) {
        this.code = code;
        return this;
    }
     ...
     * A brief description of the error.
     */
    public ErrorResponse11 withMessage(@Nonnull String message) {
     ...
     * The target resource of the error.
     */
    public ErrorResponse11 withTarget(@Nullable String target) {
        this.target = target;
        return this;
    }
     ...
     * Additional details of cascading error messages.
     */
    public ErrorResponse11 withDetails(@Nullable List<ErrorResponseBase> details) {
        this.details = details;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ErrorResponse11 other = (ErrorResponse11) o;
    ...
    public String toString() {
        return Utils.toString(
                ErrorResponse11.class, "code", code, "message", message, "target", target, "details", details);
    }
    ...
    public static final class Builder {
        ...
        public ErrorResponse11 build() {
            return new ErrorResponse11(code, message, target, details);
        }
    }
}
