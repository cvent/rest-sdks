...
public class GetCurrencyConversionRateRequestBuilder {
     ...
     */
    public GetCurrencyConversionRateResponse call() {
     ...
     * <pre><code>
     * for (GetCurrencyConversionRateResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetCurrencyConversionRateResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetCurrencyConversionRateResponse> callAsStream() {
