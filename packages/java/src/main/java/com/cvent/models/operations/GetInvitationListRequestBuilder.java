...
public class GetInvitationListRequestBuilder {
     ...
     */
    public GetInvitationListResponse call() {
     ...
     * <pre><code>
     * for (GetInvitationListResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetInvitationListResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetInvitationListResponse> callAsStream() {
