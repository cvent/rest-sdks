...
public class ListExternalAttendeeActivitiesMetadataRequest {
     ...
     * beginning of time of the data store.
     */
    public ListExternalAttendeeActivitiesMetadataRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public ListExternalAttendeeActivitiesMetadataRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public ListExternalAttendeeActivitiesMetadataRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListExternalAttendeeActivitiesMetadataRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
