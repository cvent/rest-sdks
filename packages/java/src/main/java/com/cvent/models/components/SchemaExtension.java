...
public class SchemaExtension {
     ...
     * The id of the schema extension
     */
    public SchemaExtension withSchema(@Nullable String schema) {
        this.schema = schema;
        return this;
    }
     ...
     * True indicates if the schema extension is required.
     */
    public SchemaExtension withRequired(@Nullable Boolean required) {
        this.required = required;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SchemaExtension other = (SchemaExtension) o;
    ...
    public String toString() {
        return Utils.toString(SchemaExtension.class, "schema", schema, "required", required);
    }
    ...
    public static final class Builder {
        ...
        public SchemaExtension build() {
            return new SchemaExtension(schema, required);
        }
    }
}
