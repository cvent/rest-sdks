 ...
 */
@Deprecated
public class Planner1WorkAddressAddress {
    /**
    ...
    @JsonCreator
    public Planner1WorkAddressAddress(
     ...
     * The first line of an address.
     */
    public Planner1WorkAddressAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public Planner1WorkAddressAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public Planner1WorkAddressAddress withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public Planner1WorkAddressAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public Planner1WorkAddressAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public Planner1WorkAddressAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public Planner1WorkAddressAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public Planner1WorkAddressAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country of the address.
     */
    public Planner1WorkAddressAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public Planner1WorkAddressAddress withLatitude(@Nullable Long latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public Planner1WorkAddressAddress withLongitude(@Nullable Long longitude) {
        this.longitude = longitude;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Planner1WorkAddressAddress other = (Planner1WorkAddressAddress) o;
    ...
    public String toString() {
        return Utils.toString(
                Planner1WorkAddressAddress.class,
                "address1",
                address1,
                "address2",
                address2,
    ...
    public static final class Builder {
        ...
        public Planner1WorkAddressAddress build() {
            return new Planner1WorkAddressAddress(
                    address1,
                    address2,
                    address3,
                    city,
