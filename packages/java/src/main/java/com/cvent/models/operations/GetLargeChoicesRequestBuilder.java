...
public class GetLargeChoicesRequestBuilder {
     ...
     */
    public GetLargeChoicesResponse call() {
     ...
     * <pre><code>
     * for (GetLargeChoicesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetLargeChoicesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetLargeChoicesResponse> callAsStream() {
