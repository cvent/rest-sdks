...
public class ListSpeakersPostFilterRequestBuilder {
     ...
     */
    public ListSpeakersPostFilterResponse call() {
     ...
     * <pre><code>
     * for (ListSpeakersPostFilterResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSpeakersPostFilterResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSpeakersPostFilterResponse> callAsStream() {
