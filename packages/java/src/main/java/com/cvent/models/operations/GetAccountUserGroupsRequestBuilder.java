...
public class GetAccountUserGroupsRequestBuilder {
     ...
     */
    public GetAccountUserGroupsResponse call() {
     ...
     * <pre><code>
     * for (GetAccountUserGroupsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAccountUserGroupsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAccountUserGroupsResponse> callAsStream() {
