...
public class GetCustomFieldResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetCustomFieldResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetCustomFieldResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCustomFieldResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successfully retrieved a custom field.
     */
    public GetCustomFieldResponse withExistingCustomField(@Nullable ExistingCustomField existingCustomField) {
        this.existingCustomField = existingCustomField;
        return this;
    }
