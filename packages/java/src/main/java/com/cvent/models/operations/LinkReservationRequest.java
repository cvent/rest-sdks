...
public class LinkReservationRequest {
     ...
     * Unique room reservation request ID.
     */
    public LinkReservationRequest withReservationRequestsId(@Nonnull String reservationRequestsId) {
     ...
     * Cvent Passkey confirmation number.
     */
    public LinkReservationRequest withReservationId(@Nonnull String reservationId) {
