...
public class GetAirActualDetailResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAirActualDetailResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
