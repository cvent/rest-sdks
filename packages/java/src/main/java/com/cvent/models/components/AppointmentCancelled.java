...
public class AppointmentCancelled {
     ...
     * An activity appointment.
     */
    public AppointmentCancelled withAppointment(@Nullable ActivityAppointmentJson appointment) {
        this.appointment = appointment;
        return this;
    }
     ...
     * An activity contact.
     */
    public AppointmentCancelled withContact(@Nullable ActivityContactJson contact) {
        this.contact = contact;
        return this;
    }
