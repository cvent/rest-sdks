...
public class CreateProgramItemResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateProgramItemResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
