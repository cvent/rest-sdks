...
public class ExhibitorCategoryRequest {
    ...
    public ExhibitorCategoryRequest(
            @Nonnull Event4 event, @Nonnull String name, long order, @Nonnull ExhibitorCategoryRequestType type) {
     ...
     * The Associated Event.
     */
    public ExhibitorCategoryRequest withEvent(@Nonnull Event4 event) {
