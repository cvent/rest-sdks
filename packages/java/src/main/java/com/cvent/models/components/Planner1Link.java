...
public class Planner1Link {
    ...
    @JsonCreator
    public Planner1Link(@JsonProperty("href") @Nonnull String href) {
     ...
     * The url of the contact's profile picture
     */
    public Planner1Link withHref(@Nonnull String href) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Planner1Link other = (Planner1Link) o;
    ...
    public String toString() {
        return Utils.toString(Planner1Link.class, "href", href);
    }
    ...
    public static final class Builder {
        ...
        public Planner1Link build() {
            return new Planner1Link(href);
        }
    }
}
