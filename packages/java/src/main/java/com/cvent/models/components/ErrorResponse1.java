...
public class ErrorResponse1 {
    ...
    public ErrorResponse1(long code, @Nonnull String message) {
     ...
     * The HTTP status code representing the error.
     */
    public ErrorResponse1 withCode(long code) {
        this.code = code;
        return this;
    }
     ...
     * A brief description of the error.
     */
    public ErrorResponse1 withMessage(@Nonnull String message) {
     ...
     * The target resource of the error.
     */
    public ErrorResponse1 withTarget(@Nullable String target) {
        this.target = target;
        return this;
    }
     ...
     * Additional details of cascading error messages.
     */
    public ErrorResponse1 withDetails(@Nullable List<ErrorResponseBase> details) {
        this.details = details;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(
                ErrorResponse1.class, "code", code, "message", message, "target", target, "details", details);
    }
    ...
    public static final class Builder {
        ...
        public ErrorResponse1 build() {
            return new ErrorResponse1(code, message, target, details);
        }
    }
}
