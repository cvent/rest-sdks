 ...
 * BaseAddressJson
 *
 * <p>Base Address Model
 */
public class BaseAddressJson {
    /**
     ...
     * The first line of an address.
     */
    public BaseAddressJson withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public BaseAddressJson withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public BaseAddressJson withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public BaseAddressJson withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public BaseAddressJson withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public BaseAddressJson withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BaseAddressJson other = (BaseAddressJson) o;
    ...
    @Override
    public int hashCode() {
        return Utils.enhancedHash(address1, address2, address3, city, countryCode, postalCode);
    }

    @Override
    public String toString() {
        return Utils.toString(
                BaseAddressJson.class,
                "address1",
                address1,
                "address2",
                address2,
    ...
    public static final class Builder {
        ...
        public BaseAddressJson build() {
            return new BaseAddressJson(address1, address2, address3, city, countryCode, postalCode);
        }
    }
}
