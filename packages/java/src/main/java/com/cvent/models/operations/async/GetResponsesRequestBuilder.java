...
public class GetResponsesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetResponsesRequest request;
    private final Options.Builder optionsBuilder;

    public GetResponsesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetResponsesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetResponsesRequestBuilder request(@Nonnull GetResponsesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetResponsesRequest _buildRequest() {
        return this.request;
    }

    public GetResponsesRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetResponsesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetResponsesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetResponsesResponse&gt;() {
     ...
     */
    public Publisher<GetResponsesResponse> callAsPublisher() {
        GetResponsesRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetResponsesRequest, GetResponsesResponse> operation =
                new GetResponses.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetResponsesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
