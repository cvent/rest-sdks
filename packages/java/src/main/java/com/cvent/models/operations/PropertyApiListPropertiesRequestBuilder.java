...
public class PropertyApiListPropertiesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private PropertyApiListPropertiesRequest request;
    private final Options.Builder optionsBuilder;

    public PropertyApiListPropertiesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public PropertyApiListPropertiesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public PropertyApiListPropertiesRequestBuilder request(@Nonnull PropertyApiListPropertiesRequest request) {
     ...
     */
    public PropertyApiListPropertiesResponse call() {
     ...
     * <pre><code>
     * for (PropertyApiListPropertiesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<PropertyApiListPropertiesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<PropertyApiListPropertiesResponse> callAsStream() {
