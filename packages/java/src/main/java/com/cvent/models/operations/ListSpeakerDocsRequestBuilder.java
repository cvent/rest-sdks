...
public class ListSpeakerDocsRequestBuilder {
     ...
     */
    public ListSpeakerDocsResponse call() {
     ...
     * <pre><code>
     * for (ListSpeakerDocsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSpeakerDocsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSpeakerDocsResponse> callAsStream() {
