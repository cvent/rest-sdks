...
public class GetHousingEventInventoryResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public GetHousingEventInventoryResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetHousingEventInventoryResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetHousingEventInventoryResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
