...
public class GetStandardSurveyResponsesResponse implements AsyncResponse {
    /**
     ...
     * Successfully retrieved a paginated response of all the standalone survey responses.
     */
    public Optional<StandardSurveyResponsesPaginatedResponse> standardSurveyResponsesPaginatedResponse() {
        return Optional.ofNullable(this.standardSurveyResponsesPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetStandardSurveyResponsesResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetStandardSurveyResponsesResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetStandardSurveyResponsesResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
