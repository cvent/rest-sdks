...
public class GetEventPlanningDocumentsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetEventPlanningDocumentsRequest request;
    private final Options.Builder optionsBuilder;

    public GetEventPlanningDocumentsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetEventPlanningDocumentsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetEventPlanningDocumentsRequestBuilder request(@Nonnull GetEventPlanningDocumentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetEventPlanningDocumentsRequest _buildRequest() {
        return this.request;
    }

    public GetEventPlanningDocumentsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetEventPlanningDocumentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetEventPlanningDocumentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetEventPlanningDocumentsResponse&gt;() {
     ...
     */
    public Publisher<GetEventPlanningDocumentsResponse> callAsPublisher() {
        GetEventPlanningDocumentsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetEventPlanningDocumentsRequest, GetEventPlanningDocumentsResponse> operation =
                new GetEventPlanningDocuments.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetEventPlanningDocumentsResponse> flowPublisher =
