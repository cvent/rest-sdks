 ...
 * the `value` array.
 */
public class MeetingRequestQuestion {
    /**
    ...
    @JsonCreator
    public MeetingRequestQuestion(
            @JsonProperty("id") @Nonnull String id,
            @JsonProperty("name") @Nullable String name,
            @JsonProperty("type") @Nullable QuestionType1 type,
            ...
            @JsonProperty("compositeValue") @Nullable CompositeValue compositeValue) {
    ...
    public MeetingRequestQuestion(@Nonnull String id, @Nonnull List<String> value) {
     ...
     * Denotes the type of data collected by a question.
     */
    public Optional<QuestionType1> type() {
     ...
     * <p>The structure of the array depends on the question `type`.
     */
    public Optional<CompositeValue> compositeValue() {
     ...
     * * Budget Estimates — `1479fb2d-e94c-4bfb-a63f-4af808a22160`
     */
    public MeetingRequestQuestion withId(@Nonnull String id) {
     ...
     * The display text of the question.
     */
    public MeetingRequestQuestion withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Denotes the type of data collected by a question.
     */
    public MeetingRequestQuestion withType(@Nullable QuestionType1 type) {
        this.type = type;
        return this;
    }
     ...
     * in parsed form.
     */
    public MeetingRequestQuestion withValue(@Nonnull List<String> value) {
     ...
     * <p>In all other cases, `answerType` is not expected to be set.
     */
    public MeetingRequestQuestion withAnswerType(@Nullable AnswerType12 answerType) {
        this.answerType = answerType;
        return this;
    }
     ...
     * `Other` as an answer type.
     */
    public MeetingRequestQuestion withSecondaryValue(@Nullable String secondaryValue) {
        this.secondaryValue = secondaryValue;
        return this;
    }
     ...
     * <p>The structure of the array depends on the question `type`.
     */
    public MeetingRequestQuestion withCompositeValue(@Nullable CompositeValue compositeValue) {
        this.compositeValue = compositeValue;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MeetingRequestQuestion other = (MeetingRequestQuestion) o;
    ...
    public static final class Builder {
         ...
         * Denotes the type of data collected by a question.
         */
        public Builder type(@Nullable QuestionType1 type) {
            this.type = type;
            return this;
        }
         ...
         * <p>The structure of the array depends on the question `type`.
         */
        public Builder compositeValue(@Nullable CompositeValue compositeValue) {
            this.compositeValue = compositeValue;
            return this;
        }

        public MeetingRequestQuestion build() {
            return new MeetingRequestQuestion(id, name, type, value, answerType, secondaryValue, compositeValue);
        }
    }
}
