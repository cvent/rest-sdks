...
public class GetEventSurveysResponse implements Response {
    /**
     ...
     * the survey id).
     */
    public Optional<EventSurveysPaginatedResponse> eventSurveysPaginatedResponse() {
        return Optional.ofNullable(this.eventSurveysPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetEventSurveysResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetEventSurveysResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetEventSurveysResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
