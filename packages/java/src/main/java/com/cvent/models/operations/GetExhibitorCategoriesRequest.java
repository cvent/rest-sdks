...
public class GetExhibitorCategoriesRequest {
     ...
     * ID of an event.
     */
    public GetExhibitorCategoriesRequest withId(@Nonnull String id) {
     ...
     * The maximum number of records to return per page.
     */
    public GetExhibitorCategoriesRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetExhibitorCategoriesRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
