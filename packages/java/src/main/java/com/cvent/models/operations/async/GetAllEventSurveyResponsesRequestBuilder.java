...
public class GetAllEventSurveyResponsesRequestBuilder {
    ...
    */
     ...
     * <pre><code>
     * Publisher&lt;GetAllEventSurveyResponsesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetAllEventSurveyResponsesResponse&gt;() {
    ...
    public Publisher<GetAllEventSurveyResponsesResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            GetAllEventSurveyResponsesRequest::withToken,
            operation::doRequest);

        Flow.Publisher<GetAllEventSurveyResponsesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
