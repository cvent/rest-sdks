...
public class ListAppointmentsRequestBuilder {
     ...
     */
    public ListAppointmentsResponse call() {
     ...
     * <pre><code>
     * for (ListAppointmentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAppointmentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAppointmentsResponse> callAsStream() {
