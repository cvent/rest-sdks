 ...
 * 
 * <p>Representation of an existing discount code.
 */
public class ExistingDiscountCodeJson implements ExistingDiscountPaginatedResponseData {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("level")
    private ExistingDiscountCodeJsonLevel level;
     ...
     */
    @JsonProperty("type")
    private ExistingDiscountCodeJsonType type;

    /**
     * True indicates that the discount is applied to all events. this is specific to account level
     * discount.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("applyToAllEvents")
    private Boolean applyToAllEvents;

    @JsonCreator
    public ExistingDiscountCodeJson(
            ...
            @JsonProperty("level") @Nullable ExistingDiscountCodeJsonLevel level,
            @JsonProperty("capacity") @Nullable DiscountCapacityJson capacity,
            @JsonProperty("type") @Nonnull ExistingDiscountCodeJsonType type,
            @JsonProperty("applyToAllEvents") @Nullable Boolean applyToAllEvents) {
    ...
    public ExistingDiscountCodeJson(
            ...
            @Nonnull String code,
            @Nonnull ExistingDiscountCodeJsonType type) {
        this(null, null, null,
            null, name, null,
            null, method, null,
            null, null, code,
     ...
     * Whether the discount is created at event level or account level.
     */
    public Optional<ExistingDiscountCodeJsonLevel> level() {
     ...
     * discount.
     */
    public Optional<Boolean> applyToAllEvents() {
        return Optional.ofNullable(this.applyToAllEvents);
    }
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public ExistingDiscountCodeJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public ExistingDiscountCodeJson withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public ExistingDiscountCodeJson withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public ExistingDiscountCodeJson withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * Name of the discount.
     */
    public ExistingDiscountCodeJson withName(@Nonnull String name) {
     ...
     * True indicates that the discount is active.
     */
    public ExistingDiscountCodeJson withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
     ...
     * True indicates that the discount can be clubbed together with other stackable discounts
     */
    public ExistingDiscountCodeJson withStackable(@Nullable Boolean stackable) {
     ...
     * Details about how the discount applies.
     */
    public ExistingDiscountCodeJson withMethod(@Nonnull DiscountMethodJson method) {
     ...
     * The ISO 8601 formatted date from which the discount is effective.
     */
    public ExistingDiscountCodeJson withEffectiveFrom(@Nullable LocalDate effectiveFrom) {
        this.effectiveFrom = effectiveFrom;
        return this;
    }
     ...
     * The ISO 8601 formatted date to which the discount is effective.
     */
    public ExistingDiscountCodeJson withEffectiveTo(@Nullable LocalDate effectiveTo) {
        this.effectiveTo = effectiveTo;
        return this;
    }
     ...
     * Note about the discount.
     */
    public ExistingDiscountCodeJson withNote(@Nullable String note) {
        this.note = note;
        return this;
    }
     ...
     * Code of the discount.
     */
    public ExistingDiscountCodeJson withCode(@Nonnull String code) {
     ...
     * <p>`ALL`: An attendee who's the guest of a primary registrant.
     */
    public ExistingDiscountCodeJson withAudienceType(@Nullable DiscountAudienceTypeJson audienceType) {
     ...
     * code's capacity.
     */
    public ExistingDiscountCodeJson withIncludeGuestsTowardsCapacity(@Nullable Boolean includeGuestsTowardsCapacity) {
     ...
     * True indicates that the discount is auto-applied to registrants.
     */
    public ExistingDiscountCodeJson withAutoApply(@Nullable Boolean autoApply) {
     ...
     * event level discount.
     */
    public ExistingDiscountCodeJson withApplyToAllAgendaItems(@Nullable Boolean applyToAllAgendaItems) {
     ...
     * A unique identifier of the discount.
     */
    public ExistingDiscountCodeJson withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Whether the discount is created at event level or account level.
     */
    public ExistingDiscountCodeJson withLevel(@Nullable ExistingDiscountCodeJsonLevel level) {
        this.level = level;
        return this;
    }
     ...
     * Details about the discount capacity.
     */
    public ExistingDiscountCodeJson withCapacity(@Nullable DiscountCapacityJson capacity) {
        this.capacity = capacity;
        return this;
    }
     ...
     * <p>`VOLUME_DISCOUNT`: A discount that applies when a certain volume of items are purchased.
     */
    public ExistingDiscountCodeJson withType(@Nonnull ExistingDiscountCodeJsonType type) {
     ...
     * discount.
     */
    public ExistingDiscountCodeJson withApplyToAllEvents(@Nullable Boolean applyToAllEvents) {
        this.applyToAllEvents = applyToAllEvents;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExistingDiscountCodeJson other = (ExistingDiscountCodeJson) o;
        return 
            ...
            Utils.enhancedDeepEquals(this.applyToAllEvents, other.applyToAllEvents);
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            capacity, type, applyToAllEvents);
    }
    
    @Override
    public String toString() {
        return Utils.toString(ExistingDiscountCodeJson.class,
                "created", created,
                "createdBy", createdBy,
    ...
    public final static class Builder {
         ...
         * Whether the discount is created at event level or account level.
         */
        public Builder level(@Nullable ExistingDiscountCodeJsonLevel level) {
            this.level = level;
            return this;
        }
         ...
         * <p>`VOLUME_DISCOUNT`: A discount that applies when a certain volume of items are purchased.
         */
        public Builder type(@Nonnull ExistingDiscountCodeJsonType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * discount.
         */
        public Builder applyToAllEvents(@Nullable Boolean applyToAllEvents) {
            this.applyToAllEvents = applyToAllEvents;
            return this;
        }

        public ExistingDiscountCodeJson build() {
            return new ExistingDiscountCodeJson(
                created, createdBy, lastModified,
                lastModifiedBy, name, active,
                stackable, method, effectiveFrom,
                effectiveTo, note, code,
