...
public class ListAppointmentAttendeesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListAppointmentAttendeesRequest request;
    private final Options.Builder optionsBuilder;

    public ListAppointmentAttendeesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListAppointmentAttendeesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListAppointmentAttendeesRequestBuilder request(@Nonnull ListAppointmentAttendeesRequest request) {
     ...
     */
    public ListAppointmentAttendeesResponse call() {
     ...
     * <pre><code>
     * for (ListAppointmentAttendeesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAppointmentAttendeesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAppointmentAttendeesResponse> callAsStream() {
