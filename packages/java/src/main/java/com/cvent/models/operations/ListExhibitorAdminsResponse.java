...
public class ListExhibitorAdminsResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListExhibitorAdminsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
