...
public class ListAudienceSegmentsPostFilterRequestBuilder {
     ...
     */
    public ListAudienceSegmentsPostFilterResponse call() {
     ...
     * <pre><code>
     * for (ListAudienceSegmentsPostFilterResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAudienceSegmentsPostFilterResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAudienceSegmentsPostFilterResponse> callAsStream() {
