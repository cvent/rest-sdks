...
public class Attendee1 {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public Attendee1 withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public Attendee1 withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public Attendee1 withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public Attendee1 withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The ID of attendee in the given event.
     */
    public Attendee1 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The attendee's associated event.
     */
    public Attendee1 withEvent(@Nullable AttendeeEvent event) {
        this.event = event;
        return this;
    }
     ...
     * registration for the event. Serves as proof of registration.
     */
    public Attendee1 withConfirmationNumber(@Nullable String confirmationNumber) {
        this.confirmationNumber = confirmationNumber;
        return this;
    }
     ...
     * True indicates the attendee checked in to the event.
     */
    public Attendee1 withCheckedIn(@Nullable Boolean checkedIn) {
        this.checkedIn = checkedIn;
        return this;
    }
     ...
     */
    @Deprecated
    public Attendee1 withCheckin(@Nullable OffsetDateTime checkin) {
        this.checkin = checkin;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when attendee checked out from an event.
     */
    public Attendee1 withCheckOut(@Nullable OffsetDateTime checkOut) {
        this.checkOut = checkOut;
        return this;
    }
     ...
     * The duration, in milliseconds, the attendee was present at the event.
     */
    public Attendee1 withDuration(@Nullable Long duration) {
        this.duration = duration;
        return this;
    }
     ...
     * used to reach the event registration.
     */
    public Attendee1 withReferenceId(@Nullable String referenceId) {
        this.referenceId = referenceId;
        return this;
    }
     ...
     * A planner created note for an attendee, used to track details about the attendee.
     */
    public Attendee1 withNote(@Nullable String note) {
        this.note = note;
        return this;
    }
     ...
     * True indicates the attendee is a guest of another attendee.
     */
    public Attendee1 withGuest(@Nullable Boolean guest) {
        this.guest = guest;
        return this;
    }
     ...
     * True indicates this attendee is a deleted guest.
     */
    public Attendee1 withDeletedGuest(@Nullable Boolean deletedGuest) {
        this.deletedGuest = deletedGuest;
        return this;
    }
     ...
     * attendee is a guest.
     */
    public Attendee1 withPrimaryId(@Nullable String primaryId) {
        this.primaryId = primaryId;
        return this;
    }
     ...
     */
    @Deprecated
    public Attendee1 withUnsubscribed(@Nullable Boolean unsubscribed) {
        this.unsubscribed = unsubscribed;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when attendee was registered.
     */
    public Attendee1 withRegisteredAt(@Nullable OffsetDateTime registeredAt) {
        this.registeredAt = registeredAt;
        return this;
    }
     ...
     * there are changes to the registration, such as adding or removing products.
     */
    public Attendee1 withRegistrationLastModified(@Nullable OffsetDateTime registrationLastModified) {
        this.registrationLastModified = registrationLastModified;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when attendee registration was cancelled.
     */
    public Attendee1 withRegistrationCancelledAt(@Nullable OffsetDateTime registrationCancelledAt) {
        this.registrationCancelledAt = registrationCancelledAt;
        return this;
    }
     ...
     * Contains details related to the attendee's admission item.
     */
    public Attendee1 withAdmissionItem(@Nullable AttendeeLookup admissionItem) {
        this.admissionItem = admissionItem;
        return this;
    }
     ...
     * The attendee's biographical writeup.
     */
    public Attendee1 withBio(@Nullable String bio) {
        this.bio = bio;
        return this;
    }
     ...
     */
    @Deprecated
    public Attendee1 withShowPopupNotification(@Nullable Boolean showPopupNotification) {
        this.showPopupNotification = showPopupNotification;
        return this;
    }
     ...
     * An attendee's website URL, appears on their profile.
     */
    public Attendee1 withWebsiteUrl(@Nullable String websiteUrl) {
        this.websiteUrl = websiteUrl;
        return this;
    }
     ...
     * other event activities in the Attendee Hub app.
     */
    public Attendee1 withAllowPushNotifications(@Nullable Boolean allowPushNotifications) {
        this.allowPushNotifications = allowPushNotifications;
        return this;
    }
     ...
     * Attendee Hub app.
     */
    public Attendee1 withAllowAppointmentPushNotifications(@Nullable Boolean allowAppointmentPushNotifications) {
        this.allowAppointmentPushNotifications = allowAppointmentPushNotifications;
        return this;
    }
     ...
     * True indicates this attendee record was created as part of a test scenario.
     */
    public Attendee1 withTestRecord(@Nullable Boolean testRecord) {
        this.testRecord = testRecord;
        return this;
    }
     ...
     * <p>It is not updated for registration or product changes.
     */
    public Attendee1 withAttendeeLastModified(@Nullable OffsetDateTime attendeeLastModified) {
        this.attendeeLastModified = attendeeLastModified;
        return this;
    }
     ...
     * The amount of credit associated with the attendee.
     */
    public Attendee1 withCredit(@Nullable Double credit) {
        this.credit = credit;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public Attendee1 build() {
            return new Attendee1(
                    created,
                    createdBy,
                    lastModified,
                    lastModifiedBy,
