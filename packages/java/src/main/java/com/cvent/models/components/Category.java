...
public class Category {
     ...
     * Text value of the field. Displays to users in the UI.
     */
    public Category withText(@Nullable String text) {
        this.text = text;
        return this;
    }
     ...
     * the question in reports.
     */
    public Category withShortText(@Nullable String shortText) {
        this.shortText = shortText;
        return this;
    }
     ...
     * True indicates the category is mandatory for answer.
     */
    public Category withRequired(@Nullable Boolean required) {
    ...
    public String toString() {
        return Utils.toString(Category.class, "id", id, "text", text, "shortText", shortText, "required", required);
    }
    ...
    public static final class Builder {
        ...
        public Category build() {
            return new Category(id, text, shortText, required);
        }
