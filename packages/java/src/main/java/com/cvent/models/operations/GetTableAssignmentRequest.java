...
public class GetTableAssignmentRequest {
     ...
     * ID of an event.
     */
    public GetTableAssignmentRequest withId(@Nonnull String id) {
     ...
     * ID of a seating.
     */
    public GetTableAssignmentRequest withSeatingId(@Nonnull String seatingId) {
     ...
     * The maximum number of records to return per page.
     */
    public GetTableAssignmentRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetTableAssignmentRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public GetTableAssignmentRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
     ...
     * * **Reference**: <a href="#operation/getSeat">Get Seat</a>
     */
    public GetTableAssignmentRequest withExpand(@Nullable List<SeatingAssignmentExpand> expand) {
        this.expand = expand;
        return this;
    }
