...
public class Choice3Input {
    ...
    @JsonCreator
    public Choice3Input(@JsonProperty("text") @Nonnull String text) {
     ...
     * The text for the question choice.
     */
    public Choice3Input withText(@Nonnull String text) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Choice3Input other = (Choice3Input) o;
    ...
    public String toString() {
        return Utils.toString(Choice3Input.class, "text", text);
    }
    ...
    public static final class Builder {
        ...
        public Choice3Input build() {
            return new Choice3Input(text);
        }
    }
}
