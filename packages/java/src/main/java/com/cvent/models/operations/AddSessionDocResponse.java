...
public class AddSessionDocResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public AddSessionDocResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public AddSessionDocResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AddSessionDocResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successfully added document to a session.
     */
    public AddSessionDocResponse withSessionFile(@Nullable SessionFile sessionFile) {
        this.sessionFile = sessionFile;
        return this;
    }
