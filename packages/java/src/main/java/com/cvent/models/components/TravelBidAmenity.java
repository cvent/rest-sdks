...
public class TravelBidAmenity {
    ...
    @JsonCreator
    public TravelBidAmenity(
            @JsonProperty("type") @Nullable AmenityType type,
     ...
     * Amenity type
     */
    public Optional<AmenityType> type() {
     ...
     * Amenity type
     */
    public TravelBidAmenity withType(@Nullable AmenityType type) {
        this.type = type;
        return this;
    }
     ...
     * The code representing the amenity.
     */
    public TravelBidAmenity withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * The category of the amenity.
     */
    public TravelBidAmenity withCategory(@Nullable String category) {
        this.category = category;
        return this;
    }
     ...
     * True indicates the amenity price is included in the rate.
     */
    public TravelBidAmenity withIncluded(@Nullable Boolean included) {
     ...
     * The price of the amenity.
     */
    public TravelBidAmenity withPrice(@Nullable Double price) {
        this.price = price;
        return this;
    }
     ...
     * The price of the amenity after discounts.
     */
    public TravelBidAmenity withDiscountAmount(@Nullable Double discountAmount) {
        this.discountAmount = discountAmount;
        return this;
    }
     ...
     * Internal cost of the amenity.
     */
    public TravelBidAmenity withInternalCost(@Nullable Double internalCost) {
        this.internalCost = internalCost;
        return this;
    }
     ...
     * Additional notes on the amenity.
     */
    public TravelBidAmenity withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * and the hotel, if they agree, can update the item to deleted.
     */
    public TravelBidAmenity withStatus(@Nullable BidItemStatusType status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TravelBidAmenity other = (TravelBidAmenity) o;
    ...
    public static final class Builder {
         ...
         * Amenity type
         */
        public Builder type(@Nullable AmenityType type) {
            this.type = type;
            return this;
        }
        ...
        public TravelBidAmenity build() {
            return new TravelBidAmenity(
                    type, code, category, included, price, discountAmount, internalCost, description, status);
        }
