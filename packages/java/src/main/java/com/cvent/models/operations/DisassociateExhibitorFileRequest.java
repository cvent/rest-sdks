...
public class DisassociateExhibitorFileRequest {
     ...
     * ID of an event.
     */
    public DisassociateExhibitorFileRequest withId(@Nonnull String id) {
     ...
     * ID of an exhibitor.
     */
    public DisassociateExhibitorFileRequest withExhibitorId(@Nonnull String exhibitorId) {
     ...
     * ID of a file.
     */
    public DisassociateExhibitorFileRequest withFileId(@Nonnull String fileId) {
