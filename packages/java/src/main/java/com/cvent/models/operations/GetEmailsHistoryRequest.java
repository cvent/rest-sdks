...
public class GetEmailsHistoryRequest {
     ...
     * Used to query records that have been created before this time point. Defaults to current time.
     */
    public GetEmailsHistoryRequest withBefore(@Nullable String before) {
        this.before = before;
        return this;
    }
     ...
     * current time.
     */
    public GetEmailsHistoryRequest withAfter(@Nullable String after) {
        this.after = after;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public GetEmailsHistoryRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetEmailsHistoryRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * lastModified (eq|le|ge)
     */
    public GetEmailsHistoryRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
