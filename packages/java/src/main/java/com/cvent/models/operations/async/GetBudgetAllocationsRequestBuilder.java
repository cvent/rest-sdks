...
public class GetBudgetAllocationsRequestBuilder {
    ...
    */
    public CompletableFuture<GetBudgetAllocationsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetBudgetAllocationsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetBudgetAllocationsResponse&gt;() {
     ...
     */
    public Publisher<GetBudgetAllocationsResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            GetBudgetAllocationsRequest::withToken,
            operation::doRequest);

        Flow.Publisher<GetBudgetAllocationsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
