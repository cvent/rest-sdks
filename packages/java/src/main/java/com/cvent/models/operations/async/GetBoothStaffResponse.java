...
public class GetBoothStaffResponse implements AsyncResponse {
    /**
    ...
    public GetBoothStaffResponse(@Nonnull String contentType, int statusCode, @Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * HTTP response content type for this operation
     */
    public GetBoothStaffResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetBoothStaffResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetBoothStaffResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successfully retrieved details for a booth staff member.
     */
    public GetBoothStaffResponse withBoothStaffResponse(@Nullable BoothStaffResponse boothStaffResponse) {
        this.boothStaffResponse = boothStaffResponse;
        return this;
    }
