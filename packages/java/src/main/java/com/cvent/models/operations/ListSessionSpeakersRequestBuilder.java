...
public class ListSessionSpeakersRequestBuilder {
     ...
     */
    public ListSessionSpeakersResponse call() {
     ...
     * <pre><code>
     * for (ListSessionSpeakersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSessionSpeakersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSessionSpeakersResponse> callAsStream() {
