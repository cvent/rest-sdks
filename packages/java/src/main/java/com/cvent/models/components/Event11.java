...
public class Event11 {
    ...
    public Event11(
            ...
            @JsonProperty("category") @Nullable Event1Lookup category,
     ...
     */
    @Deprecated
    public Optional<Event1Lookup> category() {
     ...
     * The identifier of the event.
     */
    public Event11 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Title of the event being organized.
     */
    public Event11 withTitle(@Nonnull String title) {
     ...
     * A system-generated code for this event.
     */
    public Event11 withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Deprecated
    public Event11 withVirtual(@Nullable Boolean virtual) {
        this.virtual = virtual;
        return this;
    }
     ...
     * Denotes the format of an event.
     */
    public Event11 withFormat(@Nonnull EventFormatJson format) {
     ...
     * Detailed description of the event.
     */
    public Event11 withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The ISO 8601 formatted date and time when the event starts.
     */
    public Event11 withStart(@Nullable OffsetDateTime start) {
        this.start = start;
        return this;
    }
     ...
     * The ISO 8601 formatted date and time when the event ends.
     */
    public Event11 withEnd(@Nullable OffsetDateTime end) {
        this.end = end;
        return this;
    }
     ...
     * The event will be closed for registration after this ISO 8601 formatted date and time.
     */
    public Event11 withCloseAfter(@Nullable OffsetDateTime closeAfter) {
        this.closeAfter = closeAfter;
        return this;
    }
     ...
     * The event will be archived after this ISO 8601 formatted date and time.
     */
    public Event11 withArchiveAfter(@Nullable OffsetDateTime archiveAfter) {
        this.archiveAfter = archiveAfter;
        return this;
    }
     ...
     * launched, this field shows a date of 1/1/1900.
     */
    public Event11 withLaunchAfter(@Nullable OffsetDateTime launchAfter) {
        this.launchAfter = launchAfter;
        return this;
    }
     ...
     * [timezones](https://developers.cvent.com/docs/rest-api/reference/api-standards#time-zones).
     */
    public Event11 withTimezone(@Nonnull String timezone) {
     ...
     * Collection of venues.
     */
    public Event11 withVenues(@Nullable List<VenueJson> venues) {
        this.venues = venues;
        return this;
    }
     ...
     * event types, the request returns a 400 error.
     */
    public Event11 withShowVenueLocation(@Nullable Boolean showVenueLocation) {
        this.showVenueLocation = showVenueLocation;
        return this;
    }
     ...
     * event types, the request returns a 400 error.
     */
    public Event11 withShowPointOfContact(@Nullable Boolean showPointOfContact) {
        this.showPointOfContact = showPointOfContact;
        return this;
    }
     ...
     * The phone number for the event.
     */
    public Event11 withPhone(@Nullable String phone) {
        this.phone = phone;
        return this;
    }
     ...
     * Event note created by planners for internal use.
     */
    public Event11 withNote(@Nullable String note) {
        this.note = note;
        return this;
    }
     ...
     * The event default locale using the IETF language tag format.
     */
    public Event11 withDefaultLocale(@Nullable String defaultLocale) {
        this.defaultLocale = defaultLocale;
        return this;
    }
     ...
     * but supports writing only one language to an event.
     */
    public Event11 withLanguages(@Nonnull List<String> languages) {
     ...
     * The ISO 4217 standard format currency code used of this event.
     */
    public Event11 withCurrency(@Nullable String currency) {
        this.currency = currency;
        return this;
    }
     ...
     * Represents the security level used for event registrations.
     */
    public Event11 withRegistrationSecurityLevel(@Nullable EventSecurityLevelJson registrationSecurityLevel) {
        this.registrationSecurityLevel = registrationSecurityLevel;
        return this;
    }
     ...
     * This is used to denote the registration status for an event.
     */
    public Event11 withStatus(@Nullable RegistrationStatusJson status) {
        this.status = status;
        return this;
    }
     ...
     * was cancelled or deleted.
     */
    public Event11 withEventStatus(@Nullable EventStatusJson eventStatus) {
        this.eventStatus = eventStatus;
        return this;
    }
     ...
     * The planner-created planning status for this event. Used for internal tracking purposes.
     */
    public Event11 withPlanningStatus(@Nullable String planningStatus) {
        this.planningStatus = planningStatus;
        return this;
    }
     ...
     * True indicates the event is in test mode.
     */
    public Event11 withTestMode(@Nullable Boolean testMode) {
        this.testMode = testMode;
        return this;
    }
     ...
     * registration feature.
     */
    public Event11 withCapacity(@Nullable Long capacity) {
        this.capacity = capacity;
        return this;
    }
     ...
     * A collection of contacts representing the event planners.
     */
    public Event11 withPlanners(@Nonnull List<PlannerJson1> planners) {
     ...
     * A collection of contacts representing event stakeholders.
     */
    public Event11 withStakeholders(@Nullable List<StakeholderJson> stakeholders) {
        this.stakeholders = stakeholders;
        return this;
    }
     ...
     * Collection of custom fields.
     */
    public Event11 withCustomFields(@Nullable List<CustomFieldJson2> customFields) {
        this.customFields = customFields;
        return this;
    }
     ...
     */
    @Deprecated
    public Event11 withCategory(@Nullable Event1Lookup category) {
        this.category = category;
        return this;
    }
     ...
     * Essentials.
     */
    public Event11 withType(@Nonnull EventTypeJson type) {
     ...
     * Represents the links associated with an event.
     */
    public Event11 withLinks(@Nullable EventLinksJson links) {
        this.links = links;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public Event11 withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public Event11 withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the meeting request related to the event, if any.
     */
    public Event11 withMeetingRequestId(@Nullable String meetingRequestId) {
        this.meetingRequestId = meetingRequestId;
        return this;
    }
     ...
     * The name of the user who created the event.
     */
    public Event11 withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The name of the user who last modified the event.
     */
    public Event11 withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
    ...
    public static final class Builder {
         ...
         */
        @Deprecated
        public Builder category(@Nullable Event1Lookup category) {
            this.category = category;
            return this;
        }
