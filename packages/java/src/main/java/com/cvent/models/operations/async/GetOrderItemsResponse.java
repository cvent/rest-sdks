...
public class GetOrderItemsResponse implements AsyncResponse {
    /**
    ...
    public GetOrderItemsResponse(@Nonnull String contentType, int statusCode, @Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * HTTP response content type for this operation
     */
    public GetOrderItemsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetOrderItemsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetOrderItemsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
