 ...
 */
public class ExistingDiscountCode implements ExistingDiscountPaginatedResponseData {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("level")
    private ExistingDiscountCodeLevel level;
    ...
    private DiscountCapacity capacity;
     ...
     */
    @JsonProperty("type")
    private ExistingDiscountCodeType type;
    ...
    public ExistingDiscountCode(
            ...
            @JsonProperty("level") @Nullable ExistingDiscountCodeLevel level,
            @JsonProperty("capacity") @Nullable DiscountCapacity capacity,
            @JsonProperty("type") @Nonnull ExistingDiscountCodeType type,
    ...
    public ExistingDiscountCode(
            ...
            @Nonnull String code,
            @Nonnull ExistingDiscountCodeType type) {
        this(
                null,
                null,
                null,
     ...
     * Whether the discount is created at event level or account level.
     */
    public Optional<ExistingDiscountCodeLevel> level() {
     ...
     * Details about the discount capacity.
     */
    public Optional<DiscountCapacity> capacity() {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public ExistingDiscountCode withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public ExistingDiscountCode withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public ExistingDiscountCode withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public ExistingDiscountCode withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * Name of the discount.
     */
    public ExistingDiscountCode withName(@Nonnull String name) {
     ...
     * True indicates that the discount is active.
     */
    public ExistingDiscountCode withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
     ...
     * True indicates that the discount can be clubbed together with other stackable discounts
     */
    public ExistingDiscountCode withStackable(@Nullable Boolean stackable) {
     ...
     * Details about how the discount applies.
     */
    public ExistingDiscountCode withMethod(@Nonnull DiscountMethod method) {
     ...
     * The ISO 8601 formatted date from which the discount is effective.
     */
    public ExistingDiscountCode withEffectiveFrom(@Nullable LocalDate effectiveFrom) {
        this.effectiveFrom = effectiveFrom;
        return this;
    }
     ...
     * The ISO 8601 formatted date to which the discount is effective.
     */
    public ExistingDiscountCode withEffectiveTo(@Nullable LocalDate effectiveTo) {
        this.effectiveTo = effectiveTo;
        return this;
    }
     ...
     * Note about the discount.
     */
    public ExistingDiscountCode withNote(@Nullable String note) {
        this.note = note;
        return this;
    }
     ...
     * Code of the discount.
     */
    public ExistingDiscountCode withCode(@Nonnull String code) {
     ...
     * <p>`ALL`: An attendee who's the guest of a primary registrant.
     */
    public ExistingDiscountCode withAudienceType(@Nullable DiscountAudienceType audienceType) {
     ...
     * code's capacity.
     */
    public ExistingDiscountCode withIncludeGuestsTowardsCapacity(@Nullable Boolean includeGuestsTowardsCapacity) {
     ...
     * True indicates that the discount is auto-applied to registrants.
     */
    public ExistingDiscountCode withAutoApply(@Nullable Boolean autoApply) {
     ...
     * event level discount.
     */
    public ExistingDiscountCode withApplyToAllAgendaItems(@Nullable Boolean applyToAllAgendaItems) {
     ...
     * A unique identifier of the discount.
     */
    public ExistingDiscountCode withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Whether the discount is created at event level or account level.
     */
    public ExistingDiscountCode withLevel(@Nullable ExistingDiscountCodeLevel level) {
        this.level = level;
        return this;
    }
     ...
     * Details about the discount capacity.
     */
    public ExistingDiscountCode withCapacity(@Nullable DiscountCapacity capacity) {
        this.capacity = capacity;
        return this;
    }
     ...
     * <p>`VOLUME_DISCOUNT`: A discount that applies when a certain volume of items are purchased.
     */
    public ExistingDiscountCode withType(@Nonnull ExistingDiscountCodeType type) {
     ...
     * discount.
     */
    public ExistingDiscountCode withApplyToAllEvents(@Nullable Boolean applyToAllEvents) {
        this.applyToAllEvents = applyToAllEvents;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExistingDiscountCode other = (ExistingDiscountCode) o;
    ...
    public static final class Builder {
         ...
         * Whether the discount is created at event level or account level.
         */
        public Builder level(@Nullable ExistingDiscountCodeLevel level) {
            this.level = level;
            return this;
        }
         ...
         * Details about the discount capacity.
         */
        public Builder capacity(@Nullable DiscountCapacity capacity) {
            this.capacity = capacity;
            return this;
        }
         ...
         * <p>`VOLUME_DISCOUNT`: A discount that applies when a certain volume of items are purchased.
         */
        public Builder type(@Nonnull ExistingDiscountCodeType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
        ...
        public ExistingDiscountCode build() {
            return new ExistingDiscountCode(
                    created,
                    createdBy,
                    lastModified,
                    lastModifiedBy,
