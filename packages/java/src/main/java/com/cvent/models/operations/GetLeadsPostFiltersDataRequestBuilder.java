...
public class GetLeadsPostFiltersDataRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetLeadsPostFiltersDataRequest request;
    private final Options.Builder optionsBuilder;

    public GetLeadsPostFiltersDataRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetLeadsPostFiltersDataRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetLeadsPostFiltersDataRequestBuilder request(@Nonnull GetLeadsPostFiltersDataRequest request) {
     ...
     */
    public GetLeadsPostFiltersDataResponse call() {
     ...
     * <pre><code>
     * for (GetLeadsPostFiltersDataResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetLeadsPostFiltersDataResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetLeadsPostFiltersDataResponse> callAsStream() {
