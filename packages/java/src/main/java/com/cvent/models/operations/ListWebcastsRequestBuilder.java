...
public class ListWebcastsRequestBuilder {
     ...
     */
    public ListWebcastsResponse call() {
     ...
     * <pre><code>
     * for (ListWebcastsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListWebcastsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListWebcastsResponse> callAsStream() {
