...
public class GetLeadsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetLeadsRequest request;
    private final Options.Builder optionsBuilder;

    public GetLeadsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetLeadsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetLeadsRequestBuilder request(@Nonnull GetLeadsRequest request) {
     ...
     * <pre><code>
     * for (GetLeadsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetLeadsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetLeadsResponse> callAsStream() {
