...
public class ExistingMember {
    ...
    private ExistingMemberLink profileImageUrl;
    ...
    public ExistingMember(
            ...
            @JsonProperty("socialMediaLinks") @Nullable SocialMediaLinks socialMediaLinks,
            @JsonProperty("profileImageUrl") @Nullable ExistingMemberLink profileImageUrl,
            @JsonProperty("emailAddress") @Nullable String emailAddress,
            @JsonProperty("mobileNumber") @Nullable String mobileNumber,
            @JsonProperty("workAddress") @Nullable WorkAddress workAddress,
            @JsonProperty("compliance") @Nullable Compliance compliance,
    ...
    public ExistingMember(@Nonnull String firstName, @Nonnull String lastName) {
        this(
                firstName,
                lastName,
                null,
     ...
     * Member's social media links.
     */
    public Optional<SocialMediaLinks> socialMediaLinks() {
     ...
     * The optimized URL of the Events+ member's profile image.
     */
    public Optional<ExistingMemberLink> profileImageUrl() {
     ...
     * Member's work address details.
     */
    public Optional<WorkAddress> workAddress() {
     ...
     * Member's first name.
     */
    public ExistingMember withFirstName(@Nonnull String firstName) {
     ...
     * Member's last name
     */
    public ExistingMember withLastName(@Nonnull String lastName) {
     ...
     * Used to denote title of member e.g. Mr., Mrs., Dr. etc.
     */
    public ExistingMember withPrefix(@Nullable String prefix) {
        this.prefix = prefix;
        return this;
    }
     ...
     * Member's designation in the company.
     */
    public ExistingMember withDesignation(@Nullable String designation) {
        this.designation = designation;
        return this;
    }
     ...
     * Member's job title.
     */
    public ExistingMember withJobTitle(@Nullable String jobTitle) {
        this.jobTitle = jobTitle;
        return this;
    }
     ...
     * Member's company name.
     */
    public ExistingMember withCompanyName(@Nullable String companyName) {
        this.companyName = companyName;
        return this;
    }
     ...
     * Member's biographical writeup.
     */
    public ExistingMember withHeadline(@Nullable String headline) {
        this.headline = headline;
        return this;
    }
     ...
     * Member's pronouns.
     */
    public ExistingMember withPronouns(@Nullable String pronouns) {
        this.pronouns = pronouns;
        return this;
    }
     ...
     * Member's social media links.
     */
    public ExistingMember withSocialMediaLinks(@Nullable SocialMediaLinks socialMediaLinks) {
        this.socialMediaLinks = socialMediaLinks;
        return this;
    }
     ...
     * The optimized URL of the Events+ member's profile image.
     */
    public ExistingMember withProfileImageUrl(@Nullable ExistingMemberLink profileImageUrl) {
        this.profileImageUrl = profileImageUrl;
        return this;
    }
     ...
     * Member's email address.
     */
    public ExistingMember withEmailAddress(@Nullable String emailAddress) {
        this.emailAddress = emailAddress;
        return this;
    }
     ...
     * Member's mobile number.
     */
    public ExistingMember withMobileNumber(@Nullable String mobileNumber) {
        this.mobileNumber = mobileNumber;
        return this;
    }
     ...
     * Member's work address details.
     */
    public ExistingMember withWorkAddress(@Nullable WorkAddress workAddress) {
        this.workAddress = workAddress;
        return this;
    }
     ...
     * Privacy compliance fields for a contact.
     */
    public ExistingMember withCompliance(@Nullable Compliance compliance) {
        this.compliance = compliance;
        return this;
    }
     ...
     * <p>e.g. en-US, fr-FR, es-ES etc.
     */
    public ExistingMember withLocale(@Nullable String locale) {
        this.locale = locale;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when the member registered.
     */
    public ExistingMember withRegistrationDate(@Nullable OffsetDateTime registrationDate) {
        this.registrationDate = registrationDate;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when the member last logged in.
     */
    public ExistingMember withLastLoginDate(@Nullable OffsetDateTime lastLoginDate) {
        this.lastLoginDate = lastLoginDate;
        return this;
    }
     ...
     * True indicates member profile is visible to other members.
     */
    public ExistingMember withVisible(@Nullable Boolean visible) {
     ...
     * The unique ID of the member.
     */
    public ExistingMember withId(@Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExistingMember other = (ExistingMember) o;
    ...
    public static final class Builder {
         ...
         * Member's social media links.
         */
        public Builder socialMediaLinks(@Nullable SocialMediaLinks socialMediaLinks) {
            this.socialMediaLinks = socialMediaLinks;
            return this;
        }
         ...
         * The optimized URL of the Events+ member's profile image.
         */
        public Builder profileImageUrl(@Nullable ExistingMemberLink profileImageUrl) {
            this.profileImageUrl = profileImageUrl;
            return this;
        }
         ...
         * Member's work address details.
         */
        public Builder workAddress(@Nullable WorkAddress workAddress) {
            this.workAddress = workAddress;
            return this;
        }
         ...
         * Privacy compliance fields for a contact.
         */
        public Builder compliance(@Nullable Compliance compliance) {
            this.compliance = compliance;
            return this;
        }
