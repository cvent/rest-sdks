...
public class GetCardsRequestBuilder {
    ...
    * <pre><code>
    * for (GetCardsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<GetCardsResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<GetCardsResponse> callAsStream() {
