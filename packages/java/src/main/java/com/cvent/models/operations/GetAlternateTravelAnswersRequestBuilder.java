...
public class GetAlternateTravelAnswersRequestBuilder {
    ...
    public GetAlternateTravelAnswersRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     * <pre><code>
     * for (GetAlternateTravelAnswersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAlternateTravelAnswersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAlternateTravelAnswersResponse> callAsStream() {
