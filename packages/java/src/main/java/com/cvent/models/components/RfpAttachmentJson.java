 ...
 */
public class RfpAttachmentJson {
    /**
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    private DocumentTypeJson0 type;
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("source")
    private AttachmentSourceJson source;
    ...
    private RfpAttachmentJsonSupplier supplier;
    ...
    public RfpAttachmentJson(
            ...
            @JsonProperty("source") @Nullable AttachmentSourceJson source,
            ...
            @JsonProperty("supplier") @Nullable RfpAttachmentJsonSupplier supplier,
    ...
    public RfpAttachmentJson(@Nonnull String id) {
     ...
     * The document type.
     */
    public Optional<DocumentTypeJson0> type() {
     ...
     * The source from where the attachment was uploaded.
     */
    public Optional<AttachmentSourceJson> source() {
     ...
     * Supplier associated with the attachment.
     */
    public Optional<RfpAttachmentJsonSupplier> supplier() {
     ...
     * Unique identifier for this attachment record.
     */
    public RfpAttachmentJson withId(@Nonnull String id) {
     ...
     * ISO 8601 date-time the attachment was uploaded.
     */
    public RfpAttachmentJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The size of attachment in bytes.
     */
    public RfpAttachmentJson withSize(@Nullable Long size) {
        this.size = size;
        return this;
    }
     ...
     * The document type.
     */
    public RfpAttachmentJson withType(@Nullable DocumentTypeJson0 type) {
        this.type = type;
        return this;
    }
     ...
     * True indicates the attachment is uploaded behind a secured URL.
     */
    public RfpAttachmentJson withSecure(@Nullable Boolean secure) {
        this.secure = secure;
        return this;
    }
     ...
     * Display name of the attachment.
     */
    public RfpAttachmentJson withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Name of the attachment. Must be unique in the account.
     */
    public RfpAttachmentJson withUniqueName(@Nullable String uniqueName) {
        this.uniqueName = uniqueName;
        return this;
    }
     ...
     * The content type of the attachment
     */
    public RfpAttachmentJson withMimeType(@Nullable String mimeType) {
        this.mimeType = mimeType;
        return this;
    }
     ...
     * The source from where the attachment was uploaded.
     */
    public RfpAttachmentJson withSource(@Nullable AttachmentSourceJson source) {
        this.source = source;
        return this;
    }
     ...
     * URL of the storage system and omits the root address.
     */
    public RfpAttachmentJson withRelativePath(@Nullable String relativePath) {
        this.relativePath = relativePath;
        return this;
    }
     ...
     * True indicates the attachment should be sent in emails that notify suppliers about RFPs.
     */
    public RfpAttachmentJson withSendInEmail(@Nullable Boolean sendInEmail) {
        this.sendInEmail = sendInEmail;
        return this;
    }
     ...
     * True indicates this attachment can be deleted.
     */
    public RfpAttachmentJson withDeletionAllowed(@Nullable Boolean deletionAllowed) {
        this.deletionAllowed = deletionAllowed;
        return this;
    }
     ...
     * URL of the attachment if `secure` is false. This field is null if `secure` is true.
     */
    public RfpAttachmentJson withUrl(@Nullable String url) {
        this.url = url;
        return this;
    }
     ...
     * Supplier associated with the attachment.
     */
    public RfpAttachmentJson withSupplier(@Nullable RfpAttachmentJsonSupplier supplier) {
        this.supplier = supplier;
        return this;
    }
     ...
     * supplier.id field.
     */
    public RfpAttachmentJson withSupplierSpecific(@Nullable Boolean supplierSpecific) {
        this.supplierSpecific = supplierSpecific;
        return this;
    }
     ...
     * True indicates the attachment is selected for the supplier whose ID is present in supplier.id field.
     */
    public RfpAttachmentJson withSelectedForSupplier(@Nullable Boolean selectedForSupplier) {
        this.selectedForSupplier = selectedForSupplier;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        RfpAttachmentJson other = (RfpAttachmentJson) o;
    ...
    public static final class Builder {
         ...
         * The document type.
         */
        public Builder type(@Nullable DocumentTypeJson0 type) {
            this.type = type;
            return this;
        }
         ...
         * The source from where the attachment was uploaded.
         */
        public Builder source(@Nullable AttachmentSourceJson source) {
            this.source = source;
            return this;
        }
         ...
         * Supplier associated with the attachment.
         */
        public Builder supplier(@Nullable RfpAttachmentJsonSupplier supplier) {
            this.supplier = supplier;
            return this;
        }
        ...
        public RfpAttachmentJson build() {
            return new RfpAttachmentJson(
                    id,
                    created,
                    size,
                    type,
