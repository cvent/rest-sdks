...
public class GetEventBadgePrintJobsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetEventBadgePrintJobsRequest request;
    private final Options.Builder optionsBuilder;

    public GetEventBadgePrintJobsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetEventBadgePrintJobsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetEventBadgePrintJobsRequestBuilder request(@Nonnull GetEventBadgePrintJobsRequest request) {
     ...
     */
    public GetEventBadgePrintJobsResponse call() {
     ...
     * <pre><code>
     * for (GetEventBadgePrintJobsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEventBadgePrintJobsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEventBadgePrintJobsResponse> callAsStream() {
