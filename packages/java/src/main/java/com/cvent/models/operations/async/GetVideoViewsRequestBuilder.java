...
public class GetVideoViewsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetVideoViewsRequest request;
    private final Options.Builder optionsBuilder;

    public GetVideoViewsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetVideoViewsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetVideoViewsRequestBuilder request(@Nonnull GetVideoViewsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetVideoViewsRequest _buildRequest() {
        return this.request;
    }

    public GetVideoViewsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetVideoViewsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetVideoViewsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetVideoViewsResponse&gt;() {
     ...
     */
    public Publisher<GetVideoViewsResponse> callAsPublisher() {
        GetVideoViewsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetVideoViewsRequest, GetVideoViewsResponse> operation =
                new GetVideoViews.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetVideoViewsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
