...
public class GetQuestionsRequestBuilder {
    ...
    */
    public GetQuestionsResponse call() {
    ...
    * <pre><code>
    * for (GetQuestionsResponse page : builder.callAsIterable()) {
    *     // Process each page
    * }
    * </code></pre>
    * 
    ...
    */
    public Iterable<GetQuestionsResponse> callAsIterable() {
    ...
    * are returned.
    **/  
    public Stream<GetQuestionsResponse> callAsStream() {
