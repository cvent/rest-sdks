...
public class ListContactGroupsRequestBuilder {
     ...
     */
    public ListContactGroupsResponse call() {
     ...
     * <pre><code>
     * for (ListContactGroupsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListContactGroupsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListContactGroupsResponse> callAsStream() {
