...
public class GetTransactionsRequestBuilder {
    ...
    public GetTransactionsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     * <pre><code>
     * Publisher&lt;GetTransactionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetTransactionsResponse&gt;() {
     ...
     */
    public Publisher<GetTransactionsResponse> callAsPublisher() {
        GetTransactionsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetTransactionsRequest, GetTransactionsResponse> operation =
                new GetTransactions.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetTransactionsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
