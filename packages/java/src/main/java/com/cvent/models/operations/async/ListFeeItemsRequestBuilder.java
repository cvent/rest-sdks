...
public class ListFeeItemsRequestBuilder {
    ...
    public ListFeeItemsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public CompletableFuture<ListFeeItemsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListFeeItemsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListFeeItemsResponse&gt;() {
     ...
     */
    public Publisher<ListFeeItemsResponse> callAsPublisher() {
        ...
        Flow.Publisher<ListFeeItemsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
