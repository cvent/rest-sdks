...
public class FeeItem {
    ...
    private List<EarlyBirdPricing> earlyBirdPricing;
    ...
    private List<RefundPolicy> refundPolicy;
    ...
    public FeeItem(
            ...
            @JsonProperty("product") @Nullable Product1 product,
            @JsonProperty("earlyBirdPricing") @Nullable List<EarlyBirdPricing> earlyBirdPricing,
            @JsonProperty("refundPolicy") @Nullable List<RefundPolicy> refundPolicy,
            ...
            @JsonProperty("generalLedgerCodes") @Nullable
                    List<
                                    AGeneralLedgerCodeUsedToCategorizeFinancialDataWhichHelpsBusinessesAnalyzeAndReportOnTheirFinancialActivity> generalLedgerCodes,
     ...
     * Represents a product. Products are items that can be purchased during registration.
     */
    public Optional<Product1> product() {
     ...
     * Early bird pricing associated with the fee.
     */
    public Optional<List<EarlyBirdPricing>> earlyBirdPricing() {
     ...
     * Refund policy for the fee.
     */
    public Optional<List<RefundPolicy>> refundPolicy() {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public FeeItem withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public FeeItem withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public FeeItem withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public FeeItem withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * A unique identifier of the fee item.
     */
    public FeeItem withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Name of the fee.
     */
    public FeeItem withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * The total fee amount.
     */
    public FeeItem withAmount(@Nullable Double amount) {
        this.amount = amount;
        return this;
    }
     ...
     * Denotes the ISO 4217 currency code for this fee item.
     */
    public FeeItem withCurrency(@Nullable String currency) {
        this.currency = currency;
        return this;
    }
     ...
     * Represents a product. Products are items that can be purchased during registration.
     */
    public FeeItem withProduct(@Nullable Product1 product) {
        this.product = product;
        return this;
    }
     ...
     * Early bird pricing associated with the fee.
     */
    public FeeItem withEarlyBirdPricing(@Nullable List<EarlyBirdPricing> earlyBirdPricing) {
        this.earlyBirdPricing = earlyBirdPricing;
        return this;
    }
     ...
     * Refund policy for the fee.
     */
    public FeeItem withRefundPolicy(@Nullable List<RefundPolicy> refundPolicy) {
        this.refundPolicy = refundPolicy;
        return this;
    }
     ...
     * True indicates that the fee is active.
     */
    public FeeItem withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
     ...
     * True indicates that the fee displays in the fee widget.
     */
    public FeeItem withDisplay(@Nullable Boolean display) {
        this.display = display;
        return this;
    }
     ...
     * Each agenda item can only have one default fee.
     */
    public FeeItem withDefault(@Nullable Boolean default_) {
        this.default_ = default_;
        return this;
    }
     ...
     * General ledger codes for the fee.
     */
    public FeeItem withGeneralLedgerCodes(
            @Nullable
                    List<
                                    AGeneralLedgerCodeUsedToCategorizeFinancialDataWhichHelpsBusinessesAnalyzeAndReportOnTheirFinancialActivity> generalLedgerCodes) {
        this.generalLedgerCodes = generalLedgerCodes;
     ...
     * The registration types this fee is applies to, represented by their IDs.
     */
    public FeeItem withRegistrationTypes(@Nullable List<String> registrationTypes) {
        this.registrationTypes = registrationTypes;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Represents a product. Products are items that can be purchased during registration.
         */
        public Builder product(@Nullable Product1 product) {
            this.product = product;
            return this;
        }
         ...
         * Early bird pricing associated with the fee.
         */
        public Builder earlyBirdPricing(@Nullable List<EarlyBirdPricing> earlyBirdPricing) {
            this.earlyBirdPricing = earlyBirdPricing;
            return this;
        }
         ...
         * Refund policy for the fee.
         */
        public Builder refundPolicy(@Nullable List<RefundPolicy> refundPolicy) {
            this.refundPolicy = refundPolicy;
            return this;
        }
         ...
         * General ledger codes for the fee.
         */
        public Builder generalLedgerCodes(
                @Nullable
                        List<
                                        AGeneralLedgerCodeUsedToCategorizeFinancialDataWhichHelpsBusinessesAnalyzeAndReportOnTheirFinancialActivity> generalLedgerCodes) {
            this.generalLedgerCodes = generalLedgerCodes;
