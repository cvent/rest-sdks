...
public class ListEventUserGroupsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListEventUserGroupsRequest request;
    private final Options.Builder optionsBuilder;

    public ListEventUserGroupsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListEventUserGroupsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListEventUserGroupsRequestBuilder request(@Nonnull ListEventUserGroupsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListEventUserGroupsRequest _buildRequest() {
        return this.request;
    }

    public ListEventUserGroupsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListEventUserGroupsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListEventUserGroupsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListEventUserGroupsResponse&gt;() {
     ...
     */
    public Publisher<ListEventUserGroupsResponse> callAsPublisher() {
        ListEventUserGroupsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListEventUserGroupsRequest, ListEventUserGroupsResponse> operation =
                new ListEventUserGroups.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListEventUserGroupsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
