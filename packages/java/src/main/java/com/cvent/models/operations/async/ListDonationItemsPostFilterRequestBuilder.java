...
public class ListDonationItemsPostFilterRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListDonationItemsPostFilterRequest request;
    private final Options.Builder optionsBuilder;

    public ListDonationItemsPostFilterRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListDonationItemsPostFilterRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListDonationItemsPostFilterRequestBuilder request(@Nonnull ListDonationItemsPostFilterRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListDonationItemsPostFilterRequest _buildRequest() {
        return this.request;
    }

    public ListDonationItemsPostFilterRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListDonationItemsPostFilterResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListDonationItemsPostFilterResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListDonationItemsPostFilterResponse&gt;() {
     ...
     */
    public Publisher<ListDonationItemsPostFilterResponse> callAsPublisher() {
        ListDonationItemsPostFilterRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListDonationItemsPostFilterRequest, ListDonationItemsPostFilterResponse> operation =
                new ListDonationItemsPostFilter.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListDonationItemsPostFilterResponse> flowPublisher =
