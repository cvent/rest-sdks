    ...
    */
    ...
    public Publisher<ListDonationItemsPostFilterResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            ListDonationItemsPostFilterRequest::withToken,
            operation::doRequest);

        Flow.Publisher<ListDonationItemsPostFilterResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
