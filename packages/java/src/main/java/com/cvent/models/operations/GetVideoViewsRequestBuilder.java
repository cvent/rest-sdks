...
public class GetVideoViewsRequestBuilder {
     ...
     */
    public GetVideoViewsResponse call() {
     ...
     * <pre><code>
     * for (GetVideoViewsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetVideoViewsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetVideoViewsResponse> callAsStream() {
