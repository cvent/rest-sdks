...
public class ListSeatsRequestBuilder {
     ...
     * <pre><code>
     * for (ListSeatsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSeatsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSeatsResponse> callAsStream() {
