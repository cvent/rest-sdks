 ...
 *
 * <p>The response from a request to get the list of event budget totals.
 */
public class EventBudgetPaginatedResponse {
    /**
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EventBudgetPaginatedResponse other = (EventBudgetPaginatedResponse) o;
    ...
    public String toString() {
        return Utils.toString(EventBudgetPaginatedResponse.class, "paging", paging, "data", data);
    }
    ...
    public static final class Builder {
        ...
        public EventBudgetPaginatedResponse build() {
            return new EventBudgetPaginatedResponse(paging, data);
        }
    }
}
