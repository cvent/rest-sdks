...
public class GetStandardSurveyQuestionsRequestBuilder {
     ...
     */
    public GetStandardSurveyQuestionsResponse call() {
     ...
     * <pre><code>
     * for (GetStandardSurveyQuestionsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetStandardSurveyQuestionsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetStandardSurveyQuestionsResponse> callAsStream() {
