...
public class Choice3 {
    ...
    @JsonCreator
    public Choice3(@JsonProperty("id") @Nullable String id, @JsonProperty("text") @Nonnull String text) {
        this.id = id;
        this.text = Optional.ofNullable(text).orElseThrow(() -> new IllegalArgumentException("text cannot be null"));
    }

    public Choice3(@Nonnull String text) {
        this(null, text);
    }
     ...
     * this choice text will be replaced with the text supplied, and a new choice ID is created.
     */
    public Choice3 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The text for the question choice.
     */
    public Choice3 withText(@Nonnull String text) {
    ...
    public String toString() {
        return Utils.toString(Choice3.class, "id", id, "text", text);
    }
    ...
    public static final class Builder {
        ...
        public Choice3 build() {
            return new Choice3(id, text);
        }
    }
}
