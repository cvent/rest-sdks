...
public class AddressJson4 {
     ...
     * The first line of an address.
     */
    public AddressJson4 withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public AddressJson4 withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public AddressJson4 withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public AddressJson4 withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public AddressJson4 withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public AddressJson4 withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public AddressJson4 withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public AddressJson4 withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country of the address.
     */
    public AddressJson4 withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public AddressJson4 withLatitude(@Nullable Long latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public AddressJson4 withLongitude(@Nullable Long longitude) {
        this.longitude = longitude;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AddressJson4 other = (AddressJson4) o;
        return 
    ...
    public String toString() {
        return Utils.toString(AddressJson4.class,
                "address1", address1,
                "address2", address2,
                "address3", address3,
                "city", city,
    ...
    public final static class Builder {
        ...
        public AddressJson4 build() {
            return new AddressJson4(
                address1, address2, address3,
                city, countryCode, postalCode,
                region, regionCode, country,
                latitude, longitude);
