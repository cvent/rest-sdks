...
public class GetEventPlanningDocumentsRequestBuilder {
     ...
     */
    public GetEventPlanningDocumentsResponse call() {
     ...
     * <pre><code>
     * for (GetEventPlanningDocumentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEventPlanningDocumentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEventPlanningDocumentsResponse> callAsStream() {
