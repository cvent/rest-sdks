...
public class ExternalReference {
    ...
    public ExternalReference(
            @JsonProperty("type") @Nullable ExternalReferenceType type,
     ...
     * Type of the external system.
     */
    public Optional<ExternalReferenceType> type() {
     ...
     * Type of the external system.
     */
    public ExternalReference withType(@Nullable ExternalReferenceType type) {
        this.type = type;
        return this;
    }
     ...
     * The identifier of the external system.
     */
    public ExternalReference withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The identifier of an attendee in the external system.
     */
    public ExternalReference withReferenceId(@Nullable String referenceId) {
        this.referenceId = referenceId;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(ExternalReference.class, "type", type, "id", id, "referenceId", referenceId);
    }
    ...
    public static final class Builder {
         ...
         * Type of the external system.
         */
        public Builder type(@Nullable ExternalReferenceType type) {
            this.type = type;
            return this;
        }
        ...
        public ExternalReference build() {
            return new ExternalReference(type, id, referenceId);
        }
    }
}
