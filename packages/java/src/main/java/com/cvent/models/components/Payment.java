...
public class Payment {
     ...
     * Name of the payment.
     */
    public Payment withName(@Nonnull String name) {
     ...
     * statement.
     */
    public Payment withReferenceNumber(@Nullable String referenceNumber) {
        this.referenceNumber = referenceNumber;
        return this;
    }
     ...
     * The ISO 4217 standard format currency code used of payment currency.
     */
    public Payment withCurrency(@Nonnull String currency) {
     ...
     * The ISO 8601 zoned date assigned to the payment, typically denotes the date of payment.
     */
    public Payment withDate(@Nonnull LocalDate date) {
     ...
     * Denotes the method of payment.
     */
    public Payment withType(@Nullable PaymentType11 type) {
        this.type = type;
        return this;
    }
