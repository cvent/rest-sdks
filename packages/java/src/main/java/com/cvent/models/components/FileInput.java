...
public class FileInput {
    ...
    public FileInput(@Nonnull Event4 event, @Nonnull Exhibitor exhibitor, @Nonnull String displayName, long order) {
     ...
     * The Associated Event.
     */
    public FileInput withEvent(@Nonnull Event4 event) {
