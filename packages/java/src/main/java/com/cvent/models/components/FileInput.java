...
public class FileInput {
    ...
    public FileInput(@Nonnull Event3 event, @Nonnull Exhibitor exhibitor, @Nonnull String displayName, long order) {
     ...
     * The Associated Event.
     */
    public FileInput withEvent(@Nonnull Event3 event) {
