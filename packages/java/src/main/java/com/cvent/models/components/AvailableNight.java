...
public class AvailableNight {
    ...
    private List<AdditionalGuestFees> additionalGuestFees;
    ...
    @JsonCreator
    public AvailableNight(
            @JsonProperty("hotel") @Nonnull HotelId hotel,
            @JsonProperty("roomType") @Nonnull RoomTypeId roomType,
            @JsonProperty("attendeeType") @Nonnull AttendeeType attendeeType,
            ...
            @JsonProperty("additionalGuestFees") @Nullable List<AdditionalGuestFees> additionalGuestFees,
            @JsonProperty("taxStructure") @Nullable TaxStructure taxStructure,
    ...
    public AvailableNight(
            ...
            @Nonnull RoomTypeId roomType,
            @Nonnull AttendeeType attendeeType,
     ...
     * List of additional guest fees.
     */
    public Optional<List<AdditionalGuestFees>> additionalGuestFees() {
     ...
     * Details about taxes and fees applicable to a room.
     */
    public Optional<TaxStructure> taxStructure() {
     ...
     * Contains unique ID of the hotel.
     */
    public AvailableNight withHotel(@Nonnull HotelId hotel) {
     ...
     * Contains unique ID of the room type.
     */
    public AvailableNight withRoomType(@Nonnull RoomTypeId roomType) {
     ...
     * Attendee type details.
     */
    public AvailableNight withAttendeeType(@Nonnull AttendeeType attendeeType) {
     ...
     * Date the rooms are available.
     */
    public AvailableNight withDate(@Nonnull LocalDate date) {
     ...
     * Number of rooms available.
     */
    public AvailableNight withQuantity(long quantity) {
        this.quantity = quantity;
        return this;
    }
     ...
     * Cost of room per night booked.
     */
    public AvailableNight withRoomRate(double roomRate) {
        this.roomRate = roomRate;
        return this;
    }
     ...
     * settings.
     */
    public AvailableNight withDisplayRate(@Nullable Double displayRate) {
        this.displayRate = displayRate;
        return this;
    }
     ...
     * List of additional guest fees.
     */
    public AvailableNight withAdditionalGuestFees(@Nullable List<AdditionalGuestFees> additionalGuestFees) {
        this.additionalGuestFees = additionalGuestFees;
        return this;
    }
     ...
     * Details about taxes and fees applicable to a room.
     */
    public AvailableNight withTaxStructure(@Nullable TaxStructure taxStructure) {
        this.taxStructure = taxStructure;
        return this;
    }
     ...
     * ISO 4217 currency code.
     */
    public AvailableNight withCurrency(@Nonnull String currency) {
     ...
     * Maximum number of guests the room can accommodate.
     */
    public AvailableNight withMaxGuests(@Nullable Long maxGuests) {
        this.maxGuests = maxGuests;
        return this;
    }
     ...
     * Minimum number of nights required for a stay.
     */
    public AvailableNight withMinLengthOfStay(long minLengthOfStay) {
        this.minLengthOfStay = minLengthOfStay;
        return this;
    }
     ...
     * True indicates the cost of the room is hidden from attendees on the booking site.
     */
    public AvailableNight withHideRate(boolean hideRate) {
        this.hideRate = hideRate;
        return this;
    }
     ...
     * True indicates a waitlist is enabled for this night.
     */
    public AvailableNight withWaitListEnabled(boolean waitListEnabled) {
        this.waitListEnabled = waitListEnabled;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AvailableNight other = (AvailableNight) o;
    ...
    public static final class Builder {
         ...
         * Contains unique ID of the room type.
         */
        public Builder roomType(@Nonnull RoomTypeId roomType) {
            this.roomType = Utils.checkNotNull(roomType, "roomType");
            return this;
        }
         ...
         * Attendee type details.
         */
        public Builder attendeeType(@Nonnull AttendeeType attendeeType) {
            this.attendeeType = Utils.checkNotNull(attendeeType, "attendeeType");
            return this;
        }
         ...
         * List of additional guest fees.
         */
        public Builder additionalGuestFees(@Nullable List<AdditionalGuestFees> additionalGuestFees) {
            this.additionalGuestFees = additionalGuestFees;
            return this;
        }
         ...
         * Details about taxes and fees applicable to a room.
         */
        public Builder taxStructure(@Nullable TaxStructure taxStructure) {
            this.taxStructure = taxStructure;
            return this;
        }
        ...
        public AvailableNight build() {
            return new AvailableNight(
                    hotel,
                    roomType,
                    attendeeType,
                    date,
