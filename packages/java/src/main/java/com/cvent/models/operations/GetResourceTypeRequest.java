...
public class GetResourceTypeRequest {
    ...
    @JsonCreator
    public GetResourceTypeRequest(@Nonnull String id) {
     ...
     * Unique ID for a resource.
     */
    public GetResourceTypeRequest withId(@Nonnull String id) {
    ...
    public String toString() {
        return Utils.toString(GetResourceTypeRequest.class, "id", id);
    }
    ...
    public static final class Builder {
        ...
        public GetResourceTypeRequest build() {
            return new GetResourceTypeRequest(id);
        }
    }
}
