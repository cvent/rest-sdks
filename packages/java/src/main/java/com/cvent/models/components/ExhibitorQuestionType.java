...
public enum ExhibitorQuestionType {
    ...
    ExhibitorQuestionType(String value) {
        this.value = value;
    }
    ...
    public static Optional<ExhibitorQuestionType> fromValue(String value) {
        for (ExhibitorQuestionType o : ExhibitorQuestionType.values()) {
