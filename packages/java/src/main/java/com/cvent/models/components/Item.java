...
public class Item {
     ...
     * Unique ID for the item.
     */
    public Item withItemId(@Nullable String itemId) {
        this.itemId = itemId;
        return this;
    }
     ...
     * The name of the item.
     */
    public Item withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * The number of items.
     */
    public Item withQuantity(@Nullable Long quantity) {
        this.quantity = quantity;
        return this;
    }
     ...
     * Total cost of the item(s).
     */
    public Item withTotalCost(@Nullable Double totalCost) {
        this.totalCost = totalCost;
        return this;
    }
     ...
     * Notes associated with the item.
     */
    public Item withNotes(@Nullable String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public Item build() {
            return new Item(itemId, name, quantity, totalCost, notes);
        }
    }
}
