...
public class GetAllEventSurveyResponsesRequest {
     ...
     * beginning of time of the data store.
     */
    public GetAllEventSurveyResponsesRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public GetAllEventSurveyResponsesRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public GetAllEventSurveyResponsesRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetAllEventSurveyResponsesRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
