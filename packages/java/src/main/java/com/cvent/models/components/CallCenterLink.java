...
public class CallCenterLink {
    ...
    @JsonCreator
    public CallCenterLink(@JsonProperty("href") @Nonnull String href) {
     ...
     * A url provided that can be followed for linking
     */
    public CallCenterLink withHref(@Nonnull String href) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CallCenterLink other = (CallCenterLink) o;
    ...
    public String toString() {
        return Utils.toString(CallCenterLink.class, "href", href);
    }
    ...
    public static final class Builder {
        ...
        public CallCenterLink build() {
            return new CallCenterLink(href);
        }
    }
}
