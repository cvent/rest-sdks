 ...
 */
@Deprecated
public class StakeholderContactOptOut {
    /**
     ...
     * Used to denote if a contact has opted-out of receiving system generated emails.
     */
    public StakeholderContactOptOut withOptedOut(@Nullable Boolean optedOut) {
     ...
     * opts out multiple times.
     */
    public StakeholderContactOptOut withDate(@Nullable OffsetDateTime date) {
        this.date = date;
        return this;
    }
     ...
     * This is used to denote how a contact is opt'd out of Cvent system.
     */
    public StakeholderContactOptOut withBy(@Nullable OptoutBy by) {
        this.by = by;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StakeholderContactOptOut other = (StakeholderContactOptOut) o;
    ...
    public String toString() {
        return Utils.toString(StakeholderContactOptOut.class, "optedOut", optedOut, "date", date, "by", by);
    }
    ...
    public static final class Builder {
         ...
         * This is used to denote how a contact is opt'd out of Cvent system.
         */
        public Builder by(@Nullable OptoutBy by) {
            this.by = by;
            return this;
        }

        public StakeholderContactOptOut build() {
            return new StakeholderContactOptOut(optedOut, date, by);
        }
