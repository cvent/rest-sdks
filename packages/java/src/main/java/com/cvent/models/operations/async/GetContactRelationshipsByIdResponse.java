...
public class GetContactRelationshipsByIdResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public GetContactRelationshipsByIdResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetContactRelationshipsByIdResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetContactRelationshipsByIdResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
