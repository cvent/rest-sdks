...
public class VenueAddressJsonInput {
     ...
     * The first line of an address.
     */
    public VenueAddressJsonInput withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public VenueAddressJsonInput withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public VenueAddressJsonInput withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public VenueAddressJsonInput withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public VenueAddressJsonInput withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public VenueAddressJsonInput withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public VenueAddressJsonInput withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VenueAddressJsonInput other = (VenueAddressJsonInput) o;
    ...
    public static final class Builder {
        ...
        public VenueAddressJsonInput build() {
            return new VenueAddressJsonInput(address1, address2, address3, city, countryCode, postalCode, regionCode);
        }
    }
}
