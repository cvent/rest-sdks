...
public class GetEventTableAssignmentsRequestBuilder {
     ...
     */
    public GetEventTableAssignmentsResponse call() {
     ...
     * <pre><code>
     * for (GetEventTableAssignmentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEventTableAssignmentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEventTableAssignmentsResponse> callAsStream() {
