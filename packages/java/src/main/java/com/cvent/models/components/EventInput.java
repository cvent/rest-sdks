...
public class EventInput {
     ...
     * Denotes the format of an event.
     */
    public EventInput withFormat(@Nonnull EventFormat format) {
     ...
     * Collection of venues.
     */
    public EventInput withVenues(@Nullable List<Venue1Input> venues) {
        this.venues = venues;
        return this;
    }
     ...
     * A collection of contacts representing the event planners.
     */
    public EventInput withPlanners(@Nonnull List<Planner1Input> planners) {
     ...
     * Essentials.
     */
    public EventInput withType(@Nonnull EventType11 type) {
