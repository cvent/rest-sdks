...
public class FieldJson1 {
    ...
    public FieldJson1(
            ...
            @JsonProperty("type") @Nullable FieldTypeJson1 type,
     ...
     * Field Type
     */
    public Optional<FieldTypeJson1> type() {
     ...
     * Text field ID.
     */
    public FieldJson1 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * text Value of the Field
     */
    public FieldJson1 withText(@Nullable String text) {
        this.text = text;
        return this;
    }
     ...
     * Reporting value of the Category, Its like a custom abbreviation
     */
    public FieldJson1 withShortText(@Nullable String shortText) {
        this.shortText = shortText;
        return this;
    }
     ...
     * Field Type
     */
    public FieldJson1 withType(@Nullable FieldTypeJson1 type) {
        this.type = type;
        return this;
    }
     ...
     * List of choices for this field.
     */
    public FieldJson1 withChoices(@Nullable List<ChoiceJson3> choices) {
        this.choices = choices;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public FieldJson1 withNotApplicableAnswer(@Nullable AdditionalChoiceJson notApplicableAnswer) {
        this.notApplicableAnswer = notApplicableAnswer;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public FieldJson1 withOtherAnswer(@Nullable AdditionalChoiceJson otherAnswer) {
        this.otherAnswer = otherAnswer;
        return this;
    }
     ...
     * Is this a mandatory field
     */
    public FieldJson1 withRequired(@Nullable Boolean required) {
    ...
    public final static class Builder {
         ...
         * Field Type
         */
        public Builder type(@Nullable FieldTypeJson1 type) {
            this.type = type;
            return this;
        }
