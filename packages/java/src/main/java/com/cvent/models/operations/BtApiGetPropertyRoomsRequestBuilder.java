...
public class BtApiGetPropertyRoomsRequestBuilder {
     ...
     */
    public BtApiGetPropertyRoomsResponse call() {
     ...
     * <pre><code>
     * for (BtApiGetPropertyRoomsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<BtApiGetPropertyRoomsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<BtApiGetPropertyRoomsResponse> callAsStream() {
