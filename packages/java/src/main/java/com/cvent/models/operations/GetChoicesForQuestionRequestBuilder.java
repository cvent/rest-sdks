...
public class GetChoicesForQuestionRequestBuilder {
     ...
     */
    public GetChoicesForQuestionResponse call() {
     ...
     * <pre><code>
     * for (GetChoicesForQuestionResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetChoicesForQuestionResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetChoicesForQuestionResponse> callAsStream() {
