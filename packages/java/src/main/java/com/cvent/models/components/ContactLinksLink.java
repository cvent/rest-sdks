...
public class ContactLinksLink {
    ...
    @JsonCreator
    public ContactLinksLink(@JsonProperty("href") @Nonnull String href) {
     ...
     * The url of the contact's profile picture
     */
    public ContactLinksLink withHref(@Nonnull String href) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContactLinksLink other = (ContactLinksLink) o;
    ...
    public String toString() {
        return Utils.toString(ContactLinksLink.class, "href", href);
    }
    ...
    public static final class Builder {
        ...
        public ContactLinksLink build() {
            return new ContactLinksLink(href);
        }
    }
}
