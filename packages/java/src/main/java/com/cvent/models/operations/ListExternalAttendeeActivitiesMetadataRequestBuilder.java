...
public class ListExternalAttendeeActivitiesMetadataRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListExternalAttendeeActivitiesMetadataRequest request;
    private final Options.Builder optionsBuilder;

    public ListExternalAttendeeActivitiesMetadataRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListExternalAttendeeActivitiesMetadataRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public ListExternalAttendeeActivitiesMetadataResponse call() {
     ...
     * <pre><code>
     * for (ListExternalAttendeeActivitiesMetadataResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListExternalAttendeeActivitiesMetadataResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListExternalAttendeeActivitiesMetadataResponse> callAsStream() {
