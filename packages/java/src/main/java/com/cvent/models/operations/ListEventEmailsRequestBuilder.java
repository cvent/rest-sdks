...
public class ListEventEmailsRequestBuilder {
     ...
     */
    public ListEventEmailsResponse call() {
     ...
     * <pre><code>
     * for (ListEventEmailsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventEmailsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventEmailsResponse> callAsStream() {
