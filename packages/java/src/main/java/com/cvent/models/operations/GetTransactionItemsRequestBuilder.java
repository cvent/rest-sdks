...
public class GetTransactionItemsRequestBuilder {
     ...
     */
    public GetTransactionItemsResponse call() {
     ...
     * <pre><code>
     * for (GetTransactionItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetTransactionItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetTransactionItemsResponse> callAsStream() {
