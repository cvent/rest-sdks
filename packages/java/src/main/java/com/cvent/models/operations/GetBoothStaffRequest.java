...
public class GetBoothStaffRequest {
     ...
     * ID of an event.
     */
    public GetBoothStaffRequest withId(@Nonnull String id) {
     ...
     * ID of an exhibitor.
     */
    public GetBoothStaffRequest withExhibitorId(@Nonnull String exhibitorId) {
     ...
     * ID of a booth staff member.
     */
    public GetBoothStaffRequest withBoothstaffId(@Nonnull String boothstaffId) {
