...
public class OneOneOf {
     ...
     * The ISO 8601 zoned minimum date time accepted.
     */
    public OneOneOf withFrom(@Nullable OffsetDateTime from) {
        this.from = from;
        return this;
    }
     ...
     * The ISO 8601 zoned maximum date time accepted.
     */
    public OneOneOf withTo(@Nullable OffsetDateTime to) {
        this.to = to;
        return this;
    }
     ...
     * This is used to denote the display format type of date time type custom field.
     */
    public OneOneOf withFormat(@Nullable DateTimeDisplayFormatJson format) {
        this.format = format;
        return this;
    }
     ...
     * Whether it needs to be pre populated with current date.
     */
    public OneOneOf withDefaultToCurrentDate(@Nullable Boolean defaultToCurrentDate) {
        this.defaultToCurrentDate = defaultToCurrentDate;
        return this;
    }
     ...
     * True means that a pop-up calendar will be displayed to assist date selection on UI.
     */
    public OneOneOf withDisplayPopUpCalendar(@Nullable Boolean displayPopUpCalendar) {
