...
public class EventSurveyQuestionJson {
     ...
     * Question Type.
     */
    public EventSurveyQuestionJson withType(@Nullable QuestionTypeJson1 type) {
        this.type = type;
        return this;
    }
     ...
     * List of choices for the question.
     */
    public EventSurveyQuestionJson withChoices(@Nullable List<ChoiceJson1> choices) {
        this.choices = choices;
        return this;
    }
     ...
     * List of categories for the question.
     */
    public EventSurveyQuestionJson withCategories(@Nullable List<CategoryJson1> categories) {
        this.categories = categories;
        return this;
    }
     ...
     * List of sub categories for matrix side-by-side questions
     */
    public EventSurveyQuestionJson withSubCategories(@Nullable List<TextFieldJson> subCategories) {
        this.subCategories = subCategories;
        return this;
    }
     ...
     * List of fields for form/matrix questions
     */
    public EventSurveyQuestionJson withFields(@Nullable List<FieldJson> fields) {
        this.fields = fields;
        return this;
    }
