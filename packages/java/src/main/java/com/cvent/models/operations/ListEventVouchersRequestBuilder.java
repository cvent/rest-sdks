...
public class ListEventVouchersRequestBuilder {
     ...
     */
    public ListEventVouchersResponse call() {
     ...
     * <pre><code>
     * for (ListEventVouchersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventVouchersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventVouchersResponse> callAsStream() {
