...
public class EventUpdate {
     ...
     */
    @Deprecated
    public Optional<EventUpdateLookup> category() {
     ...
     * The identifier of the event.
     */
    public EventUpdate withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Title of the event being organized.
     */
    public EventUpdate withTitle(@Nonnull String title) {
     ...
     * A system-generated code for this event.
     */
    public EventUpdate withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     */
    @Deprecated
    public EventUpdate withVirtual(@Nullable Boolean virtual) {
        this.virtual = virtual;
        return this;
    }
     ...
     * Detailed description of the event.
     */
    public EventUpdate withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The ISO 8601 formatted date and time when the event starts.
     */
    public EventUpdate withStart(@Nullable OffsetDateTime start) {
        this.start = start;
        return this;
    }
     ...
     * The ISO 8601 formatted date and time when the event ends.
     */
    public EventUpdate withEnd(@Nullable OffsetDateTime end) {
        this.end = end;
        return this;
    }
     ...
     * The event will be closed for registration after this ISO 8601 formatted date and time.
     */
    public EventUpdate withCloseAfter(@Nullable OffsetDateTime closeAfter) {
        this.closeAfter = closeAfter;
        return this;
    }
     ...
     * The event will be archived after this ISO 8601 formatted date and time.
     */
    public EventUpdate withArchiveAfter(@Nullable OffsetDateTime archiveAfter) {
        this.archiveAfter = archiveAfter;
        return this;
    }
     ...
     * launched, this field shows a date of 1/1/1900.
     */
    public EventUpdate withLaunchAfter(@Nullable OffsetDateTime launchAfter) {
        this.launchAfter = launchAfter;
        return this;
    }
     ...
     * event types, the request returns a 400 error.
     */
    public EventUpdate withShowVenueLocation(@Nullable Boolean showVenueLocation) {
        this.showVenueLocation = showVenueLocation;
        return this;
    }
     ...
     * event types, the request returns a 400 error.
     */
    public EventUpdate withShowPointOfContact(@Nullable Boolean showPointOfContact) {
        this.showPointOfContact = showPointOfContact;
        return this;
    }
     ...
     * The phone number for the event.
     */
    public EventUpdate withPhone(@Nullable String phone) {
        this.phone = phone;
        return this;
    }
     ...
     * Event note created by planners for internal use.
     */
    public EventUpdate withNote(@Nullable String note) {
        this.note = note;
        return this;
    }
     ...
     * The event default locale using the IETF language tag format.
     */
    public EventUpdate withDefaultLocale(@Nullable String defaultLocale) {
        this.defaultLocale = defaultLocale;
        return this;
    }
     ...
     * but supports writing only one language to an event.
     */
    public EventUpdate withLanguages(@Nonnull List<String> languages) {
     ...
     * The ISO 4217 standard format currency code used of this event.
     */
    public EventUpdate withCurrency(@Nullable String currency) {
        this.currency = currency;
        return this;
    }
     ...
     * The planner-created planning status for this event. Used for internal tracking purposes.
     */
    public EventUpdate withPlanningStatus(@Nullable String planningStatus) {
        this.planningStatus = planningStatus;
        return this;
    }
     ...
     * True indicates the event is in test mode.
     */
    public EventUpdate withTestMode(@Nullable Boolean testMode) {
        this.testMode = testMode;
        return this;
    }
     ...
     * registration feature.
     */
    public EventUpdate withCapacity(@Nullable Long capacity) {
        this.capacity = capacity;
        return this;
    }
     ...
     * Collection of custom fields.
     */
    public EventUpdate withCustomFields(@Nullable List<CustomFieldJson5> customFields) {
        this.customFields = customFields;
        return this;
    }
     ...
     */
    @Deprecated
    public EventUpdate withCategory(@Nullable EventUpdateLookup category) {
        this.category = category;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public EventUpdate withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public EventUpdate withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the meeting request related to the event, if any.
     */
    public EventUpdate withMeetingRequestId(@Nullable String meetingRequestId) {
        this.meetingRequestId = meetingRequestId;
        return this;
    }
     ...
     * The name of the user who created the event.
     */
    public EventUpdate withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The name of the user who last modified the event.
     */
    public EventUpdate withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
    ...
    public static final class Builder {
         ...
         */
        @Deprecated
        public Builder category(@Nullable EventUpdateLookup category) {
            this.category = category;
            return this;
        }
