...
public class ListAttendeesPostFilterRequestBuilder {
     ...
     */
    public ListAttendeesPostFilterResponse call() {
     ...
     * <pre><code>
     * for (ListAttendeesPostFilterResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAttendeesPostFilterResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAttendeesPostFilterResponse> callAsStream() {
