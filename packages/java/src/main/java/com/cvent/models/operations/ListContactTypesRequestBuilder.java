...
public class ListContactTypesRequestBuilder {
     ...
     */
    public ListContactTypesResponse call() {
     ...
     * <pre><code>
     * for (ListContactTypesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListContactTypesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListContactTypesResponse> callAsStream() {
