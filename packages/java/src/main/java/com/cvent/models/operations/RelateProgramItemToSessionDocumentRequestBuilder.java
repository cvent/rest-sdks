...
public class RelateProgramItemToSessionDocumentRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private RelateProgramItemToSessionDocumentRequest request;
    private final Options.Builder optionsBuilder;

    public RelateProgramItemToSessionDocumentRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public RelateProgramItemToSessionDocumentRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public RelateProgramItemToSessionDocumentResponse call() {
