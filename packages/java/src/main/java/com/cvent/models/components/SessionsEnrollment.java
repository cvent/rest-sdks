 ...
 */
public class SessionsEnrollment {
    /**
    ...
    public SessionsEnrollment(
            ...
            @JsonProperty("status") @Nullable SessionEnrollmentStatus status) {
     ...
     * <p>Cancelled: The attendee's registration for the session has been cancelled.
     */
    public Optional<SessionEnrollmentStatus> status() {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public SessionsEnrollment withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public SessionsEnrollment withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public SessionsEnrollment withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public SessionsEnrollment withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The identifier of the session registration.
     */
    public SessionsEnrollment withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public SessionsEnrollment withSession(@Nullable Uuid session) {
        this.session = session;
        return this;
    }
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public SessionsEnrollment withEvent(@Nullable Uuid event) {
        this.event = event;
        return this;
    }
     ...
     * The reference to the related entity. Contains only the ID of the related entity.
     */
    public SessionsEnrollment withAttendee(@Nullable Uuid attendee) {
        this.attendee = attendee;
        return this;
    }
     ...
     * True indicates the attendee is registered for the session.
     */
    public SessionsEnrollment withDeleted(@Nullable Boolean deleted) {
        this.deleted = deleted;
        return this;
    }
     ...
     * <p>Cancelled: The attendee's registration for the session has been cancelled.
     */
    public SessionsEnrollment withStatus(@Nullable SessionEnrollmentStatus status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SessionsEnrollment other = (SessionsEnrollment) o;
    ...
    public static final class Builder {
         ...
         * <p>Cancelled: The attendee's registration for the session has been cancelled.
         */
        public Builder status(@Nullable SessionEnrollmentStatus status) {
            this.status = status;
            return this;
        }

        public SessionsEnrollment build() {
            return new SessionsEnrollment(
                    created, createdBy, lastModified, lastModifiedBy, id, session, event, attendee, deleted, status);
        }
    }
}
