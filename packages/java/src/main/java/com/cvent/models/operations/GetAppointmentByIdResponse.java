...
public class GetAppointmentByIdResponse implements Response {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetAppointmentByIdResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successfully retrieved an appointment.
     */
    public GetAppointmentByIdResponse withAppointment(@Nullable Appointment appointment) {
        this.appointment = appointment;
        return this;
    }
