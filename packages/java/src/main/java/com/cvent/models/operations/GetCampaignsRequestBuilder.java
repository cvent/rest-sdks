...
public class GetCampaignsRequestBuilder {
     ...
     */
    public GetCampaignsResponse call() {
     ...
     * <pre><code>
     * for (GetCampaignsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetCampaignsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetCampaignsResponse> callAsStream() {
