...
public class GetEventFeaturesRequestBuilder {
     ...
     */
    public GetEventFeaturesResponse call() {
     ...
     * <pre><code>
     * for (GetEventFeaturesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEventFeaturesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEventFeaturesResponse> callAsStream() {
