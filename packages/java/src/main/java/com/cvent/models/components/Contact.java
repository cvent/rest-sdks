...
public class Contact {
    ...
    public Contact(
            ...
            @JsonProperty("event") @Nullable ContactEvent event) {
     ...
     * Event ID
     */
    public Optional<ContactEvent> event() {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public Contact withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public Contact withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public Contact withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public Contact withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The nickname of the contact.
     */
    public Contact withNickname(@Nullable String nickname) {
        this.nickname = nickname;
        return this;
    }
     ...
     * The email address of the contact.
     */
    public Contact withEmail(@Nullable String email) {
        this.email = email;
        return this;
    }
     ...
     * An alternate email address of the contact that can be cc'd on email communications.
     */
    public Contact withCcEmail(@Nullable String ccEmail) {
        this.ccEmail = ccEmail;
        return this;
    }
     ...
     * The company/organization the contact belongs to.
     */
    public Contact withCompany(@Nullable String company) {
        this.company = company;
        return this;
    }
     ...
     * The designation of the contact, typically an award or credential.
     */
    public Contact withDesignation(@Nullable String designation) {
        this.designation = designation;
        return this;
    }
     ...
     * The phone number of the contact at their place of residence.
     */
    public Contact withHomePhone(@Nullable String homePhone) {
        this.homePhone = homePhone;
        return this;
    }
     ...
     * The fax number of the contact at their place of residence.
     */
    public Contact withHomeFax(@Nullable String homeFax) {
        this.homeFax = homeFax;
        return this;
    }
     ...
     * The phone number of the contact at their place of work.
     */
    public Contact withWorkPhone(@Nullable String workPhone) {
        this.workPhone = workPhone;
        return this;
    }
     ...
     * The fax number of the contact at their place of work.
     */
    public Contact withWorkFax(@Nullable String workFax) {
        this.workFax = workFax;
        return this;
    }
     ...
     * each contact within an account. Consider adding the external system name as part of the ID.
     */
    public Contact withSourceId(@Nullable String sourceId) {
        this.sourceId = sourceId;
        return this;
    }
     ...
     * The contact's mobile phone number.
     */
    public Contact withMobilePhone(@Nullable String mobilePhone) {
        this.mobilePhone = mobilePhone;
        return this;
    }
     ...
     * The pager number of the contact.
     */
    public Contact withPager(@Nullable String pager) {
        this.pager = pager;
        return this;
    }
     ...
     * contact is inactive.
     */
    public Contact withDeleted(@Nullable Boolean deleted) {
     ...
     * permanently deleted in 30 days.
     */
    public Contact withPurged(@Nullable Boolean purged) {
        this.purged = purged;
        return this;
    }
     ...
     * health care providers in the United States.
     */
    public Contact withNpi(@Nullable String npi) {
        this.npi = npi;
        return this;
    }
     ...
     * `event/contacts:write-sensitive` scopes respectively.
     */
    public Contact withDateOfBirth(@Nullable LocalDate dateOfBirth) {
        this.dateOfBirth = dateOfBirth;
        return this;
    }
     ...
     */
    @Deprecated
    public Contact withPassportNumber(@Nullable String passportNumber) {
        this.passportNumber = passportNumber;
        return this;
    }
     ...
     * `event/contacts:write-sensitive` scopes respectively.
     */
    public Contact withSocialSecurityNumber(@Nullable String socialSecurityNumber) {
        this.socialSecurityNumber = socialSecurityNumber;
        return this;
    }
     ...
     * `event/contacts:write-sensitive` scopes respectively.
     */
    public Contact withNationalIdentificationNumber(@Nullable String nationalIdentificationNumber) {
        this.nationalIdentificationNumber = nationalIdentificationNumber;
        return this;
    }
     ...
     * The headline of the contact's profile, which summarizes their professional experience and qualities.
     */
    public Contact withHeadline(@Nullable String headline) {
        this.headline = headline;
        return this;
    }
     ...
     * A contact's personal website URL.
     */
    public Contact withPersonalWebsite(@Nullable String personalWebsite) {
        this.personalWebsite = personalWebsite;
        return this;
    }
     ...
     * A contact's biographical writeup.
     */
    public Contact withBiography(@Nullable String biography) {
        this.biography = biography;
        return this;
    }
     ...
     * Represents the preferred pronouns of a contact.
     */
    public Contact withPronouns(@Nullable String pronouns) {
        this.pronouns = pronouns;
        return this;
    }
     ...
     * ID of the parent contact, applicable with contact snapshot.
     */
    public Contact withParentId(@Nullable String parentId) {
        this.parentId = parentId;
        return this;
    }
     ...
     * Event ID
     */
    public Contact withEvent(@Nullable ContactEvent event) {
        this.event = event;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Event ID
         */
        public Builder event(@Nullable ContactEvent event) {
            this.event = event;
            return this;
        }
