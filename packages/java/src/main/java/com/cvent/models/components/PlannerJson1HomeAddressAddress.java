 ...
 */
@Deprecated
public class PlannerJson1HomeAddressAddress {
    /**
    ...
    @JsonCreator
    public PlannerJson1HomeAddressAddress(
     ...
     * The first line of an address.
     */
    public PlannerJson1HomeAddressAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public PlannerJson1HomeAddressAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public PlannerJson1HomeAddressAddress withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public PlannerJson1HomeAddressAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public PlannerJson1HomeAddressAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public PlannerJson1HomeAddressAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public PlannerJson1HomeAddressAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public PlannerJson1HomeAddressAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country of the address.
     */
    public PlannerJson1HomeAddressAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public PlannerJson1HomeAddressAddress withLatitude(@Nullable Long latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public PlannerJson1HomeAddressAddress withLongitude(@Nullable Long longitude) {
        this.longitude = longitude;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlannerJson1HomeAddressAddress other = (PlannerJson1HomeAddressAddress) o;
    ...
    public String toString() {
        return Utils.toString(
                PlannerJson1HomeAddressAddress.class,
                "address1",
                address1,
                "address2",
                address2,
    ...
    public static final class Builder {
        ...
        public PlannerJson1HomeAddressAddress build() {
            return new PlannerJson1HomeAddressAddress(
                    address1,
                    address2,
                    address3,
                    city,
