...
public class PropertyApiListBrandsRequest {
     ...
     * beginning of time of the data store.
     */
    public PropertyApiListBrandsRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public PropertyApiListBrandsRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public PropertyApiListBrandsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public PropertyApiListBrandsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * name (eq|ne|sw|contains)
     */
    public PropertyApiListBrandsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
