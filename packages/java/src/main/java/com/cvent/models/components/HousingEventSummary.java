 ...
 */
public class HousingEventSummary {
    /**
     ...
     * The unique ID of the housing event.
     */
    public HousingEventSummary withId(long id) {
        this.id = id;
        return this;
    }
     ...
     * Event name.
     */
    public HousingEventSummary withName(@Nonnull String name) {
     ...
     * days.
     */
    public HousingEventSummary withStart(@Nonnull OffsetDateTime start) {
     ...
     * The ISO 8601 date and time of the last attended day of the event, excluding shoulder days.
     */
    public HousingEventSummary withEnd(@Nonnull OffsetDateTime end) {
     ...
     * business rules, like releasing reserved room blocks back to general availability.
     */
    public HousingEventSummary withCutOff(@Nonnull OffsetDateTime cutOff) {
     ...
     * The event timezone from the Olson specification.
     */
    public HousingEventSummary withTimeZone(@Nonnull String timeZone) {
     ...
     * Event venue details.
     */
    public HousingEventSummary withVenue(@Nonnull Venue venue) {
     ...
     * Housing event status.
     */
    public HousingEventSummary withStatus(@Nonnull HousingEventStatus status) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HousingEventSummary other = (HousingEventSummary) o;
    ...
    public static final class Builder {
        ...
        public HousingEventSummary build() {
            return new HousingEventSummary(id, name, start, end, cutOff, timeZone, venue, status);
        }
    }
}
