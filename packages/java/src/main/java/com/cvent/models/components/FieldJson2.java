...
public class FieldJson2 {
     ...
     * Text field ID.
     */
    public FieldJson2 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * text Value of the Field
     */
    public FieldJson2 withText(@Nullable String text) {
        this.text = text;
        return this;
    }
     ...
     * Reporting value of the Category, Its like a custom abbreviation
     */
    public FieldJson2 withShortText(@Nullable String shortText) {
        this.shortText = shortText;
        return this;
    }
     ...
     * Field Type
     */
    public FieldJson2 withType(@Nullable FieldTypeJson2 type) {
        this.type = type;
        return this;
    }
     ...
     * List of choices for this field.
     */
    public FieldJson2 withChoices(@Nullable List<ChoiceJson2> choices) {
        this.choices = choices;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public FieldJson2 withNotApplicableAnswer(@Nullable AdditionalChoiceJson1 notApplicableAnswer) {
        this.notApplicableAnswer = notApplicableAnswer;
        return this;
    }
     ...
     * Contains text of additional choice i.e N/A choice or otherAnswer choice
     */
    public FieldJson2 withOtherAnswer(@Nullable AdditionalChoiceJson1 otherAnswer) {
        this.otherAnswer = otherAnswer;
        return this;
    }
     ...
     * Is this a mandatory field
     */
    public FieldJson2 withRequired(@Nullable Boolean required) {
    ...
    public static final class Builder {
        ...
        public FieldJson2 build() {
            return new FieldJson2(id, text, shortText, type, choices, notApplicableAnswer, otherAnswer, required);
        }
