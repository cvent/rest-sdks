...
public class ListQuantityItemsPostFilterRequestBuilder {
     ...
     */
    public ListQuantityItemsPostFilterResponse call() {
     ...
     * <pre><code>
     * for (ListQuantityItemsPostFilterResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListQuantityItemsPostFilterResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListQuantityItemsPostFilterResponse> callAsStream() {
