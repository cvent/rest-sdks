...
public class GetCommunicationLogMessagesRequestBuilder {
     ...
     */
    public GetCommunicationLogMessagesResponse call() {
     ...
     * <pre><code>
     * for (GetCommunicationLogMessagesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetCommunicationLogMessagesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetCommunicationLogMessagesResponse> callAsStream() {
