...
public class HubLogo {
     ...
     * The optimized Events+ hub logo image URL.
     */
    public HubLogo withUrl(@Nullable String url) {
        this.url = url;
        return this;
    }
     ...
     * JPEG, JPG, PNG, GIF. Recommended logo size is 170 x 90 pixels and 72 PPI.
     */
    public HubLogo withOriginalUrl(@Nullable String originalUrl) {
        this.originalUrl = originalUrl;
        return this;
    }
     ...
     * Alternate text for the logo image.
     */
    public HubLogo withAltText(@Nullable String altText) {
        this.altText = altText;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(HubLogo.class, "url", url, "originalUrl", originalUrl, "altText", altText);
    }
    ...
    public static final class Builder {
        ...
        public HubLogo build() {
            return new HubLogo(url, originalUrl, altText);
        }
    }
}
