 ...
 */
public class TravelProgramQuestion1 {
    /**
    ...
    @JsonCreator
    public TravelProgramQuestion1(
            @JsonProperty("questionId") @Nullable String questionId,
            @JsonProperty("section") @Nullable QuestionSection section,
     ...
     * specific) and program_g_and_m (group and meeting) are supported.
     */
    public Optional<QuestionSection> section() {
     ...
     * The unique ID of the custom question.
     */
    public TravelProgramQuestion1 withQuestionId(@Nullable String questionId) {
        this.questionId = questionId;
        return this;
    }
     ...
     * specific) and program_g_and_m (group and meeting) are supported.
     */
    public TravelProgramQuestion1 withSection(@Nullable QuestionSection section) {
        this.section = section;
        return this;
    }
     ...
     * Is it required for suppliers to answer this question in their proposal?
     */
    public TravelProgramQuestion1 withRequired(@Nullable Boolean required) {
        this.required = required;
        return this;
    }
     ...
     * The sequence number of the question within the proposal.
     */
    public TravelProgramQuestion1 withSequence(@Nullable Long sequence) {
        this.sequence = sequence;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TravelProgramQuestion1 other = (TravelProgramQuestion1) o;
    ...
    public static final class Builder {
         ...
         * specific) and program_g_and_m (group and meeting) are supported.
         */
        public Builder section(@Nullable QuestionSection section) {
            this.section = section;
            return this;
        }
        ...
        public TravelProgramQuestion1 build() {
            return new TravelProgramQuestion1(questionId, section, required, sequence);
        }
    }
}
