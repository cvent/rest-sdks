...
public class ListVideosRequestBuilder {
     ...
     */
    public ListVideosResponse call() {
     ...
     * <pre><code>
     * for (ListVideosResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListVideosResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListVideosResponse> callAsStream() {
