...
public class ListSeatingRequest {
     ...
     * ID of an event.
     */
    public ListSeatingRequest withId(@Nonnull String id) {
     ...
     * The maximum number of records to return per page.
     */
    public ListSeatingRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListSeatingRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public ListSeatingRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
