 ...
 */
@Deprecated
public class SessionUpdateLookup {
    /**
     ...
     * A string that has to be a format matching the industry standard uuid
     */
    public SessionUpdateLookup withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Code / Abbreviation of the lookup item.
     */
    public SessionUpdateLookup withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * Name of the lookup item.
     */
    public SessionUpdateLookup withName(@Nullable String name) {
        this.name = name;
        return this;
    }
