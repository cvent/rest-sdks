...
public class AttendeeAddBulkItemErrorResponse {
     ...
     * The HTTP status code representing the error.
     */
    public AttendeeAddBulkItemErrorResponse withCode(long code) {
        this.code = code;
        return this;
    }
     ...
     * A brief description of the error.
     */
    public AttendeeAddBulkItemErrorResponse withMessage(@Nonnull String message) {
     ...
     * The target resource of the error.
     */
    public AttendeeAddBulkItemErrorResponse withTarget(@Nullable String target) {
        this.target = target;
        return this;
    }
     ...
     * Additional details of cascading error messages.
     */
    public AttendeeAddBulkItemErrorResponse withDetails(@Nullable List<ZeroAllOf1> details) {
        this.details = details;
        return this;
    }
