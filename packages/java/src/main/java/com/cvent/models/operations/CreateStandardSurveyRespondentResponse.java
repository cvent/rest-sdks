...
public class CreateStandardSurveyRespondentResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public CreateStandardSurveyRespondentResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public CreateStandardSurveyRespondentResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateStandardSurveyRespondentResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
