...
public class PhoneNumber1 {
    ...
    @JsonCreator
    public PhoneNumber1(@JsonProperty("type") @Nonnull PhoneType type, @JsonProperty("value") @Nonnull String value) {
     ...
     * The type of the phone number.
     */
    public PhoneNumber1 withType(@Nonnull PhoneType type) {
     ...
     * The phone number of the user.
     */
    public PhoneNumber1 withValue(@Nonnull String value) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PhoneNumber1 other = (PhoneNumber1) o;
    ...
    public String toString() {
        return Utils.toString(PhoneNumber1.class, "type", type, "value", value);
    }
    ...
    public static final class Builder {
        ...
        public PhoneNumber1 build() {
            return new PhoneNumber1(type, value);
        }
    }
}
