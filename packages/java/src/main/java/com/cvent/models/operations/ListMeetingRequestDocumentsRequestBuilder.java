...
public class ListMeetingRequestDocumentsRequestBuilder {
     ...
     */
    public ListMeetingRequestDocumentsResponse call() {
     ...
     * <pre><code>
     * for (ListMeetingRequestDocumentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListMeetingRequestDocumentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListMeetingRequestDocumentsResponse> callAsStream() {
