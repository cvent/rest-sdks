...
public class ListDiscountedAgendaItemsResponse implements AsyncResponse {
    /**
     ...
     * event.
     */
    public Optional<DiscountAgendaItemsPaginatedResponse> discountAgendaItemsPaginatedResponse() {
        return Optional.ofNullable(this.discountAgendaItemsPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public ListDiscountedAgendaItemsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListDiscountedAgendaItemsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListDiscountedAgendaItemsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
