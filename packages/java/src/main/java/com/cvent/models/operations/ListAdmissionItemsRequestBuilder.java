...
public class ListAdmissionItemsRequestBuilder {
     ...
     */
    public ListAdmissionItemsResponse call() {
     ...
     * <pre><code>
     * for (ListAdmissionItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAdmissionItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAdmissionItemsResponse> callAsStream() {
