...
public class PagingJson23 {
    ...
    public PagingJson23(@Nonnull PaginationLinksJson links) {
     ...
     * additional data to fetch
     */
    public PagingJson23 withNextToken(@Nullable String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
     ...
     * The pagination token for the current page
     */
    public PagingJson23 withCurrentToken(@Nullable String currentToken) {
        this.currentToken = currentToken;
        return this;
    }
     ...
     * The number of records to return on the page not to exceed 200
     */
    public PagingJson23 withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * The total number of records available
     */
    public PagingJson23 withTotalCount(@Nullable Long totalCount) {
        this.totalCount = totalCount;
        return this;
    }
     ...
     * Represents pagination links for navigating between pages of data.
     */
    public PagingJson23 withLinks(@Nonnull PaginationLinksJson links) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PagingJson23 other = (PagingJson23) o;
    ...
    public static final class Builder {
        ...
        public PagingJson23 build() {
            return new PagingJson23(nextToken, currentToken, limit, totalCount, links);
        }
    }
}
