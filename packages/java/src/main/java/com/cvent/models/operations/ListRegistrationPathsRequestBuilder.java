...
public class ListRegistrationPathsRequestBuilder {
     ...
     */
    public ListRegistrationPathsResponse call() {
     ...
     * <pre><code>
     * for (ListRegistrationPathsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListRegistrationPathsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListRegistrationPathsResponse> callAsStream() {
