...
public class CustomField2 {
     ...
     * This is used to denote the category of a custom field.
     */
    public CustomField2 withCategory(@Nonnull CustomFieldCategory category) {
     ...
     * are read only.
     */
    public CustomField2 withType(@Nonnull CustomFieldType2 type) {
     ...
     * <p>Only applicable to session custom fields.
     */
    public CustomField2 withDisplayInDataTag(@Nullable DisplayInDataTag displayInDataTag) {
     ...
     * Visibility of the custom field on various pages/forms.
     */
    public CustomField2 withPageVisibility(@Nullable PageVisibility pageVisibility) {
        this.pageVisibility = pageVisibility;
        return this;
    }
