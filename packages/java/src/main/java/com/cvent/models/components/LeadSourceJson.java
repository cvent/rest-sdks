...
public class LeadSourceJson {
     ...
     * Represents lead source section details, which is a sub area of source generating the RFP.
     */
    public LeadSourceJson withSection(@Nullable LeadSourceSectionJson section) {
        this.section = section;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        LeadSourceJson other = (LeadSourceJson) o;
    ...
    public String toString() {
        return Utils.toString(LeadSourceJson.class, "id", id, "section", section);
    }
    ...
    public static final class Builder {
        ...
        public LeadSourceJson build() {
            return new LeadSourceJson(id, section);
        }
    }
}
