...
public class CustomField3 {
    ...
    private CustomField3Details details;
    ...
    public CustomField3(
            ...
            @JsonProperty("details") @Nullable CustomField3Details details,
     ...
     * Type-specific details of the custom-field.
     */
    public Optional<CustomField3Details> details() {
     ...
     * This is used to denote the category of a custom field.
     */
    public CustomField3 withCategory(@Nonnull CustomFieldCategoryJson category) {
     ...
     * The actual text of the custom field.
     */
    public CustomField3 withName(@Nonnull String name) {
     ...
     * Code to uniquely identify custom field.
     */
    public CustomField3 withCode(@Nonnull String code) {
     ...
     * Whether answer to custom field is mandatory or not.
     */
    public CustomField3 withRequired(@Nullable Boolean required) {
     ...
     * are read only.
     */
    public CustomField3 withType(@Nonnull CustomFieldTypeJson1 type) {
     ...
     * Type-specific details of the custom-field.
     */
    public CustomField3 withDetails(@Nullable CustomField3Details details) {
        this.details = details;
        return this;
    }
     ...
     * The help text of the custom field.
     */
    public CustomField3 withHelpText(@Nullable String helpText) {
        this.helpText = helpText;
        return this;
    }
     ...
     * <p>Only applicable to session custom fields.
     */
    public CustomField3 withDisplayInDataTag(@Nullable DisplayInDataTagJson displayInDataTag) {
     ...
     * applicable to contact custom fields.
     */
    public CustomField3 withDefaultTagText(@Nullable String defaultTagText) {
        this.defaultTagText = defaultTagText;
        return this;
    }
     ...
     * True means that this is a consent field. Only applicable to contact custom fields.
     */
    public CustomField3 withConsentField(@Nullable Boolean consentField) {
     ...
     * True means that this custom field is active. Determines visibility for event custom fields.
     */
    public CustomField3 withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
     ...
     * custom fields.
     */
    public CustomField3 withDisplayInEventCreationWizard(@Nullable Boolean displayInEventCreationWizard) {
     ...
     * Visibility of the custom field on various pages/forms.
     */
    public CustomField3 withPageVisibility(@Nullable PageVisibilityJson pageVisibility) {
        this.pageVisibility = pageVisibility;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CustomField3 other = (CustomField3) o;
    ...
    public static final class Builder {
         ...
         * Type-specific details of the custom-field.
         */
        public Builder details(@Nullable CustomField3Details details) {
            this.details = details;
            return this;
        }
        ...
        public CustomField3 build() {
            return new CustomField3(
                    category,
                    name,
                    code,
                    required,
