...
public class ListMeetingRequestDocumentsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListMeetingRequestDocumentsRequest request;
    private final Options.Builder optionsBuilder;

    public ListMeetingRequestDocumentsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListMeetingRequestDocumentsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListMeetingRequestDocumentsRequestBuilder request(@Nonnull ListMeetingRequestDocumentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListMeetingRequestDocumentsRequest _buildRequest() {
        return this.request;
    }

    public ListMeetingRequestDocumentsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListMeetingRequestDocumentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListMeetingRequestDocumentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListMeetingRequestDocumentsResponse&gt;() {
     ...
     */
    public Publisher<ListMeetingRequestDocumentsResponse> callAsPublisher() {
        ListMeetingRequestDocumentsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListMeetingRequestDocumentsRequest, ListMeetingRequestDocumentsResponse> operation =
                new ListMeetingRequestDocuments.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListMeetingRequestDocumentsResponse> flowPublisher =
