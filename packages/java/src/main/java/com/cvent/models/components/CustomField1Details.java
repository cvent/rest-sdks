...
public class CustomField1Details {
    ...
    public static CustomField1Details of(OpenEndedDateTime1 value) {
        Utils.checkNotNull(value, "value");
        return new CustomField1Details(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>() {}));
    }
    ...
    public static CustomField1Details of(Choices1Input value) {
        Utils.checkNotNull(value, "value");
        return new CustomField1Details(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>() {}));
    }
    ...
    public String toString() {
        return Utils.toString(CustomField1Details.class, "value", value);
    }
}
