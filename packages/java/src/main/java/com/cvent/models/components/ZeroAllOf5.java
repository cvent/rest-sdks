...
public class ZeroAllOf5 {
     ...
     * The unique ID of the housing event.
     */
    public ZeroAllOf5 withId(long id) {
        this.id = id;
        return this;
    }
     ...
     * Event name.
     */
    public ZeroAllOf5 withName(@Nonnull String name) {
     ...
     * days.
     */
    public ZeroAllOf5 withStart(@Nonnull OffsetDateTime start) {
     ...
     * The ISO 8601 date and time of the last attended day of the event, excluding shoulder days.
     */
    public ZeroAllOf5 withEnd(@Nonnull OffsetDateTime end) {
     ...
     * business rules, like releasing reserved room blocks back to general availability.
     */
    public ZeroAllOf5 withCutOff(@Nonnull OffsetDateTime cutOff) {
     ...
     * The event timezone from the Olson specification.
     */
    public ZeroAllOf5 withTimeZone(@Nonnull String timeZone) {
     ...
     * Event venue details.
     */
    public ZeroAllOf5 withVenue(@Nonnull VenueJson1 venue) {
     ...
     * Housing event status.
     */
    public ZeroAllOf5 withStatus(@Nonnull HousingEventStatusesJson status) {
    ...
    public static final class Builder {
        ...
        public ZeroAllOf5 build() {
            return new ZeroAllOf5(id, name, start, end, cutOff, timeZone, venue, status);
        }
    }
}
