 ...
 */
public class ErrorResponseBase12 {
    /**
    ...
    public ErrorResponseBase12(long code, @Nonnull String message) {
     ...
     * The unique identifier for the error response.
     */
    public ErrorResponseBase12 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The HTTP status code representing the error.
     */
    public ErrorResponseBase12 withCode(long code) {
        this.code = code;
        return this;
    }
     ...
     * A brief description of the error.
     */
    public ErrorResponseBase12 withMessage(@Nonnull String message) {
     ...
     * The target resource of the error.
     */
    public ErrorResponseBase12 withTarget(@Nullable String target) {
        this.target = target;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ErrorResponseBase12 other = (ErrorResponseBase12) o;
    ...
    public String toString() {
        return Utils.toString(ErrorResponseBase12.class, "id", id, "code", code, "message", message, "target", target);
    }
    ...
    public static final class Builder {
        ...
        public ErrorResponseBase12 build() {
            return new ErrorResponseBase12(id, code, message, target);
        }
    }
}
