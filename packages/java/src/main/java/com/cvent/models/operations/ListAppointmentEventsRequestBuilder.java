...
public class ListAppointmentEventsRequestBuilder {
     ...
     */
    public ListAppointmentEventsResponse call() {
     ...
     * <pre><code>
     * for (ListAppointmentEventsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAppointmentEventsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAppointmentEventsResponse> callAsStream() {
