...
public class CreateMeetingRequestResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateMeetingRequestResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
