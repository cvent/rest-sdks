...
public class GetEmailsHistoryRequestBuilder {
     ...
     */
    public GetEmailsHistoryResponse call() {
     ...
     * <pre><code>
     * for (GetEmailsHistoryResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEmailsHistoryResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEmailsHistoryResponse> callAsStream() {
