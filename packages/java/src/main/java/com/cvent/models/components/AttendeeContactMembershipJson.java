 ...
 */
@Deprecated
public class AttendeeContactMembershipJson {
    /**
     ...
     * The type of membership the contact has signed up for.
     */
    public AttendeeContactMembershipJson withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * Describes the specific plan the contact has signed up for.
     */
    public AttendeeContactMembershipJson withPlan(@Nullable String plan) {
        this.plan = plan;
        return this;
    }
     ...
     * The ISO-8601 formatted date the contact began their membership.
     */
    public AttendeeContactMembershipJson withJoined(@Nullable LocalDate joined) {
        this.joined = joined;
        return this;
    }
     ...
     * The ISO-8601 formatted date the contact's membership will expire.
     */
    public AttendeeContactMembershipJson withExpiration(@Nullable LocalDate expiration) {
        this.expiration = expiration;
        return this;
    }
     ...
     * The ISO-8601 formatted date the contact last renewed their membership.
     */
    public AttendeeContactMembershipJson withLastRenewal(@Nullable LocalDate lastRenewal) {
        this.lastRenewal = lastRenewal;
        return this;
    }
     ...
     * The amount currently due for this membership.
     */
    public AttendeeContactMembershipJson withAmountDue(@Nullable Double amountDue) {
        this.amountDue = amountDue;
        return this;
    }
     ...
     * True indicates the member details should be included in the member directory.
     */
    public AttendeeContactMembershipJson withListInDirectory(@Nullable Boolean listInDirectory) {
        this.listInDirectory = listInDirectory;
        return this;
    }
