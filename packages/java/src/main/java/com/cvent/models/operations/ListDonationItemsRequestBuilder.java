...
public class ListDonationItemsRequestBuilder {
     ...
     */
    public ListDonationItemsResponse call() {
     ...
     * <pre><code>
     * for (ListDonationItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListDonationItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListDonationItemsResponse> callAsStream() {
