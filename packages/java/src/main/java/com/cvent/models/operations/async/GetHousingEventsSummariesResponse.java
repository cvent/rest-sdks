...
public class GetHousingEventsSummariesResponse implements AsyncResponse {
    /**
     ...
     * Successfully retrieved a paginated list of summary information for your individual housing events.
     */
    public Optional<HousingEventSummaryList> housingEventSummaryList() {
        return Optional.ofNullable(this.housingEventSummaryList);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetHousingEventsSummariesResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetHousingEventsSummariesResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetHousingEventsSummariesResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
    ...
    public final static class Builder {
         ...
         * Successfully retrieved a paginated list of summary information for your individual housing events.
         */
        public Builder housingEventSummaryList(@Nullable HousingEventSummaryList housingEventSummaryList) {
            this.housingEventSummaryList = housingEventSummaryList;
            return this;
        }
