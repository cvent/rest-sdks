...
public class ListSessionsEnrollmentRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListSessionsEnrollmentRequest request;
    private final Options.Builder optionsBuilder;

    public ListSessionsEnrollmentRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListSessionsEnrollmentRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListSessionsEnrollmentRequestBuilder request(@Nonnull ListSessionsEnrollmentRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListSessionsEnrollmentRequest _buildRequest() {
        return this.request;
    }

    public ListSessionsEnrollmentRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListSessionsEnrollmentResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListSessionsEnrollmentResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListSessionsEnrollmentResponse&gt;() {
     ...
     */
    public Publisher<ListSessionsEnrollmentResponse> callAsPublisher() {
        ListSessionsEnrollmentRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListSessionsEnrollmentRequest, ListSessionsEnrollmentResponse> operation =
                new ListSessionsEnrollment.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListSessionsEnrollmentResponse> flowPublisher =
