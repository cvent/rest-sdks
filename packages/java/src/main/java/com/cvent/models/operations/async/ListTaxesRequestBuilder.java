...
public class ListTaxesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListTaxesRequest request;
    private final Options.Builder optionsBuilder;

    public ListTaxesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListTaxesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListTaxesRequestBuilder request(@Nonnull ListTaxesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTaxesRequest _buildRequest() {
        return this.request;
    }

    public ListTaxesRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListTaxesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListTaxesResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListTaxesResponse&gt;() {
     ...
     */
    public Publisher<ListTaxesResponse> callAsPublisher() {
        ListTaxesRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListTaxesRequest, ListTaxesResponse> operation =
                new ListTaxes.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListTaxesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
