...
public class ListTravelProposalBidsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListTravelProposalBidsRequest request;

    public ListTravelProposalBidsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public ListTravelProposalBidsRequestBuilder request(@Nonnull ListTravelProposalBidsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTravelProposalBidsRequest _buildRequest() {
        return this.request;
    }
    
    public ListTravelProposalBidsRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListTravelProposalBidsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListTravelProposalBidsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListTravelProposalBidsResponse&gt;() {
     ...
     */
    public Publisher<ListTravelProposalBidsResponse> callAsPublisher() {
        ListTravelProposalBidsRequest request = this.request;
        AsyncRequestOperation<ListTravelProposalBidsRequest, ListTravelProposalBidsResponse> operation
              = new ListTravelProposalBids.Async(sdkConfiguration, _headers);
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            ListTravelProposalBidsRequest::withToken,
            operation::doRequest);

        Flow.Publisher<ListTravelProposalBidsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
