...
public class LinkAgendaItemToDiscountRequest {
     ...
     * Unique ID of an event.
     */
    public LinkAgendaItemToDiscountRequest withId(@Nonnull String id) {
     ...
     * Unique ID of a discount.
     */
    public LinkAgendaItemToDiscountRequest withDiscountId(@Nonnull String discountId) {
     ...
     * Unique ID of an agenda item.
     */
    public LinkAgendaItemToDiscountRequest withAgendaItemId(@Nonnull String agendaItemId) {
