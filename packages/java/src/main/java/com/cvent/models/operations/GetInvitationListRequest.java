...
public class GetInvitationListRequest {
     ...
     * Unique ID of an event
     */
    public GetInvitationListRequest withId(@Nonnull String id) {
     ...
     * beginning of time of the data store.
     */
    public GetInvitationListRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public GetInvitationListRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public GetInvitationListRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetInvitationListRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * default (eq|ne)
     */
    public GetInvitationListRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
