...
public class GetInvitationListResponse implements Response {
    /**
     ...
     * Successfully retrieved a paginated list of invitation lists.
     */
    public Optional<InvitationListPaginatedResponse> invitationListPaginatedResponse() {
        return Optional.ofNullable(this.invitationListPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetInvitationListResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetInvitationListResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetInvitationListResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
