...
public class ListTravelProposalsResponse implements Response {
    /**
     ...
     * Successfully retrieved a paginated list of travel proposals.
     */
    public Optional<TravelProposalPaginatedResponse> travelProposalPaginatedResponse() {
        return Optional.ofNullable(this.travelProposalPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public ListTravelProposalsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListTravelProposalsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListTravelProposalsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
