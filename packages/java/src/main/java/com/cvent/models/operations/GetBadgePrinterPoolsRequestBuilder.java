...
public class GetBadgePrinterPoolsRequestBuilder {
     ...
     */
    public GetBadgePrinterPoolsResponse call() {
     ...
     * <pre><code>
     * for (GetBadgePrinterPoolsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetBadgePrinterPoolsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetBadgePrinterPoolsResponse> callAsStream() {
