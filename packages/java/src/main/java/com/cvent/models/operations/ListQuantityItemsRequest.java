...
public class ListQuantityItemsRequest {
     ...
     * Unique ID of an event.
     */
    public ListQuantityItemsRequest withId(@Nonnull String id) {
     ...
     * The maximum number of records to return per page.
     */
    public ListQuantityItemsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListQuantityItemsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
