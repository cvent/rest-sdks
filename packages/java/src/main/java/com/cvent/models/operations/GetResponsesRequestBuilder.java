...
public class GetResponsesRequestBuilder {
     ...
     */
    public GetResponsesResponse call() {
     ...
     * <pre><code>
     * for (GetResponsesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetResponsesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetResponsesResponse> callAsStream() {
