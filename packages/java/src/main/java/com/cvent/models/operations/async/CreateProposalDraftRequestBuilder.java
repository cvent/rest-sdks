...
public class CreateProposalDraftRequestBuilder {
    ...
    private ProposalRequest _buildRequest() {
        return this.request;
    }
    
    public CreateProposalDraftRequestBuilder header(String name, String value) {
