...
public class GetRespondentsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetRespondentsRequest request;
    private final Options.Builder optionsBuilder;

    public GetRespondentsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetRespondentsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetRespondentsRequestBuilder request(@Nonnull GetRespondentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetRespondentsRequest _buildRequest() {
        return this.request;
    }

    public GetRespondentsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetRespondentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetRespondentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetRespondentsResponse&gt;() {
     ...
     */
    public Publisher<GetRespondentsResponse> callAsPublisher() {
        GetRespondentsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetRespondentsRequest, GetRespondentsResponse> operation =
                new GetRespondents.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetRespondentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
