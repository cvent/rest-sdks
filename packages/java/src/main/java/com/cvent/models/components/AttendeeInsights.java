...
public class AttendeeInsights {
    ...
    public AttendeeInsights(@Nonnull String id, @Nonnull String name, @Nonnull EventJson7 event, boolean default_) {
     ...
     * An event reference used in attendee insights to identify the event context for engagement data
     */
    public AttendeeInsights withEvent(@Nonnull EventJson7 event) {
