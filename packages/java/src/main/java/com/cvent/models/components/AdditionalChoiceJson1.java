...
public class AdditionalChoiceJson1 {
     ...
     * Reporting value of additional choice text
     */
    public AdditionalChoiceJson1 withShortText(@Nullable String shortText) {
        this.shortText = shortText;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(AdditionalChoiceJson1.class, "text", text, "shortText", shortText);
    }
    ...
    public static final class Builder {
        ...
        public AdditionalChoiceJson1 build() {
            return new AdditionalChoiceJson1(text, shortText);
        }
    }
}
