...
public class ListCustomFieldsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListCustomFieldsRequest request;
    private final Options.Builder optionsBuilder;

    public ListCustomFieldsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListCustomFieldsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListCustomFieldsRequestBuilder request(@Nonnull ListCustomFieldsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListCustomFieldsRequest _buildRequest() {
        return this.request;
    }

    public ListCustomFieldsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListCustomFieldsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListCustomFieldsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListCustomFieldsResponse&gt;() {
     ...
     */
    public Publisher<ListCustomFieldsResponse> callAsPublisher() {
        ListCustomFieldsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListCustomFieldsRequest, ListCustomFieldsResponse> operation =
                new ListCustomFields.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListCustomFieldsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
