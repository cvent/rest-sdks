 ...
 * Cvent's platform.
 */
public class AccountUserGroupInput {
    /**
     ...
     * The name of the user group.
     */
    public AccountUserGroupInput withName(@Nonnull String name) {
     ...
     * The description of the user group.
     */
    public AccountUserGroupInput withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccountUserGroupInput other = (AccountUserGroupInput) o;
    ...
    public String toString() {
        return Utils.toString(AccountUserGroupInput.class, "name", name, "description", description);
    }
    ...
    public static final class Builder {
        ...
        public AccountUserGroupInput build() {
            return new AccountUserGroupInput(name, description);
        }
    }
}
