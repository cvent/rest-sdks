...
public class UpdateAccountUserGroupResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public UpdateAccountUserGroupResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
