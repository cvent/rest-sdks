...
public class ListEventWeblinksRequestBuilder {
     ...
     */
    public ListEventWeblinksResponse call() {
     ...
     * <pre><code>
     * for (ListEventWeblinksResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventWeblinksResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventWeblinksResponse> callAsStream() {
