...
public class GetExhibitorFileRequest {
     ...
     * ID of an event.
     */
    public GetExhibitorFileRequest withId(@Nonnull String id) {
     ...
     * ID of an exhibitor.
     */
    public GetExhibitorFileRequest withExhibitorId(@Nonnull String exhibitorId) {
     ...
     * ID of a file.
     */
    public GetExhibitorFileRequest withFileId(@Nonnull String fileId) {
