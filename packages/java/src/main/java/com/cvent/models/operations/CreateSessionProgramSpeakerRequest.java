...
public class CreateSessionProgramSpeakerRequest {
     ...
     * The unique identifier of a program item.
     */
    public CreateSessionProgramSpeakerRequest withProgramItemId(@Nonnull String programItemId) {
     ...
     * The unique identifier of a speaker.
     */
    public CreateSessionProgramSpeakerRequest withId(@Nonnull String id) {
