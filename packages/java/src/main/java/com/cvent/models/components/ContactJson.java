...
public class ContactJson {
    ...
    private ContactTypeJson contactType;
    ...
    @JsonCreator
    public ContactJson(
            @JsonProperty("contactType") @Nullable ContactTypeJson contactType,
     ...
     * The contact types used for the proposal.
     */
    public Optional<ContactTypeJson> contactType() {
     ...
     * The contact types used for the proposal.
     */
    public ContactJson withContactType(@Nullable ContactTypeJson contactType) {
     ...
     * The first name of the contact.
     */
    public ContactJson withFirstName(@Nullable String firstName) {
        this.firstName = firstName;
        return this;
    }
     ...
     * The last name of the contact.
     */
    public ContactJson withLastName(@Nullable String lastName) {
        this.lastName = lastName;
        return this;
    }
     ...
     * The URL of the organization's website.
     */
    public ContactJson withOrganizationWebsite(@Nullable String organizationWebsite) {
        this.organizationWebsite = organizationWebsite;
        return this;
    }
     ...
     * The name of the organization.
     */
    public ContactJson withOrganization(@Nullable String organization) {
        this.organization = organization;
        return this;
    }
     ...
     * Designation of the contact.
     */
    public ContactJson withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * The email address of the contact.
     */
    public ContactJson withEmail(@Nullable String email) {
        this.email = email;
        return this;
    }
     ...
     * The country code for the contact's phone number.
     */
    public ContactJson withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * The phone number of the organization.
     */
    public ContactJson withPhone(@Nullable String phone) {
        this.phone = phone;
        return this;
    }
     ...
     * The organization's fax number.
     */
    public ContactJson withFax(@Nullable String fax) {
        this.fax = fax;
        return this;
    }
     ...
     * The mobile number of the contact.
     */
    public ContactJson withMobile(@Nullable String mobile) {
        this.mobile = mobile;
        return this;
    }
     ...
     * Address line 1 of contact's street address.
     */
    public ContactJson withStreetAddress1(@Nullable String streetAddress1) {
        this.streetAddress1 = streetAddress1;
        return this;
    }
     ...
     * Address line 2 of contact's street address.
     */
    public ContactJson withStreetAddress2(@Nullable String streetAddress2) {
        this.streetAddress2 = streetAddress2;
        return this;
    }
     ...
     * Address line 3 of contact's street address.
     */
    public ContactJson withStreetAddress3(@Nullable String streetAddress3) {
        this.streetAddress3 = streetAddress3;
        return this;
    }
     ...
     * The city of the contact.
     */
    public ContactJson withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * The state province code used for contact information.
     */
    public ContactJson withStateProvince(@Nullable StateProvinceJson stateProvince) {
        this.stateProvince = stateProvince;
        return this;
    }
     ...
     * The postal code of the contact.
     */
    public ContactJson withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country codes with some additional non-standard cvent specific codes.
     */
    public ContactJson withCountry(@Nullable CountryJson country) {
        this.country = country;
        return this;
    }
     ...
     * Additional notes of the contact.
     */
    public ContactJson withNotes(@Nullable String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContactJson other = (ContactJson) o;
    ...
    public static final class Builder {
         ...
         * The contact types used for the proposal.
         */
        public Builder contactType(@Nullable ContactTypeJson contactType) {
            this.contactType = contactType;
            return this;
        }
        ...
        private static final LazySingletonValue<ContactTypeJson> _SINGLETON_VALUE_ContactType =
                new LazySingletonValue<>("contactType", "\"PRIMARY\"", new TypeReference<ContactTypeJson>() {});
    }
}
