...
public class CreateContactHookContactTransactionCallbackResponse implements AsyncResponse {
    /**
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateContactHookContactTransactionCallbackResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
