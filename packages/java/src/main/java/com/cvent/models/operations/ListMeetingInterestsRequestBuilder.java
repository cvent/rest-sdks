...
public class ListMeetingInterestsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListMeetingInterestsRequest request;
    private final Options.Builder optionsBuilder;

    public ListMeetingInterestsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListMeetingInterestsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListMeetingInterestsRequestBuilder request(@Nonnull ListMeetingInterestsRequest request) {
     ...
     */
    public ListMeetingInterestsResponse call() {
     ...
     * <pre><code>
     * for (ListMeetingInterestsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListMeetingInterestsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListMeetingInterestsResponse> callAsStream() {
