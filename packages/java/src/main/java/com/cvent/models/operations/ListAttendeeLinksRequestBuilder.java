...
public class ListAttendeeLinksRequestBuilder {
     ...
     */
    public ListAttendeeLinksResponse call() {
     ...
     * <pre><code>
     * for (ListAttendeeLinksResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAttendeeLinksResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAttendeeLinksResponse> callAsStream() {
