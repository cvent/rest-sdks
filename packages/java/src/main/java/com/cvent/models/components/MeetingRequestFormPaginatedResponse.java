...
public class MeetingRequestFormPaginatedResponse {
     ...
     * Collection of meeting request form objects.
     */
    public List<MeetingRequestForm> data() {
        return this.data;
    }
     ...
     * Represents pagination information for a collection of resources.
     */
    public MeetingRequestFormPaginatedResponse withPaging(@Nonnull PagingJson paging) {
     ...
     * Collection of meeting request form objects.
     */
    public MeetingRequestFormPaginatedResponse withData(@Nonnull List<MeetingRequestForm> data) {
    ...
    public static final class Builder {
         ...
         * Collection of meeting request form objects.
         */
        public Builder data(@Nonnull List<MeetingRequestForm> data) {
            this.data = Utils.checkNotNull(data, "data");
            return this;
        }
