...
public class AirActual {
    ...
    private List<AttendeeAnswer1> airActualAnswers;
    ...
    public AirActual(
            ...
            @JsonProperty("flightDetail") @Nullable List<FlightDetail> flightDetail,
            @JsonProperty("airActualAnswers") @Nullable List<AttendeeAnswer1> airActualAnswers) {
     ...
     * List of all the flight details taken by attendee and its guest
     */
    public Optional<List<FlightDetail>> flightDetail() {
     ...
     * Answer provided by requester to the air actual related question.
     */
    public Optional<List<AttendeeAnswer1>> airActualAnswers() {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public AirActual withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public AirActual withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public AirActual withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public AirActual withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * ID of the air actual.
     */
    public AirActual withAirActualId(@Nullable String airActualId) {
        this.airActualId = airActualId;
        return this;
    }
     ...
     * <p>For any other passenger, this fields contains null.
     */
    public AirActual withRequesterId(@Nullable String requesterId) {
        this.requesterId = requesterId;
        return this;
    }
     ...
     * Status of the travel request done by attendee.
     */
    public AirActual withStatus(@Nullable TravelRequestStatus status) {
        this.status = status;
        return this;
    }
     ...
     * <p>Unknown means attendee has requested a flight for passenger other than its guest.
     */
    public AirActual withRequesterType(@Nullable AirRequesterType requesterType) {
        this.requesterType = requesterType;
        return this;
    }
     ...
     * Name of the attendee booked for the flight.
     */
    public AirActual withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Confirmation Number of the flight.
     */
    public AirActual withConfirmationNumber(@Nullable String confirmationNumber) {
        this.confirmationNumber = confirmationNumber;
        return this;
    }
     ...
     * Total cost of the flight.
     */
    public AirActual withTotalAmount(@Nullable Double totalAmount) {
        this.totalAmount = totalAmount;
        return this;
    }
     ...
     * ISO 4217 currency code for the cost of the flight.
     */
    public AirActual withCurrencyCode(@Nullable String currencyCode) {
        this.currencyCode = currencyCode;
        return this;
    }
     ...
     * Additional note associated to the air actual.
     */
    public AirActual withNote(@Nullable String note) {
        this.note = note;
        return this;
    }
     ...
     * was booked.
     */
    public AirActual withRecordLocatorGDS(@Nullable String recordLocatorGDS) {
        this.recordLocatorGDS = recordLocatorGDS;
        return this;
    }
     ...
     * Additional note from the GDS associated to the air actual.
     */
    public AirActual withNoteGDS(@Nullable String noteGDS) {
        this.noteGDS = noteGDS;
        return this;
    }
     ...
     * List of all the flight details taken by attendee and its guest
     */
    public AirActual withFlightDetail(@Nullable List<FlightDetail> flightDetail) {
        this.flightDetail = flightDetail;
        return this;
    }
     ...
     * Answer provided by requester to the air actual related question.
     */
    public AirActual withAirActualAnswers(@Nullable List<AttendeeAnswer1> airActualAnswers) {
        this.airActualAnswers = airActualAnswers;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * List of all the flight details taken by attendee and its guest
         */
        public Builder flightDetail(@Nullable List<FlightDetail> flightDetail) {
            this.flightDetail = flightDetail;
            return this;
        }
         ...
         * Answer provided by requester to the air actual related question.
         */
        public Builder airActualAnswers(@Nullable List<AttendeeAnswer1> airActualAnswers) {
            this.airActualAnswers = airActualAnswers;
            return this;
        }

        public AirActual build() {
            return new AirActual(
                    created,
                    createdBy,
                    lastModified,
                    lastModifiedBy,
