 ...
 */
public class Calendar implements MembershipItemsPaginatedResponseData {
    /**
    ...
    private CalendarContactType contactType;
    ...
    public Calendar(
            ...
            @JsonProperty("contactType") @Nullable CalendarContactType contactType,
    ...
    public Calendar(@Nonnull String renewalType) {
     ...
     * The contact type associated with this membership item.
     */
    public Optional<CalendarContactType> contactType() {
     ...
     * This text will be displayed in emails using the registration information widget.
     */
    public Calendar withRegistrantInformation(@Nullable String registrantInformation) {
        this.registrantInformation = registrantInformation;
        return this;
    }
     ...
     * A unique identifier for the membership item.
     */
    public Calendar withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Planner specified type or category of membership being offered.
     */
    public Calendar withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * The specific membership item or product name within the membership type.
     */
    public Calendar withItem(@Nullable String item) {
        this.item = item;
        return this;
    }
     ...
     * The contact type associated with this membership item.
     */
    public Calendar withContactType(@Nullable CalendarContactType contactType) {
        this.contactType = contactType;
        return this;
    }
     ...
     * The price charged when an invitee purchases a membership.
     */
    public Calendar withPrice(@Nullable Double price) {
        this.price = price;
        return this;
    }
     ...
     * The price charged when an invitee renews their membership.
     */
    public Calendar withRenewalPrice(@Nullable Double renewalPrice) {
        this.renewalPrice = renewalPrice;
        return this;
    }
     ...
     * Description of the membership item.
     */
    public Calendar withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * A planner-specified code for the membership item.
     */
    public Calendar withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * Contains unique identifiers for registration types associated with this membership item.
     */
    public Calendar withRegistrationTypes(@Nullable List<String> registrationTypes) {
        this.registrationTypes = registrationTypes;
        return this;
    }
     ...
     * True indicates the membership item is selectable during registration.
     */
    public Calendar withOpenForRegistration(@Nullable Boolean openForRegistration) {
        this.openForRegistration = openForRegistration;
        return this;
    }
     ...
     * closes at the start (12:00 AM) of the chosen date, according to the UTC timezone.
     */
    public Calendar withAutomaticClosureDate(@Nullable LocalDate automaticClosureDate) {
        this.automaticClosureDate = automaticClosureDate;
        return this;
    }
     ...
     * The ISO 4217 currency code for this membership item.
     */
    public Calendar withCurrency(@Nullable String currency) {
        this.currency = currency;
        return this;
    }
     ...
     * The renewal type of the membership item.
     */
    public Calendar withRenewalType(@Nonnull String renewalType) {
     ...
     * item will be reduced based on when it is purchased.
     */
    public Calendar withProRated(@Nullable Boolean proRated) {
        this.proRated = proRated;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * The contact type associated with this membership item.
         */
        public Builder contactType(@Nullable CalendarContactType contactType) {
            this.contactType = contactType;
            return this;
        }
