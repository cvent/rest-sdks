...
public class TransactionDetailResponse {
    ...
    public TransactionDetailResponse(
            ...
            @JsonProperty("billingAddress") @Nullable BillingAddress billingAddress) {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public TransactionDetailResponse withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public TransactionDetailResponse withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public TransactionDetailResponse withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public TransactionDetailResponse withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * A unique id representing the transaction.
     */
    public TransactionDetailResponse withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * This denotes the online processor transaction Id for transactions.
     */
    public TransactionDetailResponse withProcessorTransactionId(@Nullable String processorTransactionId) {
        this.processorTransactionId = processorTransactionId;
        return this;
    }
     ...
     * The reference to the event. Contains only the ID of the event.
     */
    public TransactionDetailResponse withEvent(@Nullable Event2 event) {
        this.event = event;
        return this;
    }
     ...
     * This denotes the order IDs corresponding to this transaction.
     */
    public TransactionDetailResponse withOrders(@Nullable List<Order> orders) {
        this.orders = orders;
        return this;
    }
     ...
     * Journal number for this transaction.
     */
    public TransactionDetailResponse withJournalNumber(@Nullable String journalNumber) {
        this.journalNumber = journalNumber;
        return this;
    }
     ...
     * This denotes the payment method in a transaction.
     */
    public TransactionDetailResponse withPaymentMethod(@Nullable PaymentMethod paymentMethod) {
        this.paymentMethod = paymentMethod;
        return this;
    }
     ...
     * Indicates if the transaction was successful.
     */
    public TransactionDetailResponse withSuccess(@Nullable Boolean success) {
        this.success = success;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when attendee made the transaction.
     */
    public TransactionDetailResponse withDate(@Nullable OffsetDateTime date) {
        this.date = date;
        return this;
    }
     ...
     * This denotes the batch number of this transaction.
     */
    public TransactionDetailResponse withBatchNumber(@Nullable String batchNumber) {
        this.batchNumber = batchNumber;
        return this;
    }
     ...
     * This denotes the reference number of this transaction.
     */
    public TransactionDetailResponse withReferenceNumber(@Nullable String referenceNumber) {
        this.referenceNumber = referenceNumber;
        return this;
    }
     ...
     * Amount of the transaction.
     */
    public TransactionDetailResponse withAmount(@Nullable Double amount) {
        this.amount = amount;
        return this;
    }
     ...
     * This denotes the currency of this transaction.
     */
    public TransactionDetailResponse withCurrency(@Nullable String currency) {
        this.currency = currency;
        return this;
    }
     ...
     * This denotes the notes about this transaction.
     */
    public TransactionDetailResponse withPaymentNote(@Nullable String paymentNote) {
        this.paymentNote = paymentNote;
        return this;
    }
     ...
     * This denotes the name of credit card holder.
     */
    public TransactionDetailResponse withNameOnCreditCard(@Nullable String nameOnCreditCard) {
        this.nameOnCreditCard = nameOnCreditCard;
        return this;
    }
     ...
     * The expiration date of the attendee's credit card.
     */
    public TransactionDetailResponse withExpirationDateOfCreditCard(
            @Nullable OffsetDateTime expirationDateOfCreditCard) {
        this.expirationDateOfCreditCard = expirationDateOfCreditCard;
        return this;
    }
     ...
     * Billing Address Details
     */
    public TransactionDetailResponse withBillingAddress(@Nullable BillingAddress billingAddress) {
        this.billingAddress = billingAddress;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TransactionDetailResponse other = (TransactionDetailResponse) o;
    ...
    public static final class Builder {
         ...
         * This denotes the payment method in a transaction.
         */
        public Builder paymentMethod(@Nullable PaymentMethod paymentMethod) {
            this.paymentMethod = paymentMethod;
            return this;
        }
         ...
         * Billing Address Details
         */
        public Builder billingAddress(@Nullable BillingAddress billingAddress) {
            this.billingAddress = billingAddress;
            return this;
        }
