...
public class CreateAttendeeLinksRequest {
    ...
    @JsonCreator
    public CreateAttendeeLinksRequest(
            @Nonnull String id,
            @Nonnull List<ZeroInput> requestBody) {
    ...
    public String toString() {
        return Utils.toString(CreateAttendeeLinksRequest.class,
                "id", id,
    ...
    public final static class Builder {
        ...
        public CreateAttendeeLinksRequest build() {
            return new CreateAttendeeLinksRequest(
                id, requestBody);
        }
