...
public class ExistingExhibitorAdminJson {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public ExistingExhibitorAdminJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public ExistingExhibitorAdminJson withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public ExistingExhibitorAdminJson withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     */
    @Deprecated
    public ExistingExhibitorAdminJson withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The Associated Exhibitor.
     */
    public ExistingExhibitorAdminJson withExhibitor(@Nonnull ExhibitorJson exhibitor) {
     ...
     * The first name of the exhibitor admin
     */
    public ExistingExhibitorAdminJson withFirstName(@Nonnull String firstName) {
     ...
     * The last name of the exhibitor admin
     */
    public ExistingExhibitorAdminJson withLastName(@Nonnull String lastName) {
     ...
     * The email address of the exhibitor admin
     */
    public ExistingExhibitorAdminJson withEmail(@Nonnull String email) {
     ...
     * Exhibitor Admin id
     */
    public ExistingExhibitorAdminJson withId(@Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ExistingExhibitorAdminJson other = (ExistingExhibitorAdminJson) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ExistingExhibitorAdminJson.class,
                "created", created,
                "createdBy", createdBy,
    ...
    public final static class Builder {
        ...
        public ExistingExhibitorAdminJson build() {
            return new ExistingExhibitorAdminJson(
                created, createdBy, lastModified,
                lastModifiedBy, exhibitor, firstName,
                lastName, email, id);
        }
