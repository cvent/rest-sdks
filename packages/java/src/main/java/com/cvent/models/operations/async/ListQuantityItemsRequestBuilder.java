...
public class ListQuantityItemsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListQuantityItemsRequest request;
    private final Options.Builder optionsBuilder;

    public ListQuantityItemsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListQuantityItemsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListQuantityItemsRequestBuilder request(@Nonnull ListQuantityItemsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListQuantityItemsRequest _buildRequest() {
        return this.request;
    }

    public ListQuantityItemsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListQuantityItemsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListQuantityItemsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListQuantityItemsResponse&gt;() {
     ...
     */
    public Publisher<ListQuantityItemsResponse> callAsPublisher() {
        ListQuantityItemsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListQuantityItemsRequest, ListQuantityItemsResponse> operation =
                new ListQuantityItems.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListQuantityItemsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
