...
public class GetEventSurveyQuestionsRequestBuilder {
     ...
     */
    public GetEventSurveyQuestionsResponse call() {
     ...
     * <pre><code>
     * for (GetEventSurveyQuestionsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEventSurveyQuestionsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEventSurveyQuestionsResponse> callAsStream() {
