...
public class GetOrdersRequestBuilder {
     ...
     * <pre><code>
     * for (GetOrdersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetOrdersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetOrdersResponse> callAsStream() {
