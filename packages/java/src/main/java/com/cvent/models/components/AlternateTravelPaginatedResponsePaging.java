 ...
 *
 * <p>Represents pagination information for the list of results.
 */
public class AlternateTravelPaginatedResponsePaging {
     ...
     * previous page of data.
     */
    public AlternateTravelPaginatedResponsePaging withPreviousToken(@Nullable String previousToken) {
        this.previousToken = previousToken;
        return this;
    }
     ...
     * page of data you can fetch.
     */
    public AlternateTravelPaginatedResponsePaging withNextToken(@Nullable String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
     ...
     * The pagination token for the current page.
     */
    public AlternateTravelPaginatedResponsePaging withCurrentToken(@Nullable String currentToken) {
        this.currentToken = currentToken;
        return this;
    }
     ...
     * The number of records to return on the page. Not to exceed 200.
     */
    public AlternateTravelPaginatedResponsePaging withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * To confirm if there are more records, check the `nextToken` field.
     */
    public AlternateTravelPaginatedResponsePaging withTotalCount(@Nullable Long totalCount) {
        this.totalCount = totalCount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AlternateTravelPaginatedResponsePaging other = (AlternateTravelPaginatedResponsePaging) o;
    ...
    @Override
    public int hashCode() {
        return Utils.enhancedHash(previousToken, nextToken, currentToken, limit, totalCount, links);
    }

    @Override
    public String toString() {
        return Utils.toString(
                AlternateTravelPaginatedResponsePaging.class,
                "previousToken",
                previousToken,
                "nextToken",
                nextToken,
    ...
    public static final class Builder {
        ...
        public AlternateTravelPaginatedResponsePaging build() {
            return new AlternateTravelPaginatedResponsePaging(
                    previousToken, nextToken, currentToken, limit, totalCount, links);
        }
    }
}
