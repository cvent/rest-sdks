...
public class StandardSurveyEmailTemplateJson {
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public StandardSurveyEmailTemplateJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public StandardSurveyEmailTemplateJson withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public StandardSurveyEmailTemplateJson withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public StandardSurveyEmailTemplateJson withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * Name of the email template.
     */
    public StandardSurveyEmailTemplateJson withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Subject of the email template.
     */
    public StandardSurveyEmailTemplateJson withSubject(@Nullable String subject) {
        this.subject = subject;
        return this;
    }
     ...
     * Name of the sender.
     */
    public StandardSurveyEmailTemplateJson withFromName(@Nullable String fromName) {
        this.fromName = fromName;
        return this;
    }
     ...
     * The email address of the sender.
     */
    public StandardSurveyEmailTemplateJson withFromEmail(@Nullable String fromEmail) {
        this.fromEmail = fromEmail;
        return this;
    }
     ...
     * Plain text body of the page in the email.
     */
    public StandardSurveyEmailTemplateJson withPlaintextBody(@Nullable String plaintextBody) {
        this.plaintextBody = plaintextBody;
        return this;
    }
     ...
     * html body of the page sent in the email
     */
    public StandardSurveyEmailTemplateJson withHtmlBody(@Nullable String htmlBody) {
        this.htmlBody = htmlBody;
        return this;
    }
     ...
     * The locale of the email template using the IETF Language Tag format.
     */
    public StandardSurveyEmailTemplateJson withLocale(@Nullable String locale) {
        this.locale = locale;
        return this;
    }
     ...
     * Enables tracking when respondent clicks on the email
     */
    public StandardSurveyEmailTemplateJson withClickTrackingEnabled(@Nullable Boolean clickTrackingEnabled) {
        this.clickTrackingEnabled = clickTrackingEnabled;
        return this;
    }
     ...
     * Name of the person to reply to
     */
    public StandardSurveyEmailTemplateJson withReplyToName(@Nullable String replyToName) {
        this.replyToName = replyToName;
        return this;
    }
     ...
     * Email address to reply to
     */
    public StandardSurveyEmailTemplateJson withReplyToEmail(@Nullable String replyToEmail) {
        this.replyToEmail = replyToEmail;
        return this;
    }
     ...
     * A string that has to be a format matching the industry standard uuid
     */
    public StandardSurveyEmailTemplateJson withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Status of the email
     */
    public StandardSurveyEmailTemplateJson withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
