...
public class ListTravelProgramQuestionsRequestBuilder {
     ...
     */
    public ListTravelProgramQuestionsResponse call() {
     ...
     * <pre><code>
     * for (ListTravelProgramQuestionsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListTravelProgramQuestionsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListTravelProgramQuestionsResponse> callAsStream() {
