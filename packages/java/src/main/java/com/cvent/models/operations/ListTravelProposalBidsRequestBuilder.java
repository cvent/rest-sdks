...
public class ListTravelProposalBidsRequestBuilder {
     ...
     */
    public ListTravelProposalBidsResponse call() {
     ...
     * <pre><code>
     * for (ListTravelProposalBidsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListTravelProposalBidsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListTravelProposalBidsResponse> callAsStream() {
