...
public class ListAudienceSegmentsRequestBuilder {
    ...
    private ListAudienceSegmentsRequest request;
    private final Options.Builder optionsBuilder;

    public ListAudienceSegmentsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListAudienceSegmentsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListAudienceSegmentsRequestBuilder request(@Nonnull ListAudienceSegmentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListAudienceSegmentsRequest _buildRequest() {
        return this.request;
    }

    public ListAudienceSegmentsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListAudienceSegmentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListAudienceSegmentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListAudienceSegmentsResponse&gt;() {
     ...
     */
    public Publisher<ListAudienceSegmentsResponse> callAsPublisher() {
        ListAudienceSegmentsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListAudienceSegmentsRequest, ListAudienceSegmentsResponse> operation =
                new ListAudienceSegments.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListAudienceSegmentsResponse> flowPublisher =
