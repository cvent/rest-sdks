...
public class ListAppointmentTypesResponse implements AsyncResponse {
    /**
     ...
     * Successfully retrieved a paginated list of appointment types.
     */
    public Optional<AppointmentTypesPaginatedResponse> appointmentTypesPaginatedResponse() {
        return Optional.ofNullable(this.appointmentTypesPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public ListAppointmentTypesResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListAppointmentTypesResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListAppointmentTypesResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
