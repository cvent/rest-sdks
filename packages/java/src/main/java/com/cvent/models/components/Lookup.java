...
public class Lookup {
     ...
     * A string that has to be a format matching the industry standard uuid
     */
    public Lookup withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * Code / Abbreviation of the lookup item.
     */
    public Lookup withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * Name of the lookup item.
     */
    public Lookup withName(@Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Lookup.class, "id", id, "code", code, "name", name);
    }
