...
public class GetAccountVendorsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetAccountVendorsRequest request;
    private final Options.Builder optionsBuilder;

    public GetAccountVendorsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetAccountVendorsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetAccountVendorsRequestBuilder request(@Nonnull GetAccountVendorsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private GetAccountVendorsRequest _buildRequest() {
        return this.request;
    }

    public GetAccountVendorsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<GetAccountVendorsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetAccountVendorsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetAccountVendorsResponse&gt;() {
     ...
     */
    public Publisher<GetAccountVendorsResponse> callAsPublisher() {
        GetAccountVendorsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<GetAccountVendorsRequest, GetAccountVendorsResponse> operation =
                new GetAccountVendors.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<GetAccountVendorsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
