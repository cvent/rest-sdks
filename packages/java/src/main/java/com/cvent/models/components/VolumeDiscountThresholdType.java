...
public enum VolumeDiscountThresholdType {
    ...
    VolumeDiscountThresholdType(String value) {
        this.value = value;
    }
    ...
    public static Optional<VolumeDiscountThresholdType> fromValue(String value) {
        for (VolumeDiscountThresholdType o : VolumeDiscountThresholdType.values()) {
