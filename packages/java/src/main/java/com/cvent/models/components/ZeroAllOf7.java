...
public class ZeroAllOf7 {
    ...
    public ZeroAllOf7(long code, @Nonnull String message) {
    ...
    public String toString() {
        return Utils.toString(ZeroAllOf7.class, "id", id, "code", code, "message", message, "target", target);
    }
    ...
    public static final class Builder {
        ...
        public ZeroAllOf7 build() {
            return new ZeroAllOf7(id, code, message, target);
        }
    }
}
