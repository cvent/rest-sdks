...
public class GetHousingEventInventoryRequest {
     ...
     * ID for a Passkey housing event.
     */
    public GetHousingEventInventoryRequest withHousingEventId(long housingEventId) {
        this.housingEventId = housingEventId;
        return this;
    }
     ...
     * Limit to this number of search results. Maximum of 200, default of 100.
     */
    public GetHousingEventInventoryRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public GetHousingEventInventoryRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public GetHousingEventInventoryRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
