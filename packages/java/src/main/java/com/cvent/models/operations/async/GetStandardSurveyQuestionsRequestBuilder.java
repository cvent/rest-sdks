...
public class GetStandardSurveyQuestionsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetStandardSurveyQuestionsRequest request;
    private final Options.Builder optionsBuilder;

    public GetStandardSurveyQuestionsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetStandardSurveyQuestionsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetStandardSurveyQuestionsRequestBuilder request(@Nonnull GetStandardSurveyQuestionsRequest request) {
     ...
     * <pre><code>
     * Publisher&lt;GetStandardSurveyQuestionsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetStandardSurveyQuestionsResponse&gt;() {
