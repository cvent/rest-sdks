...
public class ListAssociatedAudienceSegmentsRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListAssociatedAudienceSegmentsRequest request;
    private final Options.Builder optionsBuilder;

    public ListAssociatedAudienceSegmentsRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListAssociatedAudienceSegmentsRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListAssociatedAudienceSegmentsRequestBuilder request(
            @Nonnull ListAssociatedAudienceSegmentsRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListAssociatedAudienceSegmentsRequest _buildRequest() {
        return this.request;
    }

    public ListAssociatedAudienceSegmentsRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListAssociatedAudienceSegmentsResponse> call() {
     ...
     */
    public Publisher<ListAssociatedAudienceSegmentsResponse> callAsPublisher() {
        ListAssociatedAudienceSegmentsRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListAssociatedAudienceSegmentsRequest, ListAssociatedAudienceSegmentsResponse> operation =
                new ListAssociatedAudienceSegments.Async(
                        sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListAssociatedAudienceSegmentsResponse> flowPublisher =
