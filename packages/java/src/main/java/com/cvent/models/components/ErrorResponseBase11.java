 ...
 */
public class ErrorResponseBase11 {
    /**
    ...
    public ErrorResponseBase11(long code, @Nonnull String message) {
     ...
     * The HTTP status code representing the error.
     */
    public ErrorResponseBase11 withCode(long code) {
        this.code = code;
        return this;
    }
     ...
     * A brief description of the error.
     */
    public ErrorResponseBase11 withMessage(@Nonnull String message) {
     ...
     * The target resource of the error.
     */
    public ErrorResponseBase11 withTarget(@Nullable String target) {
        this.target = target;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ErrorResponseBase11 other = (ErrorResponseBase11) o;
    ...
    public String toString() {
        return Utils.toString(ErrorResponseBase11.class, "code", code, "message", message, "target", target);
    }
    ...
    public static final class Builder {
        ...
        public ErrorResponseBase11 build() {
            return new ErrorResponseBase11(code, message, target);
        }
    }
}
