 ...
 */
public class MeetingRequestBulkResponseItem {
    /**
     * A meeting request.
     */
    @JsonProperty("data")
    ...
    @JsonCreator
    public MeetingRequestBulkResponseItem(
    ...
    public MeetingRequestBulkResponseItem(@Nonnull MeetingRequest data, long status) {
     ...
     * A meeting request.
     */
    public MeetingRequestBulkResponseItem withData(@Nonnull MeetingRequest data) {
     ...
     * HTTP status code representing the processing status of a single item.
     */
    public MeetingRequestBulkResponseItem withStatus(long status) {
        this.status = status;
        return this;
    }
     ...
     * Quick description of what happened during processing.
     */
    public MeetingRequestBulkResponseItem withMessage(@Nullable String message) {
        this.message = message;
        return this;
    }
     ...
     * The processed request tied to this response. This field is only sent when processing fails.
     */
    public MeetingRequestBulkResponseItem withRequest(@Nullable Request request) {
        this.request = request;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MeetingRequestBulkResponseItem other = (MeetingRequestBulkResponseItem) o;
    ...
    public String toString() {
        return Utils.toString(
                MeetingRequestBulkResponseItem.class,
                "data",
                data,
                "status",
                status,
    ...
    public static final class Builder {
        ...
        public MeetingRequestBulkResponseItem build() {
            return new MeetingRequestBulkResponseItem(data, status, message, request);
        }
    }
}
