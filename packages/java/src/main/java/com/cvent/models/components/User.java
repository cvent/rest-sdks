...
public class User {
     ...
     * Enterprise extension model for the user.
     */
    public User withUrnIetfParamsScimSchemasExtensionEnterprise20User(@Nonnull UserEnterpriseExtensionJson urnIetfParamsScimSchemasExtensionEnterprise20User) {
