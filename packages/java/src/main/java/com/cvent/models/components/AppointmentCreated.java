...
public class AppointmentCreated {
     ...
     * An activity appointment.
     */
    public AppointmentCreated withAppointment(@Nullable ActivityAppointment appointment) {
        this.appointment = appointment;
        return this;
    }
     ...
     * An activity contact.
     */
    public AppointmentCreated withContact(@Nullable ActivityContact contact) {
        this.contact = contact;
        return this;
    }
