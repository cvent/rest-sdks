...
public class ListEventRoleAssignmentRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListEventRoleAssignmentRequest request;

    public ListEventRoleAssignmentRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
    }

    public ListEventRoleAssignmentRequestBuilder request(@Nonnull ListEventRoleAssignmentRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListEventRoleAssignmentRequest _buildRequest() {
        return this.request;
    }
    
    public ListEventRoleAssignmentRequestBuilder header(String name, String value) {
    ...
    */
    public CompletableFuture<ListEventRoleAssignmentResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListEventRoleAssignmentResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListEventRoleAssignmentResponse&gt;() {
     ...
     */
    public Publisher<ListEventRoleAssignmentResponse> callAsPublisher() {
        ListEventRoleAssignmentRequest request = this.request;
        AsyncRequestOperation<ListEventRoleAssignmentRequest, ListEventRoleAssignmentResponse> operation
              = new ListEventRoleAssignment.Async(sdkConfiguration, _headers);
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
            ...
            ListEventRoleAssignmentRequest::withToken,
            operation::doRequest);

        Flow.Publisher<ListEventRoleAssignmentResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
