...
public class ListAttendeesRequestBuilder {
     ...
     */
    public ListAttendeesResponse call() {
     ...
     * <pre><code>
     * for (ListAttendeesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAttendeesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAttendeesResponse> callAsStream() {
