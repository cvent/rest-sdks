...
public class GetEmailStatusResponse implements Response {
    /**
     ...
     * Successfully retrieved a list of email send statuses associated with particular email request ID.
     */
    public Optional<EmailSendStatus> emailSendStatus() {
        return Optional.ofNullable(this.emailSendStatus);
    }
     ...
     * HTTP response content type for this operation
     */
    public GetEmailStatusResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public GetEmailStatusResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetEmailStatusResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successfully retrieved a list of email send statuses associated with particular email request ID.
     */
    public GetEmailStatusResponse withEmailSendStatus(@Nullable EmailSendStatus emailSendStatus) {
        this.emailSendStatus = emailSendStatus;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Successfully retrieved a list of email send statuses associated with particular email request ID.
         */
        public Builder emailSendStatus(@Nullable EmailSendStatus emailSendStatus) {
            this.emailSendStatus = emailSendStatus;
            return this;
        }
