...
public class GetSurveyRequestBuilder {
    ...
    private GetSurveyRequest _buildRequest() {
        return this.request;
    }

    public GetSurveyRequestBuilder header(String name, String value) {
     ...
     * <pre><code>
     * Publisher&lt;GetSurveyResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetSurveyResponse&gt;() {
    ...
    public Publisher<GetSurveyResponse> callAsPublisher() {
        ...
        Flow.Publisher<HttpResponse<Blob>> asyncPaginator = new AsyncPaginator<>(
                ...
                GetSurveyRequest::withToken,
                operation::doRequest);

        Flow.Publisher<GetSurveyResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
