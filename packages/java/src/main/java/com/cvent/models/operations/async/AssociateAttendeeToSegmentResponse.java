...
public class AssociateAttendeeToSegmentResponse implements AsyncResponse {
    /**
     ...
     * HTTP response content type for this operation
     */
    public AssociateAttendeeToSegmentResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public AssociateAttendeeToSegmentResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public AssociateAttendeeToSegmentResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
