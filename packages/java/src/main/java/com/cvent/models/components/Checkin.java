...
public class Checkin {
    ...
    public Checkin(@Nonnull String id, @Nonnull OffsetDateTime checkIn) {
     ...
     * ID of the attendee to be checked-in to an event.
     */
    public Checkin withId(@Nonnull String id) {
     ...
     * The ISO 8601 zoned date and time when the attendee was checked-in to an event.
     */
    public Checkin withCheckIn(@Nonnull OffsetDateTime checkIn) {
     ...
     * Name of the device used for check-in.
     */
    public Checkin withDevice(@Nullable String device) {
        this.device = device;
        return this;
    }
     ...
     * The ISO 8601 zoned date and time when the attendee checked out of an event.
     */
    public Checkin withCheckOut(@Nullable OffsetDateTime checkOut) {
        this.checkOut = checkOut;
        return this;
    }
     ...
     * Duration (in milliseconds) the attendee was present at the event.
     */
    public Checkin withDuration(@Nullable Long duration) {
        this.duration = duration;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public Checkin build() {
            return new Checkin(id, checkIn, device, checkOut, duration);
        }
    }
}
