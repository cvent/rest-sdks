...
public class ListTravelAccountsRequestBuilder {
     ...
     */
    public ListTravelAccountsResponse call() {
     ...
     * <pre><code>
     * for (ListTravelAccountsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListTravelAccountsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListTravelAccountsResponse> callAsStream() {
