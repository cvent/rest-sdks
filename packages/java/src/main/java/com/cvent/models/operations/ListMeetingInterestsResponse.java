...
public class ListMeetingInterestsResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public ListMeetingInterestsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListMeetingInterestsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListMeetingInterestsResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
