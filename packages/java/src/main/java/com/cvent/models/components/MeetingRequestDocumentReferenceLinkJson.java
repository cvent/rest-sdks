...
public class MeetingRequestDocumentReferenceLinkJson {
     ...
     * change over time.
     */
    public MeetingRequestDocumentReferenceLinkJson withUrl(@Nullable String url) {
        this.url = url;
        return this;
    }
     ...
     * expiration is defined.
     */
    public MeetingRequestDocumentReferenceLinkJson withExpiration(@Nullable OffsetDateTime expiration) {
        this.expiration = expiration;
        return this;
    }
