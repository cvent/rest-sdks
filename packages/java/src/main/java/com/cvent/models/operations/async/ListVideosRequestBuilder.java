...
public class ListVideosRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListVideosRequest request;
    private final Options.Builder optionsBuilder;

    public ListVideosRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListVideosRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListVideosRequestBuilder request(@Nonnull ListVideosRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListVideosRequest _buildRequest() {
        return this.request;
    }

    public ListVideosRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListVideosResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListVideosResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListVideosResponse&gt;() {
     ...
     */
    public Publisher<ListVideosResponse> callAsPublisher() {
        ListVideosRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListVideosRequest, ListVideosResponse> operation =
                new ListVideos.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListVideosResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
