...
public class DeleteSessionResponse implements Response {
    /**
     ...
     * HTTP response content type for this operation
     */
    public DeleteSessionResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public DeleteSessionResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteSessionResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
