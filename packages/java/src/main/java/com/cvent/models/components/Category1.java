...
public class Category1 {
    ...
    public Category1(
            ...
            @JsonProperty("items") @Nullable List<Item> items) {
        this.type = type;
        this.name = name;
     ...
     * The category type.
     */
    public Category1 withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * The name of the category.
     */
    public Category1 withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Total cost for all items within this category.
     */
    public Category1 withTotalCost(@Nullable Double totalCost) {
        this.totalCost = totalCost;
        return this;
    }
     ...
     * List of items in this category.
     */
    public Category1 withItems(@Nullable List<Item> items) {
        this.items = items;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Category1.class, "type", type, "name", name, "totalCost", totalCost, "items", items);
    }
    ...
    public static final class Builder {
        ...
        public Category1 build() {
            return new Category1(type, name, totalCost, items);
        }
    }
}
