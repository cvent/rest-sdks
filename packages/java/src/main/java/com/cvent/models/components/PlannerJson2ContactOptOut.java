 ...
 */
@Deprecated
public class PlannerJson2ContactOptOut {
    /**
    ...
    @JsonCreator
    public PlannerJson2ContactOptOut(
     ...
     * Used to denote if a contact has opted-out of receiving system generated emails.
     */
    public PlannerJson2ContactOptOut withOptedOut(@Nullable Boolean optedOut) {
     ...
     * opts out multiple times.
     */
    public PlannerJson2ContactOptOut withDate(@Nullable OffsetDateTime date) {
        this.date = date;
        return this;
    }
     ...
     * This is used to denote how a contact is opt'd out of Cvent system.
     */
    public PlannerJson2ContactOptOut withBy(@Nullable OptoutByJson by) {
        this.by = by;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlannerJson2ContactOptOut other = (PlannerJson2ContactOptOut) o;
    ...
    public String toString() {
        return Utils.toString(PlannerJson2ContactOptOut.class, "optedOut", optedOut, "date", date, "by", by);
    }
    ...
    public static final class Builder {
        ...
        public PlannerJson2ContactOptOut build() {
            return new PlannerJson2ContactOptOut(optedOut, date, by);
        }
