...
public class AppointmentAccepted {
     ...
     * An activity appointment.
     */
    public AppointmentAccepted withAppointment(@Nullable ActivityAppointmentJson appointment) {
        this.appointment = appointment;
        return this;
    }
     ...
     * An activity contact.
     */
    public AppointmentAccepted withContact(@Nullable ActivityContactJson contact) {
        this.contact = contact;
        return this;
    }
