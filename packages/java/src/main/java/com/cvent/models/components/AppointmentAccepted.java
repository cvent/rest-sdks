...
public class AppointmentAccepted {
     ...
     * An activity appointment.
     */
    public AppointmentAccepted withAppointment(@Nullable ActivityAppointment appointment) {
        this.appointment = appointment;
        return this;
    }
     ...
     * An activity contact.
     */
    public AppointmentAccepted withContact(@Nullable ActivityContact contact) {
        this.contact = contact;
        return this;
    }
