...
public class ListFeeItemsRequest {
     ...
     * Unique ID of an event.
     */
    public ListFeeItemsRequest withId(@Nonnull String id) {
     ...
     * The maximum number of records to return per page.
     */
    public ListFeeItemsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListFeeItemsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * or
     */
    public ListFeeItemsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
