...
public class UsersSchemas {
    ...
    private List<UsersSchema> resources;
    ...
    public UsersSchemas(
            ...
            @JsonProperty("Resources") @Nullable List<UsersSchema> resources) {
     ...
     * The collection of schema resources.
     */
    public Optional<List<UsersSchema>> resources() {
     ...
     * The collection of user schemas.
     */
    public UsersSchemas withSchemas(@Nullable List<String> schemas) {
        this.schemas = schemas;
        return this;
    }
     ...
     * The number of schemas per page.
     */
    public UsersSchemas withItemsPerPage(@Nullable Long itemsPerPage) {
        this.itemsPerPage = itemsPerPage;
        return this;
    }
     ...
     * Starting index of the response.
     */
    public UsersSchemas withStartIndex(@Nullable Long startIndex) {
        this.startIndex = startIndex;
        return this;
    }
     ...
     * The total count of schemas.
     */
    public UsersSchemas withTotalResults(@Nullable Long totalResults) {
        this.totalResults = totalResults;
        return this;
    }
     ...
     * The collection of schema resources.
     */
    public UsersSchemas withResources(@Nullable List<UsersSchema> resources) {
        this.resources = resources;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * The collection of schema resources.
         */
        public Builder resources(@Nullable List<UsersSchema> resources) {
            this.resources = resources;
            return this;
        }
