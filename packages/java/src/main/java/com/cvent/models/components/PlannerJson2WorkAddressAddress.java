...
public class PlannerJson2WorkAddressAddress {
    ...
    @JsonCreator
    public PlannerJson2WorkAddressAddress(
     ...
     * The first line of an address.
     */
    public PlannerJson2WorkAddressAddress withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public PlannerJson2WorkAddressAddress withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public PlannerJson2WorkAddressAddress withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public PlannerJson2WorkAddressAddress withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public PlannerJson2WorkAddressAddress withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public PlannerJson2WorkAddressAddress withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public PlannerJson2WorkAddressAddress withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public PlannerJson2WorkAddressAddress withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country of the address.
     */
    public PlannerJson2WorkAddressAddress withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public PlannerJson2WorkAddressAddress withLatitude(@Nullable Long latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public PlannerJson2WorkAddressAddress withLongitude(@Nullable Long longitude) {
        this.longitude = longitude;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PlannerJson2WorkAddressAddress other = (PlannerJson2WorkAddressAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PlannerJson2WorkAddressAddress.class,
                "address1", address1,
                "address2", address2,
                "address3", address3,
                "city", city,
    ...
    public final static class Builder {
        ...
        public PlannerJson2WorkAddressAddress build() {
            return new PlannerJson2WorkAddressAddress(
                address1, address2, address3,
                city, countryCode, postalCode,
                region, regionCode, country,
                latitude, longitude);
