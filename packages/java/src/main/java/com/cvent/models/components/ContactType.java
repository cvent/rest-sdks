...
public class ContactType {
    ...
    public ContactType(@Nonnull String id, @Nonnull String code, @Nonnull String name) {
     ...
     * The ID of the contact type.
     */
    public ContactType withId(@Nonnull String id) {
     ...
     * The contact type code. Must be unique in the account.
     */
    public ContactType withCode(@Nonnull String code) {
     ...
     * Name of the contact type.
     */
    public ContactType withName(@Nonnull String name) {
     ...
     * Description of the contact type.
     */
    public ContactType withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * Indicates whether the contact type is active.
     */
    public ContactType withActive(@Nullable Boolean active) {
        this.active = active;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContactType other = (ContactType) o;
    ...
    public String toString() {
        return Utils.toString(
                ContactType.class, "id", id, "code", code, "name", name, "description", description, "active", active);
    }
    ...
    public static final class Builder {
        ...
        public ContactType build() {
            return new ContactType(id, code, name, description, active);
        }
    }
}
