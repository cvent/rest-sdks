...
public class GetSessionSegmentsRequestBuilder {
     ...
     */
    public GetSessionSegmentsResponse call() {
     ...
     * <pre><code>
     * for (GetSessionSegmentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetSessionSegmentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetSessionSegmentsResponse> callAsStream() {
