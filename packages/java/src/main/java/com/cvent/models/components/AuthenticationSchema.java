...
public class AuthenticationSchema {
     ...
     * The name of the authentication.
     */
    public AuthenticationSchema withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * The description of the authentication.
     */
    public AuthenticationSchema withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * The location of the authentication specifications.
     */
    public AuthenticationSchema withSpecUri(@Nullable String specUri) {
        this.specUri = specUri;
        return this;
    }
     ...
     * The location of the API documentation.
     */
    public AuthenticationSchema withDocumentationUri(@Nullable String documentationUri) {
        this.documentationUri = documentationUri;
        return this;
    }
     ...
     * The type of the authentication.
     */
    public AuthenticationSchema withType(@Nullable String type) {
        this.type = type;
        return this;
    }
     ...
     * True indicates the authentication is primary.
     */
    public AuthenticationSchema withPrimary(@Nullable Boolean primary) {
        this.primary = primary;
        return this;
    }
    ...
    public static final class Builder {
        ...
        public AuthenticationSchema build() {
            return new AuthenticationSchema(name, description, specUri, documentationUri, type, primary);
        }
    }
}
