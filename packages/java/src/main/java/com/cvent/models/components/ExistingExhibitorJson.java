...
public class ExistingExhibitorJson {
    ...
    public ExistingExhibitorJson(@Nonnull EventJson6 event, @Nonnull String name) {
        this(
                null,
                null,
                null,
     ...
     * The ISO 8601 zoned date time when this record was created.
     */
    public ExistingExhibitorJson withCreated(@Nullable OffsetDateTime created) {
        this.created = created;
        return this;
    }
     ...
     * The identifier of the user that created this record.
     */
    public ExistingExhibitorJson withCreatedBy(@Nullable String createdBy) {
        this.createdBy = createdBy;
        return this;
    }
     ...
     * The ISO 8601 zoned date time when this record was updated.
     */
    public ExistingExhibitorJson withLastModified(@Nullable OffsetDateTime lastModified) {
        this.lastModified = lastModified;
        return this;
    }
     ...
     * The identifier of the user that last updated this record.
     */
    public ExistingExhibitorJson withLastModifiedBy(@Nullable String lastModifiedBy) {
        this.lastModifiedBy = lastModifiedBy;
        return this;
    }
     ...
     * The Associated Event.
     */
    public ExistingExhibitorJson withEvent(@Nonnull EventJson6 event) {
     ...
     * results.
     */
    public ExistingExhibitorJson withName(@Nonnull String name) {
     ...
     * Exhibitor description
     */
    public ExistingExhibitorJson withDescription(@Nullable String description) {
        this.description = description;
        return this;
    }
     ...
     * Code used to identify the exhibitor
     */
    public ExistingExhibitorJson withCode(@Nullable String code) {
        this.code = code;
        return this;
    }
     ...
     * Code used for marketing groupings
     */
    public ExistingExhibitorJson withSourceId(@Nullable String sourceId) {
        this.sourceId = sourceId;
        return this;
    }
     ...
     * Exhibitor location
     */
    public ExistingExhibitorJson withLocation(@Nullable String location) {
        this.location = location;
        return this;
    }
     ...
     * An object representing an address with various properties.
     */
    public ExistingExhibitorJson withAddress(@Nullable ExhibitorAddressJson address) {
        this.address = address;
        return this;
    }
     ...
     * Email address of the exhibitor
     */
    public ExistingExhibitorJson withEmail(@Nullable String email) {
        this.email = email;
        return this;
    }
     ...
     * Mobile Phone of the exhibitor
     */
    public ExistingExhibitorJson withMobilePhone(@Nullable String mobilePhone) {
        this.mobilePhone = mobilePhone;
        return this;
    }
     ...
     * Work Phone of the exhibitor
     */
    public ExistingExhibitorJson withWorkPhone(@Nullable String workPhone) {
        this.workPhone = workPhone;
        return this;
    }
     ...
     * Any other phone of the exhibitor
     */
    public ExistingExhibitorJson withOtherPhone(@Nullable String otherPhone) {
        this.otherPhone = otherPhone;
        return this;
    }
     ...
     * Exhibitor's website URL
     */
    public ExistingExhibitorJson withWebsite(@Nullable String website) {
        this.website = website;
        return this;
    }
     ...
     * A JSON schema representing contact links, including Twitter, Facebook, and LinkedIn URLs.
     */
    public ExistingExhibitorJson withContactLinks(@Nullable ContactLinksJson2 contactLinks) {
        this.contactLinks = contactLinks;
        return this;
    }
     ...
     * A boolean indicating whether the exhibitor is deleted or not
     */
    public ExistingExhibitorJson withDeleted(@Nullable Boolean deleted) {
     ...
     * True indicates that the exhibitor is hidden.
     */
    public ExistingExhibitorJson withHidden(@Nullable Boolean hidden) {
        this.hidden = hidden;
        return this;
    }
     ...
     * A boolean indicating whether the exhibitor is an event sponsor or not
     */
    public ExistingExhibitorJson withEventSponsor(@Nullable Boolean eventSponsor) {
     ...
     * A boolean indicating whether the exhibitor is designated as featured or not
     */
    public ExistingExhibitorJson withFeatured(@Nullable Boolean featured) {
     ...
     * Associated sponsorship level for an exhibitor
     */
    public ExistingExhibitorJson withSponsorshipLevel(@Nullable SponsorshipLevelJson sponsorshipLevel) {
        this.sponsorshipLevel = sponsorshipLevel;
        return this;
    }
     ...
     * ID of an exhibitor.
     */
    public ExistingExhibitorJson withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * File ID for exhibitor profile logo.
     */
    public ExistingExhibitorJson withProfileLogoId(@Nullable String profileLogoId) {
        this.profileLogoId = profileLogoId;
        return this;
    }
     ...
     * URL for exhibitor profile logo.
     */
    public ExistingExhibitorJson withProfileLogoUrl(@Nullable String profileLogoUrl) {
        this.profileLogoUrl = profileLogoUrl;
        return this;
    }
     ...
     * File ID for exhibitor banner.
     */
    public ExistingExhibitorJson withBannerId(@Nullable String bannerId) {
        this.bannerId = bannerId;
        return this;
    }
     ...
     * URL for exhibitor banner.
     */
    public ExistingExhibitorJson withBannerUrl(@Nullable String bannerUrl) {
        this.bannerUrl = bannerUrl;
        return this;
    }
