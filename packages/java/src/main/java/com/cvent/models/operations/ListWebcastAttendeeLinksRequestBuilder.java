...
public class ListWebcastAttendeeLinksRequestBuilder {
     ...
     */
    public ListWebcastAttendeeLinksResponse call() {
     ...
     * <pre><code>
     * for (ListWebcastAttendeeLinksResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListWebcastAttendeeLinksResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListWebcastAttendeeLinksResponse> callAsStream() {
