...
public class GetPaymentsRequestBuilder {
    ...
    public GetPaymentsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public CompletableFuture<GetPaymentsResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetPaymentsResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetPaymentsResponse&gt;() {
     ...
     */
    public Publisher<GetPaymentsResponse> callAsPublisher() {
        ...
        Flow.Publisher<GetPaymentsResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
