...
public class GetAccountBudgetItemsRequestBuilder {
    ...
    public GetAccountBudgetItemsRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public GetAccountBudgetItemsResponse call() {
     ...
     * <pre><code>
     * for (GetAccountBudgetItemsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAccountBudgetItemsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAccountBudgetItemsResponse> callAsStream() {
