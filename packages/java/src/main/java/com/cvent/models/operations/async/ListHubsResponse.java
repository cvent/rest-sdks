...
public class ListHubsResponse implements AsyncResponse {
    /**
    ...
    public ListHubsResponse(@Nonnull String contentType, int statusCode, @Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successfully retrieved a paginated list of Events+ hubs and their related details.
     */
    public Optional<HubsPaginatedResponse> hubsPaginatedResponse() {
        return Optional.ofNullable(this.hubsPaginatedResponse);
    }
     ...
     * HTTP response content type for this operation
     */
    public ListHubsResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public ListHubsResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ListHubsResponse withRawResponse(@Nonnull HttpResponse<Blob> rawResponse) {
     ...
     * Successfully retrieved a paginated list of Events+ hubs and their related details.
     */
    public ListHubsResponse withHubsPaginatedResponse(@Nullable HubsPaginatedResponse hubsPaginatedResponse) {
        this.hubsPaginatedResponse = hubsPaginatedResponse;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Successfully retrieved a paginated list of Events+ hubs and their related details.
         */
        public Builder hubsPaginatedResponse(@Nullable HubsPaginatedResponse hubsPaginatedResponse) {
            this.hubsPaginatedResponse = hubsPaginatedResponse;
            return this;
        }
