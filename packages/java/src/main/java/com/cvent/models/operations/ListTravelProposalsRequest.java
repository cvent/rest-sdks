...
public class ListTravelProposalsRequest {
     ...
     * beginning of time of the data store.
     */
    public ListTravelProposalsRequest withAfter(@Nullable OffsetDateTime after) {
        this.after = after;
        return this;
    }
     ...
     * Used to query records that have been added or updated before this time point.
     */
    public ListTravelProposalsRequest withBefore(@Nullable OffsetDateTime before) {
        this.before = before;
        return this;
    }
     ...
     * The maximum number of records to return per page.
     */
    public ListTravelProposalsRequest withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * This will override any other pageable parameters provided.
     */
    public ListTravelProposalsRequest withToken(@Nullable String token) {
        this.token = token;
        return this;
    }
     ...
     * * lastModified (eq|ne|lt|le|gt|ge)
     */
    public ListTravelProposalsRequest withFilter(@Nullable String filter) {
        this.filter = filter;
        return this;
    }
