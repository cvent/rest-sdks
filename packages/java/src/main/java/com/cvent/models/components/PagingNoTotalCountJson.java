 ...
 */
public class PagingNoTotalCountJson {
    /**
    ...
    public PagingNoTotalCountJson(@Nonnull PaginationLinksJson links) {
     ...
     * previous page of data.
     */
    public PagingNoTotalCountJson withPreviousToken(@Nullable String previousToken) {
        this.previousToken = previousToken;
        return this;
    }
     ...
     * page of data you can fetch.
     */
    public PagingNoTotalCountJson withNextToken(@Nullable String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
     ...
     * The pagination token for the current page.
     */
    public PagingNoTotalCountJson withCurrentToken(@Nullable String currentToken) {
        this.currentToken = currentToken;
        return this;
    }
     ...
     * The number of records to return on the page. Not to exceed 200.
     */
    public PagingNoTotalCountJson withLimit(@Nullable Long limit) {
        this.limit = limit;
        return this;
    }
     ...
     * Represents pagination links for navigating between pages of data.
     */
    public PagingNoTotalCountJson withLinks(@Nonnull PaginationLinksJson links) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PagingNoTotalCountJson other = (PagingNoTotalCountJson) o;
    ...
    public static final class Builder {
        ...
        public PagingNoTotalCountJson build() {
            return new PagingNoTotalCountJson(previousToken, nextToken, currentToken, limit, links);
        }
    }
}
