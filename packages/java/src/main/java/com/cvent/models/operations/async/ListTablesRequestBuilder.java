...
public class ListTablesRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListTablesRequest request;
    private final Options.Builder optionsBuilder;

    public ListTablesRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListTablesRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListTablesRequestBuilder request(@Nonnull ListTablesRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListTablesRequest _buildRequest() {
        return this.request;
    }

    public ListTablesRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListTablesResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListTablesResponse&gt; publisher = builder.callAsPublisher();
     ...
     */
    public Publisher<ListTablesResponse> callAsPublisher() {
        ListTablesRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListTablesRequest, ListTablesResponse> operation =
                new ListTables.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListTablesResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
