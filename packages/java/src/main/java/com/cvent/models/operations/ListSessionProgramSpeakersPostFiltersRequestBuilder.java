...
public class ListSessionProgramSpeakersPostFiltersRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListSessionProgramSpeakersPostFiltersRequest request;
    private final Options.Builder optionsBuilder;

    public ListSessionProgramSpeakersPostFiltersRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListSessionProgramSpeakersPostFiltersRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public ListSessionProgramSpeakersPostFiltersResponse call() {
     ...
     * <pre><code>
     * for (ListSessionProgramSpeakersPostFiltersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSessionProgramSpeakersPostFiltersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSessionProgramSpeakersPostFiltersResponse> callAsStream() {
