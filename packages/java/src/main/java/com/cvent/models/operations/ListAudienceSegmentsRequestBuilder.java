...
public class ListAudienceSegmentsRequestBuilder {
     ...
     */
    public ListAudienceSegmentsResponse call() {
     ...
     * <pre><code>
     * for (ListAudienceSegmentsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListAudienceSegmentsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListAudienceSegmentsResponse> callAsStream() {
