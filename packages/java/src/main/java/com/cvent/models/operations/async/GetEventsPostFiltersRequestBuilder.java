...
public class GetEventsPostFiltersRequestBuilder {
    ...
    public GetEventsPostFiltersRequestBuilder retryConfig(RetryConfig retryConfig) {
     ...
     */
    public CompletableFuture<GetEventsPostFiltersResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;GetEventsPostFiltersResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;GetEventsPostFiltersResponse&gt;() {
     ...
     */
    public Publisher<GetEventsPostFiltersResponse> callAsPublisher() {
        ...
        Flow.Publisher<GetEventsPostFiltersResponse> flowPublisher =
