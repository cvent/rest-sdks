...
public class UserGroup {
    ...
    @JsonCreator
    public UserGroup(@JsonProperty("id") @Nonnull String id, @JsonProperty("name") @Nonnull String name) {
     ...
     * The unique identifier of the user group
     */
    public UserGroup withId(@Nonnull String id) {
     ...
     * The name of the user group
     */
    public UserGroup withName(@Nonnull String name) {
    ...
    public String toString() {
        return Utils.toString(UserGroup.class, "id", id, "name", name);
    }
