...
public class ListSupplierAccountsRequestBuilder {
     ...
     */
    public ListSupplierAccountsResponse call() {
     ...
     * <pre><code>
     * for (ListSupplierAccountsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListSupplierAccountsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListSupplierAccountsResponse> callAsStream() {
