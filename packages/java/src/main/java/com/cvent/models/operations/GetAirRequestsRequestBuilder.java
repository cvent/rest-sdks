...
public class GetAirRequestsRequestBuilder {
     ...
     */
    public GetAirRequestsResponse call() {
     ...
     * <pre><code>
     * for (GetAirRequestsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAirRequestsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAirRequestsResponse> callAsStream() {
