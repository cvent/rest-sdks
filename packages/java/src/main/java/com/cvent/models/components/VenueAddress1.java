...
public class VenueAddress1 {
     ...
     * The first line of an address.
     */
    public VenueAddress1 withAddress1(@Nullable String address1) {
        this.address1 = address1;
        return this;
    }
     ...
     * The second line of an address.
     */
    public VenueAddress1 withAddress2(@Nullable String address2) {
        this.address2 = address2;
        return this;
    }
     ...
     * The third line of an address.
     */
    public VenueAddress1 withAddress3(@Nullable String address3) {
        this.address3 = address3;
        return this;
    }
     ...
     * The name of the city.
     */
    public VenueAddress1 withCity(@Nullable String city) {
        this.city = city;
        return this;
    }
     ...
     * ISO 3166 two-letter (alpha-2) country code.
     */
    public VenueAddress1 withCountryCode(@Nullable String countryCode) {
        this.countryCode = countryCode;
        return this;
    }
     ...
     * Postal code (also known as zipcode) of the address.
     */
    public VenueAddress1 withPostalCode(@Nullable String postalCode) {
        this.postalCode = postalCode;
        return this;
    }
     ...
     * The name of the state/province/region of the address.
     */
    public VenueAddress1 withRegion(@Nullable String region) {
        this.region = region;
        return this;
    }
     ...
     * The abbreviation of the state/province/region of the address.
     */
    public VenueAddress1 withRegionCode(@Nullable String regionCode) {
        this.regionCode = regionCode;
        return this;
    }
     ...
     * Name of the country for example, 'United States'
     */
    public VenueAddress1 withCountry(@Nullable String country) {
        this.country = country;
        return this;
    }
     ...
     * The geo latitude of the address.
     */
    public VenueAddress1 withLatitude(@Nullable Double latitude) {
        this.latitude = latitude;
        return this;
    }
     ...
     * The geo longitude of the address.
     */
    public VenueAddress1 withLongitude(@Nullable Double longitude) {
        this.longitude = longitude;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VenueAddress1 other = (VenueAddress1) o;
    ...
    public static final class Builder {
        ...
        public VenueAddress1 build() {
            return new VenueAddress1(
                    address1,
                    address2,
                    address3,
                    city,
