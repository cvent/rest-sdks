...
public class GetSeatRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private GetSeatRequest request;
    private final Options.Builder optionsBuilder;

    public GetSeatRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public GetSeatRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public GetSeatRequestBuilder request(@Nonnull GetSeatRequest request) {
     ...
     */
    public CompletableFuture<GetSeatResponse> call() {
