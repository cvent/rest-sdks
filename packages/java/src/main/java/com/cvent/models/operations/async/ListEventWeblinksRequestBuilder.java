...
public class ListEventWeblinksRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListEventWeblinksRequest request;
    private final Options.Builder optionsBuilder;

    public ListEventWeblinksRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListEventWeblinksRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListEventWeblinksRequestBuilder request(@Nonnull ListEventWeblinksRequest request) {
        this.request = Utils.checkNotNull(request, "request");
        return this;
    }

    private ListEventWeblinksRequest _buildRequest() {
        return this.request;
    }

    public ListEventWeblinksRequestBuilder header(String name, String value) {
     ...
     */
    public CompletableFuture<ListEventWeblinksResponse> call() {
     ...
     * <pre><code>
     * Publisher&lt;ListEventWeblinksResponse&gt; publisher = builder.callAsPublisher();
     * publisher.subscribe(new Subscriber&lt;ListEventWeblinksResponse&gt;() {
     ...
     */
    public Publisher<ListEventWeblinksResponse> callAsPublisher() {
        ListEventWeblinksRequest request = this.request;
        Options options = optionsBuilder.build();
        AsyncRequestOperation<ListEventWeblinksRequest, ListEventWeblinksResponse> operation =
                new ListEventWeblinks.Async(sdkConfiguration, options, sdkConfiguration.retryScheduler(), _headers);
        ...
        Flow.Publisher<ListEventWeblinksResponse> flowPublisher = mapAsync(asyncPaginator, operation::handleResponse);
