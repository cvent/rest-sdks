...
public class ListPlayersRequestBuilder {
    private final SDKConfiguration sdkConfiguration;
    private final Headers _headers = new Headers();
    private ListPlayersRequest request;
    private final Options.Builder optionsBuilder;

    public ListPlayersRequestBuilder(SDKConfiguration sdkConfiguration) {
        this.sdkConfiguration = sdkConfiguration;
        this.optionsBuilder = Options.builder();
    }

    public ListPlayersRequestBuilder retryConfig(RetryConfig retryConfig) {
        this.optionsBuilder.retryConfig(retryConfig);
        return this;
    }

    public ListPlayersRequestBuilder request(@Nonnull ListPlayersRequest request) {
     ...
     */
    public ListPlayersResponse call() {
     ...
     * <pre><code>
     * for (ListPlayersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListPlayersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListPlayersResponse> callAsStream() {
