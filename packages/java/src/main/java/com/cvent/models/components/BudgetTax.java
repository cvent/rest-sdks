...
public class BudgetTax {
    ...
    private BudgetTaxGratuityType taxType;
    ...
    public BudgetTax(
            ...
            @JsonProperty("taxType") @Nonnull BudgetTaxGratuityType taxType,
    ...
    public BudgetTax(@Nonnull String id, @Nonnull BudgetTaxGratuityType taxType, double tax) {
     ...
     * Denotes the type of tax or gratuity.
     */
    public BudgetTaxGratuityType taxType() {
        return this.taxType;
    }
     ...
     * A string that has to be a format matching the industry standard uuid
     */
    public BudgetTax withId(@Nonnull String id) {
     ...
     * Tax name.
     */
    public BudgetTax withName(@Nullable String name) {
        this.name = name;
        return this;
    }
     ...
     * Denotes the type of tax or gratuity.
     */
    public BudgetTax withTaxType(@Nonnull BudgetTaxGratuityType taxType) {
     ...
     * Tax applied to the budget item. This value can be a percentage of the cost or a flat dollar amount.
     */
    public BudgetTax withTax(double tax) {
        this.tax = tax;
        return this;
    }
     ...
     * Calculated tax amount based on tax field.
     */
    public BudgetTax withAppliedTaxValue(@Nullable Double appliedTaxValue) {
        this.appliedTaxValue = appliedTaxValue;
        return this;
    }
    ...
    public static final class Builder {
         ...
         * Denotes the type of tax or gratuity.
         */
        public Builder taxType(@Nonnull BudgetTaxGratuityType taxType) {
            this.taxType = Utils.checkNotNull(taxType, "taxType");
            return this;
        }
        ...
        public BudgetTax build() {
            return new BudgetTax(id, name, taxType, tax, appliedTaxValue);
        }
    }
}
