...
public class GetStandardSurveyResponsesRequestBuilder {
     ...
     */
    public GetStandardSurveyResponsesResponse call() {
     ...
     * <pre><code>
     * for (GetStandardSurveyResponsesResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetStandardSurveyResponsesResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetStandardSurveyResponsesResponse> callAsStream() {
