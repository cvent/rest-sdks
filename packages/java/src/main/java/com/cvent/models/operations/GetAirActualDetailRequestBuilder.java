...
public class GetAirActualDetailRequestBuilder {
     ...
     */
    public GetAirActualDetailResponse call() {
     ...
     * <pre><code>
     * for (GetAirActualDetailResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetAirActualDetailResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetAirActualDetailResponse> callAsStream() {
