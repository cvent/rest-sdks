...
public class GetEliteratureRequestsRequestBuilder {
     ...
     */
    public GetEliteratureRequestsResponse call() {
     ...
     * <pre><code>
     * for (GetEliteratureRequestsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<GetEliteratureRequestsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<GetEliteratureRequestsResponse> callAsStream() {
