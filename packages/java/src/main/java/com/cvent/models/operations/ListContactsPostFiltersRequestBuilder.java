...
public class ListContactsPostFiltersRequestBuilder {
     ...
     */
    public ListContactsPostFiltersResponse call() {
     ...
     * <pre><code>
     * for (ListContactsPostFiltersResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListContactsPostFiltersResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListContactsPostFiltersResponse> callAsStream() {
