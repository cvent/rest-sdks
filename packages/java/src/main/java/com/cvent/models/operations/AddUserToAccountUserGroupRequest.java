...
public class AddUserToAccountUserGroupRequest {
     ...
     * The User Group's Id.
     */
    public AddUserToAccountUserGroupRequest withUserGroupId(@Nonnull String userGroupId) {
     ...
     * The Account User's Id.
     */
    public AddUserToAccountUserGroupRequest withUserId(@Nonnull String userId) {
