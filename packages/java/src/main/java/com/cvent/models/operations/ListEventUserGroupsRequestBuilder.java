...
public class ListEventUserGroupsRequestBuilder {
     ...
     */
    public ListEventUserGroupsResponse call() {
     ...
     * <pre><code>
     * for (ListEventUserGroupsResponse page : builder.callAsIterable()) {
     *     // Process each page
     * }
     * </code></pre>
     *
     ...
     */
    public Iterable<ListEventUserGroupsResponse> callAsIterable() {
     ...
     * are returned.
     **/
    public Stream<ListEventUserGroupsResponse> callAsStream() {
