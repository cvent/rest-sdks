...
public class ErrorResponse2 {
    ...
    private List<ErrorResponseBase12> details;
    ...
    public ErrorResponse2(
            ...
            @JsonProperty("details") @Nullable List<ErrorResponseBase12> details) {
        this.id = id;
        this.code = code;
        this.message =
    ...
    public ErrorResponse2(long code, @Nonnull String message) {
     ...
     * Additional details of cascading error messages.
     */
    public Optional<List<ErrorResponseBase12>> details() {
     ...
     * The unique identifier for the error response.
     */
    public ErrorResponse2 withId(@Nullable String id) {
        this.id = id;
        return this;
    }
     ...
     * The HTTP status code representing the error.
     */
    public ErrorResponse2 withCode(long code) {
        this.code = code;
        return this;
    }
     ...
     * A brief description of the error.
     */
    public ErrorResponse2 withMessage(@Nonnull String message) {
     ...
     * The target resource of the error.
     */
    public ErrorResponse2 withTarget(@Nullable String target) {
        this.target = target;
        return this;
    }
     ...
     * Additional details of cascading error messages.
     */
    public ErrorResponse2 withDetails(@Nullable List<ErrorResponseBase12> details) {
        this.details = details;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ErrorResponse2 other = (ErrorResponse2) o;
    ...
    public String toString() {
        return Utils.toString(
                ErrorResponse2.class, "id", id, "code", code, "message", message, "target", target, "details", details);
    }
    ...
    public static final class Builder {
         ...
         * Additional details of cascading error messages.
         */
        public Builder details(@Nullable List<ErrorResponseBase12> details) {
            this.details = details;
            return this;
        }

        public ErrorResponse2 build() {
            return new ErrorResponse2(id, code, message, target, details);
        }
    }
}
