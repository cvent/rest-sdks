...
public class GetWebcastById {
    ...
    public static class Sync extends Base implements RequestOperation<GetWebcastByIdRequest, GetWebcastByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetWebcastByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebcastByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetWebcastByIdRequest request) {
        ...
        @Override
        public GetWebcastByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetWebcastByIdResponse.Builder resBuilder = GetWebcastByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetWebcastByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetWebcastByIdRequest, com.cvent.models.operations.async.GetWebcastByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetWebcastByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetWebcastByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetWebcastByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetWebcastByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetWebcastByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetWebcastByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetWebcastByIdResponse res = resBuilder.build();
