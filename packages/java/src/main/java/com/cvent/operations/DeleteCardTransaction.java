...
public class DeleteCardTransaction {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/transactions:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteCardTransactionRequest, DeleteCardTransactionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteCardTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCardTransactionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteCardTransactionRequest request) {
        ...
        @Override
        public DeleteCardTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteCardTransactionResponse.Builder resBuilder = DeleteCardTransactionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteCardTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteCardTransactionRequest, com.cvent.models.operations.async.DeleteCardTransactionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteCardTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCardTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteCardTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteCardTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteCardTransactionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteCardTransactionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteCardTransactionResponse res = resBuilder.build();
