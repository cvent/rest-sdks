...
public class GetStandardSurveyQuestions {
    ...
    public static class Sync extends Base
        ...
        public GetStandardSurveyQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetStandardSurveyQuestionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveyQuestionsPaginatedResponse(Utils.unmarshal(response, new TypeReference<StandardSurveyQuestionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStandardSurveyQuestionsRequest, com.cvent.models.operations.async.GetStandardSurveyQuestionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetStandardSurveyQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStandardSurveyQuestionsRequest.class);
