...
public class CreateBulkJob {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/bulk-jobs");
    ...
    public static class Sync extends Base implements RequestOperation<BulkJobWithDataInput, CreateBulkJobResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BulkJobWithDataInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BulkJobWithDataInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BulkJobWithDataInput request) {
        ...
        @Override
        public CreateBulkJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateBulkJobResponse.Builder resBuilder = CreateBulkJobResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateBulkJobResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBulkJobWithData(Utils.unmarshal(response, new TypeReference<BulkJobWithData>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    BulkJobWithDataInput, com.cvent.models.operations.async.CreateBulkJobResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(BulkJobWithDataInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<BulkJobWithDataInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BulkJobWithDataInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateBulkJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateBulkJobResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateBulkJobResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateBulkJobResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BulkJobWithData>() {})
                            .thenApply(res::withBulkJobWithData);
                } else {
