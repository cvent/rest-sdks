...
import com.cvent.models.components.ExistingVenueDetails;
...
public class UpdateVenueDetails {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "updateVenueDetails",
                    java.util.Optional.of(java.util.List.of("venue/venue-details:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/venues/{venueId}/details", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingVenueDetails", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateVenueDetailsRequest, UpdateVenueDetailsResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateVenueDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateVenueDetailsRequest.class, new TypeReference<UpdateVenueDetailsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateVenueDetailsRequest request) {
        ...
        @Override
        public UpdateVenueDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateVenueDetailsResponse.Builder resBuilder = UpdateVenueDetailsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateVenueDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingVenueDetails(
                            Utils.unmarshal(response, new TypeReference<ExistingVenueDetails>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateVenueDetailsRequest, com.cvent.models.operations.async.UpdateVenueDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateVenueDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateVenueDetailsRequest.class, new TypeReference<UpdateVenueDetailsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateVenueDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateVenueDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateVenueDetailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateVenueDetailsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateVenueDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingVenueDetails>() {})
                            .thenApply(res::withExistingVenueDetails);
                } else {
