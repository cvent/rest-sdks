...
public class CreateContacts {
    ...
    public static class Sync extends Base implements RequestOperation<CreateContactsRequest, CreateContactsResponse> {
        ...
        private HttpRequest onBuildRequest(CreateContactsRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreateContactsRequest.class, new TypeReference<CreateContactsRequest>() {});
        ...
        public CreateContactsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateContactsResponse.Builder resBuilder = CreateContactsResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateContactsRequest, com.cvent.models.operations.async.CreateContactsResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateContactsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateContactsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateContactsResponse res = resBuilder.build();
