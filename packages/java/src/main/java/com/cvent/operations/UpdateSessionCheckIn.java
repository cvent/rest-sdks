...
public class UpdateSessionCheckIn {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSessionCheckInRequest, UpdateSessionCheckInResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateSessionCheckInRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateSessionCheckInRequest.class, new TypeReference<UpdateSessionCheckInRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSessionCheckInRequest request) {
        ...
        @Override
        public UpdateSessionCheckInResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateSessionCheckInResponse.Builder resBuilder = UpdateSessionCheckInResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateSessionCheckInResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "207")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAddBulkResponse1(
                            Utils.unmarshal(response, new TypeReference<List<AttendeeInvitesBulkResponseItem12>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateSessionCheckInRequest, com.cvent.models.operations.async.UpdateSessionCheckInResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSessionCheckInRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateSessionCheckInRequest.class, new TypeReference<UpdateSessionCheckInRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSessionCheckInRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateSessionCheckInResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateSessionCheckInResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateSessionCheckInResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateSessionCheckInResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "207")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<AttendeeInvitesBulkResponseItem12>>() {})
                            .thenApply(res::withAttendeeAddBulkResponse1);
                } else {
