...
public class CreateAttendee {
    ...
    public static class Sync extends Base
            implements RequestOperation<List<AttendeeAddJson>, CreateAttendeeResponse> {
        ...
        @Override
        public CreateAttendeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAttendeeResponse.Builder resBuilder =
            ...
            CreateAttendeeResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "207")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAddBulkResponse(Utils.unmarshal(response, new TypeReference<List<AttendeeAddBulkItem>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<List<AttendeeAddJson>, com.cvent.models.operations.async.CreateAttendeeResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateAttendeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateAttendeeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateAttendeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateAttendeeResponse res = resBuilder.build();
