...
public class CreateEventAsync {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/events/async");
    ...
    public static class Sync extends Base implements RequestOperation<EventInput, CreateEventAsyncResponse> {
        ...
        @Override
        public CreateEventAsyncResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateEventAsyncResponse.Builder resBuilder = CreateEventAsyncResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateEventAsyncResponse res = resBuilder.build();
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateEventAsyncResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateEventAsyncResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateEventAsyncResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateEventAsyncResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventAsyncResponse>() {})
                            .thenApply(res::withEventAsyncResponse);
                } else {
