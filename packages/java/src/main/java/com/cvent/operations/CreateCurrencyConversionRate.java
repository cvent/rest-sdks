...
public class CreateCurrencyConversionRate {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/currencies/{currency}/conversion-rates", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "currencyConversionRate", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCurrencyConversionRateRequest, CreateCurrencyConversionRateResponse> {
        ...
        private HttpRequest onBuildRequest(CreateCurrencyConversionRateRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateCurrencyConversionRateRequest.class,
                    new TypeReference<CreateCurrencyConversionRateRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCurrencyConversionRateRequest request) {
        ...
        @Override
        public CreateCurrencyConversionRateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateCurrencyConversionRateResponse.Builder resBuilder = CreateCurrencyConversionRateResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateCurrencyConversionRateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.CreateCurrencyConversionRateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateCurrencyConversionRateRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateCurrencyConversionRateRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCurrencyConversionRateRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateCurrencyConversionRateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateCurrencyConversionRateResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateCurrencyConversionRateResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateCurrencyConversionRateResponse res = resBuilder.build();
