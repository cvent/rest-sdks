...
public class CreateEventDiscount {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/discounts", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateEventDiscountRequest, CreateEventDiscountResponse> {
        ...
        private HttpRequest onBuildRequest(CreateEventDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateEventDiscountRequest.class, new TypeReference<CreateEventDiscountRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateEventDiscountRequest request) {
        ...
        @Override
        public CreateEventDiscountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateEventDiscountResponse.Builder resBuilder = CreateEventDiscountResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateEventDiscountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateEventDiscountRequest, com.cvent.models.operations.async.CreateEventDiscountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateEventDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateEventDiscountRequest.class, new TypeReference<CreateEventDiscountRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateEventDiscountRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateEventDiscountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateEventDiscountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateEventDiscountResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateEventDiscountResponse res = resBuilder.build();
