...
public class DeleteSpeakerDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSpeakerDocumentRequest, DeleteSpeakerDocumentResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteSpeakerDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSpeakerDocumentRequest request) {
        ...
        @Override
        public DeleteSpeakerDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSpeakerDocumentResponse.Builder resBuilder = DeleteSpeakerDocumentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSpeakerDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteSpeakerDocumentRequest, com.cvent.models.operations.async.DeleteSpeakerDocumentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSpeakerDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSpeakerDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSpeakerDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSpeakerDocumentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSpeakerDocumentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSpeakerDocumentResponse res = resBuilder.build();
