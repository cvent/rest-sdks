...
public class GetEventEmailStatus {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getEventEmailStatus",
                    java.util.Optional.of(java.util.List.of("event/event-email-status:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/emails/{emailRequestId}/status", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventEmailStatusRequest, GetEventEmailStatusResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetEventEmailStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventEmailStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventEmailStatusRequest request) {
        ...
        @Override
        public GetEventEmailStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventEmailStatusResponse.Builder resBuilder = GetEventEmailStatusResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventEmailStatusResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventEmailStatusRequest, com.cvent.models.operations.async.GetEventEmailStatusResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetEventEmailStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventEmailStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventEmailStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventEmailStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventEmailStatusResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventEmailStatusResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventEmailStatusResponse res = resBuilder.build();
