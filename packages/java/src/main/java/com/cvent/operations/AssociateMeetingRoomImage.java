...
public class AssociateMeetingRoomImage {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("venue/meeting-room-images:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/venues/{venueId}/meeting-rooms/{meetingRoomId}/images", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "meetingRoomImageAssociationRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<AssociateMeetingRoomImageRequest, AssociateMeetingRoomImageResponse> {
        ...
        private HttpRequest onBuildRequest(AssociateMeetingRoomImageRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssociateMeetingRoomImageRequest.class,
                    new TypeReference<AssociateMeetingRoomImageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssociateMeetingRoomImageRequest request) {
        ...
        @Override
        public AssociateMeetingRoomImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AssociateMeetingRoomImageResponse.Builder resBuilder = AssociateMeetingRoomImageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AssociateMeetingRoomImageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRoomImageAssociationResponse(
                            Utils.unmarshal(response, new TypeReference<MeetingRoomImageAssociationResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.AssociateMeetingRoomImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AssociateMeetingRoomImageRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssociateMeetingRoomImageRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AssociateMeetingRoomImageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AssociateMeetingRoomImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AssociateMeetingRoomImageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssociateMeetingRoomImageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AssociateMeetingRoomImageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRoomImageAssociationResponse>() {})
                            .thenApply(res::withMeetingRoomImageAssociationResponse);
                } else {
