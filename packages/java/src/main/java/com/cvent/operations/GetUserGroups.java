...
public class GetUserGroups {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/scim/v2/Groups");
    ...
    public static class Sync extends Base implements RequestOperation<GetUserGroupsRequest, GetUserGroupsResponse> {
        ...
        private HttpRequest onBuildRequest(GetUserGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUserGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserGroupsRequest request) {
        ...
        @Override
        public GetUserGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetUserGroupsResponse.Builder resBuilder = GetUserGroupsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetUserGroupsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetUserGroupsRequest, com.cvent.models.operations.async.GetUserGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetUserGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUserGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUserGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetUserGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetUserGroupsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetUserGroupsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetUserGroupsResponse res = resBuilder.build();
