...
import com.cvent.models.components.VouchersPaginatedResponse;
...
public class ListEventVouchersPostFilter {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/vouchers:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/vouchers/filter", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventVouchersPostFilterRequest, ListEventVouchersPostFilterResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventVouchersPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListEventVouchersPostFilterRequest.class,
                    new TypeReference<ListEventVouchersPostFilterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventVouchersPostFilterRequest request) {
        ...
        @Override
        public ListEventVouchersPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventVouchersPostFilterResponse.Builder resBuilder = ListEventVouchersPostFilterResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventVouchersPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVouchersPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<VouchersPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListEventVouchersPostFilterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventVouchersPostFilterRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListEventVouchersPostFilterRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventVouchersPostFilterRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventVouchersPostFilterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventVouchersPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventVouchersPostFilterResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventVouchersPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VouchersPaginatedResponse>() {})
                            .thenApply(res::withVouchersPaginatedResponse);
                } else {
