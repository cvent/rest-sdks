...
public class GetHousingEventInfo {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/housing-events/{housingEventId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingEventInfoRequest, GetHousingEventInfoResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingEventInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventInfoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingEventInfoRequest request) {
        ...
        @Override
        public GetHousingEventInfoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingEventInfoResponse.Builder resBuilder = GetHousingEventInfoResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingEventInfoResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEvent(Utils.unmarshal(response, new TypeReference<HousingEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetHousingEventInfoRequest, com.cvent.models.operations.async.GetHousingEventInfoResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventInfoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventInfoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingEventInfoRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingEventInfoResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventInfoResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingEventInfoResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HousingEvent>() {})
                            .thenApply(res::withHousingEvent);
                } else {
