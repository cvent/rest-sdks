...
public class PatchVenueFacility {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "venueFacilityPatch", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchVenueFacilityRequest, PatchVenueFacilityResponse> {
        ...
        private HttpRequest onBuildRequest(PatchVenueFacilityRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchVenueFacilityRequest.class, new TypeReference<PatchVenueFacilityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchVenueFacilityRequest request) {
        ...
        @Override
        public PatchVenueFacilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PatchVenueFacilityResponse.Builder resBuilder = PatchVenueFacilityResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PatchVenueFacilityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVenueFacilityPatch(
                            Utils.unmarshal(response, new TypeReference<VenueFacilityPatch>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PatchVenueFacilityRequest, com.cvent.models.operations.async.PatchVenueFacilityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PatchVenueFacilityRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchVenueFacilityRequest.class, new TypeReference<PatchVenueFacilityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchVenueFacilityRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PatchVenueFacilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PatchVenueFacilityResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PatchVenueFacilityResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PatchVenueFacilityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VenueFacilityPatch>() {})
                            .thenApply(res::withVenueFacilityPatch);
                } else {
