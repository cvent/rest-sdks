...
public class DisassociateExhibitorFile {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-contents:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DisassociateExhibitorFileRequest, DisassociateExhibitorFileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DisassociateExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisassociateExhibitorFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisassociateExhibitorFileRequest request) {
        ...
        @Override
        public DisassociateExhibitorFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisassociateExhibitorFileResponse.Builder resBuilder =
            ...
            DisassociateExhibitorFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DisassociateExhibitorFileRequest, com.cvent.models.operations.async.DisassociateExhibitorFileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DisassociateExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisassociateExhibitorFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DisassociateExhibitorFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DisassociateExhibitorFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.DisassociateExhibitorFileResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DisassociateExhibitorFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DisassociateExhibitorFileResponse res = resBuilder.build();
