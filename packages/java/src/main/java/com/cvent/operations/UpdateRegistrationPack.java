...
public class UpdateRegistrationPack {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateRegistrationPackRequest, UpdateRegistrationPackResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRegistrationPackRequest.class, new TypeReference<UpdateRegistrationPackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateRegistrationPackRequest request) {
        ...
        @Override
        public UpdateRegistrationPackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateRegistrationPackResponse.Builder resBuilder =
            ...
            UpdateRegistrationPackResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateRegistrationPackRequest, com.cvent.models.operations.async.UpdateRegistrationPackResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateRegistrationPackRequest.class, new TypeReference<UpdateRegistrationPackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateRegistrationPackRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateRegistrationPackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateRegistrationPackResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateRegistrationPackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateRegistrationPackResponse res = resBuilder.build();
