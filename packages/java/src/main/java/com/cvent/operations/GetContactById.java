...
public class GetContactById {
    ...
    public static class Sync extends Base implements RequestOperation<GetContactByIdRequest, GetContactByIdResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetContactByIdRequest request) {
        ...
        @Override
        public GetContactByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetContactByIdResponse.Builder resBuilder = GetContactByIdResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetContactByIdRequest, com.cvent.models.operations.async.GetContactByIdResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetContactByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetContactByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetContactByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetContactByIdResponse res = resBuilder.build();
