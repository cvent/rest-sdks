...
public class DeleteContactGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteContactGroupRequest, DeleteContactGroupResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteContactGroupRequest request) {
        ...
        @Override
        public DeleteContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteContactGroupResponse.Builder resBuilder = DeleteContactGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteContactGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteContactGroupRequest, com.cvent.models.operations.async.DeleteContactGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteContactGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteContactGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteContactGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteContactGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteContactGroupResponse res = resBuilder.build();
