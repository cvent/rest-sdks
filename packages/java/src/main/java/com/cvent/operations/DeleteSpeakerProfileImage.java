...
public class DeleteSpeakerProfileImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSpeakerProfileImageRequest, DeleteSpeakerProfileImageResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteSpeakerProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerProfileImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSpeakerProfileImageRequest request) {
        ...
        @Override
        public DeleteSpeakerProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSpeakerProfileImageResponse.Builder resBuilder = DeleteSpeakerProfileImageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSpeakerProfileImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.DeleteSpeakerProfileImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSpeakerProfileImageRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerProfileImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSpeakerProfileImageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSpeakerProfileImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSpeakerProfileImageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSpeakerProfileImageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSpeakerProfileImageResponse res = resBuilder.build();
