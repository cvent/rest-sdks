...
public class DeleteSpeakerProfileImage {
    ...
    public static class Sync extends Base
        ...
        public DeleteSpeakerProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            DeleteSpeakerProfileImageResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSpeakerProfileImageRequest, com.cvent.models.operations.async.DeleteSpeakerProfileImageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSpeakerProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerProfileImageRequest.class);
