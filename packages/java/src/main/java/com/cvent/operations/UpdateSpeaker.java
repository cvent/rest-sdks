...
public class UpdateSpeaker {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/speakers/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingSpeaker", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<UpdateSpeakerRequest, UpdateSpeakerResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateSpeakerRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateSpeakerRequest.class, new TypeReference<UpdateSpeakerRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSpeakerRequest request) {
        ...
        @Override
        public UpdateSpeakerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateSpeakerResponse.Builder resBuilder = UpdateSpeakerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateSpeakerResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSpeaker(Utils.unmarshal(response, new TypeReference<ExistingSpeaker>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateSpeakerRequest, com.cvent.models.operations.async.UpdateSpeakerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSpeakerRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateSpeakerRequest.class, new TypeReference<UpdateSpeakerRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSpeakerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateSpeakerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateSpeakerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateSpeakerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateSpeakerResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingSpeaker>() {})
                            .thenApply(res::withExistingSpeaker);
                } else {
