...
public class UpdateCardTransaction {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/transactions:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/cards/transactions/{transactionId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "cardTransactionUpdate", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCardTransactionRequest, UpdateCardTransactionResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateCardTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateCardTransactionRequest.class, new TypeReference<UpdateCardTransactionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCardTransactionRequest request) {
        ...
        @Override
        public UpdateCardTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateCardTransactionResponse.Builder resBuilder = UpdateCardTransactionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateCardTransactionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardTransactionCreateResponse(
                            Utils.unmarshal(response, new TypeReference<CardTransactionCreateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateCardTransactionRequest, com.cvent.models.operations.async.UpdateCardTransactionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCardTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateCardTransactionRequest.class, new TypeReference<UpdateCardTransactionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCardTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateCardTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateCardTransactionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateCardTransactionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateCardTransactionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CardTransactionCreateResponse>() {})
                            .thenApply(res::withCardTransactionCreateResponse);
                } else {
