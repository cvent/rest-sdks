...
public class ListQuantityItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/quantity-items", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListQuantityItemsRequest, ListQuantityItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListQuantityItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListQuantityItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListQuantityItemsRequest request) {
        ...
        @Override
        public ListQuantityItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListQuantityItemsResponse.Builder resBuilder = ListQuantityItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListQuantityItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListQuantityItemsRequest, com.cvent.models.operations.async.ListQuantityItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListQuantityItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListQuantityItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListQuantityItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListQuantityItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListQuantityItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListQuantityItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListQuantityItemsResponse res = resBuilder.build();
