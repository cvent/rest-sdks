...
public class ListDonationItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/donation-items", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDonationItemsRequest, ListDonationItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListDonationItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDonationItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDonationItemsRequest request) {
        ...
        @Override
        public ListDonationItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListDonationItemsResponse.Builder resBuilder = ListDonationItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListDonationItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListDonationItemsRequest, com.cvent.models.operations.async.ListDonationItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDonationItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDonationItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDonationItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListDonationItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListDonationItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListDonationItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListDonationItemsResponse res = resBuilder.build();
