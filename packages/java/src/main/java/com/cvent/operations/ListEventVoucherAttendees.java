...
public class ListEventVoucherAttendees {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/vouchers/{voucherId}/attendees", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventVoucherAttendeesRequest, ListEventVoucherAttendeesResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventVoucherAttendeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventVoucherAttendeesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventVoucherAttendeesRequest request) {
        ...
        @Override
        public ListEventVoucherAttendeesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventVoucherAttendeesResponse.Builder resBuilder = ListEventVoucherAttendeesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventVoucherAttendeesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AttendeesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListEventVoucherAttendeesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventVoucherAttendeesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListEventVoucherAttendeesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventVoucherAttendeesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventVoucherAttendeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventVoucherAttendeesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventVoucherAttendeesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventVoucherAttendeesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeesPaginatedResponse>() {})
                            .thenApply(res::withAttendeesPaginatedResponse);
                } else {
