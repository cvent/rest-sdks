...
public class DeleteRegistrationPack {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/registration-packs:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteRegistrationPackRequest, DeleteRegistrationPackResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRegistrationPackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteRegistrationPackRequest request) {
        ...
        @Override
        public DeleteRegistrationPackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteRegistrationPackResponse.Builder resBuilder =
            ...
            DeleteRegistrationPackResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteRegistrationPackRequest, com.cvent.models.operations.async.DeleteRegistrationPackResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteRegistrationPackRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteRegistrationPackRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteRegistrationPackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteRegistrationPackResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteRegistrationPackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteRegistrationPackResponse res = resBuilder.build();
