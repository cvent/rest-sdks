...
public class GetResourceType {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/scim/v2/ResourceTypes/{id}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetResourceTypeRequest, GetResourceTypeResponse> {
        ...
        private HttpRequest onBuildRequest(GetResourceTypeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetResourceTypeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetResourceTypeRequest request) {
        ...
        @Override
        public GetResourceTypeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetResourceTypeResponse.Builder resBuilder = GetResourceTypeResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetResourceTypeResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResourceType(Utils.unmarshal(response, new TypeReference<ResourceType>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "403", "404", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    throw ErrorResponse14.from(response);
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetResourceTypeRequest, com.cvent.models.operations.async.GetResourceTypeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetResourceTypeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetResourceTypeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetResourceTypeRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetResourceTypeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetResourceTypeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetResourceTypeResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetResourceTypeResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ResourceType>() {})
                            .thenApply(res::withResourceType);
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "403", "404", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return ErrorResponse14.fromAsync(response).thenCompose(CompletableFuture::failedFuture);
                } else {
                    return Utils.createAsyncApiError(response, "Unexpected content-type received: " + contentType);
                }
            }
