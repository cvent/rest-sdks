...
public class GetEmailsHistory {
    ...
    public static class Sync extends Base
        ...
        public GetEmailsHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEmailsHistoryResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailHistoryPaginatedResponse(Utils.unmarshal(response, new TypeReference<EmailHistoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEmailsHistoryRequest, com.cvent.models.operations.async.GetEmailsHistoryResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEmailsHistoryResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEmailsHistoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEmailsHistoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
