...
public class GetExhibitorFile {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExhibitorFileRequest, GetExhibitorFileResponse> {
        ...
        private HttpRequest onBuildRequest(GetExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExhibitorFileRequest request) {
        ...
        @Override
        public GetExhibitorFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetExhibitorFileResponse.Builder resBuilder = GetExhibitorFileResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetExhibitorFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetExhibitorFileRequest, com.cvent.models.operations.async.GetExhibitorFileResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExhibitorFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetExhibitorFileResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorFileResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetExhibitorFileResponse res = resBuilder.build();
