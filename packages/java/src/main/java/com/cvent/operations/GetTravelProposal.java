...
import com.cvent.models.components.TravelProposal;
...
public class GetTravelProposal {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/travel-proposals/{travelProposalId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTravelProposalRequest, GetTravelProposalResponse> {
        ...
        private HttpRequest onBuildRequest(GetTravelProposalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelProposalRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTravelProposalRequest request) {
        ...
        @Override
        public GetTravelProposalResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTravelProposalResponse.Builder resBuilder = GetTravelProposalResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTravelProposalResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProposal(Utils.unmarshal(response, new TypeReference<TravelProposal>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetTravelProposalRequest, com.cvent.models.operations.async.GetTravelProposalResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTravelProposalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelProposalRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTravelProposalRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTravelProposalResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTravelProposalResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTravelProposalResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTravelProposalResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelProposal>() {})
                            .thenApply(res::withTravelProposal);
                } else {
