...
public class ListSessionsAttendance {
    ...
    public static class Sync extends Base
        ...
        public ListSessionsAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSessionsAttendanceResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionsCheckinPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionsCheckinPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSessionsAttendanceRequest, com.cvent.models.operations.async.ListSessionsAttendanceResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSessionsAttendanceResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSessionsAttendanceResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionsAttendanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
