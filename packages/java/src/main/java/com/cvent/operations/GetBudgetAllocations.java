...
public class GetBudgetAllocations {
    ...
    public static class Sync extends Base
        ...
        public GetBudgetAllocationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetBudgetAllocationsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetAllocationsPaginatedListResponse(Utils.unmarshal(response, new TypeReference<BudgetAllocationsPaginatedListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBudgetAllocationsRequest, com.cvent.models.operations.async.GetBudgetAllocationsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetBudgetAllocationsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetBudgetAllocationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBudgetAllocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
