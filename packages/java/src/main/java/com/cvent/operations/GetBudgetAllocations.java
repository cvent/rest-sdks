...
public class GetBudgetAllocations {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/budget-items:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/budget-items/allocations", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBudgetAllocationsRequest, GetBudgetAllocationsResponse> {
        ...
        private HttpRequest onBuildRequest(GetBudgetAllocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBudgetAllocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBudgetAllocationsRequest request) {
        ...
        @Override
        public GetBudgetAllocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBudgetAllocationsResponse.Builder resBuilder = GetBudgetAllocationsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBudgetAllocationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetAllocationsPaginatedListResponse(
                            Utils.unmarshal(response, new TypeReference<BudgetAllocationsPaginatedListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBudgetAllocationsRequest, com.cvent.models.operations.async.GetBudgetAllocationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBudgetAllocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBudgetAllocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBudgetAllocationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBudgetAllocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBudgetAllocationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBudgetAllocationsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBudgetAllocationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BudgetAllocationsPaginatedListResponse>() {})
                            .thenApply(res::withBudgetAllocationsPaginatedListResponse);
                } else {
