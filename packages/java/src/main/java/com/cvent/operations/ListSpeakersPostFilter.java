...
public class ListSpeakersPostFilter {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListSpeakersPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakersPostFilterRequest.class, new TypeReference<ListSpeakersPostFilterRequest>() {});
        ...
        public ListSpeakersPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSpeakersPostFilterResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerPaginatedResponse(Utils.unmarshal(response, new TypeReference<SpeakerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSpeakersPostFilterRequest, com.cvent.models.operations.async.ListSpeakersPostFilterResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakersPostFilterResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSpeakersPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakersPostFilterResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
