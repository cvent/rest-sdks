...
public class ListSpeakersPostFilter {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/speakers:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/speakers/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSpeakersPostFilterRequest, ListSpeakersPostFilterResponse> {
        ...
        private HttpRequest onBuildRequest(ListSpeakersPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListSpeakersPostFilterRequest.class,
                    new TypeReference<ListSpeakersPostFilterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSpeakersPostFilterRequest request) {
        ...
        @Override
        public ListSpeakersPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSpeakersPostFilterResponse.Builder resBuilder = ListSpeakersPostFilterResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSpeakersPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SpeakerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSpeakersPostFilterRequest, com.cvent.models.operations.async.ListSpeakersPostFilterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSpeakersPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListSpeakersPostFilterRequest.class,
                    new TypeReference<ListSpeakersPostFilterRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSpeakersPostFilterRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakersPostFilterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSpeakersPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakersPostFilterResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSpeakersPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SpeakerPaginatedResponse>() {})
                            .thenApply(res::withSpeakerPaginatedResponse);
                } else {
