...
public class ListSessionProgramSpeakersPostFilters {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/program-items/speakers/filter");
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListSessionProgramSpeakersPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<ListSessionProgramSpeakersPostFiltersRequest>() {});
        ...
        public ListSessionProgramSpeakersPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSessionProgramSpeakersPostFiltersResponse.Builder resBuilder =
                    ListSessionProgramSpeakersPostFiltersResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemSpeakerPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ProgramItemSpeakerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionProgramSpeakersPostFiltersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListSessionProgramSpeakersPostFiltersRequest.class,
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse>
            ...
            com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
