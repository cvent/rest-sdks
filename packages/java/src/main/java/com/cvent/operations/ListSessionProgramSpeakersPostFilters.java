...
public class ListSessionProgramSpeakersPostFilters {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSessionProgramSpeakersPostFiltersRequest, ListSessionProgramSpeakersPostFiltersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSessionProgramSpeakersPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionProgramSpeakersPostFiltersRequest.class, new TypeReference<ListSessionProgramSpeakersPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSessionProgramSpeakersPostFiltersRequest request) {
        ...
        @Override
        public ListSessionProgramSpeakersPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSessionProgramSpeakersPostFiltersResponse.Builder resBuilder =
            ...
            ListSessionProgramSpeakersPostFiltersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemSpeakerPaginatedResponse(Utils.unmarshal(response, new TypeReference<ProgramItemSpeakerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSessionProgramSpeakersPostFiltersRequest, com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionProgramSpeakersPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionProgramSpeakersPostFiltersRequest.class, new TypeReference<ListSessionProgramSpeakersPostFiltersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSessionProgramSpeakersPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSessionProgramSpeakersPostFiltersResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProgramItemSpeakerPaginatedResponse>() {})
                            .thenApply(res::withProgramItemSpeakerPaginatedResponse);
                } else {
