...
public class DeleteContactHook {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "deleteContactHook",
                    java.util.Optional.of(java.util.List.of("account/hooks:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteContactHookRequest, DeleteContactHookResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteContactHookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactHookRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteContactHookRequest request) {
        ...
        @Override
        public DeleteContactHookResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteContactHookResponse.Builder resBuilder = DeleteContactHookResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteContactHookResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteContactHookRequest, com.cvent.models.operations.async.DeleteContactHookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactHookRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactHookRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteContactHookRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteContactHookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteContactHookResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteContactHookResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteContactHookResponse res = resBuilder.build();
