...
public class GetTable {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/seatings/{seatingId}/tables/{tableId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetTableRequest, GetTableResponse> {
        ...
        public GetTableResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTableResponse.Builder resBuilder = GetTableResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingTableWithSeats(
                            Utils.unmarshal(response, new TypeReference<ExistingTableWithSeats>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetTableResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetTableResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTableResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
