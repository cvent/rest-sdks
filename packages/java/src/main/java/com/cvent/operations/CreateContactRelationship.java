...
public class CreateContactRelationship {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateContactRelationshipRequest, CreateContactRelationshipResponse> {
        ...
        private HttpRequest onBuildRequest(CreateContactRelationshipRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateContactRelationshipRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateContactRelationshipRequest request) {
        ...
        @Override
        public CreateContactRelationshipResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateContactRelationshipResponse.Builder resBuilder = CreateContactRelationshipResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateContactRelationshipResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.CreateContactRelationshipResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateContactRelationshipRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, CreateContactRelationshipRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateContactRelationshipRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateContactRelationshipResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateContactRelationshipResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateContactRelationshipResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateContactRelationshipResponse res = resBuilder.build();
