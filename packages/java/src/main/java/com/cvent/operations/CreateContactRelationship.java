...
public class CreateContactRelationship {
    ...
    public static class Sync extends Base
        ...
        public CreateContactRelationshipResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateContactRelationshipResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateContactRelationshipRequest, com.cvent.models.operations.async.CreateContactRelationshipResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateContactRelationshipRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateContactRelationshipRequest.class);
