...
public class DisassociateEventUserGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisassociateEventUserGroupRequest, DisassociateEventUserGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DisassociateEventUserGroupRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisassociateEventUserGroupRequest request) {
