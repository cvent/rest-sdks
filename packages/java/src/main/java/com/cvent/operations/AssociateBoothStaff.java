...
public class AssociateBoothStaff {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "associateBoothStaff",
                    java.util.Optional.of(java.util.List.of("exhibitor/booth-staff:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/booth-staff", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "boothStaffRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<AssociateBoothStaffRequest, AssociateBoothStaffResponse> {
        ...
        private HttpRequest onBuildRequest(AssociateBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, AssociateBoothStaffRequest.class, new TypeReference<AssociateBoothStaffRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssociateBoothStaffRequest request) {
        ...
        @Override
        public AssociateBoothStaffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AssociateBoothStaffResponse.Builder resBuilder = AssociateBoothStaffResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AssociateBoothStaffResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBoothStaffResponse(
                            Utils.unmarshal(response, new TypeReference<BoothStaffResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    AssociateBoothStaffRequest, com.cvent.models.operations.async.AssociateBoothStaffResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AssociateBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, AssociateBoothStaffRequest.class, new TypeReference<AssociateBoothStaffRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AssociateBoothStaffRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AssociateBoothStaffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AssociateBoothStaffResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssociateBoothStaffResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AssociateBoothStaffResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BoothStaffResponse>() {})
                            .thenApply(res::withBoothStaffResponse);
                } else {
