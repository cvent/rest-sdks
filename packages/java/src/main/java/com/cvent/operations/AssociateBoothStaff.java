...
public class AssociateBoothStaff {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AssociateBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssociateBoothStaffRequest.class, new TypeReference<AssociateBoothStaffRequest>() {});
        ...
        public AssociateBoothStaffResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AssociateBoothStaffResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBoothStaffResponse(Utils.unmarshal(response, new TypeReference<BoothStaffResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AssociateBoothStaffRequest, com.cvent.models.operations.async.AssociateBoothStaffResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.AssociateBoothStaffResponse> handleResponse(
            ...
            com.cvent.models.operations.async.AssociateBoothStaffResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssociateBoothStaffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
