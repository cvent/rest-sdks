...
public class GetSchema {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/scim/v2/Schemas/{id}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetSchemaRequest, GetSchemaResponse> {
        ...
        private HttpRequest onBuildRequest(GetSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSchemaRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSchemaRequest request) {
        ...
        @Override
        public GetSchemaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSchemaResponse.Builder resBuilder = GetSchemaResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSchemaResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsersSchema(Utils.unmarshal(response, new TypeReference<UsersSchema>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSchemaRequest, com.cvent.models.operations.async.GetSchemaResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSchemaRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSchemaRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSchemaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSchemaResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSchemaResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSchemaResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UsersSchema>() {})
                            .thenApply(res::withUsersSchema);
                } else {
