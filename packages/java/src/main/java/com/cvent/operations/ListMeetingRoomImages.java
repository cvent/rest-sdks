...
public class ListMeetingRoomImages {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("venue/meeting-room-images:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMeetingRoomImagesRequest, ListMeetingRoomImagesResponse> {
        ...
        private HttpRequest onBuildRequest(ListMeetingRoomImagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRoomImagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMeetingRoomImagesRequest request) {
        ...
        @Override
        public ListMeetingRoomImagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListMeetingRoomImagesResponse.Builder resBuilder = ListMeetingRoomImagesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListMeetingRoomImagesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRoomImagesResponse(
                            Utils.unmarshal(response, new TypeReference<MeetingRoomImagesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListMeetingRoomImagesRequest, com.cvent.models.operations.async.ListMeetingRoomImagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMeetingRoomImagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRoomImagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMeetingRoomImagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingRoomImagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMeetingRoomImagesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingRoomImagesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMeetingRoomImagesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRoomImagesResponse>() {})
                            .thenApply(res::withMeetingRoomImagesResponse);
                } else {
