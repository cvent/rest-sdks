...
public class GetSponsorshipLevels {
    ...
    public static class Sync extends Base
        ...
        public GetSponsorshipLevelsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSponsorshipLevelsResponse.Builder resBuilder =
                    GetSponsorshipLevelsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSponsorshipLevelListResponse(Utils.unmarshal(response, new TypeReference<SponsorshipLevelListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSponsorshipLevelsRequest, com.cvent.models.operations.async.GetSponsorshipLevelsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSponsorshipLevelsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSponsorshipLevelsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSponsorshipLevelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
