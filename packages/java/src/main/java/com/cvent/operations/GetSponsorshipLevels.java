...
public class GetSponsorshipLevels {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/sponsorship-levels:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/sponsorship-levels", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSponsorshipLevelsRequest, GetSponsorshipLevelsResponse> {
        ...
        private HttpRequest onBuildRequest(GetSponsorshipLevelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSponsorshipLevelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSponsorshipLevelsRequest request) {
        ...
        @Override
        public GetSponsorshipLevelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSponsorshipLevelsResponse.Builder resBuilder = GetSponsorshipLevelsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSponsorshipLevelsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSponsorshipLevelListResponse(
                            Utils.unmarshal(response, new TypeReference<SponsorshipLevelListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSponsorshipLevelsRequest, com.cvent.models.operations.async.GetSponsorshipLevelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSponsorshipLevelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSponsorshipLevelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSponsorshipLevelsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSponsorshipLevelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSponsorshipLevelsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSponsorshipLevelsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSponsorshipLevelsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SponsorshipLevelListResponse>() {})
                            .thenApply(res::withSponsorshipLevelListResponse);
                } else {
