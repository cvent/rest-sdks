...
public class CreateContactGroup {
    ...
    public static class Sync extends Base implements RequestOperation<ContactGroupInput, CreateContactGroupResponse> {
        ...
        private HttpRequest onBuildRequest(ContactGroupInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ContactGroupInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ContactGroupInput request) {
        ...
        @Override
        public CreateContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateContactGroupResponse.Builder resBuilder = CreateContactGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateContactGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ContactGroupInput, com.cvent.models.operations.async.CreateContactGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ContactGroupInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ContactGroupInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ContactGroupInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateContactGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateContactGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateContactGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateContactGroupResponse res = resBuilder.build();
