...
public class Oauth2Authorize {
    ...
    public static class Sync extends Base implements RequestOperation<Oauth2AuthorizeRequest, Oauth2AuthorizeResponse> {
        ...
        private HttpRequest onBuildRequest(Oauth2AuthorizeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, Oauth2AuthorizeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Oauth2AuthorizeRequest request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Oauth2AuthorizeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, Oauth2AuthorizeRequest.class);
