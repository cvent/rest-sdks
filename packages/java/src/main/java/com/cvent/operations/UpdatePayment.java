...
public class UpdatePayment {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "paymentRequest", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<UpdatePaymentRequest, UpdatePaymentResponse> {
        ...
        private HttpRequest onBuildRequest(UpdatePaymentRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdatePaymentRequest.class, new TypeReference<UpdatePaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdatePaymentRequest request) {
        ...
        @Override
        public UpdatePaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdatePaymentResponse.Builder resBuilder = UpdatePaymentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdatePaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdatePaymentRequest, com.cvent.models.operations.async.UpdatePaymentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdatePaymentRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdatePaymentRequest.class, new TypeReference<UpdatePaymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdatePaymentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdatePaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdatePaymentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdatePaymentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdatePaymentResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentResponse>() {})
                            .thenApply(res::withPaymentResponse);
                } else {
