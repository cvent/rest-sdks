...
public class GetReservationRequest {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/reservation-requests:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/reservation-requests/{reservationRequestsId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetReservationRequestRequest, GetReservationRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetReservationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReservationRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetReservationRequestRequest request) {
        ...
        @Override
        public GetReservationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetReservationRequestResponse.Builder resBuilder = GetReservationRequestResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetReservationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetReservationRequestRequest, com.cvent.models.operations.async.GetReservationRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetReservationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetReservationRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetReservationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetReservationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetReservationRequestResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetReservationRequestResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetReservationRequestResponse res = resBuilder.build();
