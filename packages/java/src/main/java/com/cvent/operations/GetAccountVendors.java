...
import com.cvent.models.components.BudgetVendorsPaginatedResponse;
...
public class GetAccountVendors {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getAccountVendors",
                    java.util.Optional.of(java.util.List.of("budget/budget-vendors:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/budget-vendors");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountVendorsRequest, GetAccountVendorsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountVendorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountVendorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountVendorsRequest request) {
        ...
        @Override
        public GetAccountVendorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountVendorsResponse.Builder resBuilder = GetAccountVendorsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountVendorsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetVendorsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BudgetVendorsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountVendorsRequest, com.cvent.models.operations.async.GetAccountVendorsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountVendorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountVendorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountVendorsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountVendorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountVendorsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountVendorsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountVendorsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BudgetVendorsPaginatedResponse>() {})
                            .thenApply(res::withBudgetVendorsPaginatedResponse);
                } else {
