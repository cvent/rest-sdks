...
public class ListRfpQuestions {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listRfpQuestions",
                    java.util.Optional.of(java.util.List.of("rfp/rfp-questions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/questions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpQuestionsRequest, ListRfpQuestionsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpQuestionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpQuestionsRequest request) {
        ...
        @Override
        public ListRfpQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpQuestionsResponse.Builder resBuilder = ListRfpQuestionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpQuestions(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpQuestions>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRfpQuestionsRequest, com.cvent.models.operations.async.ListRfpQuestionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpQuestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpQuestionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpQuestionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpQuestions>() {})
                            .thenApply(res::withPaginatedRfpQuestions);
                } else {
