...
public class AddExhibitorToExhibitorCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddExhibitorToExhibitorCategoryRequest, AddExhibitorToExhibitorCategoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddExhibitorToExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddExhibitorToExhibitorCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddExhibitorToExhibitorCategoryRequest request) {
        ...
        @Override
        public AddExhibitorToExhibitorCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddExhibitorToExhibitorCategoryResponse.Builder resBuilder =
            ...
            AddExhibitorToExhibitorCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddExhibitorToExhibitorCategoryRequest, com.cvent.models.operations.async.AddExhibitorToExhibitorCategoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddExhibitorToExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddExhibitorToExhibitorCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddExhibitorToExhibitorCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddExhibitorToExhibitorCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.AddExhibitorToExhibitorCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddExhibitorToExhibitorCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddExhibitorToExhibitorCategoryResponse res = resBuilder.build();
