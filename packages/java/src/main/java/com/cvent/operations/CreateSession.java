...
public class CreateSession {
    ...
    public static class Sync extends Base implements RequestOperation<SessionInput, CreateSessionResponse> {
        ...
        private HttpRequest onBuildRequest(SessionInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SessionInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SessionInput request) {
        ...
        @Override
        public CreateSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateSessionResponse.Builder resBuilder = CreateSessionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SessionInput, com.cvent.models.operations.async.CreateSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SessionInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SessionInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SessionInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateSessionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateSessionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateSessionResponse res = resBuilder.build();
