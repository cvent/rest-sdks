...
public class UpdateExhibitorLogo {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/logo-files/{fileId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorLogoRequest, UpdateExhibitorLogoResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorLogoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorLogoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorLogoRequest request) {
        ...
        @Override
        public UpdateExhibitorLogoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateExhibitorLogoResponse.Builder resBuilder = UpdateExhibitorLogoResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateExhibitorLogoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateExhibitorLogoRequest, com.cvent.models.operations.async.UpdateExhibitorLogoResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorLogoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorLogoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorLogoRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorLogoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorLogoResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorLogoResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorLogoResponse res = resBuilder.build();
