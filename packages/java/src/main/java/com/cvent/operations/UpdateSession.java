...
public class UpdateSession {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/sessions/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "sessionUpdate", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<UpdateSessionRequest, UpdateSessionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSessionRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateSessionRequest.class, new TypeReference<UpdateSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSessionRequest request) {
        ...
        @Override
        public UpdateSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateSessionResponse.Builder resBuilder = UpdateSessionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateSessionRequest, com.cvent.models.operations.async.UpdateSessionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSessionRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateSessionRequest.class, new TypeReference<UpdateSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateSessionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateSessionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateSessionResponse res = resBuilder.build();
