...
public class ListMeetingRequestDocuments {
    ...
    public static class Sync extends Base
        ...
        public ListMeetingRequestDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListMeetingRequestDocumentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestDocumentPaginatedResponse(Utils.unmarshal(response, new TypeReference<MeetingRequestDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMeetingRequestDocumentsRequest, com.cvent.models.operations.async.ListMeetingRequestDocumentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMeetingRequestDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRequestDocumentsRequest.class);
