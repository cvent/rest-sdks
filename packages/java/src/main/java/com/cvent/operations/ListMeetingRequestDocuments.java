...
import com.cvent.models.components.MeetingRequestDocumentPaginatedResponse;
...
public class ListMeetingRequestDocuments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/meeting-requests:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/meeting-requests/{requestId}/documents", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMeetingRequestDocumentsRequest, ListMeetingRequestDocumentsResponse> {
        ...
        private HttpRequest onBuildRequest(ListMeetingRequestDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRequestDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMeetingRequestDocumentsRequest request) {
        ...
        @Override
        public ListMeetingRequestDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListMeetingRequestDocumentsResponse.Builder resBuilder = ListMeetingRequestDocumentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListMeetingRequestDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestDocumentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<MeetingRequestDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListMeetingRequestDocumentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMeetingRequestDocumentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRequestDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMeetingRequestDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingRequestDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMeetingRequestDocumentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingRequestDocumentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMeetingRequestDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRequestDocumentPaginatedResponse>() {})
                            .thenApply(res::withMeetingRequestDocumentPaginatedResponse);
                } else {
