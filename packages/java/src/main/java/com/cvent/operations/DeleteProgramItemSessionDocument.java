...
public class DeleteProgramItemSessionDocument {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/program-items:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteProgramItemSessionDocumentRequest, DeleteProgramItemSessionDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteProgramItemSessionDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteProgramItemSessionDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteProgramItemSessionDocumentRequest request) {
        ...
        @Override
        public DeleteProgramItemSessionDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteProgramItemSessionDocumentResponse.Builder resBuilder =
            ...
            DeleteProgramItemSessionDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteProgramItemSessionDocumentRequest, com.cvent.models.operations.async.DeleteProgramItemSessionDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteProgramItemSessionDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteProgramItemSessionDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteProgramItemSessionDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteProgramItemSessionDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteProgramItemSessionDocumentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteProgramItemSessionDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteProgramItemSessionDocumentResponse res = resBuilder.build();
