...
import com.cvent.models.components.EventSurveysPaginatedResponse;
...
public class GetEventSurveys {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getEventSurveys",
                    java.util.Optional.of(java.util.List.of("survey/surveys:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/surveys", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetEventSurveysRequest, GetEventSurveysResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventSurveysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveysRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventSurveysRequest request) {
        ...
        @Override
        public GetEventSurveysResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventSurveysResponse.Builder resBuilder = GetEventSurveysResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventSurveysResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveysPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventSurveysPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventSurveysRequest, com.cvent.models.operations.async.GetEventSurveysResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventSurveysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveysRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventSurveysRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventSurveysResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventSurveysResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventSurveysResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventSurveysResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventSurveysPaginatedResponse>() {})
                            .thenApply(res::withEventSurveysPaginatedResponse);
                } else {
