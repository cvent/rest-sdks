...
public class GetEventSurveys {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventSurveysRequest, GetEventSurveysResponse> {
        ...
        public GetEventSurveysResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventSurveysResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveysPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventSurveysPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventSurveysRequest, com.cvent.models.operations.async.GetEventSurveysResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventSurveysResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventSurveysResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventSurveysResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
