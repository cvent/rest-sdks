...
import com.cvent.models.components.BudgetItemResponse;
...
public class UpdateBudgetItem {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/budget-items/{budgetItemId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "budgetItem", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateBudgetItemRequest, UpdateBudgetItemResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateBudgetItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateBudgetItemRequest.class, new TypeReference<UpdateBudgetItemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBudgetItemRequest request) {
        ...
        @Override
        public UpdateBudgetItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateBudgetItemResponse.Builder resBuilder = UpdateBudgetItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateBudgetItemResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetItemResponse(
                            Utils.unmarshal(response, new TypeReference<BudgetItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateBudgetItemRequest, com.cvent.models.operations.async.UpdateBudgetItemResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateBudgetItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateBudgetItemRequest.class, new TypeReference<UpdateBudgetItemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateBudgetItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateBudgetItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateBudgetItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateBudgetItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateBudgetItemResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BudgetItemResponse>() {})
                            .thenApply(res::withBudgetItemResponse);
                } else {
