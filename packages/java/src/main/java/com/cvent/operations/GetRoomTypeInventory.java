...
public class GetRoomTypeInventory {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRoomTypeInventoryRequest, GetRoomTypeInventoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRoomTypeInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoomTypeInventoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRoomTypeInventoryRequest request) {
        ...
        @Override
        public GetRoomTypeInventoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRoomTypeInventoryResponse.Builder resBuilder =
                    GetRoomTypeInventoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetRoomTypeInventoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRoomTypeInventoryRequest, com.cvent.models.operations.async.GetRoomTypeInventoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRoomTypeInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoomTypeInventoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRoomTypeInventoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRoomTypeInventoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRoomTypeInventoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRoomTypeInventoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRoomTypeInventoryResponse res = resBuilder.build();
