...
public class AnswerBudgetCustomField {
    ...
    public static class Sync extends Base
            implements RequestOperation<AnswerBudgetCustomFieldRequest, AnswerBudgetCustomFieldResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AnswerBudgetCustomFieldRequest request) {
