...
public class CancelAppointment {
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelAppointmentRequest, CancelAppointmentResponse> {
        ...
        private HttpRequest onBuildRequest(CancelAppointmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelAppointmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelAppointmentRequest request) {
        ...
        @Override
        public CancelAppointmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CancelAppointmentResponse.Builder resBuilder = CancelAppointmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CancelAppointmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CancelAppointmentRequest, com.cvent.models.operations.async.CancelAppointmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelAppointmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelAppointmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelAppointmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CancelAppointmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CancelAppointmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CancelAppointmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CancelAppointmentResponse res = resBuilder.build();
