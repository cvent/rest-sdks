...
public class GetEventFeatures {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getEventFeatures",
                    java.util.Optional.of(java.util.List.of("event/event-features:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/features", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventFeaturesRequest, GetEventFeaturesResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventFeaturesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventFeaturesRequest request) {
        ...
        @Override
        public GetEventFeaturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventFeaturesResponse.Builder resBuilder = GetEventFeaturesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventFeaturesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventFeaturesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventFeaturesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventFeaturesRequest, com.cvent.models.operations.async.GetEventFeaturesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventFeaturesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventFeaturesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventFeaturesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventFeaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventFeaturesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventFeaturesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventFeaturesPaginatedResponse>() {})
                            .thenApply(res::withEventFeaturesPaginatedResponse);
                } else {
