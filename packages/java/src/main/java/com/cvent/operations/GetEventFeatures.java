...
public class GetEventFeatures {
    ...
    public static class Sync extends Base
        ...
        public GetEventFeaturesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventFeaturesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventFeaturesPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventFeaturesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventFeaturesRequest, com.cvent.models.operations.async.GetEventFeaturesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventFeaturesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventFeaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventFeaturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
