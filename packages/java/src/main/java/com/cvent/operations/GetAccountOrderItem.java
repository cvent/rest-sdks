...
public class GetAccountOrderItem {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/orders/{orderId}/items/{orderItemId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountOrderItemRequest, GetAccountOrderItemResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountOrderItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrderItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountOrderItemRequest request) {
        ...
        @Override
        public GetAccountOrderItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountOrderItemResponse.Builder resBuilder = GetAccountOrderItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountOrderItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountOrderItemRequest, com.cvent.models.operations.async.GetAccountOrderItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountOrderItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrderItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountOrderItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountOrderItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountOrderItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountOrderItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountOrderItemResponse res = resBuilder.build();
