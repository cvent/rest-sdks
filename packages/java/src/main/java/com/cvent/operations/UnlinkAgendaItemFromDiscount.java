...
public class UnlinkAgendaItemFromDiscount {
    ...
    public static class Sync extends Base
            implements RequestOperation<UnlinkAgendaItemFromDiscountRequest, UnlinkAgendaItemFromDiscountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UnlinkAgendaItemFromDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnlinkAgendaItemFromDiscountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnlinkAgendaItemFromDiscountRequest request) {
        ...
        @Override
        public UnlinkAgendaItemFromDiscountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnlinkAgendaItemFromDiscountResponse.Builder resBuilder =
            ...
            UnlinkAgendaItemFromDiscountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnlinkAgendaItemFromDiscountRequest, com.cvent.models.operations.async.UnlinkAgendaItemFromDiscountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UnlinkAgendaItemFromDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnlinkAgendaItemFromDiscountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnlinkAgendaItemFromDiscountRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UnlinkAgendaItemFromDiscountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UnlinkAgendaItemFromDiscountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UnlinkAgendaItemFromDiscountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UnlinkAgendaItemFromDiscountResponse res = resBuilder.build();
