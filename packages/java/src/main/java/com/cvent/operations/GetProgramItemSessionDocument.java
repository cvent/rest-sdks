...
public class GetProgramItemSessionDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProgramItemSessionDocumentRequest, GetProgramItemSessionDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProgramItemSessionDocumentRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProgramItemSessionDocumentRequest request) {
