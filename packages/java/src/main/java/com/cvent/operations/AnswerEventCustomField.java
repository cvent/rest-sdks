...
public class AnswerEventCustomField {
    ...
    public static class Sync extends Base
            implements RequestOperation<AnswerEventCustomFieldRequest, AnswerEventCustomFieldResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AnswerEventCustomFieldRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AnswerEventCustomFieldRequest.class, new TypeReference<AnswerEventCustomFieldRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AnswerEventCustomFieldRequest request) {
        ...
        @Override
        public AnswerEventCustomFieldResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AnswerEventCustomFieldResponse.Builder resBuilder =
            ...
            AnswerEventCustomFieldResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AnswerEventCustomFieldRequest, com.cvent.models.operations.async.AnswerEventCustomFieldResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AnswerEventCustomFieldRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AnswerEventCustomFieldRequest.class, new TypeReference<AnswerEventCustomFieldRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AnswerEventCustomFieldRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AnswerEventCustomFieldResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.AnswerEventCustomFieldResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AnswerEventCustomFieldResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AnswerEventCustomFieldResponse res = resBuilder.build();
