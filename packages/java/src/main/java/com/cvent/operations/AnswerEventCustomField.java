...
public class AnswerEventCustomField {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/custom-fields/{customFieldId}/answers", request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AnswerEventCustomFieldRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<AnswerEventCustomFieldRequest>() {});
        ...
        public AnswerEventCustomFieldResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AnswerEventCustomFieldResponse.Builder resBuilder = AnswerEventCustomFieldResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    AnswerEventCustomFieldRequest, com.cvent.models.operations.async.AnswerEventCustomFieldResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.AnswerEventCustomFieldResponse> handleResponse(
            ...
            com.cvent.models.operations.async.AnswerEventCustomFieldResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AnswerEventCustomFieldResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
