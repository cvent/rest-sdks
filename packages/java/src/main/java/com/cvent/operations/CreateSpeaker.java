...
public class CreateSpeaker {
    ...
    public static class Sync extends Base implements RequestOperation<Speaker, CreateSpeakerResponse> {
        ...
        private HttpRequest onBuildRequest(Speaker request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Speaker>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Speaker request) {
        ...
        @Override
        public CreateSpeakerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateSpeakerResponse.Builder resBuilder = CreateSpeakerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateSpeakerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Speaker, com.cvent.models.operations.async.CreateSpeakerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(Speaker request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Speaker>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Speaker request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateSpeakerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateSpeakerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateSpeakerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateSpeakerResponse res = resBuilder.build();
