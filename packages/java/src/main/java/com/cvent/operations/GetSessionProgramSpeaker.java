...
public class GetSessionProgramSpeaker {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionProgramSpeakerRequest, GetSessionProgramSpeakerResponse> {
        ...
        private HttpRequest onBuildRequest(GetSessionProgramSpeakerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionProgramSpeakerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionProgramSpeakerRequest request) {
        ...
        @Override
        public GetSessionProgramSpeakerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSessionProgramSpeakerResponse.Builder resBuilder = GetSessionProgramSpeakerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSessionProgramSpeakerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetSessionProgramSpeakerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionProgramSpeakerRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetSessionProgramSpeakerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionProgramSpeakerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSessionProgramSpeakerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSessionProgramSpeakerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionProgramSpeakerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSessionProgramSpeakerResponse res = resBuilder.build();
