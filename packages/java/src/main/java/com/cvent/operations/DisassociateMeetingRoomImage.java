...
public class DisassociateMeetingRoomImage {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("venue/meeting-room-images:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DisassociateMeetingRoomImageRequest, DisassociateMeetingRoomImageResponse> {
        ...
        private HttpRequest onBuildRequest(DisassociateMeetingRoomImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisassociateMeetingRoomImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisassociateMeetingRoomImageRequest request) {
        ...
        @Override
        public DisassociateMeetingRoomImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DisassociateMeetingRoomImageResponse.Builder resBuilder = DisassociateMeetingRoomImageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DisassociateMeetingRoomImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.DisassociateMeetingRoomImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DisassociateMeetingRoomImageRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, DisassociateMeetingRoomImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DisassociateMeetingRoomImageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DisassociateMeetingRoomImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DisassociateMeetingRoomImageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DisassociateMeetingRoomImageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DisassociateMeetingRoomImageResponse res = resBuilder.build();
