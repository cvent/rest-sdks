...
public class DeleteSessionEnrollment {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/session-enrollment:delete")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/sessions/{id}/enrollment/{attendeeId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSessionEnrollmentRequest, DeleteSessionEnrollmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteSessionEnrollmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionEnrollmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSessionEnrollmentRequest request) {
        ...
        @Override
        public DeleteSessionEnrollmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSessionEnrollmentResponse.Builder resBuilder = DeleteSessionEnrollmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSessionEnrollmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteSessionEnrollmentRequest, com.cvent.models.operations.async.DeleteSessionEnrollmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSessionEnrollmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionEnrollmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSessionEnrollmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSessionEnrollmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSessionEnrollmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSessionEnrollmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSessionEnrollmentResponse res = resBuilder.build();
