...
public class CreateStandardSurveyRespondent {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateStandardSurveyRespondentRequest, CreateStandardSurveyRespondentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateStandardSurveyRespondentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStandardSurveyRespondentRequest.class, new TypeReference<CreateStandardSurveyRespondentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateStandardSurveyRespondentRequest request) {
        ...
        @Override
        public CreateStandardSurveyRespondentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateStandardSurveyRespondentResponse.Builder resBuilder =
                    CreateStandardSurveyRespondentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateStandardSurveyRespondentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveyRespondent(Utils.unmarshal(response, new TypeReference<StandardSurveyRespondent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateStandardSurveyRespondentRequest, com.cvent.models.operations.async.CreateStandardSurveyRespondentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateStandardSurveyRespondentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStandardSurveyRespondentRequest.class, new TypeReference<CreateStandardSurveyRespondentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateStandardSurveyRespondentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateStandardSurveyRespondentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateStandardSurveyRespondentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateStandardSurveyRespondentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateStandardSurveyRespondentResponse res = resBuilder.build();
