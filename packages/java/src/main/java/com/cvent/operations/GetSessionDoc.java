...
public class GetSessionDoc {
    ...
    public static class Sync extends Base implements RequestOperation<GetSessionDocRequest, GetSessionDocResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSessionDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionDocRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionDocRequest request) {
        ...
        @Override
        public GetSessionDocResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSessionDocResponse.Builder resBuilder = GetSessionDocResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSessionDocResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSessionDocRequest, com.cvent.models.operations.async.GetSessionDocResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionDocRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionDocRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSessionDocResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSessionDocResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionDocResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSessionDocResponse res = resBuilder.build();
