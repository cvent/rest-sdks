...
public class ListExhibitorWeblinks {
    ...
    public static class Sync extends Base
        ...
        public ListExhibitorWeblinksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListExhibitorWeblinksResponse.Builder resBuilder =
                    ListExhibitorWeblinksResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWeblinkListResponse(Utils.unmarshal(response, new TypeReference<WeblinkListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListExhibitorWeblinksRequest, com.cvent.models.operations.async.ListExhibitorWeblinksResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorWeblinksResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListExhibitorWeblinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorWeblinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
