...
public class ListExhibitorWeblinks {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-contents:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<ListExhibitorWeblinksRequest, ListExhibitorWeblinksResponse> {
        ...
        private HttpRequest onBuildRequest(ListExhibitorWeblinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorWeblinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListExhibitorWeblinksRequest request) {
        ...
        @Override
        public ListExhibitorWeblinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListExhibitorWeblinksResponse.Builder resBuilder = ListExhibitorWeblinksResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListExhibitorWeblinksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWeblinkListResponse(
                            Utils.unmarshal(response, new TypeReference<WeblinkListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListExhibitorWeblinksRequest, com.cvent.models.operations.async.ListExhibitorWeblinksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListExhibitorWeblinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorWeblinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListExhibitorWeblinksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorWeblinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListExhibitorWeblinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorWeblinksResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListExhibitorWeblinksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WeblinkListResponse>() {})
                            .thenApply(res::withWeblinkListResponse);
                } else {
