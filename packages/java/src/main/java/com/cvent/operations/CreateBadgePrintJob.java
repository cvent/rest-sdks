...
public class CreateBadgePrintJob {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "createBadgePrintJob",
                    java.util.Optional.of(java.util.List.of("remote-printing/badge-print-jobs:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "badgePrintJobCreated", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBadgePrintJobRequest, CreateBadgePrintJobResponse> {
        ...
        private HttpRequest onBuildRequest(CreateBadgePrintJobRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateBadgePrintJobRequest.class, new TypeReference<CreateBadgePrintJobRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBadgePrintJobRequest request) {
        ...
        @Override
        public CreateBadgePrintJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateBadgePrintJobResponse.Builder resBuilder = CreateBadgePrintJobResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateBadgePrintJobResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePrintJobCreated(
                            Utils.unmarshal(response, new TypeReference<BadgePrintJobCreated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateBadgePrintJobRequest, com.cvent.models.operations.async.CreateBadgePrintJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateBadgePrintJobRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateBadgePrintJobRequest.class, new TypeReference<CreateBadgePrintJobRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateBadgePrintJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateBadgePrintJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateBadgePrintJobResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateBadgePrintJobResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateBadgePrintJobResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BadgePrintJobCreated>() {})
                            .thenApply(res::withBadgePrintJobCreated);
                } else {
