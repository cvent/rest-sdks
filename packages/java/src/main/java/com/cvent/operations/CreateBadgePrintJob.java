...
public class CreateBadgePrintJob {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateBadgePrintJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBadgePrintJobRequest.class, new TypeReference<CreateBadgePrintJobRequest>() {});
        ...
        public CreateBadgePrintJobResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateBadgePrintJobResponse.Builder resBuilder =
                    CreateBadgePrintJobResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePrintJobCreated(Utils.unmarshal(response, new TypeReference<BadgePrintJobCreated>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateBadgePrintJobRequest, com.cvent.models.operations.async.CreateBadgePrintJobResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.CreateBadgePrintJobResponse> handleResponse(
            ...
            com.cvent.models.operations.async.CreateBadgePrintJobResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateBadgePrintJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
