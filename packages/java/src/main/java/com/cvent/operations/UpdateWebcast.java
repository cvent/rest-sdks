...
public class UpdateWebcast {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "updateWebcast",
                    java.util.Optional.of(java.util.List.of("event/webcasts:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/webcasts/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingWebcast", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<UpdateWebcastRequest, UpdateWebcastResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateWebcastRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateWebcastRequest.class, new TypeReference<UpdateWebcastRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateWebcastRequest request) {
        ...
        @Override
        public UpdateWebcastResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateWebcastResponse.Builder resBuilder = UpdateWebcastResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateWebcastResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingWebcast(Utils.unmarshal(response, new TypeReference<ExistingWebcast>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateWebcastRequest, com.cvent.models.operations.async.UpdateWebcastResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateWebcastRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateWebcastRequest.class, new TypeReference<UpdateWebcastRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateWebcastRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateWebcastResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateWebcastResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateWebcastResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateWebcastResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingWebcast>() {})
                            .thenApply(res::withExistingWebcast);
                } else {
