...
import com.cvent.models.components.Badge;
...
public class PostBadge {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "postBadge",
                    java.util.Optional.of(java.util.List.of("exhibitor/badges:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/badges", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "badge", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<PostBadgeRequest, PostBadgeResponse> {
        ...
        private HttpRequest onBuildRequest(PostBadgeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostBadgeRequest.class, new TypeReference<PostBadgeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostBadgeRequest request) {
        ...
        @Override
        public PostBadgeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PostBadgeResponse.Builder resBuilder = PostBadgeResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PostBadgeResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadge(Utils.unmarshal(response, new TypeReference<Badge>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostBadgeRequest, com.cvent.models.operations.async.PostBadgeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PostBadgeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostBadgeRequest.class, new TypeReference<PostBadgeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostBadgeRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PostBadgeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PostBadgeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PostBadgeResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PostBadgeResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Badge>() {})
                            .thenApply(res::withBadge);
                } else {
