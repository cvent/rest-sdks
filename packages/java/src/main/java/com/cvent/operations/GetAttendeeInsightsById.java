...
public class GetAttendeeInsightsById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/attendee-insights/{id}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAttendeeInsightsByIdRequest, GetAttendeeInsightsByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAttendeeInsightsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeInsightsByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAttendeeInsightsByIdRequest request) {
        ...
        @Override
        public GetAttendeeInsightsByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAttendeeInsightsByIdResponse.Builder resBuilder = GetAttendeeInsightsByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAttendeeInsightsByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInsights(
                            Utils.unmarshal(response, new TypeReference<AttendeeInsights>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAttendeeInsightsByIdRequest, com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAttendeeInsightsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeInsightsByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAttendeeInsightsByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeInsights>() {})
                            .thenApply(res::withAttendeeInsights);
                } else {
