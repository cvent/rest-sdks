...
public class GetAttendeeInsightsById {
    ...
    public static class Sync extends Base
        ...
        public GetAttendeeInsightsByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAttendeeInsightsByIdResponse.Builder resBuilder =
                    GetAttendeeInsightsByIdResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInsights(Utils.unmarshal(response, new TypeReference<AttendeeInsights>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAttendeeInsightsByIdRequest, com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAttendeeInsightsByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
