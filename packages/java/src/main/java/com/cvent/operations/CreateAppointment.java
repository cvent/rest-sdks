...
public class CreateAppointment {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/appointment-events/{id}/appointments", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "createAppointmentRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAppointmentRequest, CreateAppointmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateAppointmentRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateAppointmentRequest.class, new TypeReference<CreateAppointmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAppointmentRequest request) {
        ...
        @Override
        public CreateAppointmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateAppointmentResponse.Builder resBuilder = CreateAppointmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateAppointmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateAppointmentRequest, com.cvent.models.operations.async.CreateAppointmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateAppointmentRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateAppointmentRequest.class, new TypeReference<CreateAppointmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateAppointmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateAppointmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateAppointmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateAppointmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateAppointmentResponse res = resBuilder.build();
