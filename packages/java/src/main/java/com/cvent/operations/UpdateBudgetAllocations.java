...
public class UpdateBudgetAllocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateBudgetAllocationsRequest, UpdateBudgetAllocationsResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBudgetAllocationsRequest request) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BudgetAllocationsList>() {})
                            .thenApply(res::withBudgetAllocationsList);
                } else {
