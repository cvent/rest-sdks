...
public class ListRfpAgendaItemSchedules {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("rfp/rfp-agenda-items:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/agenda-items/schedules", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpAgendaItemSchedulesRequest, ListRfpAgendaItemSchedulesResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpAgendaItemSchedulesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpAgendaItemSchedulesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpAgendaItemSchedulesRequest request) {
        ...
        @Override
        public ListRfpAgendaItemSchedulesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpAgendaItemSchedulesResponse.Builder resBuilder = ListRfpAgendaItemSchedulesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpAgendaItemSchedulesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpAgendaItemsSchedule(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpAgendaItemsSchedule>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListRfpAgendaItemSchedulesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpAgendaItemSchedulesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListRfpAgendaItemSchedulesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpAgendaItemSchedulesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpAgendaItemSchedulesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpAgendaItemSchedulesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpAgendaItemSchedulesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpAgendaItemSchedulesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpAgendaItemsSchedule>() {})
                            .thenApply(res::withPaginatedRfpAgendaItemsSchedule);
                } else {
