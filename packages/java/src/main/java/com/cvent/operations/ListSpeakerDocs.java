...
public class ListSpeakerDocs {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/speakers/{id}/docs", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListSpeakerDocsRequest, ListSpeakerDocsResponse> {
        ...
        private HttpRequest onBuildRequest(ListSpeakerDocsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakerDocsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSpeakerDocsRequest request) {
        ...
        @Override
        public ListSpeakerDocsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSpeakerDocsResponse.Builder resBuilder = ListSpeakerDocsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSpeakerDocsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerDocumentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SpeakerDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSpeakerDocsRequest, com.cvent.models.operations.async.ListSpeakerDocsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSpeakerDocsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakerDocsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSpeakerDocsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakerDocsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSpeakerDocsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakerDocsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSpeakerDocsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SpeakerDocumentPaginatedResponse>() {})
                            .thenApply(res::withSpeakerDocumentPaginatedResponse);
                } else {
