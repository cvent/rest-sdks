...
public class ListSpeakerDocs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSpeakerDocsRequest, ListSpeakerDocsResponse> {
        ...
        public ListSpeakerDocsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSpeakerDocsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerDocumentPaginatedResponse(Utils.unmarshal(response, new TypeReference<SpeakerDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSpeakerDocsRequest, com.cvent.models.operations.async.ListSpeakerDocsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakerDocsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSpeakerDocsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakerDocsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
