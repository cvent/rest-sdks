...
public class GetBulkJobById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/bulk-jobs/{id}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetBulkJobByIdRequest, GetBulkJobByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetBulkJobByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBulkJobByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBulkJobByIdRequest request) {
        ...
        @Override
        public GetBulkJobByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBulkJobByIdResponse.Builder resBuilder = GetBulkJobByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBulkJobByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBulkJobByIdRequest, com.cvent.models.operations.async.GetBulkJobByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBulkJobByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBulkJobByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBulkJobByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBulkJobByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBulkJobByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBulkJobByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBulkJobByIdResponse res = resBuilder.build();
