...
public class GetAccountUserGroups {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("account/user-groups:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/account-user-groups");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountUserGroupsRequest, GetAccountUserGroupsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountUserGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountUserGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountUserGroupsRequest request) {
        ...
        @Override
        public GetAccountUserGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountUserGroupsResponse.Builder resBuilder = GetAccountUserGroupsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountUserGroupsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUserGroupsJson(Utils.unmarshal(response, new TypeReference<UserGroupsJson>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountUserGroupsRequest, com.cvent.models.operations.async.GetAccountUserGroupsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountUserGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountUserGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountUserGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountUserGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountUserGroupsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountUserGroupsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountUserGroupsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UserGroupsJson>() {})
                            .thenApply(res::withUserGroupsJson);
                } else {
