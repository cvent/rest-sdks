...
public class DeleteSessionAttendance {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/sessions/{id}/attendance/{attendeeId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSessionAttendanceRequest, DeleteSessionAttendanceResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteSessionAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionAttendanceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSessionAttendanceRequest request) {
        ...
        @Override
        public DeleteSessionAttendanceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSessionAttendanceResponse.Builder resBuilder = DeleteSessionAttendanceResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSessionAttendanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteSessionAttendanceRequest, com.cvent.models.operations.async.DeleteSessionAttendanceResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSessionAttendanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionAttendanceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSessionAttendanceRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSessionAttendanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSessionAttendanceResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSessionAttendanceResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSessionAttendanceResponse res = resBuilder.build();
