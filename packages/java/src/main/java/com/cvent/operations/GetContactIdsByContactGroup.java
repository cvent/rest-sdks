...
public class GetContactIdsByContactGroup {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/contact-groups:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contact-groups/{id}/contacts", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetContactIdsByContactGroupRequest, GetContactIdsByContactGroupResponse> {
        ...
        private HttpRequest onBuildRequest(GetContactIdsByContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContactIdsByContactGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetContactIdsByContactGroupRequest request) {
        ...
        @Override
        public GetContactIdsByContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetContactIdsByContactGroupResponse.Builder resBuilder = GetContactIdsByContactGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetContactIdsByContactGroupResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactIdPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ContactIdPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetContactIdsByContactGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetContactIdsByContactGroupRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetContactIdsByContactGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetContactIdsByContactGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetContactIdsByContactGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetContactIdsByContactGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetContactIdsByContactGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetContactIdsByContactGroupResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactIdPaginatedResponse>() {})
                            .thenApply(res::withContactIdPaginatedResponse);
                } else {
