...
public class GetContactIdsByContactGroup {
    ...
    public static class Sync extends Base
        ...
        public GetContactIdsByContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetContactIdsByContactGroupResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactIdPaginatedResponse(Utils.unmarshal(response, new TypeReference<ContactIdPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetContactIdsByContactGroupRequest, com.cvent.models.operations.async.GetContactIdsByContactGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetContactIdsByContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContactIdsByContactGroupRequest.class);
