...
public class ListSupplierAccounts {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("business-transient/travel-supplier-accounts:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-accounts/supplier-accounts");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSupplierAccountsRequest, ListSupplierAccountsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSupplierAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSupplierAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSupplierAccountsRequest request) {
        ...
        @Override
        public ListSupplierAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSupplierAccountsResponse.Builder resBuilder = ListSupplierAccountsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSupplierAccountsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccountSupplierAccountPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<TravelAccountSupplierAccountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSupplierAccountsRequest, com.cvent.models.operations.async.ListSupplierAccountsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSupplierAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSupplierAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSupplierAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSupplierAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSupplierAccountsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSupplierAccountsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSupplierAccountsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelAccountSupplierAccountPaginatedResponse>() {})
                            .thenApply(res::withTravelAccountSupplierAccountPaginatedResponse);
                } else {
