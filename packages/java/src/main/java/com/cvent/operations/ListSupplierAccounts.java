...
public class ListSupplierAccounts {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    this.baseUrl,
                    "/travel-accounts/supplier-accounts");
    ...
    public static class Sync extends Base
        ...
        public ListSupplierAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSupplierAccountsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccountSupplierAccountPaginatedResponse(Utils.unmarshal(response, new TypeReference<TravelAccountSupplierAccountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSupplierAccountsRequest, com.cvent.models.operations.async.ListSupplierAccountsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSupplierAccountsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSupplierAccountsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSupplierAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
