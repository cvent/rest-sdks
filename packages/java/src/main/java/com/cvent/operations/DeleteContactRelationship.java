...
public class DeleteContactRelationship {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/contacts/{id}/related-contacts/{relatedContactId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteContactRelationshipRequest, DeleteContactRelationshipResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteContactRelationshipRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactRelationshipRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteContactRelationshipRequest request) {
        ...
        @Override
        public DeleteContactRelationshipResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteContactRelationshipResponse.Builder resBuilder = DeleteContactRelationshipResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteContactRelationshipResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.DeleteContactRelationshipResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactRelationshipRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactRelationshipRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteContactRelationshipRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteContactRelationshipResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteContactRelationshipResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteContactRelationshipResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteContactRelationshipResponse res = resBuilder.build();
