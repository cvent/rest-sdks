...
public class DeleteContactRelationship {
    ...
    public static class Sync extends Base
        ...
        public DeleteContactRelationshipResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            DeleteContactRelationshipResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteContactRelationshipRequest, com.cvent.models.operations.async.DeleteContactRelationshipResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactRelationshipRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactRelationshipRequest.class);
