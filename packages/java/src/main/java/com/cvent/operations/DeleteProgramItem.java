...
public class DeleteProgramItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteProgramItemRequest, DeleteProgramItemResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteProgramItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteProgramItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteProgramItemRequest request) {
        ...
        @Override
        public DeleteProgramItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteProgramItemResponse.Builder resBuilder = DeleteProgramItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteProgramItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteProgramItemRequest, com.cvent.models.operations.async.DeleteProgramItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteProgramItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteProgramItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteProgramItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteProgramItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteProgramItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteProgramItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteProgramItemResponse res = resBuilder.build();
