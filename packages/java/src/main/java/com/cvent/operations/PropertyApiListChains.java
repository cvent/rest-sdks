...
public class PropertyApiListChains {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-suppliers/chains");
    ...
    public static class Sync extends Base
            implements RequestOperation<PropertyApiListChainsRequest, PropertyApiListChainsResponse> {
        ...
        private HttpRequest onBuildRequest(PropertyApiListChainsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListChainsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PropertyApiListChainsRequest request) {
        ...
        @Override
        public PropertyApiListChainsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PropertyApiListChainsResponse.Builder resBuilder = PropertyApiListChainsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PropertyApiListChainsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withChainPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ChainPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PropertyApiListChainsRequest, com.cvent.models.operations.async.PropertyApiListChainsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiListChainsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListChainsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PropertyApiListChainsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiListChainsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PropertyApiListChainsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiListChainsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PropertyApiListChainsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ChainPaginatedResponse>() {})
                            .thenApply(res::withChainPaginatedResponse);
                } else {
