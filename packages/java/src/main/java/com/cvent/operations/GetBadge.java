...
public class GetBadge {
    ...
    public static class Sync extends Base implements RequestOperation<GetBadgeRequest, GetBadgeResponse> {
        ...
        private HttpRequest onBuildRequest(GetBadgeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBadgeRequest request) {
        ...
        @Override
        public GetBadgeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBadgeResponse.Builder resBuilder = GetBadgeResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBadgeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBadgeRequest, com.cvent.models.operations.async.GetBadgeResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBadgeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBadgeRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBadgeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBadgeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgeResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBadgeResponse res = resBuilder.build();
