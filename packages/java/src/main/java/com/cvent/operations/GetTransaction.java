...
public class GetTransaction {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/transactions/{transactionId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetTransactionRequest, GetTransactionResponse> {
        ...
        public GetTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTransactionResponse.Builder resBuilder = GetTransactionResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionDetailResponse(
                            Utils.unmarshal(response, new TypeReference<TransactionDetailResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetTransactionRequest, com.cvent.models.operations.async.GetTransactionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTransactionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTransactionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTransactionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTransactionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTransactionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionDetailResponse>() {})
                            .thenApply(res::withTransactionDetailResponse);
                } else {
