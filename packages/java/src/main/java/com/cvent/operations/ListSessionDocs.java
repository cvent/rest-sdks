...
import com.cvent.models.components.SessionDocumentPaginatedResponse;
...
public class ListSessionDocs {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/sessions/{id}/docs", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListSessionDocsRequest, ListSessionDocsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSessionDocsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionDocsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSessionDocsRequest request) {
        ...
        @Override
        public ListSessionDocsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSessionDocsResponse.Builder resBuilder = ListSessionDocsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSessionDocsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionDocumentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSessionDocsRequest, com.cvent.models.operations.async.ListSessionDocsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionDocsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionDocsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSessionDocsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionDocsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSessionDocsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionDocsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSessionDocsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionDocumentPaginatedResponse>() {})
                            .thenApply(res::withSessionDocumentPaginatedResponse);
                } else {
