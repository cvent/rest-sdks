...
public class ListSessionDocs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSessionDocsRequest, ListSessionDocsResponse> {
        ...
        public ListSessionDocsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSessionDocsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionDocumentPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSessionDocsRequest, com.cvent.models.operations.async.ListSessionDocsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSessionDocsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSessionDocsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionDocsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
