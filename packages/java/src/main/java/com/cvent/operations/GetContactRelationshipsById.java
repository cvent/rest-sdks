...
public class GetContactRelationshipsById {
    ...
    public static class Sync extends Base
        ...
        public GetContactRelationshipsByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetContactRelationshipsByIdResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetContactRelationshipsByIdRequest, com.cvent.models.operations.async.GetContactRelationshipsByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetContactRelationshipsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContactRelationshipsByIdRequest.class);
