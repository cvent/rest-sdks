...
public class GetContactRelationshipsById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contacts/{id}/related-contacts", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetContactRelationshipsByIdRequest, GetContactRelationshipsByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetContactRelationshipsByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContactRelationshipsByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetContactRelationshipsByIdRequest request) {
        ...
        @Override
        public GetContactRelationshipsByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetContactRelationshipsByIdResponse.Builder resBuilder = GetContactRelationshipsByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetContactRelationshipsByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetContactRelationshipsByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetContactRelationshipsByIdRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetContactRelationshipsByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetContactRelationshipsByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetContactRelationshipsByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetContactRelationshipsByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetContactRelationshipsByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetContactRelationshipsByIdResponse res = resBuilder.build();
