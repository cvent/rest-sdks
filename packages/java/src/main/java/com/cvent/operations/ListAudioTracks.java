...
public class ListAudioTracks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAudioTracksRequest, ListAudioTracksResponse> {
        ...
        public ListAudioTracksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAudioTracksResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAudioTracksResponse(Utils.unmarshal(response, new TypeReference<AudioTracksResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAudioTracksRequest, com.cvent.models.operations.async.ListAudioTracksResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAudioTracksResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAudioTracksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAudioTracksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
