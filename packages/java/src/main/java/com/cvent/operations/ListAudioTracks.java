...
public class ListAudioTracks {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/videos/{videoId}/audio-tracks", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListAudioTracksRequest, ListAudioTracksResponse> {
        ...
        private HttpRequest onBuildRequest(ListAudioTracksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAudioTracksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAudioTracksRequest request) {
        ...
        @Override
        public ListAudioTracksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAudioTracksResponse.Builder resBuilder = ListAudioTracksResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAudioTracksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAudioTracksResponse(
                            Utils.unmarshal(response, new TypeReference<AudioTracksResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAudioTracksRequest, com.cvent.models.operations.async.ListAudioTracksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAudioTracksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAudioTracksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAudioTracksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAudioTracksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAudioTracksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAudioTracksResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAudioTracksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AudioTracksResponse>() {})
                            .thenApply(res::withAudioTracksResponse);
                } else {
