...
public class GetExhibitors {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExhibitorsRequest, GetExhibitorsResponse> {
        ...
        public GetExhibitorsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetExhibitorsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorsPaginatedResponse(Utils.unmarshal(response, new TypeReference<ExhibitorsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetExhibitorsRequest, com.cvent.models.operations.async.GetExhibitorsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetExhibitorsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
