...
public class LinkAgendaItemToDiscount {
    ...
    public static class Sync extends Base
            implements RequestOperation<LinkAgendaItemToDiscountRequest, LinkAgendaItemToDiscountResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(LinkAgendaItemToDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LinkAgendaItemToDiscountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LinkAgendaItemToDiscountRequest request) {
        ...
        @Override
        public LinkAgendaItemToDiscountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LinkAgendaItemToDiscountResponse.Builder resBuilder =
            ...
            LinkAgendaItemToDiscountResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LinkAgendaItemToDiscountRequest, com.cvent.models.operations.async.LinkAgendaItemToDiscountResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(LinkAgendaItemToDiscountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LinkAgendaItemToDiscountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LinkAgendaItemToDiscountRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.LinkAgendaItemToDiscountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.LinkAgendaItemToDiscountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.LinkAgendaItemToDiscountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.LinkAgendaItemToDiscountResponse res = resBuilder.build();
