...
public class GetEventById {
    ...
    public static class Sync extends Base implements RequestOperation<GetEventByIdRequest, GetEventByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventByIdRequest request) {
        ...
        @Override
        public GetEventByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventByIdResponse.Builder resBuilder = GetEventByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEvent1(Utils.unmarshal(response, new TypeReference<Event11>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventByIdRequest, com.cvent.models.operations.async.GetEventByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Event11>() {})
                            .thenApply(res::withEvent1);
                } else {
