...
public class GetAccountOrders {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/orders");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountOrdersRequest, GetAccountOrdersResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountOrdersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrdersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountOrdersRequest request) {
        ...
        @Override
        public GetAccountOrdersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountOrdersResponse.Builder resBuilder = GetAccountOrdersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountOrdersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderDetailsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<OrderDetailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountOrdersRequest, com.cvent.models.operations.async.GetAccountOrdersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountOrdersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrdersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountOrdersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountOrdersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountOrdersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountOrdersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountOrdersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<OrderDetailsPaginatedResponse>() {})
                            .thenApply(res::withOrderDetailsPaginatedResponse);
                } else {
