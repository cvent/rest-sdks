...
public class GetAppointmentEventById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/appointment-events/{id}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAppointmentEventByIdRequest, GetAppointmentEventByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAppointmentEventByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppointmentEventByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAppointmentEventByIdRequest request) {
        ...
        @Override
        public GetAppointmentEventByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAppointmentEventByIdResponse.Builder resBuilder = GetAppointmentEventByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAppointmentEventByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentEvent(
                            Utils.unmarshal(response, new TypeReference<AppointmentEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAppointmentEventByIdRequest, com.cvent.models.operations.async.GetAppointmentEventByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAppointmentEventByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppointmentEventByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAppointmentEventByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAppointmentEventByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAppointmentEventByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAppointmentEventByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAppointmentEventByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AppointmentEvent>() {})
                            .thenApply(res::withAppointmentEvent);
                } else {
