...
public class GetAppointmentEventById {
    ...
    public static class Sync extends Base
        ...
        public GetAppointmentEventByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAppointmentEventByIdResponse.Builder resBuilder =
                    GetAppointmentEventByIdResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentEvent(Utils.unmarshal(response, new TypeReference<AppointmentEvent>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAppointmentEventByIdRequest, com.cvent.models.operations.async.GetAppointmentEventByIdResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAppointmentEventByIdResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAppointmentEventByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAppointmentEventByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
