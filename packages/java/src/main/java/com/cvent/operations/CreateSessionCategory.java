...
public class CreateSessionCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<SessionCategoryInput, CreateSessionCategoryResponse> {
        ...
        private HttpRequest onBuildRequest(SessionCategoryInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SessionCategoryInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SessionCategoryInput request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SessionCategoryInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SessionCategoryInput>() {});
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionCategory>() {})
                            .thenApply(res::withSessionCategory);
                } else {
