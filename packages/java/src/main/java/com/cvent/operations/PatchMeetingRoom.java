...
public class PatchMeetingRoom {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "patchMeetingRoom", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchMeetingRoomRequest, PatchMeetingRoomResponse> {
        ...
        private HttpRequest onBuildRequest(PatchMeetingRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchMeetingRoomRequest.class, new TypeReference<PatchMeetingRoomRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchMeetingRoomRequest request) {
        ...
        @Override
        public PatchMeetingRoomResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PatchMeetingRoomResponse.Builder resBuilder = PatchMeetingRoomResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PatchMeetingRoomResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPatchMeetingRoom(Utils.unmarshal(
                            response, new TypeReference<com.cvent.models.components.PatchMeetingRoom>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PatchMeetingRoomRequest, com.cvent.models.operations.async.PatchMeetingRoomResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PatchMeetingRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchMeetingRoomRequest.class, new TypeReference<PatchMeetingRoomRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchMeetingRoomRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PatchMeetingRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PatchMeetingRoomResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PatchMeetingRoomResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PatchMeetingRoomResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<com.cvent.models.components.PatchMeetingRoom>() {})
                            .thenApply(res::withPatchMeetingRoom);
                } else {
