...
public class UpdateReservationSync {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateReservationSyncRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateReservationSyncRequest.class, new TypeReference<UpdateReservationSyncRequest>() {});
        ...
        public UpdateReservationSyncResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateReservationSyncResponse.Builder resBuilder =
                    UpdateReservationSyncResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingReservation(Utils.unmarshal(response, new TypeReference<ExistingReservation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateReservationSyncRequest, com.cvent.models.operations.async.UpdateReservationSyncResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateReservationSyncResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateReservationSyncResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateReservationSyncResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
