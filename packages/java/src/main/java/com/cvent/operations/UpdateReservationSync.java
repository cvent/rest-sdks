...
public class UpdateReservationSync {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/reservations:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/reservations/{reservationId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "newReservation", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateReservationSyncRequest, UpdateReservationSyncResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateReservationSyncRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateReservationSyncRequest.class, new TypeReference<UpdateReservationSyncRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateReservationSyncRequest request) {
        ...
        @Override
        public UpdateReservationSyncResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateReservationSyncResponse.Builder resBuilder = UpdateReservationSyncResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateReservationSyncResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingReservation(
                            Utils.unmarshal(response, new TypeReference<ExistingReservation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateReservationSyncRequest, com.cvent.models.operations.async.UpdateReservationSyncResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateReservationSyncRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateReservationSyncRequest.class, new TypeReference<UpdateReservationSyncRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateReservationSyncRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateReservationSyncResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateReservationSyncResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateReservationSyncResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateReservationSyncResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingReservation>() {})
                            .thenApply(res::withExistingReservation);
                } else {
