...
public class GetAppointmentById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/appointments/{id}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAppointmentByIdRequest, GetAppointmentByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAppointmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppointmentByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAppointmentByIdRequest request) {
        ...
        @Override
        public GetAppointmentByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAppointmentByIdResponse.Builder resBuilder = GetAppointmentByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAppointmentByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAppointmentByIdRequest, com.cvent.models.operations.async.GetAppointmentByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAppointmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAppointmentByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAppointmentByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAppointmentByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAppointmentByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAppointmentByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAppointmentByIdResponse res = resBuilder.build();
