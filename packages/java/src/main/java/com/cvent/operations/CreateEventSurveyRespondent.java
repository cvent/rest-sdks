...
public class CreateEventSurveyRespondent {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateEventSurveyRespondentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateEventSurveyRespondentRequest.class, new TypeReference<CreateEventSurveyRespondentRequest>() {});
        ...
        public CreateEventSurveyRespondentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateEventSurveyRespondentResponse.Builder resBuilder =
                    CreateEventSurveyRespondentResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateEventSurveyRespondentRequest, com.cvent.models.operations.async.CreateEventSurveyRespondentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateEventSurveyRespondentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateEventSurveyRespondentRequest.class, new TypeReference<CreateEventSurveyRespondentRequest>() {});
