...
public class RemoveContactFromContactGroup {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/contact-groups/{id}/contacts/{contactId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveContactFromContactGroupRequest, RemoveContactFromContactGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveContactFromContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveContactFromContactGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveContactFromContactGroupRequest request) {
        ...
        @Override
        public RemoveContactFromContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            RemoveContactFromContactGroupResponse.Builder resBuilder = RemoveContactFromContactGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            RemoveContactFromContactGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.RemoveContactFromContactGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveContactFromContactGroupRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, RemoveContactFromContactGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveContactFromContactGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.RemoveContactFromContactGroupResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.RemoveContactFromContactGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.RemoveContactFromContactGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.RemoveContactFromContactGroupResponse res = resBuilder.build();
