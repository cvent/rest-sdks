...
import com.cvent.models.components.RfpPastEvents;
...
public class ListRfpPastEvents {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listRfpPastEvents",
                    java.util.Optional.of(java.util.List.of("rfp/rfp-past-events:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/past-events", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpPastEventsRequest, ListRfpPastEventsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpPastEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpPastEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpPastEventsRequest request) {
        ...
        @Override
        public ListRfpPastEventsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpPastEventsResponse.Builder resBuilder = ListRfpPastEventsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpPastEventsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRfpPastEvents(Utils.unmarshal(response, new TypeReference<RfpPastEvents>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRfpPastEventsRequest, com.cvent.models.operations.async.ListRfpPastEventsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpPastEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpPastEventsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpPastEventsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpPastEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpPastEventsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpPastEventsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpPastEventsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RfpPastEvents>() {})
                            .thenApply(res::withRfpPastEvents);
                } else {
