...
public class GetBoothStaff {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/events/{id}/exhibitors/{exhibitorId}/booth-staff/{boothstaffId}",
                    request,
                    null);
    ...
    public static class Sync extends Base implements RequestOperation<GetBoothStaffRequest, GetBoothStaffResponse> {
        ...
        private HttpRequest onBuildRequest(GetBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBoothStaffRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBoothStaffRequest request) {
        ...
        @Override
        public GetBoothStaffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBoothStaffResponse.Builder resBuilder = GetBoothStaffResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBoothStaffResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBoothStaffRequest, com.cvent.models.operations.async.GetBoothStaffResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBoothStaffRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBoothStaffRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBoothStaffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBoothStaffResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBoothStaffResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBoothStaffResponse res = resBuilder.build();
