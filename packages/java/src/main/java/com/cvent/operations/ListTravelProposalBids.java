...
public class ListTravelProposalBids {
    ...
    public static class Sync extends Base
        ...
        public ListTravelProposalBidsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTravelProposalBidsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProposalBidPaginatedResponse(Utils.unmarshal(response, new TypeReference<TravelProposalBidPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTravelProposalBidsRequest, com.cvent.models.operations.async.ListTravelProposalBidsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProposalBidsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListTravelProposalBidsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProposalBidsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
