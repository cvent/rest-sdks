...
public class ListTravelProposalBids {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-proposals/bids");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTravelProposalBidsRequest, ListTravelProposalBidsResponse> {
        ...
        private HttpRequest onBuildRequest(ListTravelProposalBidsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProposalBidsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTravelProposalBidsRequest request) {
        ...
        @Override
        public ListTravelProposalBidsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTravelProposalBidsResponse.Builder resBuilder = ListTravelProposalBidsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTravelProposalBidsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProposalBidPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TravelProposalBidPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListTravelProposalBidsRequest, com.cvent.models.operations.async.ListTravelProposalBidsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTravelProposalBidsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProposalBidsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTravelProposalBidsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProposalBidsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTravelProposalBidsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProposalBidsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTravelProposalBidsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelProposalBidPaginatedResponse>() {})
                            .thenApply(res::withTravelProposalBidPaginatedResponse);
                } else {
