...
public class GetSpeakerDoc {
    ...
    public static class Sync extends Base implements RequestOperation<GetSpeakerDocRequest, GetSpeakerDocResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSpeakerDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSpeakerDocRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSpeakerDocRequest request) {
        ...
        @Override
        public GetSpeakerDocResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSpeakerDocResponse.Builder resBuilder = GetSpeakerDocResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSpeakerDocResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSpeakerDocRequest, com.cvent.models.operations.async.GetSpeakerDocResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSpeakerDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSpeakerDocRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSpeakerDocRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSpeakerDocResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSpeakerDocResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSpeakerDocResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSpeakerDocResponse res = resBuilder.build();
