...
public class ListPlayers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listPlayers",
                    java.util.Optional.of(java.util.List.of("event/players:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/webcasts/players");
    ...
    public static class Sync extends Base implements RequestOperation<ListPlayersRequest, ListPlayersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListPlayersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlayersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListPlayersRequest request) {
        ...
        @Override
        public ListPlayersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListPlayersResponse.Builder resBuilder = ListPlayersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListPlayersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlayerPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<PlayerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListPlayersRequest, com.cvent.models.operations.async.ListPlayersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListPlayersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListPlayersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListPlayersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListPlayersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListPlayersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListPlayersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListPlayersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlayerPaginatedResponse>() {})
                            .thenApply(res::withPlayerPaginatedResponse);
                } else {
