...
public class ListPlayers {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListPlayersRequest, ListPlayersResponse> {
        ...
        public ListPlayersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListPlayersResponse.Builder resBuilder =
                    ListPlayersResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlayerPaginatedResponse(Utils.unmarshal(response, new TypeReference<PlayerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListPlayersRequest, com.cvent.models.operations.async.ListPlayersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListPlayersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListPlayersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListPlayersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
