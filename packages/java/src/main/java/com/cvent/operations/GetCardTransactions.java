...
public class GetCardTransactions {
    ...
    public static class Sync extends Base
        ...
        public GetCardTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetCardTransactionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardTransactionPaginatedResponse(Utils.unmarshal(response, new TypeReference<CardTransactionPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCardTransactionsRequest, com.cvent.models.operations.async.GetCardTransactionsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetCardTransactionsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetCardTransactionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCardTransactionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
