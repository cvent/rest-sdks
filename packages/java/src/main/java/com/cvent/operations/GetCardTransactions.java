...
public class GetCardTransactions {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getCardTransactions",
                    java.util.Optional.of(java.util.List.of("budget/transactions:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCardTransactionsRequest, GetCardTransactionsResponse> {
        ...
        private HttpRequest onBuildRequest(GetCardTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCardTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCardTransactionsRequest request) {
        ...
        @Override
        public GetCardTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetCardTransactionsResponse.Builder resBuilder = GetCardTransactionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetCardTransactionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardTransactionPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<CardTransactionPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetCardTransactionsRequest, com.cvent.models.operations.async.GetCardTransactionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCardTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCardTransactionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCardTransactionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetCardTransactionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetCardTransactionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCardTransactionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetCardTransactionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CardTransactionPaginatedResponse>() {})
                            .thenApply(res::withCardTransactionPaginatedResponse);
                } else {
