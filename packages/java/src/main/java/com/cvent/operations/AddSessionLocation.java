...
public class AddSessionLocation {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "addSessionLocation",
                    java.util.Optional.of(java.util.List.of("event/sessions:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "sessionLocation", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<AddSessionLocationRequest, AddSessionLocationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddSessionLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, AddSessionLocationRequest.class, new TypeReference<AddSessionLocationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSessionLocationRequest request) {
        ...
        @Override
        public AddSessionLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AddSessionLocationResponse.Builder resBuilder = AddSessionLocationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AddSessionLocationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionLocation(Utils.unmarshal(response, new TypeReference<SessionLocation>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    AddSessionLocationRequest, com.cvent.models.operations.async.AddSessionLocationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddSessionLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, AddSessionLocationRequest.class, new TypeReference<AddSessionLocationRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSessionLocationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddSessionLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AddSessionLocationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddSessionLocationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddSessionLocationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionLocation>() {})
                            .thenApply(res::withSessionLocation);
                } else {
