...
public class PatchVenueDetails {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "venueDetailsPatch", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchVenueDetailsRequest, PatchVenueDetailsResponse> {
        ...
        private HttpRequest onBuildRequest(PatchVenueDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchVenueDetailsRequest.class, new TypeReference<PatchVenueDetailsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchVenueDetailsRequest request) {
        ...
        @Override
        public PatchVenueDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PatchVenueDetailsResponse.Builder resBuilder = PatchVenueDetailsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PatchVenueDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVenueDetailsPatch(
                            Utils.unmarshal(response, new TypeReference<VenueDetailsPatch>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PatchVenueDetailsRequest, com.cvent.models.operations.async.PatchVenueDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PatchVenueDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchVenueDetailsRequest.class, new TypeReference<PatchVenueDetailsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchVenueDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PatchVenueDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PatchVenueDetailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PatchVenueDetailsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PatchVenueDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VenueDetailsPatch>() {})
                            .thenApply(res::withVenueDetailsPatch);
                } else {
