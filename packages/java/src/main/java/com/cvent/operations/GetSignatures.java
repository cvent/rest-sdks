...
public class GetSignatures {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getSignatures",
                    java.util.Optional.of(java.util.List.of("onsite/signatures:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/signatures");
    ...
    public static class Sync extends Base implements RequestOperation<GetSignaturesRequest, GetSignaturesResponse> {
        ...
        private HttpRequest onBuildRequest(GetSignaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSignaturesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSignaturesRequest request) {
        ...
        @Override
        public GetSignaturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSignaturesResponse.Builder resBuilder = GetSignaturesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSignaturesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSignaturesResponse(
                            Utils.unmarshal(response, new TypeReference<SignaturesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSignaturesRequest, com.cvent.models.operations.async.GetSignaturesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSignaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSignaturesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSignaturesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSignaturesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSignaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSignaturesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSignaturesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SignaturesResponse>() {})
                            .thenApply(res::withSignaturesResponse);
                } else {
