...
public class GetSignatures {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSignaturesRequest, GetSignaturesResponse> {
        ...
        public GetSignaturesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSignaturesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSignaturesResponse(Utils.unmarshal(response, new TypeReference<SignaturesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSignaturesRequest, com.cvent.models.operations.async.GetSignaturesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSignaturesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSignaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSignaturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
