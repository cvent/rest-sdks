...
public class GetTravelProgram {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/travel-programs/{programId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTravelProgramRequest, GetTravelProgramResponse> {
        ...
        private HttpRequest onBuildRequest(GetTravelProgramRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelProgramRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTravelProgramRequest request) {
        ...
        @Override
        public GetTravelProgramResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTravelProgramResponse.Builder resBuilder = GetTravelProgramResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTravelProgramResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProgram(Utils.unmarshal(response, new TypeReference<TravelProgram>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetTravelProgramRequest, com.cvent.models.operations.async.GetTravelProgramResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTravelProgramRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelProgramRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTravelProgramRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTravelProgramResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTravelProgramResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTravelProgramResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTravelProgramResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelProgram>() {})
                            .thenApply(res::withTravelProgram);
                } else {
