...
public class ListCustomFields {
    ...
    public static class Sync extends Base
        ...
        public ListCustomFieldsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListCustomFieldsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomFieldsPaginatedResponse(Utils.unmarshal(response, new TypeReference<CustomFieldsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListCustomFieldsRequest, com.cvent.models.operations.async.ListCustomFieldsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListCustomFieldsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListCustomFieldsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListCustomFieldsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
