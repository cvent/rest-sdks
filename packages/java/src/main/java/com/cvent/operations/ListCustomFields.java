...
public class ListCustomFields {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListCustomFieldsRequest, ListCustomFieldsResponse> {
        ...
        private HttpRequest onBuildRequest(ListCustomFieldsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCustomFieldsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListCustomFieldsRequest request) {
        ...
        @Override
        public ListCustomFieldsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListCustomFieldsResponse.Builder resBuilder = ListCustomFieldsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListCustomFieldsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCustomFieldsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<CustomFieldsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListCustomFieldsRequest, com.cvent.models.operations.async.ListCustomFieldsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListCustomFieldsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListCustomFieldsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListCustomFieldsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListCustomFieldsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListCustomFieldsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListCustomFieldsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListCustomFieldsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CustomFieldsPaginatedResponse>() {})
                            .thenApply(res::withCustomFieldsPaginatedResponse);
                } else {
