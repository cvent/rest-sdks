...
public class CancelReservation {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "cancelReservation",
                    java.util.Optional.of(java.util.List.of("housing/reservations:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<CancelReservationRequest, CancelReservationResponse> {
        ...
        private HttpRequest onBuildRequest(CancelReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelReservationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelReservationRequest request) {
        ...
        @Override
        public CancelReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CancelReservationResponse.Builder resBuilder = CancelReservationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CancelReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CancelReservationRequest, com.cvent.models.operations.async.CancelReservationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelReservationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelReservationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CancelReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CancelReservationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CancelReservationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CancelReservationResponse res = resBuilder.build();
