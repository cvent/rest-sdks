...
import com.cvent.models.components.OrderDetail;
...
public class GetAccountOrderById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/orders/{orderId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountOrderByIdRequest, GetAccountOrderByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountOrderByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrderByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountOrderByIdRequest request) {
        ...
        @Override
        public GetAccountOrderByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountOrderByIdResponse.Builder resBuilder = GetAccountOrderByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountOrderByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderDetail(Utils.unmarshal(response, new TypeReference<OrderDetail>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountOrderByIdRequest, com.cvent.models.operations.async.GetAccountOrderByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountOrderByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrderByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountOrderByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountOrderByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountOrderByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountOrderByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountOrderByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<OrderDetail>() {})
                            .thenApply(res::withOrderDetail);
                } else {
