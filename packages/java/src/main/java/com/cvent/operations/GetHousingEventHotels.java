...
public class GetHousingEventHotels {
    ...
    public static class Sync extends Base
        ...
        public GetHousingEventHotelsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHousingEventHotelsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEventHotelsList(Utils.unmarshal(response, new TypeReference<HousingEventHotelsList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHousingEventHotelsRequest, com.cvent.models.operations.async.GetHousingEventHotelsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventHotelsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetHousingEventHotelsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventHotelsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
