...
public class GetHousingEventHotels {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/housing-event-hotels:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/housing-events/{housingEventId}/hotels", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingEventHotelsRequest, GetHousingEventHotelsResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingEventHotelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventHotelsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingEventHotelsRequest request) {
        ...
        @Override
        public GetHousingEventHotelsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingEventHotelsResponse.Builder resBuilder = GetHousingEventHotelsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingEventHotelsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEventHotelsList(
                            Utils.unmarshal(response, new TypeReference<HousingEventHotelsList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetHousingEventHotelsRequest, com.cvent.models.operations.async.GetHousingEventHotelsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventHotelsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventHotelsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingEventHotelsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventHotelsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingEventHotelsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventHotelsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingEventHotelsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HousingEventHotelsList>() {})
                            .thenApply(res::withHousingEventHotelsList);
                } else {
