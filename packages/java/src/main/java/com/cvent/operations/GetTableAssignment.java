...
public class GetTableAssignment {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/seatings/{seatingId}/assignments", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTableAssignmentRequest, GetTableAssignmentResponse> {
        ...
        private HttpRequest onBuildRequest(GetTableAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTableAssignmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTableAssignmentRequest request) {
        ...
        @Override
        public GetTableAssignmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTableAssignmentResponse.Builder resBuilder = GetTableAssignmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTableAssignmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetTableAssignmentRequest, com.cvent.models.operations.async.GetTableAssignmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTableAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTableAssignmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTableAssignmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTableAssignmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTableAssignmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTableAssignmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTableAssignmentResponse res = resBuilder.build();
