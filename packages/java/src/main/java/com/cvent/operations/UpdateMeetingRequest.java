...
public class UpdateMeetingRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMeetingRequestRequest, UpdateMeetingRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateMeetingRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMeetingRequestRequest.class, new TypeReference<UpdateMeetingRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMeetingRequestRequest request) {
        ...
        @Override
        public UpdateMeetingRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateMeetingRequestResponse.Builder resBuilder =
            ...
            UpdateMeetingRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateMeetingRequestRequest, com.cvent.models.operations.async.UpdateMeetingRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMeetingRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateMeetingRequestRequest.class, new TypeReference<UpdateMeetingRequestRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMeetingRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateMeetingRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateMeetingRequestResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateMeetingRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateMeetingRequestResponse res = resBuilder.build();
