...
public class ListEventWeblinks {
    ...
    public static class Sync extends Base
        ...
        public ListEventWeblinksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListEventWeblinksResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventWeblinksPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventWeblinksPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEventWeblinksRequest, com.cvent.models.operations.async.ListEventWeblinksResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListEventWeblinksResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListEventWeblinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventWeblinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
