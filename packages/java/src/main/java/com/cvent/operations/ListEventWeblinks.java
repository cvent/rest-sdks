...
public class ListEventWeblinks {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listEventWeblinks",
                    java.util.Optional.of(java.util.List.of("event/weblinks:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/weblinks", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventWeblinksRequest, ListEventWeblinksResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventWeblinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventWeblinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventWeblinksRequest request) {
        ...
        @Override
        public ListEventWeblinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventWeblinksResponse.Builder resBuilder = ListEventWeblinksResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventWeblinksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventWeblinksPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventWeblinksPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListEventWeblinksRequest, com.cvent.models.operations.async.ListEventWeblinksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventWeblinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventWeblinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventWeblinksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventWeblinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventWeblinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventWeblinksResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventWeblinksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventWeblinksPaginatedResponse>() {})
                            .thenApply(res::withEventWeblinksPaginatedResponse);
                } else {
