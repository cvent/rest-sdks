...
public class GetHotelRequests {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/event-travel/hotel-requests", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHotelRequestsRequest, GetHotelRequestsResponse> {
        ...
        private HttpRequest onBuildRequest(GetHotelRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHotelRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHotelRequestsRequest request) {
        ...
        @Override
        public GetHotelRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHotelRequestsResponse.Builder resBuilder = GetHotelRequestsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHotelRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHotelReservationDetail(
                            Utils.unmarshal(response, new TypeReference<HotelReservationDetail2>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetHotelRequestsRequest, com.cvent.models.operations.async.GetHotelRequestsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHotelRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHotelRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHotelRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHotelRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHotelRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHotelRequestsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHotelRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HotelReservationDetail2>() {})
                            .thenApply(res::withHotelReservationDetail);
                } else {
