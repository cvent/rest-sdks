...
public class GetHotelRequests {
    ...
    public static class Sync extends Base
        ...
        public GetHotelRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHotelRequestsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHotelReservationDetail(Utils.unmarshal(response, new TypeReference<HotelReservationDetail>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHotelRequestsRequest, com.cvent.models.operations.async.GetHotelRequestsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetHotelRequestsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetHotelRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHotelRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
