...
public class GetLeadQualificationQuestions {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/lead-qualification-questions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/questions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLeadQualificationQuestionsRequest, GetLeadQualificationQuestionsResponse> {
        ...
        private HttpRequest onBuildRequest(GetLeadQualificationQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLeadQualificationQuestionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLeadQualificationQuestionsRequest request) {
        ...
        @Override
        public GetLeadQualificationQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetLeadQualificationQuestionsResponse.Builder resBuilder = GetLeadQualificationQuestionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetLeadQualificationQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLeadQualificationQuestionsListResponse(
                            Utils.unmarshal(response, new TypeReference<LeadQualificationQuestionsListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLeadQualificationQuestionsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetLeadQualificationQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLeadQualificationQuestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LeadQualificationQuestionsListResponse>() {})
                            .thenApply(res::withLeadQualificationQuestionsListResponse);
                } else {
