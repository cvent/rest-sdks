...
public class GetLeadQualificationQuestions {
    ...
    public static class Sync extends Base
        ...
        public GetLeadQualificationQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetLeadQualificationQuestionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLeadQualificationQuestionsListResponse(Utils.unmarshal(response, new TypeReference<LeadQualificationQuestionsListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLeadQualificationQuestionsRequest, com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLeadQualificationQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLeadQualificationQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetLeadQualificationQuestionsResponse> handleResponse(
