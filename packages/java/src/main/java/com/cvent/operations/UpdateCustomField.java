...
public class UpdateCustomField {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateCustomFieldRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCustomFieldRequest.class, new TypeReference<UpdateCustomFieldRequest>() {});
        ...
        public UpdateCustomFieldResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateCustomFieldResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingCustomField(Utils.unmarshal(response, new TypeReference<ExistingCustomField>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCustomFieldRequest, com.cvent.models.operations.async.UpdateCustomFieldResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateCustomFieldResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateCustomFieldResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateCustomFieldResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
