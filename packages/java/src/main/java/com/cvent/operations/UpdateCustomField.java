...
public class UpdateCustomField {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingCustomField", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCustomFieldRequest, UpdateCustomFieldResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateCustomFieldRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateCustomFieldRequest.class, new TypeReference<UpdateCustomFieldRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCustomFieldRequest request) {
        ...
        @Override
        public UpdateCustomFieldResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateCustomFieldResponse.Builder resBuilder = UpdateCustomFieldResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateCustomFieldResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateCustomFieldRequest, com.cvent.models.operations.async.UpdateCustomFieldResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCustomFieldRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateCustomFieldRequest.class, new TypeReference<UpdateCustomFieldRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCustomFieldRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateCustomFieldResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateCustomFieldResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateCustomFieldResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateCustomFieldResponse res = resBuilder.build();
