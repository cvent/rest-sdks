...
public class RelateProgramItemToSessionDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<RelateProgramItemToSessionDocumentRequest, RelateProgramItemToSessionDocumentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RelateProgramItemToSessionDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RelateProgramItemToSessionDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RelateProgramItemToSessionDocumentRequest request) {
        ...
        @Override
        public RelateProgramItemToSessionDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RelateProgramItemToSessionDocumentResponse.Builder resBuilder =
            ...
            RelateProgramItemToSessionDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RelateProgramItemToSessionDocumentRequest, com.cvent.models.operations.async.RelateProgramItemToSessionDocumentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RelateProgramItemToSessionDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RelateProgramItemToSessionDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RelateProgramItemToSessionDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.RelateProgramItemToSessionDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.RelateProgramItemToSessionDocumentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.RelateProgramItemToSessionDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.RelateProgramItemToSessionDocumentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProgramItemSessionDocument>() {})
                            .thenApply(res::withProgramItemSessionDocument);
                } else {
