...
public class GetMeetingInterestById {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("appointments/appointment-attendees:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/appointment-meeting-interests/{id}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMeetingInterestByIdRequest, GetMeetingInterestByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetMeetingInterestByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMeetingInterestByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMeetingInterestByIdRequest request) {
        ...
        @Override
        public GetMeetingInterestByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetMeetingInterestByIdResponse.Builder resBuilder = GetMeetingInterestByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetMeetingInterestByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAppointmentMeetingInterest(
                            Utils.unmarshal(response, new TypeReference<AttendeeAppointmentMeetingInterest>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "429", "4XX")) {
                // no content
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetMeetingInterestByIdRequest, com.cvent.models.operations.async.GetMeetingInterestByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMeetingInterestByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMeetingInterestByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMeetingInterestByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetMeetingInterestByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetMeetingInterestByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetMeetingInterestByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetMeetingInterestByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeAppointmentMeetingInterest>() {})
                            .thenApply(res::withAttendeeAppointmentMeetingInterest);
                } else {
