...
public class GetMeetingInterestById {
    ...
    public static class Sync extends Base
        ...
        public GetMeetingInterestByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetMeetingInterestByIdResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAppointmentMeetingInterest(Utils.unmarshal(response, new TypeReference<AttendeeAppointmentMeetingInterest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMeetingInterestByIdRequest, com.cvent.models.operations.async.GetMeetingInterestByIdResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetMeetingInterestByIdResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetMeetingInterestByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetMeetingInterestByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
