...
public class ListEventEmails {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventEmailsRequest, ListEventEmailsResponse> {
        ...
        public ListEventEmailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListEventEmailsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventEmailsPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventEmailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEventEmailsRequest, com.cvent.models.operations.async.ListEventEmailsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListEventEmailsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListEventEmailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventEmailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
