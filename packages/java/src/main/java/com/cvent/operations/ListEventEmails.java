...
import com.cvent.models.components.EventEmailsPaginatedResponse;
...
public class ListEventEmails {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listEventEmails",
                    java.util.Optional.of(java.util.List.of("event/event-emails:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/emails", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListEventEmailsRequest, ListEventEmailsResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventEmailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventEmailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventEmailsRequest request) {
        ...
        @Override
        public ListEventEmailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventEmailsResponse.Builder resBuilder = ListEventEmailsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventEmailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventEmailsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventEmailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListEventEmailsRequest, com.cvent.models.operations.async.ListEventEmailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventEmailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventEmailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventEmailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventEmailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventEmailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventEmailsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventEmailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventEmailsPaginatedResponse>() {})
                            .thenApply(res::withEventEmailsPaginatedResponse);
                } else {
