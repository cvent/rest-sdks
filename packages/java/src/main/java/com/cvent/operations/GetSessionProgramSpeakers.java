...
public class GetSessionProgramSpeakers {
    ...
    public static class Sync extends Base
        ...
        public GetSessionProgramSpeakersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSessionProgramSpeakersResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionProgramSpeakersRequest, com.cvent.models.operations.async.GetSessionProgramSpeakersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionProgramSpeakersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionProgramSpeakersRequest.class);
