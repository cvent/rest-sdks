...
public class GetSessionProgramSpeakers {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/program-items/speakers");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionProgramSpeakersRequest, GetSessionProgramSpeakersResponse> {
        ...
        private HttpRequest onBuildRequest(GetSessionProgramSpeakersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionProgramSpeakersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionProgramSpeakersRequest request) {
        ...
        @Override
        public GetSessionProgramSpeakersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSessionProgramSpeakersResponse.Builder resBuilder = GetSessionProgramSpeakersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSessionProgramSpeakersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetSessionProgramSpeakersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionProgramSpeakersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetSessionProgramSpeakersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionProgramSpeakersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSessionProgramSpeakersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSessionProgramSpeakersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionProgramSpeakersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSessionProgramSpeakersResponse res = resBuilder.build();
