...
public class GetEventSurveyQuestions {
    ...
    public static class Sync extends Base
        ...
        public GetEventSurveyQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventSurveyQuestionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveyQuestionsPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventSurveyQuestionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventSurveyQuestionsRequest, com.cvent.models.operations.async.GetEventSurveyQuestionsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventSurveyQuestionsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventSurveyQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventSurveyQuestionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
