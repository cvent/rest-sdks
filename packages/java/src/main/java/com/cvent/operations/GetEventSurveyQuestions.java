...
public class GetEventSurveyQuestions {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("survey/survey-questions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/surveys/{surveyId}/questions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventSurveyQuestionsRequest, GetEventSurveyQuestionsResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventSurveyQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyQuestionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventSurveyQuestionsRequest request) {
        ...
        @Override
        public GetEventSurveyQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventSurveyQuestionsResponse.Builder resBuilder = GetEventSurveyQuestionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventSurveyQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveyQuestionsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventSurveyQuestionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventSurveyQuestionsRequest, com.cvent.models.operations.async.GetEventSurveyQuestionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventSurveyQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventSurveyQuestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventSurveyQuestionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventSurveyQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventSurveyQuestionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventSurveyQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventSurveyQuestionsPaginatedResponse>() {})
                            .thenApply(res::withEventSurveyQuestionsPaginatedResponse);
                } else {
