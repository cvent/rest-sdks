...
public class ListSessionsEnrollmentPostFilter {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/session-enrollment:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSessionsEnrollmentPostFilterRequest, ListSessionsEnrollmentPostFilterResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSessionsEnrollmentPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionsEnrollmentPostFilterRequest.class, new TypeReference<ListSessionsEnrollmentPostFilterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSessionsEnrollmentPostFilterRequest request) {
        ...
        @Override
        public ListSessionsEnrollmentPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSessionsEnrollmentPostFilterResponse.Builder resBuilder =
            ...
            ListSessionsEnrollmentPostFilterResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionsEnrollmentPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionsEnrollmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSessionsEnrollmentPostFilterRequest, com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionsEnrollmentPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionsEnrollmentPostFilterRequest.class, new TypeReference<ListSessionsEnrollmentPostFilterRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSessionsEnrollmentPostFilterRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionsEnrollmentPaginatedResponse>() {})
                            .thenApply(res::withSessionsEnrollmentPaginatedResponse);
                } else {
