...
public class ListSessionsEnrollmentPostFilter {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/sessions/enrollment/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<
                    ListSessionsEnrollmentPostFilterRequest, ListSessionsEnrollmentPostFilterResponse> {
        ...
        private HttpRequest onBuildRequest(ListSessionsEnrollmentPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<ListSessionsEnrollmentPostFilterRequest>() {});
        ...
        public ListSessionsEnrollmentPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSessionsEnrollmentPostFilterResponse.Builder resBuilder =
                    ListSessionsEnrollmentPostFilterResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionsEnrollmentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionsEnrollmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionsEnrollmentPostFilterRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListSessionsEnrollmentPostFilterRequest.class,
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse>
            ...
            com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionsEnrollmentPostFilterResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
