...
import com.cvent.models.components.DonationItemsPaginatedResponse;
...
public class ListDonationItemsPostFilter {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/donation-items:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/donation-items/filter", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDonationItemsPostFilterRequest, ListDonationItemsPostFilterResponse> {
        ...
        private HttpRequest onBuildRequest(ListDonationItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListDonationItemsPostFilterRequest.class,
                    new TypeReference<ListDonationItemsPostFilterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDonationItemsPostFilterRequest request) {
        ...
        @Override
        public ListDonationItemsPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListDonationItemsPostFilterResponse.Builder resBuilder = ListDonationItemsPostFilterResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListDonationItemsPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDonationItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<DonationItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListDonationItemsPostFilterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDonationItemsPostFilterRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListDonationItemsPostFilterRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDonationItemsPostFilterRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListDonationItemsPostFilterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListDonationItemsPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListDonationItemsPostFilterResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListDonationItemsPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DonationItemsPaginatedResponse>() {})
                            .thenApply(res::withDonationItemsPaginatedResponse);
                } else {
