...
public class ListDonationItemsPostFilter {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListDonationItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDonationItemsPostFilterRequest.class, new TypeReference<ListDonationItemsPostFilterRequest>() {});
        ...
        public ListDonationItemsPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListDonationItemsPostFilterResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDonationItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<DonationItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDonationItemsPostFilterRequest, com.cvent.models.operations.async.ListDonationItemsPostFilterResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDonationItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDonationItemsPostFilterRequest.class, new TypeReference<ListDonationItemsPostFilterRequest>() {});
