...
public class CreateAttendeeActivity {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/attendee-activities:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<ExternalActivityInput, CreateAttendeeActivityResponse> {
        ...
        private HttpRequest onBuildRequest(ExternalActivityInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ExternalActivityInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExternalActivityInput request) {
        ...
        @Override
        public CreateAttendeeActivityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateAttendeeActivityResponse.Builder resBuilder = CreateAttendeeActivityResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateAttendeeActivityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExternalActivity(
                            Utils.unmarshal(response, new TypeReference<ExternalActivity>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ExternalActivityInput, com.cvent.models.operations.async.CreateAttendeeActivityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ExternalActivityInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ExternalActivityInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ExternalActivityInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateAttendeeActivityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateAttendeeActivityResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateAttendeeActivityResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateAttendeeActivityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExternalActivity>() {})
                            .thenApply(res::withExternalActivity);
                } else {
