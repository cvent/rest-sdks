...
public class DeleteExhibitorLogo {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteExhibitorLogoRequest, DeleteExhibitorLogoResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteExhibitorLogoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorLogoRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteExhibitorLogoRequest request) {
        ...
        @Override
        public DeleteExhibitorLogoResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteExhibitorLogoResponse.Builder resBuilder = DeleteExhibitorLogoResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteExhibitorLogoResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteExhibitorLogoRequest, com.cvent.models.operations.async.DeleteExhibitorLogoResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteExhibitorLogoRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorLogoRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteExhibitorLogoRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteExhibitorLogoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteExhibitorLogoResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteExhibitorLogoResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteExhibitorLogoResponse res = resBuilder.build();
