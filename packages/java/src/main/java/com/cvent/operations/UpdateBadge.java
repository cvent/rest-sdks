...
public class UpdateBadge {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/badges/{badgeId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<UpdateBadgeRequest, UpdateBadgeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateBadgeRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateBadgeRequest.class, new TypeReference<UpdateBadgeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateBadgeRequest request) {
        ...
        @Override
        public UpdateBadgeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateBadgeResponse.Builder resBuilder = UpdateBadgeResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateBadgeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateBadgeRequest, com.cvent.models.operations.async.UpdateBadgeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateBadgeRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateBadgeRequest.class, new TypeReference<UpdateBadgeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateBadgeRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateBadgeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateBadgeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateBadgeResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateBadgeResponse res = resBuilder.build();
