...
public class GetAirActualDetail {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getAirActualDetail",
                    java.util.Optional.of(java.util.List.of("event/air-request:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/event-travel/air-actuals", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAirActualDetailRequest, GetAirActualDetailResponse> {
        ...
        private HttpRequest onBuildRequest(GetAirActualDetailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAirActualDetailRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAirActualDetailRequest request) {
        ...
        @Override
        public GetAirActualDetailResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAirActualDetailResponse.Builder resBuilder = GetAirActualDetailResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAirActualDetailResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAirActualDetail(Utils.unmarshal(response, new TypeReference<AirActualDetail2>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAirActualDetailRequest, com.cvent.models.operations.async.GetAirActualDetailResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAirActualDetailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAirActualDetailRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAirActualDetailRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAirActualDetailResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAirActualDetailResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAirActualDetailResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAirActualDetailResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AirActualDetail2>() {})
                            .thenApply(res::withAirActualDetail);
                } else {
