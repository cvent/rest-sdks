...
public class GetBudgetItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBudgetItemsRequest, GetBudgetItemsResponse> {
        ...
        public GetBudgetItemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetBudgetItemsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<BudgetItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBudgetItemsRequest, com.cvent.models.operations.async.GetBudgetItemsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetBudgetItemsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetBudgetItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBudgetItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
