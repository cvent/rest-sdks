...
public class GetBudgetItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/budget-items", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetBudgetItemsRequest, GetBudgetItemsResponse> {
        ...
        private HttpRequest onBuildRequest(GetBudgetItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBudgetItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBudgetItemsRequest request) {
        ...
        @Override
        public GetBudgetItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBudgetItemsResponse.Builder resBuilder = GetBudgetItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBudgetItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BudgetItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBudgetItemsRequest, com.cvent.models.operations.async.GetBudgetItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBudgetItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBudgetItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBudgetItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBudgetItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBudgetItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBudgetItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBudgetItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BudgetItemsPaginatedResponse>() {})
                            .thenApply(res::withBudgetItemsPaginatedResponse);
                } else {
