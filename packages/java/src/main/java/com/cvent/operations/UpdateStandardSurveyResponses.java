...
public class UpdateStandardSurveyResponses {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("survey/standard-survey-responses:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateStandardSurveyResponsesRequest, UpdateStandardSurveyResponsesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStandardSurveyResponsesRequest.class, new TypeReference<UpdateStandardSurveyResponsesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateStandardSurveyResponsesRequest request) {
        ...
        @Override
        public UpdateStandardSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateStandardSurveyResponsesResponse.Builder resBuilder =
            ...
            UpdateStandardSurveyResponsesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveyResponse(Utils.unmarshal(response, new TypeReference<StandardSurveyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateStandardSurveyResponsesRequest, com.cvent.models.operations.async.UpdateStandardSurveyResponsesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateStandardSurveyResponsesRequest.class, new TypeReference<UpdateStandardSurveyResponsesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateStandardSurveyResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateStandardSurveyResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateStandardSurveyResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateStandardSurveyResponsesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateStandardSurveyResponsesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StandardSurveyResponse>() {})
                            .thenApply(res::withStandardSurveyResponse);
                } else {
