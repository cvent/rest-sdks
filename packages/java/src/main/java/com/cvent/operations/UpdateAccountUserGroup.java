...
public class UpdateAccountUserGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAccountUserGroupRequest, UpdateAccountUserGroupResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAccountUserGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountUserGroupRequest.class, new TypeReference<UpdateAccountUserGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAccountUserGroupRequest request) {
        ...
        @Override
        public UpdateAccountUserGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAccountUserGroupResponse.Builder resBuilder =
            ...
            UpdateAccountUserGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAccountUserGroupRequest, com.cvent.models.operations.async.UpdateAccountUserGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAccountUserGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAccountUserGroupRequest.class, new TypeReference<UpdateAccountUserGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAccountUserGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateAccountUserGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateAccountUserGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateAccountUserGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateAccountUserGroupResponse res = resBuilder.build();
