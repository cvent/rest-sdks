...
public class CreateExhibitorCategory {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-categories:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/exhibitor-categories", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "exhibitorCategoryRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateExhibitorCategoryRequest, CreateExhibitorCategoryResponse> {
        ...
        private HttpRequest onBuildRequest(CreateExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateExhibitorCategoryRequest.class,
                    new TypeReference<CreateExhibitorCategoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateExhibitorCategoryRequest request) {
        ...
        @Override
        public CreateExhibitorCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateExhibitorCategoryResponse.Builder resBuilder = CreateExhibitorCategoryResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateExhibitorCategoryResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoryResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateExhibitorCategoryRequest, com.cvent.models.operations.async.CreateExhibitorCategoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateExhibitorCategoryRequest.class,
                    new TypeReference<CreateExhibitorCategoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateExhibitorCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateExhibitorCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateExhibitorCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateExhibitorCategoryResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateExhibitorCategoryResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorCategoryResponse>() {})
                            .thenApply(res::withExhibitorCategoryResponse);
                } else {
