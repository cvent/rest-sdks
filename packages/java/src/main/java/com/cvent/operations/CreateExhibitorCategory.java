...
public class CreateExhibitorCategory {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateExhibitorCategoryRequest.class, new TypeReference<CreateExhibitorCategoryRequest>() {});
        ...
        public CreateExhibitorCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateExhibitorCategoryResponse.Builder resBuilder =
                    CreateExhibitorCategoryResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoryResponse(Utils.unmarshal(response, new TypeReference<ExhibitorCategoryResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateExhibitorCategoryRequest, com.cvent.models.operations.async.CreateExhibitorCategoryResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.CreateExhibitorCategoryResponse> handleResponse(
            ...
            com.cvent.models.operations.async.CreateExhibitorCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateExhibitorCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
