...
public class ListAttendeesPostFilter {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListAttendeesPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeesPostFilterRequest.class, new TypeReference<ListAttendeesPostFilterRequest>() {});
        ...
        public ListAttendeesPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAttendeesPostFilterResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeePaginatedResponse(Utils.unmarshal(response, new TypeReference<AttendeePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAttendeesPostFilterRequest, com.cvent.models.operations.async.ListAttendeesPostFilterResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAttendeesPostFilterResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAttendeesPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAttendeesPostFilterResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
