...
public class DeleteExhibitorWeblink {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteExhibitorWeblinkRequest, DeleteExhibitorWeblinkResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteExhibitorWeblinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorWeblinkRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteExhibitorWeblinkRequest request) {
        ...
        @Override
        public DeleteExhibitorWeblinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteExhibitorWeblinkResponse.Builder resBuilder = DeleteExhibitorWeblinkResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteExhibitorWeblinkResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteExhibitorWeblinkRequest, com.cvent.models.operations.async.DeleteExhibitorWeblinkResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteExhibitorWeblinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorWeblinkRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteExhibitorWeblinkRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteExhibitorWeblinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteExhibitorWeblinkResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteExhibitorWeblinkResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteExhibitorWeblinkResponse res = resBuilder.build();
