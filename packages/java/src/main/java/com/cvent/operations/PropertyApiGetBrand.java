...
import com.cvent.models.components.Brand;
...
public class PropertyApiGetBrand {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/travel-suppliers/brands/{brandId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<PropertyApiGetBrandRequest, PropertyApiGetBrandResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PropertyApiGetBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiGetBrandRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PropertyApiGetBrandRequest request) {
        ...
        @Override
        public PropertyApiGetBrandResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PropertyApiGetBrandResponse.Builder resBuilder = PropertyApiGetBrandResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PropertyApiGetBrandResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBrand(Utils.unmarshal(response, new TypeReference<Brand>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PropertyApiGetBrandRequest, com.cvent.models.operations.async.PropertyApiGetBrandResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiGetBrandRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiGetBrandRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PropertyApiGetBrandRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiGetBrandResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PropertyApiGetBrandResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiGetBrandResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PropertyApiGetBrandResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Brand>() {})
                            .thenApply(res::withBrand);
                } else {
