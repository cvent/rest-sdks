...
public class ListAvailability {
    ...
    public static class Sync extends Base
        ...
        public ListAvailabilityResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAvailabilityResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentAvailabilityPaginatedResponse(Utils.unmarshal(response, new TypeReference<AppointmentAvailabilityPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAvailabilityRequest, com.cvent.models.operations.async.ListAvailabilityResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAvailabilityResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAvailabilityResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAvailabilityResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
