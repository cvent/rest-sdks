...
public class ListAvailability {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/appointment-availability-times");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAvailabilityRequest, ListAvailabilityResponse> {
        ...
        private HttpRequest onBuildRequest(ListAvailabilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAvailabilityRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAvailabilityRequest request) {
        ...
        @Override
        public ListAvailabilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAvailabilityResponse.Builder resBuilder = ListAvailabilityResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAvailabilityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentAvailabilityPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<AppointmentAvailabilityPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAvailabilityRequest, com.cvent.models.operations.async.ListAvailabilityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAvailabilityRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAvailabilityRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAvailabilityRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAvailabilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAvailabilityResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAvailabilityResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAvailabilityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AppointmentAvailabilityPaginatedResponse>() {})
                            .thenApply(res::withAppointmentAvailabilityPaginatedResponse);
                } else {
