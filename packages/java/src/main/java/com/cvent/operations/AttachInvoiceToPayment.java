...
public class AttachInvoiceToPayment {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/payments:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<AttachInvoiceToPaymentRequest, AttachInvoiceToPaymentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AttachInvoiceToPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AttachInvoiceToPaymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AttachInvoiceToPaymentRequest request) {
        ...
        @Override
        public AttachInvoiceToPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AttachInvoiceToPaymentResponse.Builder resBuilder =
                    AttachInvoiceToPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AttachInvoiceToPaymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvoiceFile(Utils.unmarshal(response, new TypeReference<InvoiceFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AttachInvoiceToPaymentRequest, com.cvent.models.operations.async.AttachInvoiceToPaymentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AttachInvoiceToPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AttachInvoiceToPaymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AttachInvoiceToPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AttachInvoiceToPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.AttachInvoiceToPaymentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AttachInvoiceToPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AttachInvoiceToPaymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InvoiceFile>() {})
                            .thenApply(res::withInvoiceFile);
                } else {
