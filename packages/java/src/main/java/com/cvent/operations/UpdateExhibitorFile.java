...
public class UpdateExhibitorFile {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/files/{fileId}", request, null);
            ...
            SerializedBody serializedRequestBody = Utils.serializeRequestBody(convertedRequest, "file", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorFileRequest, UpdateExhibitorFileResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateExhibitorFileRequest.class, new TypeReference<UpdateExhibitorFileRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorFileRequest request) {
        ...
        @Override
        public UpdateExhibitorFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateExhibitorFileResponse.Builder resBuilder = UpdateExhibitorFileResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateExhibitorFileResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingFile(Utils.unmarshal(response, new TypeReference<ExistingFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateExhibitorFileRequest, com.cvent.models.operations.async.UpdateExhibitorFileResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateExhibitorFileRequest.class, new TypeReference<UpdateExhibitorFileRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorFileResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorFileResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorFileResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingFile>() {})
                            .thenApply(res::withExistingFile);
                } else {
