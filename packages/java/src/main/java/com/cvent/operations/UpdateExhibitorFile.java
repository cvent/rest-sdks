...
public class UpdateExhibitorFile {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/events/{id}/exhibitors/{exhibitorId}/files/{fileId}",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorFileRequest.class, new TypeReference<UpdateExhibitorFileRequest>() {});
        ...
        public UpdateExhibitorFileResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateExhibitorFileResponse.Builder resBuilder =
                    UpdateExhibitorFileResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateExhibitorFileRequest, com.cvent.models.operations.async.UpdateExhibitorFileResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorFileResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateExhibitorFileResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorFileResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
