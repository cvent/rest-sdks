...
public class UpdateAppointment {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAppointmentRequest, UpdateAppointmentResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAppointmentRequest request) {
