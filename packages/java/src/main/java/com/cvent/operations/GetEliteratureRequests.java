...
public class GetEliteratureRequests {
    ...
    public static class Sync extends Base
        ...
        public GetEliteratureRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEliteratureRequestsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEliteratureRequestPaginatedResponse(Utils.unmarshal(response, new TypeReference<EliteratureRequestPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEliteratureRequestsRequest, com.cvent.models.operations.async.GetEliteratureRequestsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEliteratureRequestsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEliteratureRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEliteratureRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
