...
import com.cvent.models.components.EliteratureRequestPaginatedResponse;
...
public class GetEliteratureRequests {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/eliterature-requests:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/eliterature-requests");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEliteratureRequestsRequest, GetEliteratureRequestsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetEliteratureRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEliteratureRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEliteratureRequestsRequest request) {
        ...
        @Override
        public GetEliteratureRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEliteratureRequestsResponse.Builder resBuilder = GetEliteratureRequestsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEliteratureRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEliteratureRequestPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EliteratureRequestPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEliteratureRequestsRequest, com.cvent.models.operations.async.GetEliteratureRequestsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetEliteratureRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEliteratureRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEliteratureRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEliteratureRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEliteratureRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEliteratureRequestsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEliteratureRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EliteratureRequestPaginatedResponse>() {})
                            .thenApply(res::withEliteratureRequestPaginatedResponse);
                } else {
