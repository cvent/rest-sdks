...
public class PropertyApiGetProperty {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/travel-suppliers/properties/{propertyId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<PropertyApiGetPropertyRequest, PropertyApiGetPropertyResponse> {
        ...
        private HttpRequest onBuildRequest(PropertyApiGetPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiGetPropertyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PropertyApiGetPropertyRequest request) {
        ...
        @Override
        public PropertyApiGetPropertyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PropertyApiGetPropertyResponse.Builder resBuilder = PropertyApiGetPropertyResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PropertyApiGetPropertyResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProperty(Utils.unmarshal(response, new TypeReference<Property>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PropertyApiGetPropertyRequest, com.cvent.models.operations.async.PropertyApiGetPropertyResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiGetPropertyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiGetPropertyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PropertyApiGetPropertyRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiGetPropertyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PropertyApiGetPropertyResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiGetPropertyResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PropertyApiGetPropertyResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Property>() {})
                            .thenApply(res::withProperty);
                } else {
