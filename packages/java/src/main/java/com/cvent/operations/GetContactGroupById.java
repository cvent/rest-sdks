...
public class GetContactGroupById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetContactGroupByIdRequest, GetContactGroupByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetContactGroupByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContactGroupByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetContactGroupByIdRequest request) {
        ...
        @Override
        public GetContactGroupByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetContactGroupByIdResponse.Builder resBuilder = GetContactGroupByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetContactGroupByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetContactGroupByIdRequest, com.cvent.models.operations.async.GetContactGroupByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetContactGroupByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetContactGroupByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetContactGroupByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetContactGroupByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetContactGroupByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetContactGroupByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetContactGroupByIdResponse res = resBuilder.build();
