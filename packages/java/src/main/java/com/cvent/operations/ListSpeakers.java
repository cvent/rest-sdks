...
public class ListSpeakers {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/speakers");
    ...
    public static class Sync extends Base implements RequestOperation<ListSpeakersRequest, ListSpeakersResponse> {
        ...
        private HttpRequest onBuildRequest(ListSpeakersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSpeakersRequest request) {
        ...
        @Override
        public ListSpeakersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSpeakersResponse.Builder resBuilder = ListSpeakersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSpeakersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSpeakersRequest, com.cvent.models.operations.async.ListSpeakersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSpeakersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSpeakersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSpeakersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSpeakersResponse res = resBuilder.build();
