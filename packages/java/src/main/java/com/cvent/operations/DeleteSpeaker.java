...
public class DeleteSpeaker {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "deleteSpeaker",
                    java.util.Optional.of(java.util.List.of("event/speakers:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<DeleteSpeakerRequest, DeleteSpeakerResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteSpeakerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSpeakerRequest request) {
        ...
        @Override
        public DeleteSpeakerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSpeakerResponse.Builder resBuilder = DeleteSpeakerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSpeakerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteSpeakerRequest, com.cvent.models.operations.async.DeleteSpeakerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSpeakerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSpeakerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSpeakerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSpeakerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSpeakerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSpeakerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSpeakerResponse res = resBuilder.build();
