...
public class GetEventSurveyRespondents {
    ...
    public static class Sync extends Base
        ...
        public GetEventSurveyRespondentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventSurveyRespondentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveyRespondentsPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventSurveyRespondentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventSurveyRespondentsRequest, com.cvent.models.operations.async.GetEventSurveyRespondentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetEventSurveyRespondentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyRespondentsRequest.class);
