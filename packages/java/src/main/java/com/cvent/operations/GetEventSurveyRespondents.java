...
public class GetEventSurveyRespondents {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("survey/survey-respondents:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventSurveyRespondentsRequest, GetEventSurveyRespondentsResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventSurveyRespondentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyRespondentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventSurveyRespondentsRequest request) {
        ...
        @Override
        public GetEventSurveyRespondentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventSurveyRespondentsResponse.Builder resBuilder = GetEventSurveyRespondentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventSurveyRespondentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveyRespondentsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventSurveyRespondentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetEventSurveyRespondentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventSurveyRespondentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyRespondentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventSurveyRespondentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventSurveyRespondentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventSurveyRespondentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventSurveyRespondentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventSurveyRespondentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventSurveyRespondentsPaginatedResponse>() {})
                            .thenApply(res::withEventSurveyRespondentsPaginatedResponse);
                } else {
