...
public class CreateWebcast {
    ...
    public static class Sync extends Base implements RequestOperation<Webcast, CreateWebcastResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(Webcast request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Webcast>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Webcast request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "409", "429", "4XX", "5XX")) {
        ...
        @Override
        public CreateWebcastResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateWebcastResponse.Builder resBuilder = CreateWebcastResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateWebcastResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<Webcast, com.cvent.models.operations.async.CreateWebcastResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(Webcast request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<Webcast>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(Webcast request) {
            return unchecked(() -> onBuildRequest(request))
                    ...
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "409", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateWebcastResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateWebcastResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateWebcastResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateWebcastResponse res = resBuilder.build();
