...
import com.cvent.models.components.PaginatedRfpSuppliers;
...
public class GetRfpSuppliers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getRfpSuppliers",
                    java.util.Optional.of(java.util.List.of("rfp/rfp-suppliers:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/suppliers", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetRfpSuppliersRequest, GetRfpSuppliersResponse> {
        ...
        private HttpRequest onBuildRequest(GetRfpSuppliersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpSuppliersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRfpSuppliersRequest request) {
        ...
        @Override
        public GetRfpSuppliersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRfpSuppliersResponse.Builder resBuilder = GetRfpSuppliersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRfpSuppliersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpSuppliers(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpSuppliers>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetRfpSuppliersRequest, com.cvent.models.operations.async.GetRfpSuppliersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRfpSuppliersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpSuppliersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRfpSuppliersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRfpSuppliersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRfpSuppliersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRfpSuppliersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRfpSuppliersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpSuppliers>() {})
                            .thenApply(res::withPaginatedRfpSuppliers);
                } else {
