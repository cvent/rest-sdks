...
public class UpdateExhibitorBanner {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/banner-files/{fileId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorBannerRequest, UpdateExhibitorBannerResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorBannerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorBannerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorBannerRequest request) {
        ...
        @Override
        public UpdateExhibitorBannerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateExhibitorBannerResponse.Builder resBuilder = UpdateExhibitorBannerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateExhibitorBannerResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorBannerLogoFile(
                            Utils.unmarshal(response, new TypeReference<ExhibitorBannerLogoFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateExhibitorBannerRequest, com.cvent.models.operations.async.UpdateExhibitorBannerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorBannerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorBannerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorBannerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorBannerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorBannerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorBannerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorBannerResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorBannerLogoFile>() {})
                            .thenApply(res::withExhibitorBannerLogoFile);
                } else {
