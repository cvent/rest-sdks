...
public class GetExhibitorAnswers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getExhibitorAnswers",
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-answers:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExhibitorAnswersRequest, GetExhibitorAnswersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetExhibitorAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorAnswersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExhibitorAnswersRequest request) {
        ...
        @Override
        public GetExhibitorAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetExhibitorAnswersResponse.Builder resBuilder = GetExhibitorAnswersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetExhibitorAnswersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetExhibitorAnswersRequest, com.cvent.models.operations.async.GetExhibitorAnswersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetExhibitorAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorAnswersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExhibitorAnswersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorAnswersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetExhibitorAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorAnswersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetExhibitorAnswersResponse res = resBuilder.build();
