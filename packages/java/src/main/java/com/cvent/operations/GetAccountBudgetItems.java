...
public class GetAccountBudgetItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/budget-items");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountBudgetItemsRequest, GetAccountBudgetItemsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountBudgetItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountBudgetItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountBudgetItemsRequest request) {
        ...
        @Override
        public GetAccountBudgetItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountBudgetItemsResponse.Builder resBuilder = GetAccountBudgetItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountBudgetItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountBudgetItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AccountBudgetItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountBudgetItemsRequest, com.cvent.models.operations.async.GetAccountBudgetItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountBudgetItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountBudgetItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountBudgetItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountBudgetItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountBudgetItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountBudgetItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountBudgetItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AccountBudgetItemsPaginatedResponse>() {})
                            .thenApply(res::withAccountBudgetItemsPaginatedResponse);
                } else {
