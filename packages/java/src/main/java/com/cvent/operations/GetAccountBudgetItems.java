...
public class GetAccountBudgetItems {
    ...
    public static class Sync extends Base
        ...
        public GetAccountBudgetItemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAccountBudgetItemsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAccountBudgetItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<AccountBudgetItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAccountBudgetItemsRequest, com.cvent.models.operations.async.GetAccountBudgetItemsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAccountBudgetItemsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAccountBudgetItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountBudgetItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
