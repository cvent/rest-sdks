...
import com.cvent.models.components.TravelAccountPaginatedResponse;
...
public class ListTravelAccounts {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-accounts");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTravelAccountsRequest, ListTravelAccountsResponse> {
        ...
        private HttpRequest onBuildRequest(ListTravelAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelAccountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTravelAccountsRequest request) {
        ...
        @Override
        public ListTravelAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTravelAccountsResponse.Builder resBuilder = ListTravelAccountsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTravelAccountsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccountPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TravelAccountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListTravelAccountsRequest, com.cvent.models.operations.async.ListTravelAccountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTravelAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelAccountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTravelAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTravelAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTravelAccountsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelAccountsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTravelAccountsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelAccountPaginatedResponse>() {})
                            .thenApply(res::withTravelAccountPaginatedResponse);
                } else {
