...
public class ListTravelAccounts {
    ...
    public static class Sync extends Base
        ...
        public ListTravelAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTravelAccountsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccountPaginatedResponse(Utils.unmarshal(response, new TypeReference<TravelAccountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTravelAccountsRequest, com.cvent.models.operations.async.ListTravelAccountsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListTravelAccountsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListTravelAccountsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
