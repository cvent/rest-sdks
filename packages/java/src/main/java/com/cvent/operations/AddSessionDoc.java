...
public class AddSessionDoc {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/sessions/{id}/docs/{fileId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<AddSessionDocRequest, AddSessionDocResponse> {
        ...
        private HttpRequest onBuildRequest(AddSessionDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSessionDocRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSessionDocRequest request) {
        ...
        @Override
        public AddSessionDocResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AddSessionDocResponse.Builder resBuilder = AddSessionDocResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AddSessionDocResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionFile(Utils.unmarshal(response, new TypeReference<SessionFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    AddSessionDocRequest, com.cvent.models.operations.async.AddSessionDocResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddSessionDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSessionDocRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSessionDocRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddSessionDocResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AddSessionDocResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddSessionDocResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddSessionDocResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionFile>() {})
                            .thenApply(res::withSessionFile);
                } else {
