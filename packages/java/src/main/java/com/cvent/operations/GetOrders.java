...
public class GetOrders {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/orders", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetOrdersRequest, GetOrdersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetOrdersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrdersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrdersRequest request) {
        ...
        @Override
        public GetOrdersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetOrdersResponse.Builder resBuilder = GetOrdersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetOrdersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOrdersRequest, com.cvent.models.operations.async.GetOrdersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetOrdersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrdersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOrdersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetOrdersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetOrdersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetOrdersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetOrdersResponse res = resBuilder.build();
