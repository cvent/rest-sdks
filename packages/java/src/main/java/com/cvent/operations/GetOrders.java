...
public class GetOrders {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrdersRequest, GetOrdersResponse> {
        ...
        public GetOrdersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetOrdersResponse.Builder resBuilder =
                    GetOrdersResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderDetailsPaginatedResponse(Utils.unmarshal(response, new TypeReference<OrderDetailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetOrdersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetOrdersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetOrdersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
