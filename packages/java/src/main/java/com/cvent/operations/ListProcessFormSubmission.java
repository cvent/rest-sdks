...
import com.cvent.models.components.ProcessFormSubmissionsPaginatedResponse;
...
public class ListProcessFormSubmission {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/process-form-submissions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/process-forms/submissions");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListProcessFormSubmissionRequest, ListProcessFormSubmissionResponse> {
        ...
        private HttpRequest onBuildRequest(ListProcessFormSubmissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListProcessFormSubmissionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListProcessFormSubmissionRequest request) {
        ...
        @Override
        public ListProcessFormSubmissionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListProcessFormSubmissionResponse.Builder resBuilder = ListProcessFormSubmissionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListProcessFormSubmissionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProcessFormSubmissionsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ProcessFormSubmissionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListProcessFormSubmissionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListProcessFormSubmissionRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListProcessFormSubmissionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListProcessFormSubmissionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListProcessFormSubmissionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListProcessFormSubmissionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListProcessFormSubmissionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListProcessFormSubmissionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProcessFormSubmissionsPaginatedResponse>() {})
                            .thenApply(res::withProcessFormSubmissionsPaginatedResponse);
                } else {
