...
public class ListProcessFormSubmission {
    ...
    public static class Sync extends Base
        ...
        public ListProcessFormSubmissionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListProcessFormSubmissionResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProcessFormSubmissionsPaginatedResponse(Utils.unmarshal(response, new TypeReference<ProcessFormSubmissionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListProcessFormSubmissionRequest, com.cvent.models.operations.async.ListProcessFormSubmissionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListProcessFormSubmissionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListProcessFormSubmissionRequest.class);
