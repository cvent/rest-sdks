...
public class ListLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListLocationsRequest, ListLocationsResponse> {
        ...
        public ListLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListLocationsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLocationsPaginatedResponse(Utils.unmarshal(response, new TypeReference<LocationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListLocationsRequest, com.cvent.models.operations.async.ListLocationsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListLocationsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListLocationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
