...
public class ListLocations {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listLocations",
                    java.util.Optional.of(java.util.List.of("appointments/locations:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/appointment-events/{id}/locations", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListLocationsRequest, ListLocationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListLocationsRequest request) {
        ...
        @Override
        public ListLocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListLocationsResponse.Builder resBuilder = ListLocationsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListLocationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLocationsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<LocationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListLocationsRequest, com.cvent.models.operations.async.ListLocationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListLocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListLocationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListLocationsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListLocationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LocationsPaginatedResponse>() {})
                            .thenApply(res::withLocationsPaginatedResponse);
                } else {
