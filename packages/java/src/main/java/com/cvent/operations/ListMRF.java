...
public class ListMRF {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMRFRequest, ListMRFResponse> {
        ...
        public ListMRFResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListMRFResponse.Builder resBuilder =
                    ListMRFResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestFormPaginatedResponse(Utils.unmarshal(response, new TypeReference<MeetingRequestFormPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListMRFResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListMRFResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMRFResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
