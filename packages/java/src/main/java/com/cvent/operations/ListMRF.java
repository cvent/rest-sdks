...
public class ListMRF {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listMRF",
                    java.util.Optional.of(java.util.List.of("event/meeting-request-forms:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/meeting-request-forms");
    ...
    public static class Sync extends Base implements RequestOperation<ListMRFRequest, ListMRFResponse> {
        ...
        private HttpRequest onBuildRequest(ListMRFRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMRFRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMRFRequest request) {
        ...
        @Override
        public ListMRFResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListMRFResponse.Builder resBuilder = ListMRFResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListMRFResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestFormPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<MeetingRequestFormPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMRFRequest, com.cvent.models.operations.async.ListMRFResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMRFRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMRFRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMRFRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMRFResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMRFResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMRFResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMRFResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRequestFormPaginatedResponse>() {})
                            .thenApply(res::withMeetingRequestFormPaginatedResponse);
                } else {
