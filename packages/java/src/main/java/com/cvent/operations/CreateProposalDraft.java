...
public class CreateProposalDraft {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "createProposalDraft",
                    java.util.Optional.of(java.util.List.of("proposal/proposals:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/proposal-drafts");
    ...
    public static class Sync extends Base implements RequestOperation<ProposalRequest, CreateProposalDraftResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ProposalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ProposalRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ProposalRequest request) {
        ...
        @Override
        public CreateProposalDraftResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateProposalDraftResponse.Builder resBuilder = CreateProposalDraftResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateProposalDraftResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProposalResponse(
                            Utils.unmarshal(response, new TypeReference<ProposalResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ProposalRequest, com.cvent.models.operations.async.CreateProposalDraftResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ProposalRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ProposalRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ProposalRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateProposalDraftResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateProposalDraftResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateProposalDraftResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateProposalDraftResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProposalResponse>() {})
                            .thenApply(res::withProposalResponse);
                } else {
