...
public class CreateProposalDraft {
    ...
    public static class Sync extends Base
            implements RequestOperation<ProposalRequest, CreateProposalDraftResponse> {
        ...
        public CreateProposalDraftResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateProposalDraftResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                ...
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProposalResponse(Utils.unmarshal(response, new TypeReference<ProposalResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ProposalRequest, com.cvent.models.operations.async.CreateProposalDraftResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.CreateProposalDraftResponse> handleResponse(
            ...
            com.cvent.models.operations.async.CreateProposalDraftResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateProposalDraftResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
