...
public class GetLeads {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/leads");
    ...
    public static class Sync extends Base implements RequestOperation<GetLeadsRequest, GetLeadsResponse> {
        ...
        private HttpRequest onBuildRequest(GetLeadsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLeadsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLeadsRequest request) {
        ...
        @Override
        public GetLeadsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetLeadsResponse.Builder resBuilder = GetLeadsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetLeadsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLeadsRequest, com.cvent.models.operations.async.GetLeadsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLeadsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLeadsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLeadsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetLeadsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetLeadsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetLeadsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetLeadsResponse res = resBuilder.build();
