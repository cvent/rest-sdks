...
import com.cvent.models.components.OrderItemResponse;
...
public class AssociateDiscountCodeToOrderItem {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/discounts:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<AssociateDiscountCodeToOrderItemRequest, AssociateDiscountCodeToOrderItemResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AssociateDiscountCodeToOrderItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssociateDiscountCodeToOrderItemRequest.class, new TypeReference<AssociateDiscountCodeToOrderItemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssociateDiscountCodeToOrderItemRequest request) {
        ...
        @Override
        public AssociateDiscountCodeToOrderItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AssociateDiscountCodeToOrderItemResponse.Builder resBuilder =
                    AssociateDiscountCodeToOrderItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AssociateDiscountCodeToOrderItemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderItemResponse(Utils.unmarshal(response, new TypeReference<OrderItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AssociateDiscountCodeToOrderItemRequest, com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AssociateDiscountCodeToOrderItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssociateDiscountCodeToOrderItemRequest.class, new TypeReference<AssociateDiscountCodeToOrderItemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AssociateDiscountCodeToOrderItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<OrderItemResponse>() {})
                            .thenApply(res::withOrderItemResponse);
                } else {
