...
public class AssociateDiscountCodeToOrderItem {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "orderItemAssociateDiscount", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<
                    AssociateDiscountCodeToOrderItemRequest, AssociateDiscountCodeToOrderItemResponse> {
        ...
        private HttpRequest onBuildRequest(AssociateDiscountCodeToOrderItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<AssociateDiscountCodeToOrderItemRequest>() {});
        ...
        public AssociateDiscountCodeToOrderItemResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AssociateDiscountCodeToOrderItemResponse.Builder resBuilder =
                    AssociateDiscountCodeToOrderItemResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderItemResponse(
                            Utils.unmarshal(response, new TypeReference<OrderItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AssociateDiscountCodeToOrderItemRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssociateDiscountCodeToOrderItemRequest.class,
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse>
            ...
            com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssociateDiscountCodeToOrderItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
