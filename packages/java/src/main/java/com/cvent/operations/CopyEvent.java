...
public class CopyEvent {
    ...
    public static class Sync extends Base implements RequestOperation<CopyEventRequest, CopyEventResponse> {
        ...
        private HttpRequest onBuildRequest(CopyEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CopyEventRequest.class, new TypeReference<CopyEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CopyEventRequest request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CopyEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CopyEventRequest.class, new TypeReference<CopyEventRequest>() {});
