...
public class GetResponses {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetResponsesRequest, GetResponsesResponse> {
        ...
        public GetResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetResponsesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResponsesPaginatedResponse(Utils.unmarshal(response, new TypeReference<ResponsesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetResponsesRequest, com.cvent.models.operations.async.GetResponsesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetResponsesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetResponsesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
