...
public class GetResponses {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getResponses",
                    java.util.Optional.of(java.util.List.of("survey/responses:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/responses");
    ...
    public static class Sync extends Base implements RequestOperation<GetResponsesRequest, GetResponsesResponse> {
        ...
        private HttpRequest onBuildRequest(GetResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetResponsesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetResponsesRequest request) {
        ...
        @Override
        public GetResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetResponsesResponse.Builder resBuilder = GetResponsesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetResponsesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResponsesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ResponsesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetResponsesRequest, com.cvent.models.operations.async.GetResponsesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetResponsesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetResponsesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetResponsesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ResponsesPaginatedResponse>() {})
                            .thenApply(res::withResponsesPaginatedResponse);
                } else {
