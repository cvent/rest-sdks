...
public class GetCurrencyConversionRate {
    ...
    public static class Sync extends Base
        ...
        public GetCurrencyConversionRateResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetCurrencyConversionRateResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCurrencyConversionRatePaginatedResponse(Utils.unmarshal(response, new TypeReference<CurrencyConversionRatePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCurrencyConversionRateRequest, com.cvent.models.operations.async.GetCurrencyConversionRateResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCurrencyConversionRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCurrencyConversionRateRequest.class);
