...
public class GetCurrencyConversionRate {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/currency-conversion-rate:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCurrencyConversionRateRequest, GetCurrencyConversionRateResponse> {
        ...
        private HttpRequest onBuildRequest(GetCurrencyConversionRateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCurrencyConversionRateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCurrencyConversionRateRequest request) {
        ...
        @Override
        public GetCurrencyConversionRateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetCurrencyConversionRateResponse.Builder resBuilder = GetCurrencyConversionRateResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetCurrencyConversionRateResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCurrencyConversionRatePaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<CurrencyConversionRatePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetCurrencyConversionRateResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCurrencyConversionRateRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetCurrencyConversionRateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCurrencyConversionRateRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetCurrencyConversionRateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetCurrencyConversionRateResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCurrencyConversionRateResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetCurrencyConversionRateResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CurrencyConversionRatePaginatedResponse>() {})
                            .thenApply(res::withCurrencyConversionRatePaginatedResponse);
                } else {
