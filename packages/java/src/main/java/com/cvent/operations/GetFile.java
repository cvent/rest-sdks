...
public class GetFile {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getFile",
                    java.util.Optional.of(java.util.List.of("file/file:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/files/{id}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetFileRequest, GetFileResponse> {
        ...
        private HttpRequest onBuildRequest(GetFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFileRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetFileRequest request) {
        ...
        @Override
        public GetFileResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetFileResponse.Builder resBuilder = GetFileResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetFileResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetFileRequest, com.cvent.models.operations.async.GetFileResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetFileRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetFileRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetFileRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetFileResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetFileResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetFileResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetFileResponse res = resBuilder.build();
