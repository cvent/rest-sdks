...
import com.cvent.models.components.AppointmentTypesPaginatedResponse;
...
public class ListAppointmentTypes {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("appointments/appointment-types:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/appointment-events/{id}/appointment-types", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAppointmentTypesRequest, ListAppointmentTypesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAppointmentTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAppointmentTypesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAppointmentTypesRequest request) {
        ...
        @Override
        public ListAppointmentTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAppointmentTypesResponse.Builder resBuilder = ListAppointmentTypesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAppointmentTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentTypesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AppointmentTypesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAppointmentTypesRequest, com.cvent.models.operations.async.ListAppointmentTypesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAppointmentTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAppointmentTypesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAppointmentTypesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAppointmentTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAppointmentTypesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAppointmentTypesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAppointmentTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AppointmentTypesPaginatedResponse>() {})
                            .thenApply(res::withAppointmentTypesPaginatedResponse);
                } else {
