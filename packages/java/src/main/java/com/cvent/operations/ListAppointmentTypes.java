...
public class ListAppointmentTypes {
    ...
    public static class Sync extends Base
        ...
        public ListAppointmentTypesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAppointmentTypesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentTypesPaginatedResponse(Utils.unmarshal(response, new TypeReference<AppointmentTypesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAppointmentTypesRequest, com.cvent.models.operations.async.ListAppointmentTypesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAppointmentTypesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAppointmentTypesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAppointmentTypesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
