...
public class UpdateCustomFieldAdvancedLogic {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/custom-fields/{customFieldId}/advanced-logic", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "advancedLogic", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCustomFieldAdvancedLogicRequest, UpdateCustomFieldAdvancedLogicResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateCustomFieldAdvancedLogicRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateCustomFieldAdvancedLogicRequest.class,
                    new TypeReference<UpdateCustomFieldAdvancedLogicRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCustomFieldAdvancedLogicRequest request) {
        ...
        @Override
        public UpdateCustomFieldAdvancedLogicResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateCustomFieldAdvancedLogicResponse.Builder resBuilder = UpdateCustomFieldAdvancedLogicResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateCustomFieldAdvancedLogicResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdvancedLogic(Utils.unmarshal(response, new TypeReference<AdvancedLogic>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.UpdateCustomFieldAdvancedLogicResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCustomFieldAdvancedLogicRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateCustomFieldAdvancedLogicRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCustomFieldAdvancedLogicRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateCustomFieldAdvancedLogicResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateCustomFieldAdvancedLogicResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateCustomFieldAdvancedLogicResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateCustomFieldAdvancedLogicResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdvancedLogic>() {})
                            .thenApply(res::withAdvancedLogic);
                } else {
