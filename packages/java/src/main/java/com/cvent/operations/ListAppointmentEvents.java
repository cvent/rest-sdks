...
public class ListAppointmentEvents {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAppointmentEventsRequest, ListAppointmentEventsResponse> {
        ...
        private HttpRequest onBuildRequest(ListAppointmentEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAppointmentEventsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAppointmentEventsRequest request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAppointmentEventsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAppointmentEventsRequest.class);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AppointmentEventPaginatedResponse>() {})
                            .thenApply(res::withAppointmentEventPaginatedResponse);
                } else {
