...
public class GetAllEventSurveyResponses {
    ...
    public static class Sync extends Base
        ...
        public GetAllEventSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAllEventSurveyResponsesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveyResponsesPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventSurveyResponsesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAllEventSurveyResponsesRequest, com.cvent.models.operations.async.GetAllEventSurveyResponsesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAllEventSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllEventSurveyResponsesRequest.class);
