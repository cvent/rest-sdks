...
public class GetAllEventSurveyResponses {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("survey/survey-responses:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/events/surveys/responses");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAllEventSurveyResponsesRequest, GetAllEventSurveyResponsesResponse> {
        ...
        private HttpRequest onBuildRequest(GetAllEventSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAllEventSurveyResponsesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAllEventSurveyResponsesRequest request) {
        ...
        @Override
        public GetAllEventSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAllEventSurveyResponsesResponse.Builder resBuilder = GetAllEventSurveyResponsesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAllEventSurveyResponsesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventSurveyResponsesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventSurveyResponsesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetAllEventSurveyResponsesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAllEventSurveyResponsesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetAllEventSurveyResponsesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAllEventSurveyResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAllEventSurveyResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAllEventSurveyResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAllEventSurveyResponsesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAllEventSurveyResponsesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventSurveyResponsesPaginatedResponse>() {})
                            .thenApply(res::withEventSurveyResponsesPaginatedResponse);
                } else {
