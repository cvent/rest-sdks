...
public class GetBadgePrintJob {
    ...
    public static class Sync extends Base
        ...
        public GetBadgePrintJobResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetBadgePrintJobResponse.Builder resBuilder =
                    GetBadgePrintJobResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingBadgePrintJob(Utils.unmarshal(response, new TypeReference<ExistingBadgePrintJob>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBadgePrintJobRequest, com.cvent.models.operations.async.GetBadgePrintJobResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetBadgePrintJobResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetBadgePrintJobResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgePrintJobResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
