...
import com.cvent.models.components.ExistingBadgePrintJob;
...
public class GetBadgePrintJob {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{eventId}/badge-print-jobs/{jobId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBadgePrintJobRequest, GetBadgePrintJobResponse> {
        ...
        private HttpRequest onBuildRequest(GetBadgePrintJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgePrintJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBadgePrintJobRequest request) {
        ...
        @Override
        public GetBadgePrintJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBadgePrintJobResponse.Builder resBuilder = GetBadgePrintJobResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBadgePrintJobResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingBadgePrintJob(
                            Utils.unmarshal(response, new TypeReference<ExistingBadgePrintJob>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBadgePrintJobRequest, com.cvent.models.operations.async.GetBadgePrintJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBadgePrintJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgePrintJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBadgePrintJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBadgePrintJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBadgePrintJobResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgePrintJobResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBadgePrintJobResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingBadgePrintJob>() {})
                            .thenApply(res::withExistingBadgePrintJob);
                } else {
