...
public class GetRfpGuestRooms {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getRfpGuestRooms",
                    java.util.Optional.of(java.util.List.of("rfp/rfp-guest-rooms:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/guest-rooms", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRfpGuestRoomsRequest, GetRfpGuestRoomsResponse> {
        ...
        private HttpRequest onBuildRequest(GetRfpGuestRoomsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpGuestRoomsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRfpGuestRoomsRequest request) {
        ...
        @Override
        public GetRfpGuestRoomsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRfpGuestRoomsResponse.Builder resBuilder = GetRfpGuestRoomsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRfpGuestRoomsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRfpGuestRooms(Utils.unmarshal(response, new TypeReference<RfpGuestRooms>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetRfpGuestRoomsRequest, com.cvent.models.operations.async.GetRfpGuestRoomsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRfpGuestRoomsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpGuestRoomsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRfpGuestRoomsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRfpGuestRoomsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRfpGuestRoomsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRfpGuestRoomsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRfpGuestRoomsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RfpGuestRooms>() {})
                            .thenApply(res::withRfpGuestRooms);
                } else {
