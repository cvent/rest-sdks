...
public class UpdateQuantityItemRegistrationForAttendee {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/quantity-items:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateQuantityItemRegistrationForAttendeeRequest, UpdateQuantityItemRegistrationForAttendeeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateQuantityItemRegistrationForAttendeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateQuantityItemRegistrationForAttendeeRequest.class, new TypeReference<UpdateQuantityItemRegistrationForAttendeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateQuantityItemRegistrationForAttendeeRequest request) {
        ...
        @Override
        public UpdateQuantityItemRegistrationForAttendeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateQuantityItemRegistrationForAttendeeResponse.Builder resBuilder =
            ...
            UpdateQuantityItemRegistrationForAttendeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateQuantityItemRegistrationForAttendeeRequest, com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateQuantityItemRegistrationForAttendeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateQuantityItemRegistrationForAttendeeRequest.class, new TypeReference<UpdateQuantityItemRegistrationForAttendeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateQuantityItemRegistrationForAttendeeRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse res = resBuilder.build();
