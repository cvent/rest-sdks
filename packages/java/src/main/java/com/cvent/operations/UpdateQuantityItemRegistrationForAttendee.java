...
public class UpdateQuantityItemRegistrationForAttendee {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/quantity-items/{quantityItemId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "quantityItemUpdate", "json", false);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateQuantityItemRegistrationForAttendeeRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<UpdateQuantityItemRegistrationForAttendeeRequest>() {});
        ...
        public UpdateQuantityItemRegistrationForAttendeeResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateQuantityItemRegistrationForAttendeeResponse.Builder resBuilder =
                    UpdateQuantityItemRegistrationForAttendeeResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuantityItemResponse(
                            Utils.unmarshal(response, new TypeReference<QuantityItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse>
            ...
            com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateQuantityItemRegistrationForAttendeeResponse res =
                    resBuilder.build();
