...
import com.cvent.models.components.PaginatedRfpAttachments;
...
public class ListRfpAttachments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listRfpAttachments",
                    java.util.Optional.of(java.util.List.of("rfp/rfp-attachments:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/attachments", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpAttachmentsRequest, ListRfpAttachmentsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpAttachmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpAttachmentsRequest request) {
        ...
        @Override
        public ListRfpAttachmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpAttachmentsResponse.Builder resBuilder = ListRfpAttachmentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpAttachmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpAttachments(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpAttachments>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRfpAttachmentsRequest, com.cvent.models.operations.async.ListRfpAttachmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpAttachmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpAttachmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpAttachmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpAttachmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpAttachmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpAttachmentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpAttachmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpAttachments>() {})
                            .thenApply(res::withPaginatedRfpAttachments);
                } else {
