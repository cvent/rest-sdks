...
public class GetAttendeeMessagesMembers {
    ...
    public static class Sync extends Base
        ...
        public GetAttendeeMessagesMembersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAttendeeMessagesMembersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessageRecipientsPaginatedResponse(Utils.unmarshal(response, new TypeReference<MessageRecipientsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAttendeeMessagesMembersRequest, com.cvent.models.operations.async.GetAttendeeMessagesMembersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAttendeeMessagesMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeMessagesMembersRequest.class);
