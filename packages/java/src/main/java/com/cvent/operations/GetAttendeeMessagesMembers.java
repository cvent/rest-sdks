...
public class GetAttendeeMessagesMembers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/attendee-messages:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{eventId}/attendee-messages/members", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAttendeeMessagesMembersRequest, GetAttendeeMessagesMembersResponse> {
        ...
        private HttpRequest onBuildRequest(GetAttendeeMessagesMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeMessagesMembersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAttendeeMessagesMembersRequest request) {
        ...
        @Override
        public GetAttendeeMessagesMembersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAttendeeMessagesMembersResponse.Builder resBuilder = GetAttendeeMessagesMembersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAttendeeMessagesMembersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMessageRecipientsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<MessageRecipientsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetAttendeeMessagesMembersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAttendeeMessagesMembersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeMessagesMembersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAttendeeMessagesMembersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAttendeeMessagesMembersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAttendeeMessagesMembersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAttendeeMessagesMembersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAttendeeMessagesMembersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MessageRecipientsPaginatedResponse>() {})
                            .thenApply(res::withMessageRecipientsPaginatedResponse);
                } else {
