...
import com.cvent.models.components.VideosPaginatedResponse;
...
public class ListVideos {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/videos");
    ...
    public static class Sync extends Base implements RequestOperation<ListVideosRequest, ListVideosResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListVideosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideosRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVideosRequest request) {
        ...
        @Override
        public ListVideosResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListVideosResponse.Builder resBuilder = ListVideosResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListVideosResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVideosPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<VideosPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVideosRequest, com.cvent.models.operations.async.ListVideosResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListVideosRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideosRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVideosRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListVideosResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListVideosResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListVideosResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListVideosResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VideosPaginatedResponse>() {})
                            .thenApply(res::withVideosPaginatedResponse);
                } else {
