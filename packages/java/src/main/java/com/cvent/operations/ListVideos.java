...
public class ListVideos {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVideosRequest, ListVideosResponse> {
        ...
        public ListVideosResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListVideosResponse.Builder resBuilder =
                    ListVideosResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVideosPaginatedResponse(Utils.unmarshal(response, new TypeReference<VideosPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListVideosResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListVideosResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListVideosResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
