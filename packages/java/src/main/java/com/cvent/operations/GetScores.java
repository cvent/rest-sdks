...
import com.cvent.models.components.ScoresPaginatedResponse;
...
public class GetScores {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getScores",
                    java.util.Optional.of(java.util.List.of("attendee-insights/scores:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/attendee-insights/{id}/scores", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetScoresRequest, GetScoresResponse> {
        ...
        private HttpRequest onBuildRequest(GetScoresRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetScoresRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetScoresRequest request) {
        ...
        @Override
        public GetScoresResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetScoresResponse.Builder resBuilder = GetScoresResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetScoresResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScoresPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ScoresPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetScoresRequest, com.cvent.models.operations.async.GetScoresResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetScoresRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetScoresRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetScoresRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetScoresResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetScoresResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetScoresResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetScoresResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ScoresPaginatedResponse>() {})
                            .thenApply(res::withScoresPaginatedResponse);
                } else {
