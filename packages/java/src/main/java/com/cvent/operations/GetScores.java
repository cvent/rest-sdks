...
public class GetScores {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetScoresRequest, GetScoresResponse> {
        ...
        public GetScoresResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetScoresResponse.Builder resBuilder =
                    GetScoresResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withScoresPaginatedResponse(Utils.unmarshal(response, new TypeReference<ScoresPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetScoresResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetScoresResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetScoresResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
