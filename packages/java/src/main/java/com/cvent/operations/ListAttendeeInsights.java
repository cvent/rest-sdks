...
public class ListAttendeeInsights {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("attendee-insights/attendee-insights:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/attendee-insights");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAttendeeInsightsRequest, ListAttendeeInsightsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAttendeeInsightsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeeInsightsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAttendeeInsightsRequest request) {
        ...
        @Override
        public ListAttendeeInsightsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAttendeeInsightsResponse.Builder resBuilder = ListAttendeeInsightsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAttendeeInsightsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInsightsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AttendeeInsightsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAttendeeInsightsRequest, com.cvent.models.operations.async.ListAttendeeInsightsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAttendeeInsightsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeeInsightsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAttendeeInsightsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAttendeeInsightsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAttendeeInsightsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAttendeeInsightsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAttendeeInsightsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeInsightsPaginatedResponse>() {})
                            .thenApply(res::withAttendeeInsightsPaginatedResponse);
                } else {
