...
public class ListAttendeeInsights {
    ...
    public static class Sync extends Base
        ...
        public ListAttendeeInsightsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAttendeeInsightsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInsightsPaginatedResponse(Utils.unmarshal(response, new TypeReference<AttendeeInsightsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAttendeeInsightsRequest, com.cvent.models.operations.async.ListAttendeeInsightsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAttendeeInsightsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAttendeeInsightsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAttendeeInsightsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
