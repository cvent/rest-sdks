...
public class ListTaxes {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listTaxes",
                    java.util.Optional.of(java.util.List.of("event/taxes:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/taxes", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListTaxesRequest, ListTaxesResponse> {
        ...
        private HttpRequest onBuildRequest(ListTaxesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaxesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTaxesRequest request) {
        ...
        @Override
        public ListTaxesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTaxesResponse.Builder resBuilder = ListTaxesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTaxesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaxesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TaxesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTaxesRequest, com.cvent.models.operations.async.ListTaxesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTaxesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTaxesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTaxesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTaxesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTaxesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTaxesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTaxesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TaxesPaginatedResponse>() {})
                            .thenApply(res::withTaxesPaginatedResponse);
                } else {
