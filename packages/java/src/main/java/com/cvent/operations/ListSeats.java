...
public class ListSeats {
    ...
    public static class Sync extends Base implements RequestOperation<ListSeatsRequest, ListSeatsResponse> {
        ...
        private HttpRequest onBuildRequest(ListSeatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSeatsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSeatsRequest request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSeatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSeatsRequest.class);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SeatsPaginatedResponse>() {})
                            .thenApply(res::withSeatsPaginatedResponse);
                } else {
