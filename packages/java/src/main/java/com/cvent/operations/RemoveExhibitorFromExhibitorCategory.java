...
public class RemoveExhibitorFromExhibitorCategory {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-categories:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveExhibitorFromExhibitorCategoryRequest, RemoveExhibitorFromExhibitorCategoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RemoveExhibitorFromExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveExhibitorFromExhibitorCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveExhibitorFromExhibitorCategoryRequest request) {
        ...
        @Override
        public RemoveExhibitorFromExhibitorCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RemoveExhibitorFromExhibitorCategoryResponse.Builder resBuilder =
            ...
            RemoveExhibitorFromExhibitorCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveExhibitorFromExhibitorCategoryRequest, com.cvent.models.operations.async.RemoveExhibitorFromExhibitorCategoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveExhibitorFromExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveExhibitorFromExhibitorCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveExhibitorFromExhibitorCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.RemoveExhibitorFromExhibitorCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.RemoveExhibitorFromExhibitorCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.RemoveExhibitorFromExhibitorCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.RemoveExhibitorFromExhibitorCategoryResponse res = resBuilder.build();
