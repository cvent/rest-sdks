...
public class GetExhibitorQuestions {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-questions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/exhibitor-questions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExhibitorQuestionsRequest, GetExhibitorQuestionsResponse> {
        ...
        private HttpRequest onBuildRequest(GetExhibitorQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorQuestionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExhibitorQuestionsRequest request) {
        ...
        @Override
        public GetExhibitorQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetExhibitorQuestionsResponse.Builder resBuilder = GetExhibitorQuestionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetExhibitorQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorQuestionsResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorQuestionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetExhibitorQuestionsRequest, com.cvent.models.operations.async.GetExhibitorQuestionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetExhibitorQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExhibitorQuestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorQuestionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetExhibitorQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorQuestionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetExhibitorQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorQuestionsResponse>() {})
                            .thenApply(res::withExhibitorQuestionsResponse);
                } else {
