...
public class GetExhibitorQuestions {
    ...
    public static class Sync extends Base
        ...
        public GetExhibitorQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetExhibitorQuestionsResponse.Builder resBuilder =
                    GetExhibitorQuestionsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorQuestionsResponse(Utils.unmarshal(response, new TypeReference<ExhibitorQuestionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetExhibitorQuestionsRequest, com.cvent.models.operations.async.GetExhibitorQuestionsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorQuestionsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetExhibitorQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorQuestionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
