...
public class CreateExhibitorWeblink {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/events/{id}/exhibitors/{exhibitorId}/weblinks",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateExhibitorWeblinkRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateExhibitorWeblinkRequest.class, new TypeReference<CreateExhibitorWeblinkRequest>() {});
        ...
        public CreateExhibitorWeblinkResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateExhibitorWeblinkResponse.Builder resBuilder =
                    CreateExhibitorWeblinkResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateExhibitorWeblinkRequest, com.cvent.models.operations.async.CreateExhibitorWeblinkResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.CreateExhibitorWeblinkResponse> handleResponse(
            ...
            com.cvent.models.operations.async.CreateExhibitorWeblinkResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateExhibitorWeblinkResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
