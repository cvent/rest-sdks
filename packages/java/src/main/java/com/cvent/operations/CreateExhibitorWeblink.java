...
public class CreateExhibitorWeblink {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-contents:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/weblinks", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "weblink", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateExhibitorWeblinkRequest, CreateExhibitorWeblinkResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateExhibitorWeblinkRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateExhibitorWeblinkRequest.class,
                    new TypeReference<CreateExhibitorWeblinkRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateExhibitorWeblinkRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "422", "429", "4XX", "5XX")) {
        ...
        @Override
        public CreateExhibitorWeblinkResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateExhibitorWeblinkResponse.Builder resBuilder = CreateExhibitorWeblinkResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateExhibitorWeblinkResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingWeblink(Utils.unmarshal(response, new TypeReference<ExistingWeblink>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateExhibitorWeblinkRequest, com.cvent.models.operations.async.CreateExhibitorWeblinkResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateExhibitorWeblinkRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateExhibitorWeblinkRequest.class,
                    new TypeReference<CreateExhibitorWeblinkRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateExhibitorWeblinkRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateExhibitorWeblinkResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateExhibitorWeblinkResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateExhibitorWeblinkResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateExhibitorWeblinkResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingWeblink>() {})
                            .thenApply(res::withExistingWeblink);
                } else {
