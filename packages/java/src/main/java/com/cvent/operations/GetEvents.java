...
public class GetEvents {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/events");
    ...
    public static class Sync extends Base implements RequestOperation<GetEventsRequest, GetEventsResponse> {
        ...
        public GetEventsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventsResponse.Builder resBuilder = GetEventsResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventsRequest, com.cvent.models.operations.async.GetEventsResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventsResponse res = resBuilder.build();
