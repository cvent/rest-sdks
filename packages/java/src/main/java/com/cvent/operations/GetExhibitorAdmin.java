...
public class GetExhibitorAdmin {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExhibitorAdminRequest, GetExhibitorAdminResponse> {
        ...
        private HttpRequest onBuildRequest(GetExhibitorAdminRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorAdminRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExhibitorAdminRequest request) {
        ...
        @Override
        public GetExhibitorAdminResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetExhibitorAdminResponse.Builder resBuilder = GetExhibitorAdminResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetExhibitorAdminResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetExhibitorAdminRequest, com.cvent.models.operations.async.GetExhibitorAdminResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetExhibitorAdminRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorAdminRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExhibitorAdminRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorAdminResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetExhibitorAdminResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorAdminResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetExhibitorAdminResponse res = resBuilder.build();
