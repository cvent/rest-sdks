...
public class UpdateAttendee {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "attendeeUpdate", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<UpdateAttendeeRequest, UpdateAttendeeResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAttendeeRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateAttendeeRequest.class, new TypeReference<UpdateAttendeeRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAttendeeRequest request) {
        ...
        @Override
        public UpdateAttendeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateAttendeeResponse.Builder resBuilder = UpdateAttendeeResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateAttendeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateAttendeeRequest, com.cvent.models.operations.async.UpdateAttendeeResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAttendeeRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateAttendeeRequest.class, new TypeReference<UpdateAttendeeRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAttendeeRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateAttendeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateAttendeeResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateAttendeeResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateAttendeeResponse res = resBuilder.build();
