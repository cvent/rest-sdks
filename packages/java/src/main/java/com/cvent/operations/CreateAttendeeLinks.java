...
public class CreateAttendeeLinks {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateAttendeeLinksRequest, CreateAttendeeLinksResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateAttendeeLinksRequest request) {
