...
public class ListUsers {
    ...
    public static class Sync extends Base implements RequestOperation<ListUsersRequest, ListUsersResponse> {
        ...
        private HttpRequest onBuildRequest(ListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUsersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListUsersRequest request) {
        ...
        public ListUsersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListUsersResponse.Builder resBuilder = ListUsersResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsers(Utils.unmarshal(response, new TypeReference<Users>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListUsersRequest, com.cvent.models.operations.async.ListUsersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListUsersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListUsersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListUsersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListUsersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListUsersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListUsersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListUsersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Users>() {})
                            .thenApply(res::withUsers);
                } else {
