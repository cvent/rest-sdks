...
public class PropertyApiListBrands {
    ...
    public static class Sync extends Base
        ...
        public PropertyApiListBrandsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            PropertyApiListBrandsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBrandPaginatedResponse(Utils.unmarshal(response, new TypeReference<BrandPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PropertyApiListBrandsRequest, com.cvent.models.operations.async.PropertyApiListBrandsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiListBrandsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.PropertyApiListBrandsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiListBrandsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
