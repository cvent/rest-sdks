...
public class PropertyApiListBrands {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("business-transient/supplier-brands:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-suppliers/brands");
    ...
    public static class Sync extends Base
            implements RequestOperation<PropertyApiListBrandsRequest, PropertyApiListBrandsResponse> {
        ...
        private HttpRequest onBuildRequest(PropertyApiListBrandsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListBrandsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PropertyApiListBrandsRequest request) {
        ...
        @Override
        public PropertyApiListBrandsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PropertyApiListBrandsResponse.Builder resBuilder = PropertyApiListBrandsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PropertyApiListBrandsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBrandPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BrandPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PropertyApiListBrandsRequest, com.cvent.models.operations.async.PropertyApiListBrandsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiListBrandsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListBrandsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PropertyApiListBrandsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiListBrandsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PropertyApiListBrandsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiListBrandsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PropertyApiListBrandsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BrandPaginatedResponse>() {})
                            .thenApply(res::withBrandPaginatedResponse);
                } else {
