...
import com.cvent.models.components.Rfp;
...
public class GetRFP {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getRFP",
                    java.util.Optional.of(java.util.List.of("rfp/rfps:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetRFPRequest, GetRFPResponse> {
        ...
        private HttpRequest onBuildRequest(GetRFPRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRFPRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRFPRequest request) {
        ...
        @Override
        public GetRFPResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRFPResponse.Builder resBuilder = GetRFPResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRFPResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRfp(Utils.unmarshal(response, new TypeReference<Rfp>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRFPRequest, com.cvent.models.operations.async.GetRFPResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRFPRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRFPRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRFPRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRFPResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRFPResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRFPResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRFPResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Rfp>() {})
                            .thenApply(res::withRfp);
                } else {
