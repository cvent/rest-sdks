...
public class ListExhibitorAdmins {
    ...
    public static class Sync extends Base
        ...
        public ListExhibitorAdminsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListExhibitorAdminsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorAdminsListResponse(Utils.unmarshal(response, new TypeReference<ExhibitorAdminsListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListExhibitorAdminsRequest, com.cvent.models.operations.async.ListExhibitorAdminsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorAdminsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListExhibitorAdminsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorAdminsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
