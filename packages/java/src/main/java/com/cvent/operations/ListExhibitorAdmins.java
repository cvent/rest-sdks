...
public class ListExhibitorAdmins {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listExhibitorAdmins",
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-admins:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<ListExhibitorAdminsRequest, ListExhibitorAdminsResponse> {
        ...
        private HttpRequest onBuildRequest(ListExhibitorAdminsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorAdminsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListExhibitorAdminsRequest request) {
        ...
        @Override
        public ListExhibitorAdminsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListExhibitorAdminsResponse.Builder resBuilder = ListExhibitorAdminsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListExhibitorAdminsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorAdminsListResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorAdminsListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListExhibitorAdminsRequest, com.cvent.models.operations.async.ListExhibitorAdminsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListExhibitorAdminsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorAdminsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListExhibitorAdminsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorAdminsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListExhibitorAdminsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorAdminsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListExhibitorAdminsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorAdminsListResponse>() {})
                            .thenApply(res::withExhibitorAdminsListResponse);
                } else {
