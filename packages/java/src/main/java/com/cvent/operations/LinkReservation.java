...
public class LinkReservation {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "linkReservation",
                    java.util.Optional.of(java.util.List.of("housing/reservations-link:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<LinkReservationRequest, LinkReservationResponse> {
        ...
        private HttpRequest onBuildRequest(LinkReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LinkReservationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LinkReservationRequest request) {
        ...
        @Override
        public LinkReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            LinkReservationResponse.Builder resBuilder = LinkReservationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            LinkReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    LinkReservationRequest, com.cvent.models.operations.async.LinkReservationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LinkReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LinkReservationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LinkReservationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.LinkReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.LinkReservationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.LinkReservationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.LinkReservationResponse res = resBuilder.build();
