...
public class AddSpeakerToSession {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "sessionSpeakerAssignment", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<AddSpeakerToSessionRequest, AddSpeakerToSessionResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddSpeakerToSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, AddSpeakerToSessionRequest.class, new TypeReference<AddSpeakerToSessionRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSpeakerToSessionRequest request) {
        ...
        @Override
        public AddSpeakerToSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AddSpeakerToSessionResponse.Builder resBuilder = AddSpeakerToSessionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AddSpeakerToSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    AddSpeakerToSessionRequest, com.cvent.models.operations.async.AddSpeakerToSessionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddSpeakerToSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, AddSpeakerToSessionRequest.class, new TypeReference<AddSpeakerToSessionRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSpeakerToSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddSpeakerToSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AddSpeakerToSessionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddSpeakerToSessionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddSpeakerToSessionResponse res = resBuilder.build();
