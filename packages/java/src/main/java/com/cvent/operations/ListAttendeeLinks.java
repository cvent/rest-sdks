...
public class ListAttendeeLinks {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listAttendeeLinks",
                    java.util.Optional.of(java.util.List.of("event/attendee-links:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/webcasts/attendee-links");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAttendeeLinksRequest, ListAttendeeLinksResponse> {
        ...
        private HttpRequest onBuildRequest(ListAttendeeLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeeLinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAttendeeLinksRequest request) {
        ...
        @Override
        public ListAttendeeLinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAttendeeLinksResponse.Builder resBuilder = ListAttendeeLinksResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAttendeeLinksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeLinkPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AttendeeLinkPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAttendeeLinksRequest, com.cvent.models.operations.async.ListAttendeeLinksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAttendeeLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeeLinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAttendeeLinksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAttendeeLinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAttendeeLinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAttendeeLinksResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAttendeeLinksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeLinkPaginatedResponse>() {})
                            .thenApply(res::withAttendeeLinkPaginatedResponse);
                } else {
