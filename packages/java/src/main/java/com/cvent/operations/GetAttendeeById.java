...
public class GetAttendeeById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/attendees/{id}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetAttendeeByIdRequest, GetAttendeeByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAttendeeByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAttendeeByIdRequest request) {
        ...
        @Override
        public GetAttendeeByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAttendeeByIdResponse.Builder resBuilder = GetAttendeeByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAttendeeByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendee(Utils.unmarshal(response, new TypeReference<Attendee>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAttendeeByIdRequest, com.cvent.models.operations.async.GetAttendeeByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAttendeeByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAttendeeByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAttendeeByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAttendeeByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAttendeeByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAttendeeByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Attendee>() {})
