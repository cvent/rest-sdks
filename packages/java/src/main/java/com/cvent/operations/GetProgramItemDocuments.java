...
public class GetProgramItemDocuments {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/program-items/{programItemId}/docs", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetProgramItemDocumentsRequest, GetProgramItemDocumentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetProgramItemDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProgramItemDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetProgramItemDocumentsRequest request) {
        ...
        @Override
        public GetProgramItemDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetProgramItemDocumentsResponse.Builder resBuilder = GetProgramItemDocumentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetProgramItemDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemSessionDocuments(
                            Utils.unmarshal(response, new TypeReference<ProgramItemSessionDocuments>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetProgramItemDocumentsRequest, com.cvent.models.operations.async.GetProgramItemDocumentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetProgramItemDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetProgramItemDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetProgramItemDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetProgramItemDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetProgramItemDocumentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetProgramItemDocumentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetProgramItemDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProgramItemSessionDocuments>() {})
                            .thenApply(res::withProgramItemSessionDocuments);
                } else {
