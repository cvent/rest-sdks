...
public class GetProgramItemDocuments {
    ...
    public static class Sync extends Base
        ...
        public GetProgramItemDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetProgramItemDocumentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemSessionDocuments(Utils.unmarshal(response, new TypeReference<ProgramItemSessionDocuments>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetProgramItemDocumentsRequest, com.cvent.models.operations.async.GetProgramItemDocumentsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetProgramItemDocumentsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetProgramItemDocumentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetProgramItemDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
