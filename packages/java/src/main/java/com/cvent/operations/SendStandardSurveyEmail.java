...
public class SendStandardSurveyEmail {
    ...
    public static class Sync extends Base
            implements RequestOperation<SendStandardSurveyEmailRequest, SendStandardSurveyEmailResponse> {
        ...
        private HttpRequest onBuildRequest(SendStandardSurveyEmailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SendStandardSurveyEmailRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SendStandardSurveyEmailRequest request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SendStandardSurveyEmailRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SendStandardSurveyEmailRequest.class);
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StandardSurveySendEmailResponse>() {})
                            .thenApply(res::withStandardSurveySendEmailResponse);
                } else {
