...
public class DisassociateAttendeeFromAudienceSegment {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(DisassociateAttendeeFromAudienceSegmentRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisassociateAttendeeFromAudienceSegmentRequest request) {
