...
public class CreateExternalAttendeeActivityMetadata {
    ...
    public static class Sync extends Base
            implements RequestOperation<ExternalActivityMetadataInput, CreateExternalAttendeeActivityMetadataResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ExternalActivityMetadataInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ExternalActivityMetadataInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ExternalActivityMetadataInput request) {
        ...
        @Override
        public CreateExternalAttendeeActivityMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateExternalAttendeeActivityMetadataResponse.Builder resBuilder =
            ...
            CreateExternalAttendeeActivityMetadataResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ExternalActivityMetadataInput, com.cvent.models.operations.async.CreateExternalAttendeeActivityMetadataResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ExternalActivityMetadataInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ExternalActivityMetadataInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ExternalActivityMetadataInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateExternalAttendeeActivityMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateExternalAttendeeActivityMetadataResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateExternalAttendeeActivityMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateExternalAttendeeActivityMetadataResponse res = resBuilder.build();
