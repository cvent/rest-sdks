...
public class UpdateEventFeatures {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateEventFeaturesRequest.class, new TypeReference<UpdateEventFeaturesRequest>() {});
        ...
        public UpdateEventFeaturesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateEventFeaturesResponse.Builder resBuilder =
                    UpdateEventFeaturesResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventFeaturesResponse(Utils.unmarshal(response, new TypeReference<EventFeaturesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateEventFeaturesRequest, com.cvent.models.operations.async.UpdateEventFeaturesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateEventFeaturesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateEventFeaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateEventFeaturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
