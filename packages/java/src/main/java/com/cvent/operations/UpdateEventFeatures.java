...
public class UpdateEventFeatures {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "updateEventFeatures",
                    java.util.Optional.of(java.util.List.of("event/event-features:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/features/{type}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "featureUpdate", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateEventFeaturesRequest, UpdateEventFeaturesResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateEventFeaturesRequest.class, new TypeReference<UpdateEventFeaturesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateEventFeaturesRequest request) {
        ...
        @Override
        public UpdateEventFeaturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateEventFeaturesResponse.Builder resBuilder = UpdateEventFeaturesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateEventFeaturesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventFeaturesResponse(
                            Utils.unmarshal(response, new TypeReference<EventFeaturesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateEventFeaturesRequest, com.cvent.models.operations.async.UpdateEventFeaturesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateEventFeaturesRequest.class, new TypeReference<UpdateEventFeaturesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateEventFeaturesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateEventFeaturesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateEventFeaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateEventFeaturesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateEventFeaturesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventFeaturesResponse>() {})
                            .thenApply(res::withEventFeaturesResponse);
                } else {
