...
public class PostRegistrationPack {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(PostRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostRegistrationPackRequest.class, new TypeReference<PostRegistrationPackRequest>() {});
        ...
        public PostRegistrationPackResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            PostRegistrationPackResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRegistrationPackResponse(Utils.unmarshal(response, new TypeReference<RegistrationPackResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostRegistrationPackRequest, com.cvent.models.operations.async.PostRegistrationPackResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostRegistrationPackRequest request) {
            return unchecked(() -> onBuildRequest(request)).get().thenCompose(client::sendAsync)
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "400", "401", "403", "404", "409", "429", "4XX", "5XX")) {
        ...
        public CompletableFuture<com.cvent.models.operations.async.PostRegistrationPackResponse> handleResponse(
            ...
            com.cvent.models.operations.async.PostRegistrationPackResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PostRegistrationPackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
