...
import com.cvent.models.components.RegistrationPackResponse;
...
public class PostRegistrationPack {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/registration-packs:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "registrationPackRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<PostRegistrationPackRequest, PostRegistrationPackResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PostRegistrationPackRequest.class, new TypeReference<PostRegistrationPackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostRegistrationPackRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "400", "401", "403", "404", "409", "429", "4XX", "5XX")) {
        ...
        @Override
        public PostRegistrationPackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PostRegistrationPackResponse.Builder resBuilder = PostRegistrationPackResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PostRegistrationPackResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRegistrationPackResponse(
                            Utils.unmarshal(response, new TypeReference<RegistrationPackResponse>() {}));
                } else {
                    throw APIException.from("Unexpected content-type received: " + contentType, response);
                }
            }
            if (Utils.statusCodeMatches(response.statusCode(), "400", "401", "403", "404", "409", "429")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PostRegistrationPackRequest, com.cvent.models.operations.async.PostRegistrationPackResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PostRegistrationPackRequest.class, new TypeReference<PostRegistrationPackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostRegistrationPackRequest request) {
            return unchecked(() -> onBuildRequest(request))
                    ...
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(
                                resp.statusCode(), "400", "401", "403", "404", "409", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PostRegistrationPackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PostRegistrationPackResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PostRegistrationPackResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PostRegistrationPackResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RegistrationPackResponse>() {})
                            .thenApply(res::withRegistrationPackResponse);
                } else {
