...
public class ListTravelProposals {
    ...
    public static class Sync extends Base
        ...
        public ListTravelProposalsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTravelProposalsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProposalPaginatedResponse(Utils.unmarshal(response, new TypeReference<TravelProposalPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTravelProposalsRequest, com.cvent.models.operations.async.ListTravelProposalsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProposalsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListTravelProposalsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProposalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
