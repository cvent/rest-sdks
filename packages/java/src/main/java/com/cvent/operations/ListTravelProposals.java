...
import com.cvent.models.components.TravelProposalPaginatedResponse;
...
public class ListTravelProposals {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(
                            java.util.List.of("business-transient/proposals:read", "business-travel/proposals:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-proposals");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTravelProposalsRequest, ListTravelProposalsResponse> {
        ...
        private HttpRequest onBuildRequest(ListTravelProposalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProposalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTravelProposalsRequest request) {
        ...
        @Override
        public ListTravelProposalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTravelProposalsResponse.Builder resBuilder = ListTravelProposalsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTravelProposalsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProposalPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TravelProposalPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListTravelProposalsRequest, com.cvent.models.operations.async.ListTravelProposalsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTravelProposalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProposalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTravelProposalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProposalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTravelProposalsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProposalsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTravelProposalsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelProposalPaginatedResponse>() {})
                            .thenApply(res::withTravelProposalPaginatedResponse);
                } else {
