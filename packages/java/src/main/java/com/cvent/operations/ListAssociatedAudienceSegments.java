...
public class ListAssociatedAudienceSegments {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/attendees/{attendeeId}/audience-segments/filter", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAssociatedAudienceSegmentsRequest, ListAssociatedAudienceSegmentsResponse> {
        ...
        private HttpRequest onBuildRequest(ListAssociatedAudienceSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListAssociatedAudienceSegmentsRequest.class,
                    new TypeReference<ListAssociatedAudienceSegmentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAssociatedAudienceSegmentsRequest request) {
        ...
        @Override
        public ListAssociatedAudienceSegmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAssociatedAudienceSegmentsResponse.Builder resBuilder = ListAssociatedAudienceSegmentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAssociatedAudienceSegmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAudienceSegmentAssociationsPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<AttendeeAudienceSegmentAssociationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListAssociatedAudienceSegmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAssociatedAudienceSegmentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListAssociatedAudienceSegmentsRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAssociatedAudienceSegmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAssociatedAudienceSegmentsResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAssociatedAudienceSegmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAssociatedAudienceSegmentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAssociatedAudienceSegmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(
                            response, new TypeReference<AttendeeAudienceSegmentAssociationsPaginatedResponse>() {})
                            .thenApply(res::withAttendeeAudienceSegmentAssociationsPaginatedResponse);
                } else {
