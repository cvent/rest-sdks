...
public class UpdateExhibitorAdmin {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/events/{id}/exhibitors/{exhibitorId}/admins/{adminId}",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorAdminRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorAdminRequest.class, new TypeReference<UpdateExhibitorAdminRequest>() {});
        ...
        public UpdateExhibitorAdminResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateExhibitorAdminResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorAdminResponse(Utils.unmarshal(response, new TypeReference<ExhibitorAdminResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateExhibitorAdminRequest, com.cvent.models.operations.async.UpdateExhibitorAdminResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorAdminResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateExhibitorAdminResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorAdminResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
