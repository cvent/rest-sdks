...
public class UpdateExhibitorAdmin {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-admins:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/admins/{adminId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "exhibitorAdminRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorAdminRequest, UpdateExhibitorAdminResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateExhibitorAdminRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateExhibitorAdminRequest.class, new TypeReference<UpdateExhibitorAdminRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorAdminRequest request) {
        ...
        @Override
        public UpdateExhibitorAdminResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateExhibitorAdminResponse.Builder resBuilder = UpdateExhibitorAdminResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateExhibitorAdminResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorAdminResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorAdminResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateExhibitorAdminRequest, com.cvent.models.operations.async.UpdateExhibitorAdminResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorAdminRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateExhibitorAdminRequest.class, new TypeReference<UpdateExhibitorAdminRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorAdminRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorAdminResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorAdminResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorAdminResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorAdminResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorAdminResponse>() {})
                            .thenApply(res::withExhibitorAdminResponse);
                } else {
