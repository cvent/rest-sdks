...
import com.cvent.models.components.VideoRenditionsResponse;
...
public class ListVideoRenditions {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/videos/{videoId}/renditions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVideoRenditionsRequest, ListVideoRenditionsResponse> {
        ...
        private HttpRequest onBuildRequest(ListVideoRenditionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideoRenditionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVideoRenditionsRequest request) {
        ...
        @Override
        public ListVideoRenditionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListVideoRenditionsResponse.Builder resBuilder = ListVideoRenditionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListVideoRenditionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVideoRenditionsResponse(
                            Utils.unmarshal(response, new TypeReference<VideoRenditionsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListVideoRenditionsRequest, com.cvent.models.operations.async.ListVideoRenditionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListVideoRenditionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideoRenditionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVideoRenditionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListVideoRenditionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListVideoRenditionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListVideoRenditionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListVideoRenditionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VideoRenditionsResponse>() {})
                            .thenApply(res::withVideoRenditionsResponse);
                } else {
