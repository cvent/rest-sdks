...
public class GetResourceTypes {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/scim/v2/ResourceTypes");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetResourceTypesResponse> {
            ...
            Retries retries = Retries.builder()
                    .action(() -> {
                        ...
                        try {
                            ...
                            if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "429", "4XX", "5XX")) {
        ...
        @Override
        public GetResourceTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetResourceTypesResponse.Builder resBuilder = GetResourceTypesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetResourceTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withResourceTypes(Utils.unmarshal(response, new TypeReference<ResourceTypes>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.cvent.models.operations.async.GetResourceTypesResponse> {
        ...
        public CompletableFuture<HttpResponse<Blob>> doRequest() {
            AsyncRetries retries = AsyncRetries.builder()
                    ...
                    .build();
            return retries.retry(() -> unchecked(() -> onBuildRequest())
                    .get()
                    ...
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "401", "403", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetResourceTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetResourceTypesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetResourceTypesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetResourceTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ResourceTypes>() {})
                            .thenApply(res::withResourceTypes);
                } else {
