...
public class ListRegistrationPaths {
    ...
    public static class Sync extends Base
        ...
        public ListRegistrationPathsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListRegistrationPathsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRegistrationPathPaginatedResponse(Utils.unmarshal(response, new TypeReference<RegistrationPathPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRegistrationPathsRequest, com.cvent.models.operations.async.ListRegistrationPathsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListRegistrationPathsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListRegistrationPathsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRegistrationPathsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
