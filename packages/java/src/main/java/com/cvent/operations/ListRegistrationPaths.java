...
public class ListRegistrationPaths {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/registration-paths:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/registration-paths", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRegistrationPathsRequest, ListRegistrationPathsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRegistrationPathsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRegistrationPathsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRegistrationPathsRequest request) {
        ...
        @Override
        public ListRegistrationPathsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRegistrationPathsResponse.Builder resBuilder = ListRegistrationPathsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRegistrationPathsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRegistrationPathPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<RegistrationPathPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRegistrationPathsRequest, com.cvent.models.operations.async.ListRegistrationPathsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRegistrationPathsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRegistrationPathsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRegistrationPathsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRegistrationPathsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRegistrationPathsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRegistrationPathsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRegistrationPathsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RegistrationPathPaginatedResponse>() {})
                            .thenApply(res::withRegistrationPathPaginatedResponse);
                } else {
