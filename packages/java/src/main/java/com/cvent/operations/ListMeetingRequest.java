...
public class ListMeetingRequest {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMeetingRequestRequest, ListMeetingRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMeetingRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRequestRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMeetingRequestRequest request) {
        ...
        @Override
        public ListMeetingRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListMeetingRequestResponse.Builder resBuilder = ListMeetingRequestResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListMeetingRequestResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<MeetingRequestPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListMeetingRequestRequest, com.cvent.models.operations.async.ListMeetingRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMeetingRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRequestRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMeetingRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMeetingRequestResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingRequestResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMeetingRequestResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRequestPaginatedResponse>() {})
                            .thenApply(res::withMeetingRequestPaginatedResponse);
                } else {
