...
public class ListMeetingRequest {
    ...
    public static class Sync extends Base
        ...
        public ListMeetingRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListMeetingRequestResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestPaginatedResponse(Utils.unmarshal(response, new TypeReference<MeetingRequestPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMeetingRequestRequest, com.cvent.models.operations.async.ListMeetingRequestResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingRequestResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListMeetingRequestResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
