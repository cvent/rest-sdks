...
public class DeleteSessionDocument {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSessionDocumentRequest, DeleteSessionDocumentResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteSessionDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionDocumentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSessionDocumentRequest request) {
        ...
        @Override
        public DeleteSessionDocumentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSessionDocumentResponse.Builder resBuilder = DeleteSessionDocumentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSessionDocumentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteSessionDocumentRequest, com.cvent.models.operations.async.DeleteSessionDocumentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSessionDocumentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionDocumentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSessionDocumentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSessionDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSessionDocumentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSessionDocumentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSessionDocumentResponse res = resBuilder.build();
