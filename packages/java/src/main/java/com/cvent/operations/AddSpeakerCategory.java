...
public class AddSpeakerCategory {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "addSpeakerCategory",
                    java.util.Optional.of(java.util.List.of("event/speaker-categories:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<SpeakerCategory, AddSpeakerCategoryResponse> {
        ...
        @Override
        public AddSpeakerCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddSpeakerCategoryResponse.Builder resBuilder =
                    AddSpeakerCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            AddSpeakerCategoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSpeakerCategory(Utils.unmarshal(response, new TypeReference<ExistingSpeakerCategory>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SpeakerCategory, com.cvent.models.operations.async.AddSpeakerCategoryResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddSpeakerCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.AddSpeakerCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddSpeakerCategoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddSpeakerCategoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingSpeakerCategory>() {})
                            .thenApply(res::withExistingSpeakerCategory);
                } else {
