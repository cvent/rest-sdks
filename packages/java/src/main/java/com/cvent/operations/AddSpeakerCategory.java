...
public class AddSpeakerCategory {
    ...
    public static class Sync extends Base implements RequestOperation<SpeakerCategory, AddSpeakerCategoryResponse> {
        ...
        public AddSpeakerCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AddSpeakerCategoryResponse.Builder resBuilder = AddSpeakerCategoryResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSpeakerCategory(
                            Utils.unmarshal(response, new TypeReference<ExistingSpeakerCategory>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.AddSpeakerCategoryResponse> handleResponse(
            ...
            com.cvent.models.operations.async.AddSpeakerCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddSpeakerCategoryResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
