...
import com.cvent.models.components.MembershipItemsPaginatedResponse;
...
public class ListMembershipItemsPostFilter {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/membership-items:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/membership-items/filter", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMembershipItemsPostFilterRequest, ListMembershipItemsPostFilterResponse> {
        ...
        private HttpRequest onBuildRequest(ListMembershipItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListMembershipItemsPostFilterRequest.class,
                    new TypeReference<ListMembershipItemsPostFilterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMembershipItemsPostFilterRequest request) {
        ...
        @Override
        public ListMembershipItemsPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListMembershipItemsPostFilterResponse.Builder resBuilder = ListMembershipItemsPostFilterResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListMembershipItemsPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMembershipItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<MembershipItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListMembershipItemsPostFilterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMembershipItemsPostFilterRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListMembershipItemsPostFilterRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMembershipItemsPostFilterRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMembershipItemsPostFilterResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMembershipItemsPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMembershipItemsPostFilterResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMembershipItemsPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MembershipItemsPaginatedResponse>() {})
                            .thenApply(res::withMembershipItemsPaginatedResponse);
                } else {
