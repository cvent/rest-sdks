...
public class DeleteUser {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "deleteUser",
                    java.util.Optional.of(java.util.List.of("account/users:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<DeleteUserRequest, DeleteUserResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteUserRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteUserRequest request) {
        ...
        @Override
        public DeleteUserResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteUserResponse.Builder resBuilder = DeleteUserResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteUserRequest, com.cvent.models.operations.async.DeleteUserResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteUserRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteUserRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteUserRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteUserResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteUserResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteUserResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteUserResponse res = resBuilder.build();
