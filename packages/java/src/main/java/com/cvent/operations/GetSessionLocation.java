...
public class GetSessionLocation {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/session-locations", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionLocationRequest, GetSessionLocationResponse> {
        ...
        private HttpRequest onBuildRequest(GetSessionLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionLocationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionLocationRequest request) {
        ...
        @Override
        public GetSessionLocationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSessionLocationResponse.Builder resBuilder = GetSessionLocationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSessionLocationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionLocationsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionLocationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSessionLocationRequest, com.cvent.models.operations.async.GetSessionLocationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionLocationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionLocationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionLocationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSessionLocationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSessionLocationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionLocationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSessionLocationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionLocationsPaginatedResponse>() {})
                            .thenApply(res::withSessionLocationsPaginatedResponse);
                } else {
