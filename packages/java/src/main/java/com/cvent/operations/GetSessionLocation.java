...
public class GetSessionLocation {
    ...
    public static class Sync extends Base
        ...
        public GetSessionLocationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSessionLocationResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionLocationsPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionLocationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionLocationRequest, com.cvent.models.operations.async.GetSessionLocationResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSessionLocationResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSessionLocationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionLocationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
