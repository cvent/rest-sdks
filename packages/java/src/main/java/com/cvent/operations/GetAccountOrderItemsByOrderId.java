...
import com.cvent.models.components.OrderItemsPaginatedResponse;
...
public class GetAccountOrderItemsByOrderId {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/orders:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/orders/{orderId}/items", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountOrderItemsByOrderIdRequest, GetAccountOrderItemsByOrderIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountOrderItemsByOrderIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrderItemsByOrderIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountOrderItemsByOrderIdRequest request) {
        ...
        @Override
        public GetAccountOrderItemsByOrderIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountOrderItemsByOrderIdResponse.Builder resBuilder = GetAccountOrderItemsByOrderIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountOrderItemsByOrderIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<OrderItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetAccountOrderItemsByOrderIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountOrderItemsByOrderIdRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetAccountOrderItemsByOrderIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountOrderItemsByOrderIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountOrderItemsByOrderIdResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountOrderItemsByOrderIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountOrderItemsByOrderIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountOrderItemsByOrderIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<OrderItemsPaginatedResponse>() {})
                            .thenApply(res::withOrderItemsPaginatedResponse);
                } else {
