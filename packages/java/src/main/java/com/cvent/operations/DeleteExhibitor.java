...
public class DeleteExhibitor {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "deleteExhibitor",
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitors:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<DeleteExhibitorRequest, DeleteExhibitorResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteExhibitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteExhibitorRequest request) {
        ...
        @Override
        public DeleteExhibitorResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteExhibitorResponse.Builder resBuilder = DeleteExhibitorResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteExhibitorResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteExhibitorRequest, com.cvent.models.operations.async.DeleteExhibitorResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteExhibitorRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteExhibitorRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteExhibitorResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteExhibitorResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteExhibitorResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteExhibitorResponse res = resBuilder.build();
