...
public class PatchContactById {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contacts/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "contactPatch", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<PatchContactByIdRequest, PatchContactByIdResponse> {
        ...
        private HttpRequest onBuildRequest(PatchContactByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchContactByIdRequest.class, new TypeReference<PatchContactByIdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PatchContactByIdRequest request) {
        ...
        @Override
        public PatchContactByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PatchContactByIdResponse.Builder resBuilder = PatchContactByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PatchContactByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PatchContactByIdRequest, com.cvent.models.operations.async.PatchContactByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PatchContactByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, PatchContactByIdRequest.class, new TypeReference<PatchContactByIdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PatchContactByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PatchContactByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PatchContactByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PatchContactByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PatchContactByIdResponse res = resBuilder.build();
