...
public class ListSessionsPostFilters {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/sessions/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSessionsPostFiltersRequest, ListSessionsPostFiltersResponse> {
        ...
        private HttpRequest onBuildRequest(ListSessionsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListSessionsPostFiltersRequest.class,
                    new TypeReference<ListSessionsPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSessionsPostFiltersRequest request) {
        ...
        @Override
        public ListSessionsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSessionsPostFiltersResponse.Builder resBuilder = ListSessionsPostFiltersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSessionsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSessionsPostFiltersRequest, com.cvent.models.operations.async.ListSessionsPostFiltersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListSessionsPostFiltersRequest.class,
                    new TypeReference<ListSessionsPostFiltersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSessionsPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionsPostFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSessionsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionsPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSessionsPostFiltersResponse res = resBuilder.build();
