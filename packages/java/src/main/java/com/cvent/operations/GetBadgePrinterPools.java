...
public class GetBadgePrinterPools {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("remote-printing/badge-printer-pools:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{eventId}/badge-printer-pools", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBadgePrinterPoolsRequest, GetBadgePrinterPoolsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBadgePrinterPoolsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgePrinterPoolsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBadgePrinterPoolsRequest request) {
        ...
        @Override
        public GetBadgePrinterPoolsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBadgePrinterPoolsResponse.Builder resBuilder = GetBadgePrinterPoolsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBadgePrinterPoolsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePrinterPoolsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BadgePrinterPoolsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBadgePrinterPoolsRequest, com.cvent.models.operations.async.GetBadgePrinterPoolsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetBadgePrinterPoolsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgePrinterPoolsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBadgePrinterPoolsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBadgePrinterPoolsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBadgePrinterPoolsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgePrinterPoolsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBadgePrinterPoolsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BadgePrinterPoolsPaginatedResponse>() {})
                            .thenApply(res::withBadgePrinterPoolsPaginatedResponse);
                } else {
