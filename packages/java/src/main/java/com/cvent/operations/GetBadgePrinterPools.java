...
public class GetBadgePrinterPools {
    ...
    public static class Sync extends Base
        ...
        public GetBadgePrinterPoolsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetBadgePrinterPoolsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePrinterPoolsPaginatedResponse(Utils.unmarshal(response, new TypeReference<BadgePrinterPoolsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBadgePrinterPoolsRequest, com.cvent.models.operations.async.GetBadgePrinterPoolsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetBadgePrinterPoolsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetBadgePrinterPoolsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgePrinterPoolsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
