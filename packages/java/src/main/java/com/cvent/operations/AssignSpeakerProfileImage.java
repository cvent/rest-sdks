...
public class AssignSpeakerProfileImage {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/speakers:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/speakers/{id}/profile-images", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "speakerFile", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<AssignSpeakerProfileImageRequest, AssignSpeakerProfileImageResponse> {
        ...
        private HttpRequest onBuildRequest(AssignSpeakerProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssignSpeakerProfileImageRequest.class,
                    new TypeReference<AssignSpeakerProfileImageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssignSpeakerProfileImageRequest request) {
        ...
        @Override
        public AssignSpeakerProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AssignSpeakerProfileImageResponse.Builder resBuilder = AssignSpeakerProfileImageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AssignSpeakerProfileImageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerFile(Utils.unmarshal(response, new TypeReference<SpeakerFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.AssignSpeakerProfileImageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AssignSpeakerProfileImageRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssignSpeakerProfileImageRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AssignSpeakerProfileImageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AssignSpeakerProfileImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AssignSpeakerProfileImageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssignSpeakerProfileImageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AssignSpeakerProfileImageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SpeakerFile>() {})
                            .thenApply(res::withSpeakerFile);
                } else {
