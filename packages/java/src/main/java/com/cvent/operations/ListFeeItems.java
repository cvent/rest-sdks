...
public class ListFeeItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListFeeItemsRequest, ListFeeItemsResponse> {
        ...
        public ListFeeItemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListFeeItemsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFeeItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<FeeItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListFeeItemsRequest, com.cvent.models.operations.async.ListFeeItemsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListFeeItemsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListFeeItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListFeeItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
