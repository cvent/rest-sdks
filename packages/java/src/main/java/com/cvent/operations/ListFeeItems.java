...
public class ListFeeItems {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listFeeItems",
                    java.util.Optional.of(java.util.List.of("event/fee-items:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/fee-items", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListFeeItemsRequest, ListFeeItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListFeeItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFeeItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListFeeItemsRequest request) {
        ...
        @Override
        public ListFeeItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListFeeItemsResponse.Builder resBuilder = ListFeeItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListFeeItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFeeItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<FeeItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListFeeItemsRequest, com.cvent.models.operations.async.ListFeeItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListFeeItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListFeeItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListFeeItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListFeeItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListFeeItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListFeeItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListFeeItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FeeItemsPaginatedResponse>() {})
                            .thenApply(res::withFeeItemsPaginatedResponse);
                } else {
