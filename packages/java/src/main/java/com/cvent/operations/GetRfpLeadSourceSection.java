...
public class GetRfpLeadSourceSection {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("rfp/rfp-lead-sources:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRfpLeadSourceSectionRequest, GetRfpLeadSourceSectionResponse> {
        ...
        private HttpRequest onBuildRequest(GetRfpLeadSourceSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpLeadSourceSectionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRfpLeadSourceSectionRequest request) {
        ...
        @Override
        public GetRfpLeadSourceSectionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRfpLeadSourceSectionResponse.Builder resBuilder = GetRfpLeadSourceSectionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRfpLeadSourceSectionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRfpLeadSourceSection(
                            Utils.unmarshal(response, new TypeReference<RfpLeadSourceSection>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetRfpLeadSourceSectionRequest, com.cvent.models.operations.async.GetRfpLeadSourceSectionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRfpLeadSourceSectionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpLeadSourceSectionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRfpLeadSourceSectionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRfpLeadSourceSectionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRfpLeadSourceSectionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRfpLeadSourceSectionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRfpLeadSourceSectionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RfpLeadSourceSection>() {})
                            .thenApply(res::withRfpLeadSourceSection);
                } else {
