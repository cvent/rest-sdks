...
public class DeleteBudgetAllocations {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/budget-items:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteBudgetAllocationsRequest, DeleteBudgetAllocationsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteBudgetAllocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBudgetAllocationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBudgetAllocationsRequest request) {
        ...
        @Override
        public DeleteBudgetAllocationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteBudgetAllocationsResponse.Builder resBuilder =
            ...
            DeleteBudgetAllocationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteBudgetAllocationsRequest, com.cvent.models.operations.async.DeleteBudgetAllocationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteBudgetAllocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBudgetAllocationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteBudgetAllocationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteBudgetAllocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteBudgetAllocationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteBudgetAllocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteBudgetAllocationsResponse res = resBuilder.build();
