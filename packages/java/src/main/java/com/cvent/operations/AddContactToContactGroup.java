...
public class AddContactToContactGroup {
    ...
    public static class Sync extends Base
            implements RequestOperation<AddContactToContactGroupRequest, AddContactToContactGroupResponse> {
        ...
        private HttpRequest onBuildRequest(AddContactToContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddContactToContactGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddContactToContactGroupRequest request) {
        ...
        @Override
        public AddContactToContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AddContactToContactGroupResponse.Builder resBuilder = AddContactToContactGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AddContactToContactGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.AddContactToContactGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddContactToContactGroupRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, AddContactToContactGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddContactToContactGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddContactToContactGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AddContactToContactGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddContactToContactGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddContactToContactGroupResponse res = resBuilder.build();
