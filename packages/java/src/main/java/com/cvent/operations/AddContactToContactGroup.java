...
public class AddContactToContactGroup {
    ...
    public static class Sync extends Base
        ...
        public AddContactToContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AddContactToContactGroupResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddContactToContactGroupRequest, com.cvent.models.operations.async.AddContactToContactGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddContactToContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddContactToContactGroupRequest.class);
