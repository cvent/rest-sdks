...
public class GetAirRequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAirRequestsRequest, GetAirRequestsResponse> {
        ...
        public GetAirRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAirRequestsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAirReservationDetail(Utils.unmarshal(response, new TypeReference<AirReservationDetail>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAirRequestsRequest, com.cvent.models.operations.async.GetAirRequestsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAirRequestsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAirRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAirRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
