...
public class GetAirRequests {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/event-travel/air-requests", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetAirRequestsRequest, GetAirRequestsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAirRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAirRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAirRequestsRequest request) {
        ...
        @Override
        public GetAirRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAirRequestsResponse.Builder resBuilder = GetAirRequestsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAirRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAirReservationDetail(
                            Utils.unmarshal(response, new TypeReference<AirReservationDetail2>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAirRequestsRequest, com.cvent.models.operations.async.GetAirRequestsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAirRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAirRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAirRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAirRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAirRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAirRequestsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAirRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AirReservationDetail2>() {})
                            .thenApply(res::withAirReservationDetail);
                } else {
