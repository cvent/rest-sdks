...
public class UpdateSessionCustomFieldAnswers {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateSessionCustomFieldAnswersRequest, UpdateSessionCustomFieldAnswersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateSessionCustomFieldAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSessionCustomFieldAnswersRequest.class, new TypeReference<UpdateSessionCustomFieldAnswersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateSessionCustomFieldAnswersRequest request) {
        ...
        @Override
        public UpdateSessionCustomFieldAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateSessionCustomFieldAnswersResponse.Builder resBuilder =
            ...
            UpdateSessionCustomFieldAnswersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateSessionCustomFieldAnswersRequest, com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSessionCustomFieldAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateSessionCustomFieldAnswersRequest.class, new TypeReference<UpdateSessionCustomFieldAnswersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateSessionCustomFieldAnswersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse res = resBuilder.build();
