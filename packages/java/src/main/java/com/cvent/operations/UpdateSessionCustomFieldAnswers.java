...
public class UpdateSessionCustomFieldAnswers {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/sessions/{id}/custom-fields/{customFieldId}/answers", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<
                    UpdateSessionCustomFieldAnswersRequest, UpdateSessionCustomFieldAnswersResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateSessionCustomFieldAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<UpdateSessionCustomFieldAnswersRequest>() {});
        ...
        public UpdateSessionCustomFieldAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateSessionCustomFieldAnswersResponse.Builder resBuilder =
                    UpdateSessionCustomFieldAnswersResponse.builder()
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateSessionCustomFieldAnswersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateSessionCustomFieldAnswersRequest.class,
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse>
            ...
            com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateSessionCustomFieldAnswersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
