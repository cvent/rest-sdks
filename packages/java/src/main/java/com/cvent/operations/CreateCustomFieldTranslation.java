...
public class CreateCustomFieldTranslation {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateCustomFieldTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomFieldTranslationRequest.class, new TypeReference<CreateCustomFieldTranslationRequest>() {});
        ...
        public CreateCustomFieldTranslationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateCustomFieldTranslationResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateCustomFieldTranslationRequest, com.cvent.models.operations.async.CreateCustomFieldTranslationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCustomFieldTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateCustomFieldTranslationRequest.class, new TypeReference<CreateCustomFieldTranslationRequest>() {});
