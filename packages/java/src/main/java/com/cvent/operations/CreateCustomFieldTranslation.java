...
public class CreateCustomFieldTranslation {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateCustomFieldTranslationRequest, CreateCustomFieldTranslationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateCustomFieldTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateCustomFieldTranslationRequest.class,
                    new TypeReference<CreateCustomFieldTranslationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateCustomFieldTranslationRequest request) {
        ...
        @Override
        public CreateCustomFieldTranslationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateCustomFieldTranslationResponse.Builder resBuilder = CreateCustomFieldTranslationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateCustomFieldTranslationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.CreateCustomFieldTranslationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateCustomFieldTranslationRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateCustomFieldTranslationRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateCustomFieldTranslationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateCustomFieldTranslationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateCustomFieldTranslationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateCustomFieldTranslationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateCustomFieldTranslationResponse res = resBuilder.build();
