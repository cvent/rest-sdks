...
public class PropertyApiGetPropertyRoom {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/travel-suppliers/property-rooms/{roomId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<PropertyApiGetPropertyRoomRequest, PropertyApiGetPropertyRoomResponse> {
        ...
        private HttpRequest onBuildRequest(PropertyApiGetPropertyRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiGetPropertyRoomRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PropertyApiGetPropertyRoomRequest request) {
        ...
        @Override
        public PropertyApiGetPropertyRoomResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PropertyApiGetPropertyRoomResponse.Builder resBuilder = PropertyApiGetPropertyRoomResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PropertyApiGetPropertyRoomResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPropertyRoom(Utils.unmarshal(response, new TypeReference<PropertyRoom>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.PropertyApiGetPropertyRoomResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiGetPropertyRoomRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiGetPropertyRoomRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PropertyApiGetPropertyRoomRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiGetPropertyRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PropertyApiGetPropertyRoomResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiGetPropertyRoomResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PropertyApiGetPropertyRoomResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PropertyRoom>() {})
                            .thenApply(res::withPropertyRoom);
                } else {
