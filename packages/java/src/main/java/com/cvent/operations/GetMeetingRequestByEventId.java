...
public class GetMeetingRequestByEventId {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/meeting-requests", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMeetingRequestByEventIdRequest, GetMeetingRequestByEventIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetMeetingRequestByEventIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMeetingRequestByEventIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMeetingRequestByEventIdRequest request) {
        ...
        @Override
        public GetMeetingRequestByEventIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetMeetingRequestByEventIdResponse.Builder resBuilder = GetMeetingRequestByEventIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetMeetingRequestByEventIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequest(Utils.unmarshal(response, new TypeReference<MeetingRequest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetMeetingRequestByEventIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMeetingRequestByEventIdRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetMeetingRequestByEventIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMeetingRequestByEventIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetMeetingRequestByEventIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetMeetingRequestByEventIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetMeetingRequestByEventIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetMeetingRequestByEventIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRequest>() {})
                            .thenApply(res::withMeetingRequest);
                } else {
