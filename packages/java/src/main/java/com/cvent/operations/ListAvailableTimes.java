...
public class ListAvailableTimes {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listAvailableTimes",
                    java.util.Optional.of(java.util.List.of("appointments/available-times:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/appointment-events/{id}/appointment-available-times", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAvailableTimesRequest, ListAvailableTimesResponse> {
        ...
        private HttpRequest onBuildRequest(ListAvailableTimesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAvailableTimesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAvailableTimesRequest request) {
        ...
        @Override
        public ListAvailableTimesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAvailableTimesResponse.Builder resBuilder = ListAvailableTimesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAvailableTimesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAvailableTimesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AvailableTimesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAvailableTimesRequest, com.cvent.models.operations.async.ListAvailableTimesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAvailableTimesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAvailableTimesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAvailableTimesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAvailableTimesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAvailableTimesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAvailableTimesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAvailableTimesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AvailableTimesPaginatedResponse>() {})
                            .thenApply(res::withAvailableTimesPaginatedResponse);
                } else {
