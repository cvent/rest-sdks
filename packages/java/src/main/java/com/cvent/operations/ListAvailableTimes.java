...
public class ListAvailableTimes {
    ...
    public static class Sync extends Base
        ...
        public ListAvailableTimesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAvailableTimesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAvailableTimesPaginatedResponse(Utils.unmarshal(response, new TypeReference<AvailableTimesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAvailableTimesRequest, com.cvent.models.operations.async.ListAvailableTimesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAvailableTimesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAvailableTimesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAvailableTimesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
