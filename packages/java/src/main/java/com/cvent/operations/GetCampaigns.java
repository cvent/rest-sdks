...
public class GetCampaigns {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCampaignsRequest, GetCampaignsResponse> {
        ...
        public GetCampaignsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetCampaignsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCampaignListPaginatedResponse(Utils.unmarshal(response, new TypeReference<CampaignListPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCampaignsRequest, com.cvent.models.operations.async.GetCampaignsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetCampaignsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetCampaignsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCampaignsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
