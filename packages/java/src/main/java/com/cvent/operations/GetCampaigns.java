...
public class GetCampaigns {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getCampaigns",
                    java.util.Optional.of(java.util.List.of("eMarketing/campaigns:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/campaigns");
    ...
    public static class Sync extends Base implements RequestOperation<GetCampaignsRequest, GetCampaignsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCampaignsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCampaignsRequest request) {
        ...
        @Override
        public GetCampaignsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetCampaignsResponse.Builder resBuilder = GetCampaignsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetCampaignsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCampaignListPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<CampaignListPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetCampaignsRequest, com.cvent.models.operations.async.GetCampaignsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCampaignsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCampaignsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCampaignsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetCampaignsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetCampaignsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCampaignsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetCampaignsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CampaignListPaginatedResponse>() {})
                            .thenApply(res::withCampaignListPaginatedResponse);
                } else {
