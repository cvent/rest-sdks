...
public class CreatePayment {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/budget-items/{budgetItemId}/budget-payments", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "payment", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<CreatePaymentRequest, CreatePaymentResponse> {
        ...
        private HttpRequest onBuildRequest(CreatePaymentRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreatePaymentRequest.class, new TypeReference<CreatePaymentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreatePaymentRequest request) {
        ...
        public CreatePaymentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreatePaymentResponse.Builder resBuilder = CreatePaymentResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreatePaymentRequest, com.cvent.models.operations.async.CreatePaymentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreatePaymentRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreatePaymentRequest.class, new TypeReference<CreatePaymentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreatePaymentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreatePaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreatePaymentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreatePaymentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreatePaymentResponse res = resBuilder.build();
