...
public class ValidateToken {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/token-validation");
    ...
    public static class Sync extends Base implements RequestlessOperation<ValidateTokenResponse> {
        ...
        @Override
        public ValidateTokenResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ValidateTokenResponse.Builder resBuilder = ValidateTokenResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ValidateTokenResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withValidToken(Utils.unmarshal(response, new TypeReference<ValidToken>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.cvent.models.operations.async.ValidateTokenResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ValidateTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ValidateTokenResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ValidateTokenResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ValidateTokenResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ValidToken>() {})
                            .thenApply(res::withValidToken);
                } else {
