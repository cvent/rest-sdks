...
public class GetHousingEventHotel {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/housing-events/{housingEventId}/hotels/{hotelId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingEventHotelRequest, GetHousingEventHotelResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingEventHotelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventHotelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingEventHotelRequest request) {
        ...
        @Override
        public GetHousingEventHotelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingEventHotelResponse.Builder resBuilder = GetHousingEventHotelResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingEventHotelResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEventHotel(
                            Utils.unmarshal(response, new TypeReference<HousingEventHotel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetHousingEventHotelRequest, com.cvent.models.operations.async.GetHousingEventHotelResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventHotelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventHotelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingEventHotelRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventHotelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingEventHotelResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventHotelResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingEventHotelResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HousingEventHotel>() {})
                            .thenApply(res::withHousingEventHotel);
                } else {
