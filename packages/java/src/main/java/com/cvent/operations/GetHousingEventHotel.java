...
public class GetHousingEventHotel {
    ...
    public static class Sync extends Base
        ...
        public GetHousingEventHotelResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHousingEventHotelResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEventHotel(Utils.unmarshal(response, new TypeReference<HousingEventHotel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHousingEventHotelRequest, com.cvent.models.operations.async.GetHousingEventHotelResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventHotelResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetHousingEventHotelResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventHotelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
