...
public class ListAdmissionItemsPostFilters {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/admission-items:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/admission-items/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdmissionItemsPostFiltersRequest, ListAdmissionItemsPostFiltersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAdmissionItemsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListAdmissionItemsPostFiltersRequest.class,
                    new TypeReference<ListAdmissionItemsPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdmissionItemsPostFiltersRequest request) {
        ...
        @Override
        public ListAdmissionItemsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAdmissionItemsPostFiltersResponse.Builder resBuilder = ListAdmissionItemsPostFiltersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAdmissionItemsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdmissionItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AdmissionItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdmissionItemsPostFiltersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListAdmissionItemsPostFiltersRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdmissionItemsPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AdmissionItemsPaginatedResponse>() {})
                            .thenApply(res::withAdmissionItemsPaginatedResponse);
                } else {
