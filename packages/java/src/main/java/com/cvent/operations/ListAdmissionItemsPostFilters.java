...
public class ListAdmissionItemsPostFilters {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListAdmissionItemsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdmissionItemsPostFiltersRequest.class, new TypeReference<ListAdmissionItemsPostFiltersRequest>() {});
        ...
        public ListAdmissionItemsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAdmissionItemsPostFiltersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAdmissionItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<AdmissionItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAdmissionItemsPostFiltersRequest, com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAdmissionItemsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdmissionItemsPostFiltersRequest.class, new TypeReference<ListAdmissionItemsPostFiltersRequest>() {});
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAdmissionItemsPostFiltersResponse> handleResponse(
