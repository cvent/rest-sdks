...
public class GetStats {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStatsRequest, GetStatsResponse> {
        ...
        public GetStatsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetStatsResponse.Builder resBuilder =
                    GetStatsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInsightsStats(Utils.unmarshal(response, new TypeReference<AttendeeInsightsStats>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetStatsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetStatsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetStatsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
