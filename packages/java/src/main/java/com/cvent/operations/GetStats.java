...
public class GetStats {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getStats",
                    java.util.Optional.of(java.util.List.of("attendee-insights/stats:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/attendee-insights/{id}/stats", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetStatsRequest, GetStatsResponse> {
        ...
        private HttpRequest onBuildRequest(GetStatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStatsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStatsRequest request) {
        ...
        @Override
        public GetStatsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetStatsResponse.Builder resBuilder = GetStatsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetStatsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInsightsStats(
                            Utils.unmarshal(response, new TypeReference<AttendeeInsightsStats>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStatsRequest, com.cvent.models.operations.async.GetStatsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetStatsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStatsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStatsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetStatsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetStatsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetStatsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetStatsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeInsightsStats>() {})
                            .thenApply(res::withAttendeeInsightsStats);
                } else {
