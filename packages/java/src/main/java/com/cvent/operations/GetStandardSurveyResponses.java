...
public class GetStandardSurveyResponses {
    ...
    public static class Sync extends Base
        ...
        public GetStandardSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetStandardSurveyResponsesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveyResponsesPaginatedResponse(Utils.unmarshal(response, new TypeReference<StandardSurveyResponsesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStandardSurveyResponsesRequest, com.cvent.models.operations.async.GetStandardSurveyResponsesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStandardSurveyResponsesRequest.class);
