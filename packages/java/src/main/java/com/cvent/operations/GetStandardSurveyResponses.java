...
import com.cvent.models.components.StandardSurveyResponsesPaginatedResponse;
...
public class GetStandardSurveyResponses {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("survey/standard-survey-responses:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/standard-surveys/responses");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStandardSurveyResponsesRequest, GetStandardSurveyResponsesResponse> {
        ...
        private HttpRequest onBuildRequest(GetStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStandardSurveyResponsesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStandardSurveyResponsesRequest request) {
        ...
        @Override
        public GetStandardSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetStandardSurveyResponsesResponse.Builder resBuilder = GetStandardSurveyResponsesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetStandardSurveyResponsesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveyResponsesPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<StandardSurveyResponsesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetStandardSurveyResponsesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetStandardSurveyResponsesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetStandardSurveyResponsesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStandardSurveyResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetStandardSurveyResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetStandardSurveyResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetStandardSurveyResponsesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetStandardSurveyResponsesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StandardSurveyResponsesPaginatedResponse>() {})
                            .thenApply(res::withStandardSurveyResponsesPaginatedResponse);
                } else {
