...
public class GetBadgesPostFilters {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetBadgesPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBadgesPostFiltersRequest.class, new TypeReference<GetBadgesPostFiltersRequest>() {});
        ...
        public GetBadgesPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetBadgesPostFiltersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePaginatedResponse(Utils.unmarshal(response, new TypeReference<BadgePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBadgesPostFiltersRequest, com.cvent.models.operations.async.GetBadgesPostFiltersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetBadgesPostFiltersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetBadgesPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgesPostFiltersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
