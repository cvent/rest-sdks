...
public class GetBadgesPostFilters {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/badges:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/badges/filter", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBadgesPostFiltersRequest, GetBadgesPostFiltersResponse> {
        ...
        private HttpRequest onBuildRequest(GetBadgesPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, GetBadgesPostFiltersRequest.class, new TypeReference<GetBadgesPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBadgesPostFiltersRequest request) {
        ...
        @Override
        public GetBadgesPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBadgesPostFiltersResponse.Builder resBuilder = GetBadgesPostFiltersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBadgesPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BadgePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBadgesPostFiltersRequest, com.cvent.models.operations.async.GetBadgesPostFiltersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetBadgesPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, GetBadgesPostFiltersRequest.class, new TypeReference<GetBadgesPostFiltersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBadgesPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBadgesPostFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBadgesPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBadgesPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBadgesPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BadgePaginatedResponse>() {})
                            .thenApply(res::withBadgePaginatedResponse);
                } else {
