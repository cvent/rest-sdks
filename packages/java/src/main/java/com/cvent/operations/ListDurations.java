...
public class ListDurations {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDurationsRequest, ListDurationsResponse> {
        ...
        public ListDurationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListDurationsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDurationPaginatedResponse(Utils.unmarshal(response, new TypeReference<DurationPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDurationsRequest, com.cvent.models.operations.async.ListDurationsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListDurationsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListDurationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListDurationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
