...
public class ListDurations {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listDurations",
                    java.util.Optional.of(java.util.List.of("event/attendance-durations:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/attendance-durations");
    ...
    public static class Sync extends Base implements RequestOperation<ListDurationsRequest, ListDurationsResponse> {
        ...
        private HttpRequest onBuildRequest(ListDurationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDurationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDurationsRequest request) {
        ...
        @Override
        public ListDurationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListDurationsResponse.Builder resBuilder = ListDurationsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListDurationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDurationPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<DurationPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListDurationsRequest, com.cvent.models.operations.async.ListDurationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDurationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDurationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDurationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListDurationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListDurationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListDurationsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListDurationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DurationPaginatedResponse>() {})
                            .thenApply(res::withDurationPaginatedResponse);
                } else {
