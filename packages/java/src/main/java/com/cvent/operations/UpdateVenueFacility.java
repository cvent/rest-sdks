...
public class UpdateVenueFacility {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "updateVenueFacility",
                    java.util.Optional.of(java.util.List.of("venue/venue-facility:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/venues/{venueId}/facility", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingVenueFacility", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateVenueFacilityRequest, UpdateVenueFacilityResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateVenueFacilityRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateVenueFacilityRequest.class, new TypeReference<UpdateVenueFacilityRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateVenueFacilityRequest request) {
        ...
        @Override
        public UpdateVenueFacilityResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateVenueFacilityResponse.Builder resBuilder = UpdateVenueFacilityResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateVenueFacilityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingVenueFacility(
                            Utils.unmarshal(response, new TypeReference<ExistingVenueFacility>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateVenueFacilityRequest, com.cvent.models.operations.async.UpdateVenueFacilityResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateVenueFacilityRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateVenueFacilityRequest.class, new TypeReference<UpdateVenueFacilityRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateVenueFacilityRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateVenueFacilityResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateVenueFacilityResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateVenueFacilityResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateVenueFacilityResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingVenueFacility>() {})
                            .thenApply(res::withExistingVenueFacility);
                } else {
