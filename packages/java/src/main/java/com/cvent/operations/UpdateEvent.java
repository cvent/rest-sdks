...
public class UpdateEvent {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "eventUpdate", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<UpdateEventRequest, UpdateEventResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateEventRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateEventRequest.class, new TypeReference<UpdateEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateEventRequest request) {
        ...
        @Override
        public UpdateEventResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateEventResponse.Builder resBuilder = UpdateEventResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateEventResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventUpdate(Utils.unmarshal(response, new TypeReference<EventUpdate>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateEventRequest, com.cvent.models.operations.async.UpdateEventResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateEventRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, UpdateEventRequest.class, new TypeReference<UpdateEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateEventRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateEventResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateEventResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateEventResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateEventResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventUpdate>() {})
                            .thenApply(res::withEventUpdate);
                } else {
