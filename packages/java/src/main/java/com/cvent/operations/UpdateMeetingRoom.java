...
public class UpdateMeetingRoom {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/venues/{venueId}/meeting-rooms/{meetingRoomId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingMeetingRoom", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateMeetingRoomRequest, UpdateMeetingRoomResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateMeetingRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateMeetingRoomRequest.class, new TypeReference<UpdateMeetingRoomRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateMeetingRoomRequest request) {
        ...
        @Override
        public UpdateMeetingRoomResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateMeetingRoomResponse.Builder resBuilder = UpdateMeetingRoomResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateMeetingRoomResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateMeetingRoomRequest, com.cvent.models.operations.async.UpdateMeetingRoomResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateMeetingRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateMeetingRoomRequest.class, new TypeReference<UpdateMeetingRoomRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateMeetingRoomRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateMeetingRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateMeetingRoomResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateMeetingRoomResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateMeetingRoomResponse res = resBuilder.build();
