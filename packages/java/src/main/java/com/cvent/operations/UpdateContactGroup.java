...
public class UpdateContactGroup {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "updateContactGroup",
                    java.util.Optional.of(java.util.List.of("event/contact-groups:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contact-groups/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "contactGroup", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateContactGroupRequest, UpdateContactGroupResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateContactGroupRequest.class, new TypeReference<UpdateContactGroupRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateContactGroupRequest request) {
        ...
        @Override
        public UpdateContactGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateContactGroupResponse.Builder resBuilder = UpdateContactGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateContactGroupResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactGroup(Utils.unmarshal(response, new TypeReference<ContactGroup>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateContactGroupRequest, com.cvent.models.operations.async.UpdateContactGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateContactGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateContactGroupRequest.class, new TypeReference<UpdateContactGroupRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateContactGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateContactGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateContactGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateContactGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateContactGroupResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactGroup>() {})
                            .thenApply(res::withContactGroup);
                } else {
