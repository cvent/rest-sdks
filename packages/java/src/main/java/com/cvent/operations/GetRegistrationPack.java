...
public class GetRegistrationPack {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRegistrationPackRequest, GetRegistrationPackResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRegistrationPackRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRegistrationPackRequest request) {
        ...
        @Override
        public GetRegistrationPackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetRegistrationPackResponse.Builder resBuilder =
                    GetRegistrationPackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetRegistrationPackResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRegistrationPackRequest, com.cvent.models.operations.async.GetRegistrationPackResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetRegistrationPackRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRegistrationPackRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRegistrationPackRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRegistrationPackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRegistrationPackResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRegistrationPackResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRegistrationPackResponse res = resBuilder.build();
