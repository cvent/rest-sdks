...
public class GetAvailabilityById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/appointment-availability-times/{id}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAvailabilityByIdRequest, GetAvailabilityByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAvailabilityByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAvailabilityByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAvailabilityByIdRequest request) {
        ...
        @Override
        public GetAvailabilityByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAvailabilityByIdResponse.Builder resBuilder = GetAvailabilityByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAvailabilityByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentAvailability(
                            Utils.unmarshal(response, new TypeReference<AppointmentAvailability>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAvailabilityByIdRequest, com.cvent.models.operations.async.GetAvailabilityByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAvailabilityByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAvailabilityByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAvailabilityByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAvailabilityByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAvailabilityByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAvailabilityByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAvailabilityByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AppointmentAvailability>() {})
                            .thenApply(res::withAppointmentAvailability);
                } else {
