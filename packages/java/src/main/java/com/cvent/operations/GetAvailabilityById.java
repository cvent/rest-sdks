...
public class GetAvailabilityById {
    ...
    public static class Sync extends Base
        ...
        public GetAvailabilityByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAvailabilityByIdResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentAvailability(Utils.unmarshal(response, new TypeReference<AppointmentAvailability>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAvailabilityByIdRequest, com.cvent.models.operations.async.GetAvailabilityByIdResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAvailabilityByIdResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAvailabilityByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAvailabilityByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
