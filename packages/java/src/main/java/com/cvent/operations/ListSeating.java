...
public class ListSeating {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSeatingRequest, ListSeatingResponse> {
        ...
        public ListSeatingResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSeatingResponse.Builder resBuilder =
                    ListSeatingResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSeatingPaginatedResponse(Utils.unmarshal(response, new TypeReference<SeatingPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSeatingRequest, com.cvent.models.operations.async.ListSeatingResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSeatingResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSeatingResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSeatingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
