...
public class ListEventVouchers {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/vouchers", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventVouchersRequest, ListEventVouchersResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventVouchersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventVouchersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventVouchersRequest request) {
        ...
        @Override
        public ListEventVouchersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventVouchersResponse.Builder resBuilder = ListEventVouchersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventVouchersResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListEventVouchersRequest, com.cvent.models.operations.async.ListEventVouchersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventVouchersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventVouchersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventVouchersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventVouchersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventVouchersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventVouchersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventVouchersResponse res = resBuilder.build();
