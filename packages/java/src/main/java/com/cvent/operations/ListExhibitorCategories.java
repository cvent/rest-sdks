...
public class ListExhibitorCategories {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/exhibitor-categories", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListExhibitorCategoriesRequest, ListExhibitorCategoriesResponse> {
        ...
        private HttpRequest onBuildRequest(ListExhibitorCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListExhibitorCategoriesRequest request) {
        ...
        @Override
        public ListExhibitorCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListExhibitorCategoriesResponse.Builder resBuilder = ListExhibitorCategoriesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListExhibitorCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoryIdListResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorCategoryIdListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListExhibitorCategoriesRequest, com.cvent.models.operations.async.ListExhibitorCategoriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListExhibitorCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListExhibitorCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListExhibitorCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorCategoriesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListExhibitorCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorCategoryIdListResponse>() {})
                            .thenApply(res::withExhibitorCategoryIdListResponse);
                } else {
