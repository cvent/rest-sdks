...
public class ListExhibitorCategories {
    ...
    public static class Sync extends Base
        ...
        public ListExhibitorCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListExhibitorCategoriesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoryIdListResponse(Utils.unmarshal(response, new TypeReference<ExhibitorCategoryIdListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListExhibitorCategoriesRequest, com.cvent.models.operations.async.ListExhibitorCategoriesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorCategoriesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListExhibitorCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
