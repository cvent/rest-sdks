...
import com.cvent.models.components.ProgramItemPaginatedResponse;
...
public class ListProgramItemsPostFilters {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/program-items/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListProgramItemsPostFiltersRequest, ListProgramItemsPostFiltersResponse> {
        ...
        private HttpRequest onBuildRequest(ListProgramItemsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListProgramItemsPostFiltersRequest.class,
                    new TypeReference<ListProgramItemsPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListProgramItemsPostFiltersRequest request) {
        ...
        @Override
        public ListProgramItemsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListProgramItemsPostFiltersResponse.Builder resBuilder = ListProgramItemsPostFiltersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListProgramItemsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ProgramItemPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListProgramItemsPostFiltersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListProgramItemsPostFiltersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListProgramItemsPostFiltersRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListProgramItemsPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListProgramItemsPostFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListProgramItemsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListProgramItemsPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListProgramItemsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProgramItemPaginatedResponse>() {})
                            .thenApply(res::withProgramItemPaginatedResponse);
                } else {
