...
public class ListProgramItemsPostFilters {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListProgramItemsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListProgramItemsPostFiltersRequest.class, new TypeReference<ListProgramItemsPostFiltersRequest>() {});
        ...
        public ListProgramItemsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListProgramItemsPostFiltersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemPaginatedResponse(Utils.unmarshal(response, new TypeReference<ProgramItemPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListProgramItemsPostFiltersRequest, com.cvent.models.operations.async.ListProgramItemsPostFiltersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListProgramItemsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListProgramItemsPostFiltersRequest.class, new TypeReference<ListProgramItemsPostFiltersRequest>() {});
