...
public class GetUsage {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUsageRequest, GetUsageResponse> {
        ...
        public GetUsageResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetUsageResponse.Builder resBuilder =
                    GetUsageResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsagePaginatedResponse(Utils.unmarshal(response, new TypeReference<UsagePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetUsageResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetUsageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetUsageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
