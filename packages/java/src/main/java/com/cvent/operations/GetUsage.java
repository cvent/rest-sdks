...
public class GetUsage {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/usage");
    ...
    public static class Sync extends Base implements RequestOperation<GetUsageRequest, GetUsageResponse> {
        ...
        private HttpRequest onBuildRequest(GetUsageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUsageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUsageRequest request) {
        ...
        @Override
        public GetUsageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetUsageResponse.Builder resBuilder = GetUsageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetUsageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUsagePaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<UsagePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetUsageRequest, com.cvent.models.operations.async.GetUsageResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetUsageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetUsageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetUsageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetUsageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetUsageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetUsageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetUsageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UsagePaginatedResponse>() {})
                            .thenApply(res::withUsagePaginatedResponse);
                } else {
