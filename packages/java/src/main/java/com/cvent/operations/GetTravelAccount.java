...
public class GetTravelAccount {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/travel-accounts/{travelAccountId}",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        public GetTravelAccountResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTravelAccountResponse.Builder resBuilder =
                    GetTravelAccountResponse
                            .builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTravelAccountRequest, com.cvent.models.operations.async.GetTravelAccountResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetTravelAccountResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetTravelAccountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTravelAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
