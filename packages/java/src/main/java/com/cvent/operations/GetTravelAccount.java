...
public class GetTravelAccount {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/travel-accounts/{travelAccountId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTravelAccountRequest, GetTravelAccountResponse> {
        ...
        private HttpRequest onBuildRequest(GetTravelAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTravelAccountRequest request) {
        ...
        @Override
        public GetTravelAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTravelAccountResponse.Builder resBuilder = GetTravelAccountResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTravelAccountResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccount(Utils.unmarshal(response, new TypeReference<TravelAccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetTravelAccountRequest, com.cvent.models.operations.async.GetTravelAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTravelAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTravelAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTravelAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTravelAccountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTravelAccountResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTravelAccountResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelAccount>() {})
                            .thenApply(res::withTravelAccount);
                } else {
