...
public class GetSeating {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getSeating",
                    java.util.Optional.of(java.util.List.of("seating/event-seatings:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/seatings/{seatingId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetSeatingRequest, GetSeatingResponse> {
        ...
        private HttpRequest onBuildRequest(GetSeatingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSeatingRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSeatingRequest request) {
        ...
        @Override
        public GetSeatingResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSeatingResponse.Builder resBuilder = GetSeatingResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSeatingResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSeating(Utils.unmarshal(response, new TypeReference<ExistingSeating>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSeatingRequest, com.cvent.models.operations.async.GetSeatingResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSeatingRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSeatingRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSeatingRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSeatingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSeatingResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSeatingResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSeatingResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingSeating>() {})
                            .thenApply(res::withExistingSeating);
                } else {
