...
public class GetAlternateTravelAnswers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/alternate-travel:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/event-travel/alternate-answers", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAlternateTravelAnswersRequest, GetAlternateTravelAnswersResponse> {
        ...
        private HttpRequest onBuildRequest(GetAlternateTravelAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAlternateTravelAnswersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAlternateTravelAnswersRequest request) {
        ...
        @Override
        public GetAlternateTravelAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAlternateTravelAnswersResponse.Builder resBuilder = GetAlternateTravelAnswersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAlternateTravelAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAlternateTravelPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AlternateTravelPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetAlternateTravelAnswersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAlternateTravelAnswersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetAlternateTravelAnswersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAlternateTravelAnswersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAlternateTravelAnswersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAlternateTravelAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAlternateTravelAnswersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAlternateTravelAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AlternateTravelPaginatedResponse>() {})
                            .thenApply(res::withAlternateTravelPaginatedResponse);
                } else {
