...
public class GetAlternateTravelAnswers {
    ...
    public static class Sync extends Base
        ...
        public GetAlternateTravelAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAlternateTravelAnswersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAlternateTravelPaginatedResponse(Utils.unmarshal(response, new TypeReference<AlternateTravelPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAlternateTravelAnswersRequest, com.cvent.models.operations.async.GetAlternateTravelAnswersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetAlternateTravelAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAlternateTravelAnswersRequest.class);
