...
public class UpdateContacts {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(List<ContactUpdate> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<ContactUpdate>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(List<ContactUpdate> request) {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(List<ContactUpdate> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<ContactUpdate>>() {});
