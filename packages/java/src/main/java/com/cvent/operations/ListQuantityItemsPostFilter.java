...
public class ListQuantityItemsPostFilter {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/quantity-items:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/quantity-items/filter", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListQuantityItemsPostFilterRequest, ListQuantityItemsPostFilterResponse> {
        ...
        private HttpRequest onBuildRequest(ListQuantityItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListQuantityItemsPostFilterRequest.class,
                    new TypeReference<ListQuantityItemsPostFilterRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListQuantityItemsPostFilterRequest request) {
        ...
        @Override
        public ListQuantityItemsPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListQuantityItemsPostFilterResponse.Builder resBuilder = ListQuantityItemsPostFilterResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListQuantityItemsPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuantityItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<QuantityItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListQuantityItemsPostFilterResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListQuantityItemsPostFilterRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListQuantityItemsPostFilterRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListQuantityItemsPostFilterRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListQuantityItemsPostFilterResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListQuantityItemsPostFilterResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListQuantityItemsPostFilterResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListQuantityItemsPostFilterResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<QuantityItemsPaginatedResponse>() {})
                            .thenApply(res::withQuantityItemsPaginatedResponse);
                } else {
