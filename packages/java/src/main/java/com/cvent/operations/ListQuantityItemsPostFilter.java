...
public class ListQuantityItemsPostFilter {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListQuantityItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListQuantityItemsPostFilterRequest.class, new TypeReference<ListQuantityItemsPostFilterRequest>() {});
        ...
        public ListQuantityItemsPostFilterResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListQuantityItemsPostFilterResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuantityItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<QuantityItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListQuantityItemsPostFilterRequest, com.cvent.models.operations.async.ListQuantityItemsPostFilterResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListQuantityItemsPostFilterRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListQuantityItemsPostFilterRequest.class, new TypeReference<ListQuantityItemsPostFilterRequest>() {});
