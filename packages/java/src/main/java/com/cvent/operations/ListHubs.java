...
public class ListHubs {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListHubsRequest, ListHubsResponse> {
        ...
        public ListHubsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListHubsResponse.Builder resBuilder =
                    ListHubsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHubsPaginatedResponse(Utils.unmarshal(response, new TypeReference<HubsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListHubsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListHubsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListHubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
