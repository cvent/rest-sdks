...
import com.cvent.models.components.HubsPaginatedResponse;
...
public class ListHubs {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/hubs");
    ...
    public static class Sync extends Base implements RequestOperation<ListHubsRequest, ListHubsResponse> {
        ...
        private HttpRequest onBuildRequest(ListHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHubsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListHubsRequest request) {
        ...
        @Override
        public ListHubsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListHubsResponse.Builder resBuilder = ListHubsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListHubsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHubsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<HubsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListHubsRequest, com.cvent.models.operations.async.ListHubsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListHubsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListHubsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListHubsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListHubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListHubsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListHubsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListHubsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HubsPaginatedResponse>() {})
                            .thenApply(res::withHubsPaginatedResponse);
                } else {
