...
public class GetChangeHistoryForASpecificContact {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/contacts:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contacts/{contactId}/history", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<
                    GetChangeHistoryForASpecificContactRequest, GetChangeHistoryForASpecificContactResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetChangeHistoryForASpecificContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChangeHistoryForASpecificContactRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetChangeHistoryForASpecificContactRequest request) {
        ...
        @Override
        public GetChangeHistoryForASpecificContactResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetChangeHistoryForASpecificContactResponse.Builder resBuilder =
                    GetChangeHistoryForASpecificContactResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            GetChangeHistoryForASpecificContactResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactHistoryPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ContactHistoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetChangeHistoryForASpecificContactRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetChangeHistoryForASpecificContactRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetChangeHistoryForASpecificContactRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactHistoryPaginatedResponse>() {})
                            .thenApply(res::withContactHistoryPaginatedResponse);
                } else {
