...
public class GetChangeHistoryForASpecificContact {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetChangeHistoryForASpecificContactRequest, GetChangeHistoryForASpecificContactResponse> {
        ...
        public GetChangeHistoryForASpecificContactResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactHistoryPaginatedResponse(Utils.unmarshal(response, new TypeReference<ContactHistoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetChangeHistoryForASpecificContactRequest, com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetChangeHistoryForASpecificContactRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChangeHistoryForASpecificContactRequest.class);
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetChangeHistoryForASpecificContactResponse> handleResponse(
