...
public class CreateAccountUserGroup {
    ...
    public static class Sync extends Base
        ...
        @Override
        public CreateAccountUserGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateAccountUserGroupResponse.Builder resBuilder =
            ...
            CreateAccountUserGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UserGroupJsonInput, com.cvent.models.operations.async.CreateAccountUserGroupResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateAccountUserGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateAccountUserGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateAccountUserGroupResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateAccountUserGroupResponse res = resBuilder.build();
