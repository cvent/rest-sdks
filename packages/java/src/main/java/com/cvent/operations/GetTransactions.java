...
public class GetTransactions {
    ...
    public static class Sync extends Base implements RequestOperation<GetTransactionsRequest, GetTransactionsResponse> {
        ...
        public GetTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTransactionsResponse.Builder resBuilder = GetTransactionsResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetTransactionsRequest, com.cvent.models.operations.async.GetTransactionsResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTransactionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTransactionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTransactionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTransactionsResponse res = resBuilder.build();
