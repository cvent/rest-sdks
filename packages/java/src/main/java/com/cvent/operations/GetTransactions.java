...
public class GetTransactions {
        ...
        public GetTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionDetailsPaginatedResponse(Utils.unmarshal(response, new TypeReference<TransactionDetailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionsRequest, com.cvent.models.operations.async.GetTransactionsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetTransactionsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetTransactionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTransactionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
