...
public class GetLargeChoices {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLargeChoicesRequest, GetLargeChoicesResponse> {
        ...
        public GetLargeChoicesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetLargeChoicesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLargeChoicesPaginatedResponse(Utils.unmarshal(response, new TypeReference<LargeChoicesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLargeChoicesRequest, com.cvent.models.operations.async.GetLargeChoicesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetLargeChoicesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetLargeChoicesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetLargeChoicesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
