...
public class GetLargeChoices {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getLargeChoices",
                    java.util.Optional.of(java.util.List.of("survey/questions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/large-choices");
    ...
    public static class Sync extends Base implements RequestOperation<GetLargeChoicesRequest, GetLargeChoicesResponse> {
        ...
        private HttpRequest onBuildRequest(GetLargeChoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLargeChoicesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLargeChoicesRequest request) {
        ...
        @Override
        public GetLargeChoicesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetLargeChoicesResponse.Builder resBuilder = GetLargeChoicesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetLargeChoicesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLargeChoicesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<LargeChoicesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetLargeChoicesRequest, com.cvent.models.operations.async.GetLargeChoicesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLargeChoicesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLargeChoicesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLargeChoicesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetLargeChoicesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetLargeChoicesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetLargeChoicesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetLargeChoicesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LargeChoicesPaginatedResponse>() {})
                            .thenApply(res::withLargeChoicesPaginatedResponse);
                } else {
