...
public class UpdateExhibitorCategoryBanner {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorCategoryBannerRequest, UpdateExhibitorCategoryBannerResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateExhibitorCategoryBannerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorCategoryBannerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorCategoryBannerRequest request) {
        ...
        @Override
        public UpdateExhibitorCategoryBannerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateExhibitorCategoryBannerResponse.Builder resBuilder =
                    UpdateExhibitorCategoryBannerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateExhibitorCategoryBannerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoryBannerFile(Utils.unmarshal(response, new TypeReference<ExhibitorCategoryBannerFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateExhibitorCategoryBannerRequest, com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorCategoryBannerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorCategoryBannerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorCategoryBannerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorCategoryBannerFile>() {})
                            .thenApply(res::withExhibitorCategoryBannerFile);
                } else {
