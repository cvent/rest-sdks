...
public class UpdateExhibitorCategoryBanner {
    ...
    public static class Sync extends Base
        ...
        public UpdateExhibitorCategoryBannerResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateExhibitorCategoryBannerResponse.Builder resBuilder = UpdateExhibitorCategoryBannerResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoryBannerFile(
                            Utils.unmarshal(response, new TypeReference<ExhibitorCategoryBannerFile>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorCategoryBannerRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorCategoryBannerRequest.class);
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse>
            ...
            com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorCategoryBannerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
