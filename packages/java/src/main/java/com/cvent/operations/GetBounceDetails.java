...
public class GetBounceDetails {
    ...
    public static class Sync extends Base
        ...
        public GetBounceDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetBounceDetailsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBounceDetailsResponse(Utils.unmarshal(response, new TypeReference<BounceDetailsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetBounceDetailsRequest, com.cvent.models.operations.async.GetBounceDetailsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetBounceDetailsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetBounceDetailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBounceDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
