...
public class GetBounceDetails {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getBounceDetails",
                    java.util.Optional.of(java.util.List.of("email/bounces:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/bounces");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetBounceDetailsRequest, GetBounceDetailsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetBounceDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBounceDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetBounceDetailsRequest request) {
        ...
        @Override
        public GetBounceDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetBounceDetailsResponse.Builder resBuilder = GetBounceDetailsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetBounceDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBounceDetailsResponse(
                            Utils.unmarshal(response, new TypeReference<BounceDetailsResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetBounceDetailsRequest, com.cvent.models.operations.async.GetBounceDetailsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetBounceDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetBounceDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetBounceDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetBounceDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetBounceDetailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetBounceDetailsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetBounceDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BounceDetailsResponse>() {})
                            .thenApply(res::withBounceDetailsResponse);
                } else {
