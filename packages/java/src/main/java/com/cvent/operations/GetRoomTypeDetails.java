...
public class GetRoomTypeDetails {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRoomTypeDetailsRequest, GetRoomTypeDetailsResponse> {
        ...
        private HttpRequest onBuildRequest(GetRoomTypeDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoomTypeDetailsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRoomTypeDetailsRequest request) {
        ...
        @Override
        public GetRoomTypeDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRoomTypeDetailsResponse.Builder resBuilder = GetRoomTypeDetailsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRoomTypeDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRoomTypeDetails(Utils.unmarshal(response, new TypeReference<RoomTypeDetails>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetRoomTypeDetailsRequest, com.cvent.models.operations.async.GetRoomTypeDetailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRoomTypeDetailsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRoomTypeDetailsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRoomTypeDetailsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRoomTypeDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRoomTypeDetailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRoomTypeDetailsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRoomTypeDetailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RoomTypeDetails>() {})
                            .thenApply(res::withRoomTypeDetails);
                } else {
