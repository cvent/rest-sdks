...
public class ListBoothStaff {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBoothStaffRequest, ListBoothStaffResponse> {
        ...
        public ListBoothStaffResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListBoothStaffResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBoothStaffListResponse(Utils.unmarshal(response, new TypeReference<BoothStaffListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBoothStaffRequest, com.cvent.models.operations.async.ListBoothStaffResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListBoothStaffResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListBoothStaffResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListBoothStaffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
