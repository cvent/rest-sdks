...
public class ListBoothStaff {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listBoothStaff",
                    java.util.Optional.of(java.util.List.of("exhibitor/booth-staff:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base implements RequestOperation<ListBoothStaffRequest, ListBoothStaffResponse> {
        ...
        private HttpRequest onBuildRequest(ListBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBoothStaffRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBoothStaffRequest request) {
        ...
        @Override
        public ListBoothStaffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListBoothStaffResponse.Builder resBuilder = ListBoothStaffResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListBoothStaffResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBoothStaffListResponse(
                            Utils.unmarshal(response, new TypeReference<BoothStaffListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListBoothStaffRequest, com.cvent.models.operations.async.ListBoothStaffResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBoothStaffRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBoothStaffRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListBoothStaffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListBoothStaffResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListBoothStaffResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListBoothStaffResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BoothStaffListResponse>() {})
                            .thenApply(res::withBoothStaffListResponse);
                } else {
