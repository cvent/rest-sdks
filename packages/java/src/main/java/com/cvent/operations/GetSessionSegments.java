...
import com.cvent.models.components.SessionSegmentPaginatedResponse;
...
public class GetSessionSegments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "GetSessionSegments",
                    java.util.Optional.of(java.util.List.of("event/session-segments:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/session-segments");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSessionSegmentsRequest, GetSessionSegmentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSessionSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionSegmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSessionSegmentsRequest request) {
        ...
        @Override
        public GetSessionSegmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSessionSegmentsResponse.Builder resBuilder = GetSessionSegmentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSessionSegmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionSegmentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionSegmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSessionSegmentsRequest, com.cvent.models.operations.async.GetSessionSegmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSessionSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSessionSegmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSessionSegmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSessionSegmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSessionSegmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionSegmentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSessionSegmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionSegmentPaginatedResponse>() {})
                            .thenApply(res::withSessionSegmentPaginatedResponse);
                } else {
