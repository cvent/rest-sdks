...
public class GetSessionSegments {
    ...
    public static class Sync extends Base
        ...
        public GetSessionSegmentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSessionSegmentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionSegmentPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionSegmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSessionSegmentsRequest, com.cvent.models.operations.async.GetSessionSegmentsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSessionSegmentsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSessionSegmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSessionSegmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
