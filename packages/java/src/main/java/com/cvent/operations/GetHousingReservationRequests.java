...
public class GetHousingReservationRequests {
    ...
    public static class Sync extends Base
        ...
        public GetHousingReservationRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHousingReservationRequestsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReservationRequestPaginatedResponse(Utils.unmarshal(response, new TypeReference<ReservationRequestPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHousingReservationRequestsRequest, com.cvent.models.operations.async.GetHousingReservationRequestsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingReservationRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingReservationRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingReservationRequestsResponse> handleResponse(
