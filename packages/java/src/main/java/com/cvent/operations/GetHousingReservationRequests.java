...
public class GetHousingReservationRequests {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/hotel-request:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/event-travel/housing-reservation-requests", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingReservationRequestsRequest, GetHousingReservationRequestsResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingReservationRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingReservationRequestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingReservationRequestsRequest request) {
        ...
        @Override
        public GetHousingReservationRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingReservationRequestsResponse.Builder resBuilder = GetHousingReservationRequestsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingReservationRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReservationRequestPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ReservationRequestPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetHousingReservationRequestsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingReservationRequestsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetHousingReservationRequestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingReservationRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingReservationRequestsResponse>
                handleResponse(HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingReservationRequestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingReservationRequestsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingReservationRequestsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ReservationRequestPaginatedResponse>() {})
                            .thenApply(res::withReservationRequestPaginatedResponse);
                } else {
