...
public class GetEventQuestions {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/event-questions");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventQuestionsRequest, GetEventQuestionsResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventQuestionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventQuestionsRequest request) {
        ...
        @Override
        public GetEventQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventQuestionsResponse.Builder resBuilder = GetEventQuestionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventQuestionsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventQuestionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventQuestionsRequest, com.cvent.models.operations.async.GetEventQuestionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventQuestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventQuestionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventQuestionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventQuestionsPaginatedResponse>() {})
                            .thenApply(res::withEventQuestionsPaginatedResponse);
                } else {
