...
public class GetEventQuestions {
    ...
    public static class Sync extends Base
        ...
        public GetEventQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventQuestionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventQuestionsPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventQuestionsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventQuestionsRequest, com.cvent.models.operations.async.GetEventQuestionsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventQuestionsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventQuestionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
