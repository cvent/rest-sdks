...
public class AssignContactProfileImage {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(AssignContactProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssignContactProfileImageRequest.class, new TypeReference<AssignContactProfileImageRequest>() {});
        ...
        public AssignContactProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AssignContactProfileImageResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AssignContactProfileImageRequest, com.cvent.models.operations.async.AssignContactProfileImageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AssignContactProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AssignContactProfileImageRequest.class, new TypeReference<AssignContactProfileImageRequest>() {});
