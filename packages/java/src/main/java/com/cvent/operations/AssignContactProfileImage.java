...
import com.cvent.models.components.ContactFile;
...
public class AssignContactProfileImage {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contacts/{id}/profile-images", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "contactFile", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<AssignContactProfileImageRequest, AssignContactProfileImageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AssignContactProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssignContactProfileImageRequest.class,
                    new TypeReference<AssignContactProfileImageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AssignContactProfileImageRequest request) {
        ...
        @Override
        public AssignContactProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AssignContactProfileImageResponse.Builder resBuilder = AssignContactProfileImageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AssignContactProfileImageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactFile(Utils.unmarshal(response, new TypeReference<ContactFile>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.AssignContactProfileImageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AssignContactProfileImageRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    AssignContactProfileImageRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AssignContactProfileImageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AssignContactProfileImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AssignContactProfileImageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AssignContactProfileImageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AssignContactProfileImageResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactFile>() {})
                            .thenApply(res::withContactFile);
                } else {
