...
public class CreateMeetingRoom {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "createMeetingRoom",
                    java.util.Optional.of(java.util.List.of("venue/meeting-rooms:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/venues/{venueId}/meeting-rooms", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "meetingRoom", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateMeetingRoomRequest, CreateMeetingRoomResponse> {
        ...
        private HttpRequest onBuildRequest(CreateMeetingRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateMeetingRoomRequest.class, new TypeReference<CreateMeetingRoomRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateMeetingRoomRequest request) {
        ...
        @Override
        public CreateMeetingRoomResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateMeetingRoomResponse.Builder resBuilder = CreateMeetingRoomResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateMeetingRoomResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingMeetingRoom(
                            Utils.unmarshal(response, new TypeReference<ExistingMeetingRoom>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateMeetingRoomRequest, com.cvent.models.operations.async.CreateMeetingRoomResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateMeetingRoomRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateMeetingRoomRequest.class, new TypeReference<CreateMeetingRoomRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateMeetingRoomRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateMeetingRoomResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateMeetingRoomResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateMeetingRoomResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateMeetingRoomResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingMeetingRoom>() {})
                            .thenApply(res::withExistingMeetingRoom);
                } else {
