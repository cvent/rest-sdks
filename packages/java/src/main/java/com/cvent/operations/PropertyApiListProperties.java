...
public class PropertyApiListProperties {
    ...
    public static class Sync extends Base
        ...
        public PropertyApiListPropertiesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            PropertyApiListPropertiesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPropertyPaginatedResponse(Utils.unmarshal(response, new TypeReference<PropertyPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PropertyApiListPropertiesRequest, com.cvent.models.operations.async.PropertyApiListPropertiesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiListPropertiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListPropertiesRequest.class);
