...
public class PropertyApiListProperties {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("business-transient/supplier-properties:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-suppliers/properties");
    ...
    public static class Sync extends Base
            implements RequestOperation<PropertyApiListPropertiesRequest, PropertyApiListPropertiesResponse> {
        ...
        private HttpRequest onBuildRequest(PropertyApiListPropertiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListPropertiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PropertyApiListPropertiesRequest request) {
        ...
        @Override
        public PropertyApiListPropertiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PropertyApiListPropertiesResponse.Builder resBuilder = PropertyApiListPropertiesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PropertyApiListPropertiesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPropertyPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<PropertyPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    PropertyApiListPropertiesRequest,
                    com.cvent.models.operations.async.PropertyApiListPropertiesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(PropertyApiListPropertiesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, PropertyApiListPropertiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PropertyApiListPropertiesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PropertyApiListPropertiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PropertyApiListPropertiesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PropertyApiListPropertiesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PropertyApiListPropertiesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PropertyPaginatedResponse>() {})
                            .thenApply(res::withPropertyPaginatedResponse);
                } else {
