...
public class ListBulkJobResult {
    ...
    public static class Sync extends Base
        ...
        public ListBulkJobResultResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListBulkJobResultResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBulkResultsPaginatedResponse(Utils.unmarshal(response, new TypeReference<BulkResultsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListBulkJobResultRequest, com.cvent.models.operations.async.ListBulkJobResultResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListBulkJobResultResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListBulkJobResultResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListBulkJobResultResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
