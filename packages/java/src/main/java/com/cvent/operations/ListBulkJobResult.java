...
public class ListBulkJobResult {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listBulkJobResult",
                    java.util.Optional.of(java.util.List.of("bulk/bulk-jobs:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/bulk-jobs/{id}/results", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListBulkJobResultRequest, ListBulkJobResultResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListBulkJobResultRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBulkJobResultRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListBulkJobResultRequest request) {
        ...
        @Override
        public ListBulkJobResultResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListBulkJobResultResponse.Builder resBuilder = ListBulkJobResultResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListBulkJobResultResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBulkResultsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BulkResultsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListBulkJobResultRequest, com.cvent.models.operations.async.ListBulkJobResultResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListBulkJobResultRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListBulkJobResultRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListBulkJobResultRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListBulkJobResultResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListBulkJobResultResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListBulkJobResultResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListBulkJobResultResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BulkResultsPaginatedResponse>() {})
                            .thenApply(res::withBulkResultsPaginatedResponse);
                } else {
