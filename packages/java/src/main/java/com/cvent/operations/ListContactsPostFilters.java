...
public class ListContactsPostFilters {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListContactsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactsPostFiltersRequest.class, new TypeReference<ListContactsPostFiltersRequest>() {});
        ...
        public ListContactsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListContactsPostFiltersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactPaginatedResponse(Utils.unmarshal(response, new TypeReference<ContactPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListContactsPostFiltersRequest, com.cvent.models.operations.async.ListContactsPostFiltersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListContactsPostFiltersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListContactsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactsPostFiltersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
