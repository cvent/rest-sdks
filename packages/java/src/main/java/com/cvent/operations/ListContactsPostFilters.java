...
public class ListContactsPostFilters {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/contacts/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListContactsPostFiltersRequest, ListContactsPostFiltersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListContactsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListContactsPostFiltersRequest.class,
                    new TypeReference<ListContactsPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListContactsPostFiltersRequest request) {
        ...
        @Override
        public ListContactsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListContactsPostFiltersResponse.Builder resBuilder = ListContactsPostFiltersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListContactsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ContactPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListContactsPostFiltersRequest, com.cvent.models.operations.async.ListContactsPostFiltersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListContactsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    ListContactsPostFiltersRequest.class,
                    new TypeReference<ListContactsPostFiltersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListContactsPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListContactsPostFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListContactsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactsPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListContactsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactPaginatedResponse>() {})
                            .thenApply(res::withContactPaginatedResponse);
                } else {
