...
public class AddSpeakerDoc {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/speakers/{id}/docs/{fileId}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<AddSpeakerDocRequest, AddSpeakerDocResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(AddSpeakerDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSpeakerDocRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddSpeakerDocRequest request) {
        ...
        @Override
        public AddSpeakerDocResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AddSpeakerDocResponse.Builder resBuilder = AddSpeakerDocResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AddSpeakerDocResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    AddSpeakerDocRequest, com.cvent.models.operations.async.AddSpeakerDocResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddSpeakerDocRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddSpeakerDocRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddSpeakerDocRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddSpeakerDocResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AddSpeakerDocResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddSpeakerDocResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddSpeakerDocResponse res = resBuilder.build();
