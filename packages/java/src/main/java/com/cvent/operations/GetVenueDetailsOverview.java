...
public class GetVenueDetailsOverview {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("venue/venue-details-overview:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/venues/{venueId}/details/overview", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetVenueDetailsOverviewRequest, GetVenueDetailsOverviewResponse> {
        ...
        private HttpRequest onBuildRequest(GetVenueDetailsOverviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVenueDetailsOverviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVenueDetailsOverviewRequest request) {
        ...
        @Override
        public GetVenueDetailsOverviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetVenueDetailsOverviewResponse.Builder resBuilder = GetVenueDetailsOverviewResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetVenueDetailsOverviewResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVenueDetailsOverview(
                            Utils.unmarshal(response, new TypeReference<VenueDetailsOverview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetVenueDetailsOverviewRequest, com.cvent.models.operations.async.GetVenueDetailsOverviewResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetVenueDetailsOverviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetVenueDetailsOverviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetVenueDetailsOverviewRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetVenueDetailsOverviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetVenueDetailsOverviewResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetVenueDetailsOverviewResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetVenueDetailsOverviewResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VenueDetailsOverview>() {})
                            .thenApply(res::withVenueDetailsOverview);
                } else {
