...
import com.cvent.models.components.PaginatedInternalDocuments;
...
public class ListRfpInternalDocuments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("rfp/rfp-internal-documents:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/internal-documents", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpInternalDocumentsRequest, ListRfpInternalDocumentsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpInternalDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpInternalDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpInternalDocumentsRequest request) {
        ...
        @Override
        public ListRfpInternalDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpInternalDocumentsResponse.Builder resBuilder = ListRfpInternalDocumentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpInternalDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedInternalDocuments(
                            Utils.unmarshal(response, new TypeReference<PaginatedInternalDocuments>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListRfpInternalDocumentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpInternalDocumentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListRfpInternalDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpInternalDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpInternalDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpInternalDocumentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpInternalDocumentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpInternalDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedInternalDocuments>() {})
                            .thenApply(res::withPaginatedInternalDocuments);
                } else {
