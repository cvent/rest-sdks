...
public class CreateSessionEnrollment {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/session-enrollment:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateSessionEnrollmentRequest, CreateSessionEnrollmentResponse> {
        ...
        private HttpRequest onBuildRequest(CreateSessionEnrollmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSessionEnrollmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateSessionEnrollmentRequest request) {
        ...
        @Override
        public CreateSessionEnrollmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateSessionEnrollmentResponse.Builder resBuilder = CreateSessionEnrollmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateSessionEnrollmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateSessionEnrollmentRequest, com.cvent.models.operations.async.CreateSessionEnrollmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateSessionEnrollmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateSessionEnrollmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateSessionEnrollmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateSessionEnrollmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateSessionEnrollmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateSessionEnrollmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateSessionEnrollmentResponse res = resBuilder.build();
