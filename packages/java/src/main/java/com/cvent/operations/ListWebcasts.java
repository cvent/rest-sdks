...
import com.cvent.models.components.WebcastPaginatedResponse;
...
public class ListWebcasts {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listWebcasts",
                    java.util.Optional.of(java.util.List.of("event/webcasts:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/webcasts");
    ...
    public static class Sync extends Base implements RequestOperation<ListWebcastsRequest, ListWebcastsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListWebcastsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWebcastsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListWebcastsRequest request) {
        ...
        @Override
        public ListWebcastsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListWebcastsResponse.Builder resBuilder = ListWebcastsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListWebcastsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWebcastPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<WebcastPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListWebcastsRequest, com.cvent.models.operations.async.ListWebcastsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListWebcastsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWebcastsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListWebcastsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListWebcastsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListWebcastsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListWebcastsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListWebcastsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<WebcastPaginatedResponse>() {})
                            .thenApply(res::withWebcastPaginatedResponse);
                } else {
