...
public class ListWebcasts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListWebcastsRequest, ListWebcastsResponse> {
        ...
        public ListWebcastsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListWebcastsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withWebcastPaginatedResponse(Utils.unmarshal(response, new TypeReference<WebcastPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListWebcastsRequest, com.cvent.models.operations.async.ListWebcastsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListWebcastsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListWebcastsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListWebcastsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
