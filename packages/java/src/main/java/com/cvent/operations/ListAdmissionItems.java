...
public class ListAdmissionItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/admission-items");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAdmissionItemsRequest, ListAdmissionItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListAdmissionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdmissionItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAdmissionItemsRequest request) {
        ...
        @Override
        public ListAdmissionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAdmissionItemsResponse.Builder resBuilder = ListAdmissionItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAdmissionItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAdmissionItemsRequest, com.cvent.models.operations.async.ListAdmissionItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAdmissionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAdmissionItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAdmissionItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAdmissionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAdmissionItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAdmissionItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAdmissionItemsResponse res = resBuilder.build();
