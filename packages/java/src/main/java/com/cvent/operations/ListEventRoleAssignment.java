...
public class ListEventRoleAssignment {
    ...
    public static class Sync extends Base
        ...
        public ListEventRoleAssignmentResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListEventRoleAssignmentResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventRoleAssignmentsPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventRoleAssignmentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEventRoleAssignmentRequest, com.cvent.models.operations.async.ListEventRoleAssignmentResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListEventRoleAssignmentResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListEventRoleAssignmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventRoleAssignmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
