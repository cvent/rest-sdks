...
public class ListEventRoleAssignment {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/role-assignments:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/event-roles/assignments");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventRoleAssignmentRequest, ListEventRoleAssignmentResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventRoleAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventRoleAssignmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventRoleAssignmentRequest request) {
        ...
        @Override
        public ListEventRoleAssignmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventRoleAssignmentResponse.Builder resBuilder = ListEventRoleAssignmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventRoleAssignmentResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventRoleAssignmentsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventRoleAssignmentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListEventRoleAssignmentRequest, com.cvent.models.operations.async.ListEventRoleAssignmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventRoleAssignmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventRoleAssignmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventRoleAssignmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventRoleAssignmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventRoleAssignmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventRoleAssignmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventRoleAssignmentResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventRoleAssignmentsPaginatedResponse>() {})
                            .thenApply(res::withEventRoleAssignmentsPaginatedResponse);
                } else {
