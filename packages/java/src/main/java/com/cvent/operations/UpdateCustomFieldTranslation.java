...
public class UpdateCustomFieldTranslation {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/custom-fields/{customFieldId}/translations", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "translation1", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateCustomFieldTranslationRequest, UpdateCustomFieldTranslationResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateCustomFieldTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateCustomFieldTranslationRequest.class,
                    new TypeReference<UpdateCustomFieldTranslationRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateCustomFieldTranslationRequest request) {
        ...
        @Override
        public UpdateCustomFieldTranslationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateCustomFieldTranslationResponse.Builder resBuilder = UpdateCustomFieldTranslationResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateCustomFieldTranslationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTranslation1(Utils.unmarshal(response, new TypeReference<Translation1>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.UpdateCustomFieldTranslationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCustomFieldTranslationRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateCustomFieldTranslationRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateCustomFieldTranslationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateCustomFieldTranslationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateCustomFieldTranslationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateCustomFieldTranslationResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateCustomFieldTranslationResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Translation1>() {})
                            .thenApply(res::withTranslation1);
                } else {
