...
public class UpdateCustomFieldTranslation {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateCustomFieldTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCustomFieldTranslationRequest.class, new TypeReference<UpdateCustomFieldTranslationRequest>() {});
        ...
        public UpdateCustomFieldTranslationResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateCustomFieldTranslationResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateCustomFieldTranslationRequest, com.cvent.models.operations.async.UpdateCustomFieldTranslationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateCustomFieldTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateCustomFieldTranslationRequest.class, new TypeReference<UpdateCustomFieldTranslationRequest>() {});
