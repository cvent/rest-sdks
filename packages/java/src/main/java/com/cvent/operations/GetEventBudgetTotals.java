...
public class GetEventBudgetTotals {
    ...
    public static class Sync extends Base
        ...
        public GetEventBudgetTotalsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventBudgetTotalsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventBudgetPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventBudgetPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventBudgetTotalsRequest, com.cvent.models.operations.async.GetEventBudgetTotalsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventBudgetTotalsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventBudgetTotalsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventBudgetTotalsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
