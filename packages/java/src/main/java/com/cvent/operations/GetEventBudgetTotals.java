...
public class GetEventBudgetTotals {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("budget/budget-totals:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/budget-totals", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventBudgetTotalsRequest, GetEventBudgetTotalsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetEventBudgetTotalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventBudgetTotalsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventBudgetTotalsRequest request) {
        ...
        @Override
        public GetEventBudgetTotalsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventBudgetTotalsResponse.Builder resBuilder = GetEventBudgetTotalsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventBudgetTotalsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventBudgetPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventBudgetPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventBudgetTotalsRequest, com.cvent.models.operations.async.GetEventBudgetTotalsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetEventBudgetTotalsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventBudgetTotalsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventBudgetTotalsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventBudgetTotalsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventBudgetTotalsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventBudgetTotalsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventBudgetTotalsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventBudgetPaginatedResponse>() {})
                            .thenApply(res::withEventBudgetPaginatedResponse);
                } else {
