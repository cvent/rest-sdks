...
public class DeleteBoothStaff {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "deleteBoothStaff",
                    java.util.Optional.of(java.util.List.of("exhibitor/booth-staff:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteBoothStaffRequest, DeleteBoothStaffResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBoothStaffRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteBoothStaffRequest request) {
        ...
        @Override
        public DeleteBoothStaffResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteBoothStaffResponse.Builder resBuilder =
            ...
            DeleteBoothStaffResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteBoothStaffRequest, com.cvent.models.operations.async.DeleteBoothStaffResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteBoothStaffRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteBoothStaffRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteBoothStaffRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteBoothStaffResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteBoothStaffResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteBoothStaffResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteBoothStaffResponse res = resBuilder.build();
