...
public class GetEmarketingEmailStatus {
    ...
    public static class Sync extends Base
        ...
        public GetEmarketingEmailStatusResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEmarketingEmailStatusResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSendEmailEmarketingResponse(Utils.unmarshal(response, new TypeReference<SendEmailEmarketingResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEmarketingEmailStatusRequest, com.cvent.models.operations.async.GetEmarketingEmailStatusResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetEmarketingEmailStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEmarketingEmailStatusRequest.class);
