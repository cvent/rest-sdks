...
import com.cvent.models.components.SendEmailEmarketingResponse;
...
public class GetEmarketingEmailStatus {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("emarketing/emarketing-email-status:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/emarketing/emails/{emailRequestId}/status", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEmarketingEmailStatusRequest, GetEmarketingEmailStatusResponse> {
        ...
        private HttpRequest onBuildRequest(GetEmarketingEmailStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEmarketingEmailStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEmarketingEmailStatusRequest request) {
        ...
        @Override
        public GetEmarketingEmailStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEmarketingEmailStatusResponse.Builder resBuilder = GetEmarketingEmailStatusResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEmarketingEmailStatusResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSendEmailEmarketingResponse(
                            Utils.unmarshal(response, new TypeReference<SendEmailEmarketingResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetEmarketingEmailStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEmarketingEmailStatusRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetEmarketingEmailStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEmarketingEmailStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEmarketingEmailStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEmarketingEmailStatusResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEmarketingEmailStatusResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEmarketingEmailStatusResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SendEmailEmarketingResponse>() {})
                            .thenApply(res::withSendEmailEmarketingResponse);
                } else {
