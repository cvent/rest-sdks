...
public class UpdateInternalInfoAnswers {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/attendees/{id}/internal-information-questions", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "attendeeInternalInfo", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateInternalInfoAnswersRequest, UpdateInternalInfoAnswersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateInternalInfoAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateInternalInfoAnswersRequest.class,
                    new TypeReference<UpdateInternalInfoAnswersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateInternalInfoAnswersRequest request) {
        ...
        @Override
        public UpdateInternalInfoAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateInternalInfoAnswersResponse.Builder resBuilder = UpdateInternalInfoAnswersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateInternalInfoAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInternalInfo(
                            Utils.unmarshal(response, new TypeReference<AttendeeInternalInfo>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.UpdateInternalInfoAnswersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateInternalInfoAnswersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateInternalInfoAnswersRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateInternalInfoAnswersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateInternalInfoAnswersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateInternalInfoAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateInternalInfoAnswersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateInternalInfoAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeInternalInfo>() {})
                            .thenApply(res::withAttendeeInternalInfo);
                } else {
