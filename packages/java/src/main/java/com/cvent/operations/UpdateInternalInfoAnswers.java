...
public class UpdateInternalInfoAnswers {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateInternalInfoAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateInternalInfoAnswersRequest.class, new TypeReference<UpdateInternalInfoAnswersRequest>() {});
        ...
        public UpdateInternalInfoAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateInternalInfoAnswersResponse.Builder resBuilder =
                    UpdateInternalInfoAnswersResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeInternalInfo(Utils.unmarshal(response, new TypeReference<AttendeeInternalInfo>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateInternalInfoAnswersRequest, com.cvent.models.operations.async.UpdateInternalInfoAnswersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateInternalInfoAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateInternalInfoAnswersRequest.class, new TypeReference<UpdateInternalInfoAnswersRequest>() {});
