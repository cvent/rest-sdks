...
public class ListAudienceSegments {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAudienceSegmentsRequest, ListAudienceSegmentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAudienceSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAudienceSegmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAudienceSegmentsRequest request) {
        ...
        @Override
        public ListAudienceSegmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAudienceSegmentsResponse.Builder resBuilder = ListAudienceSegmentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAudienceSegmentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAudienceSegmentsRequest, com.cvent.models.operations.async.ListAudienceSegmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAudienceSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAudienceSegmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAudienceSegmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAudienceSegmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAudienceSegmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAudienceSegmentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAudienceSegmentsResponse res = resBuilder.build();
