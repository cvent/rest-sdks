...
public class ListContacts {
    ...
    public static class Sync extends Base implements RequestOperation<ListContactsRequest, ListContactsResponse> {
        ...
        private HttpRequest onBuildRequest(ListContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListContactsRequest request) {
        ...
        @Override
        public ListContactsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListContactsResponse.Builder resBuilder = ListContactsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListContactsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListContactsRequest, com.cvent.models.operations.async.ListContactsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListContactsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListContactsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListContactsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListContactsResponse res = resBuilder.build();
