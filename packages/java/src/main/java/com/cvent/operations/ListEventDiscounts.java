...
public class ListEventDiscounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListEventDiscountsRequest, ListEventDiscountsResponse> {
        ...
        private HttpRequest onBuildRequest(ListEventDiscountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventDiscountsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListEventDiscountsRequest request) {
        ...
        @Override
        public ListEventDiscountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListEventDiscountsResponse.Builder resBuilder = ListEventDiscountsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListEventDiscountsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingDiscountPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ExistingDiscountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListEventDiscountsRequest, com.cvent.models.operations.async.ListEventDiscountsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListEventDiscountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListEventDiscountsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListEventDiscountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListEventDiscountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListEventDiscountsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventDiscountsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListEventDiscountsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingDiscountPaginatedResponse>() {})
                            .thenApply(res::withExistingDiscountPaginatedResponse);
                } else {
