...
public class ListEventDiscounts {
    ...
    public static class Sync extends Base
        ...
        public ListEventDiscountsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListEventDiscountsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingDiscountPaginatedResponse(Utils.unmarshal(response, new TypeReference<ExistingDiscountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListEventDiscountsRequest, com.cvent.models.operations.async.ListEventDiscountsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListEventDiscountsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListEventDiscountsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListEventDiscountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
