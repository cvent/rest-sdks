...
public class ListExhibitorFiles {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/files", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListExhibitorFilesRequest, ListExhibitorFilesResponse> {
        ...
        private HttpRequest onBuildRequest(ListExhibitorFilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorFilesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListExhibitorFilesRequest request) {
        ...
        @Override
        public ListExhibitorFilesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListExhibitorFilesResponse.Builder resBuilder = ListExhibitorFilesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListExhibitorFilesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFileListResponse(
                            Utils.unmarshal(response, new TypeReference<FileListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListExhibitorFilesRequest, com.cvent.models.operations.async.ListExhibitorFilesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListExhibitorFilesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorFilesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListExhibitorFilesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorFilesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListExhibitorFilesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorFilesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListExhibitorFilesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FileListResponse>() {})
                            .thenApply(res::withFileListResponse);
                } else {
