...
public class ListExhibitorFiles {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/events/{id}/exhibitors/{exhibitorId}/files",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        public ListExhibitorFilesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListExhibitorFilesResponse.Builder resBuilder =
                    ListExhibitorFilesResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFileListResponse(Utils.unmarshal(response, new TypeReference<FileListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListExhibitorFilesRequest, com.cvent.models.operations.async.ListExhibitorFilesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorFilesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListExhibitorFilesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorFilesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
