...
public class CreateTextTrack {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "createTextTrack",
                    java.util.Optional.of(java.util.List.of("event/videos:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "videoTextTrack", "json", false);
    ...
    public static class Sync extends Base implements RequestOperation<CreateTextTrackRequest, CreateTextTrackResponse> {
        ...
        private HttpRequest onBuildRequest(CreateTextTrackRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreateTextTrackRequest.class, new TypeReference<CreateTextTrackRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateTextTrackRequest request) {
        ...
        @Override
        public CreateTextTrackResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateTextTrackResponse.Builder resBuilder = CreateTextTrackResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateTextTrackResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingVideoTextTrack(
                            Utils.unmarshal(response, new TypeReference<ExistingVideoTextTrack>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateTextTrackRequest, com.cvent.models.operations.async.CreateTextTrackResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateTextTrackRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, CreateTextTrackRequest.class, new TypeReference<CreateTextTrackRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateTextTrackRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateTextTrackResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateTextTrackResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateTextTrackResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateTextTrackResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingVideoTextTrack>() {})
                            .thenApply(res::withExistingVideoTextTrack);
                } else {
