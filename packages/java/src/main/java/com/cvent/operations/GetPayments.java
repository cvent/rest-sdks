...
public class GetPayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPaymentsRequest, GetPaymentsResponse> {
        ...
        public GetPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetPaymentsResponse.Builder resBuilder =
                    GetPaymentsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentPaginatedResponse(Utils.unmarshal(response, new TypeReference<PaymentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetPaymentsRequest, com.cvent.models.operations.async.GetPaymentsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetPaymentsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetPaymentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
