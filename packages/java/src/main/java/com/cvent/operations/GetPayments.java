...
import com.cvent.models.components.PaymentPaginatedResponse;
...
public class GetPayments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getPayments",
                    java.util.Optional.of(java.util.List.of("budget/payments:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/budget-payments", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetPaymentsRequest, GetPaymentsResponse> {
        ...
        private HttpRequest onBuildRequest(GetPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPaymentsRequest request) {
        ...
        @Override
        public GetPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetPaymentsResponse.Builder resBuilder = GetPaymentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetPaymentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaymentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<PaymentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetPaymentsRequest, com.cvent.models.operations.async.GetPaymentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetPaymentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetPaymentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetPaymentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetPaymentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaymentPaginatedResponse>() {})
                            .thenApply(res::withPaymentPaginatedResponse);
                } else {
