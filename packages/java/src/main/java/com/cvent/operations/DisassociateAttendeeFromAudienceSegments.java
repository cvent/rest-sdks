...
public class DisassociateAttendeeFromAudienceSegments {
    ...
    public static class Sync extends Base
            implements RequestOperation<DisassociateAttendeeFromAudienceSegmentsRequest, DisassociateAttendeeFromAudienceSegmentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DisassociateAttendeeFromAudienceSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisassociateAttendeeFromAudienceSegmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DisassociateAttendeeFromAudienceSegmentsRequest request) {
        ...
        @Override
        public DisassociateAttendeeFromAudienceSegmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DisassociateAttendeeFromAudienceSegmentsResponse.Builder resBuilder =
            ...
            DisassociateAttendeeFromAudienceSegmentsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DisassociateAttendeeFromAudienceSegmentsRequest, com.cvent.models.operations.async.DisassociateAttendeeFromAudienceSegmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DisassociateAttendeeFromAudienceSegmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DisassociateAttendeeFromAudienceSegmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DisassociateAttendeeFromAudienceSegmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DisassociateAttendeeFromAudienceSegmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.DisassociateAttendeeFromAudienceSegmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DisassociateAttendeeFromAudienceSegmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DisassociateAttendeeFromAudienceSegmentsResponse res = resBuilder.build();
