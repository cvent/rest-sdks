...
public class CreateCardTransaction {
    ...
    public static class Sync extends Base
        ...
        public CreateCardTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateCardTransactionResponse.Builder resBuilder =
                    CreateCardTransactionResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardTransactionCreateResponse(Utils.unmarshal(response, new TypeReference<CardTransactionCreateResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CardTransactionCreate, com.cvent.models.operations.async.CreateCardTransactionResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.CreateCardTransactionResponse> handleResponse(
            ...
            com.cvent.models.operations.async.CreateCardTransactionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateCardTransactionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
