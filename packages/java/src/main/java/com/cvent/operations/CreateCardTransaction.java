...
public class CreateCardTransaction {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/cards/transactions");
    ...
    public static class Sync extends Base
            implements RequestOperation<CardTransactionCreate, CreateCardTransactionResponse> {
        ...
        private HttpRequest onBuildRequest(CardTransactionCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CardTransactionCreate>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CardTransactionCreate request) {
        ...
        @Override
        public CreateCardTransactionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateCardTransactionResponse.Builder resBuilder = CreateCardTransactionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateCardTransactionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CardTransactionCreate, com.cvent.models.operations.async.CreateCardTransactionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CardTransactionCreate request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<CardTransactionCreate>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CardTransactionCreate request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateCardTransactionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateCardTransactionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateCardTransactionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateCardTransactionResponse res = resBuilder.build();
