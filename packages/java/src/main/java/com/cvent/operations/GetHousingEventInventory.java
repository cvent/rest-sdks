...
public class GetHousingEventInventory {
    ...
    public static class Sync extends Base
        ...
        public GetHousingEventInventoryResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHousingEventInventoryResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInventoryDetailsList(Utils.unmarshal(response, new TypeReference<InventoryDetailsList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHousingEventInventoryRequest, com.cvent.models.operations.async.GetHousingEventInventoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventInventoryRequest.class);
