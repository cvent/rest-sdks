...
public class GetHousingEventInventory {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/housing-event-inventory:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/housing-events/{housingEventId}/inventory", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingEventInventoryRequest, GetHousingEventInventoryResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingEventInventoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventInventoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingEventInventoryRequest request) {
        ...
        @Override
        public GetHousingEventInventoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingEventInventoryResponse.Builder resBuilder = GetHousingEventInventoryResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingEventInventoryResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInventoryDetailsList(
                            Utils.unmarshal(response, new TypeReference<InventoryDetailsList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetHousingEventInventoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventInventoryRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventInventoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingEventInventoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventInventoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingEventInventoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventInventoryResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingEventInventoryResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InventoryDetailsList>() {})
                            .thenApply(res::withInventoryDetailsList);
                } else {
