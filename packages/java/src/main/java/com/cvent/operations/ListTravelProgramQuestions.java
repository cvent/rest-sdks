...
public class ListTravelProgramQuestions {
    ...
    public static class Sync extends Base
        ...
        public ListTravelProgramQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTravelProgramQuestionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuestionPaginatedResponse(Utils.unmarshal(response, new TypeReference<QuestionPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTravelProgramQuestionsRequest, com.cvent.models.operations.async.ListTravelProgramQuestionsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListTravelProgramQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProgramQuestionsRequest.class);
