...
import com.cvent.models.components.QuestionPaginatedResponse;
...
public class ListTravelProgramQuestions {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/travel-programs/{programId}/questions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTravelProgramQuestionsRequest, ListTravelProgramQuestionsResponse> {
        ...
        private HttpRequest onBuildRequest(ListTravelProgramQuestionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProgramQuestionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTravelProgramQuestionsRequest request) {
        ...
        @Override
        public ListTravelProgramQuestionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTravelProgramQuestionsResponse.Builder resBuilder = ListTravelProgramQuestionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTravelProgramQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuestionPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<QuestionPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListTravelProgramQuestionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTravelProgramQuestionsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProgramQuestionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTravelProgramQuestionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProgramQuestionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTravelProgramQuestionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProgramQuestionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTravelProgramQuestionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<QuestionPaginatedResponse>() {})
                            .thenApply(res::withQuestionPaginatedResponse);
                } else {
