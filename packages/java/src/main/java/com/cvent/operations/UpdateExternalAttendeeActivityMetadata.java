...
public class UpdateExternalAttendeeActivityMetadata {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/attendee-activities-metadata:write")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExternalAttendeeActivityMetadataRequest, UpdateExternalAttendeeActivityMetadataResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateExternalAttendeeActivityMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExternalAttendeeActivityMetadataRequest.class, new TypeReference<UpdateExternalAttendeeActivityMetadataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExternalAttendeeActivityMetadataRequest request) {
        ...
        @Override
        public UpdateExternalAttendeeActivityMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateExternalAttendeeActivityMetadataResponse.Builder resBuilder =
                    UpdateExternalAttendeeActivityMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            UpdateExternalAttendeeActivityMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExternalActivityMetadata(Utils.unmarshal(response, new TypeReference<ExternalActivityMetadata>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateExternalAttendeeActivityMetadataRequest, com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExternalAttendeeActivityMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExternalAttendeeActivityMetadataRequest.class, new TypeReference<UpdateExternalAttendeeActivityMetadataRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExternalAttendeeActivityMetadataRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExternalActivityMetadata>() {})
                            .thenApply(res::withExternalActivityMetadata);
                } else {
