...
public class UpdateExternalAttendeeActivityMetadata {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/attendees/activities/external/metadata/{id}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "externalActivityMetadata", "json", false);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateExternalAttendeeActivityMetadataRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<UpdateExternalAttendeeActivityMetadataRequest>() {});
        ...
        public UpdateExternalAttendeeActivityMetadataResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateExternalAttendeeActivityMetadataResponse.Builder resBuilder =
                    UpdateExternalAttendeeActivityMetadataResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExternalActivityMetadata(
                            Utils.unmarshal(response, new TypeReference<ExternalActivityMetadata>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExternalAttendeeActivityMetadataRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateExternalAttendeeActivityMetadataRequest.class,
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse>
            ...
            com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExternalAttendeeActivityMetadataResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
