...
public class GetMeetingRoomOverview {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/venues/{venueId}/meeting-rooms/{meetingRoomId}/overview", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMeetingRoomOverviewRequest, GetMeetingRoomOverviewResponse> {
        ...
        private HttpRequest onBuildRequest(GetMeetingRoomOverviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMeetingRoomOverviewRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMeetingRoomOverviewRequest request) {
        ...
        @Override
        public GetMeetingRoomOverviewResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetMeetingRoomOverviewResponse.Builder resBuilder = GetMeetingRoomOverviewResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetMeetingRoomOverviewResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRoomOverview(
                            Utils.unmarshal(response, new TypeReference<MeetingRoomOverview>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetMeetingRoomOverviewRequest, com.cvent.models.operations.async.GetMeetingRoomOverviewResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetMeetingRoomOverviewRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMeetingRoomOverviewRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMeetingRoomOverviewRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetMeetingRoomOverviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetMeetingRoomOverviewResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetMeetingRoomOverviewResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetMeetingRoomOverviewResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRoomOverview>() {})
                            .thenApply(res::withMeetingRoomOverview);
                } else {
