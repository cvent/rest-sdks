...
public class AddUserToAccountUserGroup {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("account/user-groups:write")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/account-user-groups/{userGroupId}/users/{userId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<AddUserToAccountUserGroupRequest, AddUserToAccountUserGroupResponse> {
        ...
        private HttpRequest onBuildRequest(AddUserToAccountUserGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddUserToAccountUserGroupRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AddUserToAccountUserGroupRequest request) {
        ...
        @Override
        public AddUserToAccountUserGroupResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            AddUserToAccountUserGroupResponse.Builder resBuilder = AddUserToAccountUserGroupResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            AddUserToAccountUserGroupResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.AddUserToAccountUserGroupResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AddUserToAccountUserGroupRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, AddUserToAccountUserGroupRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AddUserToAccountUserGroupRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.AddUserToAccountUserGroupResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.AddUserToAccountUserGroupResponse.Builder resBuilder =
                    com.cvent.models.operations.async.AddUserToAccountUserGroupResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.AddUserToAccountUserGroupResponse res = resBuilder.build();
