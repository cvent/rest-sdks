...
public class AddUserToAccountUserGroup {
    ...
    public static class Sync extends Base
        ...
        public AddUserToAccountUserGroupResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            AddUserToAccountUserGroupResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AddUserToAccountUserGroupRequest, com.cvent.models.operations.async.AddUserToAccountUserGroupResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(AddUserToAccountUserGroupRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AddUserToAccountUserGroupRequest.class);
