...
public class GetEventTableAssignments {
    ...
    public static class Sync extends Base
        ...
        public GetEventTableAssignmentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventTableAssignmentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTableAssignmentPaginatedResponse(Utils.unmarshal(response, new TypeReference<TableAssignmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventTableAssignmentsRequest, com.cvent.models.operations.async.GetEventTableAssignmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetEventTableAssignmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventTableAssignmentsRequest.class);
