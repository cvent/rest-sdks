...
public class GetEventTableAssignments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("seating/assignments:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/seatings/assignments", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventTableAssignmentsRequest, GetEventTableAssignmentsResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventTableAssignmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventTableAssignmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventTableAssignmentsRequest request) {
        ...
        @Override
        public GetEventTableAssignmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventTableAssignmentsResponse.Builder resBuilder = GetEventTableAssignmentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventTableAssignmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTableAssignmentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TableAssignmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetEventTableAssignmentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventTableAssignmentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetEventTableAssignmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventTableAssignmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventTableAssignmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventTableAssignmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventTableAssignmentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventTableAssignmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TableAssignmentPaginatedResponse>() {})
                            .thenApply(res::withTableAssignmentPaginatedResponse);
                } else {
