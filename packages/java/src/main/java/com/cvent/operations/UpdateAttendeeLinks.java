...
public class UpdateAttendeeLinks {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateAttendeeLinksRequest, UpdateAttendeeLinksResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateAttendeeLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAttendeeLinksRequest.class, new TypeReference<UpdateAttendeeLinksRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateAttendeeLinksRequest request) {
        ...
        @Override
        public UpdateAttendeeLinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateAttendeeLinksResponse.Builder resBuilder =
            ...
            UpdateAttendeeLinksResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateAttendeeLinksRequest, com.cvent.models.operations.async.UpdateAttendeeLinksResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateAttendeeLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateAttendeeLinksRequest.class, new TypeReference<UpdateAttendeeLinksRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateAttendeeLinksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateAttendeeLinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateAttendeeLinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateAttendeeLinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateAttendeeLinksResponse res = resBuilder.build();
