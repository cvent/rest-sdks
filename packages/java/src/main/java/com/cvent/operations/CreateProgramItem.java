...
public class CreateProgramItem {
    ...
    public static class Sync extends Base implements RequestOperation<ProgramItemInput, CreateProgramItemResponse> {
        ...
        private HttpRequest onBuildRequest(ProgramItemInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ProgramItemInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ProgramItemInput request) {
        ...
        @Override
        public CreateProgramItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateProgramItemResponse.Builder resBuilder = CreateProgramItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateProgramItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ProgramItemInput, com.cvent.models.operations.async.CreateProgramItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ProgramItemInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<ProgramItemInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ProgramItemInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateProgramItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateProgramItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateProgramItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateProgramItemResponse res = resBuilder.build();
