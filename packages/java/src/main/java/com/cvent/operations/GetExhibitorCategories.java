...
public class GetExhibitorCategories {
    ...
    public static class Sync extends Base
        ...
        public GetExhibitorCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetExhibitorCategoriesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoriesPaginatedResponse(Utils.unmarshal(response, new TypeReference<ExhibitorCategoriesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetExhibitorCategoriesRequest, com.cvent.models.operations.async.GetExhibitorCategoriesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorCategoriesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetExhibitorCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
