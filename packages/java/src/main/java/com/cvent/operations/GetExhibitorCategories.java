...
public class GetExhibitorCategories {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-categories:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<GetExhibitorCategoriesRequest, GetExhibitorCategoriesResponse> {
        ...
        private HttpRequest onBuildRequest(GetExhibitorCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetExhibitorCategoriesRequest request) {
        ...
        @Override
        public GetExhibitorCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetExhibitorCategoriesResponse.Builder resBuilder = GetExhibitorCategoriesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetExhibitorCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorCategoriesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorCategoriesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetExhibitorCategoriesRequest, com.cvent.models.operations.async.GetExhibitorCategoriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetExhibitorCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetExhibitorCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetExhibitorCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetExhibitorCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetExhibitorCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetExhibitorCategoriesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetExhibitorCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorCategoriesPaginatedResponse>() {})
                            .thenApply(res::withExhibitorCategoriesPaginatedResponse);
                } else {
