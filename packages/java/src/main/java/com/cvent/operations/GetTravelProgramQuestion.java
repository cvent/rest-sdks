...
public class GetTravelProgramQuestion {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/travel-programs/{programId}/questions/{questionId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTravelProgramQuestionRequest, GetTravelProgramQuestionResponse> {
        ...
        private HttpRequest onBuildRequest(GetTravelProgramQuestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTravelProgramQuestionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTravelProgramQuestionRequest request) {
        ...
        @Override
        public GetTravelProgramQuestionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTravelProgramQuestionResponse.Builder resBuilder = GetTravelProgramQuestionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTravelProgramQuestionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withQuestion(Utils.unmarshal(response, new TypeReference<Question>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetTravelProgramQuestionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetTravelProgramQuestionRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetTravelProgramQuestionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTravelProgramQuestionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTravelProgramQuestionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTravelProgramQuestionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTravelProgramQuestionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTravelProgramQuestionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Question>() {})
                            .thenApply(res::withQuestion);
                } else {
