...
public class GetEventCopyStatus {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/copy/{eventCopyId}/status", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventCopyStatusRequest, GetEventCopyStatusResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventCopyStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventCopyStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventCopyStatusRequest request) {
        ...
        @Override
        public GetEventCopyStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventCopyStatusResponse.Builder resBuilder = GetEventCopyStatusResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventCopyStatusResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventCopyStatusRequest, com.cvent.models.operations.async.GetEventCopyStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventCopyStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventCopyStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventCopyStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventCopyStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventCopyStatusResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventCopyStatusResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventCopyStatusResponse res = resBuilder.build();
