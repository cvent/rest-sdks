...
public class GetHousingEventReservations {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/reservations:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/housing-events/{housingEventId}/reservations", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingEventReservationsRequest, GetHousingEventReservationsResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingEventReservationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventReservationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingEventReservationsRequest request) {
        ...
        @Override
        public GetHousingEventReservationsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingEventReservationsResponse.Builder resBuilder = GetHousingEventReservationsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingEventReservationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReservationsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ReservationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetHousingEventReservationsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventReservationsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventReservationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingEventReservationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventReservationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingEventReservationsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventReservationsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingEventReservationsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ReservationsPaginatedResponse>() {})
                            .thenApply(res::withReservationsPaginatedResponse);
                } else {
