...
public class GetHousingEventReservations {
    ...
    public static class Sync extends Base
        ...
        public GetHousingEventReservationsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHousingEventReservationsResponse.Builder resBuilder =
                    GetHousingEventReservationsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withReservationsPaginatedResponse(Utils.unmarshal(response, new TypeReference<ReservationsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHousingEventReservationsRequest, com.cvent.models.operations.async.GetHousingEventReservationsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventReservationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventReservationsRequest.class);
