...
import com.cvent.models.components.EmailSendStatus;
...
public class GetEmailStatus {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getEmailStatus",
                    java.util.Optional.of(java.util.List.of("email/email-status:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/emails/{emailRequestId}/status", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetEmailStatusRequest, GetEmailStatusResponse> {
        ...
        private HttpRequest onBuildRequest(GetEmailStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEmailStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEmailStatusRequest request) {
        ...
        @Override
        public GetEmailStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEmailStatusResponse.Builder resBuilder = GetEmailStatusResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEmailStatusResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailSendStatus(Utils.unmarshal(response, new TypeReference<EmailSendStatus>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEmailStatusRequest, com.cvent.models.operations.async.GetEmailStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEmailStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEmailStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEmailStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEmailStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEmailStatusResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEmailStatusResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEmailStatusResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EmailSendStatus>() {})
                            .thenApply(res::withEmailSendStatus);
                } else {
