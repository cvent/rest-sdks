...
public class ListMeetingInterests {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/appointment-meeting-interests");
    ...
    public static class Sync extends Base
        ...
        public ListMeetingInterestsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListMeetingInterestsResponse.Builder resBuilder = ListMeetingInterestsResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAppointmentMeetingInterestsPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<AttendeeAppointmentMeetingInterestsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListMeetingInterestsRequest, com.cvent.models.operations.async.ListMeetingInterestsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingInterestsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListMeetingInterestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingInterestsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
