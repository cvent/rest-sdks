...
import com.cvent.models.components.AttendeeAppointmentMeetingInterestsPaginatedResponse;
...
public class ListMeetingInterests {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMeetingInterestsRequest, ListMeetingInterestsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListMeetingInterestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingInterestsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMeetingInterestsRequest request) {
        ...
        @Override
        public ListMeetingInterestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListMeetingInterestsResponse.Builder resBuilder =
            ...
            ListMeetingInterestsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAppointmentMeetingInterestsPaginatedResponse(Utils.unmarshal(response, new TypeReference<AttendeeAppointmentMeetingInterestsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListMeetingInterestsRequest, com.cvent.models.operations.async.ListMeetingInterestsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListMeetingInterestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingInterestsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMeetingInterestsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingInterestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMeetingInterestsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingInterestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMeetingInterestsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeAppointmentMeetingInterestsPaginatedResponse>() {})
                            .thenApply(res::withAttendeeAppointmentMeetingInterestsPaginatedResponse);
                } else {
