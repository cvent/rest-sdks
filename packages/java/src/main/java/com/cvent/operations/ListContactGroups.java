...
public class ListContactGroups {
    ...
    public static class Sync extends Base
        ...
        public ListContactGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListContactGroupsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactGroupPaginatedResponse(Utils.unmarshal(response, new TypeReference<ContactGroupPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListContactGroupsRequest, com.cvent.models.operations.async.ListContactGroupsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListContactGroupsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListContactGroupsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactGroupsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
