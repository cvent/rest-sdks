...
public class ListContactGroups {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/contact-groups");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListContactGroupsRequest, ListContactGroupsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListContactGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactGroupsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListContactGroupsRequest request) {
        ...
        @Override
        public ListContactGroupsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListContactGroupsResponse.Builder resBuilder = ListContactGroupsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListContactGroupsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactGroupPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ContactGroupPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListContactGroupsRequest, com.cvent.models.operations.async.ListContactGroupsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListContactGroupsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactGroupsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListContactGroupsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListContactGroupsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListContactGroupsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactGroupsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListContactGroupsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContactGroupPaginatedResponse>() {})
                            .thenApply(res::withContactGroupPaginatedResponse);
                } else {
