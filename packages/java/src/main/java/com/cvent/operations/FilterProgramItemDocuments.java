...
public class FilterProgramItemDocuments {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(FilterProgramItemDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FilterProgramItemDocumentsRequest.class, new TypeReference<FilterProgramItemDocumentsRequest>() {});
        ...
        public FilterProgramItemDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            FilterProgramItemDocumentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemDocumentPaginatedResponse(Utils.unmarshal(response, new TypeReference<ProgramItemDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FilterProgramItemDocumentsRequest, com.cvent.models.operations.async.FilterProgramItemDocumentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(FilterProgramItemDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, FilterProgramItemDocumentsRequest.class, new TypeReference<FilterProgramItemDocumentsRequest>() {});
