...
public class FilterProgramItemDocuments {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/program-items/docs/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<FilterProgramItemDocumentsRequest, FilterProgramItemDocumentsResponse> {
        ...
        private HttpRequest onBuildRequest(FilterProgramItemDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    FilterProgramItemDocumentsRequest.class,
                    new TypeReference<FilterProgramItemDocumentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FilterProgramItemDocumentsRequest request) {
        ...
        @Override
        public FilterProgramItemDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            FilterProgramItemDocumentsResponse.Builder resBuilder = FilterProgramItemDocumentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            FilterProgramItemDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withProgramItemDocumentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ProgramItemDocumentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.FilterProgramItemDocumentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(FilterProgramItemDocumentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    FilterProgramItemDocumentsRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FilterProgramItemDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.FilterProgramItemDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.FilterProgramItemDocumentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.FilterProgramItemDocumentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.FilterProgramItemDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ProgramItemDocumentPaginatedResponse>() {})
                            .thenApply(res::withProgramItemDocumentPaginatedResponse);
                } else {
