...
public class GetChoicesForQuestion {
    ...
    public static class Sync extends Base
        ...
        public GetChoicesForQuestionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetChoicesForQuestionResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventQuestionChoicesResponse(Utils.unmarshal(response, new TypeReference<EventQuestionChoicesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetChoicesForQuestionRequest, com.cvent.models.operations.async.GetChoicesForQuestionResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetChoicesForQuestionResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetChoicesForQuestionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetChoicesForQuestionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
