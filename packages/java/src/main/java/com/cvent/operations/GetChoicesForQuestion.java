...
public class GetChoicesForQuestion {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/event-questions/{questionId}/choices", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetChoicesForQuestionRequest, GetChoicesForQuestionResponse> {
        ...
        private HttpRequest onBuildRequest(GetChoicesForQuestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChoicesForQuestionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetChoicesForQuestionRequest request) {
        ...
        @Override
        public GetChoicesForQuestionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetChoicesForQuestionResponse.Builder resBuilder = GetChoicesForQuestionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetChoicesForQuestionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventQuestionChoicesResponse(
                            Utils.unmarshal(response, new TypeReference<EventQuestionChoicesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetChoicesForQuestionRequest, com.cvent.models.operations.async.GetChoicesForQuestionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetChoicesForQuestionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetChoicesForQuestionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetChoicesForQuestionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetChoicesForQuestionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetChoicesForQuestionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetChoicesForQuestionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetChoicesForQuestionResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventQuestionChoicesResponse>() {})
                            .thenApply(res::withEventQuestionChoicesResponse);
                } else {
