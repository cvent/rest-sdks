...
public class GetUsageTier {
    ...
    abstract static class Base {
        ...
        HttpRequest buildRequest() throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/usage/tier");
    ...
    public static class Sync extends Base implements RequestlessOperation<GetUsageTierResponse> {
        ...
        @Override
        public GetUsageTierResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetUsageTierResponse.Builder resBuilder = GetUsageTierResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetUsageTierResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPublicUsagePlan(Utils.unmarshal(response, new TypeReference<PublicUsagePlan>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestlessOperation<com.cvent.models.operations.async.GetUsageTierResponse> {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetUsageTierResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetUsageTierResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetUsageTierResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetUsageTierResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PublicUsagePlan>() {})
                            .thenApply(res::withPublicUsagePlan);
                } else {
