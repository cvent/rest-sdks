...
public class CreateStandardSurveyResponses {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "standardSurveyResponse", "json", false);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    ...
                    new TypeReference<CreateStandardSurveyResponsesRequest>() {});
        ...
        public CreateStandardSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateStandardSurveyResponsesResponse.Builder resBuilder = CreateStandardSurveyResponsesResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveyResponse(
                            Utils.unmarshal(response, new TypeReference<StandardSurveyResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateStandardSurveyResponsesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    CreateStandardSurveyResponsesRequest.class,
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse>
            ...
            com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
