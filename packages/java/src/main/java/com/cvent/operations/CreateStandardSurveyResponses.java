...
public class CreateStandardSurveyResponses {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateStandardSurveyResponsesRequest, CreateStandardSurveyResponsesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(CreateStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStandardSurveyResponsesRequest.class, new TypeReference<CreateStandardSurveyResponsesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateStandardSurveyResponsesRequest request) {
        ...
        @Override
        public CreateStandardSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateStandardSurveyResponsesResponse.Builder resBuilder =
                    CreateStandardSurveyResponsesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            CreateStandardSurveyResponsesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateStandardSurveyResponsesRequest, com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(CreateStandardSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateStandardSurveyResponsesRequest.class, new TypeReference<CreateStandardSurveyResponsesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateStandardSurveyResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateStandardSurveyResponsesResponse res = resBuilder.build();
