...
public class ListProgramItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/program-items");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListProgramItemsRequest, ListProgramItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListProgramItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListProgramItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListProgramItemsRequest request) {
        ...
        @Override
        public ListProgramItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListProgramItemsResponse.Builder resBuilder = ListProgramItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListProgramItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListProgramItemsRequest, com.cvent.models.operations.async.ListProgramItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListProgramItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListProgramItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListProgramItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListProgramItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListProgramItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListProgramItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListProgramItemsResponse res = resBuilder.build();
