...
public class DeleteEventCheckIn {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/check-in/{attendeeId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteEventCheckInRequest, DeleteEventCheckInResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteEventCheckInRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteEventCheckInRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteEventCheckInRequest request) {
        ...
        @Override
        public DeleteEventCheckInResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteEventCheckInResponse.Builder resBuilder = DeleteEventCheckInResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteEventCheckInResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteEventCheckInRequest, com.cvent.models.operations.async.DeleteEventCheckInResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteEventCheckInRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteEventCheckInRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteEventCheckInRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteEventCheckInResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteEventCheckInResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteEventCheckInResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteEventCheckInResponse res = resBuilder.build();
