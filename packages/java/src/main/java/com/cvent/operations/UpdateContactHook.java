...
import com.cvent.models.components.HookOutput;
...
public class UpdateContactHook {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "updateContactHook",
                    java.util.Optional.of(java.util.List.of("account/hooks:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/contacts/hooks/{id}", request, null);
            ...
            SerializedBody serializedRequestBody = Utils.serializeRequestBody(convertedRequest, "hook", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateContactHookRequest, UpdateContactHookResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateContactHookRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateContactHookRequest.class, new TypeReference<UpdateContactHookRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateContactHookRequest request) {
        ...
        @Override
        public UpdateContactHookResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateContactHookResponse.Builder resBuilder = UpdateContactHookResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateContactHookResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHook(Utils.unmarshal(response, new TypeReference<HookOutput>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateContactHookRequest, com.cvent.models.operations.async.UpdateContactHookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateContactHookRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateContactHookRequest.class, new TypeReference<UpdateContactHookRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateContactHookRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateContactHookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateContactHookResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateContactHookResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateContactHookResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HookOutput>() {})
                            .thenApply(res::withHook);
                } else {
