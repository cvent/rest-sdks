...
public class ListSessionSpeakers {
    ...
    public static class Sync extends Base
        ...
        public ListSessionSpeakersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSessionSpeakersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionSpeakerPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionSpeakerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSessionSpeakersRequest, com.cvent.models.operations.async.ListSessionSpeakersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSessionSpeakersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSessionSpeakersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionSpeakersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
