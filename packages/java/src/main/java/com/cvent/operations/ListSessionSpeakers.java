...
public class ListSessionSpeakers {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/sessions/{id}/speakers", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSessionSpeakersRequest, ListSessionSpeakersResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSessionSpeakersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionSpeakersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSessionSpeakersRequest request) {
        ...
        @Override
        public ListSessionSpeakersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSessionSpeakersResponse.Builder resBuilder = ListSessionSpeakersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSessionSpeakersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionSpeakerPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionSpeakerPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSessionSpeakersRequest, com.cvent.models.operations.async.ListSessionSpeakersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionSpeakersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionSpeakersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSessionSpeakersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionSpeakersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSessionSpeakersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionSpeakersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSessionSpeakersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionSpeakerPaginatedResponse>() {})
                            .thenApply(res::withSessionSpeakerPaginatedResponse);
                } else {
