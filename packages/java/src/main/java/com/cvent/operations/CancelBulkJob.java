...
public class CancelBulkJob {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/bulk-jobs/{id}/cancel", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<CancelBulkJobRequest, CancelBulkJobResponse> {
        ...
        private HttpRequest onBuildRequest(CancelBulkJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelBulkJobRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CancelBulkJobRequest request) {
        ...
        @Override
        public CancelBulkJobResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CancelBulkJobResponse.Builder resBuilder = CancelBulkJobResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CancelBulkJobResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CancelBulkJobRequest, com.cvent.models.operations.async.CancelBulkJobResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CancelBulkJobRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CancelBulkJobRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CancelBulkJobRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CancelBulkJobResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CancelBulkJobResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CancelBulkJobResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CancelBulkJobResponse res = resBuilder.build();
