...
public class GetEventSurveyResponses {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/surveys/{surveyId}/responses", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventSurveyResponsesRequest, GetEventSurveyResponsesResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyResponsesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventSurveyResponsesRequest request) {
        ...
        @Override
        public GetEventSurveyResponsesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventSurveyResponsesResponse.Builder resBuilder = GetEventSurveyResponsesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventSurveyResponsesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventSurveyResponsesRequest, com.cvent.models.operations.async.GetEventSurveyResponsesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventSurveyResponsesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventSurveyResponsesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventSurveyResponsesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventSurveyResponsesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventSurveyResponsesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventSurveyResponsesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventSurveyResponsesResponse res = resBuilder.build();
