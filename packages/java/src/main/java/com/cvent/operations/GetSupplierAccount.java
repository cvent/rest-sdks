...
import com.cvent.models.components.TravelAccountSupplierAccount;
...
public class GetSupplierAccount {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/travel-accounts/{travelAccountId}/supplier-accounts", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSupplierAccountRequest, GetSupplierAccountResponse> {
        ...
        private HttpRequest onBuildRequest(GetSupplierAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSupplierAccountRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSupplierAccountRequest request) {
        ...
        @Override
        public GetSupplierAccountResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSupplierAccountResponse.Builder resBuilder = GetSupplierAccountResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSupplierAccountResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccountSupplierAccount(
                            Utils.unmarshal(response, new TypeReference<TravelAccountSupplierAccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSupplierAccountRequest, com.cvent.models.operations.async.GetSupplierAccountResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSupplierAccountRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSupplierAccountRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSupplierAccountRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSupplierAccountResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSupplierAccountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSupplierAccountResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSupplierAccountResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelAccountSupplierAccount>() {})
                            .thenApply(res::withTravelAccountSupplierAccount);
                } else {
