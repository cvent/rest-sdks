...
public class GetSupplierAccount {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/travel-accounts/{travelAccountId}/supplier-accounts",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        public GetSupplierAccountResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSupplierAccountResponse.Builder resBuilder =
                    GetSupplierAccountResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelAccountSupplierAccount(Utils.unmarshal(response, new TypeReference<TravelAccountSupplierAccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSupplierAccountRequest, com.cvent.models.operations.async.GetSupplierAccountResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSupplierAccountResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSupplierAccountResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSupplierAccountResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
