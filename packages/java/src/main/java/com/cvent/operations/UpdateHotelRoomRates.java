...
public class UpdateHotelRoomRates {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/housing-hotels/{hotelCode}/rooms/{roomCode}/rates",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateHotelRoomRatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateHotelRoomRatesRequest.class, new TypeReference<UpdateHotelRoomRatesRequest>() {});
        ...
        public UpdateHotelRoomRatesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateHotelRoomRatesResponse.Builder resBuilder =
                    UpdateHotelRoomRatesResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHotelRoomRatesResponse(Utils.unmarshal(response, new TypeReference<HotelRoomRatesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateHotelRoomRatesRequest, com.cvent.models.operations.async.UpdateHotelRoomRatesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateHotelRoomRatesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateHotelRoomRatesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateHotelRoomRatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
