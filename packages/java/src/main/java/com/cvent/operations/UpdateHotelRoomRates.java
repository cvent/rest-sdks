...
public class UpdateHotelRoomRates {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/hotel-room-rates:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/housing-hotels/{hotelCode}/rooms/{roomCode}/rates", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "hotelRoomRatesRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateHotelRoomRatesRequest, UpdateHotelRoomRatesResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateHotelRoomRatesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateHotelRoomRatesRequest.class, new TypeReference<UpdateHotelRoomRatesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateHotelRoomRatesRequest request) {
        ...
        @Override
        public UpdateHotelRoomRatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateHotelRoomRatesResponse.Builder resBuilder = UpdateHotelRoomRatesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateHotelRoomRatesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHotelRoomRatesResponse(
                            Utils.unmarshal(response, new TypeReference<HotelRoomRatesResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateHotelRoomRatesRequest, com.cvent.models.operations.async.UpdateHotelRoomRatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateHotelRoomRatesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateHotelRoomRatesRequest.class, new TypeReference<UpdateHotelRoomRatesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateHotelRoomRatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateHotelRoomRatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateHotelRoomRatesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateHotelRoomRatesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateHotelRoomRatesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HotelRoomRatesResponse>() {})
                            .thenApply(res::withHotelRoomRatesResponse);
                } else {
