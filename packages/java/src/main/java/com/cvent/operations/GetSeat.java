...
import com.cvent.models.components.ExistingSeat;
...
public class GetSeat {
    ...
    public static class Sync extends Base implements RequestOperation<GetSeatRequest, GetSeatResponse> {
        ...
        private HttpRequest onBuildRequest(GetSeatRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSeatRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSeatRequest request) {
        ...
        @Override
        public GetSeatResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSeatResponse.Builder resBuilder = GetSeatResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSeatResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSeat(Utils.unmarshal(response, new TypeReference<ExistingSeat>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSeatRequest, com.cvent.models.operations.async.GetSeatResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSeatRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSeatRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSeatRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSeatResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSeatResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSeatResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSeatResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingSeat>() {})
                            .thenApply(res::withExistingSeat);
                } else {
