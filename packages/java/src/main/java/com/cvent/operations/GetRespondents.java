...
public class GetRespondents {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRespondentsRequest, GetRespondentsResponse> {
        ...
        public GetRespondentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetRespondentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRespondentsPaginatedResponse(Utils.unmarshal(response, new TypeReference<RespondentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetRespondentsRequest, com.cvent.models.operations.async.GetRespondentsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetRespondentsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetRespondentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRespondentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
