...
public class GetRespondents {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getRespondents",
                    java.util.Optional.of(java.util.List.of("survey/respondents:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/respondents");
    ...
    public static class Sync extends Base implements RequestOperation<GetRespondentsRequest, GetRespondentsResponse> {
        ...
        private HttpRequest onBuildRequest(GetRespondentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRespondentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRespondentsRequest request) {
        ...
        @Override
        public GetRespondentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRespondentsResponse.Builder resBuilder = GetRespondentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRespondentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRespondentsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<RespondentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetRespondentsRequest, com.cvent.models.operations.async.GetRespondentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRespondentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRespondentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRespondentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRespondentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRespondentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRespondentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRespondentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RespondentsPaginatedResponse>() {})
                            .thenApply(res::withRespondentsPaginatedResponse);
                } else {
