...
public class GetCommunicationLogMessages {
    ...
    public static class Sync extends Base
        ...
        public GetCommunicationLogMessagesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetCommunicationLogMessagesResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCommunicationLogMessagesRequest, com.cvent.models.operations.async.GetCommunicationLogMessagesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCommunicationLogMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommunicationLogMessagesRequest.class);
