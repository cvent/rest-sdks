...
public class GetCommunicationLogMessages {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/logs/communications/messages");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCommunicationLogMessagesRequest, GetCommunicationLogMessagesResponse> {
        ...
        private HttpRequest onBuildRequest(GetCommunicationLogMessagesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCommunicationLogMessagesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCommunicationLogMessagesRequest request) {
        ...
        @Override
        public GetCommunicationLogMessagesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetCommunicationLogMessagesResponse.Builder resBuilder = GetCommunicationLogMessagesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetCommunicationLogMessagesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetCommunicationLogMessagesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCommunicationLogMessagesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetCommunicationLogMessagesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCommunicationLogMessagesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetCommunicationLogMessagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetCommunicationLogMessagesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCommunicationLogMessagesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetCommunicationLogMessagesResponse res = resBuilder.build();
