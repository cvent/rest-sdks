...
public class UpdateExhibitorCategory {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitor-categories/{exhibitorCategoryId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorCategoryRequest, UpdateExhibitorCategoryResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateExhibitorCategoryRequest.class,
                    new TypeReference<UpdateExhibitorCategoryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorCategoryRequest request) {
        ...
        @Override
        public UpdateExhibitorCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateExhibitorCategoryResponse.Builder resBuilder = UpdateExhibitorCategoryResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateExhibitorCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateExhibitorCategoryRequest, com.cvent.models.operations.async.UpdateExhibitorCategoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateExhibitorCategoryRequest.class,
                    new TypeReference<UpdateExhibitorCategoryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorCategoryResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorCategoryResponse res = resBuilder.build();
