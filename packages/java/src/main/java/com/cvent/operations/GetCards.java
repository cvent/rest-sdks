...
public class GetCards {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getCards",
                    java.util.Optional.of(java.util.List.of("budget/cards:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/cards");
    ...
    public static class Sync extends Base implements RequestOperation<GetCardsRequest, GetCardsResponse> {
        ...
        private HttpRequest onBuildRequest(GetCardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCardsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCardsRequest request) {
        ...
        @Override
        public GetCardsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetCardsResponse.Builder resBuilder = GetCardsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetCardsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardDetailsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<CardDetailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCardsRequest, com.cvent.models.operations.async.GetCardsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetCardsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCardsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCardsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetCardsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetCardsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCardsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetCardsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CardDetailsPaginatedResponse>() {})
                            .thenApply(res::withCardDetailsPaginatedResponse);
                } else {
