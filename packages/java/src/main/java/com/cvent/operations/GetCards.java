...
public class GetCards {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCardsRequest, GetCardsResponse> {
        ...
        public GetCardsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetCardsResponse.Builder resBuilder =
                    GetCardsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCardDetailsPaginatedResponse(Utils.unmarshal(response, new TypeReference<CardDetailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetCardsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetCardsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetCardsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
