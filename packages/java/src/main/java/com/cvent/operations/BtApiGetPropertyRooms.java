...
public class BtApiGetPropertyRooms {
    ...
    public static class Sync extends Base
        ...
        public BtApiGetPropertyRoomsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            BtApiGetPropertyRoomsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPropertyRoomPaginatedResponse(Utils.unmarshal(response, new TypeReference<PropertyRoomPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<BtApiGetPropertyRoomsRequest, com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
