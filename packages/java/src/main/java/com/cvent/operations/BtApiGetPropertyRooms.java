...
public class BtApiGetPropertyRooms {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("business-transient/supplier-property-rooms:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-suppliers/property-rooms");
    ...
    public static class Sync extends Base
            implements RequestOperation<BtApiGetPropertyRoomsRequest, BtApiGetPropertyRoomsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(BtApiGetPropertyRoomsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, BtApiGetPropertyRoomsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(BtApiGetPropertyRoomsRequest request) {
        ...
        @Override
        public BtApiGetPropertyRoomsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            BtApiGetPropertyRoomsResponse.Builder resBuilder = BtApiGetPropertyRoomsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            BtApiGetPropertyRoomsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPropertyRoomPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<PropertyRoomPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    BtApiGetPropertyRoomsRequest, com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(BtApiGetPropertyRoomsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, BtApiGetPropertyRoomsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(BtApiGetPropertyRoomsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.BtApiGetPropertyRoomsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PropertyRoomPaginatedResponse>() {})
                            .thenApply(res::withPropertyRoomPaginatedResponse);
                } else {
