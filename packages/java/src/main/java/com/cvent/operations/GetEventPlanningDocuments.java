...
public class GetEventPlanningDocuments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/planning-documents:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/planning-documents", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventPlanningDocumentsRequest, GetEventPlanningDocumentsResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventPlanningDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventPlanningDocumentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventPlanningDocumentsRequest request) {
        ...
        @Override
        public GetEventPlanningDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventPlanningDocumentsResponse.Builder resBuilder = GetEventPlanningDocumentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventPlanningDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPlanningDocumentsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<PlanningDocumentsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetEventPlanningDocumentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventPlanningDocumentsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetEventPlanningDocumentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventPlanningDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventPlanningDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventPlanningDocumentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventPlanningDocumentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventPlanningDocumentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PlanningDocumentsPaginatedResponse>() {})
                            .thenApply(res::withPlanningDocumentsPaginatedResponse);
                } else {
