...
public class ListRfpRecipientsHistory {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("rfp/rfp-recipients-history:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/recipients/history", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpRecipientsHistoryRequest, ListRfpRecipientsHistoryResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpRecipientsHistoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpRecipientsHistoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpRecipientsHistoryRequest request) {
        ...
        @Override
        public ListRfpRecipientsHistoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpRecipientsHistoryResponse.Builder resBuilder = ListRfpRecipientsHistoryResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpRecipientsHistoryResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpRecipientsHistory(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpRecipientsHistory>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListRfpRecipientsHistoryResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpRecipientsHistoryRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListRfpRecipientsHistoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpRecipientsHistoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpRecipientsHistoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpRecipientsHistoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpRecipientsHistoryResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpRecipientsHistoryResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpRecipientsHistory>() {})
                            .thenApply(res::withPaginatedRfpRecipientsHistory);
                } else {
