...
public class ListSpeakersCategories {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/speaker-categories:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/speaker-categories");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSpeakersCategoriesRequest, ListSpeakersCategoriesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSpeakersCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakersCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSpeakersCategoriesRequest request) {
        ...
        @Override
        public ListSpeakersCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSpeakersCategoriesResponse.Builder resBuilder = ListSpeakersCategoriesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSpeakersCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerCategoryPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SpeakerCategoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSpeakersCategoriesRequest, com.cvent.models.operations.async.ListSpeakersCategoriesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSpeakersCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakersCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSpeakersCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakersCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSpeakersCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakersCategoriesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSpeakersCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SpeakerCategoryPaginatedResponse>() {})
                            .thenApply(res::withSpeakerCategoryPaginatedResponse);
                } else {
