...
public class ListSpeakersCategories {
    ...
    public static class Sync extends Base
        ...
        public ListSpeakersCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSpeakersCategoriesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerCategoryPaginatedResponse(Utils.unmarshal(response, new TypeReference<SpeakerCategoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSpeakersCategoriesRequest, com.cvent.models.operations.async.ListSpeakersCategoriesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakersCategoriesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSpeakersCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakersCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
