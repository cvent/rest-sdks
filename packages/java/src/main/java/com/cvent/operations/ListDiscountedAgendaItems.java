...
import com.cvent.models.components.DiscountAgendaItemsPaginatedResponse;
...
public class ListDiscountedAgendaItems {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/event-discounts:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/discounts/agenda-items", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListDiscountedAgendaItemsRequest, ListDiscountedAgendaItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListDiscountedAgendaItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDiscountedAgendaItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListDiscountedAgendaItemsRequest request) {
        ...
        @Override
        public ListDiscountedAgendaItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListDiscountedAgendaItemsResponse.Builder resBuilder = ListDiscountedAgendaItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListDiscountedAgendaItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDiscountAgendaItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<DiscountAgendaItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListDiscountedAgendaItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListDiscountedAgendaItemsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListDiscountedAgendaItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListDiscountedAgendaItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListDiscountedAgendaItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListDiscountedAgendaItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListDiscountedAgendaItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListDiscountedAgendaItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DiscountAgendaItemsPaginatedResponse>() {})
                            .thenApply(res::withDiscountAgendaItemsPaginatedResponse);
                } else {
