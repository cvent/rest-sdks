...
public class ListDiscountedAgendaItems {
    ...
    public static class Sync extends Base
        ...
        public ListDiscountedAgendaItemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListDiscountedAgendaItemsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDiscountAgendaItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<DiscountAgendaItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListDiscountedAgendaItemsRequest, com.cvent.models.operations.async.ListDiscountedAgendaItemsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListDiscountedAgendaItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListDiscountedAgendaItemsRequest.class);
