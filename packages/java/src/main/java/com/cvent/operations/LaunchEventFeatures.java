...
public class LaunchEventFeatures {
    ...
    static abstract class Base {
        ...
        <T, U>HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/events/{id}/features/{type}/launch",
                    request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(LaunchEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LaunchEventFeaturesRequest.class, new TypeReference<LaunchEventFeaturesRequest>() {});
        ...
        public LaunchEventFeaturesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            LaunchEventFeaturesResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LaunchEventFeaturesRequest, com.cvent.models.operations.async.LaunchEventFeaturesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.LaunchEventFeaturesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.LaunchEventFeaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.LaunchEventFeaturesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
