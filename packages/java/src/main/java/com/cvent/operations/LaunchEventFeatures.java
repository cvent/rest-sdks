...
public class LaunchEventFeatures {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/features/{type}/launch", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "eventFeatureLaunchRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<LaunchEventFeaturesRequest, LaunchEventFeaturesResponse> {
        ...
        private HttpRequest onBuildRequest(LaunchEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, LaunchEventFeaturesRequest.class, new TypeReference<LaunchEventFeaturesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LaunchEventFeaturesRequest request) {
        ...
        @Override
        public LaunchEventFeaturesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            LaunchEventFeaturesResponse.Builder resBuilder = LaunchEventFeaturesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            LaunchEventFeaturesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    LaunchEventFeaturesRequest, com.cvent.models.operations.async.LaunchEventFeaturesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LaunchEventFeaturesRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, LaunchEventFeaturesRequest.class, new TypeReference<LaunchEventFeaturesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LaunchEventFeaturesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.LaunchEventFeaturesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.LaunchEventFeaturesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.LaunchEventFeaturesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.LaunchEventFeaturesResponse res = resBuilder.build();
