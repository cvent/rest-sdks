...
public class EventCheckIn {
    ...
    public static class Sync extends Base
            implements RequestOperation<EventCheckInRequest, EventCheckInResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(EventCheckInRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EventCheckInRequest.class, new TypeReference<EventCheckInRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EventCheckInRequest request) {
        ...
        @Override
        public EventCheckInResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EventCheckInResponse.Builder resBuilder =
            ...
            EventCheckInResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "207")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeAddBulkResponseEvent(Utils.unmarshal(response, new TypeReference<List<AttendeeAddBulkItemEventJson>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EventCheckInRequest, com.cvent.models.operations.async.EventCheckInResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(EventCheckInRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EventCheckInRequest.class, new TypeReference<EventCheckInRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EventCheckInRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.EventCheckInResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.EventCheckInResponse.Builder resBuilder =
                    com.cvent.models.operations.async.EventCheckInResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.EventCheckInResponse res = resBuilder.build();
