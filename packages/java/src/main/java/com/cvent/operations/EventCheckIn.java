...
public class EventCheckIn {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/check-in", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<EventCheckInRequest, EventCheckInResponse> {
        ...
        private HttpRequest onBuildRequest(EventCheckInRequest request) throws Exception {
            HttpRequest req =
                    buildRequest(request, EventCheckInRequest.class, new TypeReference<EventCheckInRequest>() {});
        ...
        public EventCheckInResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            EventCheckInResponse.Builder resBuilder = EventCheckInResponse.builder()
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    EventCheckInRequest, com.cvent.models.operations.async.EventCheckInResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.EventCheckInResponse> handleResponse(
            ...
            com.cvent.models.operations.async.EventCheckInResponse.Builder resBuilder =
                    com.cvent.models.operations.async.EventCheckInResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
