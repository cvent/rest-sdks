...
public class GetAccountTransactions {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/transactions");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountTransactionsRequest, GetAccountTransactionsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountTransactionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountTransactionsRequest request) {
        ...
        @Override
        public GetAccountTransactionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountTransactionsResponse.Builder resBuilder = GetAccountTransactionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountTransactionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionDetailsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TransactionDetailsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAccountTransactionsRequest, com.cvent.models.operations.async.GetAccountTransactionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountTransactionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountTransactionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountTransactionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountTransactionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountTransactionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountTransactionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountTransactionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionDetailsPaginatedResponse>() {})
                            .thenApply(res::withTransactionDetailsPaginatedResponse);
                } else {
