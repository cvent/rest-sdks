...
public class ListContactTypes {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/contact-types");
    ...
    public static class Sync extends Base
        ...
        public ListContactTypesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListContactTypesResponse.Builder resBuilder = ListContactTypesResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContactTypePaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<ContactTypePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListContactTypesRequest, com.cvent.models.operations.async.ListContactTypesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListContactTypesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListContactTypesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactTypesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
