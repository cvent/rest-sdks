...
import com.cvent.models.components.HousingEventSummaryList;
...
public class GetHousingEventsSummaries {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("housing/housing-events:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/housing-events/summaries");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHousingEventsSummariesRequest, GetHousingEventsSummariesResponse> {
        ...
        private HttpRequest onBuildRequest(GetHousingEventsSummariesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventsSummariesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHousingEventsSummariesRequest request) {
        ...
        @Override
        public GetHousingEventsSummariesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHousingEventsSummariesResponse.Builder resBuilder = GetHousingEventsSummariesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHousingEventsSummariesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEventSummaryList(
                            Utils.unmarshal(response, new TypeReference<HousingEventSummaryList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetHousingEventsSummariesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventsSummariesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventsSummariesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHousingEventsSummariesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHousingEventsSummariesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHousingEventsSummariesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHousingEventsSummariesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHousingEventsSummariesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HousingEventSummaryList>() {})
                            .thenApply(res::withHousingEventSummaryList);
                } else {
