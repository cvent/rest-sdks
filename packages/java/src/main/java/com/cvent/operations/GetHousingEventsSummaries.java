...
public class GetHousingEventsSummaries {
    ...
    public static class Sync extends Base
        ...
        public GetHousingEventsSummariesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHousingEventsSummariesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHousingEventSummaryList(Utils.unmarshal(response, new TypeReference<HousingEventSummaryList>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHousingEventsSummariesRequest, com.cvent.models.operations.async.GetHousingEventsSummariesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetHousingEventsSummariesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHousingEventsSummariesRequest.class);
