...
public class GetOrderItems {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrderItemsRequest, GetOrderItemsResponse> {
        ...
        public GetOrderItemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetOrderItemsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOrderItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<OrderItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetOrderItemsRequest, com.cvent.models.operations.async.GetOrderItemsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetOrderItemsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetOrderItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetOrderItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
