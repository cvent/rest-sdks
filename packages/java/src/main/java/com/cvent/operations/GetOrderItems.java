...
public class GetOrderItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/orders/items", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetOrderItemsRequest, GetOrderItemsResponse> {
        ...
        private HttpRequest onBuildRequest(GetOrderItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrderItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrderItemsRequest request) {
        ...
        @Override
        public GetOrderItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetOrderItemsResponse.Builder resBuilder = GetOrderItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetOrderItemsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetOrderItemsRequest, com.cvent.models.operations.async.GetOrderItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetOrderItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetOrderItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetOrderItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetOrderItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetOrderItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetOrderItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetOrderItemsResponse res = resBuilder.build();
