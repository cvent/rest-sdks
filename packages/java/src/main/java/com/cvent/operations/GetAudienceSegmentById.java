...
public class GetAudienceSegmentById {
    ...
    public static class Sync extends Base
        ...
        public GetAudienceSegmentByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAudienceSegmentByIdResponse.Builder resBuilder =
                    GetAudienceSegmentByIdResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAudienceSegmentResponse(Utils.unmarshal(response, new TypeReference<AudienceSegmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAudienceSegmentByIdRequest, com.cvent.models.operations.async.GetAudienceSegmentByIdResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAudienceSegmentByIdResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAudienceSegmentByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAudienceSegmentByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
