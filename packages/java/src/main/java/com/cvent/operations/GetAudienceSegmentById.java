...
public class GetAudienceSegmentById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/audience-segments/{audienceSegmentId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAudienceSegmentByIdRequest, GetAudienceSegmentByIdResponse> {
        ...
        private HttpRequest onBuildRequest(GetAudienceSegmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAudienceSegmentByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAudienceSegmentByIdRequest request) {
        ...
        @Override
        public GetAudienceSegmentByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAudienceSegmentByIdResponse.Builder resBuilder = GetAudienceSegmentByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAudienceSegmentByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAudienceSegmentResponse(
                            Utils.unmarshal(response, new TypeReference<AudienceSegmentResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAudienceSegmentByIdRequest, com.cvent.models.operations.async.GetAudienceSegmentByIdResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAudienceSegmentByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAudienceSegmentByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAudienceSegmentByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAudienceSegmentByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAudienceSegmentByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAudienceSegmentByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAudienceSegmentByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AudienceSegmentResponse>() {})
                            .thenApply(res::withAudienceSegmentResponse);
                } else {
