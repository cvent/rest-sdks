...
public class ListAttendeeActivities {
    ...
    public static class Sync extends Base
        ...
        public ListAttendeeActivitiesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAttendeeActivitiesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeActivitiesPaginatedResponse(Utils.unmarshal(response, new TypeReference<AttendeeActivitiesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAttendeeActivitiesRequest, com.cvent.models.operations.async.ListAttendeeActivitiesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAttendeeActivitiesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAttendeeActivitiesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAttendeeActivitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
