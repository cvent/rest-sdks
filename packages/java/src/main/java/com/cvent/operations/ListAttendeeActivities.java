...
import com.cvent.models.components.AttendeeActivitiesPaginatedResponse;
...
public class ListAttendeeActivities {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/attendee-activities:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/attendees/activities");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAttendeeActivitiesRequest, ListAttendeeActivitiesResponse> {
        ...
        private HttpRequest onBuildRequest(ListAttendeeActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeeActivitiesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAttendeeActivitiesRequest request) {
        ...
        @Override
        public ListAttendeeActivitiesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAttendeeActivitiesResponse.Builder resBuilder = ListAttendeeActivitiesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAttendeeActivitiesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeActivitiesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AttendeeActivitiesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAttendeeActivitiesRequest, com.cvent.models.operations.async.ListAttendeeActivitiesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListAttendeeActivitiesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAttendeeActivitiesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAttendeeActivitiesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAttendeeActivitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAttendeeActivitiesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAttendeeActivitiesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAttendeeActivitiesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeActivitiesPaginatedResponse>() {})
                            .thenApply(res::withAttendeeActivitiesPaginatedResponse);
                } else {
