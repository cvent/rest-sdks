...
public class ListMeetingRoomsOverviews {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("venue/meeting-room-overviews:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/venues/{venueId}/meeting-rooms/overviews", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListMeetingRoomsOverviewsRequest, ListMeetingRoomsOverviewsResponse> {
        ...
        private HttpRequest onBuildRequest(ListMeetingRoomsOverviewsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRoomsOverviewsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListMeetingRoomsOverviewsRequest request) {
        ...
        @Override
        public ListMeetingRoomsOverviewsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListMeetingRoomsOverviewsResponse.Builder resBuilder = ListMeetingRoomsOverviewsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListMeetingRoomsOverviewsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRoomsOverviewResponse(
                            Utils.unmarshal(response, new TypeReference<MeetingRoomsOverviewResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.ListMeetingRoomsOverviewsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListMeetingRoomsOverviewsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListMeetingRoomsOverviewsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListMeetingRoomsOverviewsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListMeetingRoomsOverviewsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListMeetingRoomsOverviewsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListMeetingRoomsOverviewsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListMeetingRoomsOverviewsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRoomsOverviewResponse>() {})
                            .thenApply(res::withMeetingRoomsOverviewResponse);
                } else {
