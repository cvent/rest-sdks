...
public class DeleteContactById {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "deleteContactById",
                    java.util.Optional.of(java.util.List.of("event/contacts:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteContactByIdRequest, DeleteContactByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteContactByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteContactByIdRequest request) {
        ...
        @Override
        public DeleteContactByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteContactByIdResponse.Builder resBuilder = DeleteContactByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteContactByIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteContactByIdRequest, com.cvent.models.operations.async.DeleteContactByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteContactByIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteContactByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteContactByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteContactByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteContactByIdResponse res = resBuilder.build();
