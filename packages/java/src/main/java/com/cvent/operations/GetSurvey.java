...
public class GetSurvey {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSurveyRequest, GetSurveyResponse> {
        ...
        public GetSurveyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSurveyResponse.Builder resBuilder =
                    GetSurveyResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSurveysPaginatedResponse(Utils.unmarshal(response, new TypeReference<SurveysPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSurveyResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSurveyResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSurveyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
