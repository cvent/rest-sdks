...
import com.cvent.models.components.SurveysPaginatedResponse;
...
public class GetSurvey {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/surveys");
    ...
    public static class Sync extends Base implements RequestOperation<GetSurveyRequest, GetSurveyResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetSurveyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSurveyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSurveyRequest request) {
        ...
        @Override
        public GetSurveyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSurveyResponse.Builder resBuilder = GetSurveyResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSurveyResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSurveysPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SurveysPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSurveyRequest, com.cvent.models.operations.async.GetSurveyResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetSurveyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSurveyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSurveyRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSurveyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSurveyResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSurveyResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSurveyResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SurveysPaginatedResponse>() {})
                            .thenApply(res::withSurveysPaginatedResponse);
                } else {
