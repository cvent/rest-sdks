...
public class ListSessionsCategories {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/session-categories:read")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSessionsCategoriesRequest, ListSessionsCategoriesResponse> {
        ...
        private HttpRequest onBuildRequest(ListSessionsCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionsCategoriesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSessionsCategoriesRequest request) {
        ...
        @Override
        public ListSessionsCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSessionsCategoriesResponse.Builder resBuilder = ListSessionsCategoriesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSessionsCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionCategoryPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SessionCategoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSessionsCategoriesRequest, com.cvent.models.operations.async.ListSessionsCategoriesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSessionsCategoriesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSessionsCategoriesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSessionsCategoriesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSessionsCategoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSessionsCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionsCategoriesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSessionsCategoriesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SessionCategoryPaginatedResponse>() {})
                            .thenApply(res::withSessionCategoryPaginatedResponse);
                } else {
