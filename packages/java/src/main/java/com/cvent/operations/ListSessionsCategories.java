...
public class ListSessionsCategories {
    ...
    public static class Sync extends Base
        ...
        public ListSessionsCategoriesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSessionsCategoriesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSessionCategoryPaginatedResponse(Utils.unmarshal(response, new TypeReference<SessionCategoryPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSessionsCategoriesRequest, com.cvent.models.operations.async.ListSessionsCategoriesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSessionsCategoriesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSessionsCategoriesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSessionsCategoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
