...
public class ListTravelPrograms {
    ...
    public static class Sync extends Base
        ...
        public ListTravelProgramsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTravelProgramsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProgramPaginatedResponse(Utils.unmarshal(response, new TypeReference<TravelProgramPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTravelProgramsRequest, com.cvent.models.operations.async.ListTravelProgramsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProgramsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListTravelProgramsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProgramsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
