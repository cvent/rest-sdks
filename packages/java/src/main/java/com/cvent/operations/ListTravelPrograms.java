...
import com.cvent.models.components.TravelProgramPaginatedResponse;
...
public class ListTravelPrograms {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/travel-programs");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTravelProgramsRequest, ListTravelProgramsResponse> {
        ...
        private HttpRequest onBuildRequest(ListTravelProgramsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProgramsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTravelProgramsRequest request) {
        ...
        @Override
        public ListTravelProgramsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTravelProgramsResponse.Builder resBuilder = ListTravelProgramsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTravelProgramsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTravelProgramPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TravelProgramPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListTravelProgramsRequest, com.cvent.models.operations.async.ListTravelProgramsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTravelProgramsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTravelProgramsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTravelProgramsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTravelProgramsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTravelProgramsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTravelProgramsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTravelProgramsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TravelProgramPaginatedResponse>() {})
                            .thenApply(res::withTravelProgramPaginatedResponse);
                } else {
