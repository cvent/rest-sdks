...
public class ListSegmentAssociatedAttendees {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSegmentAssociatedAttendeesRequest, ListSegmentAssociatedAttendeesResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListSegmentAssociatedAttendeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSegmentAssociatedAttendeesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSegmentAssociatedAttendeesRequest request) {
        ...
        @Override
        public ListSegmentAssociatedAttendeesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListSegmentAssociatedAttendeesResponse.Builder resBuilder =
            ...
            ListSegmentAssociatedAttendeesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSegmentAttendeesAssociatedPaginatedResponse(Utils.unmarshal(response, new TypeReference<SegmentAttendeesAssociatedPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSegmentAssociatedAttendeesRequest, com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListSegmentAssociatedAttendeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSegmentAssociatedAttendeesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSegmentAssociatedAttendeesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SegmentAttendeesAssociatedPaginatedResponse>() {})
                            .thenApply(res::withSegmentAttendeesAssociatedPaginatedResponse);
                } else {
