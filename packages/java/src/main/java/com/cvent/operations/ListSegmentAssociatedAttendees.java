...
public class ListSegmentAssociatedAttendees {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/audience-segments/{audienceSegmentId}/attendees", request, null);
    ...
    public static class Sync extends Base
        ...
        public ListSegmentAssociatedAttendeesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSegmentAssociatedAttendeesResponse.Builder resBuilder = ListSegmentAssociatedAttendeesResponse.builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSegmentAttendeesAssociatedPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<SegmentAttendeesAssociatedPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSegmentAssociatedAttendeesRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, ListSegmentAssociatedAttendeesRequest.class);
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse>
            ...
            com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSegmentAssociatedAttendeesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
