...
public class GetAttendeeCredits {
    ...
    public static class Sync extends Base
        ...
        public GetAttendeeCreditsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetAttendeeCreditsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeCreditsPaginatedResponse(Utils.unmarshal(response, new TypeReference<AttendeeCreditsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetAttendeeCreditsRequest, com.cvent.models.operations.async.GetAttendeeCreditsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetAttendeeCreditsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetAttendeeCreditsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAttendeeCreditsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
