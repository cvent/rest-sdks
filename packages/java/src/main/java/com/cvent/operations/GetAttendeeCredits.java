...
import com.cvent.models.components.AttendeeCreditsPaginatedResponse;
...
public class GetAttendeeCredits {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getAttendeeCredits",
                    java.util.Optional.of(java.util.List.of("event/attendee-credits:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/attendee-credits");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAttendeeCreditsRequest, GetAttendeeCreditsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAttendeeCreditsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeCreditsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAttendeeCreditsRequest request) {
        ...
        @Override
        public GetAttendeeCreditsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAttendeeCreditsResponse.Builder resBuilder = GetAttendeeCreditsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAttendeeCreditsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeCreditsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AttendeeCreditsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetAttendeeCreditsRequest, com.cvent.models.operations.async.GetAttendeeCreditsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAttendeeCreditsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAttendeeCreditsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAttendeeCreditsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAttendeeCreditsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAttendeeCreditsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAttendeeCreditsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAttendeeCreditsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AttendeeCreditsPaginatedResponse>() {})
                            .thenApply(res::withAttendeeCreditsPaginatedResponse);
                } else {
