...
public class ListRegistrationTypes {
    ...
    public static class Sync extends Base
        ...
        public ListRegistrationTypesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListRegistrationTypesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRegistrationTypePaginatedResponse(Utils.unmarshal(response, new TypeReference<RegistrationTypePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListRegistrationTypesRequest, com.cvent.models.operations.async.ListRegistrationTypesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListRegistrationTypesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListRegistrationTypesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRegistrationTypesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
