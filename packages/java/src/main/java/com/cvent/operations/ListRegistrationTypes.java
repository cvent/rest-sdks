...
import com.cvent.models.components.RegistrationTypePaginatedResponse;
...
public class ListRegistrationTypes {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/registration-types:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/registration-types", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRegistrationTypesRequest, ListRegistrationTypesResponse> {
        ...
        private HttpRequest onBuildRequest(ListRegistrationTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRegistrationTypesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRegistrationTypesRequest request) {
        ...
        @Override
        public ListRegistrationTypesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRegistrationTypesResponse.Builder resBuilder = ListRegistrationTypesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRegistrationTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRegistrationTypePaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<RegistrationTypePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRegistrationTypesRequest, com.cvent.models.operations.async.ListRegistrationTypesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRegistrationTypesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRegistrationTypesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRegistrationTypesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRegistrationTypesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRegistrationTypesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRegistrationTypesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRegistrationTypesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RegistrationTypePaginatedResponse>() {})
                            .thenApply(res::withRegistrationTypePaginatedResponse);
                } else {
