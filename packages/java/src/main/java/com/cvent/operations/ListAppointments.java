...
public class ListAppointments {
    ...
    public static class Sync extends Base
        ...
        public ListAppointmentsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListAppointmentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentPaginatedResponse(Utils.unmarshal(response, new TypeReference<AppointmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListAppointmentsRequest, com.cvent.models.operations.async.ListAppointmentsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListAppointmentsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListAppointmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAppointmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
