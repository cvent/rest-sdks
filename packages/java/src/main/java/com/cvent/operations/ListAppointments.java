...
public class ListAppointments {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listAppointments",
                    java.util.Optional.of(java.util.List.of("appointments/appointments:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/appointments");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListAppointmentsRequest, ListAppointmentsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListAppointmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAppointmentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListAppointmentsRequest request) {
        ...
        @Override
        public ListAppointmentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListAppointmentsResponse.Builder resBuilder = ListAppointmentsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListAppointmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAppointmentPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<AppointmentPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListAppointmentsRequest, com.cvent.models.operations.async.ListAppointmentsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListAppointmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListAppointmentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListAppointmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListAppointmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListAppointmentsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListAppointmentsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListAppointmentsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<AppointmentPaginatedResponse>() {})
                            .thenApply(res::withAppointmentPaginatedResponse);
                } else {
