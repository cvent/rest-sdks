...
public class DeleteAudienceSegment {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteAudienceSegmentRequest, DeleteAudienceSegmentResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteAudienceSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAudienceSegmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteAudienceSegmentRequest request) {
        ...
        @Override
        public DeleteAudienceSegmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteAudienceSegmentResponse.Builder resBuilder = DeleteAudienceSegmentResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteAudienceSegmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteAudienceSegmentRequest, com.cvent.models.operations.async.DeleteAudienceSegmentResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteAudienceSegmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteAudienceSegmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteAudienceSegmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteAudienceSegmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteAudienceSegmentResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteAudienceSegmentResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteAudienceSegmentResponse res = resBuilder.build();
