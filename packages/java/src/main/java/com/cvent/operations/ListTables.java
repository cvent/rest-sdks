...
import com.cvent.models.components.TablesPaginatedResponse;
...
public class ListTables {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/{id}/seatings/{seatingId}/tables", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<ListTablesRequest, ListTablesResponse> {
        ...
        private HttpRequest onBuildRequest(ListTablesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTablesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListTablesRequest request) {
        ...
        @Override
        public ListTablesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListTablesResponse.Builder resBuilder = ListTablesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListTablesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTablesPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TablesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListTablesRequest, com.cvent.models.operations.async.ListTablesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListTablesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListTablesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListTablesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListTablesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListTablesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTablesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListTablesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TablesPaginatedResponse>() {})
                            .thenApply(res::withTablesPaginatedResponse);
                } else {
