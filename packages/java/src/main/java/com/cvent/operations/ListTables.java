...
public class ListTables {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListTablesRequest, ListTablesResponse> {
        ...
        public ListTablesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListTablesResponse.Builder resBuilder =
                    ListTablesResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTablesPaginatedResponse(Utils.unmarshal(response, new TypeReference<TablesPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListTablesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListTablesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListTablesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
