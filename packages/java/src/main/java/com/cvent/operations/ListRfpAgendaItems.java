...
import com.cvent.models.components.PaginatedRfpAgendaItems;
...
public class ListRfpAgendaItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/agenda-items", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpAgendaItemsRequest, ListRfpAgendaItemsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpAgendaItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpAgendaItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpAgendaItemsRequest request) {
        ...
        @Override
        public ListRfpAgendaItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpAgendaItemsResponse.Builder resBuilder = ListRfpAgendaItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpAgendaItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpAgendaItems(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpAgendaItems>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRfpAgendaItemsRequest, com.cvent.models.operations.async.ListRfpAgendaItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpAgendaItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpAgendaItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpAgendaItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpAgendaItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpAgendaItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpAgendaItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpAgendaItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpAgendaItems>() {})
                            .thenApply(res::withPaginatedRfpAgendaItems);
                } else {
