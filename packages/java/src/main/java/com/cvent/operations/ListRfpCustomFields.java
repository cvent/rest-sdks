...
public class ListRfpCustomFields {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listRfpCustomFields",
                    java.util.Optional.of(java.util.List.of("rfp/rfp-custom-fields:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/{rfpId}/custom-fields/answers", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListRfpCustomFieldsRequest, ListRfpCustomFieldsResponse> {
        ...
        private HttpRequest onBuildRequest(ListRfpCustomFieldsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpCustomFieldsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListRfpCustomFieldsRequest request) {
        ...
        @Override
        public ListRfpCustomFieldsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListRfpCustomFieldsResponse.Builder resBuilder = ListRfpCustomFieldsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListRfpCustomFieldsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedRfpCustomField(
                            Utils.unmarshal(response, new TypeReference<PaginatedRfpCustomField>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListRfpCustomFieldsRequest, com.cvent.models.operations.async.ListRfpCustomFieldsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListRfpCustomFieldsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListRfpCustomFieldsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListRfpCustomFieldsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListRfpCustomFieldsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListRfpCustomFieldsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListRfpCustomFieldsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListRfpCustomFieldsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedRfpCustomField>() {})
                            .thenApply(res::withPaginatedRfpCustomField);
                } else {
