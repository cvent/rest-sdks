...
public class UnlinkReservation {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "unlinkReservation",
                    java.util.Optional.of(java.util.List.of("housing/reservations-link:delete")),
                    securitySource());
        }
    ...
    public static class Sync extends Base
            implements RequestOperation<UnlinkReservationRequest, UnlinkReservationResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UnlinkReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnlinkReservationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UnlinkReservationRequest request) {
        ...
        @Override
        public UnlinkReservationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UnlinkReservationResponse.Builder resBuilder =
            ...
            UnlinkReservationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UnlinkReservationRequest, com.cvent.models.operations.async.UnlinkReservationResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UnlinkReservationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UnlinkReservationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UnlinkReservationRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UnlinkReservationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.UnlinkReservationResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UnlinkReservationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UnlinkReservationResponse res = resBuilder.build();
