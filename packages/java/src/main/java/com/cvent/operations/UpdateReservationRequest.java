...
public class UpdateReservationRequest {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "existingReservationRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateReservationRequestRequest, UpdateReservationRequestResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UpdateReservationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateReservationRequestRequest.class,
                    new TypeReference<UpdateReservationRequestRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateReservationRequestRequest request) {
        ...
        @Override
        public UpdateReservationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateReservationRequestResponse.Builder resBuilder = UpdateReservationRequestResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateReservationRequestResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.UpdateReservationRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateReservationRequestRequest request)
                throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateReservationRequestRequest.class,
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateReservationRequestRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateReservationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateReservationRequestResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateReservationRequestResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateReservationRequestResponse res = resBuilder.build();
