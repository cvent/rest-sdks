...
public class UpdateReservationRequest {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateReservationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateReservationRequestRequest.class, new TypeReference<UpdateReservationRequestRequest>() {});
        ...
        public UpdateReservationRequestResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateReservationRequestResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingReservationRequest(Utils.unmarshal(response, new TypeReference<ExistingReservationRequest>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateReservationRequestRequest, com.cvent.models.operations.async.UpdateReservationRequestResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UpdateReservationRequestRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateReservationRequestRequest.class, new TypeReference<UpdateReservationRequestRequest>() {});
