...
public class GetSponsorshipLevel {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/sponsorship-levels/{sponsorshipLevelId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetSponsorshipLevelRequest, GetSponsorshipLevelResponse> {
        ...
        private HttpRequest onBuildRequest(GetSponsorshipLevelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSponsorshipLevelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetSponsorshipLevelRequest request) {
        ...
        @Override
        public GetSponsorshipLevelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetSponsorshipLevelResponse.Builder resBuilder = GetSponsorshipLevelResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetSponsorshipLevelResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSponsorshipLevel(
                            Utils.unmarshal(response, new TypeReference<ExistingSponsorshipLevel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetSponsorshipLevelRequest, com.cvent.models.operations.async.GetSponsorshipLevelResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetSponsorshipLevelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetSponsorshipLevelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetSponsorshipLevelRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetSponsorshipLevelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetSponsorshipLevelResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSponsorshipLevelResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetSponsorshipLevelResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExistingSponsorshipLevel>() {})
                            .thenApply(res::withExistingSponsorshipLevel);
                } else {
