...
public class GetSponsorshipLevel {
    ...
    public static class Sync extends Base
        ...
        public GetSponsorshipLevelResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetSponsorshipLevelResponse.Builder resBuilder =
                    GetSponsorshipLevelResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExistingSponsorshipLevel(Utils.unmarshal(response, new TypeReference<ExistingSponsorshipLevel>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetSponsorshipLevelRequest, com.cvent.models.operations.async.GetSponsorshipLevelResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetSponsorshipLevelResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetSponsorshipLevelResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetSponsorshipLevelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
