...
public class GetTransactionItems {
    ...
    public static class Sync extends Base
        ...
        public GetTransactionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetTransactionItemsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionItemsPaginatedResponse(Utils.unmarshal(response, new TypeReference<TransactionItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTransactionItemsRequest, com.cvent.models.operations.async.GetTransactionItemsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetTransactionItemsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetTransactionItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTransactionItemsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
