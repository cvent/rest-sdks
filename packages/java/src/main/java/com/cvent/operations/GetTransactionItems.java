...
public class GetTransactionItems {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/transactions/items", request, null);
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetTransactionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTransactionItemsRequest.class);
        ...
        @Override
        public GetTransactionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetTransactionItemsResponse.Builder resBuilder = GetTransactionItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetTransactionItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionItemsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<TransactionItemsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetTransactionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetTransactionItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetTransactionItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetTransactionItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionItemsPaginatedResponse>() {})
                            .thenApply(res::withTransactionItemsPaginatedResponse);
                } else {
