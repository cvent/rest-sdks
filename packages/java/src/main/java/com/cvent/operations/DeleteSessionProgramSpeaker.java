...
public class DeleteSessionProgramSpeaker {
    ...
    public static class Sync extends Base
        ...
        public DeleteSessionProgramSpeakerResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            DeleteSessionProgramSpeakerResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteSessionProgramSpeakerRequest, com.cvent.models.operations.async.DeleteSessionProgramSpeakerResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSessionProgramSpeakerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionProgramSpeakerRequest.class);
