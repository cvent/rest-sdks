...
public class DeleteSessionProgramSpeaker {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteSessionProgramSpeakerRequest, DeleteSessionProgramSpeakerResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteSessionProgramSpeakerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionProgramSpeakerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteSessionProgramSpeakerRequest request) {
        ...
        @Override
        public DeleteSessionProgramSpeakerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteSessionProgramSpeakerResponse.Builder resBuilder = DeleteSessionProgramSpeakerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteSessionProgramSpeakerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.DeleteSessionProgramSpeakerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteSessionProgramSpeakerRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, DeleteSessionProgramSpeakerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteSessionProgramSpeakerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteSessionProgramSpeakerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteSessionProgramSpeakerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteSessionProgramSpeakerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteSessionProgramSpeakerResponse res = resBuilder.build();
