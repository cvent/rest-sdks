...
public class GetHubMembers {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetHubMembersRequest, GetHubMembersResponse> {
        ...
        public GetHubMembersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetHubMembersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedExistingMember(Utils.unmarshal(response, new TypeReference<PaginatedExistingMember>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetHubMembersRequest, com.cvent.models.operations.async.GetHubMembersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetHubMembersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetHubMembersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHubMembersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
