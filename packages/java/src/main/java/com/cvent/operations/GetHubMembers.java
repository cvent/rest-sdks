...
public class GetHubMembers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getHubMembers",
                    java.util.Optional.of(java.util.List.of("events-plus/hubs:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/hubs/{hubId}/members", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetHubMembersRequest, GetHubMembersResponse> {
        ...
        private HttpRequest onBuildRequest(GetHubMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHubMembersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetHubMembersRequest request) {
        ...
        @Override
        public GetHubMembersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetHubMembersResponse.Builder resBuilder = GetHubMembersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetHubMembersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPaginatedExistingMember(
                            Utils.unmarshal(response, new TypeReference<PaginatedExistingMember>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetHubMembersRequest, com.cvent.models.operations.async.GetHubMembersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetHubMembersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetHubMembersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetHubMembersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetHubMembersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetHubMembersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetHubMembersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetHubMembersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PaginatedExistingMember>() {})
                            .thenApply(res::withPaginatedExistingMember);
                } else {
