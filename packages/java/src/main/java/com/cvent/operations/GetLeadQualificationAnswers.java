...
public class GetLeadQualificationAnswers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/lead-qualification-answers:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/leads/{leadId}/answers", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetLeadQualificationAnswersRequest, GetLeadQualificationAnswersResponse> {
        ...
        private HttpRequest onBuildRequest(GetLeadQualificationAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLeadQualificationAnswersRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetLeadQualificationAnswersRequest request) {
        ...
        @Override
        public GetLeadQualificationAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetLeadQualificationAnswersResponse.Builder resBuilder = GetLeadQualificationAnswersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetLeadQualificationAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLeadQualificationAnswersListResponse(
                            Utils.unmarshal(response, new TypeReference<LeadQualificationAnswersListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetLeadQualificationAnswersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetLeadQualificationAnswersRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetLeadQualificationAnswersRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetLeadQualificationAnswersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetLeadQualificationAnswersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetLeadQualificationAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetLeadQualificationAnswersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetLeadQualificationAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<LeadQualificationAnswersListResponse>() {})
                            .thenApply(res::withLeadQualificationAnswersListResponse);
                } else {
