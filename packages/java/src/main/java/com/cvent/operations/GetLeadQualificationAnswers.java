...
public class GetLeadQualificationAnswers {
    ...
    public static class Sync extends Base
        ...
        public GetLeadQualificationAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetLeadQualificationAnswersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withLeadQualificationAnswersListResponse(Utils.unmarshal(response, new TypeReference<LeadQualificationAnswersListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetLeadQualificationAnswersRequest, com.cvent.models.operations.async.GetLeadQualificationAnswersResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetLeadQualificationAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetLeadQualificationAnswersRequest.class);
