...
import com.cvent.models.components.InvitationListPaginatedResponse;
...
public class GetInvitationList {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getInvitationList",
                    java.util.Optional.of(java.util.List.of("event/invitation-lists:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{id}/invitation-lists", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetInvitationListRequest, GetInvitationListResponse> {
        ...
        private HttpRequest onBuildRequest(GetInvitationListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInvitationListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInvitationListRequest request) {
        ...
        @Override
        public GetInvitationListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetInvitationListResponse.Builder resBuilder = GetInvitationListResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetInvitationListResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvitationListPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<InvitationListPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetInvitationListRequest, com.cvent.models.operations.async.GetInvitationListResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetInvitationListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetInvitationListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetInvitationListRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetInvitationListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetInvitationListResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetInvitationListResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetInvitationListResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<InvitationListPaginatedResponse>() {})
                            .thenApply(res::withInvitationListPaginatedResponse);
                } else {
