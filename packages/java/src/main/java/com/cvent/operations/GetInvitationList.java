...
public class GetInvitationList {
    ...
    public static class Sync extends Base
        ...
        public GetInvitationListResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetInvitationListResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withInvitationListPaginatedResponse(Utils.unmarshal(response, new TypeReference<InvitationListPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInvitationListRequest, com.cvent.models.operations.async.GetInvitationListResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetInvitationListResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetInvitationListResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetInvitationListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
