...
public class ListContactHooks {
    ...
    public static class Sync extends Base
        ...
        public ListContactHooksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListContactHooksResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHooksPaginatedResponse(Utils.unmarshal(response, new TypeReference<HooksPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListContactHooksRequest, com.cvent.models.operations.async.ListContactHooksResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListContactHooksResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListContactHooksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactHooksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
