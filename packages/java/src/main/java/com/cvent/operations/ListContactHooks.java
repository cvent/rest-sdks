...
public class ListContactHooks {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "ListContactHooks",
                    java.util.Optional.of(java.util.List.of("account/hooks:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/contacts/hooks");
    ...
    public static class Sync extends Base
            implements RequestOperation<ListContactHooksRequest, ListContactHooksResponse> {
        ...
        private HttpRequest onBuildRequest(ListContactHooksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactHooksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListContactHooksRequest request) {
        ...
        @Override
        public ListContactHooksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListContactHooksResponse.Builder resBuilder = ListContactHooksResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListContactHooksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withHooksPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<HooksPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListContactHooksRequest, com.cvent.models.operations.async.ListContactHooksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListContactHooksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListContactHooksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListContactHooksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListContactHooksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListContactHooksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListContactHooksResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListContactHooksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<HooksPaginatedResponse>() {})
                            .thenApply(res::withHooksPaginatedResponse);
                } else {
