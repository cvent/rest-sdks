...
public class CreateBudgetItem {
    ...
    public static class Sync extends Base
            implements RequestOperation<CreateBudgetItemRequest, CreateBudgetItemResponse> {
        ...
        private HttpRequest onBuildRequest(CreateBudgetItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateBudgetItemRequest.class, new TypeReference<CreateBudgetItemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(CreateBudgetItemRequest request) {
        ...
        @Override
        public CreateBudgetItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateBudgetItemResponse.Builder resBuilder = CreateBudgetItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateBudgetItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    CreateBudgetItemRequest, com.cvent.models.operations.async.CreateBudgetItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(CreateBudgetItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, CreateBudgetItemRequest.class, new TypeReference<CreateBudgetItemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(CreateBudgetItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateBudgetItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateBudgetItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateBudgetItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateBudgetItemResponse res = resBuilder.build();
