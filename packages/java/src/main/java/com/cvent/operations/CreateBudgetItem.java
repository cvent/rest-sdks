...
public class CreateBudgetItem {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(CreateBudgetItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, CreateBudgetItemRequest.class, new TypeReference<CreateBudgetItemRequest>() {});
        ...
        public CreateBudgetItemResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            CreateBudgetItemResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBudgetItemResponse(Utils.unmarshal(response, new TypeReference<BudgetItemResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<CreateBudgetItemRequest, com.cvent.models.operations.async.CreateBudgetItemResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.CreateBudgetItemResponse> handleResponse(
            ...
            com.cvent.models.operations.async.CreateBudgetItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateBudgetItemResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
