...
public class GetEventsPostFilters {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/events:read")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/events/filter");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventsPostFiltersRequest, GetEventsPostFiltersResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, GetEventsPostFiltersRequest.class, new TypeReference<GetEventsPostFiltersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventsPostFiltersRequest request) {
        ...
        @Override
        public GetEventsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventsPostFiltersResponse.Builder resBuilder = GetEventsPostFiltersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EventPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventsPostFiltersRequest, com.cvent.models.operations.async.GetEventsPostFiltersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, GetEventsPostFiltersRequest.class, new TypeReference<GetEventsPostFiltersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventsPostFiltersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventsPostFiltersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventsPostFiltersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventsPostFiltersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventPaginatedResponse>() {})
                            .thenApply(res::withEventPaginatedResponse);
                } else {
