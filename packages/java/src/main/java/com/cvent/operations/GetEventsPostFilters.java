...
public class GetEventsPostFilters {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(GetEventsPostFiltersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventsPostFiltersRequest.class, new TypeReference<GetEventsPostFiltersRequest>() {});
        ...
        public GetEventsPostFiltersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventsPostFiltersResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventPaginatedResponse(Utils.unmarshal(response, new TypeReference<EventPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventsPostFiltersRequest, com.cvent.models.operations.async.GetEventsPostFiltersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventsPostFiltersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventsPostFiltersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventsPostFiltersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
