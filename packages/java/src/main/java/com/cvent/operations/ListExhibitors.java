...
public class ListExhibitors {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListExhibitorsRequest, ListExhibitorsResponse> {
        ...
        public ListExhibitorsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListExhibitorsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorIdListResponse(Utils.unmarshal(response, new TypeReference<ExhibitorIdListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListExhibitorsRequest, com.cvent.models.operations.async.ListExhibitorsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListExhibitorsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
