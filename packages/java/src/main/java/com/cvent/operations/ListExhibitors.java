...
import com.cvent.models.components.ExhibitorIdListResponse;
...
public class ListExhibitors {
    ...
    public static class Sync extends Base implements RequestOperation<ListExhibitorsRequest, ListExhibitorsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListExhibitorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListExhibitorsRequest request) {
        ...
        @Override
        public ListExhibitorsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListExhibitorsResponse.Builder resBuilder = ListExhibitorsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListExhibitorsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorIdListResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorIdListResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListExhibitorsRequest, com.cvent.models.operations.async.ListExhibitorsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListExhibitorsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListExhibitorsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListExhibitorsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListExhibitorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListExhibitorsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListExhibitorsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListExhibitorsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorIdListResponse>() {})
                            .thenApply(res::withExhibitorIdListResponse);
                } else {
