...
public class ListSpeakerSessions {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/speakers/{id}/sessions", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListSpeakerSessionsRequest, ListSpeakerSessionsResponse> {
        ...
        private HttpRequest onBuildRequest(ListSpeakerSessionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakerSessionsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListSpeakerSessionsRequest request) {
        ...
        @Override
        public ListSpeakerSessionsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListSpeakerSessionsResponse.Builder resBuilder = ListSpeakerSessionsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListSpeakerSessionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerSessionPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<SpeakerSessionPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListSpeakerSessionsRequest, com.cvent.models.operations.async.ListSpeakerSessionsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListSpeakerSessionsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListSpeakerSessionsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListSpeakerSessionsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakerSessionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListSpeakerSessionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakerSessionsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListSpeakerSessionsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SpeakerSessionPaginatedResponse>() {})
                            .thenApply(res::withSpeakerSessionPaginatedResponse);
                } else {
