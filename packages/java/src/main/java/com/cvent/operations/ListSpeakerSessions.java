...
public class ListSpeakerSessions {
    ...
    public static class Sync extends Base
        ...
        public ListSpeakerSessionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListSpeakerSessionsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSpeakerSessionPaginatedResponse(Utils.unmarshal(response, new TypeReference<SpeakerSessionPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListSpeakerSessionsRequest, com.cvent.models.operations.async.ListSpeakerSessionsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListSpeakerSessionsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListSpeakerSessionsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListSpeakerSessionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
