...
public class RemoveSpeakerFromSession {
    ...
    public static class Sync extends Base
        ...
        public RemoveSpeakerFromSessionResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            RemoveSpeakerFromSessionResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RemoveSpeakerFromSessionRequest, com.cvent.models.operations.async.RemoveSpeakerFromSessionResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSpeakerFromSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSpeakerFromSessionRequest.class);
