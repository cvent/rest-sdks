...
public class RemoveSpeakerFromSession {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/sessions:delete")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/sessions/{id}/speakers/{speakerId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<RemoveSpeakerFromSessionRequest, RemoveSpeakerFromSessionResponse> {
        ...
        private HttpRequest onBuildRequest(RemoveSpeakerFromSessionRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RemoveSpeakerFromSessionRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RemoveSpeakerFromSessionRequest request) {
        ...
        @Override
        public RemoveSpeakerFromSessionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            RemoveSpeakerFromSessionResponse.Builder resBuilder = RemoveSpeakerFromSessionResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            RemoveSpeakerFromSessionResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.RemoveSpeakerFromSessionResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(RemoveSpeakerFromSessionRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, RemoveSpeakerFromSessionRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RemoveSpeakerFromSessionRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.RemoveSpeakerFromSessionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.RemoveSpeakerFromSessionResponse.Builder resBuilder =
                    com.cvent.models.operations.async.RemoveSpeakerFromSessionResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.RemoveSpeakerFromSessionResponse res = resBuilder.build();
