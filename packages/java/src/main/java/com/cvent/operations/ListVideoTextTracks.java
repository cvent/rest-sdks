...
import com.cvent.models.components.VideoTextTracksResponse;
...
public class ListVideoTextTracks {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "listVideoTextTracks",
                    java.util.Optional.of(java.util.List.of("event/videos:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/videos/{videoId}/text-tracks", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<ListVideoTextTracksRequest, ListVideoTextTracksResponse> {
        ...
        private HttpRequest onBuildRequest(ListVideoTextTracksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideoTextTracksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListVideoTextTracksRequest request) {
        ...
        @Override
        public ListVideoTextTracksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            ListVideoTextTracksResponse.Builder resBuilder = ListVideoTextTracksResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            ListVideoTextTracksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVideoTextTracksResponse(
                            Utils.unmarshal(response, new TypeReference<VideoTextTracksResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ListVideoTextTracksRequest, com.cvent.models.operations.async.ListVideoTextTracksResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ListVideoTextTracksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListVideoTextTracksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListVideoTextTracksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListVideoTextTracksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.ListVideoTextTracksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListVideoTextTracksResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListVideoTextTracksResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<VideoTextTracksResponse>() {})
                            .thenApply(res::withVideoTextTracksResponse);
                } else {
