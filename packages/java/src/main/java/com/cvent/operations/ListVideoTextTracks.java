...
public class ListVideoTextTracks {
    ...
    public static class Sync extends Base
        ...
        public ListVideoTextTracksResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            ListVideoTextTracksResponse.Builder resBuilder =
                    ListVideoTextTracksResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withVideoTextTracksResponse(Utils.unmarshal(response, new TypeReference<VideoTextTracksResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListVideoTextTracksRequest, com.cvent.models.operations.async.ListVideoTextTracksResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.ListVideoTextTracksResponse> handleResponse(
            ...
            com.cvent.models.operations.async.ListVideoTextTracksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListVideoTextTracksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
