...
public class DeleteExhibitorCategory {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteExhibitorCategoryRequest, DeleteExhibitorCategoryResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorCategoryRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteExhibitorCategoryRequest request) {
        ...
        @Override
        public DeleteExhibitorCategoryResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteExhibitorCategoryResponse.Builder resBuilder = DeleteExhibitorCategoryResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteExhibitorCategoryResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteExhibitorCategoryRequest, com.cvent.models.operations.async.DeleteExhibitorCategoryResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteExhibitorCategoryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorCategoryRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteExhibitorCategoryRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteExhibitorCategoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteExhibitorCategoryResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteExhibitorCategoryResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteExhibitorCategoryResponse res = resBuilder.build();
