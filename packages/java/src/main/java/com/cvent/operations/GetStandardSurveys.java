...
public class GetStandardSurveys {
    ...
    public static class Sync extends Base
        ...
        public GetStandardSurveysResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetStandardSurveysResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveysPaginatedResponse(Utils.unmarshal(response, new TypeReference<StandardSurveysPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetStandardSurveysRequest, com.cvent.models.operations.async.GetStandardSurveysResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetStandardSurveysResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetStandardSurveysResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetStandardSurveysResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
