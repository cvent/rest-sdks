...
import com.cvent.models.components.StandardSurveysPaginatedResponse;
...
public class GetStandardSurveys {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getStandardSurveys",
                    java.util.Optional.of(java.util.List.of("survey/standard-surveys:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/standard-surveys");
    ...
    public static class Sync extends Base
            implements RequestOperation<GetStandardSurveysRequest, GetStandardSurveysResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetStandardSurveysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStandardSurveysRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetStandardSurveysRequest request) {
        ...
        @Override
        public GetStandardSurveysResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetStandardSurveysResponse.Builder resBuilder = GetStandardSurveysResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetStandardSurveysResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withStandardSurveysPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<StandardSurveysPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetStandardSurveysRequest, com.cvent.models.operations.async.GetStandardSurveysResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetStandardSurveysRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetStandardSurveysRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetStandardSurveysRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetStandardSurveysResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetStandardSurveysResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetStandardSurveysResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetStandardSurveysResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<StandardSurveysPaginatedResponse>() {})
                            .thenApply(res::withStandardSurveysPaginatedResponse);
                } else {
