...
import com.cvent.models.components.RfpLeadSource;
...
public class GetRfpLeadSource {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/rfps/lead-sources/{leadSourceId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetRfpLeadSourceRequest, GetRfpLeadSourceResponse> {
        ...
        private HttpRequest onBuildRequest(GetRfpLeadSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpLeadSourceRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRfpLeadSourceRequest request) {
        ...
        @Override
        public GetRfpLeadSourceResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetRfpLeadSourceResponse.Builder resBuilder = GetRfpLeadSourceResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetRfpLeadSourceResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withRfpLeadSource(Utils.unmarshal(response, new TypeReference<RfpLeadSource>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetRfpLeadSourceRequest, com.cvent.models.operations.async.GetRfpLeadSourceResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetRfpLeadSourceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetRfpLeadSourceRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetRfpLeadSourceRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetRfpLeadSourceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetRfpLeadSourceResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetRfpLeadSourceResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetRfpLeadSourceResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<RfpLeadSource>() {})
                            .thenApply(res::withRfpLeadSource);
                } else {
