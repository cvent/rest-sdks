...
public class GetEventBadgePrintJobs {
    ...
    public static class Sync extends Base
        ...
        public GetEventBadgePrintJobsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventBadgePrintJobsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePrintJobsPaginatedResponse(Utils.unmarshal(response, new TypeReference<BadgePrintJobsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventBadgePrintJobsRequest, com.cvent.models.operations.async.GetEventBadgePrintJobsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventBadgePrintJobsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventBadgePrintJobsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventBadgePrintJobsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
