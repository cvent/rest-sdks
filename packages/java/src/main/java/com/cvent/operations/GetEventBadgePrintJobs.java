...
public class GetEventBadgePrintJobs {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("remote-printing/badge-print-jobs:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/events/{eventId}/badge-print-jobs", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventBadgePrintJobsRequest, GetEventBadgePrintJobsResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventBadgePrintJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventBadgePrintJobsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventBadgePrintJobsRequest request) {
        ...
        @Override
        public GetEventBadgePrintJobsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventBadgePrintJobsResponse.Builder resBuilder = GetEventBadgePrintJobsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventBadgePrintJobsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBadgePrintJobsPaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<BadgePrintJobsPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventBadgePrintJobsRequest, com.cvent.models.operations.async.GetEventBadgePrintJobsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventBadgePrintJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventBadgePrintJobsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventBadgePrintJobsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventBadgePrintJobsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventBadgePrintJobsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventBadgePrintJobsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventBadgePrintJobsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BadgePrintJobsPaginatedResponse>() {})
                            .thenApply(res::withBadgePrintJobsPaginatedResponse);
                } else {
