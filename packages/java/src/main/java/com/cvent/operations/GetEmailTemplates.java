...
public class GetEmailTemplates {
    ...
    public static class Sync extends Base
        ...
        public GetEmailTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEmailTemplatesResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailTemplatePaginatedResponse(Utils.unmarshal(response, new TypeReference<EmailTemplatePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEmailTemplatesRequest, com.cvent.models.operations.async.GetEmailTemplatesResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEmailTemplatesResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEmailTemplatesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEmailTemplatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
