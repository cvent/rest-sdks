...
import com.cvent.models.components.EmailTemplatePaginatedResponse;
...
public class GetEmailTemplates {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "getEmailTemplates",
                    java.util.Optional.of(java.util.List.of("eMarketing/eMarketing-email-templates:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/emarketing/campaigns/{campaignId}/email-templates", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEmailTemplatesRequest, GetEmailTemplatesResponse> {
        ...
        private HttpRequest onBuildRequest(GetEmailTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEmailTemplatesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEmailTemplatesRequest request) {
        ...
        @Override
        public GetEmailTemplatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEmailTemplatesResponse.Builder resBuilder = GetEmailTemplatesResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEmailTemplatesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmailTemplatePaginatedResponse(
                            Utils.unmarshal(response, new TypeReference<EmailTemplatePaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEmailTemplatesRequest, com.cvent.models.operations.async.GetEmailTemplatesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEmailTemplatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEmailTemplatesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEmailTemplatesRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEmailTemplatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEmailTemplatesResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEmailTemplatesResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEmailTemplatesResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EmailTemplatePaginatedResponse>() {})
                            .thenApply(res::withEmailTemplatePaginatedResponse);
                } else {
