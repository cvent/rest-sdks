...
public class DeleteExhibitorBanner {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteExhibitorBannerRequest, DeleteExhibitorBannerResponse> {
        ...
        private HttpRequest onBuildRequest(DeleteExhibitorBannerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorBannerRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteExhibitorBannerRequest request) {
        ...
        @Override
        public DeleteExhibitorBannerResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteExhibitorBannerResponse.Builder resBuilder = DeleteExhibitorBannerResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteExhibitorBannerResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    DeleteExhibitorBannerRequest, com.cvent.models.operations.async.DeleteExhibitorBannerResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteExhibitorBannerRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteExhibitorBannerRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteExhibitorBannerRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteExhibitorBannerResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteExhibitorBannerResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteExhibitorBannerResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteExhibitorBannerResponse res = resBuilder.build();
