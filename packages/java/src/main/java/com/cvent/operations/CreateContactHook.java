...
public class CreateContactHook {
    ...
    public static class Sync extends Base implements RequestOperation<HookInput, CreateContactHookResponse> {
        ...
        private HttpRequest onBuildRequest(HookInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<HookInput>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(HookInput request) {
        ...
        @Override
        public CreateContactHookResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            CreateContactHookResponse.Builder resBuilder = CreateContactHookResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            CreateContactHookResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<HookInput, com.cvent.models.operations.async.CreateContactHookResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(HookInput request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<HookInput>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(HookInput request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.CreateContactHookResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.CreateContactHookResponse.Builder resBuilder =
                    com.cvent.models.operations.async.CreateContactHookResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.CreateContactHookResponse res = resBuilder.build();
