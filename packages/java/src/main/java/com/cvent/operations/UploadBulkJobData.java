...
public class UploadBulkJobData {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "uploadBulkJobData",
                    java.util.Optional.of(java.util.List.of("bulk/bulk-jobs:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/bulk-jobs/{id}/data", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "bulkData", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UploadBulkJobDataRequest, UploadBulkJobDataResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(UploadBulkJobDataRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UploadBulkJobDataRequest.class, new TypeReference<UploadBulkJobDataRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UploadBulkJobDataRequest request) {
        ...
        @Override
        public UploadBulkJobDataResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UploadBulkJobDataResponse.Builder resBuilder = UploadBulkJobDataResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UploadBulkJobDataResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBulkDataUploadResponse(
                            Utils.unmarshal(response, new TypeReference<BulkDataUploadResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UploadBulkJobDataRequest, com.cvent.models.operations.async.UploadBulkJobDataResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(UploadBulkJobDataRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UploadBulkJobDataRequest.class, new TypeReference<UploadBulkJobDataRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UploadBulkJobDataRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UploadBulkJobDataResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UploadBulkJobDataResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UploadBulkJobDataResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UploadBulkJobDataResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<BulkDataUploadResponse>() {})
                            .thenApply(res::withBulkDataUploadResponse);
                } else {
