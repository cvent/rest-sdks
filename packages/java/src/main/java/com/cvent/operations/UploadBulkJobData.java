...
public class UploadBulkJobData {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UploadBulkJobDataRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UploadBulkJobDataRequest.class, new TypeReference<UploadBulkJobDataRequest>() {});
        ...
        public UploadBulkJobDataResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UploadBulkJobDataResponse.Builder resBuilder =
                    UploadBulkJobDataResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withBulkDataUploadResponse(Utils.unmarshal(response, new TypeReference<BulkDataUploadResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UploadBulkJobDataRequest, com.cvent.models.operations.async.UploadBulkJobDataResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UploadBulkJobDataResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UploadBulkJobDataResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UploadBulkJobDataResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
