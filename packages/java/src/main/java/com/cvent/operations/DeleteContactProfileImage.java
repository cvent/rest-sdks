...
public class DeleteContactProfileImage {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteContactProfileImageRequest, DeleteContactProfileImageResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteContactProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactProfileImageRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteContactProfileImageRequest request) {
        ...
        @Override
        public DeleteContactProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            DeleteContactProfileImageResponse.Builder resBuilder = DeleteContactProfileImageResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            DeleteContactProfileImageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.DeleteContactProfileImageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactProfileImageRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactProfileImageRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteContactProfileImageRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.DeleteContactProfileImageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.DeleteContactProfileImageResponse.Builder resBuilder =
                    com.cvent.models.operations.async.DeleteContactProfileImageResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.DeleteContactProfileImageResponse res = resBuilder.build();
