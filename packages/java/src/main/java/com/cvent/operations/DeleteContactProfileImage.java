...
public class DeleteContactProfileImage {
    ...
    public static class Sync extends Base
        ...
        public DeleteContactProfileImageResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            DeleteContactProfileImageResponse.Builder resBuilder =
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteContactProfileImageRequest, com.cvent.models.operations.async.DeleteContactProfileImageResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteContactProfileImageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteContactProfileImageRequest.class);
