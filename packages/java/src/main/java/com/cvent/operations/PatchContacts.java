...
public class PatchContacts {
    ...
    public static class Sync extends Base implements RequestOperation<List<ContactPatch>, PatchContactsResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(List<ContactPatch> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<ContactPatch>>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(List<ContactPatch> request) {
        ...
        @Override
        public PatchContactsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            PatchContactsResponse.Builder resBuilder = PatchContactsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            PatchContactsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    List<ContactPatch>, com.cvent.models.operations.async.PatchContactsResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(List<ContactPatch> request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<List<ContactPatch>>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(List<ContactPatch> request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.PatchContactsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.PatchContactsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.PatchContactsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.PatchContactsResponse res = resBuilder.build();
