...
public class GetAccountTransactionItems {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("event/transactions:read")),
                    securitySource());
        }
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/transactions/{transactionId}/items", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountTransactionItemsRequest, GetAccountTransactionItemsResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountTransactionItemsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountTransactionItemsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountTransactionItemsRequest request) {
        ...
        @Override
        public GetAccountTransactionItemsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountTransactionItemsResponse.Builder resBuilder = GetAccountTransactionItemsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountTransactionItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionItemsAccountPaginatedResponse(Utils.unmarshal(
                            response, new TypeReference<TransactionItemsAccountPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetAccountTransactionItemsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountTransactionItemsRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetAccountTransactionItemsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountTransactionItemsRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountTransactionItemsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountTransactionItemsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountTransactionItemsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountTransactionItemsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionItemsAccountPaginatedResponse>() {})
                            .thenApply(res::withTransactionItemsAccountPaginatedResponse);
                } else {
