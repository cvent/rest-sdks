...
public class GetEventAsyncStatus {
    ...
    public static class Sync extends Base
        ...
        public GetEventAsyncStatusResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetEventAsyncStatusResponse.Builder resBuilder =
                    GetEventAsyncStatusResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventAsyncStatus(Utils.unmarshal(response, new TypeReference<EventAsyncStatus>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventAsyncStatusRequest, com.cvent.models.operations.async.GetEventAsyncStatusResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetEventAsyncStatusResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetEventAsyncStatusResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventAsyncStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
