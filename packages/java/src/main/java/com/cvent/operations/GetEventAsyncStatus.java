...
public class GetEventAsyncStatus {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url =
                    Utils.generateURL(klass, this.baseUrl, "/events/async/{eventCreationId}/status", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetEventAsyncStatusRequest, GetEventAsyncStatusResponse> {
        ...
        private HttpRequest onBuildRequest(GetEventAsyncStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventAsyncStatusRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetEventAsyncStatusRequest request) {
        ...
        @Override
        public GetEventAsyncStatusResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetEventAsyncStatusResponse.Builder resBuilder = GetEventAsyncStatusResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetEventAsyncStatusResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEventAsyncStatus(
                            Utils.unmarshal(response, new TypeReference<EventAsyncStatus>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    GetEventAsyncStatusRequest, com.cvent.models.operations.async.GetEventAsyncStatusResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetEventAsyncStatusRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetEventAsyncStatusRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetEventAsyncStatusRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetEventAsyncStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetEventAsyncStatusResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetEventAsyncStatusResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetEventAsyncStatusResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<EventAsyncStatus>() {})
                            .thenApply(res::withEventAsyncStatus);
                } else {
