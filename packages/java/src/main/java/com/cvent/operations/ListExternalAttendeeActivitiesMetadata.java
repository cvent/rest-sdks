...
public class ListExternalAttendeeActivitiesMetadata {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(ListExternalAttendeeActivitiesMetadataRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListExternalAttendeeActivitiesMetadataRequest request) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExternalActivityMetadataPaginatedResponse>() {})
                            .thenApply(res::withExternalActivityMetadataPaginatedResponse);
                } else {
