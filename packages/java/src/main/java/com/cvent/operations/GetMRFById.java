...
public class GetMRFById {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/meeting-request-forms/{id}", request, null);
    ...
    public static class Sync extends Base implements RequestOperation<GetMRFByIdRequest, GetMRFByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetMRFByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMRFByIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetMRFByIdRequest request) {
            HttpRequest r = unchecked(() -> onBuildRequest(request)).get();
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "403", "404", "422", "429", "4XX", "5XX")) {
        ...
        @Override
        public GetMRFByIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetMRFByIdResponse.Builder resBuilder = GetMRFByIdResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetMRFByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestForm(
                            Utils.unmarshal(response, new TypeReference<MeetingRequestForm>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetMRFByIdRequest, com.cvent.models.operations.async.GetMRFByIdResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetMRFByIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetMRFByIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetMRFByIdRequest request) {
            return unchecked(() -> onBuildRequest(request))
                    ...
                    .handle((resp, err) -> {
                        ...
                        if (Utils.statusCodeMatches(resp.statusCode(), "401", "403", "404", "422", "429", "4XX", "5XX")) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetMRFByIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetMRFByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetMRFByIdResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetMRFByIdResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<MeetingRequestForm>() {})
                            .thenApply(res::withMeetingRequestForm);
                } else {
