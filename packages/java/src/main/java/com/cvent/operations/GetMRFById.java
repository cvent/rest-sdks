...
public class GetMRFById {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetMRFByIdRequest, GetMRFByIdResponse> {
        ...
        public GetMRFByIdResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            GetMRFByIdResponse.Builder resBuilder =
                    GetMRFByIdResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withMeetingRequestForm(Utils.unmarshal(response, new TypeReference<MeetingRequestForm>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.cvent.models.operations.async.GetMRFByIdResponse> handleResponse(
            ...
            com.cvent.models.operations.async.GetMRFByIdResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetMRFByIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
