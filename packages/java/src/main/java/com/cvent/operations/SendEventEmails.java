...
public class SendEventEmails {
    ...
    public static class Sync extends Base
            implements RequestOperation<SendEmailEventRequest, SendEventEmailsResponse> {
        ...
        public SendEventEmailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            SendEventEmailsResponse.Builder resBuilder =
                    SendEventEmailsResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSendEmailEventResponse(Utils.unmarshal(response, new TypeReference<SendEmailEventResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SendEmailEventRequest, com.cvent.models.operations.async.SendEventEmailsResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.SendEventEmailsResponse> handleResponse(
            ...
            com.cvent.models.operations.async.SendEventEmailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.SendEventEmailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
