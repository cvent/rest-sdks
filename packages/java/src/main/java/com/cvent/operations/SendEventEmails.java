...
public class SendEventEmails {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "sendEventEmails",
                    java.util.Optional.of(java.util.List.of("event/event-emails:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(this.baseUrl, "/events/emails");
    ...
    public static class Sync extends Base implements RequestOperation<SendEmailEventRequest, SendEventEmailsResponse> {
        ...
        private HttpRequest onBuildRequest(SendEmailEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SendEmailEventRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SendEmailEventRequest request) {
        ...
        @Override
        public SendEventEmailsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            SendEventEmailsResponse.Builder resBuilder = SendEventEmailsResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            SendEventEmailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withSendEmailEventResponse(
                            Utils.unmarshal(response, new TypeReference<SendEmailEventResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    SendEmailEventRequest, com.cvent.models.operations.async.SendEventEmailsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SendEmailEventRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<SendEmailEventRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SendEmailEventRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.SendEventEmailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.SendEventEmailsResponse.Builder resBuilder =
                    com.cvent.models.operations.async.SendEventEmailsResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.SendEventEmailsResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "202")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<SendEmailEventResponse>() {})
                            .thenApply(res::withSendEmailEventResponse);
                } else {
