...
public class UpdateProgramItem {
    ...
    abstract static class Base {
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(klass, this.baseUrl, "/program-items/{programItemId}", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "programItemUpdateRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateProgramItemRequest, UpdateProgramItemResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateProgramItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateProgramItemRequest.class, new TypeReference<UpdateProgramItemRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateProgramItemRequest request) {
        ...
        @Override
        public UpdateProgramItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateProgramItemResponse.Builder resBuilder = UpdateProgramItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateProgramItemResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateProgramItemRequest, com.cvent.models.operations.async.UpdateProgramItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateProgramItemRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request, UpdateProgramItemRequest.class, new TypeReference<UpdateProgramItemRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateProgramItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateProgramItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateProgramItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateProgramItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateProgramItemResponse res = resBuilder.build();
