...
public class ListWebcastAttendeeLinks {
    ...
    public static class Sync extends Base
            implements RequestOperation<ListWebcastAttendeeLinksRequest, ListWebcastAttendeeLinksResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(ListWebcastAttendeeLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWebcastAttendeeLinksRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ListWebcastAttendeeLinksRequest request) {
        ...
        @Override
        public ListWebcastAttendeeLinksResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ListWebcastAttendeeLinksResponse.Builder resBuilder =
            ...
            ListWebcastAttendeeLinksResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withAttendeeLinkPaginatedResponse(Utils.unmarshal(response, new TypeReference<AttendeeLinkPaginatedResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ListWebcastAttendeeLinksRequest, com.cvent.models.operations.async.ListWebcastAttendeeLinksResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(ListWebcastAttendeeLinksRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ListWebcastAttendeeLinksRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ListWebcastAttendeeLinksRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.ListWebcastAttendeeLinksResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.cvent.models.operations.async.ListWebcastAttendeeLinksResponse.Builder resBuilder =
                    com.cvent.models.operations.async.ListWebcastAttendeeLinksResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.ListWebcastAttendeeLinksResponse res = resBuilder.build();
