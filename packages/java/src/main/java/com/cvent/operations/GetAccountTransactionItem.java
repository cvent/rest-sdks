...
import com.cvent.models.components.TransactionItemAccountResponse;
...
public class GetAccountTransactionItem {
    ...
    abstract static class Base {
        ...
        <T> HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/transactions/{transactionId}/items/{transactionItemId}", request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetAccountTransactionItemRequest, GetAccountTransactionItemResponse> {
        ...
        private HttpRequest onBuildRequest(GetAccountTransactionItemRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetAccountTransactionItemRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetAccountTransactionItemRequest request) {
        ...
        @Override
        public GetAccountTransactionItemResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            GetAccountTransactionItemResponse.Builder resBuilder = GetAccountTransactionItemResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            GetAccountTransactionItemResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTransactionItemAccountResponse(
                            Utils.unmarshal(response, new TypeReference<TransactionItemAccountResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    ...
                    com.cvent.models.operations.async.GetAccountTransactionItemResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(GetAccountTransactionItemRequest request)
                throws Exception {
            HttpRequest req = buildRequest(request, GetAccountTransactionItemRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetAccountTransactionItemRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.GetAccountTransactionItemResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.GetAccountTransactionItemResponse.Builder resBuilder =
                    com.cvent.models.operations.async.GetAccountTransactionItemResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.GetAccountTransactionItemResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TransactionItemAccountResponse>() {})
                            .thenApply(res::withTransactionItemAccountResponse);
                } else {
