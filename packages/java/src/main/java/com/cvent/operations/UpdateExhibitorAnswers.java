...
public class UpdateExhibitorAnswers {
    ...
    abstract static class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    java.util.Optional.of(java.util.List.of("exhibitor/exhibitor-answers:write")),
                    securitySource());
        }
        ...
        <T, U> HttpRequest buildRequest(T request, Class<T> klass, TypeReference<U> typeReference) throws Exception {
            String url = Utils.generateURL(
                    klass, this.baseUrl, "/events/{id}/exhibitors/{exhibitorId}/exhibitor-answers", request, null);
            ...
            SerializedBody serializedRequestBody =
                    Utils.serializeRequestBody(convertedRequest, "exhibitorAnswersRequest", "json", false);
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateExhibitorAnswersRequest, UpdateExhibitorAnswersResponse> {
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateExhibitorAnswersRequest.class,
                    new TypeReference<UpdateExhibitorAnswersRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateExhibitorAnswersRequest request) {
        ...
        @Override
        public UpdateExhibitorAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            UpdateExhibitorAnswersResponse.Builder resBuilder = UpdateExhibitorAnswersResponse.builder()
                    .contentType(contentType)
                    .statusCode(response.statusCode())
                    .rawResponse(response);

            UpdateExhibitorAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorAnswersResponse(
                            Utils.unmarshal(response, new TypeReference<ExhibitorAnswersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<
                    UpdateExhibitorAnswersRequest, com.cvent.models.operations.async.UpdateExhibitorAnswersResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateExhibitorAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(
                    request,
                    UpdateExhibitorAnswersRequest.class,
                    new TypeReference<UpdateExhibitorAnswersRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateExhibitorAnswersRequest request) {
        ...
        @Override
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorAnswersResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response.headers().firstValue("Content-Type").orElse("application/octet-stream");
            com.cvent.models.operations.async.UpdateExhibitorAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorAnswersResponse.builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.cvent.models.operations.async.UpdateExhibitorAnswersResponse res = resBuilder.build();

            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ExhibitorAnswersResponse>() {})
                            .thenApply(res::withExhibitorAnswersResponse);
                } else {
