...
public class UpdateExhibitorAnswers {
    ...
    public static class Sync extends Base
        ...
        private HttpRequest onBuildRequest(UpdateExhibitorAnswersRequest request) throws Exception {
            HttpRequest req = buildRequest(request, UpdateExhibitorAnswersRequest.class, new TypeReference<UpdateExhibitorAnswersRequest>() {});
        ...
        public UpdateExhibitorAnswersResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            UpdateExhibitorAnswersResponse.Builder resBuilder =
                    UpdateExhibitorAnswersResponse
                            .builder()
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExhibitorAnswersResponse(Utils.unmarshal(response, new TypeReference<ExhibitorAnswersResponse>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateExhibitorAnswersRequest, com.cvent.models.operations.async.UpdateExhibitorAnswersResponse> {
        ...
        public CompletableFuture<com.cvent.models.operations.async.UpdateExhibitorAnswersResponse> handleResponse(
            ...
            com.cvent.models.operations.async.UpdateExhibitorAnswersResponse.Builder resBuilder =
                    com.cvent.models.operations.async.UpdateExhibitorAnswersResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
