...
import com.cvent.utils.AsyncHook.AfterError;
import com.cvent.utils.AsyncHook.AfterSuccess;
import com.cvent.utils.AsyncHook.BeforeRequest;
import com.cvent.utils.Blob;
import com.cvent.utils.Hook.AfterErrorContext;
import com.cvent.utils.Hook.AfterSuccessContext;
import com.cvent.utils.Hook.BeforeRequestContext;
import com.cvent.utils.Hooks.FailEarlyException;
...
public class AsyncHooks implements BeforeRequest, AfterSuccess, AfterError {
    ...
    public CompletableFuture<HttpResponse<Blob>> afterSuccess(
            AfterSuccessContext context, HttpResponse<Blob> response) {
        Utils.checkNotNull(context, "context");
    ...
    public CompletableFuture<HttpResponse<Blob>> afterError(
            AfterErrorContext context, HttpResponse<Blob> response, Throwable error) {
        Utils.checkNotNull(context, "context");
        Utils.checkArgument(
