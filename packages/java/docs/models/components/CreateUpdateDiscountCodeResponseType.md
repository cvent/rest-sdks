...
```java
import com.cvent.models.components.CreateUpdateDiscountCodeResponseType;

CreateUpdateDiscountCodeResponseType value = CreateUpdateDiscountCodeResponseType.DISCOUNT_CODE;
```
