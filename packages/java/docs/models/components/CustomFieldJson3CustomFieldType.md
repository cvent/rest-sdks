...
```java
import com.cvent.models.components.CustomFieldJson3CustomFieldType;

CustomFieldJson3CustomFieldType value = CustomFieldJson3CustomFieldType.OPEN_ENDED_TEXT_DATE_TIME;
```
