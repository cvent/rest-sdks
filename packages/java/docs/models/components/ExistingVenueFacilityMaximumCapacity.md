...
| --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- | --------------------------------------- |
| `seated`                                | *Optional\<Long>*                       | :heavy_minus_sign:                      | Maximum seated capacity at the venue.   | 500                                     |
| `standing`                              | *Optional\<Long>*                       | :heavy_minus_sign:                      | Maximum standing capacity at the venue. | 800                                     |