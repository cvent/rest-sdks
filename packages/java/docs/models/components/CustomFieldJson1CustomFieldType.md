...
```java
import com.cvent.models.components.CustomFieldJson1CustomFieldType;

CustomFieldJson1CustomFieldType value = CustomFieldJson1CustomFieldType.OPEN_ENDED_TEXT_DATE_TIME;
```
