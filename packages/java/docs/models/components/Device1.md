...
| `type`                                                                                 | [Optional\<DeviceType>](../../models/components/DeviceType.md)                         | :heavy_minus_sign:                                                                     | The device used to watch the video. Videos can be viewed on desktop, mobile or tablet. |                                                                                        |
