...
| `code`                                                               | *Optional\<String>*                                                  | :heavy_minus_sign:                                                   | Code / Abbreviation of the location.                                 | ConfA                                                                |
| `name`                                                               | *Optional\<String>*                                                  | :heavy_minus_sign:                                                   | Name of the location.                                                | Conference Room A                                                    |