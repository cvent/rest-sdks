...
```java
import com.cvent.models.components.MeetingRequestCustomFieldJsonCustomFieldType;

MeetingRequestCustomFieldJsonCustomFieldType value = MeetingRequestCustomFieldJsonCustomFieldType.AUTO_INCREMENT;
```
