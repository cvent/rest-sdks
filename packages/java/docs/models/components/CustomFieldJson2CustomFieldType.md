...
```java
import com.cvent.models.components.CustomFieldJson2CustomFieldType;

CustomFieldJson2CustomFieldType value = CustomFieldJson2CustomFieldType.OPEN_ENDED_TEXT_DATE_TIME;
```
