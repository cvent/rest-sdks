...
```java
import com.cvent.models.components.CustomField2CustomFieldType;

CustomField2CustomFieldType value = CustomField2CustomFieldType.AUTO_INCREMENT;
```
