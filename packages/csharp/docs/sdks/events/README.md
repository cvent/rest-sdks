...
EventInput req = new EventInput() {
    ...
    Venues = new List<Venue1Input>() {
        new Venue1Input() {
            Name = "Capital Convention Center",
            Address = new VenueAddress1Input() {
                Address1 = "Cvent Inc.",
    ...
    Planners = new List<Planner1Input>() {
        new Planner1Input() {
            Prefix = "Dr.",
            FirstName = "Henry",
            LastName = "Smith",
...
<!-- UsageSnippet language="csharp" operationID="getEventPlanningDocuments" method="get" path="/events/{id}/planning-documents" -->
```csharp
using Cvent.SDK;
using Cvent.SDK.Models.Components;
using Cvent.SDK.Models.Requests;
...
GetEventPlanningDocumentsRequest req = new GetEventPlanningDocumentsRequest() {
    Id = "04ca6ae2-0dc3-487b-953e-86d6abbdf7d3",
    After = System.DateTime.Parse("2017-01-02T02:00:00Z").ToUniversalTime(),
    Before = System.DateTime.Parse("2017-01-02T02:00:00Z").ToUniversalTime(),
    Token = "0e28af57-511f-47ab-ae46-46cd1ca51a1a",
...
GetEventPlanningDocumentsResponse? res = await sdk.Events.GetEventPlanningDocumentsAsync(req);
...
| Parameter                                                                                     | Type                                                                                          | Required                                                                                      | Description                                                                                   |
| --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| `request`                                                                                     | [GetEventPlanningDocumentsRequest](../../Models/Requests/GetEventPlanningDocumentsRequest.md) | :heavy_check_mark:                                                                            | The request object to use for the request.                                                    |

### Response

**[GetEventPlanningDocumentsResponse](../../Models/Requests/GetEventPlanningDocumentsResponse.md)**
...
<!-- UsageSnippet language="csharp" operationID="listTaxes" method="get" path="/events/{id}/taxes" -->
```csharp
using Cvent.SDK;
using Cvent.SDK.Models.Components;
using Cvent.SDK.Models.Requests;
...
ListTaxesRequest req = new ListTaxesRequest() {
    Id = "04ca6ae2-0dc3-487b-953e-86d6abbdf7d3",
    Token = "0e28af57-511f-47ab-ae46-46cd1ca51a1a",
    Filter = "id eq '04ca6ae2-0dc3-487b-953e-86d6abbdf7d3'",
};

ListTaxesResponse? res = await sdk.Events.ListTaxesAsync(req);
...
| Parameter                                                     | Type                                                          | Required                                                      | Description                                                   |
| ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------- |
| `request`                                                     | [ListTaxesRequest](../../Models/Requests/ListTaxesRequest.md) | :heavy_check_mark:                                            | The request object to use for the request.                    |

### Response

**[ListTaxesResponse](../../Models/Requests/ListTaxesResponse.md)**
...
PostTransactionsRequest req = new PostTransactionsRequest() {
    ...
    CreateTransactionResponse = new CreateTransactionResponseInput() {
        ...
        TransactionItems = new List<TransactionItemCreateInput>() {
            new TransactionItemCreateInput() {
                Product = new ProductOrderItemInput() {
                    Id = "04ca6ae2-0dc3-487b-953e-86d6abbdf7d3",
                },
                Amount = 15.25D,
            },
...
<!-- UsageSnippet language="csharp" operationID="listEventVouchers" method="get" path="/events/{id}/vouchers" -->
```csharp
using Cvent.SDK;
using Cvent.SDK.Models.Components;
using Cvent.SDK.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="listEventVouchersPostFilter" method="post" path="/events/{id}/vouchers/filter" -->
```csharp
using Cvent.SDK;
using Cvent.SDK.Models.Components;
using Cvent.SDK.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="listEventVoucherAttendees" method="get" path="/events/{id}/vouchers/{voucherId}/attendees" -->
```csharp
using Cvent.SDK;
using Cvent.SDK.Models.Components;
using Cvent.SDK.Models.Requests;
...
SessionCheckInRequest req = new SessionCheckInRequest() {
    Id = "04ca6ae2-0dc3-487b-953e-86d6abbdf7d3",
    RequestBody = new List<SessionCheckin>() {},
};
...
UpdateSessionCheckInRequest req = new UpdateSessionCheckInRequest() {
    Id = "04ca6ae2-0dc3-487b-953e-86d6abbdf7d3",
    RequestBody = new List<SessionCheckinBase>() {},
};
