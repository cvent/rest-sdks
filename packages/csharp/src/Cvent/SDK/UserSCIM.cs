...
namespace Cvent.SDK
{
    ...
    public interface IUserSCIM
    {
        ...
        /// <exception cref="ErrorResponseJson12">Bad request. Thrown when the API returns a 400, 401, 403 or 429 response.</exception>
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ErrorResponseJson12">Bad or expired token. Thrown when the API returns a 401, 403 or 429 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ErrorResponseJson12">Bad request. Thrown when the API returns a 400, 401, 403, 404 or 429 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ErrorResponseJson12">Bad request. Thrown when the API returns a 400, 401, 403, 409 or 429 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ErrorResponseJson12">Bad or expired token. Thrown when the API returns a 401, 403, 404 or 429 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        ...
        )
        {
            ...
            else if (new List<int> { 400, 401, 403, 429 }.Contains(responseStatusCode))
            {
                if (Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        payload = ResponseBodyDeserializer.DeserializeNotNull<ErrorResponseJson12Payload>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
        ...
        public async Task<GetResourceTypesResponse> GetResourceTypesAsync(RetryConfig? retryConfig = null)
        {
            ...
            else if (new List<int> { 401, 403, 429 }.Contains(responseStatusCode))
            {
                if (Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        payload = ResponseBodyDeserializer.DeserializeNotNull<ErrorResponseJson12Payload>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ErrorResponseJson12Payload.", httpRequest, httpResponse, httpResponseBody, ex);
