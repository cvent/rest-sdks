...
namespace Cvent.SDK
{
    ...
    public interface IAuthentication
    {
        ...
        /// <param name="request">A <see cref="Oauth2TokenApplicationXWwwFormUrlencodedPostRequest"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        ...
        /// <exception cref="Oauth2TokenPostResponse0Exception">A bad token response. Thrown when the API returns a 400 response.</exception>
        /// <exception cref="APIException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public Task<Oauth2TokenResponse> Oauth2TokenAsync(
            Oauth2TokenSecurity security,
            Oauth2TokenApplicationXWwwFormUrlencodedPostRequest? request = null,
            RetryConfig? retryConfig = null
        );
        ...
        )
        {
            ...
            if (responseStatusCode == 200)
            {
                if (Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Oauth2TokenPostResponse obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Oauth2TokenPostResponse>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Oauth2TokenPostResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
                    ...
                    response.Oauth2TokenPostResponse = obj;
                    return response;
                }
            ...
            else if (responseStatusCode == 400)
            {
                if (Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        payload = ResponseBodyDeserializer.DeserializeNotNull<Oauth2TokenPostResponse0ExceptionPayload>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Oauth2TokenPostResponse0ExceptionPayload.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    throw new Oauth2TokenPostResponse0Exception(payload, httpRequest, httpResponse, httpResponseBody);
                }
