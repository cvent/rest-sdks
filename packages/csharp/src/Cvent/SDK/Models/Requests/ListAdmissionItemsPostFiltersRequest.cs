...
namespace Cvent.SDK.Models.Requests
{
    ...
    public class ListAdmissionItemsPostFiltersRequest
    {
        ...
        /// <summary>
        /// The request body accepts filters to refine the data returned.  Refer to available filter details in  <a href="#operation/listAdmissionItems">GET List Admission</a>.
        /// </summary>
