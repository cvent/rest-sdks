        ...
        public static ExpandAirRequestQuestionAnswer ToEnum(this string value)
        {
            foreach(var field in typeof(ExpandAirRequestQuestionAnswer).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ExpandAirRequestQuestionAnswer)
                    {
                        return (ExpandAirRequestQuestionAnswer)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ExpandAirRequestQuestionAnswer");
        }
    }
}