...
namespace Cvent.SDK.Models.Components
{
    ...
    /// </summary>
    public enum CustomFieldSchemaCustomFieldType
    {
    ...
    public static class CustomFieldSchemaCustomFieldTypeExtension
    {
        public static string Value(this CustomFieldSchemaCustomFieldType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CustomFieldSchemaCustomFieldType ToEnum(this string value)
        {
            foreach (var field in typeof(CustomFieldSchemaCustomFieldType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CustomFieldSchemaCustomFieldType)
                    {
                        return (CustomFieldSchemaCustomFieldType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CustomFieldSchemaCustomFieldType");
        }
    }
}