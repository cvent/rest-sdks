        ...
        public static AppointmentAvailabilityTypeJson ToEnum(this string value)
        {
            foreach(var field in typeof(AppointmentAvailabilityTypeJson).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AppointmentAvailabilityTypeJson)
                    {
                        return (AppointmentAvailabilityTypeJson)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AppointmentAvailabilityTypeJson");
        }
    }
