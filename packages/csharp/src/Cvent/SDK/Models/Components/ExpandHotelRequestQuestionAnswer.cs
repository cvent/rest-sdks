        ...
        public static ExpandHotelRequestQuestionAnswer ToEnum(this string value)
        {
            foreach(var field in typeof(ExpandHotelRequestQuestionAnswer).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ExpandHotelRequestQuestionAnswer)
                    {
                        return (ExpandHotelRequestQuestionAnswer)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ExpandHotelRequestQuestionAnswer");
        }
    }
