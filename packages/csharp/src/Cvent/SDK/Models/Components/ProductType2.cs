...
namespace Cvent.SDK.Models.Components
{
    ...
    public static class ProductType2Extension
    {
        public static string Value(this ProductType2 value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ProductType2 ToEnum(this string value)
        {
            foreach (var field in typeof(ProductType2).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ProductType2)
                    {
                        return (ProductType2)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ProductType2");
        }
    }
}