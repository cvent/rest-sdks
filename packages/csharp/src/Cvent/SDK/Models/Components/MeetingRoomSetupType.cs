...
namespace Cvent.SDK.Models.Components
{
    ...
    /// </summary>
    public enum MeetingRoomSetupType
    {
    ...
    public static class MeetingRoomSetupTypeExtension
    {
        public static string Value(this MeetingRoomSetupType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static MeetingRoomSetupType ToEnum(this string value)
        {
            foreach (var field in typeof(MeetingRoomSetupType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is MeetingRoomSetupType)
                    {
                        return (MeetingRoomSetupType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum MeetingRoomSetupType");
        }
    }
}