        ...
        public static TravelProgramFormatTypeJson ToEnum(this string value)
        {
            foreach(var field in typeof(TravelProgramFormatTypeJson).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is TravelProgramFormatTypeJson)
                    {
                        return (TravelProgramFormatTypeJson)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum TravelProgramFormatTypeJson");
        }
    }
}