...
namespace Cvent.SDK.Models.Components
{
    ...
    {
        public static string Value(this BidItemStatusType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static BidItemStatusType ToEnum(this string value)
        {
            foreach (var field in typeof(BidItemStatusType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is BidItemStatusType)
                    {
                        return (BidItemStatusType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum BidItemStatusType");
        }
    }
}