...
namespace Cvent.SDK.Models.Components
{
    ...
    {
        public static string Value(this AttendeeUpdateStatus value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static AttendeeUpdateStatus ToEnum(this string value)
        {
            foreach (var field in typeof(AttendeeUpdateStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AttendeeUpdateStatus)
                    {
                        return (AttendeeUpdateStatus)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AttendeeUpdateStatus");
        }
    }
}