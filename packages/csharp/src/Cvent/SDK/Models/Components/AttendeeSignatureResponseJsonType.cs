        ...
        public static AttendeeSignatureResponseJsonType ToEnum(this string value)
        {
            foreach(var field in typeof(AttendeeSignatureResponseJsonType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AttendeeSignatureResponseJsonType)
                    {
                        return (AttendeeSignatureResponseJsonType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AttendeeSignatureResponseJsonType");
        }
    }
