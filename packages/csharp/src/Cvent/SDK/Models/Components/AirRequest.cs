...
namespace Cvent.SDK.Models.Components
{
    ...
    public class AirRequest
    {
        ...
        public AirRequesterType? RequesterType { get; set; }
        ...
        public LegDetail? OutgoingLeg { get; set; }
        ...
        public List<AirlinePreference>? AirlinePreference { get; set; }
        ...
        public List<AttendeeAnswer1>? AirRequestAnswers { get; set; }
    }
}