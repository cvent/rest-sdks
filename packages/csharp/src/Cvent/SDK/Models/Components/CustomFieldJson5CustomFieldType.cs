...
namespace Cvent.SDK.Models.Components
{
    ...
    /// </summary>
    public enum CustomFieldJson5CustomFieldType
    {
    ...
    public static class CustomFieldJson5CustomFieldTypeExtension
    {
        public static string Value(this CustomFieldJson5CustomFieldType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CustomFieldJson5CustomFieldType ToEnum(this string value)
        {
            foreach (var field in typeof(CustomFieldJson5CustomFieldType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CustomFieldJson5CustomFieldType)
                    {
                        return (CustomFieldJson5CustomFieldType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CustomFieldJson5CustomFieldType");
        }
    }
}