        ...
        public static ReconciliationStatusJson ToEnum(this string value)
        {
            foreach (var field in typeof(ReconciliationStatusJson).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ReconciliationStatusJson)
                    {
                        return (ReconciliationStatusJson)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ReconciliationStatusJson");
        }
    }
}