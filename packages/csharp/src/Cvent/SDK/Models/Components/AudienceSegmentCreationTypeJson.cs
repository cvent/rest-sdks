        ...
        public static AudienceSegmentCreationTypeJson ToEnum(this string value)
        {
            foreach(var field in typeof(AudienceSegmentCreationTypeJson).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AudienceSegmentCreationTypeJson)
                    {
                        return (AudienceSegmentCreationTypeJson)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AudienceSegmentCreationTypeJson");
        }
    }
