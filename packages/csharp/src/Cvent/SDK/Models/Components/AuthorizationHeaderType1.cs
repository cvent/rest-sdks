        ...
        public static AuthorizationHeaderType1 ToEnum(this string value)
        {
            foreach (var field in typeof(AuthorizationHeaderType1).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is AuthorizationHeaderType1)
                    {
                        return (AuthorizationHeaderType1)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum AuthorizationHeaderType1");
        }
    }
}