...
namespace Cvent.SDK.Models.Components
{
    ...
    public class Planner1
    {
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("optOut")]
        public Planner1ContactOptOut? OptOut { get; set; }
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("_links")]
        public Planner1ContactLinks? Links { get; set; }
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("gender")]
        public Planner1Gender? Gender { get; set; }
        ...
        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("type")]
        public Planner1Type? Type { get; set; }

        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("membership")]
        public Planner1ContactMembership? Membership { get; set; }

        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("primaryAddressType")]
        public Planner1AddressType? PrimaryAddressType { get; set; }

        [Obsolete("This field will be removed in a future release, please migrate away from it as soon as possible")]
        [JsonProperty("homeAddress")]
        public Planner1HomeAddressAddress? HomeAddress { get; set; }
        ...
        public Planner1WorkAddressAddress? WorkAddress { get; set; }
