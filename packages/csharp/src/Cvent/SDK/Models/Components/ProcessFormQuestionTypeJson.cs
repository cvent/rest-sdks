        ...
        public static ProcessFormQuestionTypeJson ToEnum(this string value)
        {
            foreach(var field in typeof(ProcessFormQuestionTypeJson).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ProcessFormQuestionTypeJson)
                    {
                        return (ProcessFormQuestionTypeJson)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum ProcessFormQuestionTypeJson");
        }
    }
}