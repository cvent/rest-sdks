...
namespace Cvent.SDK.Models.Components
{
    ...
    /// </summary>
    public enum MeetingRoomAgendaItemType
    {
    ...
    public static class MeetingRoomAgendaItemTypeExtension
    {
        public static string Value(this MeetingRoomAgendaItemType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static MeetingRoomAgendaItemType ToEnum(this string value)
        {
            foreach (var field in typeof(MeetingRoomAgendaItemType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is MeetingRoomAgendaItemType)
                    {
                        return (MeetingRoomAgendaItemType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum MeetingRoomAgendaItemType");
        }
    }
}