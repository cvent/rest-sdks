...
namespace Cvent.SDK.Models.Components
{
    ...
    public class AttendeeSignatureResponse
    {
        ...
        /// </summary>
        [JsonProperty("event")]
        public AttendeeSignatureResponseEvent Event { get; set; } = default!;

        /// <summary>
        /// Session information associated with the signature.
        /// </summary>
        [JsonProperty("session")]
        public AttendeeSignatureResponseSession? Session { get; set; }

        /// <summary>
        /// Attendee information associated with the signature.
        /// </summary>
        [JsonProperty("attendee")]
        public AttendeeSignatureResponseAttendee Attendee { get; set; } = default!;

        /// <summary>
        /// Type of entity this signature is associated with. Possible values are: `EVENT`, `SESSION`.
        /// </summary>
        [JsonProperty("type")]
        public AttendeeSignatureResponseType Type { get; set; } = default!;
