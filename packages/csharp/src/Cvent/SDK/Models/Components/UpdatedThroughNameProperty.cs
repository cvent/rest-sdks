...
namespace Cvent.SDK.Models.Components
{
    ...
    public static class UpdatedThroughNamePropertyExtension
    {
        public static string Value(this UpdatedThroughNameProperty value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static UpdatedThroughNameProperty ToEnum(this string value)
        {
            foreach (var field in typeof(UpdatedThroughNameProperty).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is UpdatedThroughNameProperty)
                    {
                        return (UpdatedThroughNameProperty)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum UpdatedThroughNameProperty");
        }
    }
}