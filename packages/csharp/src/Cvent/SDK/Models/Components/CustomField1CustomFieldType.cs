        ...
        public static CustomField1CustomFieldType ToEnum(this string value)
        {
            foreach (var field in typeof(CustomField1CustomFieldType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CustomField1CustomFieldType)
                    {
                        return (CustomField1CustomFieldType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CustomField1CustomFieldType");
        }
    }
}