...
namespace Cvent.SDK.Models.Components
{
    ...
    {
        public static string Value(this FieldType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static FieldType ToEnum(this string value)
        {
            foreach (var field in typeof(FieldType).GetFields())
            {
            ...
            throw new Exception($"Unknown value {value} for enum FieldType");
        }
    }
}