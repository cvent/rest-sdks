        ...
        public static CustomFieldJson4CustomFieldType ToEnum(this string value)
        {
            foreach(var field in typeof(CustomFieldJson4CustomFieldType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CustomFieldJson4CustomFieldType)
                    {
                        return (CustomFieldJson4CustomFieldType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CustomFieldJson4CustomFieldType");
        }
    }
}