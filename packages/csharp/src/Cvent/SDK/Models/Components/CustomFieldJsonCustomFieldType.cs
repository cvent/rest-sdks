...
namespace Cvent.SDK.Models.Components
{
    ...
    /// </summary>
    public enum CustomFieldJsonCustomFieldType
    {
    ...
    public static class CustomFieldJsonCustomFieldTypeExtension
    {
        public static string Value(this CustomFieldJsonCustomFieldType value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString()) [0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static CustomFieldJsonCustomFieldType ToEnum(this string value)
        {
            foreach (var field in typeof(CustomFieldJsonCustomFieldType).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is CustomFieldJsonCustomFieldType)
                    {
                        return (CustomFieldJsonCustomFieldType)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum CustomFieldJsonCustomFieldType");
        }
    }
}