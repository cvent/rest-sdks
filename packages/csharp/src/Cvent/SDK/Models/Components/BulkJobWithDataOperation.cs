        ...
        public static BulkJobWithDataOperation ToEnum(this string value)
        {
            foreach(var field in typeof(BulkJobWithDataOperation).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is BulkJobWithDataOperation)
                    {
                        return (BulkJobWithDataOperation)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum BulkJobWithDataOperation");
        }
    }
}