        ...
        public static HousingEventStatusesJson ToEnum(this string value)
        {
            foreach(var field in typeof(HousingEventStatusesJson).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is HousingEventStatusesJson)
                    {
                        return (HousingEventStatusesJson)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum HousingEventStatusesJson");
        }
    }
